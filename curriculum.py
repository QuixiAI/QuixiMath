...
CURRICULUM = {
    ...
    "ComplementProbabilityGenerator": {"grade_level": ELEMENTARY, "difficulty": 2},
    "ExperimentalProbabilityGenerator": {"grade_level": ELEMENTARY, "difficulty": 2},
    ...
    "TelescopingGenerator": {"grade_level": HIGH, "difficulty": 5},
    ...
    "DiscretePosteriorGenerator": {"grade_level": GRADUATE, "difficulty": 3},
    ...
    "MeanGenerator": {"grade_level": MIDDLE, "difficulty": 2},
    "MedianGenerator": {"grade_level": MIDDLE, "difficulty": 2},
    "ModeGenerator": {"grade_level": MIDDLE, "difficulty": 1},
    "RangeGenerator": {"grade_level": MIDDLE, "difficulty": 1},
    ...
    "PolynomialInequalityGenerator": {"grade_level": HIGH, "difficulty": 5},
    ...
    "QRDecompositionGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    ...
    "MasterTheoremGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "InductionVerifyGenerator": {"grade_level": HIGH, "difficulty": 5},
    "CountingClassicsGenerator": {"grade_level": COLLEGE, "difficulty": 3},
    ...
    "TuringMachineTraceGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "DFASimulationGenerator": {"grade_level": COLLEGE, "difficulty": 3},
    "NFASimulationGenerator": {"grade_level": COLLEGE, "difficulty": 3},
    "DFAMinimizationGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "RegexToAutomatonGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "PDASimulationGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "CYKParserGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "DPLLTraceGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "ResolutionProofGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "UnificationGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    "LambdaReductionGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    ...
    "JacobiSymbolGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    "TonelliShanksGenerator": {"grade_level": GRADUATE, "difficulty": 5},
    ...
    "PollardFactorizationGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "BabyStepGiantStepGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    ...
    "EllipticCurveFiniteFieldGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    "ECDHGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    "ECDSAGenerator": {"grade_level": GRADUATE, "difficulty": 5},
    "LLLReductionGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    ...
    "SeparablePDEGenerator": {"grade_level": GRADUATE, "difficulty": 3},
    ...
    "EquilibriumICEGenerator": {"grade_level": HIGH, "difficulty": 5},
    ...
    "BECChannelGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "EntropyRateMarkovGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    "ViterbiGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "HuffmanCodingGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "ArithmeticCodingGenerator": {"grade_level": GRADUATE, "difficulty": 5},
    "LZCompressionGenerator": {"grade_level": COLLEGE, "difficulty": 4},
    "ConvolutionalCodeViterbiGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    "ReedSolomonGenerator": {"grade_level": GRADUATE, "difficulty": 4},
    ...
    "CholeskyGenerator": {"grade_level": COLLEGE, "difficulty": 4},
