...
1711 distinct op-codes observed.
...
| `ACT_SETUP` | 3 | `ACT_SETUP\|activation=sigmoid\|x=-4\|w1=1,b1=4,w2=-3,b2=6` | activation_generator.py |
| `ACT_VALUE` | 3 | `ACT_VALUE\|sigmoid\|0\|1/2` | activation_generator.py |
| `AC_COMPLEX` | 3 | `AC_COMPLEX\|Z\|25\|14j` | ac_circuit_generator.py |
| `AC_FORMULA` | 1 | `AC_FORMULA\|Z=R+j(XL-XC)` | ac_circuit_generator.py |
| `AC_PRODUCT` | 2 | `AC_PRODUCT\|3 × 20\|60` | factor_trinomial_generator.py |
| `AC_SETUP` | 3 | `AC_SETUP\|series_rlc\|R=25, XL=22\|XC=8, V=107` | ac_circuit_generator.py |
| `ADAM_SETUP` | 3 | `ADAM_SETUP\|theta=-2,g=4\|beta1=9/10,beta2=99/100\|lr=1/20,epsilon=0` | adam_step_generator.py |
...
| `ADJOINT` | 1 | `ADJOINT\|A^dagger=[[-14,6],[6,-14]]` | hermitian_check_generator.py |
| `ADJ_LIST` | 2 | `ADJ_LIST\|A\|B, C, D` | euler_circuit_generator.py, graph_traversal_generator.py |
| `ALG_SETUP` | 3 | `ALG_SETUP\|insertion sort\|passes 3\|values 10, 11, 3, 34, 1` | algorithm_trace_generator.py |
| `ALIGN_NUM` | 2 | `ALIGN_NUM\|046.36\|177.07` | number_comparison_generator.py |
| `ALPHA` | 2 | `ALPHA\|alpha1\|-7/24` | kernel_ridge_generator.py |
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda s. n\|lambda z. n` | lambda_reduction_generator.py |
| `AMORT_ROW` | 3 | `AMORT_ROW\|1\|interest=$4368.00\|principal=$5712.00,balance=$23408.00` | annuity_generator.py |
| `AMPLITUDE` | 2 | `AMPLITUDE\|abs(2)\|2` | sinusoid_features_generator.py |
| `ANALOGY_SETUP` | 3 | `ANALOGY_SETUP\|man=(-4,-1)\|woman=(-6,-1)\|king=(-7,-1)` | embedding_similarity_generator.py |
| `ANALOGY_VECTOR` | 2 | `ANALOGY_VECTOR\|king-man+woman\|(-9,-1)` | embedding_similarity_generator.py |
| `ANGLE` | 2 | `ANGLE\|theta\|3pi/4` | positional_encoding_generator.py |
| `ANGLE_DEFECT_SETUP` | 2 | `ANGLE_DEFECT_SETUP\|R=13\|angles=45,30,45` | angle_defect_generator.py |
...
| `ANGLE_WRAP` | 2 | `ANGLE_WRAP\|301 deg\|-59 deg` | complex_log_generator.py |
| `ANNUITY_FORMULA` | 1 | `ANNUITY_FORMULA\|interest=balance*r; principal=payment-interest` | annuity_generator.py |
| `ANNUITY_SETUP` | 2, 3 | `ANNUITY_SETUP\|amortization schedule\|balance=29120,payment=10080,r=15%\|periods=3` | annuity_generator.py |
...
| `APPLY_GATE` | 3 | `APPLY_GATE\|CNOT\|e^(i78π/41)·ket10\|e^(i78π/41)·ket11` | quantum_gate_generator.py |
...
| `APPROX_ENTRY` | 2 | `APPROX_ENTRY\|(1,1)\|4` | low_rank_approx_generator.py |
...
| `ARGUMENT` | 2 | `ARGUMENT\|(-4,-4)\|225 deg` | complex_log_generator.py, euler_formula_generator.py |
...
| `ARITH_SETUP` | 2 | `ARITH_SETUP\|A=1/2, B=1/8, C=1/8, D=1/4\|message=DBD` | arithmetic_coding_generator.py |
| `ARITH_SYMBOL` | 2 | `ARITH_SYMBOL\|D\|cum=[3/4,1)` | arithmetic_coding_generator.py |
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|10, 11, 3, 34, 1` | algorithm_trace_generator.py |
...
| `ATTN_OUTPUT` | 2 | `ATTN_OUTPUT\|1\|[[1/2,11/2]]` | attention_generator.py |
...
| `BACKPROP_SETUP` | 3 | `BACKPROP_SETUP\|x=(3,3)\|y=3\|eta=1/8` | backprop_generator.py |
| `BACK_SUB` | 2 | `BACK_SUB\|v = y/x\|y/x = 2 ln(x) + C` | ode_substitution_generator.py |
| `BACK_SUB_ROW` | 3 | `BACK_SUB_ROW\|r=609\|x=1\|y=0` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `BAYES_UPDATE_SETUP` | 2, 3 | `BAYES_UPDATE_SETUP\|beta_binomial\|prior=Beta(12,12)\|successes=3, trials=9` | bayesian_update_generator.py |
...
| `BETA` | 1 | `BETA\|(lambda p. (q p)) applied to q` | lambda_reduction_generator.py |
| `BEZOUT_CHECK` | 2 | `BEZOUT_CHECK\|609*7 + 112*-38\|7` | extended_euclid_generator.py |
| `BIAS_CORRECT` | 2 | `BIAS_CORRECT\|m_hat\|4` | adam_step_generator.py |
| `BINARY_EXPONENT` | 2 | `BINARY_EXPONENT\|39\|100111` | mod_exp_generator.py, quadratic_residue_generator.py |
...
| `BISECTION_SETUP` | 3 | `BISECTION_SETUP\|f(x)=x^2-109\|interval=[10, 11]\|iterations=5` | bisection_generator.py |
| `BISECT_UPDATE` | 3 | `BISECT_UPDATE\|1\|product < 0\|[10, 21/2]` | bisection_generator.py |
...
| `BLACKBODY_SETUP` | 3 | `BLACKBODY_SETUP\|stefan_power\|sigma=3, A=13\|T=15` | blackbody_generator.py |
| `BOND_FORMULA` | 1 | `BOND_FORMULA\|price=sum coupon/(1+y)^t + face/(1+y)^n` | bond_pricing_generator.py |
| `BOND_PRICE` | 1 | `BOND_PRICE\|$7040.00` | bond_pricing_generator.py |
| `BOND_SETUP` | 2 | `BOND_SETUP\|face=9600\|coupon=10%,ytm=50%,years=1` | bond_pricing_generator.py |
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables A, B, C\|CNF from G=0 rows` | boolean_algebra_generator.py |
...
| `BOX_SETUP` | 1, 3 | `BOX_SETUP\|energy_level\|n=1, h=3\|m=10, L=2` | particle_in_box_generator.py |
| `BRAKET_FORMULA` | 1 | `BRAKET_FORMULA\|inner(phi,psi)=sum conj(phi_k)*psi_k` | braket_generator.py |
| `BRAKET_SETUP` | 3 | `BRAKET_SETUP\|inner_product\|phi=[i,2+i,-1+i]\|psi=[1,0,2-i]` | braket_generator.py |
...
| `BSGS_SETUP` | 4 | `BSGS_SETUP\|p=29\|g=2\|h=5\|m=6` | baby_step_giant_step_generator.py |
| `BS_FORMULA` | 2 | `BS_FORMULA\|C=S*N(d1)-K*df*N(d2)\|P=K*df*N(-d2)-S*N(-d1)` | black_scholes_generator.py |
| `BS_RESULT` | 2 | `BS_RESULT\|call=3.3\|put=7.3` | black_scholes_generator.py |
| `BS_SETUP` | 3 | `BS_SETUP\|S=110,K=120\|df=0.95\|N_d1=0.6,N_d2=0.55` | black_scholes_generator.py |
...
| `CANONICAL_ORDER` | 1 | `CANONICAL_ORDER\|A=2, C=2, B=5, D=5` | kraft_inequality_generator.py |
...
| `CASIMIR_FORCE_SETUP` | 2 | `CASIMIR_FORCE_SETUP\|F/A=-π^2*hbar*c/(240*d^4)\|hbar=3,c=20,d=7` | casimir_force_generator.py |
| `CASIMIR_SETUP` | 3 | `CASIMIR_SETUP\|spin=5/2\|hbar=2/7\|JplusJminus entry at m=5/2` | casimir_generator.py |
...
| `CENTROID_UPDATE` | 2 | `CENTROID_UPDATE\|C1\|(1/2,-5/2)` | kmeans_step_generator.py |
| `CF_PARTIAL` | 2 | `CF_PARTIAL\|a_0\|3` | continued_fraction_generator.py |
| `CF_RESULT` | 1 | `CF_RESULT\|[3; 5, 5, 1, 2]` | continued_fraction_generator.py |
| `CF_SETUP` | 1 | `CF_SETUP\|281/88` | continued_fraction_generator.py |
...
| `CHINCHILLA` | 2 | `CHINCHILLA\|20N\|540000000` | scaling_law_generator.py |
...
| `CHOL_SETUP` | 2 | `CHOL_SETUP\|A = [[9, -9, 3], [-9, 34, -13], [3, -13, 9]]\|A = L L^T` | cholesky_generator.py |
...
| `CHRISTOFFEL_VALUE` | 2 | `CHRISTOFFEL_VALUE\|Gamma^phi_thetatheta\|-3120/7921` | riemann_tensor_generator.py |
...
| `CIRCLE_EQ` | 1 | `CIRCLE_EQ\|(x - 1)^2 + (y + 6)^2 = 81` | complex_locus_generator.py |
...
| `CLAUSE` | 2 | `CLAUSE\|C1\|(not P93718)` | resolution_proof_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(A OR B OR C) AND (A OR NOT B OR C) AND (A OR NOT B OR NOT C) AND (NOT A OR B OR C) AND (NOT A OR NOT B OR C) AND (NOT A OR NOT B OR NOT C)` | boolean_algebra_generator.py |
...
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=1, j=6\|1+6=7\|5` | generating_function_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[2, 0], [1, -1]]` | determinant_generator.py |
| `COLLIDER_SETUP` | 3 | `COLLIDER_SETUP\|luminosity\|N=154 events\|sigma=30 fb` | cross_section_generator.py |
| `COLLISION` | 1 | `COLLISION\|f(g) = f(h) = 4` | function_properties_generator.py |
| `COLLISION_SETUP` | 3 | `COLLISION_SETUP\|elastic_1d\|m1=6, u1=11\|m2=13, u2=1` | collision_generator.py |
...
| `COMM_RESULT` | 2 | `COMM_RESULT\|[D,x]f\|x^6` | commutator_generator.py |
| `COMM_SETUP` | 3 | `COMM_SETUP\|[D,x]f\|f=x^6\|D=d/dx` | commutator_generator.py |
...
| `CONGRUENCE_REDUCE` | 2 | `CONGRUENCE_REDUCE\|17x congruent to 1\|mod 7` | modular_inverse_generator.py |
| `CONGRUENCE_SOLUTIONS` | 3 | `CONGRUENCE_SOLUTIONS\|base 5\|step 7\|5, 12, 19, 26` | modular_inverse_generator.py |
...
| `CONSERVATION_SETUP` | 2 | `CONSERVATION_SETUP\|p + anti_p -> pi0 + pi+ + pi0\|check=Q,B,Le,Lmu` | conservation_law_generator.py |
...
| `CONTOUR_SETUP` | 3 | `CONTOUR_SETUP\|abs(z)=4\|positive orientation\|f=2/(z+1) - 1/(z+7) - 5/(z-6)` | contour_integral_generator.py |
...
| `CONV_SETUP` | 2, 3 | `CONV_SETUP\|x=[3,8,3,1,8]\|h=[7,2,6]` | convolution_generator.py, convolutional_code_viterbi_generator.py |
...
| `COSET` | 2 | `COSET\|0+H\|{0, 12, 24, 9, 21, 6, 18, 3, 15}` | coset_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|28 boxes\|force 29 in one box` | counting_classics_generator.py |
| `COUPON` | 1 | `COUPON\|960` | bond_pricing_generator.py |
...
| `CRC_CHECK` | 3 | `CRC_CHECK\|codeword=1100101000110\|remainder=0000\|valid` | crc_generator.py |
| `CRC_REMAINDER` | 1 | `CRC_REMAINDER\|0110` | crc_generator.py |
| `CRC_SETUP` | 3 | `CRC_SETUP\|data=110010100\|poly=11101\|augmented=1100101000000` | crc_generator.py |
| `CRC_SKIP` | 2 | `CRC_SKIP\|i=1\|leading bit 0` | crc_generator.py |
| `CRC_XOR` | 3 | `CRC_XOR\|i=0\|11001 xor 11101\|00100` | crc_generator.py |
...
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=1\|ln(9/2)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|40·BC = 16·25` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CROSS_RATIO` | 1 | `CROSS_RATIO\|-1/12` | mobius_transform_generator.py |
...
| `CRT_FACTOR` | 3 | `CRT_FACTOR\|i=1\|M_i=35\|mod 3` | crt_generator.py |
| `CRT_SETUP` | 1 | `CRT_SETUP\|3 congruences` | crt_generator.py |
| `CRT_TERM` | 2 | `CRT_TERM\|i=1\|140` | crt_generator.py |
| `CRT_TOTAL_MODULUS` | 2 | `CRT_TOTAL_MODULUS\|3, 5, 7\|105` | crt_generator.py |
| `CR_SETUP` | 2 | `CR_SETUP\|u=4x^2 - 4y^2 + 2x\|v=8xy + 2y` | cauchy_riemann_generator.py |
...
| `CURRENT_YIELD` | 1 | `CURRENT_YIELD\|3/22` | bond_pricing_generator.py |
...
| `CX_A` | 3 | `CX_A\|60/61\|0\|60/61` | braket_generator.py, spin_half_generator.py |
| `CX_M` | 3 | `CX_M\|1\|60/61\|60/61` | braket_generator.py, spin_half_generator.py |
| `CX_SETUP` | 2 | `CX_SETUP\|(-2 + 7i) - (-9 - 3i)\|subtract` | complex_division_generator.py, complex_number_ops_generator.py |
| `CYCLE` | 1 | `CYCLE\|(1 3 4 2)` | permutation_group_generator.py |
...
| `CYCLE_TRACE` | 2 | `CYCLE_TRACE\|start 1\|1->3->4->2->1` | permutation_group_generator.py |
| `CYCLIC_START` | 2 | `CYCLIC_START\|1\|identity 0` | cyclic_group_generator.py |
| `CYCLIC_SUBGROUP` | 2 | `CYCLIC_SUBGROUP\|{0, 1, 2, 3, 4, 5}\|6` | cyclic_group_generator.py |
| `CYK_CELL` | 2 | `CYK_CELL\|1,2\|{S,Y}` | cyk_parser_generator.py |
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|Y A\|{S,Y}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|A\|e` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string eee\|length 3` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{A,Y} x {A,Y}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|e\|{A,Y}` | cyk_parser_generator.py |
...
| `DECISION` | 2 | `DECISION\|f(x)\|81` | kernel_perceptron_generator.py, svm_margin_generator.py |
...
| `DEMOIVRE_POWER` | 1 | `DEMOIVRE_POWER\|16807 cis(0 deg)` | de_moivre_generator.py |
| `DEMOIVRE_SETUP` | 2, 4 | `DEMOIVRE_SETUP\|roots_of_unity\|n=8` | de_moivre_generator.py |
| `DENSITY` | 2 | `DENSITY\|f_XY(x,y)\|1/7^2` | rv_transform_generator.py |
| `DENSITY_MATRIX` | 1 | `DENSITY_MATRIX\|rho=[[1/15,0],[0,14/15]]` | density_matrix_generator.py |
| `DENSITY_SETUP` | 2, 3 | `DENSITY_SETUP\|state=Phi_phase\|psi=(ket00 + e^(i351π/272)ket11)/sqrt(2)` | density_matrix_generator.py, partial_trace_generator.py |
| `DEPTH` | 1, 2 | `DEPTH\|3` | wff_parsing_generator.py |
| `DEQUANT_VALUE` | 2 | `DEQUANT_VALUE\|1\|-44/25` | quantization_generator.py |
...
| `DERIVED` | 2 | `DERIVED\|C5\|(P70515)` | resolution_proof_generator.py |
...
| `DET` | 2 | `DET\|K\|-141` | kernel_ridge_generator.py, kernel_validity_generator.py |
...
| `DFA_INPUT` | 1 | `DFA_INPUT\|0001` | dfa_simulation_generator.py |
...
| `DFT_SETUP` | 2 | `DFT_SETUP\|N=2\|x=[5,1]` | dft_generator.py |
...
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[-3, -3, -3]` | finite_difference_generator.py |
...
| `DIST_SETUP` | 3 | `DIST_SETUP\|normal\|mu=2,sigma=2\|x=4` | named_distribution_generator.py |
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited D\|A=7, B=2, C=inf, D=0` | dijkstra_generator.py |
...
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT K AND NOT L AND NOT M AND N) OR (NOT K AND L AND NOT M AND N) OR (NOT K AND L AND M AND NOT N) OR (K AND NOT L AND NOT M AND N) OR (K AND NOT L AND M AND N)` | boolean_algebra_generator.py |
...
| `DOPPLER_SETUP` | 3 | `DOPPLER_SETUP\|relativistic_approach\|f=109\|beta=15/17` | doppler_generator.py |
...
| `DOT4` | 4 | `DOT4\|gamma3gamma3\|(2,2)\|0*0 + 0*0 + 1*-1 + 0*0\|-1` | gamma_matrix_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=2,v=10); 2:(w=3,v=2); 3:(w=4,v=11); 4:(w=3,v=9)` | dp_table_generator.py |
| `DP_ROW` | 2 | `DP_ROW\|i=0\|0, 0, 0, 0, 0, 0` | dp_table_generator.py |
| `DP_SETUP` | 2, 3 | `DP_SETUP\|LCS\|X=DAAAD\|Y=DDCBD` | dp_table_generator.py |
...
| `ECDSA_SETUP` | 4 | `ECDSA_SETUP\|E/F_17, G=(5,1), n=19\|d=2\|z=5\|k=15` | ecdsa_generator.py |
| `ECDSA_SIGN` | 2 | `ECDSA_SIGN\|s=k^-1(z+rd) mod n\|s=2` | ecdsa_generator.py |
| `ECDSA_VERIFY` | 2 | `ECDSA_VERIFY\|u1=12\|u2=11` | ecdsa_generator.py |
...
| `EC_SCALAR_SETUP` | 2 | `EC_SCALAR_SETUP\|k=6\|P=(7,11)` | elliptic_curve_finite_field_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|AD\|weight 2\|add D` | mst_generator.py |
...
| `EINSTEIN_SETUP` | 2, 3 | `EINSTEIN_SETUP\|trace\|T_ij=[[-4, -1, 0], [2, 5, -6], [-1, -6, 0]]` | einstein_summation_generator.py |
| `ELEC_FORMULA` | 1 | `ELEC_FORMULA\|left charge: E1=q1/r1^2` | electrostatics_generator.py |
| `ELEC_SETUP` | 2, 3 | `ELEC_SETUP\|field_axis\|q1=8, x1=-5\|q2=5, x2=2` | electrostatics_generator.py |
...
| `ENERGY_LEVEL` | 2 | `ENERGY_LEVEL\|E_5=hbar*omega*(n+1/2)\|44` | ladder_operator_generator.py |
| `ENERGY_SETUP` | 3 | `ENERGY_SETUP\|gravity_drop\|m=17\|h=720, g=10` | energy_conservation_generator.py |
...
| `ENGINE_SETUP` | 3 | `ENGINE_SETUP\|refrigerator_cop\|Qc=171\|W=38` | heat_engine_generator.py |
...
| `EPS_CLOSURE` | 2 | `EPS_CLOSURE\|{q6}\|{q6}` | nfa_simulation_generator.py |
...
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|609\|112\|5\|49` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|A\|route suffix A\|stack A-B-D-C` | euler_circuit_generator.py |
| `EULER_CRITERION` | 2 | `EULER_CRITERION\|19^20 mod 41\|40` | quadratic_residue_generator.py |
...
| `EXPECTATION` | 3 | `EXPECTATION\|E[X]=20/47\|E[Y]=20/47\|E[XY]=130/2209` | joint_distribution_generator.py |
...
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|609\|112` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `FERMAT_SETUP` | 3 | `FERMAT_SETUP\|prime 23\|base 51\|exponent 233` | totient_generator.py |
...
| `FINITE_DIFF_SETUP` | 3 | `FINITE_DIFF_SETUP\|table\|x=[-1, 2, 5, 8]\|y=[8, 5, 2, -1]` | finite_difference_generator.py |
...
| `FIRSTLAW_SETUP` | 3 | `FIRSTLAW_SETUP\|isothermal\|W=90\|ideal gas` | first_law_generator.py |
...
| `FIXED_POINT_SETUP` | 3 | `FIXED_POINT_SETUP\|g(x)=1/2*x-2\|x0=-1\|iterations=4` | fixed_point_generator.py |
| `FIXED_POINT_UPDATE` | 3 | `FIXED_POINT_UPDATE\|1\|x_0=-1\|x_1=-5/2` | fixed_point_generator.py |
| `FLAG` | 2 | `FLAG\|4\|54 ÷ 9 = 6, not 8` | error_spotting_generator.py |
| `FLOOR_DIV` | 3 | `FLOOR_DIV\|6\|2\|3` | algorithm_trace_generator.py |
| `FLOPS_SETUP` | 2 | `FLOPS_SETUP\|rule=2mnk\|m=16,d=256,h=2048,o=512` | flops_memory_generator.py |
...
| `FOURIER_SETUP` | 3 | `FOURIER_SETUP\|square\|A=2\|n=6` | fourier_series_generator.py |
| `FOUR_VECTOR_SETUP` | 3 | `FOUR_VECTOR_SETUP\|signature=+---\|p=[-1,7,-5,5]\|q=[-7,-2,-3,-6]` | four_vector_generator.py |
...
| `FUNDAMENTAL_FORM_SETUP` | 3 | `FUNDAMENTAL_FORM_SETUP\|sphere\|R=10\|theta in [0,pi/2], phi in [90,180]` | fundamental_form_generator.py |
| `GAME_SETUP` | 2 | `GAME_SETUP\|payoffs=(19,14;2,20)\|row player maximizes, column player minimizes` | game_theory_generator.py |
| `GAMMA_SETUP` | 3 | `GAMMA_SETUP\|anticommutator_entry\|gamma3,gamma3\|entry=(2,2)` | gamma_matrix_generator.py |
| `GAS_FORMULA` | 1 | `GAS_FORMULA\|P1*V1/T1=P2*V2/T2` | gas_law_generator.py, gas_stoichiometry_generator.py |
| `GAS_SETUP` | 3 | `GAS_SETUP\|combined_pressure\|P1=18, V1=13, T1=1\|V2=9, T2=29` | gas_law_generator.py |
| `GAS_STOICH_SETUP` | 3 | `GAS_STOICH_SETUP\|mass_to_gas_volume\|2 KClO3 -> 2 KCl + 3 O2\|given=976 g KClO3, gas=O2` | gas_stoichiometry_generator.py |
| `GATE_MATRIX` | 2 | `GATE_MATRIX\|CNOT\|ket00bra00+ket01bra01+ket11bra10+ket10bra11` | quantum_gate_generator.py |
| `GAUSSIAN_CURVATURE_SETUP` | 2, 3 | `GAUSSIAN_CURVATURE_SETUP\|sphere\|R=141` | gaussian_curvature_generator.py |
...
| `GAUSS_SETUP` | 3 | `GAUSS_SETUP\|line_charge\|lambda=9, r=6\|L=2` | gauss_law_generator.py |
...
| `GD_SETUP` | 3 | `GD_SETUP\|f(x,y)=1/2*(6x^2+5y^2)\|start=(-9,-2)\|eta=1/14` | gradient_descent_generator.py |
| `GD_UPDATE` | 3 | `GD_UPDATE\|w_old=(-3,-1)\|eta=1/3\|w_new=(-1/3,-31/3)` | gradient_step_generator.py |
| `GELLMANN_IDENTITY` | 3 | `GELLMANN_IDENTITY\|Tr(lambda_4 lambda_5)\|2 delta_ab\|0` | pauli_algebra_generator.py |
| `GELLMANN_SETUP` | 3 | `GELLMANN_SETUP\|trace\|A=lambda_4\|B=-lambda_5` | pauli_algebra_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^7]\|(1 + x)^5(1 + x)^6` | generating_function_generator.py |
...
| `GRAD` | 2 | `GRAD\|1\|-7/9` | softmax_gradient_generator.py |
| `GRADIENT_FORMULA` | 1 | `GRADIENT_FORMULA\|grad=(6x,5y)` | gradient_descent_generator.py, matrix_calculus_generator.py |
| `GRAD_ENTRY` | 2 | `GRAD_ENTRY\|g1\|-52` | matrix_calculus_generator.py |
...
| `GRAPH_SETUP` | 2 | `GRAPH_SETUP\|vertices A, B, C, D\|edges AC, BD, CD` | dijkstra_generator.py, euler_circuit_generator.py, graph_counting_generator.py, graph_traversal_generator.py |
| `GRASSMANN_RESULT` | 3 | `GRASSMANN_RESULT\|constant=-27\|theta=66\|-27 + 66theta` | grassmann_generator.py |
| `GRASSMANN_SETUP` | 3 | `GRASSMANN_SETUP\|multiply\|x=3 - 8theta\|y=-9 - 2theta` | grassmann_generator.py |
| `GREATEST` | 1 | `GREATEST\|none` | partial_order_generator.py |
| `GREAT_CIRCLE_SETUP` | 3 | `GREAT_CIRCLE_SETUP\|R=12\|A=(90,120)\|B=(0,-120)` | great_circle_generator.py |
...
| `HAMMING_RECEIVED` | 1 | `HAMMING_RECEIVED\|r=1011100` | hamming_code_generator.py |
...
| `HAM_SETUP` | 3 | `HAM_SETUP\|atwood\|m1=3, m2=16\|g=10, q=y, p=p_y` | hamiltonian_generator.py |
| `HARMONIC_SETUP` | 1 | `HARMONIC_SETUP\|u=-2x^2 + 2y^2 + 3x + y` | cauchy_riemann_generator.py |
| `HAWKING_SETUP` | 3 | `HAWKING_SETUP\|temperature\|T_H=hbar*c^3/(8π*G*M*k_B)\|hbar=1,c=2,G=12,M=13,k_B=11` | hawking_generator.py |
...
| `HIDDEN_PRE` | 2 | `HIDDEN_PRE\|h1\|z=-13` | backprop_generator.py |
...
| `HOOK` | 4 | `HOOK\|(1,1)\|right=8\|below=2\|hook=11` | young_tableaux_generator.py |
...
| `HUFFMAN_SETUP` | 1 | `HUFFMAN_SETUP\|A=1/4, B=1/4, C=1/16, D=1/16, E=1/16, F=1/4, G=1/16` | huffman_coding_generator.py |
| `HYDROGEN_FORMULA` | 1 | `HYDROGEN_FORMULA\|1/lambda=R_L*(1/n_low^2-1/n_high^2)` | hydrogen_atom_generator.py |
| `HYDROGEN_SETUP` | 3 | `HYDROGEN_SETUP\|transition_wavelength\|n_low=3, n_high=4\|R_L=11 1/m` | hydrogen_atom_generator.py |
| `HYPERBOLIC_DISTANCE_SETUP` | 3 | `HYPERBOLIC_DISTANCE_SETUP\|disk\|P=(0,0)\|Q=(17/35,0)` | hyperbolic_distance_generator.py |
...
| `ICE_ROW` | 2 | `ICE_ROW\|equilibrium\|[A]=1, [B]=5.5` | equilibrium_ice_generator.py |
| `IDENTIFY` | 2 | `IDENTIFY\|order matters\|use P(n, r)` | permutation_combination_generator.py |
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=10..26 C(i,10) = C(27,11)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IG_SETUP` | 3 | `IG_SETUP\|parent pos=6, neg=10\|total=16\|splits=shape,source` | information_gain_generator.py |
...
| `INDEP_CHECK` | 3 | `INDEP_CHECK\|P11=130/2209\|product=400/2209\|no` | joint_distribution_generator.py |
| `INDEP_FORMULA` | 1 | `INDEP_FORMULA\|independent iff P11=P(X=1)P(Y=1)` | joint_distribution_generator.py |
| `INDEX` | 3 | `INDEX\|G size 27\|H size 9\|3` | coset_generator.py |
| `INDEX_METRIC` | 3 | `INDEX_METRIC\|raise\|sphere\|g^ii=[1,1/25]` | index_raising_generator.py |
| `INDEX_SETUP` | 3 | `INDEX_SETUP\|c=-5\|j=1, k=2\|l=3, m=2` | index_gymnastics_generator.py |
...
| `INNER_PRODUCT_SETUP` | 3 | `INNER_PRODUCT_SETUP\|interval=[0,2pi]\|f=sin(49x)\|g=sin(4x)` | function_inner_product_generator.py |
| `INSERT_KEY` | 3 | `INSERT_KEY\|pass 1\|11\|index 1` | algorithm_trace_generator.py |
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 1\|10, 11, 3, 34, 1` | algorithm_trace_generator.py |
| `INTEGRAL` | 1, 2 | `INTEGRAL\|integral cos(45x) on [0,2pi]\|0` | fourier_series_generator.py, function_inner_product_generator.py, legendre_construction_generator.py |
| `INTEGRAL_SETUP` | 1 | `INTEGRAL_SETUP\|L = integral from 0 to 3pi/4 of 4 dtheta` | metric_arc_length_generator.py |
| `INTEGRATE` | 2 | `INTEGRATE\|v_y = u_x\|v=-4xy - x + 3y + phi(x)` | cauchy_riemann_generator.py |
...
| `INTERFERENCE_SETUP` | 3 | `INTERFERENCE_SETUP\|double_slit\|m=5, lambda=16\|L=2, d=2` | interference_generator.py |
| `INTERP_SETUP` | 3 | `INTERP_SETUP\|newton\|points=(-2,-8), (-1,-3), (0,-4)\|x=-5` | interpolation_generator.py |
| `INTERVAL_CLASS` | 2 | `INTERVAL_CLASS\|s2=72\|timelike` | minkowski_interval_generator.py |
...
| `IRR_SETUP` | 2 | `IRR_SETUP\|c0=-900,c1=1080\|r0=1/5,iterations=2` | npv_irr_generator.py |
...
| `JOINT_SETUP` | 3 | `JOINT_SETUP\|X,Y in {0,1}\|p00=459/2209, p01=810/2209\|p10=810/2209, p11=130/2209` | joint_distribution_generator.py |
...
| `KERNEL_SETUP` | 3 | `KERNEL_SETUP\|type=rbf\|points=A=(0,-2), B=(-3,-1)\|gamma=2` | kernel_evaluation_generator.py |
...
| `KL_SETUP` | 3 | `KL_SETUP\|P=[256/273,17/273]\|Q=[1/273,272/273]\|direction=P to Q` | kl_divergence_generator.py |
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|0110, 0111\|NOT A AND B AND C` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|AB=00\|1, 0, 0, 1` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows AB=00,AB=01,AB=11,AB=10\|columns CD=00,CD=01,CD=11,CD=10` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|(NOT A AND B AND C) OR (NOT A AND NOT B AND NOT D) OR (A AND NOT B AND D)` | boolean_algebra_generator.py |
| `KMEANS_SETUP` | 2 | `KMEANS_SETUP\|points=P1=(-3,-4), P2=(4,-1), P3=(3,4), P4=(-5,0)\|centroids=C1=(1,-5), C2=(-5,0)` | kmeans_step_generator.py |
| `KNN_DISTANCE` | 3 | `KNN_DISTANCE\|P1\|label=B\|d2=40` | knn_generator.py |
| `KNN_NEIGHBORS` | 1 | `KNN_NEIGHBORS\|P5:26:A,P1:40:B,P2:81:B` | knn_generator.py |
| `KNN_SETUP` | 3 | `KNN_SETUP\|q=(-3,5)\|k=3\|training=P1=(3,3,B), P2=(-3,-4,B), P3=(5,-4,A), P4=(-1,-4,A), P5=(-2,0,A)` | knn_generator.py |
| `KNN_SORT` | 1 | `KNN_SORT\|P5:26:A,P1:40:B,P2:81:B,P4:85:A,P3:145:A` | knn_generator.py |
| `KP_EXAMPLE` | 3 | `KP_EXAMPLE\|1\|x=-5,y=-1\|alpha=(0,0,0)` | kernel_perceptron_generator.py |
| `KP_SETUP` | 3 | `KP_SETUP\|kernel=linear\|data=[(-5,-1), (-1,1), (-7,1)]\|alpha0=(0,0,0)` | kernel_perceptron_generator.py |
...
| `KRAFT_SETUP` | 2 | `KRAFT_SETUP\|A=2, B=5, C=2, D=5\|binary prefix code` | kraft_inequality_generator.py |
| `KRAFT_TERM` | 3 | `KRAFT_TERM\|A\|l=2\|1/4` | kraft_inequality_generator.py |
| `KRR_SETUP` | 3 | `KRR_SETUP\|kernel=linear\|data=[(-6,1), (3,-3)]\|lambda=3,x*=4` | kernel_ridge_generator.py |
| `KV_CACHE` | 2 | `KV_CACHE\|values\|134217728` | flops_memory_generator.py |
...
| `LADDER_APPLY` | 2 | `LADDER_APPLY\|adag ket4\|sqrt(5) ket5` | ladder_operator_generator.py |
...
| `LADDER_SETUP` | 3 | `LADDER_SETUP\|single_step_energy\|state=ket4\|hbar=1, omega=8` | ladder_operator_generator.py |
| `LAGRANGE_EQ` | 2 | `LAGRANGE_EQ\|f_x = lambda\|y^2` | lagrange_multiplier_generator.py |
| `LAGRANGE_FACTOR` | 3 | `LAGRANGE_FACTOR\|L_0\|j=1\|4/5` | interpolation_generator.py |
...
| `LAG_SETUP` | 3 | `LAG_SETUP\|pendulum\|m=7, L=1\|g=10, q=theta` | lagrangian_generator.py |
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|(((lambda p. (q p)) q) g)\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LAURENT_SETUP` | 3 | `LAURENT_SETUP\|center a=1\|w=(z-1)\|f=(-5 + 2(z-1) + (z-1)^2 - (z-1)^3 - 2(z-1)^4 + 4(z-1)^5 - 5(z-1)^6)/(z-1)^2` | laurent_series_generator.py |
...
| `LAYERNORM_SETUP` | 3 | `LAYERNORM_SETUP\|x=(0,6)\|gamma=(3,3)\|beta=(-4,1)` | layer_norm_generator.py |
...
| `LEGENDRE_SETUP` | 2 | `LEGENDRE_SETUP\|a=19\|p=41` | legendre_construction_generator.py, quadratic_residue_generator.py |
| `LIE_EXP_FORM` | 2 | `LIE_EXP_FORM\|e^(theta J)\|cos(theta)I + sin(theta)J` | lie_exponential_generator.py |
| `LIE_EXP_SETUP` | 4 | `LIE_EXP_SETUP\|SO3\|axis=z\|theta=210 deg\|K=[[0, -1, 0], [1, 0, 0], [0, 0, 0]]` | lie_exponential_generator.py |
| `LIMITING_REAGENT` | 2 | `LIMITING_REAGENT\|O2\|H2O=14 mol` | stoichiometry_generator.py |
| `LIMIT_CHECK` | 2 | `LIMIT_CHECK\|H2O from H2=25 mol\|H2O from O2=14 mol` | stoichiometry_generator.py |
...
| `LINEAR_SYSTEM` | 2 | `LINEAR_SYSTEM\|a=7/9, b=-2/9\|c=-2/9, d=2/3` | markov_chain_generator.py |
| `LINE_EQ` | 1 | `LINE_EQ\|-14x + 4y + 11 = 0` | complex_locus_generator.py |
...
| `LLL_DONE` | 1 | `LLL_DONE\|[(-4,0),(1,7)]` | lll_reduction_generator.py |
| `LLL_SETUP` | 1 | `LLL_SETUP\|[(-10,14),(7,-7)]` | lll_reduction_generator.py |
| `LOCUS_SETUP` | 3 | `LOCUS_SETUP\|z=x+iy\|center=(1,-6)\|radius=9` | complex_locus_generator.py |
...
| `LOG_EVAL` | 2 | `LOG_EVAL\|26/9\|ln(26/9)` | hyperbolic_distance_generator.py |
...
| `LOG_LIKELIHOOD` | 1 | `LOG_LIKELIHOOD\|ell(lambda)=4*log(lambda)-28*lambda` | mle_generator.py |
...
| `LOG_SOFTMAX` | 2 | `LOG_SOFTMAX\|1\|ln(2/9)` | softmax_gradient_generator.py |
...
| `LORA_COUNT` | 2 | `LORA_COUNT\|r*(d_in+d_out)\|91520` | param_count_generator.py |
| `LOWRANK_SETUP` | 2 | `LOWRANK_SETUP\|A=[[4,0], [0,1]]\|rank=1` | low_rank_approx_generator.py |
| `LP_CORNER_SETUP` | 3 | `LP_CORNER_SETUP\|max z=9x+2y\|0<=x<=23, 0<=y<=9\|x+y<=29` | lp_corner_generator.py |
| `LR_PHASE` | 1 | `LR_PHASE\|decay` | lr_schedule_generator.py |
| `LR_SETUP` | 3 | `LR_SETUP\|base=3/100\|min=3/1000\|warmup=10,total=210,t=110` | lr_schedule_generator.py |
...
| `LZ_SETUP` | 2 | `LZ_SETUP\|LZ77 decode\|(0,0,t), (0,0,y), (1,1,y), (3,3,$)` | lz_compression_generator.py |
...
| `MAG_SETUP` | 3 | `MAG_SETUP\|force\|q=4, v=27\|B=7, sin=7/25` | magnetism_generator.py |
...
| `MARKOV_SETUP` | 2, 3 | `MARKOV_SETUP\|two_state\|P00=1/3, P01=2/3\|P10=2/7, P11=5/7` | entropy_rate_markov_generator.py, markov_chain_generator.py |
...
| `MATRIX_GROUP_SETUP` | 2 | `MATRIX_GROUP_SETUP\|GL2Z\|M=[[12,11],[-3,10]]` | matrix_group_check_generator.py |
| `MATRIX_MULT` | 2, 3 | `MATRIX_MULT\|row1 dot col1\|1437601/36012001*1437601/36012001+7050120/36012001*7050120/36012001\|1437601/36012001` | projector_generator.py |
...
| `MATRIX_SCALE` | 2 | `MATRIX_SCALE\|1/2 ladder sum\|[[1444/81, 0, 0], [0, 2888/81, 0], [0, 0, 1444/81]]` | bch_generator.py, casimir_generator.py |
| `MATRIX_SETUP` | 2 | `MATRIX_SETUP\|hermitian\|A=[[-14,6],[6,-14]]` | hermitian_check_generator.py |
...
| `MATRIX_VALUE` | 2 | `MATRIX_VALUE\|A\|[[0, -5i], [5i, 0]]` | pauli_algebra_generator.py, structure_constant_generator.py |
...
| `MC_SETUP` | 3 | `MC_SETUP\|expression=x^T A x\|A=[[4,1], [-4,-4]]\|x=(-5,4)` | matrix_calculus_generator.py |
...
| `MEMORY_SETUP` | 3 | `MEMORY_SETUP\|kv_cache\|L=32,h=8,d_k=128\|seq=2048,precision_bytes=4` | flops_memory_generator.py |
| `MEMORY_UNIT` | 2 | `MEMORY_UNIT\|MiB\|512` | flops_memory_generator.py |
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=0,mid=1,hi=2\|left 4; right 45` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|4\|45\|take left` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 0-1\|array 4, 45, 31, 12, 14` | algorithm_trace_generator.py |
| `MERGE_TAKE` | 2 | `MERGE_TAKE\|4\|merged 4` | algorithm_trace_generator.py |
| `METRIC` | 2 | `METRIC\|Chebyshev\|d = max(abs(x2 - x1), abs(y2 - y1))` | taxicab_geometry_generator.py |
| `METRICS_SETUP` | 1 | `METRICS_SETUP\|TP=12, FP=22, FN=23, TN=14` | classifier_metrics_generator.py |
| `METRIC_ARC_SETUP` | 3 | `METRIC_ARC_SETUP\|polar metric\|ds^2=dr^2+r^2 dtheta^2\|r=4, theta:0->3pi/4` | metric_arc_length_generator.py |
...
| `MGF_SETUP` | 3 | `MGF_SETUP\|P(X=0)=6/17\|P(X=1)=6/17\|P(X=2)=5/17` | mgf_generator.py |
| `MGF_TERM` | 3 | `MGF_TERM\|x=0\|p0*e^(0t)\|6/17` | mgf_generator.py |
...
| `MINKOWSKI_SETUP` | 3 | `MINKOWSKI_SETUP\|interval_classification\|ct=19\|x=17` | minkowski_interval_generator.py |
| `MINTERM` | 2 | `MINTERM\|0001\|NOT K AND NOT L AND NOT M AND N` | boolean_algebra_generator.py |
...
| `MI_SETUP` | 2 | `MI_SETUP\|rows=[[0,1/4,1/4,0];[1/4,0,0,1/4]]\|task=H(X,Y), H(Y given X), and I(X;Y)` | mutual_information_generator.py |
| `MLE_SETUP` | 2, 3 | `MLE_SETUP\|exponential\|parameter=lambda\|data=[6,8,12,2]` | mle_generator.py |
| `MOBIUS_SETUP` | 2 | `MOBIUS_SETUP\|T(z)=(z - 4)/(4)\|z0=-4` | mobius_transform_generator.py |
...
| `MODEL_OUTPUT` | 1 | `MODEL_OUTPUT\|9/2` | activation_generator.py |
| `MODEXP_MULTIPLY` | 2 | `MODEXP_MULTIPLY\|bit 1=1\|35` | mod_exp_generator.py, quadratic_residue_generator.py |
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 35\|exponent 39\|modulus 51` | mod_exp_generator.py |
| `MODEXP_SQUARE` | 2 | `MODEXP_SQUARE\|bit 1=1\|1` | mod_exp_generator.py, quadratic_residue_generator.py |
| `MODEXP_STATE` | 2 | `MODEXP_STATE\|after bit 1\|35` | mod_exp_generator.py, quadratic_residue_generator.py |
...
| `MOD_POWER` | 3 | `MOD_POWER\|47^2\|mod 30\|19` | diffie_hellman_generator.py, pollard_factorization_generator.py, primality_test_generator.py, rsa_generator.py, tonelli_shanks_generator.py, totient_generator.py |
...
| `MOM_SETUP` | 3 | `MOM_SETUP\|uniform_zero_theta\|parameter=theta\|data=[19,15,7,7,1,9]` | method_of_moments_generator.py |
...
| `MR_SETUP` | 2 | `MR_SETUP\|n=95\|witnesses 2, 17` | primality_test_generator.py |
...
| `MSE_GRADIENT` | 2 | `MSE_GRADIENT\|g0=-8\|g1=28` | gradient_step_generator.py |
| `MSE_SAMPLE` | 3 | `MSE_SAMPLE\|i=1\|pred=-4\|r=1` | gradient_step_generator.py |
| `MSE_SETUP` | 3 | `MSE_SETUP\|model y_hat=w0+w1*x\|samples=[(1,-5), (-3,9)]\|w=(-3,-1), eta=1/3` | gradient_step_generator.py |
...
| `MU` | 2 | `MU\|-21/37\|round=-1` | lll_reduction_generator.py |
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(3x)y' + 3e^(3x)y\|28e^(7x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `MULTIVALUED_LOG` | 2 | `MULTIVALUED_LOG\|ln(11/10) + i*(-59pi/180 + 2pi*k)\|k in Z` | complex_log_generator.py |
...
| `NATURAL_SETUP` | 3 | `NATURAL_SETUP\|time\|hbar=1,c=1\|t=37/24 TeV^-1` | natural_units_generator.py |
| `NB_FEATURE_COUNT` | 3 | `NB_FEATURE_COUNT\|Spam\|known=0\|count=13` | naive_bayes_generator.py |
| `NB_LIKELIHOOD` | 3 | `NB_LIKELIHOOD\|Spam\|known=0\|2/3` | naive_bayes_generator.py |
| `NB_PRIOR` | 2 | `NB_PRIOR\|Spam\|19/29` | naive_bayes_generator.py |
| `NB_SCORE` | 2 | `NB_SCORE\|Spam\|start=19/29` | naive_bayes_generator.py |
| `NB_SETUP` | 3 | `NB_SETUP\|query=known=0, offer=0, urgent=1\|alpha=1\|classes=Spam,Ham` | naive_bayes_generator.py |
...
| `NEAREST` | 2 | `NEAREST\|queen\|(-9,-1)` | embedding_similarity_generator.py |
...
| `NEWTON_SETUP` | 2, 3 | `NEWTON_SETUP\|f(x)=x^2-51\|f'(x)=2x\|x0=8,iterations=2` | newton_raphson_generator.py, newtons_laws_generator.py |
...
| `NFA_ACTIVE` | 2 | `NFA_ACTIVE\|start\|{q6}` | nfa_simulation_generator.py |
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|s0\|{s2}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|aba` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{q6}\|a\|q6->{q6,q7}\|{q6,q7}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|a` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states q6, q7, q8\|alphabet a, b\|start q6` | nfa_simulation_generator.py |
| `NFA_TRANSITION` | 3 | `NFA_TRANSITION\|q6\|a\|{q6,q7}` | nfa_simulation_generator.py |
| `NILPOTENT` | 3 | `NILPOTENT\|theta^2=0\|16theta^2\|0` | grassmann_generator.py |
| `NLL` | 2 | `NLL\|179 tokens\|179*ln(4)` | perplexity_generator.py |
...
| `NORMALIZE_SIGN` | 2 | `NORMALIZE_SIGN\|(-3,-10)\|(3,10)` | lll_reduction_generator.py |
...
| `NO_REDEX` | 2 | `NO_REDEX\|((q q) g)\|no beta redex remains` | lambda_reduction_generator.py |
| `NPV_SETUP` | 2 | `NPV_SETUP\|c0=-800,c1=200,c2=350,c3=1500\|rate=20%` | npv_irr_generator.py |
...
| `NW_ALLOC` | 1, 3 | `NW_ALLOC\|cell x11\|min(23,10)\|10` | transportation_generator.py |
...
| `OPTICS_SETUP` | 3 | `OPTICS_SETUP\|snell\|n1=2, n2=9\|sin(theta1)=4/9` | optics_generator.py |
...
| `ORBIT_SETUP` | 3 | `ORBIT_SETUP\|kepler_third\|T1=32, a1=2\|a2=32` | orbital_mechanics_generator.py |
...
| `ORDER_SETUP` | 3 | `ORDER_SETUP\|n=7\|k=6\|q=2/5` | order_statistics_generator.py |
...
| `OR_SETUP` | 3 | `OR_SETUP\|M/M/1\|lambda=15\|mu=24` | or_formula_generator.py |
...
| `OUTER_PRODUCT` | 1 | `OUTER_PRODUCT\|rho=1/2(ket00bra00+e^(-i351π/272)ket00bra11+e^(i351π/272)ket11bra00+ket11bra11)` | partial_trace_generator.py |
| `OUTPUT` | 1 | `OUTPUT\|y_hat=-20` | backprop_generator.py |
...
| `PARAMS` | 3 | `PARAMS\|W1=[[-2,-2], [2,1]]\|b1=(-1,0)\|v=(1,-2), c=-2` | backprop_generator.py |
...
| `PARTICLE_TABLE` | 1 | `PARTICLE_TABLE\|p(Q=1,B=1,Le=0,Lmu=0); anti_p(Q=-1,B=-1,Le=0,Lmu=0); pi0(Q=0,B=0,Le=0,Lmu=0); pi+(Q=1,B=0,Le=0,Lmu=0)` | conservation_law_generator.py |
...
| `PARTITION_SETUP` | 3 | `PARTITION_SETUP\|degenerate_two_level\|g0=4, g1=1\|epsilon=1, b=1/6` | partition_function_generator.py |
...
| `PAULI_IDENTITY` | 3 | `PAULI_IDENTITY\|Tr(sigma_z sigma_z)\|2 delta_ij\|24` | pauli_algebra_generator.py |
| `PAULI_MATRIX` | 2 | `PAULI_MATRIX\|sigma_z\|[[1,0],[0,-1]]` | spin_half_generator.py |
| `PAULI_SETUP` | 3 | `PAULI_SETUP\|trace\|A=4sigma_z\|B=3sigma_z` | pauli_algebra_generator.py |
| `PCA_SETUP` | 2 | `PCA_SETUP\|points=[(6,0), (2,0), (4,4), (4,-4)]\|population covariance` | pca_generator.py |
...
| `PDE_SETUP` | 2 | `PDE_SETUP\|u_t = 9u_xx on [0,12]\|u(x,0)=4sin(6πx/12)` | separable_pde_generator.py |
...
| `PERCEPTRON_SETUP` | 3 | `PERCEPTRON_SETUP\|eta=1\|w=(-1,1,1)\|samples=[(1,2,-1), (0,2,-1), (3,1,-1), (-2,1,1)]` | perceptron_generator.py |
| `PERCEPTRON_UPDATE` | 2, 3 | `PERCEPTRON_UPDATE\|i=1\|w=(-2,0,-1)` | perceptron_generator.py |
...
| `PERM_RESULT` | 1 | `PERM_RESULT\|[3, 1, 4, 2]` | permutation_group_generator.py |
...
| `PERPLEXITY_SETUP` | 2 | `PERPLEXITY_SETUP\|tokens=179\|p=1/4` | perplexity_generator.py |
| `PE_ENTRY` | 2 | `PE_ENTRY\|0\|sqrt(2)/2` | positional_encoding_generator.py |
| `PE_SETUP` | 3 | `PE_SETUP\|position=135\|d=2\|theta=3pi/4` | positional_encoding_generator.py |
...
| `PH_SETUP` | 2, 3 | `PH_SETUP\|hydronium_power\|[H+]=10^-1` | ph_calculation_generator.py |
| `PI2_NUM` | 3 | `PI2_NUM\|-1/9604\|π^2\|-π^2/9604` | casimir_force_generator.py |
...
| `PI_DEN` | 3 | `PI_DEN\|1/1716\|π\|1/(1716π)` | gauss_law_generator.py, hawking_generator.py, magnetism_generator.py |
...
| `PLANCK_SETUP` | 4 | `PLANCK_SETUP\|length\|hbar=4\|G=64\|c=4` | planck_units_generator.py |
...
| `POLAR_FORM` | 1 | `POLAR_FORM\|4sqrt2 cis(225 deg)` | euler_formula_generator.py |
...
| `POLE_TEST` | 3 | `POLE_TEST\|pole -1\|abs(-1) < 4\|inside` | contour_integral_generator.py |
...
| `POLLARD_RHO_SETUP` | 3 | `POLLARD_RHO_SETUP\|n=91\|c=2\|x0=6` | pollard_factorization_generator.py |
...
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|4x^2 + x + 2` | finite_field_generator.py |
...
| `PORT_RESULT` | 2 | `PORT_RESULT\|expected_return=0.124\|variance=0.0252` | portfolio_generator.py |
| `PORT_SETUP` | 3 | `PORT_SETUP\|wA=0.4,wB=0.6\|rA=10%,rB=14%\|varA=0.09,varB=0.09,cov=-0.045` | portfolio_generator.py |
...
| `POWER_REDUCE` | 2 | `POWER_REDUCE\|47^122\|47^2 mod 30` | totient_generator.py |
...
| `POWER_SETUP` | 2 | `POWER_SETUP\|cis(73 deg)^(5i)\|principal logarithm` | complex_log_generator.py |
...
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited A\|AD=2, AB=3, AC=6, AE=16` | mst_generator.py |
| `PRIM_START` | 1 | `PRIM_START\|A` | mst_generator.py |
| `PRINCIPAL_LOG` | 1 | `PRINCIPAL_LOG\|ln(11/10) - i*59pi/180` | complex_log_generator.py |
...
| `PROJECTILE_SETUP` | 3 | `PROJECTILE_SETUP\|vx=54\|vy=53\|g=10` | projectile_motion_generator.py |
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[4, 6, 8, 10]` | least_squares_generator.py, legendre_construction_generator.py |
| `PROJECTOR_SETUP` | 2 | `PROJECTOR_SETUP\|v=(1199/6001, 5880/6001)\|P=vv^T=[[1437601/36012001,7050120/36012001],[7050120/36012001,34574400/36012001]]` | projector_generator.py |
...
| `PSD_SETUP` | 2 | `PSD_SETUP\|K=[[4,13], [13,7]]\|criterion=all principal minors >= 0` | kernel_validity_generator.py |
| `PURITY` | 1 | `PURITY\|Tr(rho^2)=197/225` | density_matrix_generator.py |
...
| `QUADRATIC` | 3 | `QUADRATIC\|1\|0\|-16` | mobius_transform_generator.py |
| `QUANTUM_FORMULA` | 1 | `QUANTUM_FORMULA\|Delta_lambda=h/(m*c)*(1-cos(theta))` | quantum_formula_generator.py |
| `QUANTUM_SETUP` | 2, 3 | `QUANTUM_SETUP\|gate=CNOT\|input=e^(i78π/41)·ket10` | quantum_formula_generator.py, quantum_gate_generator.py |
| `QUANT_SETUP` | 3 | `QUANT_SETUP\|x=(-89/50,-18/25,21/25)\|scale=1/25\|zero_point=10` | quantization_generator.py |
| `QUANT_VALUE` | 2 | `QUANT_VALUE\|1\|-34` | quantization_generator.py |
| `QUARK_CHARGE` | 2 | `QUARK_CHARGE\|d\|-1/3` | quark_composition_generator.py |
| `QUARK_SETUP` | 3 | `QUARK_SETUP\|baryon,count=236\|d c u\|u=2/3,d=-1/3,s=-1/3,c=2/3,b=-1/3; anti=-charge` | quark_composition_generator.py |
...
| `QUAT_INVERSE` | 2 | `QUAT_INVERSE\|p\|(-3/14,0,1/14,-1/7)` | quaternion_generator.py |
| `QUAT_MUL_START` | 3 | `QUAT_MUL_START\|p*q\|p\|q` | quaternion_generator.py |
| `QUAT_RESULT` | 2 | `QUAT_RESULT\|p*q\|(-3,8,3,4)` | quaternion_generator.py |
| `QUAT_SETUP` | 2 | `QUAT_SETUP\|p=(-3,0,-1,2)\|q=(1,-1,-2,-1)` | quaternion_generator.py |
...
| `RECT_FORM` | 1 | `RECT_FORM\|26i` | de_moivre_generator.py, euler_formula_generator.py |
...
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q18579_2` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|(a or b)*ab(a or b)*\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q18579_0\|no useful suffix` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q18579_0\|a\|q18579_1` | regex_to_automaton_generator.py |
...
| `RELU` | 3 | `RELU\|z=-13\|h=0\|deriv=0` | backprop_generator.py |
| `REL_ENERGY_FORMULA` | 1 | `REL_ENERGY_FORMULA\|E=sqrt(p^2+m^2)` | relativistic_energy_generator.py |
| `REL_ENERGY_SETUP` | 3 | `REL_ENERGY_SETUP\|energy_momentum\|c=1\|p=75, m=40` | relativistic_energy_generator.py |
...
| `RESIDUE_SETUP` | 2 | `RESIDUE_SETUP\|a=-5\|f=(4 - 7(z+5) - 3(z+5)^2 - 4(z+5)^3)/(z+5)^2` | residue_generator.py |
...
| `RESOLVE` | 3 | `RESOLVE\|C1\|C3\|not P93718` | resolution_proof_generator.py |
...
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(not P93718), C2=(not P70515), C3=(P70515 OR P93718), C4=(P13473 OR P63051 OR P81821)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C3\|(P70515)` | resolution_proof_generator.py |
...
| `RG_SETUP` | 3 | `RG_SETUP\|one_loop\|alpha0=1/15\|beta=5/3,L=3/2` | running_coupling_generator.py |
| `RHO_ITER` | 4 | `RHO_ITER\|1\|x=38, y=81\|abs(r)=43\|gcd=1` | pollard_factorization_generator.py |
...
| `RIEMANN_ENTRY` | 2 | `RIEMANN_ENTRY\|R^phi_theta phi theta\|1521/7921` | riemann_tensor_generator.py |
...
| `RK_COMBINE` | 2 | `RK_COMBINE\|k1+2k2+2k3+k4\|6079/125` | runge_kutta_generator.py |
| `RK_STAGE` | 3 | `RK_STAGE\|k1\|t=-5/2\|N=5/2` | runge_kutta_generator.py |
...
| `ROT_SETUP` | 3 | `ROT_SETUP\|parallel_axis\|I_cm=63, m=22\|d=4` | rotational_dynamics_generator.py |
| `ROUND` | 2 | `ROUND\|-69/2\|-34` | quantization_generator.py |
...
| `ROUTH_SETUP` | 1 | `ROUTH_SETUP\|p(s)=s^3+32s^2+21s+16` | routh_hurwitz_generator.py |
...
| `RSA_DECRYPT` | 2 | `RSA_DECRYPT\|82\|199` | rsa_generator.py |
| `RSA_ENCRYPT` | 2 | `RSA_ENCRYPT\|199\|82` | rsa_generator.py |
| `RSA_PRIVATE_KEY` | 1 | `RSA_PRIVATE_KEY\|d=133` | rsa_generator.py |
| `RSA_PUBLIC_KEY` | 2 | `RSA_PUBLIC_KEY\|n=247\|e=13` | rsa_generator.py |
...
| `RS_CORRECT` | 2 | `RS_CORRECT\|position=2\|[59,43,160,37]` | reed_solomon_generator.py |
| `RS_EVAL` | 2 | `RS_EVAL\|x=14\|119` | reed_solomon_generator.py |
| `RS_LINE` | 3 | `RS_LINE\|m0=77\|m1=11\|agree=2` | reed_solomon_generator.py |
| `RS_PAIR` | 2 | `RS_PAIR\|x=28,47\|y=59,105` | reed_solomon_generator.py |
| `RS_RECEIVED` | 1 | `RS_RECEIVED\|[59,105,160,37]` | reed_solomon_generator.py |
| `RS_SETUP` | 3 | `RS_SETUP\|F_137\|m(x)=93+41x\|points 14,102,117,119` | reed_solomon_generator.py |
...
| `SAMPLE_MOMENT` | 2 | `SAMPLE_MOMENT\|xbar\|29/3` | method_of_moments_generator.py |
...
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|26*cos\|0` | de_moivre_generator.py, euler_formula_generator.py |
...
| `SCALING_COMPUTE` | 2 | `SCALING_COMPUTE\|6ND\|9072000000000000000` | scaling_law_generator.py |
| `SCALING_SETUP` | 3 | `SCALING_SETUP\|N=27000000\|D=56000000000\|F=93000000000000000` | scaling_law_generator.py |
| `SCAN` | 2 | `SCAN\|(\|parenthesis depth 1` | wff_parsing_generator.py |
| `SCHWARZSCHILD_SETUP` | 3, 4 | `SCHWARZSCHILD_SETUP\|radius\|G=1\|M=36\|c=2` | schwarzschild_generator.py |
...
| `SCORE_EQ` | 1 | `SCORE_EQ\|4/lambda=28` | mle_generator.py |
...
| `SIMPLEX_SETUP` | 3 | `SIMPLEX_SETUP\|max z=13x+12y\|x<=4\|y<=19` | simplex_generator.py |
...
| `SIZE_REDUCE` | 2 | `SIZE_REDUCE\|b2=(7, -7)\|b2-(-1)b1=(-3, 7)` | lll_reduction_generator.py |
...
| `SOFTMAX_PROB` | 2 | `SOFTMAX_PROB\|1\|2/9` | softmax_gradient_generator.py |
| `SOFTMAX_SETUP` | 3 | `SOFTMAX_SETUP\|z=(2*ln(4),2*ln(9),2*ln(5))\|T=2\|target=1` | softmax_gradient_generator.py |
...
| `SOLUTION_SETUP` | 3 | `SOLUTION_SETUP\|mixing_molarity\|Ma=3, Va=189\|Mb=1, Vb=114` | solution_chem_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|AC=1, BC=3, AD=5, AB=8, BD=11` | mst_generator.py |
...
| `SPHERICAL_EXCESS_SETUP` | 2 | `SPHERICAL_EXCESS_SETUP\|R=4\|angles=75,45,120` | spherical_excess_generator.py |
...
| `SPIN_COMPONENT` | 2 | `SPIN_COMPONENT\|row=1\|60/61` | spin_half_generator.py |
...
| `SPLIT_SETUP` | 3 | `SPLIT_SETUP\|shape\|left pos=1, neg=7\|right pos=5, neg=3` | information_gain_generator.py |
...
| `STANDING_SETUP` | 3 | `STANDING_SETUP\|closed_pipe\|k=3\|L=12, v=128` | standing_wave_generator.py |
...
| `STATICS_SETUP` | 3 | `STATICS_SETUP\|supported_beam\|W=126, L=5\|x=4` | statics_generator.py |
...
| `STRUCTURE_SETUP` | 3 | `STRUCTURE_SETUP\|A=10Jy\|B=-18Jx\|epsilon_yxz=-1` | structure_constant_generator.py |
...
| `SUBGROUP` | 2 | `SUBGROUP\|H={0, 12, 24, 9, 21, 6, 18, 3, 15}\|size 9` | coset_generator.py |
...
| `SUBSTITUTE` | 2 | `SUBSTITUTE\|p:=q in (q p)\|(q q)` | lambda_reduction_generator.py |
...
| `SUPPORT` | 2 | `SUPPORT\|0<=u+v<=14\|0<=u-v<=14` | rv_transform_generator.py |
| `SUPPORT_TERM` | 2 | `SUPPORT_TERM\|1\|(-24,0)` | svm_margin_generator.py |
| `SVM_SETUP` | 3 | `SVM_SETUP\|x1=(-24,0),y1=1,alpha1=1\|x2=(0,-7),y2=-1,alpha2=1\|b=2,x=(-3,1)` | svm_margin_generator.py |
| `SWAP` | 2 | `SWAP\|norm b2=58\|norm b1=296` | lll_reduction_generator.py |
...
| `TABLEAU` | 2, 3 | `TABLEAU\|initial\|s1: x + s1 = 4\|s2: y + s2 = 19` | simplex_generator.py |
...
| `TENSOR_SETUP` | 3 | `TENSOR_SETUP\|A=diag(0,4)\|B=diag(4,5)\|u=[2,2], v=[2,1]` | tensor_product_generator.py |
| `TENSOR_STATE` | 2 | `TENSOR_STATE\|u tensor v\|[4,2,4,2]` | tensor_product_generator.py |
| `TERM` | 2 | `TERM\|i=0: 1·(2/5)^0·(3/5)^4\|0.1296` | binomial_probability_generator.py |
| `TERMS` | 1 | `TERMS\|x[0..3]=[6,36,216,1296]` | z_transform_generator.py |
...
| `TF_SETUP` | 3 | `TF_SETUP\|block_feedback\|G1=9/(s+3), G2=1/(s+9)\|H=1` | transfer_function_generator.py |
...
| `THETA` | 2 | `THETA\|min(7,10)\|7` | transportation_generator.py |
| `THROUGHPUT` | 2 | `THROUGHPUT\|tokens_per_second\|15500000000/27` | scaling_law_generator.py |
...
| `TIME_EVOLVE` | 2 | `TIME_EVOLVE\|U psi\|[1-2i,2-i,1+i]` | braket_generator.py |
...
| `TRACE_SUM` | 2 | `TRACE_SUM\|-i + 0 + i\|0` | pauli_algebra_generator.py |
| `TRANSFER` | 1 | `TRANSFER\|G(s)=9/(s^2+12s+27)` | transfer_function_generator.py |
...
| `TRANSIENT_SETUP` | 3 | `TRANSIENT_SETUP\|rl_rise\|R=5, L=25\|V=34, t=10` | transient_circuit_generator.py |
...
| `TRANSPORT_SETUP` | 3 | `TRANSPORT_SETUP\|supply=(23,7)\|demand=(10,20)\|costs=(14,9;4,9)` | transportation_generator.py |
...
| `WAVE_SETUP` | 3 | `WAVE_SETUP\|power_interval\|psi=N*(x/L)^10\|0<=x<=40` | wavefunction_generator.py |
...
| `WIDTH_SETUP` | 3 | `WIDTH_SETUP\|branching_ratio\|Gamma_a=6, Gamma_b=10, Gamma_c=14\|target=BR_b` | branching_ratio_generator.py |
| `WITNESS` | 3 | `WITNESS\|n=70171\|a=17539\|b=3` | induction_verify_generator.py |
...
| `YOUNG_SETUP` | 3 | `YOUNG_SETUP\|partition=[9,1,1]\|n=11\|group=S_11` | young_tableaux_generator.py |
...
| `ZT_SETUP` | 2, 3 | `ZT_SETUP\|geometric\|x[n]=6*6^n u[n]` | z_transform_generator.py |
