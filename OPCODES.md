...
2024 distinct op-codes observed.
...
| `DEC_TO_PERCENT` | 2 | `DEC_TO_PERCENT\|0.8\|80%` | fraction_decimal_percent_converter.py, mixture_generator.py, percent_chain_generator.py, percent_problem_generator.py, risk_communication_generator.py, simple_probability_generator.py, standard_deviation_generator.py, tip_bill_split_generator.py |
...
| `PCT_CHANGE` | 2 | `PCT_CHANGE\|(29 − 25)/25\|16%` | risk_communication_generator.py |
...
| `PP_CHANGE` | 2 | `PP_CHANGE\|29 − 25\|4 points` | risk_communication_generator.py |
