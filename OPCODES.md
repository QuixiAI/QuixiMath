...
1736 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|5x + 4 = 7` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|5x + 2 > 4 -> x > 2/5` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|abs(5x + 2) > 4` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for >=` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|5x + 2 > 4 or 5x + 2 < -4` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(5x + 4) = 7` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|5x + 4 = 7\|5x + 4 = -7` | absolute_value_equation_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|fair die; A = [3, 6], B = [2, 3, 5]\|P(A ∪ B)` | probability_addition_rule_generator.py |
| `ADJOINT` | 1 | `ADJOINT\|U^dagger=[[60/109,91/109],[-91/109,60/109]]` | hermitian_check_generator.py |
| `ADJ_LIST` | 2 | `ADJ_LIST\|A\|B, F` | euler_circuit_generator.py, graph_traversal_generator.py |
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|-2 sin(2x)\|cos(2x)` | antiderivative_generator.py, arc_length_generator.py, area_between_curves_generator.py, definite_integral_generator.py, improper_integral_generator.py, integrating_factor_generator.py, integration_by_parts_generator.py, ode_substitution_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py, variation_parameters_generator.py |
...
| `APPROX_SETUP` | 2 | `APPROX_SETUP\|estimate √28\|linearize f(x) = √x at a = 25` | linear_approx_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 2, central angle 210°\|arc length` | arc_sector_generator.py |
...
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 + x - 5 and y = 10x - 23\|area between the curves` | area_between_curves_generator.py |
...
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = -1 ± (4/3)(x - 6)` | hyperbola_features_generator.py |
| `ATA` | 2 | `ATA\|A^T A\|[[80, 64], [64, 80]]` | svd_generator.py |
...
| `AV_VECTOR` | 2 | `AV_VECTOR\|A*v1\|[12/√2, 12/√2]` | svd_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 72, disease=no 104\|sensitivity 5/6, specificity 7/8\|P(disease=yes given test positive)` | conditional_probability_generator.py |
...
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 4, k = 1, p = 2/3\|P(X = k)` | binomial_probability_generator.py |
...
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables B, C, D, E\|DNF from F=1 rows` | boolean_algebra_generator.py |
...
| `CBRT` | 2 | `CBRT\|27p^6\|3p^2` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
...
| `CEIL` | 2 | `CEIL\|56.826525\|57` | confidence_interval_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*dx/dt + f_y*dy/dt\|(-6)*2 + (-13)*(-3)\|27` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(-2)\|2*(-2)\|-4` | multivar_chain_rule_generator.py |
| `CHANGE_BASE` | 1 | `CHANGE_BASE\|log_8(16) = log_2(16)/log_2(8)` | log_conversion_generator.py |
| `CHAR_DIAG` | 2 | `CHAR_DIAG\|diagonal of λI - A\|(λ + 4), (λ - 4), (λ - 3)` | eigenvalue_generator.py |
...
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^3 - 3λ^2 - 16λ + 48\|(λ + 4)*(λ - 3)*(λ - 4)` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 50, 51, 49; expected: 50 each\|goodness of fit; df = 2, critical value = 5.991` | chi_square_generator.py |
...
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|inscribed angle 63°\|central angle on the same arc` | circle_angle_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|8*6^2*pi\|288*pi` | vector_theorem_generator.py |
...
| `CMP` | 3 | `CMP\|44\|9\|>` | fraction_comparison_generator.py, graph_interpret_generator.py, integers_as_pairs_generator.py, logical_connective_eval_generator.py, set_builder_roster_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(L OR M OR N) AND (L OR NOT M OR N) AND (NOT L OR NOT M OR NOT N)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|-14160` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|3, 13, -1, -28` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[3, -4], [4, 0]]` | determinant_generator.py |
...
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2\|[[5, -2, -9], [-2, 1, 3]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(3,1)\|3` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = -9*v1 + 2*v2\|[2, -5]` | diagonalization_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|choose 7 of 10\|order does not matter` | counting_classics_generator.py, permutation_combination_generator.py, stars_and_bars_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|-14 - (-6)\|-8` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|500/250\|2` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMPARE` | 2, 3 | `COMPARE\|6 < 9\|log_b(a) < k` | algorithm_trace_generator.py, equilibrium_ice_generator.py, fixed_point_generator.py, master_theorem_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|4x + 7 < -21 -> x < -7` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|4 < 3x + 4 < 28` | compound_inequality_generator.py |
...
| `COND_COUNT` | 2 | `COND_COUNT\|club=no and commute=bike\|5` | conditional_probability_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 12, no/bike 5, yes/bus 23, no/bus 28\|P(club=no given commute=bike)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|commute=bike total\|12 + 5 = 17` | conditional_probability_generator.py |
...
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(x + 1)^2 = 16(y + 5)\|vertex, focus, directrix` | conic_standard_form_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
| `CONJ` | 2 | `CONJ\|phi_1=2-i\|2+i` | braket_generator.py |
| `CONJUGATE` | 2 | `CONJUGATE\|5 - i\|5 + i` | complex_division_generator.py, quaternion_generator.py |
...
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|3*x + y = 78\|lambda*(9/6 + 1/8) = 78\|lambda = 48` | lagrange_multiplier_generator.py |
| `CONST_SOLVE` | 2 | `CONST_SOLVE\|C1 = 5\|C2 = 2` | recurrence_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[-9, 2]` | diagonalization_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|2 boxes\|force 24 in one box` | counting_classics_generator.py |
...
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|-10*x + y - 11 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|(-10)*4 - 1^2\|-41` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=2\|ln(4)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|30·BC = 12·25` | similar_triangles_generator.py, triangle_solve_generator.py |
...
| `CURL_COMPONENT` | 3 | `CURL_COMPONENT\|i\|-1 - 1\|-2` | div_curl_generator.py |
...
| `CURVE_GEOM_SETUP` | 3 | `CURVE_GEOM_SETUP\|r(t) = <3*t + 3, -4*t - 4>\|0 <= t <= 9\|arc length` | curve_geometry_generator.py |
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 12x^2 + 45x - 2\|critical points and their nature` | curve_analysis_generator.py |
...
| `CX_SETUP` | 2 | `CX_SETUP\|(-7 + 8i) + (6 - 5i)\|add` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 4x^5 + 2x^3 + 6x + 3\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -3], [1, -1], [1, 1], [1, 3]]\|y = [-1, 7, 11, 11]` | least_squares_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[1, 5], [-1, -6]]\|D = [[3, 0], [0, 9]]\|P^-1 = [[6, 5], [-1, -1]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[-42, 12, 66]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 2*x^2 + 5*y^2 - 2*x*y - 5*x + 6*y\|point (0, 3)\|dx=-1/4, dy=1/2` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|(-11)*(-1/4) + 36*1/2\|20.75` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|64\|-3536\|3600` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-8x + 44 = -4` | systems_substitution_generator.py |
...
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited A\|A=0, B=4, C=2, D=inf, E=inf` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|-2x\|- 10x^3 + 8x^2 + 2x` | multiplying_polynomials_generator.py |
...
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y + R_z\|-4 + 2 + 3\|1` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|32t^5\|4t\|8t^4` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT B AND NOT C AND D AND E) OR (NOT B AND C AND NOT D AND E)` | boolean_algebra_generator.py |
...
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|radicand in a denominator: > 0\|-2t - 14 > 0` | domain_range_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(11, 9) · (5/13, 12/13)\|11*5/13 + 9*12/13\|163/13` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|AD\|weight 4\|add D` | mst_generator.py |
| `EDGE_CONSIDER` | 2 | `EDGE_CONSIDER\|CE\|weight 4` | mst_generator.py |
| `EDGE_COUNT` | 2 | `EDGE_COUNT\|m\|5` | euler_circuit_generator.py, graph_counting_generator.py |
| `EDGE_LIST` | 1 | `EDGE_LIST\|AC, AD, BD, BE` | euler_circuit_generator.py |
...
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 4I\|[[0, 3, -2], [0, 8, -2], [0, 0, 7]]` | eigenvalue_generator.py |
...
| `EQUILIBRIA` | 2 | `EQUILIBRIA\|f(y) = 0\|y=-5, y=-3, y=13` | stability_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(-9, 0)\|(-7, -10)` | equation_from_two_points_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|89860 × 47334 ≈ 90000 × 50000\|4500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1.1 × 10^4\|10752\|rounded estimate` | fermi_estimation_generator.py, long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|E\|route suffix E\|stack C-A-D-B` | euler_circuit_generator.py |
...
| `EULER_ROUTE` | 2 | `EULER_ROUTE\|C-A-D-B-E\|uses 4 edges` | euler_circuit_generator.py |
...
| `EV_SETUP` | 2 | `EV_SETUP\|P(win $10) = 3/10; P(win $12) = 1/10; P(win $8) = 3/5\|fair? cost = $3` | expected_value_generator.py |
...
| `EXP_CELL` | 2 | `EXP_CELL\|(40·80)/200\|16` | chi_square_generator.py |
| `EXP_DIAG` | 2 | `EXP_DIAG\|e^(Dt)\|[[e^(-3t), 0], [0, e^(-t)]]` | matrix_exponential_generator.py |
| `EXP_ENTRY` | 3 | `EXP_ENTRY\|(1,1)\|7*e^(-3t) - 6*e^(-t)\|7*e^(-3t) - 6*e^(-t)` | matrix_exponential_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-63 ÷ 7 = -9, not -7` | error_spotting_generator.py |
...
| `FLUX_SUM` | 2 | `FLUX_SUM\|(-1 + 2 - 1)*84\|0` | vector_theorem_generator.py |
...
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-4i) * 1\|-4i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(3 + √6)(6 + √6)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|8/18\|4/9` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|43/40\|1.075` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Dog: 11, Cat: 11, Fish: 7, Bird: 2, Rabbit: 10\|total count` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(p/q)(5)\|p(5)/q(5)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|t: -1, 0, 3, 6, 9; h(t): -9, 16, 19, -7, 24\|h(9)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|32, 8, 4\|4` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_RESULT` | 1 | `GCF_RESULT\|4t` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_VAR` | 2 | `GCF_VAR\|t^5, t^3, t\|t` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; leg = 84 with projection p = 14 on the hypotenuse\|the hypotenuse c` | geometric_mean_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^6]\|(1 + x)^4(1 + x)^8` | generating_function_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = x^2 + 3*y^2 + x*y - 3*y\|point (0, 3)\|tangent` | gradient_generator.py |
...
| `GS_SETUP` | 2 | `GS_SETUP\|vectors [[-1, -1, -1], [3, -1, 1], [5, -3, -5]]\|orthogonal basis, not normalized` | gram_schmidt_generator.py |
...
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|(-10)*4 - 1^2\|-41` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = -5*x^2 + 2*y^2 + x*y - 11*x - 3*y\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = -41\|f_xx = -10\|saddle point` | hessian_classify_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-x^3 + x^2 - 4x - 3\|x = 4` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 25, 16 successes, critical value = 1.645` | hypothesis_test_generator.py, two_sample_test_generator.py |
...
| `IDENTITY` | 2 | `IDENTITY\|Vandermonde\|Σ C(6,i)C(9,15-i) = C(15,15)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=37, n(B)=39\|n(A intersect B)=6` | inclusion_exclusion_generator.py |
...
| `IMPLICIT_SETUP` | 2 | `IMPLICIT_SETUP\|xy = 4\|dy/dx` | implicit_diff_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|7\|-17 ≤ 2x ≤ 3` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INITIAL_SYSTEM` | 2 | `INITIAL_SYSTEM\|C1[2, 1] + C2[1, 1]\|[-2, -3]` | ode_system_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ -2 sin(2x) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 - 3x - 8 on [-2, 0]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|2*(-1) - 1*(-4)\|2` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[2, 1], [-4, -1]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = 2*u + v\|y = -4*u - v\|d(x,y)/d(u,v)` | jacobian_generator.py |
...
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = 3*x^2 + 4*y^2\|constraint 3*x + y = 78\|minimize` | lagrange_multiplier_generator.py |
...
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→∞ of (2x - 1)/(4x^2 + x + 4)\|compare degrees` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
...
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|4/2 + 16\|18` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = 1/4x - 7\|(-4, -3)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <-x - y, -2*x + 4*y>\|from (2, 2) to (-1, 3)` | line_integral_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(4x)) = ln(19)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
...
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|2x + 4 = x - 4` | log_equation_generator.py |
...
| `LOG_PRODUCT` | 1, 2 | `LOG_PRODUCT\|log_5(125xy^4)\|log_5(125x) + log_5(y^4)` | log_equation_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_5(x^2) - log_5(y^3)\|log_5(x^2/y^3)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|2log_5(x) - 3log_5(y)\|condense` | complex_log_generator.py, log_properties_generator.py |
...
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-3, -1), (-1, 7), (1, 11), (3, 11)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[4, -3, 4], [16, -10, 14], [12, -17, 15]]\|unit lower L` | lu_decomposition_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[2, 2], [-3, 0]], v = [[4], [0]]\|Av` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
...
| `METRIC` | 2 | `METRIC\|taxicab circle\|all points with abs(x) + abs(y) = 10` | taxicab_geometry_generator.py |
...
| `MINTERM` | 2 | `MINTERM\|0011\|NOT B AND NOT C AND D AND E` | boolean_algebra_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 36700 · (1 - 0.27)^2` | exponential_model_generator.py |
...
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|5 * 1\|5` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(12x^5) / (-3x^4)` | monomial_mult_div_generator.py |
...
| `MST_ADD` | 2 | `MST_ADD\|AD\|total 4` | mst_generator.py |
...
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|2 L's, 4 A's, 5 O's\|total 11` | stars_and_bars_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 + 5x + 7 on [-3, 3]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 2*x^2 + y^2 + 4*x*y + 2*x - y\|x = 2*t, y = -3*t - 4\|t = -2` | multivar_chain_rule_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 gives the scale factor 8\|line 5 answers 56` | fill_in_step_generator.py |
...
| `NET_SETUP` | 2 | `NET_SETUP\|2 right triangles with legs 9 and 12; rectangles 9 by 12, 12 by 12, and 15 by 12\|total surface area` | nets_surface_area_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(77, 10)\|z-score of x = 99` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
...
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dt = ky; y doubles every 224 hours\|find k exactly` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `OPT_SETUP` | 2 | `OPT_SETUP\|square sheet 2448 by 2448; cut corners x and fold\|maximize volume` | optimization_generator.py |
...
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|6*x^2 + 20*x` | double_integral_generator.py |
...
| `PAIR_RULE` | 1, 2 | `PAIR_RULE\|[a, b] ≤ [c, d]\|a + d ≤ b + c` | integers_as_pairs_generator.py |
...
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(-3*t + 2, t + 2)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 14cos t - 20, y = 14sin t + 15\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(x - 4)/((x + 2)(x - 1)) = A/(x + 2) + B/(x - 1)` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|-1/(s + 2) - 4/(s - 3)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|28*x^3*y^3 + 9*x^2*y^3` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|7*x^4*y^3\|d/dx\|28*x^3*y^3` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 7*x^4*y^3 + 3*x^3*y^3\|f_x` | partial_derivative_generator.py |
...
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = 193x, dv = e^(-x) dx\|du = 193 dx, v = -e^(-x)` | integration_by_parts_generator.py |
...
| `PASCAL_SETUP` | 1 | `PASCAL_SETUP\|15C5` | pascal_triangle_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.04\|2470\|98.8` | percent_problem_generator.py |
...
| `PI_COEFF` | 2 | `PI_COEFF\|4π/3\|4/3` | arc_sector_generator.py |
...
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|x = ±54\|x = 54 or x = -54` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|48*3/6\|24` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y - 0 = -5(x + 9)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|(r, θ) = (44, 6480°)\|rectangular coordinates` | parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|2x^3 - 6x^2 - 5x - 4\|x - 4` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-5x^2 + 5x - 3` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(8x^3 - 2x^3) / (-2x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(8x^3) / (-2x^3) + (-2x^3) / (-2x^3)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-5x^2) + (5x) + (-3)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|x + 2` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x + 5)(5x^2 - 4x - 1)` | multiplying_polynomials_generator.py |
...
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-5x^2) + (5x - 3)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(2x^3 - 6x^2) - (2x^3 - 8x^2)\|2x^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
...
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|5*x^2 + 5*y^2 - 4*x*y - 5*x - 5*y` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(2/3)^1\|2/3` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|27*6 + (-3645)\|-3483` | diagonalization_generator.py |
...
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited A\|AD=4, AB=17, AC=18` | mst_generator.py |
...
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[1, 5, 9, 13]` | least_squares_generator.py, legendre_construction_generator.py |
...
| `Q1` | 4 | `Q1\|-8\|60\|4\|13` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|-8\|60\|4\|-17` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QN_ADD` | 4 | `QN_ADD\|Q\|left\|0 + p(1)\|1` | conservation_law_generator.py |
| `QR_ENTRY` | 2 | `QR_ENTRY\|q1\|[1, 0, 0]` | qr_decomposition_generator.py |
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[3, -1, -1], [0, 4, 1], [0, 0, 2]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|55°\|quadrant I` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
...
| `QUARTILE` | 3 | `QUARTILE\|Q1\|9,9,14,18,19,19,27\|18` | five_number_summary_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|cube: ds/dt = 8 ft/min; s = 18 ft\|dV/dt` | related_rates_generator.py |
| `RATIO` | 2, 3 | `RATIO\|y = 3*x\|y = 3*x` | lagrange_multiplier_generator.py, simplex_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|√83/√83` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 34621 / 0.89` | percent_problem_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = -5 a_(n-1) - 6 a_(n-2)\|a_0 = 7, a_1 = -16` | master_theorem_generator.py, recurrence_generator.py |
| `REDUCE` | 2 | `REDUCE\|(21191, 20443)\|(748, 0)` | integers_as_pairs_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 62), (2, 60), (3, 64), (4, 61), (5, 63)\|coefficient of determination r^2` | regression_generator.py |
| `REJECT` | 1, 2 | `REJECT\|x = −45` | conditional_forms_generator.py, counterexample_search_generator.py, factor_trinomial_generator.py, knights_knaves_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py, set_builder_roster_generator.py |
| `RELAX` | 3 | `RELAX\|A->B\|update inf to 4\|via weight 4` | dijkstra_generator.py |
...
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (3, 67), line ŷ = 72.2 - 0.4x\|residual = observed − predicted` | regression_generator.py |
...
| `ROW_OP` | 1, 2 | `ROW_OP\|R2 → R2 + 3·R1\|[0, 1, 2, -1]` | row_reduction_generator.py, simplex_generator.py, subspace_basis_generator.py |
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, -2, -3], [0, 1, 4, 3], [0, 0, 0, 0]]` | subspace_basis_generator.py |
...
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x4 = 13\|xi >= 0` | stars_and_bars_generator.py |
...
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = -7\|(-343)*(-9)\|3087` | diagonalization_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(0, 8), B(-18, -10); ratio 4:5 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|-222 = -6 + (n - 1)·-8` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|-6, -14, -22, -30, ...\|which term equals -222` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ (-1)^(n+1)·1/n^(2/3), n ≥ 1\|absolutely convergent, conditionally convergent, or divergent?` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
...
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 0.04 * 2470` | percent_problem_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y9 = 20` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
...
| `SIGFIG_ROUND` | 3 | `SIGFIG_ROUND\|10752\|2 significant figures\|1.1 × 10^4` | fermi_estimation_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|768 + 3072 + 12288 + 49152` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=3)^(6) 12·4^k\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=3\|12·4^3\|768` | sigma_notation_generator.py |
...
| `SIGN_CHART` | 2 | `SIGN_CHART\|critical values\|-4, -2` | polynomial_inequality_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, -5)\|y = -6\|f(y) = -57 (negative)\|down` | stability_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; DE = 30, AB = 12, EF = 25\|find BC` | similar_triangles_generator.py |
...
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = 5cos(3(x - 90°)) - 2\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_INT_IDENTIFY` | 2 | `SLOPE_INT_IDENTIFY\|Slope (m)\|6` | slope_intercept_form_generator.py |
| `SLOPE_INT_MATCH` | 2 | `SLOPE_INT_MATCH\|Compare to Slope-Intercept Form\|y = mx + b` | slope_intercept_form_generator.py |
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = 6x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|-5` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-7, -1)\|(8, -10)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-10 - (-1)) / (8 - (-7))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOLUTIONS` | 2 | `SOLUTIONS\|cos x = 1/2\|60°, 300°, 420°, 660°, 780°, 1020°, 1140°, 1380°, 1500°, 1740°, 1860°, 2100°, 2220°, 2460°, 2580°, 2820°, 2940°, 3180°, 3300°, 3540°, 3660°, 3900°, 4020°, 4260°, 4380°, 4620°, 4740°, 4980°, 5100°, 5340°, 5460°, 5700°, 5820°, 6060°, 6180°, 6420°` | trig_equation_generator.py |
...
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(-6*e^(-5t) + 7*e^(-3t))*(-1) + (-14*e^(-5t) + 14*e^(-3t))*(-1)\|20*e^(-5t) - 21*e^(-3t)` | matrix_exponential_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|CE=4, BE=11, AF=14, CD=17, BD=21, AB=23, AC=24` | mst_generator.py |
...
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|x^2 = 2916\|x = ±54` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
...
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|26973\|729 × 37\|729` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `SUM` | 2, 3 | `SUM\|62 + 60 + 64 + 61 + 63\|310` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
...
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = (y + 2)/3` | inverse_function_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|3x^3 + 13x^2 - x - 28\|r = -4` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|3, 1, -5, -8` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = -3y + 14` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * 2, Eq2 * -1` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|4x + 4y = -64\|-5x - 4y = 71` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|y = 2x - 11\|-4y = -4` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute (2x - 11) for y in Eq 2` | systems_substitution_generator.py |
...
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|f(0)\|1` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(9)\|24` | de_moivre_generator.py, dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, lie_exponential_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 18 + 3*(x - 0) + 15*(y - 3)` | gradient_generator.py |
...
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|survive first and last\|1/115 - 1/233` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Σ k=115..232 (1/k - 1/(k+1))` | telescoping_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Stokes\|F=<-8*y, 0, 0>\|disk radius 6 in z=0` | vector_theorem_generator.py |
...
| `TRACE` | 2 | `TRACE\|0 + 6\|6` | ode_system_generator.py |
...
| `TRANSFORM_APPLY` | 2 | `TRANSFORM_APPLY\|(2(8), 2(-5))\|(16, -10)` | transformation_generator.py |
| `TRANSFORM_RULE` | 1 | `TRANSFORM_RULE\|(x, y) → (2x, 2y)` | transformation_generator.py |
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(8, -5)\|dilation by factor 2 centered at the origin` | rv_transform_generator.py, transformation_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle, angle 53°, hypotenuse = 345; given sin 53° ≈ 0.8\|the opposite side` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|z_part * r_part * angle\|6*72*32*2*pi\|27648*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 6*z\|cylinder radius 8, height 12\|cylindrical` | triple_integral_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|30-60-90 triangle, hypotenuse = 598\|both legs` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|23, 11, -1, -13\|arithmetic, d = -12` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|1 - 3.5 = -2.5\|(-2.5)^2 = 6.25\|1/4·6.25 = 1.5625` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|13` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y,z) = <-4*x + 5*y - z, -6*x + 2*y + z, -4*x - y + 3*z>\|divergence and curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|(-128)\|-128` | diagonalization_generator.py |
| `VEC_SETUP` | 2 | `VEC_SETUP\|u = ⟨0, -3⟩, v = ⟨4, 2⟩\|5u - 3v` | dot_product_generator.py, vector_ops_generator.py |
...
| `VERTEX` | 1 | `VERTEX\|(-1, -5)` | ellipse_features_generator.py, hyperbola_features_generator.py, lp_corner_generator.py, parabola_features_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region under y = x(239 - x) on [0, 239], rotated about the y-axis\|shell method` | solid_revolution_generator.py |
...
| `VOP_FORM` | 2 | `VOP_FORM\|u1' = -y2*g/W\|-36/3 * e^(4x)` | variation_parameters_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|60 - 52\|8` | line_integral_generator.py |
...
| `ZERO_PRODUCT` | 2 | `ZERO_PRODUCT\|(x + 2) = 0\|x = -2` | area_between_curves_generator.py, curve_analysis_generator.py, domain_range_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_equation_generator.py, trig_equation_generator.py |
| `ZSCORE` | 2 | `ZSCORE\|(56 - 63)/4\|-1.75` | normal_table_generator.py, z_score_generator.py |
