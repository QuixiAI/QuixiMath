...
366 distinct op-codes observed.
...
| `ESTIMATE` | 2 | `ESTIMATE\|59188 × 25709 ≈ 60000 × 30000\|1800000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1800000000\|1521664292\|1521664292 ≈ 1800000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|9 × 3 = 27, not 21` | error_spotting_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(166, 7)\|P(X < 155.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(8x^4 - 20x^3 + 20x^2 + 20x) / (-4x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(8x^4) / (-4x) + (-20x^3) / (-4x) + (20x^2) / (-4x) + (20x) / (-4x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x + 4)(3x^2 + x - 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(155.5 - 166)/7\|-1.50` | normal_table_generator.py |
