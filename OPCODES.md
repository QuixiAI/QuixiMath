...
808 distinct op-codes observed.
...
| `BACK_SUB_ROW` | 3 | `BACK_SUB_ROW\|r=300\|x=1\|y=0` | extended_euclid_generator.py, modular_inverse_generator.py |
...
| `BINARY_EXPONENT` | 2 | `BINARY_EXPONENT\|50\|110010` | mod_exp_generator.py |
...
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|300\|205\|1\|95` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py |
...
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|300\|205` | extended_euclid_generator.py, modular_inverse_generator.py |
...
| `GCD_RESULT` | 1, 2 | `GCD_RESULT\|2` | lcm_generator.py, modular_inverse_generator.py, totient_generator.py |
...
| `MODEXP_MULTIPLY` | 2 | `MODEXP_MULTIPLY\|bit 1=1\|7` | mod_exp_generator.py |
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 7\|exponent 50\|modulus 18` | mod_exp_generator.py |
| `MODEXP_SQUARE` | 2 | `MODEXP_SQUARE\|bit 1=1\|1` | mod_exp_generator.py |
| `MODEXP_STATE` | 2 | `MODEXP_STATE\|after bit 1\|7` | mod_exp_generator.py |
| `MODE_COUNT` | 2 | `MODE_COUNT\|1\|1` | simple_stats_generator.py |
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|34 mod 15\|4` | crt_generator.py, modular_inverse_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|4\|mod 15\|4` | modular_inverse_generator.py |
| `MOD_POWER` | 3 | `MOD_POWER\|29^3\|mod 5\|4` | totient_generator.py |
| `MOD_REDUCE` | 3 | `MOD_REDUCE\|169\|mod 11\|4` | calendar_arithmetic_generator.py, crt_generator.py, mod_exp_generator.py, modular_arithmetic_generator.py, modular_inverse_generator.py, totient_generator.py |
