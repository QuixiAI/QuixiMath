...
422 distinct op-codes observed.
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|16x^3\|4x^4` | antiderivative_generator.py, area_between_curves_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py |
| `APPROX_SETUP` | 2 | `APPROX_SETUP\|estimate √63\|linearize f(x) = √x at a = 64` | linear_approx_generator.py |
| `ARCLEN_FORMULA` | 1 | `ARCLEN_FORMULA\|L = ∫ √((dx/dt)^2 + (dy/dt)^2) dt` | parametric_calculus_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|97446 × 45437 ≈ 100000 × 50000\|5000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5000000000\|4427653902\|4427653902 ≈ 5000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|70 ÷ 7 = 10, not 8` | error_spotting_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (16x^3 - 9x^2 - 4x) dx\|antiderivative` | antiderivative_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(89, 15)\|P(X < 108.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 12x^3 + 6x^3 + 12x^2 - 12x^2) / (6x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-12x^3) / (6x) + (6x^3) / (6x) + (12x^2) / (6x) + (-12x^2) / (6x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(4x - 5)(-x^2 + x - 4)` | multiplying_polynomials_generator.py |
...
| `THEOREM` | 2 | `THEOREM\|factor theorem\|x + 2 is a factor iff P(-2) = 0` | circle_angle_generator.py, geometric_mean_generator.py, logistic_growth_generator.py, mean_value_theorem_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py, rational_root_generator.py, remainder_factor_theorem_generator.py, special_right_triangle_generator.py, triangle_solve_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(108.5 - 89)/15\|1.30` | normal_table_generator.py |
