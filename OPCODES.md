...
| `MODEL_EQ` | 2 | `MODEL_EQ\|x = 5 * 9 - 18\|quantities in the story` | integer_puzzle_word_generator.py, linear_model_word_generator.py, mixture_generator.py, money_life_generator.py, motion_word_generator.py, multi_step_word_generator.py, percent_chain_generator.py, work_rate_generator.py |
