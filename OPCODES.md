...
| `KRAFT_CHECK` | 2 | `KRAFT_CHECK\|sum=1\|complete` | huffman_coding_generator.py |
| `KRAFT_FORMULA` | 1 | `KRAFT_FORMULA\|sum 2^-l_i` | huffman_coding_generator.py |
