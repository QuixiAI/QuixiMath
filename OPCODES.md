...
494 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|3x + 4 = 20` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|x - 5 >= 19 -> x >= 24` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|x - 5\| >= 19` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|x - 5 >= 19 OR x - 5 <= -19` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|x + 3\| = 0` | absolute_value_equation_generator.py |
...
| `ACCEPT` | 2 | `ACCEPT\|(-7, 9)\|product -63 ✓, sum 2 ✓` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
| `AC_PRODUCT` | 2 | `AC_PRODUCT\|12 × 3\|36` | factor_trinomial_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 4/8, P(B) = 2/8, P(A ∪ B) = 4/8\|P(A ∩ B)` | probability_addition_rule_generator.py |
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|-2x\|-x^2` | antiderivative_generator.py, arc_length_generator.py, area_between_curves_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 3, central angle 60°\|sector area` | arc_sector_generator.py |
| `AREA` | 1, 3 | `AREA\|80` | geometry_area_perimeter_generator.py |
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 and y = 9x - 18\|area between the curves` | area_between_curves_generator.py |
...
| `BAYES_CELL` | 3 | `BAYES_CELL\|true positive\|55 * 4/5\|44` | conditional_probability_generator.py |
| `BAYES_FORMULA` | 1 | `BAYES_FORMULA\|P(disease=no given negative) = TN/(TN + FN)` | conditional_probability_generator.py |
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 55, disease=no 190\|sensitivity 4/5, specificity 9/10\|P(disease=no given test negative)` | conditional_probability_generator.py |
...
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|0 < -3\|no` | piecewise_evaluation_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|row 1: 19, 31; row 2: 1, 49; N = 100\|independence; df = 1, critical value = 3.841` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|19 - 10 = 9\|9^2 = 81\|81/10 = 8.1` | chi_square_generator.py |
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|inscribed angle 64°\|intercepted arc` | circle_angle_generator.py |
...
| `COEFFS` | 1, 2 | `COEFFS\|1, 0, -5, -20\|0 inserted for missing x^2 term` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[-4, -3], [2, 4]]` | determinant_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|choose 4 of 11\|order does not matter` | permutation_combination_generator.py |
...
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|x + 2 < 1 OR x + 2 > 12` | compound_inequality_generator.py |
| `COND_COUNT` | 2 | `COND_COUNT\|club=no and commute=bike\|26` | conditional_probability_generator.py |
| `COND_FORMULA` | 1 | `COND_FORMULA\|P(A given B) = count(A and B)/count(B)` | conditional_probability_generator.py |
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 16, no/bike 26, yes/bus 12, no/bus 15\|P(commute=bike given club=no)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|club=no total\|26 + 15 = 41` | conditional_probability_generator.py |
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(x + 3)^2 = 8(y - 3)\|vertex, focus, directrix` | conic_standard_form_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `CROSS_MULT` | 1 | `CROSS_MULT\|20·BC = 15·24` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 12x^2 + 45x + 4\|inflection point and concavity` | curve_analysis_generator.py |
| `CX_SETUP` | 2 | `CX_SETUP\|(-2 - 6i) + (-5 - 5i)\|add` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 7x^3 + 7x - x^(-1)\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DET_FORMULA` | 1 | `DET_FORMULA\|det = ad - bc` | cramers_rule_generator.py, determinant_generator.py, matrix_inverse_generator.py |
| `DEV_ROW` | 3 | `DEV_ROW\|7\|-5\|25` | standard_deviation_generator.py |
| `DIRECTRIX` | 1 | `DIRECTRIX\|y = 1` | parabola_features_generator.py |
| `DISC` | 2, 3 | `DISC\|225\|216\|9` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|3y + 0 = 27` | systems_substitution_generator.py |
| `DIST_FORMULA` | 1 | `DIST_FORMULA\|d = √((x2 - x1)^2 + (y2 - y1)^2)` | distance_formula_generator.py, hypercube_counting_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|-3x\|9x^3 + 3x^2 - 3x` | multiplying_polynomials_generator.py |
...
| `DIV_TERM` | 3 | `DIV_TERM\|20t^4\|4t\|5t^3` | factor_gcf_generator.py, polynomial_long_division_generator.py |
...
| `EQUATE_EXP` | 1 | `EQUATE_EXP\|x + 2 = 4` | exponential_equation_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(9, -10)\|(8, -8)` | equation_from_two_points_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|53112 × 35912 ≈ 50000 × 40000\|2000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2000000000\|1907358144\|1907358144 ≈ 2000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FACTOR_GROUP` | 3 | `FACTOR_GROUP\|12x^2 + 9x\|3x\|(4x + 3)` | conic_standard_form_generator.py, curve_analysis_generator.py, derivative_limit_def_generator.py, factor_grouping_generator.py, factor_trinomial_generator.py |
| `FACTOR_PAIR_GOAL` | 2 | `FACTOR_PAIR_GOAL\|m·n = -63\|m + n = 2` | factor_trinomial_generator.py |
...
| `FOCUS` | 1 | `FOCUS\|(-3, 5)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `FOIL_I` | 2 | `FOIL_I\|Inner: 4i * (-4)\|-16i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_O` | 2 | `FOIL_O\|Outer: 2 * 6i\|12i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(3 + √13)(3 + √13)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|histogram — 60-69: 1, 70-79: 7, 80-89: 13, 90-99: 2, 100-109: 8\|count at or above 100` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(f + g)(4)\|f(4) + g(4)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|g(x) = -5x + 4\|g(8)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|20, 16, 32\|4` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude h = 12 to the hypotenuse; one segment p = 72\|the other segment q` | geometric_mean_generator.py |
...
| `GROUP` | 2 | `GROUP\|(12x^2 + 9x)\|(4x + 3)` | factor_grouping_generator.py, factor_trinomial_generator.py |
| `HA` | 1 | `HA\|y = 0` | rational_function_features_generator.py |
| `HOLE` | 1 | `HOLE\|x = -5` | rational_function_features_generator.py |
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-x^3 - 4x^2 - 3x - 1\|x = 1` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: μ = 44; Ha: μ ≠ 44\|n = 25, x̄ = 47, s = 2.5, critical value = 2.326` | hypothesis_test_generator.py |
...
| `IDENT_SUB` | 1 | `IDENT_SUB\|1 - cos^2 A = sin^2 A` | parametric_calculus_generator.py, trig_identity_verify_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|8\|-13 <= 3x <= -3` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (-2x - 1) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 3x + 7 on [1, 4]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = -3/2x + 3\|(6, -3)` | parallel_perpendicular_line_generator.py |
...
| `LOG_FORM` | 1 | `LOG_FORM\|log_2(16) = y ⟺ 2^y = 16` | log_conversion_generator.py, log_equation_generator.py |
| `LOG_IDENT` | 2 | `LOG_IDENT\|e^(ln x) = x (inverse functions)\|8` | exponential_equation_generator.py, log_conversion_generator.py |
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|3x + 7 = x - 5` | log_equation_generator.py |
| `LOG_POWER` | 2 | `LOG_POWER\|log_5(x^2)\|2log_5(x)` | log_diff_higher_order_generator.py, log_properties_generator.py |
| `LOG_PRODUCT` | 2 | `LOG_PRODUCT\|log_5(125x^2y^4)\|log_5(125x^2) + log_5(y^4)` | log_equation_generator.py, log_properties_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_3(x^2y^2) - log_3(z^4)\|log_3(x^2y^2/z^4)` | log_properties_generator.py |
| `LOG_SETUP` | 2 | `LOG_SETUP\|log_5(125x^2y^4)\|expand` | log_properties_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[3, -5], [2, 2]], B = [[-4, 1], [-2, 2]]\|AB` | determinant_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py |
| `MAX` | 2 | `MAX\|14, 4\|14` | taxicab_geometry_generator.py |
...
| `METRIC` | 2 | `METRIC\|taxicab circle\|all points with abs(x) + abs(y) = 12` | taxicab_geometry_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 96 · (1/2)^(100/25)` | exponential_model_generator.py |
...
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|7 * -3\|-21` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(48x^7) / (6x^2)` | monomial_mult_div_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 + 4x + 8 on [1, 3]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `NCR` | 2 | `NCR\|C(4,1)\|4` | binomial_probability_generator.py, hypercube_counting_generator.py |
| `NEED` | 2 | `NEED\|line 3 gives the scale factor 8\|line 5 answers 24` | fill_in_step_generator.py |
| `NET_SETUP` | 2 | `NET_SETUP\|2 right triangles with legs 6 and 8; rectangles 6 by 10, 8 by 10, and 10 by 10\|total surface area` | nets_surface_area_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 2/3\|Perpendicular lines have negative reciprocal slopes` | parallel_perpendicular_line_generator.py |
| `NORMAL_SLOPE` | 2 | `NORMAL_SLOPE\|-1/(7)\|-1/7` | tangent_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(102, 10)\|is x = 114 unusual?` | normal_table_generator.py, z_score_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(-x + 13)/((x - 3)(x + 2)) = A/(x - 3) + B/(x + 2)` | partial_fractions_generator.py |
...
| `PERM_SETUP` | 2 | `PERM_SETUP\|P(5, 3)\|n!/(n-r)!` | permutation_combination_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|2x^3 + 3x^2 + x + 8\|2x + 5` | polynomial_long_division_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|9x^2 + 11x + 3` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(3x^5 - 9x^5 + 3x^4 + 12x^3) / (3x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(3x^5) / (3x^2) + (-9x^5) / (3x^2) + (3x^4) / (3x^2) + (12x^3) / (3x^2)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(9x^2) + (9x +2x) + (3)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-3x + 1)(-3x^2 - x + 1)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(9x) - (-9x^2 - 2x - 3)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2 | `POLY_SUB\|(2x^3 + 3x^2) - (2x^3 + 5x^2)\|-2x^2` | polynomial_long_division_generator.py |
| `POW` | 2 | `POW\|(1/4)^1\|0.25` | binomial_probability_generator.py, geometric_distribution_generator.py |
...
| `Q1` | 4 | `Q1\|15\|3\|6\|3` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|15\|3\|6\|2` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|237°\|quadrant III` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
| `QUARTILE` | 3 | `QUARTILE\|Q1\|6,7,9,14,16,17,22\|14` | five_number_summary_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|conical tank, radius = height/2; water in at dV/dt = 2 m³/min; depth h = 4 m\|dh/dt` | related_rates_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 60 / 0.3` | percent_problem_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 51), (2, 49), (3, 57), (4, 55), (5, 53)\|coefficient of determination r^2` | regression_generator.py |
| `REJECT` | 2 | `REJECT\|(-1, 63)\|sum is 62, need 2` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (2, 81), line ŷ = 81.2 - 1.4x\|residual = observed − predicted` | regression_generator.py |
...
| `RIEMANN_SETUP` | 2 | `RIEMANN_SETUP\|f(x) = 4x - 2 on [0, 8], n = 4\|left Riemann sum` | riemann_sum_generator.py |
...
| `ROW_OP` | 2 | `ROW_OP\|R2 → R2 + 2·R1\|[0, 1, -3, 7]` | row_reduction_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(6, -6), B(11, -26); ratio 2:3 from A\|point P` | segment_partition_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ 1/n^4, n ≥ 1\|converge or diverge?` | power_series_generator.py, series_convergence_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 0.1 * 10` | percent_problem_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|8 + 11 + 14 + 17 + 20 + 23` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=1)^(6) (3k + 5)\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=1\|3(1) + 5\|8` | sigma_notation_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; DE = 20, AB = 15, EF = 24\|find BC` | similar_triangles_generator.py |
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = -4sin(6x - 60°) + 5\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-3, -7)\|(-1, 5)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (5 - (-7)) / (-1 - (-3))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|13x = 9x + 4x\|12x^2 + 9x + 4x + 3` | factor_trinomial_generator.py |
...
| `SQRT_NEG` | 2 | `SQRT_NEG\|√(-28)\|i√28` | complex_quadratic_generator.py, polynomial_zeros_generator.py |
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(3x - 9) = x - 3\|3x - 9 = (x - 3)^2` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|117\|9 × 13\|9` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `SUM` | 2 | `SUM\|51 + 49 + 57 + 55 + 53\|265` | regression_generator.py |
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = y^3 - 1` | inverse_function_generator.py |
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|x^3 - 5x - 20\|r = 3` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_DROP` | 1 | `SYN_DROP\|1` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_ROW` | 1 | `SYN_ROW\|1, 3, 4, -8` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -7y = -35` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with x only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = -1y + 7` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq2 * -1` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|5x - 4y = 25\|-5x - 3y = -60` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x + 1y = 7\|0x + 3y = 27` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=9 into x = -1y + 7` | systems_elimination_generator.py, systems_substitution_generator.py |
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|f(-1)\|14` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|g(-1)\|7` | dot_product_generator.py, function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
...
| `TEST_CHOOSE` | 2 | `TEST_CHOOSE\|p-series\|Σ 1/n^p with p = 4` | power_series_generator.py, series_convergence_generator.py |
...
| `TRANSFORM_SETUP` | 2 | `TRANSFORM_SETUP\|P(5, -2)\|reflection over the y-axis, then dilation by factor 3 centered at the origin` | transformation_generator.py |
| `TRIG_RATIO` | 2 | `TRIG_RATIO\|cos\|adjacent/hypotenuse` | right_triangle_trig_generator.py |
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: adjacent side = 32, hypotenuse = 40; given cos 37° ≈ 0.8\|angle A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRY` | 2 | `TRY\|(-1, 63)\|(-1)·63=-63, (-1)+63=62` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|2, 10, 18, 26\|arithmetic, d = 8` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|8 - 5.7 = 2.3\|(2.3)^2 = 5.29\|3/5·5.29 = 3.174` | expected_value_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region under y = x(5 - x) on [0, 5], rotated about the y-axis\|shell method` | solid_revolution_generator.py |
...
| `ZERO_PRODUCT` | 2 | `ZERO_PRODUCT\|(y + 9)(y - 4) = 0\|y + 9 = 0 or y - 4 = 0` | area_between_curves_generator.py, curve_analysis_generator.py, domain_range_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_equation_generator.py, trig_equation_generator.py |
| `ZSCORE` | 2 | `ZSCORE\|(84 - 80)/2\|2` | normal_table_generator.py, z_score_generator.py |
