...
514 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|5x + 2 = 14` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|4x + 9 > 11 -> x > 2/4` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|x + 9\| < 4` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <=` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|AND case\|-4 < x + 9 < 4` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|5x + 2\| = 14` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|5x + 2 = 14\|5x + 2 = -14` | absolute_value_equation_generator.py |
...
| `ACCEPT` | 2 | `ACCEPT\|(1, -3)\|product -3 ✓, sum -2 ✓` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 13/20, P(B) = 16/20, P(A ∩ B) = 11/20\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 6, central angle 210°\|arc length` | arc_sector_generator.py |
...
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = 5 ± (5/12)(x + 3)` | hyperbola_features_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 70, disease=no 48\|sensitivity 7/10, specificity 3/4\|P(disease=no given test negative)` | conditional_probability_generator.py |
| `BINOM_FORMULA` | 1 | `BINOM_FORMULA\|P(X=k) = C(n,k)·p^k·(1-p)^(n-k)` | binomial_probability_generator.py |
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 4, k = 3, p = 7/10\|P(X = k)` | binomial_probability_generator.py |
...
| `CENTER` | 1 | `CENTER\|(-5, 1)` | circle_equation_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 8, 12, 10; expected: 10 each\|goodness of fit; df = 2, critical value = 5.991` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|8 - 10 = -2\|(-2)^2 = 4\|4/10 = 0.4` | chi_square_generator.py |
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|central angle 216° subtends an arc\|inscribed angle on the same arc` | circle_angle_generator.py |
...
| `CI_SETUP` | 2 | `CI_SETUP\|σ = 22, n = 400, z* = 1.645\|confidence interval for μ` | confidence_interval_generator.py |
...
| `COEFFS` | 1, 2 | `COEFFS\|3, 14, 13, 20` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[-4, 2], [-2, -3]]` | determinant_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|C(4, 3)\|n!/(r!·(n-r)!)` | permutation_combination_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|1 - 6\|-5` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|-12/24\|-1/2` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|3x + 4 < -11 -> x < -5` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|3x + 4 < -11 OR 3x + 4 > 22` | compound_inequality_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 5, no/bike 22, yes/bus 24, no/bus 12\|P(club=no given commute=bike)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|commute=bike total\|5 + 22 = 27` | conditional_probability_generator.py |
...
| `CONJUGATE` | 2 | `CONJUGATE\|1 + 4i\|1 - 4i` | complex_division_generator.py |
...
| `CROSS_MULT` | 1 | `CROSS_MULT\|28·BC = 8·49` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 + 3x^2 - 9x - 8\|critical points and their nature` | curve_analysis_generator.py |
| `CX_SETUP` | 2 | `CX_SETUP\|(9 + 3i)(-2 - 9i)\|multiply` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 5x^5 - 2x^2 + 5\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
...
| `DEV_ROW` | 3 | `DEV_ROW\|13\|-2\|4` | standard_deviation_generator.py |
| `DIRECTRIX` | 1 | `DIRECTRIX\|x = 0` | parabola_features_generator.py |
| `DISC` | 2, 3 | `DISC\|144\|-432\|576` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-5y + 44 = -6` | systems_substitution_generator.py |
| `DIST_FORMULA` | 1 | `DIST_FORMULA\|d = √((x2 - x1)^2 + (y2 - y1)^2)` | distance_formula_generator.py, hypercube_counting_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|x\|1x^3 - 2x^2 + 5x` | multiplying_polynomials_generator.py |
...
| `DIV_TERM` | 3 | `DIV_TERM\|48y^3\|6y\|8y^2` | factor_gcf_generator.py, polynomial_long_division_generator.py |
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|denominator ≠ 0\|t - 1 ≠ 0` | domain_range_generator.py |
...
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(4, 6)\|(6, 16)` | equation_from_two_points_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|68156 × 58662 ≈ 70000 × 60000\|4200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|4200000000\|3998167272\|3998167272 ≈ 4200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|6 × 6 = 36, not 48` | error_spotting_generator.py |
| `FOCUS` | 1 | `FOCUS\|(10, 2)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: 9 * (-2)\|-18` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_O` | 2 | `FOIL_O\|Outer: 9 * (-9i)\|-81i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|48, 54, 48\|6` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_RESULT` | 1 | `GCF_RESULT\|6y` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_VAR` | 2 | `GCF_VAR\|y^3, y^2, y\|y` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude h = 11 to the hypotenuse; one segment p = 11\|the other segment q` | geometric_mean_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-x^3 + 3x^2 + 3x + 5\|x = 2` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 400, 234 successes, critical value = 1.96` | hypothesis_test_generator.py |
| `HYPERCUBE_FORMULA` | 1 | `HYPERCUBE_FORMULA\|k-faces of the n-cube: C(n,k) · 2^(n-k)` | hypercube_counting_generator.py |
| `HYPERCUBE_SETUP` | 2 | `HYPERCUBE_SETUP\|points P(-4, -4, -1, -4) and Q(1, 5, 3, 2) in R^4\|distance` | hypercube_counting_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|9\|-13 < 1x < -5` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (8x^3 - 3x^2 - 6x) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 3x - 9 on [1, 2]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
| `I_CYCLE` | 2 | `I_CYCLE\|i^1\|i` | complex_number_ops_generator.py |
| `I_SQUARE` | 2 | `I_SQUARE\|-27i^2\|27` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→4 of (x^2 - 16)/(x - 4)\|0/0: factor and cancel` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = x - 3\|(-7, -3)` | parallel_perpendicular_line_generator.py |
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(3x)) = ln(43)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
...
| `LOG_POWER` | 2 | `LOG_POWER\|log_10(x^3)\|3log_10(x)` | log_diff_higher_order_generator.py, log_properties_generator.py |
| `LOG_PRODUCT` | 2 | `LOG_PRODUCT\|log_10(1000x^3y^3)\|log_10(1000x^3) + log_10(y^3)` | log_equation_generator.py, log_properties_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_5(x^3y^4) - log_5(z^2)\|log_5(x^3y^4/z^2)` | log_properties_generator.py |
| `LOG_SETUP` | 2 | `LOG_SETUP\|log_10(1000x^3y^3)\|expand` | log_properties_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[-2, 4], [3, 3]], B = [[-2, 4], [-1, -3]]\|AB` | determinant_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py |
| `MAX` | 2 | `MAX\|5, 3\|5` | taxicab_geometry_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 300e^0.42` | exponential_model_generator.py |
...
| `MONO_ADD_EXP` | 2 | `MONO_ADD_EXP\|x^2 * x^2 = x^(2+2)\|x^4` | monomial_mult_div_generator.py |
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|-30 / 6\|-5` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|-9 * 1\|-9` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-30x^5) / (6x^2)` | monomial_mult_div_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 + 4x + 3 on [-2, 0]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `NCR` | 2 | `NCR\|C(4,1)\|4` | binomial_probability_generator.py, hypercube_counting_generator.py |
| `NEED` | 2 | `NEED\|line 3 shows 8x = 40\|line 5 shows x = 5` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(106, 10)\|is x = 135 unusual?` | normal_table_generator.py, z_score_generator.py |
| `ODE_SETUP` | 2 | `ODE_SETUP\|dy/dt = ky; y doubles every 5 hours\|find k exactly` | euler_method_generator.py, logistic_growth_generator.py, separable_ode_generator.py |
| `OPT_SETUP` | 2 | `OPT_SETUP\|160 m of fence, barn forms the fourth side; sides x, x, and 160 - 2x\|maximize area` | optimization_generator.py |
...
| `PARAM_SETUP` | 2 | `PARAM_SETUP\|x = t - 1, y = -3t - 2\|eliminate t` | parametric_calculus_generator.py, polar_parametric_generator.py |
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(6x - 2)/((x + 3)(x - 2)) = A/(x + 3) + B/(x - 2)` | partial_fractions_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.7\|60\|42` | percent_problem_generator.py |
...
| `PERM_SETUP` | 2 | `PERM_SETUP\|P(13, 6)\|n!/(n-r)!` | permutation_combination_generator.py |
...
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|n - 9 = ±10\|n - 9 = 10 or n - 9 = -10` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y - 6 = 5(x - 4)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|3y^3 + 7y^2 + y - 4\|y + 2` | polynomial_long_division_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-x^3 - 4x^2 + x - 14` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(8x^5 + 32x^4) / (-8x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(8x^5) / (-8x) + (32x^4) / (-8x)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-1x^3) + (2x^2 -6x^2) + (1x) + (-8 -6)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 2)(x^2 - 2x + 5)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-x^3 + 2x^2 + x - 8) - (6x^2 + 6)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2 | `POLY_SUB\|(3y^3 + 7y^2) - (3y^3 + 6y^2)\|y^2` | polynomial_long_division_generator.py |
| `POW` | 2 | `POW\|(7/10)^3\|0.343` | binomial_probability_generator.py, geometric_distribution_generator.py |
...
| `Q1` | 4 | `Q1\|12\|24\|6\|6` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|12\|24\|6\|-2` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|353°\|quadrant IV` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
| `QUARTILE` | 3 | `QUARTILE\|Q1\|9,10,11\|10` | five_number_summary_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|conical tank, radius = height/2; water in at dV/dt = 5 m³/min; depth h = 6 m\|dh/dt` | related_rates_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|(5 - √6)/(5 - √6)` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 100 / 0.1` | percent_problem_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 67), (2, 69), (3, 70), (4, 68), (5, 71)\|coefficient of determination r^2` | regression_generator.py |
| `REJECT` | 2 | `REJECT\|(1, 63)\|sum is 64, need 16` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (2, 44), line ŷ = 39 + x\|residual = observed − predicted` | regression_generator.py |
...
| `RIEMANN_SETUP` | 2 | `RIEMANN_SETUP\|f(x) = 3x + 3 on [2, 10], n = 4\|midpoint Riemann sum` | riemann_sum_generator.py |
...
| `ROW_OP` | 2 | `ROW_OP\|R2 → R2 + 2·R1\|[0, 1, 2, 7]` | row_reduction_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(2, 5), B(11, -31); ratio 5:4 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_26 = 6 + (26 - 1)·-5` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|6, 1, -4, -9, ...\|26th term` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ n/(n^2 + 1), n ≥ 1\|converge or diverge?` | power_series_generator.py, series_convergence_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|100 = 0.1 * whole` | percent_problem_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|1 + 3 + 9 + 27 + 81` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=0)^(4) 3^k\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=0\|3^0\|1` | sigma_notation_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; DE = 28, AB = 8, EF = 49\|find BC` | similar_triangles_generator.py |
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = 4sin(4(x + 90°)) - 2\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(4, -1)\|(5, 4)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (4 - (-1)) / (5 - 4)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
| `SLOPE_UNDEFINED` | 1 | `SLOPE_UNDEFINED\|Division by zero` | slope_two_points_generator.py |
| `SOLUTIONS` | 2 | `SOLUTIONS\|sin x = -√2/2\|225°, 315°` | trig_equation_generator.py |
...
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|17n = 16n + n\|4n^2 + 16n + n + 4` | factor_trinomial_generator.py |
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|(n - 9)^2 = 100\|n - 9 = ±10` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
...
| `SQUARE_TEST` | 3 | `SQUARE_TEST\|161\|12^2 = 144, 13^2 = 169\|not a perfect square` | discriminant_generator.py |
...
| `SUM` | 2 | `SUM\|67 + 69 + 70 + 68 + 71\|345` | regression_generator.py |
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = y^3 - 3` | inverse_function_generator.py |
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|3x^3 + 14x^2 + 13x + 20\|r = -4` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_DROP` | 1 | `SYN_DROP\|3` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_ROW` | 1 | `SYN_ROW\|3, 2, 5, 0` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -7y = -21` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with y only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = 1y + -11` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * -3, Eq2 * 2` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|12x - 3y = 75\|-12x - 4y = -96` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x - 1y = -11\|-4x -1y = -6` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=10 into x = 1y + -11` | systems_elimination_generator.py, systems_substitution_generator.py |
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|h(0)\|1` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|g(8)\|9` | dot_product_generator.py, function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|45-45-90 triangle, leg = 10\|hypotenuse` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
| `TRY` | 2 | `TRY\|(1, -3)\|1·(-3)=-3, 1+(-3)=-2` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|3, 12, 48, 192\|geometric, r = 4` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|7 - 4.75 = 2.25\|(2.25)^2 = 5.0625\|1/4·5.0625 = 1.265625` | expected_value_generator.py |
...
| `VERTEX` | 1 | `VERTEX\|(5, 2)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(51 - 42)/4\|2.25` | normal_table_generator.py, z_score_generator.py |
