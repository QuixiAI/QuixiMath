...
1798 distinct op-codes observed.
...
| `ANGLE_RELATION` | 1 | `ANGLE_RELATION\|6x + 8 = 2x + 64` | angle_relationships_generator.py |
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|vertical\|Vertical angles are equal` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|4x = 56\|x = 14` | angle_relationships_generator.py |
...
| `APPLY_OPERATOR` | 2 | `APPLY_OPERATOR\|L[A]\|-8A = -8` | commutator_generator.py, undetermined_coeff_generator.py |
...
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|12^3/3\|576` | centroid_generator.py |
| `AREA_INTEGRAL` | 2 | `AREA_INTEGRAL\|sqrt(EG-F^2)=R\|area = R*theta*h` | fundamental_form_generator.py |
| `AREA_SCALE` | 3 | `AREA_SCALE\|uv rectangle area\|3*8\|24` | jacobian_generator.py |
...
| `ARG_SETUP` | 2 | `ARG_SETUP\|¬(s ∨ p) ∨ ((s ∧ p) ∧ ¬q); ¬¬(s ∨ p)\|(s ∧ p) ∧ ¬q` | argument_form_generator.py |
...
| `BASE_ARITH_SETUP` | 2 | `BASE_ARITH_SETUP\|base 2\|101001 + 1101100` | base_arithmetic_generator.py |
...
| `BASE_SETUP` | 2 | `BASE_SETUP\|10110111_2\|decimal` | base_conversion_generator.py |
| `BAYES_CELL` | 3 | `BAYES_CELL\|true positive\|460 × 11/20\|253` | conditional_probability_generator.py |
| `BAYES_FORMULA` | 1 | `BAYES_FORMULA\|P(disease=yes given positive) = TP/(TP + FP)` | conditional_probability_generator.py |
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 460, disease=no 768\|sensitivity 11/20, specificity 5/16\|P(disease=yes given test positive)` | conditional_probability_generator.py |
...
| `BIT_SETUP` | 2 | `BIT_SETUP\|0010 XOR 1100\|4-bit mask` | bitwise_ops_generator.py |
...
| `BRING_DOWN` | 2 | `BRING_DOWN\|group 71\|current = 71` | composite_arithmetic_generator.py, manual_square_root_generator.py |
...
| `CAL_SETUP` | 3 | `CAL_SETUP\|2024-06-14\|Friday, offset 21 days\|weekday` | calendar_arithmetic_generator.py, calorimetry_generator.py |
...
| `CARTESIAN_RESULT` | 1 | `CARTESIAN_RESULT\|{(e, 9), (e, 18), (e, 19), (j, 9), (j, 18), (j, 19)}` | set_operations_generator.py |
| `CART_PAIR` | 3 | `CART_PAIR\|e\|9\|(e, 9)` | set_operations_generator.py |
| `CASE` | 1, 2 | `CASE\|Kira=knight, Quin=knight` | countability_bijection_generator.py, knights_knaves_generator.py |
...
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(5184)/(576)\|9` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= x^2\|0 <= x <= 12\|centroid` | centroid_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*dx/dt + f_y*dy/dt\|(-10)*2 + 40*(-4)\|-180` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(-3)\|2*(-3) + (-1)\|-7` | multivar_chain_rule_generator.py |
| `CHANGE_BASE` | 1 | `CHANGE_BASE\|log_9(27) = log_3(27)/log_3(9)` | log_conversion_generator.py |
| `CHAR_DIAG` | 2 | `CHAR_DIAG\|diagonal of λI - A\|(λ - 1), (λ - 2), (λ - 4)` | eigenvalue_generator.py |
| `CHAR_EQ` | 2 | `CHAR_EQ\|assume y=e^(rx)\|r^2 - 16 = 0` | ode_system_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^3 - 7λ^2 + 14λ - 8\|(λ - 1)*(λ - 2)*(λ - 4)` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
| `CHAR_ROOTS` | 2 | `CHAR_ROOTS\|r1 = -4, r2 = 4\|distinct real` | recurrence_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `CHECK_POINT` | 3 | `CHECK_POINT\|x=0\|24·0 + 3 = 3\|24·0 + 3 = 3` | special_solution_equation_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(-1 - 0)*55\|-55` | vector_theorem_generator.py |
...
| `CLUE_APPLY` | 3 | `CLUE_APPLY\|clue 1\|Kira has map\|6 → 2 candidates` | logic_grid_puzzle_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(B OR C OR D OR E) AND (B OR NOT C OR NOT D OR E)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|117000` | laurent_series_generator.py, series_solution_generator.py |
...
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=0, j=4\|0+4=4\|15` | generating_function_generator.py |
...
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2\|[[3, 2, 0], [1, 1, -1]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(3,1)\|3` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = 24*v1 - 13*v2\|[7, 5]` | diagonalization_generator.py |
| `COMB_CONST` | 3 | `COMB_CONST\|7\|-6\|1` | derivative_product_quotient_generator.py, equation_from_two_points_generator.py, linear_complex_generator.py, rational_expr_add_sub_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `COMB_X` | 3 | `COMB_X\|x\|+x\|2x` | derivative_product_quotient_generator.py, linear_complex_generator.py, rational_expr_add_sub_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `COMPARE` | 2, 3 | `COMPARE\|3 < 9\|log_b(a) < k` | algorithm_trace_generator.py, equilibrium_ice_generator.py, fixed_point_generator.py, master_theorem_generator.py |
...
| `CONCLUSION_AT` | 2 | `CONCLUSION_AT\|p=T, q=F, s=T\|T` | argument_form_generator.py |
| `CONCLUSION_CHECK` | 1 | `CONCLUSION_CHECK\|not forced` | syllogism_generator.py |
| `COND_COUNT` | 2 | `COND_COUNT\|club=no and commute=bike\|28` | conditional_probability_generator.py |
...
| `COND_PARTS` | 2 | `COND_PARTS\|(q ∨ q) ∨ r\|¬(r ∨ p)` | conditional_forms_generator.py |
| `COND_SETUP` | 2, 3 | `COND_SETUP\|club=yes and commute=bike: 48; club=yes and commute=bus: 77; club=no and commute=bike: 28; club=no and commute=bus: 36\|P(club=no given commute=bike)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|commute=bike total\|48 + 28 = 76` | conditional_probability_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[24, -13]` | diagonalization_generator.py |
...
| `COUNTEREXAMPLE` | 2, 3 | `COUNTEREXAMPLE\|set pair\|A = {62}; B = {62}; left = ∅; right = {62}` | argument_form_generator.py, conditional_forms_generator.py, counterexample_search_generator.py, truth_table_generator.py |
...
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|4*x - 5*y + 9 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|4*2 - (-5)^2\|-17` | hessian_classify_generator.py |
...
| `CURL_COMPONENT` | 3 | `CURL_COMPONENT\|Q_x - P_y\|5 - 4\|1` | div_curl_generator.py |
...
| `CURVE_GEOM_SETUP` | 3 | `CURVE_GEOM_SETUP\|r(t) = <-3*t + 5, -4*t + 8>\|0 <= t <= 9\|arc length` | curve_geometry_generator.py |
...
| `DATE_ORDINAL` | 2 | `DATE_ORDINAL\|2027-05-10\|740111` | calendar_arithmetic_generator.py |
...
| `DEDUCE` | 3 | `DEDUCE\|Mara\|item = kite\|only solution left` | logic_grid_puzzle_generator.py |
...
| `DERIV_FORM` | 2 | `DERIV_FORM\|y'\|-4C1e^(-4x) + 4C2e^(4x)` | second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -1], [1, 0], [1, 1]]\|y = [8, 12, 10]` | least_squares_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[3, 5], [4, 7]]\|D = [[8, 0], [0, 9]]\|P^-1 = [[7, -5], [-4, 3]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[-14, -10, -6]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 3*x^2 + y^2 + 2*x*y - 6*x - 5*y\|point (4, -3)\|dx=2/5, dy=1/4` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|12*2/5 + (-3)*1/4\|4.05` | multivar_chain_rule_generator.py |
...
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited B\|A=1, B=0, C=4, D=3, E=inf, F=inf` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|-x\|- 5x^3 + 4x^2 - 5x` | multiplying_polynomials_generator.py |
| `DIVIDE_EQ` | 2 | `DIVIDE_EQ\|divide by y^2\|y^(-2)dy/dx + 2y^(-1) = 2` | ode_substitution_generator.py |
| `DIVMOD` | 3, 4 | `DIVMOD\|3946\|16\|246\|r=10` | base_conversion_generator.py, induction_verify_generator.py, recursive_definition_unfold_generator.py |
...
| `DIV_COEFF` | 3 | `DIV_COEFF\|1\|2\|x=1/2` | linear_complex_generator.py |
...
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT X AND Y AND Z) OR (X AND NOT Y AND Z)` | boolean_algebra_generator.py |
| `DOMAIN` | 1, 2 | `DOMAIN\|x = −34..−23\|{−34, −33, −32, −31, −30, −29, −28, −27, −26, −25, −24, −23}` | quantifier_finite_domain_generator.py, relation_operations_generator.py, set_builder_roster_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(0, 26) · (1, 0)\|0*1 + 26*0\|0` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `DOUBLE_SETUP` | 2, 3 | `DOUBLE_SETUP\|integrand 2*x + 8*y + 2\|x:0..3\|y:1..6` | double_integral_generator.py |
...
| `D_POWER` | 2 | `D_POWER\|D^4\|[[1296, 0], [0, 625]]` | diagonalization_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|CD\|weight 17\|add C` | mst_generator.py |
| `EDGE_CONSIDER` | 2 | `EDGE_CONSIDER\|BD\|weight 4` | mst_generator.py |
...
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A - 1I\|[[0, 1, 2], [0, 1, 2], [0, 0, 3]]` | eigenvalue_generator.py |
...
| `ELIMINATE` | 1, 3 | `ELIMINATE\|clue 1\|Mara: kite; Kira: mug; Nico: map\|violates clue` | logic_grid_puzzle_generator.py, newtons_laws_generator.py |
...
| `EQ_SIMPLIFY` | 1 | `EQ_SIMPLIFY\|8x = 80` | error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, two_step_equation_generator.py |
| `ESCAPE_CHECK` | 3 | `ESCAPE_CHECK\|n=1\|norm2=1\|bounded` | fractal_iteration_generator.py |
| `ESTIMATE` | 2 | `ESTIMATE\|64692 × 36987 ≈ 60000 × 40000\|2400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2 × 10^4\|20480\|rounded estimate` | fermi_estimation_generator.py, long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EVAL_PARTIAL` | 3 | `EVAL_PARTIAL\|f_x\|10*3 - 6\|24` | gradient_generator.py, multivar_chain_rule_generator.py |
...
| `EXP_ENTRY` | 3 | `EXP_ENTRY\|(1,1)\|-4*e^(5t) + 5*e^(6t)\|-4*e^(5t) + 5*e^(6t)` | matrix_exponential_generator.py |
| `EXP_EXPAND` | 1 | `EXP_EXPAND\|12 × 12` | exponent_generator.py |
...
| `EXP_RULE_APPLY` | 3, 4 | `EXP_RULE_APPLY\|add\|26\|3\|29` | exponent_generator.py, exponent_mixed_rules_generator.py |
...
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|b^26 · b^3` | exponent_generator.py, exponent_mixed_rules_generator.py, rational_exponent_generator.py |
| `EXP_RULE_SIMPLIFY` | 1 | `EXP_RULE_SIMPLIFY\|b^29` | exponent_generator.py, exponent_mixed_rules_generator.py |
| `EXP_SETUP` | 2 | `EXP_SETUP\|12\|2` | exponent_generator.py |
...
| `FIN_SETUP` | 3 | `FIN_SETUP\|simple interest P = 1000\|r = 4%, t = 3\|interest and balance` | finance_generator.py |
...
| `FLUX_SUM` | 2 | `FLUX_SUM\|(-1 + 3 + 3)*108\|540` | vector_theorem_generator.py |
...
| `FORM` | 2 | `FORM\|forward\|((q ∨ q) ∨ r) → ¬(r ∨ p)` | conditional_forms_generator.py, zf_axiom_identify_generator.py |
...
| `GEOM_SETUP` | 2 | `GEOM_SETUP\|p = 3/5, q = 2/5\|P(X <= 7)` | geometric_distribution_generator.py |
| `GEO_PROB_FORMULA` | 1 | `GEO_PROB_FORMULA\|probability = favorable length / total length` | geometric_probability_generator.py |
| `GEO_PROB_SETUP` | 2 | `GEO_PROB_SETUP\|number line from 0 to 43\|lands between 20 and 25` | geometric_probability_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^4]\|(1 + x)^3(1 + x)^6` | generating_function_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = 5*x^2 + 5*y^2 - 6*x - 2*y\|point (3, 3)\|tangent` | gradient_generator.py |
...
| `GRAPH_MAX` | 2 | `GRAPH_MAX\|10am\|19` | graph_interpret_generator.py |
| `GRAPH_MAX_CHANGE` | 3 | `GRAPH_MAX_CHANGE\|10am\|11am\|1` | graph_interpret_generator.py |
| `GRAPH_MIN` | 2 | `GRAPH_MIN\|min\|5` | graph_interpret_generator.py |
| `GRAPH_READ` | 2 | `GRAPH_READ\|9am\|18` | graph_interpret_generator.py |
| `GRAPH_SETUP` | 2 | `GRAPH_SETUP\|vertices A, B, C, D\|edges AB, AC, AD, BC, BD` | dijkstra_generator.py, euler_circuit_generator.py, graph_counting_generator.py, graph_traversal_generator.py |
...
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|4*2 - (-5)^2\|-17` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = 2*x^2 + y^2 - 5*x*y + 9*x - 7*y\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = -17\|f_xx = 4\|saddle point` | hessian_classify_generator.py |
...
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=3..29 C(i,3) = C(30,4)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=44, n(B)=20\|n(A intersect B)=4` | inclusion_exclusion_generator.py |
...
| `INEQ_OP_BOTH` | 4 | `INEQ_OP_BOTH\|subtract\|15\|x\|-14` | domain_range_generator.py, linear_fractional_generator.py, one_step_inequality_generator.py, two_step_inequality_generator.py |
...
| `INEQ_SETUP` | 1 | `INEQ_SETUP\|x + 15 < 1` | linear_fractional_generator.py, one_step_inequality_generator.py, polynomial_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_SIMPLIFY` | 1 | `INEQ_SIMPLIFY\|x + 8 ≤ 1` | domain_range_generator.py, linear_fractional_generator.py, two_step_inequality_generator.py |
...
| `INITIAL_COEFF` | 2 | `INITIAL_COEFF\|a_0\|23400` | series_solution_generator.py |
...
| `INNER_ANTIDERIV` | 2 | `INNER_ANTIDERIV\|dy\|2*x*y + 4*y^2 + 2*y` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_EVAL` | 2, 3 | `INNER_EVAL\|y=1..6\|10*x + 150` | double_integral_generator.py, triple_integral_generator.py |
...
| `INT_ABS` | 2 | `INT_ABS\|1\|1` | integer_operations_generator.py |
| `INT_ALIGN` | 2 | `INT_ALIGN\|82320\|65750` | multi_digit_addition_generator.py, multi_digit_subtraction_generator.py |
| `INT_APPLY_SIGN` | 3 | `INT_APPLY_SIGN\|4\|negative\|-4` | integer_operations_generator.py |
| `INT_OP` | 4 | `INT_OP\|×\|1\|4\|4` | integer_operations_generator.py |
| `INT_REWRITE` | 2 | `INT_REWRITE\|-18 - 12\|-18 + (-12)` | integer_operations_generator.py |
...
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|(-4)*(-3) - (-1)*(-5)\|7` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[-4, -1], [-5, -3]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = -4*u - v\|y = -5*u - 3*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
...
| `KIN_SETUP` | 3, 4 | `KIN_SETUP\|v = 37 miles/hour\|t = 9 hours\|distance` | invariant_mass_generator.py, kinematics_generator.py |
...
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|11\|X AND Y` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|X=0\|0, 0` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows X=0,X=1\|columns Y=0,Y=1` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|X AND Y` | boolean_algebra_generator.py |
...
| `LAW` | 3 | `LAW\|idempotent\|((p ∨ q) ∨ r) ∨ ((p ∨ q) ∨ r)\|(p ∨ q) ∨ r` | logical_equivalence_laws_generator.py, set_algebra_laws_generator.py |
...
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|39/2 - 12\|15/2` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = -2x + 2\|(6, 10)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <6*x + 4*y + 3, 2*y + 4*x + 3>\|from (-4, 0) to (2, 0)` | line_integral_generator.py |
...
| `LS_LINE` | 2 | `LS_LINE\|a = 10, b = 1\|ŷ = 10 + x` | least_squares_generator.py |
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-1, 8), (0, 12), (1, 10)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[1, 4, -2], [-4, -20, 5], [-3, -4, 9]]\|unit lower L` | lu_decomposition_generator.py |
...
| `MAXTERM` | 2 | `MAXTERM\|0000\|B OR C OR D OR E` | boolean_algebra_generator.py |
...
| `MEASURE_FAVORABLE` | 2 | `MEASURE_FAVORABLE\|interval length\|25 - 20 = 5` | geometric_probability_generator.py |
| `MEASURE_PROB` | 3 | `MEASURE_PROB\|computational basis\|P(0)=1/2\|P(1)=1/2` | quantum_gate_generator.py |
| `MEASURE_TOTAL` | 2 | `MEASURE_TOTAL\|total length\|43` | geometric_probability_generator.py |
...
| `MINTERM` | 2 | `MINTERM\|011\|NOT X AND Y AND Z` | boolean_algebra_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|12^5/10\|124416/5` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|12^4/4\|5184` | centroid_generator.py |
...
| `MST_ADD` | 2 | `MST_ADD\|CD\|total 17` | mst_generator.py |
...
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|2 L's, 1 A, 3 C's, 3 Y's\|total 9` | stars_and_bars_generator.py |
...
| `MUL_TERM` | 3 | `MUL_TERM\|3\|(-1/3)x\|-1x` | linear_fractional_generator.py, polynomial_long_division_generator.py, rational_equation_generator.py |
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 - 4x - 8 on [2, 10]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 4*x^2 + 3*y^2 + 4*x*y + 2*x + 2*y\|x = 2*t - 1, y = -4*t - 1\|t = -3` | multivar_chain_rule_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 subtracts 11, giving -24\|line 4 divides by 8` | fill_in_step_generator.py |
...
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|5*x^2 + 150*x` | double_integral_generator.py |
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|x=0..3\|5*(3^2 - 0^2) + 150*(3 - 0)\|495` | double_integral_generator.py |
...
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|3x + 20 = 4x + 13` | angle_relationships_generator.py |
...
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(-5*t + 3, 6*t - 3)\|0 <= t <= 1` | line_integral_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|2/(s + 1) - 3/(s - 4)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|16*x^3*y^4 + 12*x^3*y^2` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|3*x^4*y^2\|d/dx\|12*x^3*y^2` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 4*x^4*y^4 + 3*x^4*y^2\|f_x` | partial_derivative_generator.py |
...
| `PARTICULAR_CHECK` | 2 | `PARTICULAR_CHECK\|K = 5\|2K + 8K - 45 = K` | recurrence_generator.py |
...
| `PATH_DERIV` | 2 | `PATH_DERIV\|r'(t)\|(-5, 6)` | curve_geometry_generator.py, line_integral_generator.py |
...
| `PHYS_SETUP` | 3 | `PHYS_SETUP\|P = 56 watts\|t = 8 minutes\|energy` | physics_formula_generator.py |
...
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|2*4/2\|4` | lagrange_multiplier_generator.py |
...
| `POLISH` | 1 | `POLISH\|AKrqEArqp` | wff_parsing_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(24x^2 + 24x^2) / (-8x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(24x^2) / (-8x) + (24x^2) / (-8x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x - 5)(5x^2 - 4x + 5)` | multiplying_polynomials_generator.py |
...
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|3*x^2 + y^2 + 4*x*y + 3*x + 3*y` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(1/5)^6\|0.000064` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|2592*(-3) + 4375\|-3401` | diagonalization_generator.py |
...
| `POWER_SET_RESULT` | 1 | `POWER_SET_RESULT\|{∅, {h}, {n}, {h, n}}` | set_operations_generator.py |
...
| `PREMISES_ALL_T` | 2 | `PREMISES_ALL_T\|p=T, q=T, s=T\|no` | argument_form_generator.py |
| `PRIME` | 1 | `PRIME\|41` | divisibility_classification_generator.py |
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited D\|CD=17, BD=22, AD=23` | mst_generator.py |
...
| `PROB_CONDITIONAL` | 2 | `PROB_CONDITIONAL\|P(yellow given first was yellow)\|3/10` | compound_probability_generator.py |
| `PROB_DEPENDENT` | 1 | `PROB_DEPENDENT\|Drawing without replacement means dependent events` | compound_probability_generator.py |
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Two dice: d5=2, d12=2` | compound_probability_generator.py |
| `PROB_IDENTIFY` | 2 | `PROB_IDENTIFY\|P(first die is 2)\|1/5` | compound_probability_generator.py |
| `PROB_INDEPENDENT` | 1 | `PROB_INDEPENDENT\|The two dice are independent events` | compound_probability_generator.py |
| `PROB_MULTIPLY` | 3 | `PROB_MULTIPLY\|1/5\|1/12\|1/60` | compound_probability_generator.py |
...
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[9, 10, 11]` | least_squares_generator.py, legendre_construction_generator.py |
...
| `PYTHAG_CALCULATE` | 2 | `PYTHAG_CALCULATE\|d² = 3080025 + 63504 = 3143529\|3143529` | pythag_leg_generator.py |
| `PYTHAG_CONTEXT` | 3 | `PYTHAG_CONTEXT\|displacement\|east=1755m, north=252m\|diagram=NGA` | pythag_leg_generator.py |
| `PYTHAG_FORMULA` | 1 | `PYTHAG_FORMULA\|a² + b² = c²` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_MODEL` | 3 | `PYTHAG_MODEL\|east=1755\|north=252\|distance=?` | pythag_leg_generator.py |
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|210681\|459` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 2, 3 | `PYTHAG_SETUP\|legs=56,192\|hypotenuse DT=?` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 1798281 - 1587600\|210681` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|1260\|1587600` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|1260² + b² = 1341²` | pythag_leg_generator.py |
...
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[3, -14], [4, -2]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
...
| `RATIO_TABLE` | 2 | `RATIO_TABLE\|Red (liters): 16, 20, 40, ?\|Blue (liters): 44, 55, 110, 121` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = 2 a_(n-1) + 8 a_(n-2) - 45\|a_0 = 11, a_1 = 11` | master_theorem_generator.py, recurrence_generator.py |
...
| `REGION_EQ` | 2 | `REGION_EQ\|A ∩ B ∩ C\|2` | venn_region_count_generator.py |
| `REGION_MEASURE` | 3 | `REGION_MEASURE\|volume\|9*4*3\|108` | vector_theorem_generator.py |
...
| `REJECT` | 1, 2 | `REJECT\|x = −34` | cantor_pairing_generator.py, conditional_forms_generator.py, counterexample_search_generator.py, factor_trinomial_generator.py, knights_knaves_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py, set_builder_roster_generator.py, structure_isomorphism_generator.py |
| `RELAX` | 3 | `RELAX\|B->A\|update inf to 1\|via weight 1` | dijkstra_generator.py |
...
| `REVERSE` | 2 | `REVERSE\|A,6,F\|F6A` | base_arithmetic_generator.py, base_conversion_generator.py, bitwise_ops_generator.py |
...
| `ROOT_SETUP` | 1 | `ROOT_SETUP\|∛8` | exponent_generator.py, radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
| `ROOT_SIMPLIFY` | 1, 2 | `ROOT_SIMPLIFY\|3√10` | complex_quadratic_generator.py, distance_formula_generator.py, dot_product_generator.py, euler_formula_generator.py, exponent_generator.py, geometric_mean_generator.py, hypercube_counting_generator.py, polar_parametric_generator.py, vector_ops_generator.py |
| `ROSTER` | 2 | `ROSTER\|S\|{−33, −31, −29, −27, −25, −23}` | set_builder_roster_generator.py |
...
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, 4, 4], [0, 1, 2, 3], [0, 0, 0, 0]]` | subspace_basis_generator.py |
...
| `SA_FACES` | 3 | `SA_FACES\|top/bottom\|11 × 5\|55` | volume_3d_generator.py |
| `SA_FORMULA` | 1 | `SA_FORMULA\|SA = 2(lw + lh + wh)` | round_solids_generator.py, volume_3d_generator.py |
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 48 × 54\|5184π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=11, w=5, h=9` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(55 + 99 + 45)\|398` | round_solids_generator.py, volume_3d_generator.py |
| `SB_FORMULA` | 1 | `SB_FORMULA\|C(n-1, k-1)` | stars_and_bars_generator.py |
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x8 = 31\|xi >= 1` | stars_and_bars_generator.py |
| `SCALE_DIV` | 3 | `SCALE_DIV\|393\|131\|3` | scaling_generator.py |
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|11*cos\|0` | de_moivre_generator.py, euler_formula_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|393 feet\|scaled_dimension` | scaling_generator.py |
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = 8\|512*24\|12288` | diagonalization_generator.py |
| `SCALE_MULT` | 3 | `SCALE_MULT\|4.5\|63\|283.5` | scaling_generator.py |
...
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|6.84\|6` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|right\|6` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|divide_coefficients\|6.9\|2.3\|3` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|(6.9 × 10^3) ÷ (2.3 × 10^-9)` | exponent_generator.py |
...
| `SET_SETUP` | 2, 3, 4 | `SET_SETUP\|A = {b, i, j, p, q}\|B = {d, j, m, p, r, t}\|A ∩ B` | set_expression_generator.py, set_operations_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y8 = 23` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
...
| `SIGFIG_ROUND` | 3 | `SIGFIG_ROUND\|20480\|2 significant figures\|2 × 10^4` | fermi_estimation_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, -7)\|y = -8\|f(y) = -255 (negative)\|down` | stability_generator.py |
| `SIMILAR_APPLY` | 3 | `SIMILAR_APPLY\|8\|3\|24` | scaling_generator.py |
| `SIMILAR_SCALE` | 3 | `SIMILAR_SCALE\|12\|8\|1.5` | scaling_generator.py |
| `SIMILAR_SETUP` | 3 | `SIMILAR_SETUP\|square\|8\|12` | scaling_generator.py |
...
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(-8*e^(-5t) + 9*e^(-3t))*6 + (-6*e^(-5t) + 6*e^(-3t))*3\|-66*e^(-5t) + 72*e^(-3t)` | matrix_exponential_generator.py |
| `SOL_FORM` | 1, 2 | `SOL_FORM\|y = C1e^(-4x) + C2e^(4x)` | ode_system_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `SORT` | 2 | `SORT\|9,15,20,2,1\|1,2,9,15,20` | five_number_summary_generator.py, simple_stats_generator.py |
| `SORT_EDGES` | 1 | `SORT_EDGES\|BD=4, CD=6, BC=7, AC=22, AB=23` | mst_generator.py |
| `SPECIAL_SOLUTION` | 2 | `SPECIAL_SOLUTION\|3 = 3\|identity: true for every x` | radical_equation_generator.py, special_solution_equation_generator.py |
...
| `SQRT_SETUP` | 2 | `SQRT_SETUP\|N = 719104\|groups 71, 91, 04` | manual_square_root_generator.py |
...
| `STATEMENT_EVAL` | 3 | `STATEMENT_EVAL\|Kira says Kira and Quin are different types\|F\|contradiction` | knights_knaves_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(30 + 56) / 2\|43` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|10` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|47\|50\|-3` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|330 / 10\|33` | statistics_generator.py |
| `STAT_FREQUENCY` | 2 | `STAT_FREQUENCY\|18\|1` | statistics_generator.py |
| `STAT_MAD` | 3 | `STAT_MAD\|18\|6\|3` | statistics_generator.py |
| `STAT_MAX` | 1 | `STAT_MAX\|99` | statistics_generator.py |
| `STAT_MEAN` | 2 | `STAT_MEAN\|300 / 6\|50` | statistics_generator.py |
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|position 3\|88` | statistics_generator.py |
...
| `STAT_ORDER` | 1 | `STAT_ORDER\|15, 25, 88, 90, 92` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|99 - 14\|85` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|30, 52, 24, 12, 11, 57, 10, 45, 46, 43` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|30 + 52 + 24 + 12 + 11 + 57 + 10 + 45 + 46 + 43\|330` | statistics_generator.py |
...
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 66 + 24*(x - 3) + 28*(y - 3)` | gradient_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|divergence theorem\|F=<-x, 3*y, 3*z>\|box 9 by 4 by 3` | vector_theorem_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|z_part * r_part * angle\|2*121/2*25/2*2*pi\|3025*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 2*z\|cylinder radius 5, height 11\|cylindrical` | triple_integral_generator.py |
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|2x + 13\|4x + 7\|x + 62` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|7x + 82 = 180\|x = 14` | angle_relationships_generator.py |
| `TRI_ANGLE_SUM` | 1 | `TRI_ANGLE_SUM\|(2x + 13) + (4x + 7) + (x + 62) = 180` | angle_relationships_generator.py |
...
| `TT_COLUMN` | 2 | `TT_COLUMN\|formula 1\|TTTTFFTT` | truth_table_generator.py |
...
| `UNIT_ATTACH` | 3 | `UNIT_ATTACH\|333\|miles\|333 miles` | cross_section_generator.py, kinematics_generator.py, physics_formula_generator.py |
...
| `UNIT_RATE_DIV` | 3 | `UNIT_RATE_DIV\|450¢\|10\|45¢` | unit_rate_generator.py |
| `UNIT_RATE_PICK` | 2 | `UNIT_RATE_PICK\|4\|40` | unit_rate_generator.py |
| `UNIT_RATE_SETUP` | 3 | `UNIT_RATE_SETUP\|10\|cookies\|450¢` | unit_rate_generator.py |
| `UNIT_RATE_TABLE` | 2 | `UNIT_RATE_TABLE\|4,5,9\|40,50,90` | unit_rate_generator.py |
...
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y) = <5*x + 4*y, 5*x + 3*y>\|divergence and scalar curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|12288*3 + (-9477)*5\|-10521` | diagonalization_generator.py |
...
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 9 × 4\|18.0` | round_solids_generator.py, volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 4 × 6 × 9\|216` | round_solids_generator.py, volume_3d_generator.py |
| `VOL_FORMULA` | 1 | `VOL_FORMULA\|V = l × w × h` | round_solids_generator.py, solid_revolution_generator.py, volume_3d_generator.py |
| `VOL_SETUP` | 2 | `VOL_SETUP\|rectangular_prism\|l=4, w=6, h=9` | volume_3d_generator.py |
| `VOP_FORM` | 2 | `VOP_FORM\|u1' = -y2*g/W\|-60/3 * e^(5x)` | variation_parameters_generator.py |
...
| `WALK_TERM` | 3 | `WALK_TERM\|via 1\|A[3,1]*A[1,2]\|0` | graph_counting_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|18 - 36\|-18` | line_integral_generator.py |
