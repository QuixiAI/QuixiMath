...
| `ESTIMATE` | 2 | `ESTIMATE\|30957 × 17717 ≈ 30000 × 20000\|600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|600000000\|548465169\|548465169 ≈ 600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 8:11\|line 4 multiplies 8 by 7` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(54, 8)\|P(65.2 < X < 70)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(21x^5 + 35x^4 + 7x^2 - 35x^2) / (7x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(21x^5) / (7x^2) + (35x^4) / (7x^2) + (7x^2) / (7x^2) + (-35x^2) / (7x^2)` | polynomial_div_monomial_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(65.2 - 54)/8\|1.40` | normal_table_generator.py |
