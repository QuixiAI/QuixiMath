...
1738 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|3x - 5 = 19` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|4x + 9 ≥ 12 -> x ≥ 3/4` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|abs(4x + 9) ≥ 12` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for >` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|4x + 9 ≥ 12 or 4x + 9 ≤ -12` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(3x - 5) = 19` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|3x - 5 = 19\|3x - 5 = -19` | absolute_value_equation_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 6/10, P(B) = 1/10, mutually exclusive\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `ALG_SETUP` | 3 | `ALG_SETUP\|insertion sort\|passes 3\|values 38, 26, 35, 2, 21, 8, 27` | algorithm_trace_generator.py |
...
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda m. (m t)\|lambda z. (z t)` | lambda_reduction_generator.py |
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|3 cos(3x)\|sin(3x)` | antiderivative_generator.py, arc_length_generator.py, area_between_curves_generator.py, definite_integral_generator.py, improper_integral_generator.py, integrating_factor_generator.py, integration_by_parts_generator.py, ode_substitution_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py, variation_parameters_generator.py |
...
| `APPLY_OPERATOR` | 2 | `APPLY_OPERATOR\|L[Ae^(-x)]\|A(1 + 3 + 2)e^(-x)` | commutator_generator.py, undetermined_coeff_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 4, central angle 55°\|sector area` | arc_sector_generator.py |
| `AREA` | 1 | `AREA\|66` | geometry_area_perimeter_generator.py |
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|5^3/3\|125/3` | centroid_generator.py |
...
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 - 7x - 9 and y = 5x - 36\|area between the curves` | area_between_curves_generator.py |
...
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|26, 38, 35, 2, 21, 8, 27` | algorithm_trace_generator.py |
...
| `ATA` | 2 | `ATA\|A^T A\|[[9161, 7480], [7480, 9161]]` | svd_generator.py |
...
| `AV_VECTOR` | 2 | `AV_VECTOR\|A*v1\|[129/√2, 129/√2]` | svd_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 44, disease=no 85\|sensitivity 3/4, specificity 4/5\|P(disease=no given test negative)` | conditional_probability_generator.py |
...
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables K, L, M, N\|CNF from F=0 rows` | boolean_algebra_generator.py |
...
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|363 <= 500\|yes` | piecewise_evaluation_generator.py |
...
| `CBRT` | 2 | `CBRT\|8t^3\|2t` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
...
| `CEIL` | 2 | `CEIL\|322.6944\|323` | confidence_interval_generator.py |
...
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(625/4)/(125/3)\|15/4` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= x^2\|0 <= x <= 5\|centroid` | centroid_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*dx/dt + f_y*dy/dt\|47*3 + 11*1\|152` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(1)\|3*1 + 4\|7` | multivar_chain_rule_generator.py |
...
| `CHAR_EQ` | 2 | `CHAR_EQ\|assume y=e^(rx)\|r^2 - r - 6 = 0` | ode_system_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^2 + λ - 2\|(λ + 2)*(λ - 1)` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|row 1: 96, 184; row 2: 24, 96; N = 400\|independence; df = 1, critical value = 3.841` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|96 - 84 = 12\|12^2 = 144\|144/84 = 12/7` | chi_square_generator.py |
...
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|triangle inscribed in a circle with one side a diameter; one acute angle is 43°\|the other acute angle` | circle_angle_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(-1)*4^2*pi\|-16*pi` | vector_theorem_generator.py |
...
| `CLAUSE` | 2 | `CLAUSE\|C1\|(P5736 ∨ ¬P80724 ∨ P85767)` | resolution_proof_generator.py |
...
| `CMP` | 3 | `CMP\|44\|9\|>` | fraction_comparison_generator.py, graph_interpret_generator.py, integers_as_pairs_generator.py, logical_connective_eval_generator.py, rationals_as_pairs_generator.py, set_builder_roster_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(K OR NOT L OR M OR N) AND (NOT K OR L OR NOT M OR N) AND (NOT K OR NOT L OR M OR NOT N) AND (NOT K OR NOT L OR NOT M OR NOT N)` | boolean_algebra_generator.py |
...
| `COEFFS` | 1, 2 | `COEFFS\|1, 0, -5, -1\|0 inserted for missing x^2 term` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COEFF_MATCH` | 2 | `COEFF_MATCH\|x^n\|(n+1)a_(n+1) = -4a_n` | series_solution_generator.py |
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=0, j=7\|3i + 5j = 35\|accepted` | generating_function_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[1, -3], [-1, 4]]` | determinant_generator.py |
...
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2\|[[7, 2, -7], [3, 1, -3]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(3,1)\|3` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = -6*v1 - 2*v2\|[-8, 6]` | diagonalization_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|C(8, 7)\|n!/(r!·(n-r)!)` | counting_classics_generator.py, permutation_combination_generator.py, stars_and_bars_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|13 - 9\|4` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|300/(-100)\|-3` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMPARE` | 2, 3 | `COMPARE\|3 > 1\|log_b(a) > k` | algorithm_trace_generator.py, equilibrium_ice_generator.py, fixed_point_generator.py, master_theorem_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|x + 1 < 1 -> x < 0` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|x + 1 < 1 or x + 1 > 8` | compound_inequality_generator.py |
...
| `COND_COUNT` | 2 | `COND_COUNT\|club=no and commute=bike\|14` | conditional_probability_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 27, no/bike 14, yes/bus 13, no/bus 14\|P(commute=bike given club=no)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|club=no total\|14 + 14 = 28` | conditional_probability_generator.py |
...
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|x + y = 6\|x = 6/2\|3` | lagrange_multiplier_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[-6, -2]` | diagonalization_generator.py |
...
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|4*x - y - 3 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|4*10 - (-1)^2\|39` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=2\|ln(4)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|10·EF = 30·16` | similar_triangles_generator.py, triangle_solve_generator.py |
...
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 6x^2 - 36x + 6\|inflection point and concavity` | curve_analysis_generator.py |
...
| `CX_SETUP` | 2 | `CX_SETUP\|(-5 - i)(9 + 8i)\|multiply` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|E X\|{X}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|B\|b` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string baaab\|length 5` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{B,E} x {E,X}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|b\|{B,E}` | cyk_parser_generator.py |
...
| `DEGREE_SEQUENCE` | 1 | `DEGREE_SEQUENCE\|3, 2, 2, 2, 2, 1` | graph_counting_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 5x^5 - 4x^4 + 5x^2 - 4x\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -1], [1, 0], [1, 1]]\|y = [24, 16, 20]` | least_squares_generator.py |
...
| `DFA_INPUT` | 1 | `DFA_INPUT\|000011` | dfa_simulation_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[1, 1], [-1, 0]]\|D = [[4, 0], [0, 9]]\|P^-1 = [[0, -1], [1, 1]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[-42, 12, 66]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 3*x^2 + 3*y^2 - 2*x*y - 6*x - 5*y\|point (-2, -3)\|dx=-2/5, dy=-1/4` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|(-12)*(-2/5) + (-19)*(-1/4)\|9.55` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|63504\|62720\|784` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `DISC_CLASSIFY` | 2 | `DISC_CLASSIFY\|44 > 0\|two real solutions` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|16x - 55 = 9` | systems_substitution_generator.py |
...
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited A\|A=0, B=5, C=8, D=6` | dijkstra_generator.py |
...
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y + R_z\|5 + 1 + 6\|12` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|54x\|6\|9x` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT R AND NOT S AND NOT T) OR (NOT R AND NOT S AND T) OR (NOT R AND S AND NOT T) OR (NOT R AND S AND T) OR (R AND S AND NOT T) OR (R AND S AND T)` | boolean_algebra_generator.py |
...
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|denominator ≠ 0\|x^2 + 1 ≠ 0` | domain_range_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(3, 2) · (-3/5, 4/5)\|3*(-3/5) + 2*4/5\|-0.2` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=4,v=2); 2:(w=2,v=7); 3:(w=2,v=7); 4:(w=2,v=3)` | dp_table_generator.py |
| `DP_ROW` | 2 | `DP_ROW\|i=0\|1, 0, 0, 0, 0, 0` | dp_table_generator.py |
| `DP_SETUP` | 2, 3 | `DP_SETUP\|coin change\|target 5` | dp_table_generator.py |
| `D_POWER` | 2 | `D_POWER\|D^4\|[[625, 0], [0, 1]]` | diagonalization_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|AD\|weight 1\|add A` | mst_generator.py |
...
| `EDGE_LIST` | 1 | `EDGE_LIST\|AC, AD, BC, BD, CD` | euler_circuit_generator.py |
...
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 2I\|[[0, 4], [0, 3]]` | eigenvalue_generator.py |
...
| `EQUATE_EXP` | 1 | `EQUATE_EXP\|3x - 1 = 5` | exponential_equation_generator.py |
| `EQUILIBRIA` | 2 | `EQUILIBRIA\|f(y) = 0\|y=-6, y=4` | stability_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(7, -5)\|(11, 5)` | equation_from_two_points_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|57638 × 24076 ≈ 60000 × 20000\|1200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1.8 × 10^4\|18432\|rounded estimate` | fermi_estimation_generator.py, long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|D\|route suffix D\|stack C-A-D-B-C` | euler_circuit_generator.py |
...
| `EULER_ROUTE` | 2 | `EULER_ROUTE\|C-A-D-B-C-D\|uses 5 edges` | euler_circuit_generator.py |
...
| `EVAL_PARTIAL` | 3 | `EVAL_PARTIAL\|f_x\|6*2 + 3*4 - 1\|23` | gradient_generator.py, multivar_chain_rule_generator.py |
...
| `EV_SETUP` | 2 | `EV_SETUP\|P(win $8) = 17/20; P(win $1) = 1/10; P(win $9) = 1/20\|fair? cost = $3` | expected_value_generator.py |
| `EXACT_MATCH` | 2 | `EXACT_MATCH\|F_y = N\|-2*x + g'(y) = -2*x + 6*y + 5` | exact_ode_generator.py |
...
| `EXP_CELL` | 2 | `EXP_CELL\|(280·120)/400\|84` | chi_square_generator.py |
| `EXP_DIAG` | 2 | `EXP_DIAG\|e^(Dt)\|[[e^t, 0], [0, e^(2t)]]` | matrix_exponential_generator.py |
| `EXP_ENTRY` | 3 | `EXP_ENTRY\|(1,1)\|-8*e^t + 9*e^(2t)\|-8*e^t + 9*e^(2t)` | matrix_exponential_generator.py |
...
| `FACTOR_GROUP` | 3 | `FACTOR_GROUP\|9n^2 + 6n\|3n\|(3n + 2)` | conic_standard_form_generator.py, curve_analysis_generator.py, derivative_limit_def_generator.py, factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-55 - 9 = -64, not -48` | error_spotting_generator.py |
...
| `FLUX_SUM` | 2 | `FLUX_SUM\|(2 + 3 + 5)*100\|1000` | vector_theorem_generator.py |
| `FOCUS` | 1 | `FOCUS\|(4, -6)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (-5) * 9\|-45` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(5 + √7)(4 + √7)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|15/-23\|-15/23` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|43/40\|1.075` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|histogram — 50-59: 11, 60-69: 3, 70-79: 11, 80-89: 11, 90-99: 4\|cumulative count up to 90-99` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(p - q)(1)\|p(1) - q(1)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|g(x) = -3x^2 - 6x + 9\|g(-6)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|54, 12\|6` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_RESULT` | 1 | `GCF_RESULT\|6` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_VAR` | 2 | `GCF_VAR\|n^3, n^2, n\|n` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude h = 46 to the hypotenuse; one segment p = 92\|the other segment q` | geometric_mean_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^35]\|1/((1 - x^3)(1 - x^5))` | generating_function_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = 3*x^2 + 5*y^2 + 3*x*y - x + 4*y\|point (2, 4)\|tangent` | gradient_generator.py |
...
| `GRAPH_SETUP` | 2 | `GRAPH_SETUP\|vertices A, B, C, D, E, F\|edges AB, AE, BC, BD, CF, DE` | dijkstra_generator.py, euler_circuit_generator.py, graph_counting_generator.py, graph_traversal_generator.py |
...
| `GROUP` | 2 | `GROUP\|(9n^2 + 6n)\|(-3n - 2)` | factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `GS_SETUP` | 2 | `GS_SETUP\|vectors [[2, 0, 2], [-1, 0, -3], [-7, 1, -5]]\|orthogonal basis, not normalized` | gram_schmidt_generator.py |
...
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|4*10 - (-1)^2\|39` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = 2*x^2 + 5*y^2 - x*y - 3*x - 9*y\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = 39\|f_xx = 4\|local minimum` | hessian_classify_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|2x^4 + 5x^3 + x^2 - 2x + 5\|x = -4` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: μ = 48; Ha: μ ≠ 48\|n = 400, x̄ = 49, s = 80, critical value = 2.326` | hypothesis_test_generator.py, two_sample_test_generator.py |
...
| `HYPERCUBE_SETUP` | 2 | `HYPERCUBE_SETUP\|3-cube with side 3\|main diagonal` | hypercube_counting_generator.py |
...
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=9..82 C(i,9) = C(83,10)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=22, n(B)=20, n(C)=20\|n(AB)=5, n(AC)=3, n(BC)=5, n(ABC)=2` | inclusion_exclusion_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|add\|7\|-3 ≤ 2x ≤ 17` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INITIAL_COEFF` | 2 | `INITIAL_COEFF\|a_0\|18600` | series_solution_generator.py |
| `INITIAL_EQ` | 2 | `INITIAL_EQ\|C1 + C2\|0` | recurrence_generator.py |
| `INITIAL_SYSTEM` | 2 | `INITIAL_SYSTEM\|C1[1, 0] + C2[1, 1]\|[-6, -2]` | ode_system_generator.py |
...
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 0\|26, 38, 35, 2, 21, 8, 27` | algorithm_trace_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ 3 cos(3x) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + x + 4 on [1, 2]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|5*5 - 0*(-2)\|25` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[5, 0], [-2, 5]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = 5*u\|y = -2*u + 5*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
...
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|0001\|NOT J AND NOT K AND NOT L AND M` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|JK=00\|0, 1, 0, 0` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows JK=00,JK=01,JK=11,JK=10\|columns LM=00,LM=01,LM=11,LM=10` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|(NOT J AND NOT K AND NOT L AND M) OR (NOT J AND K AND L AND M) OR (J AND NOT K AND NOT L AND NOT M) OR (J AND NOT K AND L AND M)` | boolean_algebra_generator.py |
...
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = x*y\|constraint x + y = 6\|maximize` | lagrange_multiplier_generator.py |
...
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|((lambda h. ((s h) h)) s)\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→3 of (x^2 - 9x + 18)/(x - 3)\|0/0: factor and cancel` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
...
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|326/2 - 168\|-5` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = x - 3\|(2, 7)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <10*x - 2*y, 10*y - 2*x + 1>\|from (4, 2) to (1, 3)` | line_integral_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(2x)) = ln(5)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_EVAL` | 2 | `LOG_EVAL\|26/5\|ln(26/5)` | hyperbolic_distance_generator.py |
| `LOG_EXACT` | 2 | `LOG_EXACT\|log_10(1000)\|3` | master_theorem_generator.py |
...
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|3x + 9 = x - 9` | log_equation_generator.py |
...
| `LOG_PRODUCT` | 1, 2 | `LOG_PRODUCT\|log_5(25x^3y^2)\|log_5(25x^3) + log_5(y^2)` | log_equation_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_3(x^4) - log_3(y)\|log_3(x^4/y)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|4log_3(x) - log_3(y)\|condense` | complex_log_generator.py, log_properties_generator.py |
...
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-1, 24), (0, 16), (1, 20)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_RESULT` | 2 | `LU_RESULT\|L\|[[1, 0, 0], [-3, 1, 0], [2, -1, 1]]` | lu_decomposition_generator.py |
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[-5, 5, 2], [15, -20, -1], [-10, 15, 0]]\|unit lower L` | lu_decomposition_generator.py |
...
| `MASTER_CASE` | 2 | `MASTER_CASE\|case 3\|Θ(n^3)` | master_theorem_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[0, 3], [5, 1]], B = [[6, -6], [-5, -4]]\|A + B` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
| `MAX` | 2, 3 | `MAX\|9, 8\|9` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
| `MAXIMAL` | 1 | `MAXIMAL\|{55, 58}` | partial_order_generator.py |
| `MAXTERM` | 2 | `MAXTERM\|0100\|K OR NOT L OR M OR N` | boolean_algebra_generator.py |
...
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=0,mid=1,hi=2\|left 48; right 16` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|48\|16\|take right` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 0-1\|array 16, 48, 15, 33, 27` | algorithm_trace_generator.py |
| `MERGE_TAKE` | 2 | `MERGE_TAKE\|16\|merged 16` | algorithm_trace_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 156 · (1/2)^(6/3)` | exponential_model_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|5^5/10\|625/2` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|5^4/4\|625/4` | centroid_generator.py |
...
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|15 / -5\|-3` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|8 * -7\|-56` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(8x^2)(-7x^8)` | monomial_mult_div_generator.py |
...
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|1 W, 3 A's, 5 O's, 4 U's\|total 13` | stars_and_bars_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 + 5x - 6 on [-2, 0]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 4*x^2 + 5*y^2 + 4*x*y - x + 3*y\|x = 3*t + 4, y = t - 3\|t = 1` | multivar_chain_rule_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 adds 9, giving 28\|line 4 divides by 4` | fill_in_step_generator.py |
...
| `NET_SETUP` | 2 | `NET_SETUP\|2 rectangles 2 by 11; 2 rectangles 2 by 9; 2 rectangles 11 by 9\|total surface area` | nets_surface_area_generator.py |
...
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|r0\|{r2}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|bcababcbb` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{u0}\|b\|u0->{u0}\|{u0}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|b` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states u0, u2, u8\|alphabet a, b, c\|start u0` | nfa_simulation_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(62, 25)\|is x = 2 unusual?` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
...
| `NO_REDEX` | 2 | `NO_REDEX\|((s s) s)\|no beta redex remains` | lambda_reduction_generator.py |
...
| `NULL_REL` | 2 | `NULL_REL\|x1 + 3*x3 = 0\|x1 = -3*x3` | subspace_basis_generator.py |
...
| `OPT_SETUP` | 2 | `OPT_SETUP\|square sheet 84 by 84; cut corners x and fold\|maximize volume` | optimization_generator.py |
...
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|6*x^2 + 117*x` | double_integral_generator.py |
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|y=0..14\|8*2*7^2/2\|392` | double_integral_generator.py |
...
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(-3*t + 2, -8*t + 4)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = t + 9, y = -5t - 20\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|15/((x + 2)(x - 3)) = A/(x + 2) + B/(x - 3)` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|1/(s + 1) - 3/(s - 1)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|8*x*y + 5*y` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|5*x*y\|d/dx\|5*y` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 4*x^2*y + 5*x*y\|f_x` | partial_derivative_generator.py |
...
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = -145x, dv = sin(x) dx\|du = -145 dx, v = -cos(x)` | integration_by_parts_generator.py |
...
| `PASCAL_SETUP` | 1 | `PASCAL_SETUP\|12C9` | pascal_triangle_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|1.9\|2255\|4284.5` | percent_problem_generator.py |
...
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|80*2/4\|40` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 5 = 5/2(x - 7)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|(x, y) = (-896, -528)\|polar (r ≥ 0, 0° ≤ θ < 360°)` | parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|4y^3 + 16y^2 + 13y - 12\|2y + 5` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|3x^2 + 10x + 10` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(-4x^5 - 4x^3) / (4x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-4x^5) / (4x) + (-4x^3) / (4x)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(3x^2) + (x +9x) + (1 +9)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|x + 2` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x + 1)(-5x^2 + x - 2)` | multiplying_polynomials_generator.py |
...
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(3x^2 + x + 1) - (-9x - 9)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(4y^3 + 16y^2) - (4y^3 + 10y^2)\|6y^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
...
| `POTENTIAL_BUILD` | 3 | `POTENTIAL_BUILD\|integrate P dx\|5*x^2 - 2*x*y + g(y)\|g'(y) remains` | exact_ode_generator.py, line_integral_generator.py |
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|5*x^2 + 5*y^2 - 2*x*y + y` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(7/10)^7\|0.0823543` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|(-3750) + 7\|-3743` | diagonalization_generator.py |
...
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited D\|AD=1, CD=11, BD=14` | mst_generator.py |
...
| `Q1` | 4 | `Q1\|-252\|28\|14\|-16` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|-252\|28\|14\|-20` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QN_ADD` | 4 | `QN_ADD\|Q\|left\|0 + p(1)\|1` | conservation_law_generator.py |
| `QR_ENTRY` | 2 | `QR_ENTRY\|q1\|[1, 0, 0]` | qr_decomposition_generator.py |
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[1, 1, 5], [0, 3, -1], [0, 0, 3]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
...
| `QUARTILE` | 3 | `QUARTILE\|Q1\|5,5,6,14,15\|6` | five_number_summary_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|136 cm ladder; the base slides away at 1 cm/s; base is 120 cm from the wall\|dy/dt` | related_rates_generator.py |
| `RATIO` | 2, 3 | `RATIO\|y = x\|y = x` | lagrange_multiplier_generator.py, simplex_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|√110/√110` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 57949 / 1.735` | percent_problem_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = 6 a_(n-1) - 8 a_(n-2) + 18\|a_0 = 6, a_1 = 10` | master_theorem_generator.py, recurrence_generator.py |
...
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q47293_3, q47293_4` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|(a or b)*(ab or ba)\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q47293_0\|start` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q47293_0\|a\|q47293_1` | regex_to_automaton_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 66), (2, 64), (3, 67), (4, 68), (5, 65)\|coefficient of determination r^2` | regression_generator.py |
| `REJECT` | 1, 2 | `REJECT\|x = −45` | conditional_forms_generator.py, counterexample_search_generator.py, factor_trinomial_generator.py, knights_knaves_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py, set_builder_roster_generator.py |
| `RELAX` | 3 | `RELAX\|A->B\|update inf to 5\|via weight 5` | dijkstra_generator.py |
...
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (5, 33), line ŷ = 37.7 - 0.9x\|residual = observed − predicted` | regression_generator.py |
| `RESOLVE` | 3 | `RESOLVE\|C2\|C3\|P13448` | resolution_proof_generator.py |
...
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(P5736 ∨ ¬P80724 ∨ P85767), C2=(P13448), C3=(¬P13448)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C2\|(P99453 ∨ ¬P99453)` | resolution_proof_generator.py |
...
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, 3, 0], [0, 1, -4, 0], [0, 0, 0, 0]]` | subspace_basis_generator.py |
...
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x10 = 35\|xi >= 0` | stars_and_bars_generator.py |
...
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = 4\|16*(-6)\|-96` | diagonalization_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(5, 7), B(-16, 14); ratio 2:5 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_16 = 9 + (16 - 1)·4` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|9, 13, 17, 21, ...\|sum of first 16 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ (7n + 6)/(17n + 20), n ≥ 1\|converge or diverge?` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
...
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|57949 = 1.735 * whole` | percent_problem_generator.py |
...
| `SIGFIG_ROUND` | 3 | `SIGFIG_ROUND\|18432\|2 significant figures\|1.8 × 10^4` | fermi_estimation_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|12 + 24 + 48 + 96 + 192` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=0)^(4) 12·2^k\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=0\|12·2^0\|12` | sigma_notation_generator.py |
...
| `SIGN_CHART` | 2 | `SIGN_CHART\|zeros\|-2, 0, 3` | polynomial_inequality_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, -6)\|y = -7\|f(y) = 11 (positive)\|up` | stability_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; AB = 10, DE = 30, BC = 16\|find EF` | similar_triangles_generator.py |
...
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = -2cos(2(x - π/4)) + 3\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_INT_IDENTIFY` | 2 | `SLOPE_INT_IDENTIFY\|Slope (m)\|91` | slope_intercept_form_generator.py |
| `SLOPE_INT_MATCH` | 2 | `SLOPE_INT_MATCH\|Compare to Slope-Intercept Form\|y = mx + b` | slope_intercept_form_generator.py |
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = 91x - 22` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|5/2` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(5, 4)\|(9, 6)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (6 - 4) / (9 - 5)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOLUTIONS` | 2 | `SOLUTIONS\|tan x = 1\|45°, 225°, 405°, 585°, 765°, 945°, 1125°, 1305°, 1485°, 1665°, 1845°, 2025°, 2205°, 2385°, 2565°, 2745°, 2925°, 3105°, 3285°, 3465°, 3645°, 3825°, 4005°, 4185°, 4365°, 4545°, 4725°, 4905°, 5085°, 5265°, 5445°, 5625°, 5805°, 5985°, 6165°, 6345°, 6525°, 6705°, 6885°, 7065°, 7245°, 7425°, 7605°, 7785°, 7965°, 8145°, 8325°, 8505°, 8685°, 8865°, 9045°, 9225°, 9405°, 9585°, 9765°, 9945°, 10125°, 10305°, 10485°, 10665°, 10845°, 11025°, 11205°, 11385°` | trig_equation_generator.py |
...
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(-8*e^t + 9*e^(2t))*5 + (12*e^t - 12*e^(2t))*(-5)\|-100*e^t + 105*e^(2t)` | matrix_exponential_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|AD=2, BC=16, AC=17, AB=18, BD=21` | mst_generator.py |
...
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|3n = 6n - 3n\|9n^2 + 6n - 3n - 2` | factor_trinomial_generator.py |
...
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|18176\|256 × 71\|256` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `SUBSTITUTE` | 2 | `SUBSTITUTE\|h:=s in ((s h) h)\|((s s) s)` | lambda_reduction_generator.py |
...
| `SUM` | 2, 3 | `SUM\|66 + 64 + 67 + 68 + 65\|330` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
...
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = (y + 1)/2` | inverse_function_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|x^3 - 5x - 1\|r = 1` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|1, 1, -4, -5` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: 4y = 0` | systems_elimination_generator.py |
...
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * -4, Eq2 * -3` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|12x - 4y = -136\|-12x - 3y = 66` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|y = 4x - 11\|-4x + 5y = 9` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute (4x - 11) for y in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute x=4 into Eq 1` | systems_elimination_generator.py, systems_substitution_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|f(5)\|20` | de_moivre_generator.py, dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, lie_exponential_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 130 + 23*(x - 2) + 50*(y - 4)` | gradient_generator.py |
...
| `TAYLOR_SETUP` | 2 | `TAYLOR_SETUP\|f(x) = e^x\|approximate e^0.3 with P_2` | taylor_series_generator.py |
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|all middle factors cancel\|55/145` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Π k=55..144 k/(k+1)` | telescoping_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Stokes\|F=<y, 0, 0>\|disk radius 4 in z=0` | vector_theorem_generator.py |
...
| `TRANSFORM_APPLY` | 2 | `TRANSFORM_APPLY\|((-2), -(1))\|(-2, -1)` | transformation_generator.py |
| `TRANSFORM_RULE` | 1 | `TRANSFORM_RULE\|(x, y) → (x, -y)` | transformation_generator.py |
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(-2, 1)\|reflection over the x-axis, then rotation 90° counterclockwise about the origin` | rv_transform_generator.py, transformation_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: leg opposite A = 48, leg adjacent to A = 14, hypotenuse = 50\|sin A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|z_part * r_part * angle\|4*8*72*2*pi\|4608*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 4*z\|cylinder radius 12, height 4\|cylindrical` | triple_integral_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|45-45-90 triangle, hypotenuse = 552\|leg` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|44, 47, 50, 53\|arithmetic, d = 3` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|5 - 5.4 = -0.4\|(-0.4)^2 = 0.16\|1/5·0.16 = 0.032` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|13` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y,z) = <5*x + 4*y - 3*z, 3*x + y - 4*z, -6*x + 5*y + 6*z>\|divergence and curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|(-96) + (-162)\|-258` | diagonalization_generator.py |
| `VEC_SETUP` | 2 | `VEC_SETUP\|v = ⟨0, -6⟩\|magnitude` | dot_product_generator.py, vector_ops_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region under y = x(429 - x) on [0, 429], rotated about the y-axis\|shell method` | solid_revolution_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|47 - 86\|-39` | line_integral_generator.py |
...
| `ZERO_PRODUCT` | 2 | `ZERO_PRODUCT\|(x + 2)x(x - 3)\|x = -2 or x = 0 or x = 3` | area_between_curves_generator.py, curve_analysis_generator.py, domain_range_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_equation_generator.py, trig_equation_generator.py |
| `ZSCORE` | 2 | `ZSCORE\|(125 - 119)/2\|3` | normal_table_generator.py, z_score_generator.py |
