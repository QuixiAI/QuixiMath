...
258 distinct op-codes observed.
...
| `CHECK` | 3 | `CHECK\|multiply_back\|23×98+45=2299\|2299` | factor_gcf_generator.py, factor_trinomial_generator.py, linear_fractional_generator.py, long_division_generator.py, ratio_table_generator.py, special_solution_equation_generator.py, systems_elimination_generator.py, tip_bill_split_generator.py, two_step_equation_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|4x\|4x^3 - 20x^2 - 4x` | multiplying_polynomials_generator.py |
...
| `FOIL_I` | 2 | `FOIL_I\|Inner: (1) * (9x)\|9x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (1) * (8)\|8` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (1x) * (8)\|8x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(x + 1)(9x + 8)` | multiplying_binomials_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 15x^6 - 5x^6 + 5x^4 + 20x^2) / (5x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-15x^6) / (5x^2) + (-5x^6) / (5x^2) + (5x^4) / (5x^2) + (20x^2) / (5x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(4x - 1)(x^2 - 5x - 1)` | multiplying_polynomials_generator.py |
