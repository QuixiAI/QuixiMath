...
499 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|3x - 10 = 16` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|5x + 5 >= 9 -> x >= 4/5` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|5x + 1\| < 18` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|AND case\|-18 < 5x + 1 < 18` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|3x - 10\| = 16` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|3x - 10 = 16\|3x - 10 = -16` | absolute_value_equation_generator.py |
...
| `ACCEPT` | 2 | `ACCEPT\|(-6, 9)\|product -54 ✓, sum 3 ✓` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 4/20, P(B) = 15/20, P(A ∩ B) = 4/20\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `APPROX_SETUP` | 2 | `APPROX_SETUP\|estimate √103\|linearize f(x) = √x at a = 100` | linear_approx_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 12, central angle 45°\|sector area` | arc_sector_generator.py |
...
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = 3 ± (8/15)(x + 5)` | hyperbola_features_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 60, disease=no 92\|sensitivity 7/10, specificity 3/4\|P(disease=yes given test positive)` | conditional_probability_generator.py |
| `BINOM_FORMULA` | 1 | `BINOM_FORMULA\|P(X=k) = C(n,k)·p^k·(1-p)^(n-k)` | binomial_probability_generator.py |
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 7, k = 6, p = 2/5\|P(X = k)` | binomial_probability_generator.py |
| `BORROW` | 3 | `BORROW\|col_1\|from_left\|1` | multi_digit_subtraction_generator.py |
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|78 <= 100\|yes` | piecewise_evaluation_generator.py |
| `BRANCH_USE` | 1 | `BRANCH_USE\|$40.00` | piecewise_evaluation_generator.py |
| `BRING_DOWN` | 2 | `BRING_DOWN\|6\|current = 6` | composite_arithmetic_generator.py |
...
| `CENTER` | 1 | `CENTER\|(1, -1)` | circle_equation_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 29, 21, 21, 29; expected: 25 each\|goodness of fit; df = 3, critical value = 7.815` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|29 - 25 = 4\|4^2 = 16\|16/25 = 0.64` | chi_square_generator.py |
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|inscribed angle 31°\|intercepted arc` | circle_angle_generator.py |
...
| `CI_SETUP` | 2 | `CI_SETUP\|σ = 22, n = 25, z* = 2.05\|margin of error` | confidence_interval_generator.py |
...
| `COEFFS` | 1, 2 | `COEFFS\|2, -5, 1, -10, -7` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[2, 3], [-4, -2]]` | determinant_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|C(4, 2)\|n!/(r!·(n-r)!)` | permutation_combination_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|-16 - (-7)\|-9` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|4/(-8)\|-1/2` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|x + 6 < 4 -> x < -2` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|-8 < 4x - 4 < 16` | compound_inequality_generator.py |
| `COND_COUNT` | 2 | `COND_COUNT\|club=no and commute=bike\|7` | conditional_probability_generator.py |
| `COND_FORMULA` | 1 | `COND_FORMULA\|P(A given B) = count(A and B)/count(B)` | conditional_probability_generator.py |
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 25, no/bike 7, yes/bus 20, no/bus 8\|P(commute=bike given club=no)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|club=no total\|7 + 8 = 15` | conditional_probability_generator.py |
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(y + 6)^2 = 16(x - 1)\|vertex, focus, directrix` | conic_standard_form_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
| `CONJUGATE` | 2 | `CONJUGATE\|2 - 4i\|2 + 4i` | complex_division_generator.py |
...
| `CROSS_MULT` | 1 | `CROSS_MULT\|6·EF = 30·8` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 6x^2 - 15x + 7\|critical points and their nature` | curve_analysis_generator.py |
| `CX_SETUP` | 2 | `CX_SETUP\|i^19\|simplify` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 5x^5 + 7x^2 + 4x - 2\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
...
| `DEV_ROW` | 3 | `DEV_ROW\|32\|3\|9` | standard_deviation_generator.py |
| `DIRECTRIX` | 1 | `DIRECTRIX\|x = -3` | parabola_features_generator.py |
| `DISC` | 2, 3 | `DISC\|4\|0\|4` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-28y + -55 = -27` | systems_substitution_generator.py |
| `DIST_FORMULA` | 1 | `DIST_FORMULA\|d = √((x2 - x1)^2 + (y2 - y1)^2)` | distance_formula_generator.py, hypercube_counting_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|x\|5x^3 - 1x^2 + 1x` | multiplying_polynomials_generator.py |
...
| `DIV_TERM` | 3 | `DIV_TERM\|25x^4\|5x\|5x^3` | factor_gcf_generator.py, polynomial_long_division_generator.py |
...
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(7, -5)\|(9, 1)` | equation_from_two_points_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|42 ÷ 6 = 7, not 5` | error_spotting_generator.py |
| `FOCUS` | 1 | `FOCUS\|(5, -6)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `FOIL_L` | 2 | `FOIL_L\|Last: (-6i) * (-4i)\|24i^2` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|1/-22\|-1/22` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|2/6\|0.3333333333` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Soccer: 12, Tennis: 9, Golf: 12, Track: 2\|relative frequency of Track` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(g + h)(4)\|g(4) + h(4)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|t: -4, 0, 5, 6, 9; h(t): 3, 19, -15, 23, -7\|h(0)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|25, 20, 10\|5` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEOM_SETUP` | 2 | `GEOM_SETUP\|p = 1/5, q = 4/5\|P(X = 6)` | geometric_distribution_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; the altitude splits the hypotenuse into p = 8 and q = 8\|altitude h` | geometric_mean_generator.py |
...
| `GROUP` | 2 | `GROUP\|(4x^2 - x)\|(20x - 5)` | factor_grouping_generator.py, factor_trinomial_generator.py |
| `HA` | 1 | `HA\|y = 7/2` | rational_function_features_generator.py |
| `HOLE` | 1 | `HOLE\|x = 2` | rational_function_features_generator.py |
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|x^4 - 2x^3 + 3x^2 + x + 3\|x = 3` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: μ = 34; Ha: μ ≠ 34\|n = 100, x̄ = 33, s = 5, critical value = 2.576` | hypothesis_test_generator.py |
| `HYPERCUBE_FORMULA` | 1 | `HYPERCUBE_FORMULA\|k-faces of the n-cube: C(n,k) · 2^(n-k)` | hypercube_counting_generator.py |
| `HYPERCUBE_SETUP` | 2 | `HYPERCUBE_SETUP\|points P(-4, -2, 0, 1) and Q(-4, -1, 5, 0) in R^4\|distance` | hypercube_counting_generator.py |
...
| `IDENTITY_SETUP` | 2 | `IDENTITY_SETUP\|verify: sin^2 θ - cos^2 θ = sin^4 θ - cos^4 θ\|transform the right side` | trig_identity_verify_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|1\|-19 < 5x < 17` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (4x^3 - 4x + 3) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + x + 6 on [-3, 0]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
| `I_CYCLE` | 2 | `I_CYCLE\|i^3\|-i` | complex_number_ops_generator.py |
| `I_SQUARE` | 2 | `I_SQUARE\|24i^2\|-24` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→1 of (x^2 + 5x - 6)/(x - 1)\|0/0: factor and cancel` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = -x + 5\|(4, 10)` | parallel_perpendicular_line_generator.py |
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|log_5(5^x) = log_5(50)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_FORM` | 1 | `LOG_FORM\|b^y = x ⟺ log_b(x) = y` | log_conversion_generator.py, log_equation_generator.py |
| `LOG_IDENT` | 2 | `LOG_IDENT\|e^(ln x) = x (inverse functions)\|3` | exponential_equation_generator.py, log_conversion_generator.py |
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|3x - 2 = x + 6` | log_equation_generator.py |
| `LOG_POWER` | 2 | `LOG_POWER\|2log_5(y)\|log_5(y^2)` | log_diff_higher_order_generator.py, log_properties_generator.py |
| `LOG_PRODUCT` | 2 | `LOG_PRODUCT\|log_5(x) + log_5(y^2)\|log_5(xy^2)` | log_equation_generator.py, log_properties_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_5(xy^2) - log_5(z^3)\|log_5(xy^2/z^3)` | log_properties_generator.py |
| `LOG_SETUP` | 2 | `LOG_SETUP\|log_5(x) + 2log_5(y) - 3log_5(z)\|condense` | log_properties_generator.py |
...
| `MAT_ENTRY` | 2 | `MAT_ENTRY\|(1,1)\|8` | matrix_ops_generator.py |
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[0, -4], [0, -2]], B = [[-2, 4], [-2, -2]]\|AB` | determinant_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py |
| `MAX` | 2 | `MAX\|5, 5\|5` | taxicab_geometry_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 4000 · (1 + 0.5)^4` | exponential_model_generator.py |
...
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-40x^8) / (-8x^5)` | monomial_mult_div_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 - 3x + 7 on [-1, 5]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `NCR` | 2 | `NCR\|C(4,1)\|4` | binomial_probability_generator.py, hypercube_counting_generator.py |
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 10:11\|line 4 multiplies 10 by 3` | fill_in_step_generator.py |
| `NET_SETUP` | 2 | `NET_SETUP\|2 rectangles 10 by 10; 2 rectangles 10 by 5; 2 rectangles 10 by 5\|total surface area` | nets_surface_area_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(78, 8)\|raw value for z = -0.625` | normal_table_generator.py, z_score_generator.py |
| `ODE_SETUP` | 2 | `ODE_SETUP\|dy/dx = x^2/y^2, y(0) = 4\|solve` | euler_method_generator.py, logistic_growth_generator.py, separable_ode_generator.py |
...
| `PARAM_SETUP` | 2 | `PARAM_SETUP\|x = t - 2, y = 3t - 5\|eliminate t` | parametric_calculus_generator.py, polar_parametric_generator.py |
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(3x + 8)/(x + 2)^2 = A/(x + 2) + B/(x + 2)^2` | partial_fractions_generator.py |
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = -4x, dv = e^(-x) dx\|du = -4 dx, v = -e^(-x)` | integration_by_parts_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.7\|150\|105` | percent_problem_generator.py |
...
| `PERM_SETUP` | 2 | `PERM_SETUP\|P(8, 2)\|n!/(n-r)!` | permutation_combination_generator.py |
...
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|y = ±6\|y = 6 or y = -6` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
...
| `POLAR_SETUP` | 2 | `POLAR_SETUP\|r = 3\|rectangular equation` | parametric_calculus_generator.py, polar_parametric_generator.py |
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|9x^3 + 9x^2 - 22x - 28\|3x + 5` | polynomial_long_division_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-7x^2 - 3x - 14` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 1x^6 - 2x^5 + 4x^3 - 1x^2) / (-x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-1x^6) / (-x^2) + (-2x^5) / (-x^2) + (4x^3) / (-x^2) + (-1x^2) / (-x^2)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-7x^2) + (-9x +6x) + (-6 -8)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 3)(5x^2 - x + 1)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-9x - 6) + (-7x^2 + 6x - 8)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2 | `POLY_SUB\|(9x^3 + 9x^2) - (9x^3 + 15x^2)\|-6x^2` | polynomial_long_division_generator.py |
| `POW` | 2 | `POW\|(2/5)^6\|0.004096` | binomial_probability_generator.py, geometric_distribution_generator.py |
| `POWER_RULE` | 2 | `POWER_RULE\|5x^5\|25x^4` | chain_rule_generator.py, curve_analysis_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, lhopital_generator.py, linear_approx_generator.py, log_diff_higher_order_generator.py, mean_value_theorem_generator.py, optimization_generator.py, tangent_line_generator.py |
...
| `Q1` | 4 | `Q1\|-2\|2\|4\|0` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|-2\|2\|4\|-1` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|147°\|quadrant II` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
| `QUARTILE` | 3 | `QUARTILE\|Q1\|13,14,17,22,24,24,27\|22` | five_number_summary_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|circle: dr/dt = 5 cm/s; r = 10 cm\|dA/dt` | related_rates_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 60 / 0.25` | percent_problem_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 54), (2, 52), (3, 55), (4, 51), (5, 53)\|correlation coefficient r` | regression_generator.py |
| `REJECT` | 2 | `REJECT\|(-1, 54)\|sum is 53, need 3` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (5, 71), line ŷ = 68.2 + 0.6x\|residual = observed − predicted` | regression_generator.py |
| `REVERSE` | 2 | `REVERSE\|1,0,1,0,1,0,0,1\|10010101` | base_conversion_generator.py |
...
| `RIEMANN_SETUP` | 2 | `RIEMANN_SETUP\|f(x) = 3x + 3 on [-2, 2], n = 4\|trapezoid rule` | riemann_sum_generator.py |
...
| `ROW_OP` | 2 | `ROW_OP\|R2 → R2 - 3·R1\|[0, 1, -1, 0]` | row_reduction_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(5, -3), B(-22, -30); ratio 5:4 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_28 = -7 + (28 - 1)·-9` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|-7, -16, -25, -34, ...\|sum of first 28 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ n/(n^2 + 3), n ≥ 1\|converge or diverge?` | power_series_generator.py, series_convergence_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 0.7 * 150` | percent_problem_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|3 + 6 + 12 + 24` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=0)^(3) 3·2^k\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=0\|3·2^0\|3` | sigma_notation_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; AB = 6, DE = 30, BC = 8\|find EF` | similar_triangles_generator.py |
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = -5sin(6(x - π/3)) - 3\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -9 - 5x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|3` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(1, 5)\|(-3, -9)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-9 - 5) / (-3 - 1)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
| `SLOPE_UNDEFINED` | 1 | `SLOPE_UNDEFINED\|Division by zero` | slope_two_points_generator.py |
| `SOLUTIONS` | 2 | `SOLUTIONS\|sin x = 1\|90°` | trig_equation_generator.py |
...
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|19x = -x + 20x\|4x^2 - x + 20x - 5` | factor_trinomial_generator.py |
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|y^2 = 36\|y = ±6` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `SQRT_NEG` | 2 | `SQRT_NEG\|√(-44)\|i√44` | complex_quadratic_generator.py, polynomial_zeros_generator.py |
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(3x - 36) = x - 12\|3x - 36 = (x - 12)^2` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|98\|49 × 2\|49` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `SUM` | 2 | `SUM\|54 + 52 + 55 + 51 + 53\|265` | regression_generator.py |
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = 2y - 5` | inverse_function_generator.py |
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|2x^4 - 5x^3 + x^2 - 10x - 7\|r = 3` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_DROP` | 1 | `SYN_DROP\|2` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_ROW` | 1 | `SYN_ROW\|2, 1, 4, 2, -1` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = 4y + -25` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * 3, Eq2 * 2` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|6x + 6y = 72\|-6x - 8y = -90` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x = 5y + 11\|-5x - 3y = -27` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute (5y + 11) for x in Eq 2` | systems_substitution_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(0)\|19` | dot_product_generator.py, function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
...
| `TERM` | 2 | `TERM\|i=0: 1·(1/3)^0·(2/3)^5\|32/243` | binomial_probability_generator.py |
...
| `TRANSFORM_APPLY` | 2 | `TRANSFORM_APPLY\|((5) - 5, (-8) + 4)\|(0, -4)` | transformation_generator.py |
| `TRANSFORM_RULE` | 1 | `TRANSFORM_RULE\|(x, y) → (x - 5, y + 4)` | transformation_generator.py |
| `TRANSFORM_SETUP` | 2 | `TRANSFORM_SETUP\|P(5, -8)\|translation by (-5, 4)` | transformation_generator.py |
| `TRIG_RATIO` | 2 | `TRIG_RATIO\|cos\|adjacent/hypotenuse` | right_triangle_trig_generator.py |
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle, angle 66°, hypotenuse = 15; given cos 66° ≈ 0.4\|the adjacent side` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|30-60-90 triangle, longer leg = 11√3\|shorter leg and hypotenuse` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
| `TRY` | 2 | `TRY\|(-1, 54)\|(-1)·54=-54, (-1)+54=53` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|4, -1, -6, -11\|arithmetic, d = -5` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|1 - 3 = -2\|(-2)^2 = 4\|1/5·4 = 0.8` | expected_value_generator.py |
| `VEC_SETUP` | 2 | `VEC_SETUP\|u = ⟨-1, -1⟩, v = ⟨-2, 6⟩\|5u + 4v` | dot_product_generator.py, vector_ops_generator.py |
| `VERIFY` | 2 | `VERIFY\|1\|ok` | error_spotting_generator.py |
| `VERTEX` | 1 | `VERTEX\|(1, -6)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
