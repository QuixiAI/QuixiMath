...
1256 distinct op-codes observed.
...
| `ENTROPY_SETUP` | 2, 3 | `ENTROPY_SETUP\|eigenvalues=[1/2,1/2]\|S=-sum lambda log2(lambda)` | entropy_change_generator.py, entropy_generator.py, mutual_information_generator.py, von_neumann_entropy_generator.py |
...
| `LOG2` | 2 | `LOG2\|1/2\|-1` | entropy_generator.py, mutual_information_generator.py, von_neumann_entropy_generator.py |
