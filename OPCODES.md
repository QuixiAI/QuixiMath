...
483 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|5x\|20x^3 + 10x^2 + 25x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|88312 × 61236 ≈ 90000 × 60000\|5400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5400000000\|5407873632\|5407873632 ≈ 5400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-24 + 8 = -16, not 0` | error_spotting_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(5x^5 - 5x^5 - 5x^5) / (-x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(5x^5) / (-x) + (-5x^5) / (-x) + (-5x^5) / (-x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(5x + 5)(4x^2 + 2x + 5)` | multiplying_polynomials_generator.py |
...
| `POW` | 2 | `POW\|(1/10)^2\|0.01` | binomial_probability_generator.py |
