...
413 distinct op-codes observed.
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|16x^3\|4x^4` | antiderivative_generator.py, area_between_curves_generator.py, definite_integral_generator.py, u_substitution_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|- 2x^3 - 8x^2 + 2x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|82011 × 17778 ≈ 80000 × 20000\|1600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1600000000\|1457991558\|1457991558 ≈ 1600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(78, 15)\|P(X < 87)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 6x^7 - 30x^5 + 24x^3 + 6x^3) / (6x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-6x^7) / (6x^3) + (-30x^5) / (6x^3) + (24x^3) / (6x^3) + (6x^3) / (6x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x - 3)(-x^2 - 4x + 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(87 - 78)/15\|0.60` | normal_table_generator.py |
