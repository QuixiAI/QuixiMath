...
342 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|6x^3 - 2x^2 + 8x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|90248 × 5674 ≈ 90000 × 6000\|540000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|540000000\|512067152\|512067152 ≈ 540000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|30 ÷ 10 = 3, not 1` | error_spotting_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(40, 10)\|P(50 < X < 62)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(24x^4 + 8x^2) / (-8x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(24x^4) / (-8x) + (8x^2) / (-8x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x + 2)(3x^2 - x + 4)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(50 - 40)/10\|1.00` | normal_table_generator.py |
