...
297 distinct op-codes observed.
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|6 - 4\|2` | arithmetic_sequence_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|10x^3 - 6x^2 + 2x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|39851 × 25104 ≈ 40000 × 30000\|1200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1200000000\|1000419504\|1000419504 ≈ 1200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|40 ÷ 4 = 10, not 8` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (2x) * (-4x)\|-8x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (2) * (-4x)\|-8x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (2) * (-5)\|-10` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (2x) * (-5)\|-10x` | multiplying_binomials_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(90, 15)\|P(X < 103.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(12x^4 - 12x^2 - 6x^2) / (-3x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(12x^4) / (-3x^2) + (-12x^2) / (-3x^2) + (-6x^2) / (-3x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x + 1)(5x^2 - 3x + 1)` | multiplying_polynomials_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_12 = 4 + (12 - 1)·2` | arithmetic_sequence_generator.py |
| `SEQ_FORMULA` | 1 | `SEQ_FORMULA\|a_n = a_1 + (n - 1)d` | arithmetic_sequence_generator.py |
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|4, 6, 8, 10, ...\|sum of first 12 terms` | arithmetic_sequence_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(103.5 - 90)/15\|0.90` | normal_table_generator.py |
