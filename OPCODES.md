...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|- 16x^3 + 4x^2 + 4x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | arc_sector_generator.py, circle_equation_generator.py, complex_division_generator.py, conic_standard_form_generator.py, distance_formula_generator.py, ellipse_features_generator.py, exponential_equation_generator.py, exponential_model_generator.py, factor_special_forms_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_mean_generator.py, geometric_sequence_generator.py, hyperbola_features_generator.py, hypercube_counting_generator.py, log_conversion_generator.py, log_equation_generator.py, log_properties_generator.py, piecewise_evaluation_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py, trig_six_functions_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|97269 × 72408 ≈ 100000 × 70000\|7000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|7000000000\|7043053752\|7043053752 ≈ 7000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|2 × 11 = 22, not 11` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 subtracts 10, giving -30\|line 4 divides by 6` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(72, 13)\|P(X < 85)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 8x^6 + 2x^5 + 2x^3 + 4x^3) / (2x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-8x^6) / (2x^3) + (2x^5) / (2x^3) + (2x^3) / (2x^3) + (4x^3) / (2x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x - 5)(4x^2 - x - 1)` | multiplying_polynomials_generator.py |
...
| `SIGN_RULE` | 2 | `SIGN_RULE\|sin, quadrant I\|positive` | trig_six_functions_generator.py, unit_circle_generator.py |
...
| `THEOREM` | 2 | `THEOREM\|factor theorem\|x + 2 is a factor iff P(-2) = 0` | circle_angle_generator.py, geometric_mean_generator.py, rational_root_generator.py, remainder_factor_theorem_generator.py, special_right_triangle_generator.py, trig_six_functions_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle, angle 24°, hypotenuse = 20; given sin 24° ≈ 0.4\|the opposite side` | right_triangle_trig_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(85 - 72)/13\|1.00` | normal_table_generator.py |
