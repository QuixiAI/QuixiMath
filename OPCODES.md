...
| `DIST_TERM` | 2 | `DIST_TERM\|-2x\|8x^3 - 2x^2 + 10x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | arc_sector_generator.py, circle_equation_generator.py, complex_division_generator.py, conic_standard_form_generator.py, distance_formula_generator.py, ellipse_features_generator.py, exponential_equation_generator.py, exponential_model_generator.py, factor_special_forms_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_mean_generator.py, geometric_sequence_generator.py, hyperbola_features_generator.py, hypercube_counting_generator.py, log_conversion_generator.py, log_equation_generator.py, log_properties_generator.py, piecewise_evaluation_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|49896 × 15932 ≈ 50000 × 20000\|1000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1000000000\|794943072\|794943072 ≈ 1000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|44 ÷ 11 = 4, not 5` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 subtracts 11, giving 54\|line 4 divides by 9` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(44, 8)\|P(X < 50.4)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(4x^7 + 10x^3) / (2x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(4x^7) / (2x^3) + (10x^3) / (2x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x + 1)(-4x^2 + x - 5)` | multiplying_polynomials_generator.py |
...
| `SIGN_RULE` | 2 | `SIGN_RULE\|sin, quadrant I\|positive` | trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(5)\|18` | function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, right_triangle_trig_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `THEOREM` | 2 | `THEOREM\|factor theorem\|x + 2 is a factor iff P(-2) = 0` | circle_angle_generator.py, geometric_mean_generator.py, rational_root_generator.py, remainder_factor_theorem_generator.py, special_right_triangle_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(50.4 - 44)/8\|0.80` | normal_table_generator.py |
