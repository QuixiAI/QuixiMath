...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|- 5x^3 - 3x^2 - 2x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|75992 × 54573 ≈ 80000 × 50000\|4000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|4000000000\|4147111416\|4147111416 ≈ 4000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|44 ÷ 11 = 4, not 3` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 9:5\|line 4 multiplies 9 by 2` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(57, 10)\|P(X < 63)` | normal_table_generator.py |
| `ODE_SETUP` | 2 | `ODE_SETUP\|dy/dt = 3y, y(0) = 10\|solve` | euler_method_generator.py, separable_ode_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(8x^6 - 2x^5 + 4x^2 - 10x^2) / (2x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(8x^6) / (2x^2) + (-2x^5) / (2x^2) + (4x^2) / (2x^2) + (-10x^2) / (2x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 1)(-5x^2 - 3x - 2)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(63 - 57)/10\|0.60` | normal_table_generator.py |
