...
446 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|- 15x^3 - 9x^2 + 15x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|30812 × 2455 ≈ 30000 × 2000\|60000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|60000000\|75643460\|75643460 ≈ 60000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 subtracts 6, giving 56\|line 4 divides by 8` | fill_in_step_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 45x^4 - 27x^4 - 36x^2) / (-9x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-45x^4) / (-9x) + (-27x^4) / (-9x) + (-36x^2) / (-9x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x + 2)(-5x^2 - 3x + 5)` | multiplying_polynomials_generator.py |
