...
368 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-x\|3x^3 + 5x^2 - 1x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|79038 × 22340 ≈ 80000 × 20000\|1600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1600000000\|1765708920\|1765708920 ≈ 1600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|11 + 3 = 14, not 7` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 7:8\|line 4 multiplies 7 by 5` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(57, 8)\|P(X > 62.6)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(3x^7 + 5x^7 + 4x^4 + 1x^4) / (x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(3x^7) / (x^3) + (5x^7) / (x^3) + (4x^4) / (x^3) + (1x^4) / (x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x + 4)(-3x^2 - 5x + 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(62.6 - 57)/8\|0.70` | normal_table_generator.py |
