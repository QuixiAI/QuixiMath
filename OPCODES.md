...
557 distinct op-codes observed.
...
| `INNER_ANTIDERIV` | 2 | `INNER_ANTIDERIV\|dr\|r^4/4` | double_integral_generator.py |
| `INNER_EVAL` | 2, 3 | `INNER_EVAL\|r=0..6\|6^4/4\|324` | double_integral_generator.py |
