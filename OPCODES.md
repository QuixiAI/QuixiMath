...
426 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-2x\|- 4x^3 - 2x^2 + 2x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|98575 × 74984 ≈ 100000 × 70000\|7000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|7000000000\|7391547800\|7391547800 ≈ 7000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|9 × 2 = 18, not 16` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 8x - 6 = 26\|line 3 shows 8x = 32` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(72, 13)\|P(X > 83.7)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 2x^6 + 4x^4 - 2x^3) / (-2x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-2x^6) / (-2x^3) + (4x^4) / (-2x^3) + (-2x^3) / (-2x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x + 4)(2x^2 + x - 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(83.7 - 72)/13\|0.90` | normal_table_generator.py |
