...
2009 distinct op-codes observed.
...
| `INTERPRET` | 2 | `INTERPRET\|15\|fixed booking charge` | linear_model_word_generator.py, rate_of_change_interpret_generator.py |
...
| `TABLE_ROW` | 2, 3 | `TABLE_ROW\|order A\|8 markers, 3 folders\|$148.00` | growth_comparison_generator.py, rate_of_change_interpret_generator.py, systems_word_generator.py |
