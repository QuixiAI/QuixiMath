...
318 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|1x^3 + 1x^2 + 2x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|93168 × 77682 ≈ 90000 × 80000\|7200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|7200000000\|7237476576\|7237476576 ≈ 7200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|34 + 6 = 40, not 56` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 25:60\|line 3 divides 108 by 12` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(160, 9)\|P(X < 181.6)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(3x^4 - 1x^3 + 1x^2 + 5x) / (x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(3x^4) / (x) + (-1x^3) / (x) + (1x^2) / (x) + (5x) / (x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 4)(x^2 + x + 2)` | multiplying_polynomials_generator.py |
...
| `THEOREM` | 2 | `THEOREM\|factor theorem\|x + 2 is a factor iff P(-2) = 0` | remainder_factor_theorem_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(181.6 - 160)/9\|2.40` | normal_table_generator.py |
