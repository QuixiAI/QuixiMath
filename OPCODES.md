...
794 distinct op-codes observed.
...
| `GCD_RESULT` | 1, 2 | `GCD_RESULT\|2` | lcm_generator.py, modular_inverse_generator.py |
...
| `MOD_REDUCE` | 3 | `MOD_REDUCE\|169\|mod 11\|4` | calendar_arithmetic_generator.py, crt_generator.py, mod_exp_generator.py, modular_arithmetic_generator.py, modular_inverse_generator.py |
