...
| `ESTIMATE` | 2 | `ESTIMATE\|59483 × 57997 ≈ 60000 × 60000\|3600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3600000000\|3449835551\|3449835551 ≈ 3600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-15 ÷ 5 = -3, not -2` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 21:24\|line 3 divides 56 by 8` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(41, 4)\|P(X < 46.2)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 21x^5 - 7x^4 + 14x^3 - 21x^2) / (-7x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-21x^5) / (-7x^2) + (-7x^4) / (-7x^2) + (14x^3) / (-7x^2) + (-21x^2) / (-7x^2)` | polynomial_div_monomial_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(46.2 - 41)/4\|1.30` | normal_table_generator.py |
