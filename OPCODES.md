...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|4x + 1 = 3` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|x - 6 >= 6 -> x >= 12` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|x - 6\| >= 6` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|x - 6 >= 6 OR x - 6 <= -6` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|4x + 1\| = 3` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|4x + 1 = 3\|4x + 1 = -3` | absolute_value_equation_generator.py |
...
| `ANGLE_RELATION` | 1 | `ANGLE_RELATION\|5x + 17 = 5x + 17` | angle_relationships_generator.py |
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|vertical\|Vertical angles are equal` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|x = 7\|x = 7` | angle_relationships_generator.py |
...
| `CIRCLE_CALCULATE` | 2 | `CIRCLE_CALCULATE\|A = π × 16\|16π` | circle_generator.py |
| `CIRCLE_FORMULA` | 1 | `CIRCLE_FORMULA\|A = πr²` | circle_generator.py |
| `CIRCLE_SETUP` | 2 | `CIRCLE_SETUP\|4\|radius` | circle_generator.py |
| `CIRCLE_SUBSTITUTE` | 1 | `CIRCLE_SUBSTITUTE\|A = π × 4²` | circle_generator.py |
...
| `COMB_CONST` | 3 | `COMB_CONST\|7\|-2\|5` | equation_from_two_points_generator.py, linear_complex_generator.py, simplify_expression_generator.py |
| `COMB_X` | 3 | `COMB_X\|-4x\|-5x\|-9x` | linear_complex_generator.py, simplify_expression_generator.py |
| `COMPOSITE_FACTOR` | 2 | `COMPOSITE_FACTOR\|2\|31` | divisibility_classification_generator.py |
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|3x + 6 < -3 -> x < -3` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|6 < 2x + 2 < 18` | compound_inequality_generator.py |
...
| `DISC` | 3 | `DISC\|1\|0\|1` | quadratic_generator.py |
| `DIST` | 3 | `DIST\|3\|-2x-3\|-6x-9` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, simplify_expression_generator.py |
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|7y + 22 = 8` | systems_substitution_generator.py |
...
| `DIV_COEFF` | 3 | `DIV_COEFF\|5\|-9\|x=-5/9` | linear_complex_generator.py |
| `DIV_SETUP` | 2 | `DIV_SETUP\|577\|80` | decimal_div_generator.py, percent_problem_generator.py |
| `E` | 3 | `E\|16\|2\|256` | pythag_hyp_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(0, -8)\|(2, -3)` | equation_from_two_points_generator.py |
| `EQ_OP_BOTH` | 4 | `EQ_OP_BOTH\|divide\|11\|x\|-8` | absolute_value_equation_generator.py, one_step_equation_generator.py, systems_elimination_generator.py, systems_substitution_generator.py, two_step_equation_generator.py |
...
| `EQ_RESULT` | 2 | `EQ_RESULT\|x\|-8` | one_step_equation_generator.py, two_step_equation_generator.py |
...
| `EQ_SIMPLIFY` | 1 | `EQ_SIMPLIFY\|x/2 = -2` | two_step_equation_generator.py |
| `EXP_EXPAND` | 1 | `EXP_EXPAND\|8 × 8 × 8 × 8 × 8 × 8` | exponent_generator.py |
| `EXP_PARTIAL` | 3 | `EXP_PARTIAL\|8\|8\|64` | exponent_generator.py |
| `EXP_RULE_APPLY` | 4 | `EXP_RULE_APPLY\|subtract\|7\|4\|3` | exponent_generator.py |
| `EXP_RULE_IDENTIFY` | 2 | `EXP_RULE_IDENTIFY\|quotient_rule\|x^a / x^b = x^(a-b)` | exponent_generator.py |
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|n^7 / n^4` | exponent_generator.py |
| `EXP_RULE_SIMPLIFY` | 1 | `EXP_RULE_SIMPLIFY\|n^3` | exponent_generator.py |
| `EXP_SETUP` | 2 | `EXP_SETUP\|8\|6` | exponent_generator.py |
...
| `FOIL_F` | 2 | `FOIL_F\|First: (1x) * (-5x)\|-5x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (5) * (-5x)\|-25x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (5) * (7)\|35` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (1x) * (7)\|7x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(x + 5)(-5x + 7)` | multiplying_binomials_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|add\|4\|1 < 1x < 7` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
| `INEQ_OP_BOTH` | 4 | `INEQ_OP_BOTH\|multiply\|5\|x\|40` | one_step_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_RESULT` | 3 | `INEQ_RESULT\|x\|≥\|40` | one_step_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_SETUP` | 1 | `INEQ_SETUP\|x/5 ≥ 8` | one_step_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_SIMPLIFY` | 1 | `INEQ_SIMPLIFY\|x + 1 < 2` | two_step_inequality_generator.py |
...
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = -2/2x + 3\|(5, -5)` | parallel_perpendicular_line_generator.py |
...
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-27x^9) / (-3x^5)` | monomial_mult_div_generator.py |
| `MONO_SUB_EXP` | 2 | `MONO_SUB_EXP\|x^9 / x^5 = x^(9-5)\|x^4` | monomial_mult_div_generator.py |
| `MOVE_TERM` | 3 | `MOVE_TERM\|+5x\|left\|-4x+2-5x = +7` | linear_complex_generator.py, standard_form_conversion_generator.py |
...
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|6x + 36 = 5x + 45` | angle_relationships_generator.py |
| `PARALLEL_SETUP` | 2 | `PARALLEL_SETUP\|alternate_interior\|Alternate interior angles are equal` | angle_relationships_generator.py |
| `PARALLEL_SOLVE` | 2 | `PARALLEL_SOLVE\|1x = 9\|x = 9` | angle_relationships_generator.py |
...
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 8 = 5/2(x - 0)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-7x^2 - 8x + 13` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(4x^4 - 4x^3 + 5x^3 + 5x^2) / (-x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(4x^4) / (-x) + (-4x^3) / (-x) + (5x^3) / (-x) + (5x^2) / (-x)` | polynomial_div_monomial_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-7x^2) + (-8x) + (7 +6)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x + 4)(-x^2 - x + 1)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1 | `POLY_SETUP\|(-7x^2 + 7) - (8x - 6)` | polynomial_add_sub_generator.py |
...
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Two dice rolls, looking for 2 then 1` | compound_probability_generator.py |
| `PROB_IDENTIFY` | 2 | `PROB_IDENTIFY\|P(rolling 2)\|1/6` | compound_probability_generator.py |
...
| `PYTHAG_CALCULATE` | 2 | `PYTHAG_CALCULATE\|h² = 1600 - 576 = 1024\|1024` | pythag_leg_generator.py |
| `PYTHAG_CONTEXT` | 2 | `PYTHAG_CONTEXT\|ladder\|ladder=40ft, given=24ft` | pythag_leg_generator.py |
| `PYTHAG_FORMULA` | 1 | `PYTHAG_FORMULA\|a² + b² = c²` | pythag_leg_generator.py |
| `PYTHAG_MODEL` | 3 | `PYTHAG_MODEL\|ground=24\|wall=32\|ladder=40` | pythag_leg_generator.py |
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|11025\|105` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 3 | `PYTHAG_SETUP\|c=111\|a=36\|b=?` | pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 12321 - 1296\|11025` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|36\|1296` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|36² + b² = 111²` | pythag_leg_generator.py |
| `Q1` | 4 | `Q1\|1\|1\|2\|1` | quadratic_generator.py |
| `Q2` | 4 | `Q2\|1\|1\|2\|0` | quadratic_generator.py |
| `R` | 1 | `R\|28` | long_division_generator.py |
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 120 / 0.75` | percent_problem_generator.py |
...
| `ROOT_EXTRACT` | 2 | `ROOT_EXTRACT\|2\|√5` | exponent_generator.py |
| `ROOT_IDENTIFY` | 3 | `ROOT_IDENTIFY\|20\|4\|5` | exponent_generator.py |
| `ROOT_SETUP` | 1 | `ROOT_SETUP\|√20` | exponent_generator.py |
| `ROOT_SIMPLIFY` | 1 | `ROOT_SIMPLIFY\|2√5` | exponent_generator.py |
...
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 6 × 11\|132π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=9, w=12, h=11` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(108 + 99 + 132)\|678` | volume_3d_generator.py |
| `SCALE_DIV` | 3 | `SCALE_DIV\|400\|50\|8.0` | scaling_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|3 inches\|actual_dimension` | scaling_generator.py |
| `SCALE_MULT` | 3 | `SCALE_MULT\|3\|10\|30` | scaling_generator.py |
| `SCALE_SETUP` | 3 | `SCALE_SETUP\|1 inch\|10 miles\|10` | scaling_generator.py |
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|7.9\|-5` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|right\|5` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|multiply_coefficients\|3.4\|3.4\|11.559999999999999` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|(3.4 × 10^6) × (3.4 × 10^5)` | exponent_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 0.6 * 200` | percent_problem_generator.py |
| `SIMILAR_APPLY` | 3 | `SIMILAR_APPLY\|5\|0.5\|2.5` | scaling_generator.py |
| `SIMILAR_SCALE` | 3 | `SIMILAR_SCALE\|2.0\|4\|0.5` | scaling_generator.py |
| `SIMILAR_SETUP` | 3 | `SIMILAR_SETUP\|parallelogram\|4,5\|2.0 (others unknown)` | scaling_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = 5 - 3x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|5/2` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-2, -5)\|(-1, -5)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-5 - (-5)) / (-1 - (-2))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(58 + 59) / 2\|58.5` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|10` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|57\|46\|11` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|520 / 10\|52` | statistics_generator.py |
| `STAT_FREQUENCY` | 2 | `STAT_FREQUENCY\|23\|1` | statistics_generator.py |
| `STAT_MAD` | 3 | `STAT_MAD\|122\|7\|17.43` | statistics_generator.py |
| `STAT_MAX` | 1 | `STAT_MAX\|88` | statistics_generator.py |
| `STAT_MEAN` | 2 | `STAT_MEAN\|322 / 7\|46` | statistics_generator.py |
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|position 3\|48` | statistics_generator.py |
...
| `STAT_ORDER` | 1 | `STAT_ORDER\|42, 48, 48, 52, 97` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|88 - 22\|66` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|36, 65, 44, 46, 42, 64, 68, 52, 44, 59` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|36 + 65 + 44 + 46 + 42 + 64 + 68 + 52 + 44 + 59\|520` | statistics_generator.py |
| `SUBST` | 3 | `SUBST\|x\|-5\|-2(-5)+4y+2` | evaluate_expression_generator.py |
...
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = -4y + -11` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * -1, Eq2 * -1` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|4x + 1y = 3\|-4x - 3y = -1` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x + 4y = -11\|-2x -1y = 8` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=-2 into x = -4y + -11` | systems_elimination_generator.py, systems_substitution_generator.py |
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|3x + 15\|3x + 7\|1x + 46` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|7x + 68 = 180\|x = 16` | angle_relationships_generator.py |
| `TRI_ANGLE_SUM` | 1 | `TRI_ANGLE_SUM\|(3x + 15) + (3x + 7) + (1x + 46) = 180` | angle_relationships_generator.py |
...
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 5 × 9\|22.5` | volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 12 × 7 × 6\|504` | volume_3d_generator.py |
| `VOL_FORMULA` | 1 | `VOL_FORMULA\|V = l × w × h` | volume_3d_generator.py |
| `VOL_SETUP` | 2 | `VOL_SETUP\|rectangular_prism\|l=12, w=7, h=6` | volume_3d_generator.py |
