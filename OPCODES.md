...
394 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|5x\|10x^3 + 25x^2 - 25x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|60859 × 54023 ≈ 60000 × 50000\|3000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3000000000\|3287785757\|3287785757 ≈ 3000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|15 ÷ 5 = 3, not 1` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 36.18\|line 4 answers $237.18` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(53, 10)\|P(75 < X < 77)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(28x^2 - 14x + 21x) / (7x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(28x^2) / (7x) + (-14x) / (7x) + (21x) / (7x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(5x - 4)(2x^2 + 5x - 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(75 - 53)/10\|2.20` | normal_table_generator.py |
