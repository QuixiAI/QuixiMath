...
406 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|- 15x^3 - 12x^2 + 12x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|58468 × 20251 ≈ 60000 × 20000\|1200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1200000000\|1184035468\|1184035468 ≈ 1200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|82 - 10 = 72, not 88` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 6:5\|line 4 multiplies 6 by 4` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(76, 9)\|P(X < 67.9)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 8x^6 + 10x^3) / (2x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-8x^6) / (2x^2) + (10x^3) / (2x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x - 2)(-5x^2 - 4x + 4)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(67.9 - 76)/9\|-0.90` | normal_table_generator.py |
