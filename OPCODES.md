...
468 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|- 20x^3 + 20x^2 + 16x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|82365 × 57575 ≈ 80000 × 60000\|4800000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|4800000000\|4742164875\|4742164875 ≈ 4800000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|21 - 9 = 12, not 9` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 adds 14, giving 35\|line 4 divides by 7` | fill_in_step_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(7x^3 + 7x^2 - 14x^2) / (7x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(7x^3) / (7x) + (7x^2) / (7x) + (-14x^2) / (7x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x + 3)(5x^2 - 5x - 4)` | multiplying_polynomials_generator.py |
