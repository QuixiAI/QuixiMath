...
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|- 4x^3 + 2x^2 + 4x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|95902 × 60405 ≈ 100000 × 60000\|6000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|6000000000\|5792960310\|5792960310 ≈ 6000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|15 ÷ 3 = 5, not 3` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (2x) * (-4x)\|-8x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (6) * (-4x)\|-24x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (6) * (-7)\|-42` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (2x) * (-7)\|-14x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(2x + 6)(-4x - 7)` | multiplying_binomials_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 subtracts 12, giving -21\|line 4 divides by 7` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(27, 9)\|P(X < 13.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 16x^5 - 8x^5 + 4x^4) / (4x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-16x^5) / (4x^2) + (-8x^5) / (4x^2) + (4x^4) / (4x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x - 5)(-2x^2 + x + 2)` | multiplying_polynomials_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|Φ(1.50)\|0.9332` | normal_table_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(13.5 - 27)/9\|-1.50` | normal_table_generator.py |
