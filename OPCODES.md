...
363 distinct op-codes observed.
...
| `ESTIMATE` | 2 | `ESTIMATE\|95214 × 81264 ≈ 100000 × 80000\|8000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|8000000000\|7737470496\|7737470496 ≈ 8000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-13 - 5 = -18, not -12` | error_spotting_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(515, 6)\|P(522.8 < X < 527)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(16x^6 + 16x^6 + 32x^5) / (-8x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(16x^6) / (-8x^3) + (16x^6) / (-8x^3) + (32x^5) / (-8x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(5x + 3)(3x^2 + 5x + 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(522.8 - 515)/6\|1.30` | normal_table_generator.py |
