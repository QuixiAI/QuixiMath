...
279 distinct op-codes observed.
...
| `ESTIMATE` | 2 | `ESTIMATE\|81569 × 79950 ≈ 80000 × 80000\|6400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|6400000000\|6521441550\|6521441550 ≈ 6400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-6 ÷ 6 = -1, not 0` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (-3x) * (5x)\|-15x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (1) * (5x)\|5x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (1) * (7)\|7` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-3x) * (7)\|-21x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(-3x + 1)(5x + 7)` | multiplying_binomials_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 15% to 0.15\|line 3 adds the tip 19.50 to the bill` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(170, 9)\|P(X < 161.9)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(45x^3 + 36x^3 + 9x - 27x) / (9x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(45x^3) / (9x) + (36x^3) / (9x) + (9x) / (9x) + (-27x) / (9x)` | polynomial_div_monomial_generator.py |
...
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|490\|49 × 10\|49` | radical_variable_simplify_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|Φ(0.90)\|0.8159` | normal_table_generator.py |
