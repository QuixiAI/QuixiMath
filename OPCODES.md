...
783 distinct op-codes observed.
...
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|34 mod 15\|4` | modular_inverse_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|4\|mod 15\|4` | modular_inverse_generator.py |
| `MOD_REDUCE` | 3 | `MOD_REDUCE\|169\|mod 11\|4` | calendar_arithmetic_generator.py, modular_arithmetic_generator.py, modular_inverse_generator.py |
