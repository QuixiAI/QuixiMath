...
453 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-3x\|- 6x^3 + 12x^2 - 6x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|26580 × 11460 ≈ 30000 × 10000\|300000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|300000000\|304606800\|304606800 ≈ 300000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-8 ÷ 4 = -2, not -3` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 4x - 3 = -39\|line 3 shows 4x = -36` | fill_in_step_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 2x^7 - 3x^5) / (x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-2x^7) / (x^3) + (-3x^5) / (x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-3x + 5)(2x^2 - 4x + 2)` | multiplying_polynomials_generator.py |
