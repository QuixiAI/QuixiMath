...
305 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|- 4x^3 - 8x^2 - 20x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|88951 × 44926 ≈ 90000 × 40000\|3600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3600000000\|3996212626\|3996212626 ≈ 3600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|6 - 10 = -4, not -8` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (3x) * (-9x)\|-27x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-3) * (-9x)\|27x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (-3) * (-9)\|27` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (3x) * (-9)\|-27x` | multiplying_binomials_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 3:2\|line 4 multiplies 3 by 12` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(31, 5)\|P(35.5 < X < 39)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 32x^6 + 8x^5 - 40x^3 + 16x^2) / (8x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-32x^6) / (8x^2) + (8x^5) / (8x^2) + (-40x^3) / (8x^2) + (16x^2) / (8x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x + 2)(x^2 + 2x + 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(35.5 - 31)/5\|0.90` | normal_table_generator.py |
