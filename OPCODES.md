...
1773 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|x + 9 = 9` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|5x + 3 ≥ 6 -> x ≥ 3/5` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|abs(5x + 3) ≥ 6` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <=` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|5x + 3 ≥ 6 or 5x + 3 ≤ -6` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(x + 9) = 9` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|x + 9 = 9\|x + 9 = -9` | absolute_value_equation_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 3/6, P(B) = 3/6, P(A ∩ B) = 3/6\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `ALG_SETUP` | 3 | `ALG_SETUP\|merge sort\|merges 1\|values 16, 33, 35, 8, 13` | algorithm_trace_generator.py |
...
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda h. (h (d d))\|lambda z. (z (d d))` | lambda_reduction_generator.py |
...
| `ARC_LENGTH` | 3 | `ARC_LENGTH\|int_0^T speed dt\|17*6\|102` | curve_geometry_generator.py |
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 54, central angle 260°\|sector area` | arc_sector_generator.py |
...
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 + 39x + 170 and y = -x^2 + 3x + 10\|area between the curves` | area_between_curves_generator.py |
...
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|27, 35, 38, 6, 18, 15, 26` | algorithm_trace_generator.py |
...
| `ATA` | 2 | `ATA\|A^T A\|[[8996, 8960], [8960, 8996]]` | svd_generator.py |
...
| `AV_VECTOR` | 2 | `AV_VECTOR\|A*v1\|[134/√2, 134/√2]` | svd_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 72, disease=no 168\|sensitivity 5/6, specificity 7/8\|P(disease=yes given test positive)` | conditional_probability_generator.py |
...
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables X, Y\|K-map simplify` | boolean_algebra_generator.py |
...
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|229 <= 300\|yes` | piecewise_evaluation_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*dx/dt + f_y*dy/dt\|(-7)*1 + (-8)*(-4)\|25` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(-1)\|(-1) + 1\|0` | multivar_chain_rule_generator.py |
| `CHANGE_BASE` | 1 | `CHANGE_BASE\|log_27(81) = log_3(81)/log_3(27)` | log_conversion_generator.py |
| `CHAR_DIAG` | 2 | `CHAR_DIAG\|diagonal of λI - A\|(λ + 4), (λ + 5)` | eigenvalue_generator.py |
...
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^2 + 9λ + 20\|(λ + 5)*(λ + 4)` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 5, 6, 2, 9, 3, 1, 9; expected: 5 each\|goodness of fit; df = 6, critical value = 12.592` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|5 - 5 = 0\|0^2 = 0\|0/5 = 0` | chi_square_generator.py |
...
| `CHURCH_NUMERAL` | 2 | `CHURCH_NUMERAL\|3\|lambda e. (lambda m. (e (e (e m))))` | lambda_reduction_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(-5 - 0)*36\|-180` | vector_theorem_generator.py |
| `CI_FORMULA` | 1 | `CI_FORMULA\|x̄ ± E` | confidence_interval_generator.py |
| `CI_SETUP` | 2 | `CI_SETUP\|p̂ = 0.2, E = 0.04, z* = 1.645\|minimum sample size for the proportion` | confidence_interval_generator.py |
...
| `CLAUSE` | 2 | `CLAUSE\|C1\|(¬P11148 ∨ P44548)` | resolution_proof_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(L OR M OR NOT N) AND (L OR NOT M OR NOT N)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|66600` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|1, 0, -7, -7\|0 inserted for missing x^2 term` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COEFF_MATCH` | 2 | `COEFF_MATCH\|x^n\|(n+1)a_(n+1) = 3a_n` | series_solution_generator.py |
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=1, j=4\|2i + 3j = 14\|accepted` | generating_function_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[0, 0], [3, 2]]` | determinant_generator.py |
...
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2, 3\|[[-2, 1, 3], [-3, 1, 6], [1, 0, -2]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(3,1)\|3` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = -2*v1 + 20*v2\|[-2, 8]` | diagonalization_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|choose 7 of 9\|order does not matter` | counting_classics_generator.py, permutation_combination_generator.py, stars_and_bars_generator.py |
...
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|77/121\|7/11` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMPARE` | 2, 3 | `COMPARE\|12 > 7\|log_b(a) > k` | algorithm_trace_generator.py, equilibrium_ice_generator.py, fixed_point_generator.py, master_theorem_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|3x - 6 < -21 -> x < -5` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|3x - 6 < -21 or 3x - 6 > 15` | compound_inequality_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 27, no/bike 13, yes/bus 8, no/bus 19\|P(club=no given commute=bike)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|commute=bike total\|27 + 13 = 40` | conditional_probability_generator.py |
...
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|4*x + 5*y = 360\|lambda*(16/8 + 25/10) = 360\|lambda = 80` | lagrange_multiplier_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[-2, 20]` | diagonalization_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|65 boxes\|force 13 in one box` | counting_classics_generator.py |
...
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|-10*x + 4*y - 42 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|(-10)*(-10) - 4^2\|84` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=2\|ln(18/7)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|20·EF = 40·20` | similar_triangles_generator.py, triangle_solve_generator.py |
...
| `CX_SETUP` | 2 | `CX_SETUP\|(7 + 7i) + (7 + i)\|add` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `CYK_CELL` | 2 | `CYK_CELL\|1,2\|{C}` | cyk_parser_generator.py |
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|C Z\|{C}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|C\|a or C Z or S S` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string acb\|length 3` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{C,Z} x {Z}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|a\|{C,Z}` | cyk_parser_generator.py |
...
| `DERIVED` | 2 | `DERIVED\|C6\|(P44548)` | resolution_proof_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 6x^2 - 4x + 6\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -3], [1, -1], [1, 1], [1, 3]]\|y = [30, 20, 14, 12]` | least_squares_generator.py |
...
| `DEV_ROW` | 3 | `DEV_ROW\|22\|2\|4` | standard_deviation_generator.py |
| `DFA_ACCEPT` | 1 | `DFA_ACCEPT\|q2` | dfa_minimization_generator.py, dfa_simulation_generator.py |
| `DFA_INPUT` | 1 | `DFA_INPUT\|0010111` | dfa_simulation_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[3, 2], [-2, -1]]\|D = [[-5, 0], [0, 2]]\|P^-1 = [[-1, -2], [2, 3]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[18, 42, 66]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 2*x^2 + 3*y^2 + 4*y\|point (2, 1)\|dx=-1/2, dy=-1/4` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|8*(-1/2) + 10*(-1/4)\|-6.5` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|139876\|135252\|4624` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `DISC_CLASSIFY` | 2 | `DISC_CLASSIFY\|57 > 0\|two real solutions` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|4y + 2 = -34` | systems_substitution_generator.py |
...
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited F\|A=7, B=inf, C=inf, D=6, E=inf, F=0` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|20x^3 - 4x^2 + 20x` | multiplying_polynomials_generator.py |
...
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y\|-5 - 6\|-11` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|28x^3\|4x\|7x^2` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT V AND NOT W AND X AND Y) OR (NOT V AND W AND X AND NOT Y) OR (V AND NOT W AND X AND Y) OR (V AND W AND NOT X AND NOT Y) OR (V AND W AND NOT X AND Y)` | boolean_algebra_generator.py |
...
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|denominator ≠ 0\|t^2 + 8t + 15 ≠ 0` | domain_range_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(-3, -3) · (0, 1)\|(-3)*0 + (-3)*1\|-3` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `DOUBLE_SETUP` | 2, 3 | `DOUBLE_SETUP\|integrand x^2 + y^2\|first-quadrant disk radius 4` | double_integral_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=4,v=6); 2:(w=2,v=3); 3:(w=2,v=3)` | dp_table_generator.py |
| `DP_ROW` | 2 | `DP_ROW\|i=0\|0, 1, 2, 3` | dp_table_generator.py |
| `DP_SETUP` | 2, 3 | `DP_SETUP\|edit distance\|source=DDAA\|target=BDC` | dp_table_generator.py |
| `D_POWER` | 2 | `D_POWER\|D^2\|[[25, 0], [0, 81]]` | diagonalization_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|EF\|weight 4\|add F` | mst_generator.py |
...
| `EDGE_LIST` | 1 | `EDGE_LIST\|AB, AC, AE, AF, BC, BD, BE, BF, DE, EF` | euler_circuit_generator.py |
...
| `EIGENVECTOR` | 2 | `EIGENVECTOR\|A + 5I times v = 0\|[4, 1]` | diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, svd_generator.py |
| `EIGEN_CHECK` | 3 | `EIGEN_CHECK\|sigma_z psi\|1*psi\|lambda=1` | spin_half_generator.py |
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 5I\|[[1, -4], [0, 0]]` | eigenvalue_generator.py |
...
| `EQUILIBRIA` | 2 | `EQUILIBRIA\|f(y) = 0\|y=5, y=6` | stability_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(-8, -3)\|(-2, -5)` | equation_from_two_points_generator.py |
...
| `EQ_OP_NOTE` | 3 | `EQ_OP_NOTE\|divide\|q\|from both sides` | equation_from_two_points_generator.py, literal_equation_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, standard_form_conversion_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|82272 × 44069 ≈ 80000 × 40000\|3200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|F\|route suffix F\|stack B-A-C-B-D-E-A-F-B-E` | euler_circuit_generator.py |
...
| `EULER_ROUTE` | 2 | `EULER_ROUTE\|B-A-C-B-D-E-A-F-B-E-F\|uses 10 edges` | euler_circuit_generator.py |
...
| `EV_SETUP` | 2 | `EV_SETUP\|P(X=0) = 1/4; P(X=7) = 1/4; P(X=2) = 1/4; P(X=8) = 1/4\|E[X]` | expected_value_generator.py |
...
| `EXP_CELL` | 2 | `EXP_CELL\|(70·60)/100\|42` | chi_square_generator.py |
| `EXP_DIAG` | 2 | `EXP_DIAG\|e^(Dt)\|[[e^(-4t), 0], [0, e^(-t)]]` | matrix_exponential_generator.py |
| `EXP_ENTRY` | 3 | `EXP_ENTRY\|(1,1)\|9*e^(-4t) - 8*e^(-t)\|9*e^(-4t) - 8*e^(-t)` | matrix_exponential_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-72 ÷ 9 = -8, not -9` | error_spotting_generator.py |
...
| `FLUX_SUM` | 2 | `FLUX_SUM\|(-1 + 0 + 2)*72\|72` | vector_theorem_generator.py |
...
| `FOIL_I` | 2 | `FOIL_I\|Inner: 5i * 4\|20i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_O` | 2 | `FOIL_O\|Outer: 3 * (-3i)\|-9i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(2 + √2)(6 + √2)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|18/-28\|-9/14` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|43/40\|1.075` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Red: 5, Blue: 9, Green: 8, Yellow: 11\|relative frequency of Green` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(p/q)(1)\|p(1)/q(1)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|x: -4, -3, 2, 3, 4; f(x): 15, 10, -12, 13, 5\|f(-3)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|28, 16, 12\|4` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEOM_SETUP` | 2 | `GEOM_SETUP\|p = 1/3, q = 2/3\|P(X > 7)` | geometric_distribution_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; leg = 45 with projection p = 15 on the hypotenuse\|the hypotenuse c` | geometric_mean_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^14]\|1/((1 - x^2)(1 - x^3))` | generating_function_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = x^2 + 4*y^2 - 4*x*y - 5*x + 3*y\|point (0, 2)\|tangent` | gradient_generator.py |
...
| `GRAPH_SETUP` | 2 | `GRAPH_SETUP\|vertices A, B, C, D\|edges AC, BC, BD` | dijkstra_generator.py, euler_circuit_generator.py, graph_counting_generator.py, graph_traversal_generator.py |
...
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|(-10)*(-10) - 4^2\|84` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = -5*x^2 - 5*y^2 + 4*x*y - 42*x + 42*y\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = 84\|f_xx = -10\|local maximum` | hessian_classify_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-3x^3 - 3x^2 + 5x + 3\|x = -4` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: μ = 54; Ha: μ ≠ 54\|n = 25, x̄ = 44, s = 5, critical value = 2.576` | hypothesis_test_generator.py, two_sample_test_generator.py |
...
| `HYPERCUBE_SETUP` | 2 | `HYPERCUBE_SETUP\|4-cube\|number of square faces (k = 2)` | hypercube_counting_generator.py |
...
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=7..71 C(i,7) = C(72,8)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=36, n(B)=25, n(C)=31\|n(AB)=10, n(AC)=13, n(BC)=9, n(ABC)=1` | inclusion_exclusion_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|add\|6\|-11 ≤ 1x ≤ 23` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INITIAL_COEFF` | 2 | `INITIAL_COEFF\|a_0\|22200` | series_solution_generator.py |
...
| `INSERT_KEY` | 3 | `INSERT_KEY\|pass 1\|35\|index 1` | algorithm_trace_generator.py |
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 1\|27, 35, 38, 6, 18, 15, 26` | algorithm_trace_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (9x^2 - 8x - 3) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 4x - 2 on [-3, -1]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|(-4)*(-5) - (-5)*(-2)\|10` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[-4, -5], [-2, -5]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = -4*u - 5*v\|y = -2*u - 5*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
...
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|10, 11\|X` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|X=0\|0, 1` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows X=0,X=1\|columns Y=0,Y=1` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|X OR Y` | boolean_algebra_generator.py |
...
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = 4*x^2 + 5*y^2\|constraint 4*x + 5*y = 360\|minimize` | lagrange_multiplier_generator.py |
...
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|(((lambda d. (lambda h. (h (d d)))) (h h)) (lambda g. h))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|72/2 + 48\|84` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = 1/2x - 2\|(-3, 5)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <2*x + 4*y, 2*x - y>\|from (-4, 4) to (2, 4)` | line_integral_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|log_10(10^x) = log_10(40)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_EVAL` | 2 | `LOG_EVAL\|28/17\|ln(28/17)` | hyperbolic_distance_generator.py |
| `LOG_EXACT` | 2 | `LOG_EXACT\|log_8(68719476736)\|12` | master_theorem_generator.py |
| `LOG_FORM` | 1 | `LOG_FORM\|log_2(4) = y ⟺ 2^y = 4` | log_conversion_generator.py, log_equation_generator.py |
...
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|3x + 3 = x - 3` | log_equation_generator.py |
...
| `LOG_PRODUCT` | 1, 2 | `LOG_PRODUCT\|log_5(x^2y^4)\|log_5(x^2) + log_5(y^4)` | log_equation_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_5(5x^4/y^2)\|log_5(5x^4) - log_5(y^2)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|log_5(x^2y^4)\|expand` | complex_log_generator.py, log_properties_generator.py |
...
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-3, 30), (-1, 20), (1, 14), (3, 12)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_RESULT` | 2 | `LU_RESULT\|L\|[[1, 0, 0], [-4, 1, 0], [-2, -2, 1]]` | lu_decomposition_generator.py |
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[5, -4, -1], [-20, 19, 2], [-10, 2, 3]]\|unit lower L` | lu_decomposition_generator.py |
...
| `MASTER_CASE` | 2 | `MASTER_CASE\|case 3\|Θ(n^12)` | master_theorem_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[2, -2], [0, -1]], B = [[-3, -3], [0, 3]]\|AB` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
...
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=0,mid=1,hi=2\|left 16; right 33` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|16\|33\|take left` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 0-1\|array 16, 33, 35, 8, 13` | algorithm_trace_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 22900 · (1 - 0.02)^2` | exponential_model_generator.py |
...
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|20 / 4\|5` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|5 * -4\|-20` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(5x^3)(-4x^3)` | monomial_mult_div_generator.py |
...
| `MST_ADD` | 2 | `MST_ADD\|BC\|total 2` | mst_generator.py |
...
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^xy' + e^xy\|3e^(3x)` | integrating_factor_generator.py, ode_substitution_generator.py |
...
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|1 X, 5 W's, 2 S's\|total 8` | stars_and_bars_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 - x + 4 on [-2, 4]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 4*x^2 + 4*y^2 + 2*x*y - 5*x\|x = t + 1, y = -4*t - 5\|t = -1` | multivar_chain_rule_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 gives the scale factor 10\|line 5 answers 110` | fill_in_step_generator.py |
...
| `NET_SETUP` | 2 | `NET_SETUP\|2 right triangles with legs 12 and 16; rectangles 12 by 7, 16 by 7, and 20 by 7\|total surface area` | nets_surface_area_generator.py |
...
| `NFA_INPUT` | 1 | `NFA_INPUT\|acabaa` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{s1}\|a\|s1->{s1,s7}\|{s1,s7}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|a` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states s1, s7, s8\|alphabet a, b, c\|start s1` | nfa_simulation_generator.py |
| `NFA_TRANSITION` | 3 | `NFA_TRANSITION\|s1\|a\|{s1,s7}` | nfa_simulation_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(69, 2)\|is x = 68 unusual?` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
...
| `NO_REDEX` | 2 | `NO_REDEX\|h\|no beta redex remains` | lambda_reduction_generator.py |
...
| `NULL_VECTOR` | 2 | `NULL_VECTOR\|x4=1\|[4, -4, -2, 1]` | subspace_basis_generator.py |
...
| `ODD_VERTICES` | 2 | `ODD_VERTICES\|B, F\|2` | euler_circuit_generator.py |
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dx = y^2, y(0) = 119\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `OPT_SETUP` | 2 | `OPT_SETUP\|x + y = 786, x, y > 0\|maximize P = x·y^2` | optimization_generator.py |
...
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|5*x^2 + 20*x` | double_integral_generator.py |
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|x=1..2\|5*(2^2 - 1^2) + 20*(2 - 1)\|35` | double_integral_generator.py |
...
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 3t + 14, y = 10t - 6\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|-8/((x + 2)x) = A/(x + 2) + B/x` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|3/(s + 1) + 2/(s - 2)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_y\|12*x^4*y + 15*x^3*y^2` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|5*x^3*y^3\|d/dy\|15*x^3*y^2` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 6*x^4*y^2 + 5*x^3*y^3\|f_y` | partial_derivative_generator.py |
...
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = -161x, dv = e^x dx\|du = -161 dx, v = e^x` | integration_by_parts_generator.py |
...
| `PASCAL_SETUP` | 1 | `PASCAL_SETUP\|13C4` | pascal_triangle_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|1.41\|925\|1304.25` | percent_problem_generator.py |
...
| `PERM_SETUP` | 2, 3 | `PERM_SETUP\|P(14, 7)\|n!/(n-r)!` | permutation_combination_generator.py, permutation_group_generator.py |
...
| `PI_COEFF` | 2 | `PI_COEFF\|15π/8\|15/8` | arc_sector_generator.py |
...
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|x - 96 = ±90\|x - 96 = 90 or x - 96 = -90` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|80*4/8\|40` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 3 = -1/3(x + 8)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|(x, y) = (132, 351)\|polar (r ≥ 0, 0° ≤ θ < 360°)` | parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|2y^3 - 4y^2 - 10y + 9\|y - 3` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|6x^3 - 3x^2 + 3x + 13` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(-27x^5 - 9x^3) / (-9x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-27x^5) / (-9x^3) + (-9x^3) / (-9x^3)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(6x^3) + (-3x^2) + (-x +4x) + (9 +4)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|x^2 + x + 1` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x + 2)(-5x^2 + x - 5)` | multiplying_polynomials_generator.py |
...
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|2*x^2 + 3*y^2 - 2*x*y - 2*x` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(1/3)^2\|1/9` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|(-125) + 81*6\|361` | diagonalization_generator.py |
...
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited E\|EF=4, AE=21` | mst_generator.py |
...
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[28, 22, 16, 10]` | least_squares_generator.py, legendre_construction_generator.py |
...
| `Q1` | 4 | `Q1\|-374\|68\|34\|-9` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|-374\|68\|34\|-13` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QN_ADD` | 4 | `QN_ADD\|Q\|left\|0 + p(1)\|1` | conservation_law_generator.py |
| `QR_ENTRY` | 2 | `QR_ENTRY\|q1\|[1, 0, 0]` | qr_decomposition_generator.py |
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[5, -3, -2], [0, 6, -2], [0, 0, 5]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|295°\|quadrant IV` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
...
| `QUARTILE` | 3 | `QUARTILE\|Q1\|5,6,15,19,29\|15` | five_number_summary_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|51 m ladder; the base slides away at 10 m/min; base is 45 m from the wall\|dy/dt` | related_rates_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 84513 / 0.985` | percent_problem_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = -5 a_(n-1) - 6 a_(n-2)\|a_0 = -3, a_1 = 8` | master_theorem_generator.py, recurrence_generator.py |
...
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q32732_2` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|(a or b)*ab(a or b)*\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q32732_0\|no useful suffix` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q32732_0\|a\|q32732_1` | regex_to_automaton_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 46), (2, 47), (3, 44), (4, 45), (5, 43)\|coefficient of determination r^2` | regression_generator.py |
| `REJECT` | 1, 2 | `REJECT\|x = −45` | cantor_pairing_generator.py, conditional_forms_generator.py, counterexample_search_generator.py, factor_trinomial_generator.py, knights_knaves_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py, set_builder_roster_generator.py, structure_isomorphism_generator.py |
| `RELAX` | 3 | `RELAX\|F->A\|update inf to 7\|via weight 7` | dijkstra_generator.py |
...
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (5, 71), line ŷ = 75.2 - 1.4x\|residual = observed − predicted` | regression_generator.py |
| `RESOLVE` | 3 | `RESOLVE\|C1\|C3\|¬P11148` | resolution_proof_generator.py |
...
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(¬P11148 ∨ P44548), C2=(¬P6110), C3=(P11148), C4=(P6110), C5=(¬P44548)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C3\|(P44548)` | resolution_proof_generator.py |
...
| `RIEMANN_SETUP` | 2, 3 | `RIEMANN_SETUP\|f(x) = 2x + 3 on [1, 5], n = 4\|right Riemann sum` | riemann_sum_generator.py, riemann_tensor_generator.py |
...
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, 0, -4], [0, 1, 0, 4], [0, 0, 1, 2]]` | subspace_basis_generator.py |
...
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x4 = 10\|xi >= 1` | stars_and_bars_generator.py |
...
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = -2\|(-8)*(-2)\|16` | diagonalization_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(-4, 2), B(2, -16); ratio 4:2 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_30 = 5 + (30 - 1)·2` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|5, 7, 9, 11, ...\|30th term` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ (13n + 1)/(4n + 5), n ≥ 1\|converge or diverge?` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
...
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|84513 = 0.985 * whole` | percent_problem_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y4 = 6` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
...
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|82 + 96 + 110 + 124` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=7)^(10) (14k - 16)\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=7\|14(7) - 16\|82` | sigma_notation_generator.py |
...
| `SIGN_CHART` | 2 | `SIGN_CHART\|zeros\|-5, -3, 5` | polynomial_inequality_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, 5)\|y = 4\|f(y) = -2 (negative)\|down` | stability_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; AB = 20, DE = 40, BC = 20\|find EF` | similar_triangles_generator.py |
...
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = 3cos(3x + 60°) - 6\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -9x + 9` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|-1/3` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-4, 4)\|(4, -7)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-7 - 4) / (4 - (-4))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOLUTIONS` | 2 | `SOLUTIONS\|sin x = 1/2\|30°, 150°, 390°, 510°, 750°, 870°, 1110°, 1230°, 1470°, 1590°, 1830°, 1950°, 2190°, 2310°, 2550°, 2670°, 2910°, 3030°, 3270°, 3390°, 3630°, 3750°, 3990°, 4110°, 4350°, 4470°, 4710°, 4830°, 5070°, 5190°, 5430°, 5550°, 5790°, 5910°, 6150°, 6270°` | trig_equation_generator.py |
...
| `SOLVE_Y` | 2 | `SOLVE_Y\|e^xy = e^(3x) + C\|y = e^(2x) + Ce^(-x)` | integrating_factor_generator.py, laplace_ivp_generator.py, ode_substitution_generator.py |
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(9*e^(-4t) - 8*e^(-t))*(-6) + (-6*e^(-4t) + 6*e^(-t))*(-6)\|-18*e^(-4t) + 12*e^(-t)` | matrix_exponential_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|BC=2, AB=8, AD=16, BD=17` | mst_generator.py |
...
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|(x - 96)^2 = 8100\|x - 96 = ±90` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
...
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(x - 3) = x - 5\|x - 3 = (x - 5)^2` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|7154\|49 × 146\|49` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
| `SQUARE_TEST` | 3 | `SQUARE_TEST\|57\|7^2 = 49, 8^2 = 64\|not a perfect square` | discriminant_generator.py |
...
| `SUM` | 2, 3 | `SUM\|46 + 47 + 44 + 45 + 43\|225` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|x^3 - 7x - 7\|r = 3` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|1, 3, 2, -1` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -7y = -42` | systems_elimination_generator.py |
...
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|10x + 8y = 38\|-10x - 15y = -80` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x = -y - 1\|-2x + 2y = -34` | systems_elimination_generator.py, systems_substitution_generator.py |
...
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|h(-3)\|13` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
...
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 22 - 13*(x - 0) + 19*(y - 2)` | gradient_generator.py |
...
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|middle radicals cancel\|√133 - √78` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Σ k=78..132 (√(k+1) - √k)` | telescoping_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Green\|F=<0, -5*x>\|rectangle 4 by 9` | vector_theorem_generator.py |
...
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(4, 3)\|reflection over the y-axis` | rv_transform_generator.py, transformation_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: leg opposite A = 84, leg adjacent to A = 35, hypotenuse = 91\|sin A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|z_part * r_part * angle\|4*18*32*2*pi\|4608*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 4*z\|cylinder radius 8, height 6\|cylindrical` | triple_integral_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|45-45-90 triangle, leg = 210\|hypotenuse` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|8 - 2.2 = 5.8\|(5.8)^2 = 33.64\|1/20·33.64 = 1.682` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|5` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y) = <-5*x, -4*x - 6*y>\|divergence and scalar curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|16\|16` | diagonalization_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region between y = 225x (outer) and y = 225x^2 (inner) on [0, 1], about the x-axis\|washer method` | solid_revolution_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|27 - 48\|-21` | line_integral_generator.py |
...
| `ZERO_PRODUCT` | 2 | `ZERO_PRODUCT\|(x + 5)(x + 3)(x - 5)\|x = -5 or x = -3 or x = 5` | area_between_curves_generator.py, curve_analysis_generator.py, domain_range_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_equation_generator.py, trig_equation_generator.py |
| `ZSCORE` | 2 | `ZSCORE\|(62 - 53)/4\|2.25` | normal_table_generator.py, z_score_generator.py |
