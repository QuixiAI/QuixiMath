...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|1x^3 + 2x^2 + 1x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|94699 × 3995 ≈ 90000 × 4000\|360000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|360000000\|378322505\|378322505 ≈ 360000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-3 ÷ 3 = -1, not -2` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 6x = 12\|line 5 shows x = 2` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(82, 11)\|P(89.7 < X < 104)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 9x^5 - 27x - 36x) / (9x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-9x^5) / (9x) + (-27x) / (9x) + (-36x) / (9x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 5)(x^2 + 2x + 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(89.7 - 82)/11\|0.70` | normal_table_generator.py |
