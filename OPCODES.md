...
| `PORT_RESULT` | 2 | `PORT_RESULT\|expected_return=0.0825\|variance=0.02390625` | portfolio_generator.py |
| `PORT_SETUP` | 3 | `PORT_SETUP\|wA=0.75,wB=0.25\|rA=8%,rB=9%\|varA=0.04,varB=0.0225,cov=0` | portfolio_generator.py |
