...
299 distinct op-codes observed.
...
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|-8/(-4)\|2` | geometric_sequence_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-2x\|- 2x^3 + 10x^2 - 10x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | factor_special_forms_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_sequence_generator.py, piecewise_evaluation_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, round_solids_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|54127 × 8961 ≈ 50000 × 9000\|450000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|450000000\|485032047\|485032047 ≈ 450000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FOIL_F` | 2 | `FOIL_F\|First: (4x) * (9x)\|36x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (9) * (9x)\|81x` | multiplying_binomials_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 gives the scale factor 4\|line 5 answers 12` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(164, 9)\|P(173.9 < X < 174.8)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 6x^7 - 2x^5) / (-2x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-6x^7) / (-2x^3) + (-2x^5) / (-2x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x + 5)(x^2 - 5x + 5)` | multiplying_polynomials_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_12 = 4 + (12 - 1)·2` | arithmetic_sequence_generator.py, geometric_sequence_generator.py |
| `SEQ_FORMULA` | 1 | `SEQ_FORMULA\|a_n = a_1 + (n - 1)d` | arithmetic_sequence_generator.py, geometric_sequence_generator.py |
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|4, 6, 8, 10, ...\|sum of first 12 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(173.9 - 164)/9\|1.10` | normal_table_generator.py |
