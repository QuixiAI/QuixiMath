...
| `DIST_TERM` | 2 | `DIST_TERM\|-2x\|2x^3 - 4x^2 - 6x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | factor_special_forms_generator.py, pythag_hyp_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, round_solids_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|55115 × 11026 ≈ 60000 × 10000\|600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|600000000\|607697990\|607697990 ≈ 600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 3x = -15\|line 5 shows x = -5` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(174, 5)\|P(X > 178.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(16x^6 - 16x^4 - 16x^3 - 8x^3) / (8x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(16x^6) / (8x^3) + (-16x^4) / (8x^3) + (-16x^3) / (8x^3) + (-8x^3) / (8x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x - 2)(-x^2 + 2x + 3)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(178.5 - 174)/5\|0.90` | normal_table_generator.py |
