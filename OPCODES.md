...
| `MODEL_EQ` | 2 | `MODEL_EQ\|x = 60*(1+20/100)\|changed value` | integer_puzzle_word_generator.py, linear_model_word_generator.py, mixture_generator.py, money_life_generator.py, motion_word_generator.py, multi_step_word_generator.py, percent_chain_generator.py, percent_word_problem_generator.py, proportion_word_problem_generator.py, unit_rate_generator.py, work_rate_generator.py |
