...
| `ESTIMATE` | 2 | `ESTIMATE\|64078 × 38593 ≈ 60000 × 40000\|2400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2400000000\|2472962254\|2472962254 ≈ 2400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `EVAL` | 2 | `EVAL\|g(2)\|-15` | function_operations_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|4 × 12 = 48, not 24` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (-6x) * (5x)\|-30x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-9) * (5x)\|-45x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (-9) * (7)\|-63` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-6x) * (7)\|-42x` | multiplying_binomials_generator.py |
...
| `FUNC_OP` | 2 | `FUNC_OP\|(g/h)(2)\|g(2)/h(2)` | function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|f(t) = 3t + 3\|f(5)` | function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, piecewise_evaluation_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 26.10\|line 4 answers $171.10` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(173, 6)\|P(X > 179)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 18x^4 - 6x^4 - 30x^4 - 24x^4) / (-6x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-18x^4) / (-6x) + (-6x^4) / (-6x) + (-30x^4) / (-6x) + (-24x^4) / (-6x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x + 1)(-x^2 + 5x - 5)` | multiplying_polynomials_generator.py |
...
| `SUBST` | 3 | `SUBST\|x\|-5\|2(-5)+5y+7` | evaluate_expression_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, piecewise_evaluation_generator.py |
