...
| `ESTIMATE` | 2 | `ESTIMATE\|6777 × 5955 ≈ 7000 × 6000\|42000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|42000000\|40357035\|40357035 ≈ 42000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-72 ÷ 8 = -9, not -7` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 gives the scale factor 7\|line 5 answers 35` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(89, 12)\|P(X > 98.6)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(16x^6 + 4x^5 - 4x^5) / (-4x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(16x^6) / (-4x^3) + (4x^5) / (-4x^3) + (-4x^5) / (-4x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 1)(x^2 - 2x + 3)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(98.6 - 89)/12\|0.80` | normal_table_generator.py |
