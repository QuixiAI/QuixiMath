...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|x - 7 = 3` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|2x - 2 >= 11 -> x >= 13/2` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|5x - 9\| < 10` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <=` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|AND case\|-10 < 5x - 9 < 10` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|x - 7\| = 3` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|x - 7 = 3\|x - 7 = -3` | absolute_value_equation_generator.py |
...
| `ANGLE_RELATION` | 1 | `ANGLE_RELATION\|3x + 10 = 6x - 35` | angle_relationships_generator.py |
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|vertical\|Vertical angles are equal` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|-3x = -45\|x = 15` | angle_relationships_generator.py |
...
| `CHECK` | 3 | `CHECK\|cross_products\|2×24=48\|3×16=48` | linear_fractional_generator.py, ratio_table_generator.py, special_solution_equation_generator.py, tip_bill_split_generator.py |
| `CHECK_POINT` | 3 | `CHECK_POINT\|x=0\|11·0 + 13 = 13\|11·0 + 12 = 12` | special_solution_equation_generator.py |
| `CIRCLE_CALCULATE` | 2 | `CIRCLE_CALCULATE\|C = 17π\|17π` | circle_generator.py |
| `CIRCLE_FORMULA` | 1 | `CIRCLE_FORMULA\|C = πd` | circle_generator.py |
| `CIRCLE_SETUP` | 2 | `CIRCLE_SETUP\|17\|diameter` | circle_generator.py |
| `CIRCLE_SUBSTITUTE` | 1 | `CIRCLE_SUBSTITUTE\|C = π × 17` | circle_generator.py |
...
| `COMB_CONST` | 3 | `COMB_CONST\|9\|-1\|8` | equation_from_two_points_generator.py, linear_complex_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|x + 2 < -2 -> x < -4` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|6 < x + 4 < 9` | compound_inequality_generator.py |
...
| `DISC` | 3 | `DISC\|225\|216\|9` | quadratic_generator.py |
| `DIST` | 3 | `DIST\|-1\|-4x-5\|4x+5` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-4y + -35 = 1` | systems_substitution_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|x\|1x^3 + 2x^2 + 3x` | multiplying_polynomials_generator.py |
| `DIV_CHECK` | 3 | `DIV_CHECK\|62\|2\|0` | divisibility_classification_generator.py |
| `DIV_COEFF` | 3 | `DIV_COEFF\|8\|-8\|x=-1` | linear_complex_generator.py |
| `DIV_SETUP` | 2 | `DIV_SETUP\|577\|80` | decimal_div_generator.py, percent_problem_generator.py |
| `E` | 3 | `E\|21\|2\|441` | pythag_hyp_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(-2, -7)\|(-3, -5)` | equation_from_two_points_generator.py |
| `EQ_OP_BOTH` | 4 | `EQ_OP_BOTH\|divide\|2\|x\|1` | absolute_value_equation_generator.py, linear_fractional_generator.py, one_step_equation_generator.py, special_solution_equation_generator.py, systems_elimination_generator.py, systems_substitution_generator.py, two_step_equation_generator.py |
| `EQ_OP_NOTE` | 3 | `EQ_OP_NOTE\|multiply\|z\|to both sides` | equation_from_two_points_generator.py, literal_equation_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, standard_form_conversion_generator.py |
| `EQ_RESULT` | 2 | `EQ_RESULT\|x\|1` | linear_fractional_generator.py, one_step_equation_generator.py, special_solution_equation_generator.py, two_step_equation_generator.py |
| `EQ_SETUP` | 1 | `EQ_SETUP\|x = 120/5` | linear_fractional_generator.py, literal_equation_generator.py, one_step_equation_generator.py, proportion_word_problem_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py, two_step_equation_generator.py |
| `EQ_SIMPLIFY` | 1 | `EQ_SIMPLIFY\|x/5 = -2` | linear_fractional_generator.py, two_step_equation_generator.py |
| `EXP_EXPAND` | 1 | `EXP_EXPAND\|(-5) × (-5)` | exponent_generator.py |
| `EXP_PARTIAL` | 3 | `EXP_PARTIAL\|-5\|-5\|25` | exponent_generator.py |
| `EXP_RULE_APPLY` | 4 | `EXP_RULE_APPLY\|negate\|4\|\|4` | exponent_generator.py |
| `EXP_RULE_IDENTIFY` | 2 | `EXP_RULE_IDENTIFY\|negative_exponent\|x^(-n) = 1/x^n` | exponent_generator.py |
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|x^(-4)` | exponent_generator.py |
| `EXP_RULE_SIMPLIFY` | 1 | `EXP_RULE_SIMPLIFY\|1/x^4` | exponent_generator.py |
| `EXP_SETUP` | 2 | `EXP_SETUP\|-5\|2` | exponent_generator.py |
...
| `FOIL_F` | 2 | `FOIL_F\|First: (-1x) * (-2x)\|2x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-4) * (-2x)\|8x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (-4) * (2)\|-8` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-1x) * (2)\|-2x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(-x - 4)(-2x + 2)` | multiplying_binomials_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|add\|9\|-1 < 5x < 19` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
| `INEQ_OP_BOTH` | 4 | `INEQ_OP_BOTH\|subtract\|13\|x\|0` | linear_fractional_generator.py, one_step_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_RESULT` | 3 | `INEQ_RESULT\|x\|≤\|0` | linear_fractional_generator.py, one_step_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_SETUP` | 1 | `INEQ_SETUP\|x + 13 ≤ 13` | linear_fractional_generator.py, one_step_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_SIMPLIFY` | 1 | `INEQ_SIMPLIFY\|7x > 49` | two_step_inequality_generator.py |
...
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = -2x - 5\|(6, -2)` | parallel_perpendicular_line_generator.py |
...
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|-14 / -7\|2` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|-4 * 1\|-4` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-14x^7) / (-7x^3)` | monomial_mult_div_generator.py |
| `MONO_SUB_EXP` | 2 | `MONO_SUB_EXP\|x^7 / x^3 = x^(7-3)\|x^4` | monomial_mult_div_generator.py |
| `MOVE_TERM` | 3 | `MOVE_TERM\|+4x\|left\|-4x+1-4x = +9` | linear_complex_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py |
...
| `MUL_TERM` | 3 | `MUL_TERM\|4\|(1/2)x\|2x` | linear_fractional_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = -2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|3x + 7 = 3x + 7` | angle_relationships_generator.py |
| `PARALLEL_SETUP` | 2 | `PARALLEL_SETUP\|alternate_interior\|Alternate interior angles are equal` | angle_relationships_generator.py |
| `PARALLEL_SOLVE` | 2 | `PARALLEL_SOLVE\|0x = 0\|x = 20` | angle_relationships_generator.py |
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.25\|40\|10` | percent_problem_generator.py |
...
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 7 = -2(x + 2)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|x^3 - 3x^2 - 6x + 8` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(4x^5 - 1x^4 + 4x^3) / (x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(4x^5) / (x^2) + (-1x^4) / (x^2) + (4x^3) / (x^2)` | polynomial_div_monomial_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-4x^3 +5x^3) + (-6x^2 +3x^2) + (-6x) + (8)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 4)(x^2 + 2x + 3)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1 | `POLY_SETUP\|(-4x^3 - 6x^2) + (5x^3 + 3x^2 - 6x + 8)` | polynomial_add_sub_generator.py |
| `PRIME` | 1 | `PRIME\|37` | divisibility_classification_generator.py |
| `PROB_CONDITIONAL` | 2 | `PROB_CONDITIONAL\|P(blue\|first was red)\|4/7` | compound_probability_generator.py |
| `PROB_DEPENDENT` | 1 | `PROB_DEPENDENT\|Drawing without replacement means dependent events` | compound_probability_generator.py |
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Draw with replacement: red then green` | compound_probability_generator.py |
| `PROB_IDENTIFY` | 2 | `PROB_IDENTIFY\|P(red)\|9/14` | compound_probability_generator.py |
| `PROB_INDEPENDENT` | 1 | `PROB_INDEPENDENT\|Drawing with replacement means independent events` | compound_probability_generator.py |
| `PROB_MULTIPLY` | 3 | `PROB_MULTIPLY\|9/14\|1/7\|9/98` | compound_probability_generator.py |
...
| `PYTHAG_CALCULATE` | 2 | `PYTHAG_CALCULATE\|d² = 100 + 576 = 676\|676` | pythag_leg_generator.py |
| `PYTHAG_CONTEXT` | 2 | `PYTHAG_CONTEXT\|displacement\|east=10m, north=24m` | pythag_leg_generator.py |
| `PYTHAG_FORMULA` | 1 | `PYTHAG_FORMULA\|a² + b² = c²` | pythag_leg_generator.py |
| `PYTHAG_MODEL` | 3 | `PYTHAG_MODEL\|east=10\|north=24\|distance=?` | pythag_leg_generator.py |
...
| `Q1` | 4 | `Q1\|-15\|3\|6\|-2` | quadratic_generator.py |
| `Q2` | 4 | `Q2\|-15\|3\|6\|-3` | quadratic_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 90 / 0.75` | percent_problem_generator.py |
...
| `ROOT` | 2 | `ROOT\|5625\|75` | pythag_hyp_generator.py, quadratic_generator.py |
| `ROOT_EXTRACT` | 2 | `ROOT_EXTRACT\|4` | exponent_generator.py |
| `ROOT_IDENTIFY` | 3 | `ROOT_IDENTIFY\|16\|perfect_square\|4` | exponent_generator.py |
| `ROOT_SETUP` | 1 | `ROOT_SETUP\|√16` | exponent_generator.py |
| `ROOT_SIMPLIFY` | 1 | `ROOT_SIMPLIFY\|6√3` | exponent_generator.py |
...
| `SA_FACES` | 3 | `SA_FACES\|top/bottom\|6 × 7\|42` | volume_3d_generator.py |
| `SA_FORMULA` | 1 | `SA_FORMULA\|SA = 2(lw + lh + wh)` | volume_3d_generator.py |
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 8 × 7\|112π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=6, w=7, h=11` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(42 + 66 + 77)\|370` | volume_3d_generator.py |
| `SCALE_DIV` | 3 | `SCALE_DIV\|112\|16\|7.0` | scaling_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|112 feet\|scaled_dimension` | scaling_generator.py |
| `SCALE_MULT` | 3 | `SCALE_MULT\|2.5\|100\|250.0` | scaling_generator.py |
| `SCALE_SETUP` | 3 | `SCALE_SETUP\|1 inch\|16 feet\|16` | scaling_generator.py |
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|6.0\|8` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|left\|8` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|multiply_coefficients\|2.5\|3.6\|9.0` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|(2.5 × 10^5) × (3.6 × 10^3)` | exponent_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 0.25 * 40` | percent_problem_generator.py |
| `SIMILAR_APPLY` | 3 | `SIMILAR_APPLY\|6\|5\|30` | scaling_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = 7 - 8x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|-2` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(7, 1)\|(-10, 0)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (0 - 1) / (-10 - 7)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SPECIAL_SOLUTION` | 2 | `SPECIAL_SOLUTION\|13 = 12\|contradiction: no value of x works` | special_solution_equation_generator.py |
| `STAT_ABS_DEV` | 2 | `STAT_ABS_DEV\|1\|1` | statistics_generator.py |
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(47 + 61) / 2\|54.0` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|8` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|28\|27\|1` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|336 / 8\|42` | statistics_generator.py |
| `STAT_FREQUENCY` | 2 | `STAT_FREQUENCY\|17\|2` | statistics_generator.py |
| `STAT_MAD` | 3 | `STAT_MAD\|32\|5\|6.4` | statistics_generator.py |
| `STAT_MAX` | 1 | `STAT_MAX\|87` | statistics_generator.py |
| `STAT_MEAN` | 2 | `STAT_MEAN\|135 / 5\|27` | statistics_generator.py |
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|positions 4 and 5\|47, 61` | statistics_generator.py |
| `STAT_MIN` | 1 | `STAT_MIN\|45` | statistics_generator.py |
| `STAT_MODE` | 2 | `STAT_MODE\|26\|4` | statistics_generator.py |
| `STAT_ORDER` | 1 | `STAT_ORDER\|36, 44, 46, 47, 61, 63, 82, 92` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|87 - 45\|42` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|31, 43, 45, 23, 35, 61, 30, 68` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|31 + 43 + 45 + 23 + 35 + 61 + 30 + 68\|336` | statistics_generator.py |
| `SUBST` | 3 | `SUBST\|x\|0\|2(0)-3y+9` | evaluate_expression_generator.py |
| `SUB_COL` | 3 | `SUB_COL\|col_1\|1-6-borrow0\|->5 (borrow_out 1)` | multi_digit_subtraction_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -9x = -81` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with x only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = -3y + -35` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * 2, Eq2 * -1` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|-8x + 8y = -32\|-1x - 8y = -49` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x + 3y = -35\|1x -1y = 1` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=-9 into x = -3y + -35` | systems_elimination_generator.py, systems_substitution_generator.py |
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|48\|62\|exterior` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|exterior = 48 + 62\|110` | angle_relationships_generator.py |
...
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 4 × 8\|16.0` | volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 16.0 × 6\|96.0` | volume_3d_generator.py |
| `VOL_FORMULA` | 1 | `VOL_FORMULA\|V = Base Area × length` | volume_3d_generator.py |
| `VOL_SETUP` | 2 | `VOL_SETUP\|triangular_prism\|b=4, h_tri=8, length=6` | volume_3d_generator.py |
