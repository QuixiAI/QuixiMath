...
789 distinct op-codes observed.
...
| `MOD_REDUCE` | 3 | `MOD_REDUCE\|169\|mod 11\|4` | calendar_arithmetic_generator.py, crt_generator.py, modular_arithmetic_generator.py, modular_inverse_generator.py |
