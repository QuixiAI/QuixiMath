...
1800 distinct op-codes observed.
...
| `AC_SETUP` | 3 | `AC_SETUP\|resonance\|R=28, L=4\|C=1/324` | ac_circuit_generator.py |
| `ADAM_SETUP` | 3 | `ADAM_SETUP\|theta=12,g=6\|beta1=9/10,beta2=99/100\|lr=1/10,epsilon=0` | adam_step_generator.py |
| `ADAM_UPDATE` | 2 | `ADAM_UPDATE\|theta_new\|119/10` | adam_step_generator.py |
...
| `ADJOINT` | 1 | `ADJOINT\|U^dagger=[[24/25,7/25],[-7/25,24/25]]` | hermitian_check_generator.py |
| `ADJ_LIST` | 2 | `ADJ_LIST\|A\|B, D` | euler_circuit_generator.py, graph_traversal_generator.py |
| `ALG_SETUP` | 3 | `ALG_SETUP\|merge sort\|merges 2\|values 19, 40, 39, 23, 32, 33, 26` | algorithm_trace_generator.py |
| `ALIGN_NUM` | 2 | `ALIGN_NUM\|046.36\|177.07` | number_comparison_generator.py |
| `ALPHA` | 2 | `ALPHA\|line 1\|2: j; 3: ¬i` | kernel_ridge_generator.py, semantic_tableau_generator.py |
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda c. ((lambda f. (c c)) t)\|lambda z. ((lambda f. (z z)) t)` | lambda_reduction_generator.py |
| `AMORT_ROW` | 3 | `AMORT_ROW\|1\|interest=$555.00\|principal=$1370.00,balance=$2330.00` | annuity_generator.py |
| `AMPLITUDE` | 2 | `AMPLITUDE\|abs(-3)\|3` | sinusoid_features_generator.py |
| `ANALOGY_SETUP` | 3 | `ANALOGY_SETUP\|man=(-3,2)\|woman=(-3,4)\|king=(-3,-1)` | embedding_similarity_generator.py |
...
| `ANGLE_DEFECT_SETUP` | 2 | `ANGLE_DEFECT_SETUP\|R=7\|angles=75,75,15` | angle_defect_generator.py |
...
| `ANGLE_RELATION` | 1 | `ANGLE_RELATION\|6x + 66 = 180` | angle_relationships_generator.py |
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|supplementary\|(4x + 7)° + (2x + 59)° = 180°` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|6x = 114\|x = 19` | angle_relationships_generator.py |
| `ANGLE_WRAP` | 2 | `ANGLE_WRAP\|336 deg\|-24 deg` | complex_log_generator.py |
| `ANNUITY_FORMULA` | 1 | `ANNUITY_FORMULA\|PV = PMT/r` | annuity_generator.py |
| `ANNUITY_SETUP` | 2, 3 | `ANNUITY_SETUP\|perpetuity present value\|PMT=3065,r=25%` | annuity_generator.py |
| `ANTICHAIN` | 2 | `ANTICHAIN\|{7, 35, 52}\|size 3` | partial_order_generator.py |
...
| `APPLY` | 3 | `APPLY\|∧I\|1,2\|f ∧ p` | natural_deduction_generator.py |
| `APPLY_GATE` | 3 | `APPLY_GATE\|Y\|e^(i69π/269)·ket0\|i·e^(i69π/269)·ket1` | quantum_gate_generator.py |
| `APPLY_OPERATOR` | 2 | `APPLY_OPERATOR\|L[Ae^(2x)]\|A(4 - 2 - 12)e^(2x)` | commutator_generator.py, undetermined_coeff_generator.py |
| `APPLY_PAULI` | 2 | `APPLY_PAULI\|sigma_x psi\|[112/113,15/113]` | spin_half_generator.py |
| `APPLY_SUBST` | 1 | *(not observed in sampling)* | unification_generator.py |
| `APPROX` | 2 | `APPROX\|12*d^2*L\|894910464` | param_count_generator.py |
...
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|5*6^2/2\|90` | centroid_generator.py |
...
| `ARG_SETUP` | 2 | `ARG_SETUP\|¬(s ∧ s) ∧ (p ∧ (s ∨ s))\|¬(s ∧ s)` | argument_form_generator.py |
| `ARITH_INTERVAL` | 1 | `ARITH_INTERVAL\|[3/4,1)` | arithmetic_coding_generator.py |
| `ARITH_SETUP` | 2 | `ARITH_SETUP\|A=1/2, B=1/4, C=1/4\|message=CCACC` | arithmetic_coding_generator.py |
| `ARITH_SYMBOL` | 2 | `ARITH_SYMBOL\|C\|cum=[3/4,1)` | arithmetic_coding_generator.py |
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|2, 10, 8, 1, 36, 14, 29` | algorithm_trace_generator.py |
...
| `ATA` | 2 | `ATA\|A^T A\|[[2785, 936], [936, 2785]]` | svd_generator.py |
| `ATOM_CHECK` | 3 | `ATOM_CHECK\|C\|left=1\|right=1` | stoichiometry_generator.py |
| `ATTN_OUTPUT` | 2 | `ATTN_OUTPUT\|1\|[[-2/3,-4]]` | attention_generator.py |
...
| `AV_VECTOR` | 2 | `AV_VECTOR\|A*v1\|[61/√2, 61/√2]` | svd_generator.py |
| `AXIOM` | 2 | `AXIOM\|total probability\|Σ P(ω) = 1` | probability_axioms_finite_generator.py, probability_measure_generator.py |
| `AXIOM_MATCH` | 2 | `AXIOM_MATCH\|L1\|p := (m ∨ d), q := ((g ∨ m) → n)` | hilbert_axiom_derivation_generator.py |
...
| `BACKPROP_SETUP` | 3 | `BACKPROP_SETUP\|x=(-2,-2)\|y=4\|eta=1/8` | backprop_generator.py |
| `BACK_SUB` | 2 | `BACK_SUB\|v = y/x\|y/x = -ln(x) + C` | ode_substitution_generator.py |
| `BACK_SUB_ROW` | 3 | `BACK_SUB_ROW\|r=595\|x=1\|y=0` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `BASE` | 2 | `BASE\|g(0)\|-14` | recursive_definition_unfold_generator.py |
| `BASE_ADD_COL` | 3 | `BASE_ADD_COL\|col 0\|0 + 0 + carry 0\|0 -> digit 0, carry 0` | base_arithmetic_generator.py |
| `BASE_ARITH_SETUP` | 2 | `BASE_ARITH_SETUP\|base 16\|18A * 3` | base_arithmetic_generator.py |
| `BASE_CARRY` | 2 | `BASE_CARRY\|carry 1\|digit 1, carry 0` | base_arithmetic_generator.py |
| `BASE_MUL_COL` | 3 | `BASE_MUL_COL\|col 0\|A * 3 + carry 0\|30 -> digit E, carry 1` | base_arithmetic_generator.py |
| `BASE_SETUP` | 2 | `BASE_SETUP\|172_10\|binary` | base_conversion_generator.py |
...
| `BAYES_UPDATE_SETUP` | 2, 3 | `BAYES_UPDATE_SETUP\|beta_binomial\|prior=Beta(8,5)\|successes=1, trials=6` | bayesian_update_generator.py |
| `BCH_FORM` | 2 | `BCH_FORM\|A+B+1/2[A,B]\|[[0, 4, 4], [0, 0, 2], [0, 0, 0]]` | bch_generator.py |
| `BCH_SETUP` | 3 | `BCH_SETUP\|A=4E12\|B=2E23\|order=2` | bch_generator.py |
...
| `BETA` | 1, 3 | `BETA\|line 2\|1L: 6: ¬c\|1R: 7: ¬o` | lambda_reduction_generator.py, semantic_tableau_generator.py |
| `BETA_COUNT` | 1 | `BETA_COUNT\|3` | lambda_reduction_generator.py |
| `BEZOUT_CHECK` | 2 | `BEZOUT_CHECK\|595*17 + 532*-19\|7` | extended_euclid_generator.py |
...
| `BINARY_EXPONENT` | 2 | `BINARY_EXPONENT\|6\|110` | mod_exp_generator.py, quadratic_residue_generator.py |
| `BINOM_FORMULA` | 1 | `BINOM_FORMULA\|Var(X) = n·p·(1-p)` | binomial_probability_generator.py |
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 10, p = 1/4\|Var(X)` | binomial_probability_generator.py |
...
| `BITWISE` | 1 | `BITWISE\|∨\|11000010\|11110001\|11110011` | characteristic_vector_generator.py |
...
| `BLACKBODY_SETUP` | 3 | `BLACKBODY_SETUP\|wien_peak\|b=8008\|T=728` | blackbody_generator.py |
| `BOND_FORMULA` | 1 | `BOND_FORMULA\|price=sum coupon/(1+y)^t + face/(1+y)^n` | bond_pricing_generator.py |
| `BOND_PRICE` | 1 | `BOND_PRICE\|$2743.20` | bond_pricing_generator.py |
| `BOND_SETUP` | 2 | `BOND_SETUP\|face=4500\|coupon=5%,ytm=25%,years=3` | bond_pricing_generator.py |
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables P, Q, R\|CNF from F=0 rows` | boolean_algebra_generator.py |
...
| `BOX_SETUP` | 1, 3 | `BOX_SETUP\|energy_level\|n=4, h=2\|m=8, L=8` | particle_in_box_generator.py |
| `BRAKET_FORMULA` | 1 | `BRAKET_FORMULA\|inner(phi,psi)=sum conj(phi_k)*psi_k` | braket_generator.py |
| `BRAKET_SETUP` | 3 | `BRAKET_SETUP\|inner_product\|phi=[-1+i,2+i]\|psi=[i,i]` | braket_generator.py |
| `BRANCH_CLOSE` | 2 | `BRANCH_CLOSE\|1\|c, ¬c` | semantic_tableau_generator.py |
| `BRANCH_OPEN` | 2 | `BRANCH_OPEN\|1\|i=F, j=T` | semantic_tableau_generator.py |
...
| `BRING_DOWN` | 2 | `BRING_DOWN\|group 27\|current = 27` | composite_arithmetic_generator.py, manual_square_root_generator.py |
...
| `CAL_SETUP` | 3 | `CAL_SETUP\|2024-01-01 through 2024-01-16\|count Sunday\|inclusive` | calendar_arithmetic_generator.py, calorimetry_generator.py |
...
| `CANONICAL_ORDER` | 1 | `CANONICAL_ORDER\|A=2, D=2, B=3, C=3` | kraft_inequality_generator.py |
| `CANONICAL_SHIFT` | 3 | `CANONICAL_SHIFT\|code=0\|left=2\|0` | kraft_inequality_generator.py |
| `CARD_RULE` | 2 | `CARD_RULE\|continuum definition\|2^ℵ0 = c` | cardinal_arithmetic_generator.py |
| `CARRY_FINAL` | 1 | `CARRY_FINAL\|1` | multi_digit_addition_generator.py |
| `CARTESIAN_RESULT` | 1 | `CARTESIAN_RESULT\|{(g, 3), (g, 16)}` | set_operations_generator.py |
| `CART_PAIR` | 3 | `CART_PAIR\|g\|3\|(g, 3)` | set_operations_generator.py |
| `CASE` | 1, 2 | `CASE\|Cleo=knight, Luca=knight, Ravi=knight` | countability_bijection_generator.py, knights_knaves_generator.py |
| `CASHFLOW_PV` | 2 | `CASHFLOW_PV\|coupon_t1\|180` | bond_pricing_generator.py |
| `CASIMIR_FORCE_SETUP` | 2 | `CASIMIR_FORCE_SETUP\|F/A=-π^2*hbar*c/(240*d^4)\|hbar=13,c=7,d=4` | casimir_force_generator.py |
| `CASIMIR_SETUP` | 3 | `CASIMIR_SETUP\|spin=2\|hbar=48\|J^2=Jz^2+(J+J-+J-J+)/2` | casimir_generator.py |
...
| `CEIL` | 2 | `CEIL\|2206.3125\|2207` | confidence_interval_generator.py |
...
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(360)/(90)\|4` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= 5*x\|0 <= x <= 6\|centroid` | centroid_generator.py |
...
| `CF_RESULT` | 1 | `CF_RESULT\|[1; 1, 2, 8, 6]` | continued_fraction_generator.py |
| `CF_SETUP` | 1 | `CF_SETUP\|257/153` | continued_fraction_generator.py |
...
| `CHAIN` | 2 | `CHAIN\|{7, 9}\|length 2` | partial_order_generator.py |
| `CHAIN_DERIV` | 2 | `CHAIN_DERIV\|dy/dx\|0` | activation_generator.py |
| `CHAIN_RATE` | 2 | `CHAIN_RATE\|x_s\|-1` | multivar_chain_rule_generator.py |
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*x_s + f_y*y_s\|(-45)*(-1) + 31*2\|107` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(3,2)\|(-1)*3 + 2 + (-2)\|-3` | multivar_chain_rule_generator.py |
...
| `CHECK_POINT` | 3 | `CHECK_POINT\|x=0\|7·0 + 27 = 27\|7·0 + 27 = 27` | special_solution_equation_generator.py |
...
| `CHOL_SETUP` | 2 | `CHOL_SETUP\|A = [[25, -10, -15], [-10, 13, 0], [-15, 0, 17]]\|A = L L^T` | cholesky_generator.py |
| `CHRISTOFFEL_FORMULA` | 1 | `CHRISTOFFEL_FORMULA\|Gamma^i_jk = 1/2 g^im(d_j g_mk + d_k g_mj - d_m g_jk)` | christoffel_generator.py |
| `CHRISTOFFEL_SETUP` | 3 | `CHRISTOFFEL_SETUP\|sphere\|g_phiphi=R^2, g_thetatheta=R^2 sin^2(phi)\|R=75, phi=45 deg` | christoffel_generator.py |
| `CHRISTOFFEL_VALUE` | 2 | `CHRISTOFFEL_VALUE\|Gamma^phi_thetatheta\|-1008/4225` | riemann_tensor_generator.py |
| `CHURCH_NUMERAL` | 2 | `CHURCH_NUMERAL\|3\|lambda t. (lambda k. (t (t (t k))))` | lambda_reduction_generator.py |
...
| `CIRCLE_EQ` | 1 | `CIRCLE_EQ\|x^2 + (y - 1)^2 = 36` | complex_locus_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(4 - 0)*30\|120` | vector_theorem_generator.py |
...
| `CLASS` | 2 | `CLASS\|[1]\|{1, 11, 48}` | equivalence_relation_generator.py |
| `CLASSIFY` | 2 | `CLASSIFY\|contingency\|T at 2 of 4 rows` | foundations_critic_generator.py, truth_table_generator.py |
| `CLAUSE` | 2 | `CLAUSE\|C1\|(¬P3476)` | resolution_proof_generator.py |
| `CLIFFORD_EXPECT` | 3 | `CLIFFORD_EXPECT\|2*eta=2\|I_entry=0\|0` | gamma_matrix_generator.py |
| `CLOSURE_ADD` | 2 | `CLOSURE_ADD\|(9, 36)\|symmetric` | relation_closure_generator.py |
| `CLUE_APPLY` | 3 | `CLUE_APPLY\|clue 1\|Iris has fish\|36 → 12 candidates` | logic_grid_puzzle_generator.py |
...
| `CNF` | 1 | `CNF\|ω` | ordinal_arithmetic_generator.py |
| `CNF_FORM` | 1 | `CNF_FORM\|(P OR Q OR R) AND (P OR NOT Q OR R) AND (NOT P OR Q OR R) AND (NOT P OR Q OR NOT R) AND (NOT P OR NOT Q OR R)` | boolean_algebra_generator.py |
...
| `COLLIDER_SETUP` | 3 | `COLLIDER_SETUP\|cross_section\|N=132 events\|L=28 fb^-1` | cross_section_generator.py |
| `COLLISION` | 1 | `COLLISION\|f(h) = f(k) = 23` | function_properties_generator.py |
| `COLLISION_SETUP` | 3 | `COLLISION_SETUP\|elastic_1d\|m1=15, u1=9\|m2=14, u2=-4` | collision_generator.py |
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2, 3\|[[-3, 2, -4], [-2, 1, -3], [-2, 0, -3]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(5,1)\|5` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = 4*v1 - 11*v2\|[-1, 0]` | diagonalization_generator.py |
| `COMB_CONST` | 3 | `COMB_CONST\|-1\|-7\|-8` | derivative_product_quotient_generator.py, equation_from_two_points_generator.py, linear_complex_generator.py, rational_expr_add_sub_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `COMB_X` | 3 | `COMB_X\|3x\|+x\|4x` | derivative_product_quotient_generator.py, linear_complex_generator.py, rational_expr_add_sub_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `COMM_RESULT` | 2 | `COMM_RESULT\|[x,p]f\|18i*x^19` | commutator_generator.py |
| `COMM_SETUP` | 3 | `COMM_SETUP\|[x,p]f\|f=x^19\|p=-i*hbar*D, hbar=18` | commutator_generator.py |
...
| `COMPOSE` | 3 | `COMPOSE\|m\|f(m) = 5\|g(5) = H` | function_properties_generator.py |
| `COMPOSE_PAIR` | 3 | `COMPOSE_PAIR\|(i, 2)\|(2, N)\|(i, N)` | relation_operations_generator.py |
...
| `CONCLUDE` | 1 | `CONCLUDE\|t ∣ a` | direct_proof_algebra_generator.py |
| `CONCLUSION_AT` | 2 | `CONCLUSION_AT\|p=T, q=T, s=F\|F` | argument_form_generator.py |
...
| `COND_PARTS` | 2 | `COND_PARTS\|p ∨ q\|(q ∨ r) ∧ (p ∨ q)` | conditional_forms_generator.py |
...
| `CONGRUENCE_REDUCE` | 2 | `CONGRUENCE_REDUCE\|25x congruent to 1\|mod 13` | modular_inverse_generator.py |
| `CONGRUENCE_SOLUTIONS` | 3 | `CONGRUENCE_SOLUTIONS\|base 12\|step 13\|12, 25, 38` | modular_inverse_generator.py |
...
| `CONSERVATION_SETUP` | 2 | `CONSERVATION_SETUP\|mu- -> gamma + anti_nu_mu + e- + nu_e + gamma\|check=Q,B,Le,Lmu` | conservation_law_generator.py |
| `CONSERVE_CHECK` | 3 | `CONSERVE_CHECK\|Q\|left=-1,right=-1\|conserved` | conservation_law_generator.py |
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|x + y = 6\|x = 2*6/3\|4` | lagrange_multiplier_generator.py |
| `CONST_SOLVE` | 2 | `CONST_SOLVE\|C1 = -2\|C2 = 2` | recurrence_generator.py |
| `CONTOUR_SETUP` | 3 | `CONTOUR_SETUP\|abs(z)=3\|positive orientation\|f=2/(z+7) + 2/(z+4) + 6/(z-2)` | contour_integral_generator.py |
...
| `CONV_SETUP` | 2, 3 | `CONV_SETUP\|x=[5,7,7,6,3]\|h=[6,9,7,0]` | convolution_generator.py, convolutional_code_viterbi_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[4, -11]` | diagonalization_generator.py |
| `CORRECT_BIT` | 3 | `CORRECT_BIT\|position=6\|1->0\|corrected=1010101` | hamming_code_generator.py |
...
| `COSET` | 2 | `COSET\|1H\|{1, 9, 25}` | coset_generator.py |
...
| `COUNTEREXAMPLE` | 2, 3 | `COUNTEREXAMPLE\|set pair\|A = ∅; B = {72}; left = {72}; right = ∅` | argument_form_generator.py, conditional_forms_generator.py, counterexample_search_generator.py, truth_table_generator.py |
| `COUNTERMODEL` | 1 | `COUNTERMODEL\|researchers=TFF, gardeners=FFF, dancers=FTF` | syllogism_generator.py |
...
| `COVER` | 3 | `COVER\|∅\|{a}\|no c strictly between` | partial_order_generator.py |
| `COV_ENTRY` | 2 | `COV_ENTRY\|xx\|9/2` | pca_generator.py |
| `COV_FORMULA` | 1 | `COV_FORMULA\|Cov=E[XY]-E[X]E[Y]` | joint_distribution_generator.py |
| `CRC_CHECK` | 3 | `CRC_CHECK\|codeword=110000011\|remainder=0000\|valid` | crc_generator.py |
| `CRC_REMAINDER` | 1 | `CRC_REMAINDER\|0011` | crc_generator.py |
| `CRC_SETUP` | 3 | `CRC_SETUP\|data=11000\|poly=11101\|augmented=110000000` | crc_generator.py |
| `CRC_SKIP` | 2 | `CRC_SKIP\|i=1\|leading bit 0` | crc_generator.py |
| `CRC_XOR` | 3 | `CRC_XOR\|i=0\|11000 xor 11101\|00101` | crc_generator.py |
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|10*x + y - 39 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|10*(-2) - 1^2\|-21` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=1\|ln(24/7)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|2·EF = 10·4` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CROSS_RATIO` | 1 | `CROSS_RATIO\|5/16` | mobius_transform_generator.py |
| `CROSS_RATIO_SETUP` | 4 | `CROSS_RATIO_SETUP\|z1=6\|z2=-5\|z3=1\|z4=-2` | mobius_transform_generator.py |
...
| `CURL_COMPONENT` | 3 | `CURL_COMPONENT\|i\|-5 - 4\|-9` | div_curl_generator.py |
| `CURRENT_YIELD` | 1 | `CURRENT_YIELD\|125/1524` | bond_pricing_generator.py |
| `CURVATURE_FORMULA` | 2 | `CURVATURE_FORMULA\|circle\|kappa = 1/R` | curve_geometry_generator.py |
| `CURVE_GEOM_SETUP` | 3 | `CURVE_GEOM_SETUP\|r(t) = <-3*t - 2, 4*t - 6>\|0 <= t <= 2\|arc length` | curve_geometry_generator.py |
...
| `CX_A` | 3 | `CX_A\|0\|112/113\|112/113` | braket_generator.py, spin_half_generator.py |
| `CX_M` | 3 | `CX_M\|0\|15/113\|0` | braket_generator.py, spin_half_generator.py |
...
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|X U\|{S}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|S\|X U` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string bedee\|length 5` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{X} x {U,X}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|b\|{X}` | cyk_parser_generator.py |
...
| `DATE_ORDINAL` | 2 | `DATE_ORDINAL\|2024-07-06\|739073` | calendar_arithmetic_generator.py |
...
| `DECODE` | 2 | `DECODE\|11110011\|{a, b, e, n, v, z}` | characteristic_vector_generator.py |
...
| `DEMOIVRE_POWER` | 1 | `DEMOIVRE_POWER\|243 cis(330 deg)` | de_moivre_generator.py |
| `DEMOIVRE_SETUP` | 2, 4 | `DEMOIVRE_SETUP\|power\|r=3\|theta=210 deg\|n=5` | de_moivre_generator.py |
| `DENSITY` | 2 | `DENSITY\|f_X(x)\|1/13` | rv_transform_generator.py |
| `DENSITY_MATRIX` | 1 | `DENSITY_MATRIX\|rho=[[10/13,0],[0,3/13]]` | density_matrix_generator.py |
| `DENSITY_SETUP` | 2, 3 | `DENSITY_SETUP\|state=plus_phase_0\|psi=(ket00 + e^(i27π/257)ket10)/sqrt(2)` | density_matrix_generator.py, partial_trace_generator.py |
...
| `DERANGE_SETUP` | 2 | `DERANGE_SETUP\|n = 13\|exactly 2 fixed` | derangement_generator.py |
...
| `DERIVED` | 2 | `DERIVED\|C5\|(P29349)` | resolution_proof_generator.py |
...
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -1], [1, 0], [1, 1]]\|y = [10, 1, 4]` | least_squares_generator.py |
...
| `DFT_SETUP` | 2 | `DFT_SETUP\|N=4\|x=[-6,-6,8,0]` | dft_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[8, 3], [-11, -4]]\|D = [[-3, 0], [0, -2]]\|P^-1 = [[-4, -3], [11, 8]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[18, 36, 54]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = x^2 + 3*y^2 + y\|point (-2, -3)\|dx=1/4, dy=-2/5` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|(-4)*1/4 + (-17)*(-2/5)\|5.8` | multivar_chain_rule_generator.py |
...
| `DIST` | 3 | `DIST\|2\|3x+1\|6x+2` | derivative_limit_def_generator.py, derivative_product_quotient_generator.py, equation_from_two_points_generator.py, function_composition_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, polar_parametric_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_expr_add_sub_generator.py, recursive_explicit_generator.py, simplify_expression_generator.py, solid_revolution_generator.py, special_solution_equation_generator.py, tangent_line_generator.py |
...
| `DIST_SETUP` | 2, 3 | `DIST_SETUP\|Bernoulli\|p = 3/5` | discrete_uniform_bernoulli_generator.py, named_distribution_generator.py |
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited B\|A=2, B=0, C=8, D=6` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|x\|- 4x^3 + 2x^2 - 2x` | multiplying_polynomials_generator.py |
| `DIVIDE_EQ` | 2 | `DIVIDE_EQ\|divide by y^2\|y^(-2)dy/dx + y^(-1) = 3` | ode_substitution_generator.py |
| `DIVMOD` | 3, 4 | `DIVMOD\|172\|2\|86\|r=0` | base_conversion_generator.py, induction_verify_generator.py, recursive_definition_unfold_generator.py |
...
| `DIV_COEFF` | 3 | `DIV_COEFF\|-8\|4\|x=-2` | linear_complex_generator.py |
| `DIV_SETUP` | 2 | `DIV_SETUP\|330\|2` | decimal_div_generator.py, percent_problem_generator.py |
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y + R_z\|-5 - 2 - 2\|-9` | div_curl_generator.py |
...
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT X AND NOT Y AND NOT Z) OR (NOT X AND NOT Y AND Z) OR (NOT X AND Y AND NOT Z) OR (NOT X AND Y AND Z) OR (X AND NOT Y AND NOT Z) OR (X AND Y AND NOT Z)` | boolean_algebra_generator.py |
| `DOMAIN` | 1, 2 | `DOMAIN\|x = −29..−19\|{−29, −28, −27, −26, −25, −24, −23, −22, −21, −20, −19}` | quantifier_finite_domain_generator.py, relation_operations_generator.py, set_builder_roster_generator.py |
...
| `DOPPLER_SETUP` | 3 | `DOPPLER_SETUP\|relativistic_approach\|f=886\|beta=63/65` | doppler_generator.py |
| `DOT` | 2, 3 | `DOT\|(0, 6) · (0, 1)\|0*0 + 6*1\|6` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
| `DOT4` | 4 | `DOT4\|gamma0gamma0\|(3,2)\|0*0 + 0*1 + 1*0 + 0*0\|0` | gamma_matrix_generator.py |
...
| `ECDSA_SETUP` | 4 | `ECDSA_SETUP\|E/F_17, G=(5,1), n=19\|d=4\|z=9\|k=8` | ecdsa_generator.py |
| `ECDSA_SIGN` | 2 | `ECDSA_SIGN\|s=k^-1(z+rd) mod n\|s=10` | ecdsa_generator.py |
| `ECDSA_VERIFY` | 2 | `ECDSA_VERIFY\|u1=18\|u2=7` | ecdsa_generator.py |
| `EC_ACCUM` | 2 | `EC_ACCUM\|1P\|(16,13)` | elliptic_curve_finite_field_generator.py |
| `EC_ADD` | 1 | `EC_ADD\|(13,7)` | ecdsa_generator.py |
| `EC_IDENTITY` | 2 | `EC_IDENTITY\|O + Q\|(16,13)` | elliptic_curve_finite_field_generator.py |
...
| `EC_PUBLIC` | 2 | `EC_PUBLIC\|A=(10,6)\|B=(0,6)` | ecdh_generator.py |
| `EC_SCALAR` | 2 | `EC_SCALAR\|a=3\|aG=(10,6)` | ecdh_generator.py, ecdsa_generator.py |
| `EC_SCALAR_SETUP` | 2 | `EC_SCALAR_SETUP\|k=6\|P=(16,13)` | elliptic_curve_finite_field_generator.py |
...
| `EC_X3` | 2 | `EC_X3\|2P\|0` | elliptic_curve_finite_field_generator.py |
| `EC_Y3` | 2 | `EC_Y3\|2P\|11` | elliptic_curve_finite_field_generator.py |
| `EDGE_CHECK` | 3 | `EDGE_CHECK\|(691, 691)\|(c, c)\|absent` | structure_isomorphism_generator.py |
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|DE\|weight 2\|add D` | mst_generator.py |
...
| `EDGE_LIST` | 1 | `EDGE_LIST\|AB, BC, CD` | euler_circuit_generator.py |
...
| `EIGENVECTOR` | 2 | `EIGENVECTOR\|A + 3I times v = 0\|[2, -1]` | diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, svd_generator.py |
| `EIGEN_CHECK` | 3 | `EIGEN_CHECK\|sigma_y psi\|1*psi\|lambda=1` | spin_half_generator.py |
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 3I\|[[2, 4], [0, 0]]` | eigenvalue_generator.py |
| `EINSTEIN_SETUP` | 2, 3 | `EINSTEIN_SETUP\|trace\|T_ij=[[6, 5, -3], [-4, 5, -1], [5, -4, 1]]` | einstein_summation_generator.py |
| `ELEC_FORMULA` | 1 | `ELEC_FORMULA\|left charge: E1=q1/r1^2` | electrostatics_generator.py |
| `ELEC_SETUP` | 2, 3 | `ELEC_SETUP\|field_axis\|q1=2, x1=-9\|q2=7, x2=8` | electrostatics_generator.py |
...
| `ELIMINATE` | 1, 3 | `ELIMINATE\|clue 1\|Cleo: fish, lemonade; Iris: gecko, punch; Gia: rabbit, tea\|violates clue` | logic_grid_puzzle_generator.py, newtons_laws_generator.py |
...
| `EL_SOLVE` | 2 | `EL_SOLVE\|yddot\|190/27` | lagrangian_generator.py |
| `EMBED_SETUP` | 1 | `EMBED_SETUP\|A=(5,12), B=(4,3), C=(3,4)` | embedding_similarity_generator.py |
| `ENERGY_FORMULA` | 1 | `ENERGY_FORMULA\|vf^2=vi^2+2W/m` | energy_conservation_generator.py |
| `ENERGY_LEVEL` | 2 | `ENERGY_LEVEL\|E_28=hbar*omega*(n+1/2)\|3762` | ladder_operator_generator.py |
| `ENERGY_SETUP` | 3 | `ENERGY_SETUP\|work_energy\|m=1\|vi=19, W=240` | energy_conservation_generator.py |
...
| `ENTROPY_SETUP` | 2, 3 | `ENTROPY_SETUP\|eigenvalues=[1/16,1/16,1/4,1/16,1/32,1/32,1/32,1/16,1/32,1/16,1/16,1/4]\|S=-sum lambda log2(lambda)` | entropy_change_generator.py, entropy_generator.py, huffman_coding_generator.py, information_gain_generator.py, mutual_information_generator.py, von_neumann_entropy_generator.py |
...
| `EQ_SIMPLIFY` | 1 | `EQ_SIMPLIFY\|6x = 12` | error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, two_step_equation_generator.py |
| `ESCAPE_CHECK` | 3 | `ESCAPE_CHECK\|n=1\|norm2=125/16\|escaped` | fractal_iteration_generator.py |
| `ESTIMATE` | 2 | `ESTIMATE\|54501 × 50733 ≈ 50000 × 50000\|2500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1.4 × 10^6\|1350000\|rounded estimate` | fermi_estimation_generator.py, long_division_generator.py, multi_digit_multiplication_generator.py |
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|595\|532\|1\|63` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|D\|route suffix D\|stack A-B-C` | euler_circuit_generator.py |
| `EULER_CRITERION` | 2 | `EULER_CRITERION\|89^18 mod 37\|36` | quadratic_residue_generator.py |
...
| `EULER_ROUTE` | 2 | `EULER_ROUTE\|A-B-C-D\|uses 3 edges` | euler_circuit_generator.py |
...
| `EVAL_PARTIAL` | 3 | `EVAL_PARTIAL\|f_x\|2*1 - 2*1\|0` | gradient_generator.py, multivar_chain_rule_generator.py |
...
| `EV_FORMULA` | 1, 2 | `EV_FORMULA\|E[I] = P(I=1)\|13/27` | discrete_uniform_bernoulli_generator.py, expected_value_generator.py |
| `EV_SETUP` | 2 | `EV_SETUP\|P(X=4) = 3/10; P(X=6) = 1/5; P(X=8) = 1/10; P(X=5) = 2/5\|Var(X)` | expected_value_generator.py |
| `EXACT_MATCH` | 2 | `EXACT_MATCH\|F_y = N\|x + g'(y) = x + 10*y + 5` | exact_ode_generator.py |
| `EXPAND` | 1, 2 | `EXPAND\|a = yh\|a = (td)h` | complex_locus_generator.py, direct_proof_algebra_generator.py, mobius_transform_generator.py, zf_axiom_identify_generator.py |
| `EXPECTATION` | 3 | `EXPECTATION\|E[X]=16/29\|E[Y]=16/29\|E[XY]=204/841` | joint_distribution_generator.py |
...
| `EXP_ENTRY` | 3 | `EXP_ENTRY\|(1,1)\|6*e^(-6t) - 5*e^(-4t)\|6*e^(-6t) - 5*e^(-4t)` | matrix_exponential_generator.py |
| `EXP_EXPAND` | 1 | `EXP_EXPAND\|(-11) × (-11)` | exponent_generator.py |
...
| `EXP_RULE_APPLY` | 3, 4 | `EXP_RULE_APPLY\|negate\|27\|27` | exponent_generator.py, exponent_mixed_rules_generator.py |
...
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|(wm)^(-27)` | exponent_generator.py, exponent_mixed_rules_generator.py, rational_exponent_generator.py |
| `EXP_RULE_SIMPLIFY` | 1 | `EXP_RULE_SIMPLIFY\|1/(wm)^27` | exponent_generator.py, exponent_mixed_rules_generator.py |
| `EXP_SETUP` | 2 | `EXP_SETUP\|-11\|2` | exponent_generator.py |
| `EXP_SUB` | 3 | `EXP_SUB\|t/tau\|2\|e^-2` | transient_circuit_generator.py |
| `EXP_VALUE` | 2 | `EXP_VALUE\|exp(-z)\|1` | activation_generator.py |
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|595\|532` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `FACTOR` | 1, 2 | `FACTOR\|a = t(dh)` | direct_proof_algebra_generator.py, polynomial_inequality_generator.py, second_order_ode_generator.py, transfer_function_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `FEATURE_MAP_SETUP` | 3 | `FEATURE_MAP_SETUP\|K(x,z)=(xz+2)^2\|phi(t)=(t^2,2t,2)\|x=4,z=11` | feature_map_generator.py |
...
| `FERMAT_SETUP` | 3 | `FERMAT_SETUP\|prime 31\|base 9\|exponent 177` | totient_generator.py |
...
| `FINITE_DIFF_SETUP` | 3 | `FINITE_DIFF_SETUP\|table\|x=[1, 4, 7, 10]\|y=[10, 28, 64, 118]` | finite_difference_generator.py |
...
| `FIRSTLAW_SETUP` | 3 | `FIRSTLAW_SETUP\|adiabatic\|Q=0\|W=74` | first_law_generator.py |
| `FIXED_CHECK` | 3 | `FIXED_CHECK\|d\|f(d) = z\|not fixed` | function_properties_generator.py |
| `FIXED_EQ` | 1 | `FIXED_EQ\|z=(az+b)/(cz+d)` | mobius_transform_generator.py |
| `FIXED_POINT` | 1 | `FIXED_POINT\|-1` | mobius_transform_generator.py |
| `FIXED_POINT_SETUP` | 3 | `FIXED_POINT_SETUP\|g(x)=1/3*x-2\|x0=3\|iterations=4` | fixed_point_generator.py |
| `FIXED_POINT_UPDATE` | 3 | `FIXED_POINT_UPDATE\|1\|x_0=3\|x_1=-1` | fixed_point_generator.py |
...
| `FLOPS_SETUP` | 2 | `FLOPS_SETUP\|rule=2mnk\|m=128,d=128,h=1024,o=128` | flops_memory_generator.py |
| `FLUX_SUM` | 2 | `FLUX_SUM\|(-2 - 2 + 3)*240\|-240` | vector_theorem_generator.py |
...
| `FOLD` | 2 | `FOLD\|g(1)\|-6` | peano_arithmetic_generator.py, recursive_definition_unfold_generator.py |
...
| `FORM` | 2 | `FORM\|forward\|(p ∨ q) → ((q ∨ r) ∧ (p ∨ q))` | conditional_forms_generator.py, zf_axiom_identify_generator.py |
...
| `FOURIER_COEF` | 1 | `FOURIER_COEF\|b_5=18/5` | fourier_series_generator.py |
| `FOURIER_SETUP` | 3 | `FOURIER_SETUP\|sawtooth\|A=9\|n=5` | fourier_series_generator.py |
| `FOUR_VECTOR_SETUP` | 3 | `FOUR_VECTOR_SETUP\|signature=+---\|p=[4,-8,8,6]\|q=[-7,5,0,-8]` | four_vector_generator.py |
| `FRACTAL_SETUP` | 4 | `FRACTAL_SETUP\|julia\|z0=(-1,-3/2)\|c=(0,-1/2)\|N=4` | fractal_iteration_generator.py |
...
| `FUNDAMENTAL_FORM_SETUP` | 3 | `FUNDAMENTAL_FORM_SETUP\|sphere\|R=8\|theta in [0,2pi/3], phi in [60,180]` | fundamental_form_generator.py |
| `GAME_SETUP` | 2 | `GAME_SETUP\|payoffs=(12,18;16,14)\|row player maximizes, column player minimizes` | game_theory_generator.py |
| `GAMMA_SETUP` | 3 | `GAMMA_SETUP\|anticommutator_entry\|gamma0,gamma0\|entry=(3,2)` | gamma_matrix_generator.py |
| `GAS_FORMULA` | 1 | `GAS_FORMULA\|PV=nRT so n=PV/T` | gas_law_generator.py, gas_stoichiometry_generator.py |
| `GAS_SETUP` | 3 | `GAS_SETUP\|ideal_moles\|P=1, V=20\|T=7, R=1` | gas_law_generator.py |
...
| `GAUSSIAN_CURVATURE_SETUP` | 2, 3 | `GAUSSIAN_CURVATURE_SETUP\|sphere\|R=35` | gaussian_curvature_generator.py |
| `GAUSS_BONNET_SETUP` | 3 | `GAUSS_BONNET_SETUP\|flat_torus\|width=25, height=36\|chi=0` | gauss_bonnet_generator.py |
| `GAUSS_FORMULA` | 1 | `GAUSS_FORMULA\|E*(4πr^2)=Q` | gauss_law_generator.py |
| `GAUSS_SETUP` | 3 | `GAUSS_SETUP\|sphere\|Q=5\|r=1` | gauss_law_generator.py |
| `GCD` | 2 | `GCD\|gcd(265,720)\|5` | derangement_generator.py, pollard_factorization_generator.py |
| `GCD_DIV` | 4 | `GCD_DIV\|9353\|870\|10\|653` | rationals_as_pairs_generator.py |
...
| `GD_SETUP` | 3 | `GD_SETUP\|f(x,y)=1/2*(1x^2+1y^2)\|start=(-3,2)\|eta=1/5` | gradient_descent_generator.py |
| `GD_UPDATE` | 3 | `GD_UPDATE\|w_old=(-1,3)\|eta=1/3\|w_new=(-1,7/3)` | gradient_step_generator.py |
| `GELLMANN_IDENTITY` | 3 | `GELLMANN_IDENTITY\|Tr(lambda_5 lambda_6)\|2 delta_ab\|0` | pauli_algebra_generator.py |
| `GELLMANN_SETUP` | 3 | `GELLMANN_SETUP\|trace\|A=-4lambda_5\|B=-2lambda_6` | pauli_algebra_generator.py |
...
| `GEO_PROB_SETUP` | 2 | `GEO_PROB_SETUP\|number line from 0 to 58\|lands between 23 and 40` | geometric_probability_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^2]\|(1 + x)^6(1 + x)^3` | generating_function_generator.py |
...
| `GOAL` | 1 | `GOAL\|show h + 1 is even` | direct_proof_algebra_generator.py, point_slope_generator.py, standard_form_conversion_generator.py |
| `GODEL_DECODE` | 2 | `GODEL_DECODE\|1, 2, 7\|( ) p` | godel_numbering_generator.py |
| `GODEL_TERM` | 2 | `GODEL_TERM\|2^1\|2` | godel_numbering_generator.py |
| `GRAD` | 2 | `GRAD\|1\|-17/24` | softmax_gradient_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = x^2 + 4*y^2 - 2*x*y\|point (1, 1)\|directional` | gradient_generator.py |
| `GRAPH_CHANGE` | 3 | `GRAPH_CHANGE\|Week 1\|Week 2\|0` | graph_interpret_generator.py |
| `GRAPH_DATA` | 2 | `GRAPH_DATA\|bar_chart\|Tennis:9,Swimming:42,Basketball:31,Baseball:22` | graph_interpret_generator.py |
| `GRAPH_MAX` | 2 | `GRAPH_MAX\|Giraffes\|35` | graph_interpret_generator.py |
| `GRAPH_MAX_CHANGE` | 3 | `GRAPH_MAX_CHANGE\|Week 4\|Week 5\|8` | graph_interpret_generator.py |
| `GRAPH_MIN` | 2 | `GRAPH_MIN\|min\|26` | graph_interpret_generator.py |
| `GRAPH_READ` | 2 | `GRAPH_READ\|Basketball\|31` | graph_interpret_generator.py |
...
| `GREATEST` | 1 | `GREATEST\|58` | partial_order_generator.py |
| `GREAT_CIRCLE_SETUP` | 3 | `GREAT_CIRCLE_SETUP\|R=12\|A=(-90,0)\|B=(30,90)` | great_circle_generator.py |
...
| `GS_SETUP` | 2 | `GS_SETUP\|vectors [[6, 0], [6, 2]]\|orthogonal basis, not normalized` | gram_schmidt_generator.py |
| `GS_SUBTRACT` | 2 | `GS_SUBTRACT\|remove projection on u1\|[0, 2]` | gram_schmidt_generator.py, qr_decomposition_generator.py |
| `GS_VECTOR` | 2 | `GS_VECTOR\|u1 = v1\|[6, 0]` | gram_schmidt_generator.py |
...
| `HAM_EQ` | 2 | `HAM_EQ\|thetadot=dH/dp_theta\|thetadot=p_theta/448` | hamiltonian_generator.py |
| `HAM_SETUP` | 3 | `HAM_SETUP\|pendulum\|m=7, L=8\|g=10, q=theta` | hamiltonian_generator.py |
| `HARMONIC_SETUP` | 1 | `HARMONIC_SETUP\|u=4x^2 - 4y^2 - x - 5y` | cauchy_riemann_generator.py |
| `HAWKING_SETUP` | 3 | `HAWKING_SETUP\|entropy\|S_BH=k_B*c^3*A/(4*hbar*G)\|k_B=3,c=1,A=36,hbar=12,G=12` | hawking_generator.py |
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|10*(-2) - 1^2\|-21` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = 5*x^2 - y^2 + x*y - 39*x - 6*y\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = -21\|f_xx = 10\|saddle point` | hessian_classify_generator.py |
...
| `HUFFMAN_MERGE` | 2 | `HUFFMAN_MERGE\|A:1/8 + D:1/8\|AD:1/4` | huffman_coding_generator.py |
| `HUFFMAN_SETUP` | 1 | `HUFFMAN_SETUP\|A=1/8, B=1/2, C=1/4, D=1/8` | huffman_coding_generator.py |
| `HYDROGEN_FORMULA` | 1 | `HYDROGEN_FORMULA\|E_ion=R_E/n^2` | hydrogen_atom_generator.py |
| `HYDROGEN_SETUP` | 3 | `HYDROGEN_SETUP\|ionization_energy\|n=8\|R_E=7 eV` | hydrogen_atom_generator.py |
| `HYPERBOLIC_DISTANCE_SETUP` | 3 | `HYPERBOLIC_DISTANCE_SETUP\|disk\|P=(0,0)\|Q=(7/20,0)` | hyperbolic_distance_generator.py |
| `HYPERBOLIC_SETUP` | 2 | `HYPERBOLIC_SETUP\|e^x=25/14\|e^(-x)=14/25` | hyperbolic_function_generator.py |
...
| `ICE_ROW` | 2 | `ICE_ROW\|current\|[A]=2.5, [B]=12.5` | equilibrium_ice_generator.py |
| `IDENTIFY` | 2 | `IDENTIFY\|order does not matter\|use C(n, r)` | permutation_combination_generator.py |
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=1..29 C(i,1) = C(30,2)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=32, n(B)=46, n(C)=28\|n(AB)=18, n(AC)=17, n(BC)=13, n(ABC)=7` | inclusion_exclusion_generator.py |
| `IFACTOR` | 2 | `IFACTOR\|mu = e^(∫ 4 dx)\|e^(4x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `IG_SETUP` | 3 | `IG_SETUP\|parent pos=4, neg=12\|total=16\|splits=region,color` | information_gain_generator.py |
| `IMAGE` | 2 | `IMAGE\|o\|6` | function_properties_generator.py, mobius_transform_generator.py |
...
| `INDEX_SETUP` | 3 | `INDEX_SETUP\|c=2\|j=3, k=3\|l=3, m=1` | index_gymnastics_generator.py |
...
| `INEQ_OP_BOTH` | 4 | `INEQ_OP_BOTH\|divide\|7\|x\|-8` | domain_range_generator.py, linear_fractional_generator.py, one_step_inequality_generator.py, two_step_inequality_generator.py |
...
| `INEQ_SETUP` | 1 | `INEQ_SETUP\|7x ≤ -56` | linear_fractional_generator.py, one_step_inequality_generator.py, polynomial_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_SIMPLIFY` | 1 | `INEQ_SIMPLIFY\|x/-4 ≤ 5` | domain_range_generator.py, linear_fractional_generator.py, two_step_inequality_generator.py |
| `INEX_TERM` | 3 | `INEX_TERM\|0\|1×4^4\|256` | function_properties_generator.py |
| `INFO_GAIN` | 2 | `INFO_GAIN\|region\|0.31125` | information_gain_generator.py |
...
| `INITIAL_SYSTEM` | 2 | `INITIAL_SYSTEM\|C1[2, 1] + C2[1, 1]\|[6, 2]` | ode_system_generator.py |
...
| `INNER_PRODUCT` | 2 | `INNER_PRODUCT\|inner(phi,psi)\|2+i` | braket_generator.py |
| `INNER_PRODUCT_SETUP` | 3 | `INNER_PRODUCT_SETUP\|interval=[0,2pi]\|f=cos(25x)\|g=cos(25x)` | function_inner_product_generator.py |
| `INSERT_KEY` | 3 | `INSERT_KEY\|pass 1\|10\|index 1` | algorithm_trace_generator.py |
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 1\|2, 10, 8, 1, 36, 14, 29` | algorithm_trace_generator.py |
...
| `INTEGRAL_SETUP` | 1 | `INTEGRAL_SETUP\|L = integral from 0 to pi of 8 dtheta` | metric_arc_length_generator.py |
| `INTEGRATE` | 2 | `INTEGRATE\|v_y = u_x\|v=8xy + 5x - y + phi(x)` | cauchy_riemann_generator.py |
...
| `INTERFERENCE_SETUP` | 3 | `INTERFERENCE_SETUP\|double_slit\|m=5, lambda=9\|L=5, d=22` | interference_generator.py |
| `INTERP_SETUP` | 3 | `INTERP_SETUP\|lagrange\|points=(-4,-67), (-1,-13), (3,-25)\|x=-5` | interpolation_generator.py |
| `INTERVAL_CLASS` | 2 | `INTERVAL_CLASS\|s2=-208\|spacelike` | minkowski_interval_generator.py |
...
| `INT_OP` | 4 | `INT_OP\|+\|17\|17\|34` | integer_operations_generator.py |
| `INT_REWRITE` | 2 | `INT_REWRITE\|17 - (-17)\|17 + 17` | integer_operations_generator.py |
...
| `INVERSE_PAIR` | 2 | `INVERSE_PAIR\|(n, 30)\|(30, n)` | function_properties_generator.py, relation_operations_generator.py |
| `INV_FORMULA` | 1 | `INV_FORMULA\|A⁻¹ = (1/det)·[[d, -b], [-c, a]]` | matrix_inverse_generator.py |
| `IRR_SETUP` | 2 | `IRR_SETUP\|c0=-1500,c1=3750\|r0=0,iterations=2` | npv_irr_generator.py |
| `IRR_VALUE` | 2 | `IRR_VALUE\|f1\|2250` | npv_irr_generator.py |
| `ITERATE` | 2 | `ITERATE\|n=1\|z=(-5/4,5/2)` | fractal_iteration_generator.py, gradient_descent_generator.py |
...
| `JACOBI_SETUP` | 3 | `JACOBI_SETUP\|a=97\|n=65\|n odd` | jacobi_symbol_generator.py |
...
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|5*(-3) - 4*3\|-27` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[5, 4], [3, -3]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = 5*u + 4*v\|y = 3*u - 3*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
| `JOINT_SETUP` | 3 | `JOINT_SETUP\|X,Y in {0,1}\|p00=117/841, p01=260/841\|p10=260/841, p11=204/841` | joint_distribution_generator.py |
...
| `KERNEL_SETUP` | 3 | `KERNEL_SETUP\|type=polynomial\|points=A=(2,0), B=(1,-3)\|c=1,d=2` | kernel_evaluation_generator.py |
...
| `KIN_SETUP` | 3, 4 | `KIN_SETUP\|d = 380 miles\|v = 76 miles/hour\|time` | invariant_mass_generator.py, kinematics_generator.py |
| `KL_FORMULA` | 1 | `KL_FORMULA\|D=sum source_i*log2(source_i/target_i)` | kl_divergence_generator.py |
| `KL_SETUP` | 3 | `KL_SETUP\|P=[56/127,15/254,1/2]\|Q=[7/254,60/127,1/2]\|direction=Q to P` | kl_divergence_generator.py |
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|100, 101\|B AND NOT C` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|B=0\|0, 0, 0, 1` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows B=0,B=1\|columns CD=00,CD=01,CD=11,CD=10` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|(B AND NOT C) OR (NOT B AND C AND NOT D)` | boolean_algebra_generator.py |
| `KMEANS_SETUP` | 2 | `KMEANS_SETUP\|points=P1=(2,-2), P2=(0,5), P3=(-4,-1), P4=(-3,4)\|centroids=C1=(-1,5), C2=(-3,4)` | kmeans_step_generator.py |
| `KNN_DISTANCE` | 3 | `KNN_DISTANCE\|P1\|label=B\|d2=25` | knn_generator.py |
| `KNN_NEIGHBORS` | 1 | `KNN_NEIGHBORS\|P5:2:A,P1:25:B,P3:32:B` | knn_generator.py |
| `KNN_SETUP` | 3 | `KNN_SETUP\|q=(0,3)\|k=3\|training=P1=(5,3,B), P2=(5,0,A), P3=(4,-1,B), P4=(1,-4,A), P5=(1,2,A)` | knn_generator.py |
| `KNN_SORT` | 1 | `KNN_SORT\|P5:2:A,P1:25:B,P3:32:B,P2:34:A,P4:50:A` | knn_generator.py |
| `KP_EXAMPLE` | 3 | `KP_EXAMPLE\|1\|x=-2,y=1\|alpha=(0,0,0)` | kernel_perceptron_generator.py |
| `KP_SETUP` | 3 | `KP_SETUP\|kernel=linear\|data=[(-2,1), (5,-1), (3,1)]\|alpha0=(0,0,0)` | kernel_perceptron_generator.py |
...
| `KRAFT_CLASSIFY` | 2 | `KRAFT_CLASSIFY\|excess=9/8\|no prefix code` | kraft_inequality_generator.py |
| `KRAFT_FORMULA` | 1 | `KRAFT_FORMULA\|sum 2^-l_i` | huffman_coding_generator.py, kraft_inequality_generator.py |
| `KRAFT_SETUP` | 2 | `KRAFT_SETUP\|A=3, B=1, C=3, D=3, E=1, F=3, G=3, H=1\|binary prefix code` | kraft_inequality_generator.py |
| `KRAFT_TERM` | 3 | `KRAFT_TERM\|A\|l=3\|1/8` | kraft_inequality_generator.py |
| `KRR_SETUP` | 3 | `KRR_SETUP\|kernel=linear\|data=[(-5,-2), (-3,-6)]\|lambda=2,x*=-5` | kernel_ridge_generator.py |
...
| `LADDER_SETUP` | 3 | `LADDER_SETUP\|commutator_energy\|state=ket28\|hbar=12, omega=11` | ladder_operator_generator.py |
...
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = x^2*y\|constraint x + y = 6\|maximize` | lagrange_multiplier_generator.py |
| `LAGRANGIAN` | 1, 2 | `LAGRANGIAN\|L=T-V` | lagrangian_generator.py |
| `LAG_SETUP` | 3 | `LAG_SETUP\|atwood\|m1=4, m2=23\|g=10, q=y` | lagrangian_generator.py |
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|(((lambda t. (lambda c. ((lambda f. (c c)) t))) (lambda a. (c c))) (c c))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LAURENT_SETUP` | 3 | `LAURENT_SETUP\|center a=2\|w=(z-2)\|f=(3 + (z-2) - 5(z-2)^2 + 5(z-2)^3 - (z-2)^4 - 4(z-2)^5)/(z-2)^2` | laurent_series_generator.py |
| `LAURENT_TERM` | 1 | `LAURENT_TERM\|1(z+5)^-3` | residue_generator.py |
| `LAW` | 3 | `LAW\|biconditional elimination\|r ↔ p\|(r → p) ∧ (p → r)` | logical_equivalence_laws_generator.py, set_algebra_laws_generator.py |
| `LAYERNORM_SETUP` | 3 | `LAYERNORM_SETUP\|x=(-2,22)\|gamma=(1,4)\|beta=(-2,-5)` | layer_norm_generator.py |
| `LB` | 2 | `LB\|{18, 30}\|∅` | partial_order_generator.py |
...
| `LEGENDRE_SETUP` | 2 | `LEGENDRE_SETUP\|a=89\|p=37` | legendre_construction_generator.py, quadratic_residue_generator.py |
| `LEVEL` | 2 | `LEVEL\|v\|42495` | type_theory_generator.py |
...
| `LIMITING_REAGENT` | 2 | `LIMITING_REAGENT\|CO\|CO2=11 mol` | stoichiometry_generator.py |
| `LIMIT_CHECK` | 2 | `LIMIT_CHECK\|CO2 from CO=11 mol\|CO2 from O2=48 mol` | stoichiometry_generator.py |
...
| `LINEAR_SYSTEM` | 2 | `LINEAR_SYSTEM\|a=9/11, b=-2/11\|c=-2/11, d=6/11` | markov_chain_generator.py |
| `LINE_EQ` | 1 | `LINE_EQ\|-8x + 8y - 24 = 0` | complex_locus_generator.py |
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|60/2 - 36\|-6` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = -x + 2\|(-5, -2)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <4*x - 4*y + 3, 4*y - 4*x - 3>\|from (3, 0) to (4, -2)` | line_integral_generator.py |
| `LIST_MAX` | 2 | `LIST_MAX\|15/28, 29/51, 49/37\|49/37` | dedekind_cut_generator.py |
| `LLL_DONE` | 1 | `LLL_DONE\|[(-11,-1),(-1,-13)]` | lll_reduction_generator.py |
| `LLL_SETUP` | 1 | `LLL_SETUP\|[(-11,-1),(10,-12)]` | lll_reduction_generator.py |
| `LOCUS_SETUP` | 3 | `LOCUS_SETUP\|z=x+iy\|center=(0,1)\|radius=6` | complex_locus_generator.py |
...
| `LOG_EVAL` | 2 | `LOG_EVAL\|27/13\|ln(27/13)` | hyperbolic_distance_generator.py |
| `LOG_EXACT` | 2 | `LOG_EXACT\|log_6(10077696)\|9` | master_theorem_generator.py |
...
| `LOG_LIKELIHOOD` | 1 | `LOG_LIKELIHOOD\|ell(p)=1*log(p)+5*log(1-p)` | mle_generator.py |
...
| `LOG_SOFTMAX` | 2 | `LOG_SOFTMAX\|1\|ln(7/24)` | softmax_gradient_generator.py |
| `LOG_SUPPLIED` | 2 | `LOG_SUPPLIED\|log10(1/10)\|-1` | signal_arithmetic_generator.py |
| `LOG_TERM` | 3 | `LOG_TERM\|2\|ln(10)\|2*ln(10)` | entropy_change_generator.py |
| `LOOKUP_SUPPLIED` | 2 | `LOOKUP_SUPPLIED\|e^-3\|4979/100000` | named_distribution_generator.py |
| `LORA_COUNT` | 2 | `LORA_COUNT\|r*(d_in+d_out)\|3168` | param_count_generator.py |
| `LOWRANK_SETUP` | 2 | `LOWRANK_SETUP\|A=[[2,0], [0,19]]\|rank=1` | low_rank_approx_generator.py |
| `LP_CORNER_SETUP` | 3 | `LP_CORNER_SETUP\|max z=2x+y\|0<=x<=21, 0<=y<=10\|x+y<=29` | lp_corner_generator.py |
| `LR_PHASE` | 1 | `LR_PHASE\|warmup` | lr_schedule_generator.py |
| `LR_SETUP` | 3 | `LR_SETUP\|base=1/1000\|min=0\|warmup=100,total=900,t=52` | lr_schedule_generator.py |
| `LR_VALUE` | 1 | `LR_VALUE\|13/25000` | lr_schedule_generator.py |
| `LS_LINE` | 2 | `LS_LINE\|a = 5, b = -3\|ŷ = 5 - 3x` | least_squares_generator.py |
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-1, 10), (0, 1), (1, 4)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[1, -1, -1], [3, -4, 1], [2, 2, -15]]\|unit lower L` | lu_decomposition_generator.py |
...
| `LZ_SETUP` | 2 | `LZ_SETUP\|LZ77 decode\|(0,0,b), (0,0,o), (1,1,o), (1,1,b), (2,1,$)` | lz_compression_generator.py |
...
| `MAG_SETUP` | 3 | `MAG_SETUP\|loop_center\|I=16, R=4\|mu0=1` | magnetism_generator.py |
| `MAIN_CONNECTIVE` | 1 | `MAIN_CONNECTIVE\|∧` | wff_parsing_generator.py |
| `MAP` | 2 | `MAP\|d\|f(d) = 6` | function_properties_generator.py |
...
| `MARKOV_SETUP` | 2, 3 | `MARKOV_SETUP\|two_state\|P00=1/3, P01=2/3\|P10=3/4, P11=1/4` | entropy_rate_markov_generator.py, markov_chain_generator.py |
...
| `MATRIX_GROUP_SETUP` | 2 | `MATRIX_GROUP_SETUP\|SU2\|M=[[-1/4,1],[-1,-1/4]]` | matrix_group_check_generator.py |
...
| `MATRIX_ROW` | 2 | `MATRIX_ROW\|b\|0 1` | graph_counting_generator.py, relation_operations_generator.py |
| `MATRIX_SCALE` | 2 | `MATRIX_SCALE\|1/2 ladder sum\|[[4608, 0, 0, 0, 0], [0, 11520, 0, 0, 0], [0, 0, 13824, 0, 0], [0, 0, 0, 11520, 0], [0, 0, 0, 0, 4608]]` | bch_generator.py, casimir_generator.py |
| `MATRIX_SETUP` | 2 | `MATRIX_SETUP\|unitary\|U=[[24/25,-7/25],[7/25,24/25]]` | hermitian_check_generator.py |
...
| `MAXIMAL` | 1 | `MAXIMAL\|{58}` | partial_order_generator.py |
| `MAXTERM` | 2 | `MAXTERM\|000\|P OR Q OR R` | boolean_algebra_generator.py |
| `MC_SETUP` | 3 | `MC_SETUP\|expression=x^T A x\|A=[[-2,-4], [-4,1]]\|x=(0,-4)` | matrix_calculus_generator.py |
...
| `MEASURE_FAVORABLE` | 2 | `MEASURE_FAVORABLE\|interval length\|40 - 23 = 17` | geometric_probability_generator.py |
| `MEASURE_PROB` | 3 | `MEASURE_PROB\|computational basis\|P(0)=0\|P(1)=1` | quantum_gate_generator.py |
| `MEASURE_TOTAL` | 2 | `MEASURE_TOTAL\|total length\|58` | geometric_probability_generator.py |
...
| `MEMBER` | 1 | `MEMBER\|29/51 ∈ L(√2)` | dedekind_cut_generator.py |
| `MEMBERSHIP_BAD` | 2 | `MEMBERSHIP_BAD\|type(v) = type(v) + 1\|impossible` | type_theory_generator.py |
| `MEMBERSHIP_OK` | 1 | `MEMBERSHIP_OK\|type(s) = type(x) + 1` | type_theory_generator.py |
| `MEMBER_ROW` | 1, 3 | `MEMBER_ROW\|x∈C, x∈H, x∈R` | foundations_critic_generator.py, set_identity_membership_table_generator.py |
| `MEMORY_SETUP` | 3 | `MEMORY_SETUP\|kv_cache\|L=24,h=8,d_k=32\|seq=2048,precision_bytes=2` | flops_memory_generator.py |
| `MEMORY_UNIT` | 2 | `MEMORY_UNIT\|MiB\|48` | flops_memory_generator.py |
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=1,mid=2,hi=3\|left 40; right 39` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|40\|39\|take right` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 1-2\|array 19, 39, 40, 23, 32, 33, 26` | algorithm_trace_generator.py |
| `MERGE_TAKE` | 2 | `MERGE_TAKE\|39\|merged 39` | algorithm_trace_generator.py |
| `METRIC` | 2 | `METRIC\|taxicab vs Chebyshev\|sum of absolute differences vs their max` | taxicab_geometry_generator.py |
| `METRICS_SETUP` | 1 | `METRICS_SETUP\|TP=5, FP=30, FN=20, TN=8` | classifier_metrics_generator.py |
| `METRIC_ARC_SETUP` | 3 | `METRIC_ARC_SETUP\|polar metric\|ds^2=dr^2+r^2 dtheta^2\|r=8, theta:0->pi` | metric_arc_length_generator.py |
...
| `MGF_SETUP` | 3 | `MGF_SETUP\|P(X=0)=3/4\|P(X=1)=1/12\|P(X=2)=1/6` | mgf_generator.py |
...
| `MINIMAL` | 1 | `MINIMAL\|{23, 28}` | partial_order_generator.py |
| `MINKOWSKI_FORMULA` | 1 | `MINKOWSKI_FORMULA\|eta_total=eta1+eta2` | minkowski_interval_generator.py |
| `MINKOWSKI_SETUP` | 3 | `MINKOWSKI_SETUP\|rapidity_addition\|eta1=-2/3\|eta2=-5/3` | minkowski_interval_generator.py |
| `MINTERM` | 2 | `MINTERM\|000\|NOT X AND NOT Y AND NOT Z` | boolean_algebra_generator.py |
...
| `MI_SETUP` | 2 | `MI_SETUP\|rows=[[0,1/4,1/4,0];[1/4,0,0,1/4]]\|task=H(X,Y)` | mutual_information_generator.py |
| `MLE_SETUP` | 2, 3 | `MLE_SETUP\|bernoulli\|parameter=p\|data=[0,0,0,1,0,0]` | mle_generator.py |
| `MOBIUS_SETUP` | 2 | `MOBIUS_SETUP\|T(z)=(-3z - 3)/(3z + 5)\|z0=-5` | mobius_transform_generator.py |
...
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 47\|exponent 6\|modulus 16` | mod_exp_generator.py |
...
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|25 mod 13\|12` | crt_generator.py, ecdsa_generator.py, elliptic_curve_finite_field_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|-1\|mod 13\|12` | modular_inverse_generator.py, rsa_generator.py |
| `MOD_POWER` | 3 | `MOD_POWER\|67^5\|mod 60\|7` | diffie_hellman_generator.py, pollard_factorization_generator.py, primality_test_generator.py, rsa_generator.py, tonelli_shanks_generator.py, totient_generator.py |
| `MOD_REDUCE` | 3 | `MOD_REDUCE\|30\|mod 10\|0` | calendar_arithmetic_generator.py, cayley_table_generator.py, coset_generator.py, crt_generator.py, cyclic_group_generator.py, de_moivre_generator.py, elliptic_curve_finite_field_generator.py, finite_field_generator.py, jacobi_symbol_generator.py, lie_exponential_generator.py, mod_exp_generator.py, modular_arithmetic_generator.py, modular_inverse_generator.py, primality_test_generator.py, quadratic_residue_generator.py, reed_solomon_generator.py, rsa_generator.py, totient_generator.py |
| `MOD_SETUP` | 2, 3, 4 | `MOD_SETUP\|Luhn modulus 10\|prefix 5574578` | modular_arithmetic_generator.py, modular_inverse_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|5^2*6^3/6\|900` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|5*6^3/3\|360` | centroid_generator.py |
| `MOM_EQUATION` | 2 | `MOM_EQUATION\|E[X]=lambda\|xbar=lambda` | method_of_moments_generator.py |
| `MOM_SETUP` | 3 | `MOM_SETUP\|poisson\|parameter=lambda\|data=[0,4,7,2,0,3,9,2]` | method_of_moments_generator.py |
...
| `MOOD` | 2 | `MOOD\|OOA\|figure 2` | syllogism_generator.py |
| `MOVE_TERM` | 2, 3 | `MOVE_TERM\|-1x\|left\|3x+7+x = -1` | area_between_curves_generator.py, completing_square_generator.py, conic_standard_form_generator.py, linear_complex_generator.py, polar_parametric_generator.py, quadratic_factoring_generator.py, quadratic_square_root_generator.py, radical_equation_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py |
| `MP` | 2 | `MP\|lines 1,2\|¬(k → f) → ((m ∨ d) → (((g ∨ m) → n) → (m ∨ d)))` | hilbert_axiom_derivation_generator.py |
| `MR_DECOMPOSE` | 2 | `MR_DECOMPOSE\|72\|2^3 * 9` | primality_test_generator.py |
| `MR_SETUP` | 2 | `MR_SETUP\|n=73\|witnesses 5, 8` | primality_test_generator.py |
| `MR_SQUARE` | 2 | `MR_SQUARE\|r=1\|27` | primality_test_generator.py |
| `MR_WITNESS` | 1 | `MR_WITNESS\|5` | primality_test_generator.py |
| `MR_WITNESS_RESULT` | 2 | `MR_WITNESS_RESULT\|5\|passes at r=2` | primality_test_generator.py |
| `MSE_FORMULA` | 2 | `MSE_FORMULA\|L=(1/n) sum r_i^2\|grad=(2/n) sum r_i*[1,x_i]` | gradient_step_generator.py |
| `MSE_GRADIENT` | 2 | `MSE_GRADIENT\|g0=0\|g1=2` | gradient_step_generator.py |
| `MSE_SAMPLE` | 3 | `MSE_SAMPLE\|i=1\|pred=2\|r=1` | gradient_step_generator.py |
| `MSE_SETUP` | 3 | `MSE_SETUP\|model y_hat=w0+w1*x\|samples=[(1,1), (-1,-3)]\|w=(-1,3), eta=1/3` | gradient_step_generator.py |
| `MST_ADD` | 2 | `MST_ADD\|DE\|total 2` | mst_generator.py |
| `MST_SET` | 1 | `MST_SET\|DE` | mst_generator.py |
| `MST_SETUP` | 2 | `MST_SETUP\|weighted undirected graph\|vertices A, B, C, D, E` | mst_generator.py |
| `MU` | 2 | `MU\|-49/61\|round=-1` | lll_reduction_generator.py |
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(4x)y' + 4e^(4x)y\|10e^(5x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `MULTIVALUED_LOG` | 2 | `MULTIVALUED_LOG\|ln(209) + i*(32pi/45 + 2pi*k)\|k in Z` | complex_log_generator.py |
| `MULTI_FORMULA` | 2 | `MULTI_FORMULA\|n!/(a!b!c!...)\|10! / repeats` | stars_and_bars_generator.py |
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|2 C's, 1 V, 2 P's, 5 O's\|total 10` | stars_and_bars_generator.py |
...
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = x^2 + y^2 - 4*x*y - 3*x + y\|x = -s + t - 2, y = 2*s + 3*t - 3\|(s,t) = (3, 2)` | multivar_chain_rule_generator.py |
| `NATURAL_SETUP` | 3 | `NATURAL_SETUP\|length\|hbar=1,c=1\|L=40/9 MeV^-1` | natural_units_generator.py |
| `NB_FEATURE_COUNT` | 3 | `NB_FEATURE_COUNT\|Spam\|offer=1\|count=15` | naive_bayes_generator.py |
| `NB_LIKELIHOOD` | 3 | `NB_LIKELIHOOD\|Spam\|offer=1\|4/5` | naive_bayes_generator.py |
| `NB_PRIOR` | 2 | `NB_PRIOR\|Spam\|18/31` | naive_bayes_generator.py |
| `NB_SCORE` | 2 | `NB_SCORE\|Spam\|start=18/31` | naive_bayes_generator.py |
| `NB_SETUP` | 3 | `NB_SETUP\|query=offer=1, link=1, urgent=0\|alpha=1\|classes=Spam,Ham` | naive_bayes_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 44:55\|line 3 divides 20 by 5` | fill_in_step_generator.py |
...
| `NEWTON_SETUP` | 2, 3 | `NEWTON_SETUP\|f(x)=x^2-46\|f'(x)=2x\|x0=7,iterations=2` | newton_raphson_generator.py, newtons_laws_generator.py |
| `NEWTON_STEP` | 2 | `NEWTON_STEP\|1\|3/5` | npv_irr_generator.py |
| `NEWTON_UPDATE` | 3 | `NEWTON_UPDATE\|1\|x_0=7\|x_1=95/14` | newton_raphson_generator.py |
...
| `NEW_STRING` | 1 | `NEW_STRING\|1010011111` | cantor_diagonal_generator.py |
| `NFA_ACCEPT` | 1 | `NFA_ACCEPT\|q8` | nfa_simulation_generator.py |
| `NFA_ACTIVE` | 2 | `NFA_ACTIVE\|start\|{q0}` | nfa_simulation_generator.py |
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|u3\|{u5}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|aaabaaa` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{q0}\|a\|q0->{q0,q3}\|{q0,q3}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|a` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states q0, q3, q4, q8\|alphabet a, b\|start q0` | nfa_simulation_generator.py |
| `NFA_TRANSITION` | 3 | `NFA_TRANSITION\|q0\|a\|{q0,q3}` | nfa_simulation_generator.py |
| `NILPOTENT` | 3 | `NILPOTENT\|n>=2\|theta^2=0\|0` | grassmann_generator.py |
| `NLL` | 2 | `NLL\|82 tokens\|82*ln(8)` | perplexity_generator.py |
| `NORM2` | 2 | `NORM2\|b1\|122` | lll_reduction_generator.py |
| `NORMALIZE` | 2 | `NORMALIZE\|1/2 + 1/2\|1` | clebsch_gordan_generator.py, layer_norm_generator.py |
| `NORMALIZE_SIGN` | 2 | `NORMALIZE_SIGN\|(-9,1)\|(9,-1)` | lll_reduction_generator.py |
...
| `NO_REDEX` | 2 | `NO_REDEX\|((c c) (c c))\|no beta redex remains` | lambda_reduction_generator.py |
| `NO_WITNESS` | 2, 3 | `NO_WITNESS\|x=14\|fails y=27\|f(27) = 27` | peano_arithmetic_generator.py, quantifier_finite_domain_generator.py |
| `NPV_SETUP` | 2 | `NPV_SETUP\|c0=-2600,c1=800,c2=1750,c3=400\|rate=10%` | npv_irr_generator.py |
| `NPV_TERM` | 2 | `NPV_TERM\|t=0\|-2600` | npv_irr_generator.py |
| `NULL_REL` | 2 | `NULL_REL\|x1 - 2*x4 = 0\|x1 = 2*x4` | subspace_basis_generator.py |
| `NULL_VECTOR` | 2 | `NULL_VECTOR\|x4=1\|[2, 4, 1, 1]` | subspace_basis_generator.py |
| `NUMBER_OPERATOR` | 2 | `NUMBER_OPERATOR\|N ket19\|19 ket19` | ladder_operator_generator.py |
| `NW_ALLOC` | 1, 3 | `NW_ALLOC\|cell x11\|min(22,14)\|14` | transportation_generator.py |
...
| `OPTICS_SETUP` | 3 | `OPTICS_SETUP\|snell\|n1=5, n2=5\|sin(theta1)=1/5` | optics_generator.py |
...
| `ORBIT_SETUP` | 3 | `ORBIT_SETUP\|gravity_force\|m1=39, m2=69\|r=26, G=1` | orbital_mechanics_generator.py |
| `ORDER_PAIR` | 2 | `ORDER_PAIR\|∅ ≤ {a}\|∅ ⊆ {a}` | partial_order_generator.py |
| `ORDER_PDF` | 1 | `ORDER_PDF\|f_{1:4}(x)=4*(1-x)^3` | order_statistics_generator.py |
| `ORDER_SETUP` | 3 | `ORDER_SETUP\|n=4\|k=1\|q=11/12` | order_statistics_generator.py |
...
| `ORD_CMP` | 2 | `ORD_CMP\|coefficients at exponent 1\|2 > 1` | ordinal_arithmetic_generator.py |
...
| `OR_SETUP` | 3 | `OR_SETUP\|M/M/1\|lambda=8\|mu=21` | or_formula_generator.py |
| `OUTCOME_CHECK` | 3 | `OUTCOME_CHECK\|17\|the two-digit number is greater than 81\|no` | sample_space_list_generator.py |
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|12*x^2 + 36*x` | double_integral_generator.py |
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|x=3..8\|12*(8^2 - 3^2) + 36*(8 - 3)\|840` | double_integral_generator.py |
| `OUTER_PRODUCT` | 1 | `OUTER_PRODUCT\|rho=1/2(ket00bra00+e^(-i27π/257)ket00bra10+e^(i27π/257)ket10bra00+ket10bra10)` | partial_trace_generator.py |
...
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|(2x + 9) + (4x + 81) = 180` | angle_relationships_generator.py |
...
| `PARALLEL_SOLVE` | 2 | `PARALLEL_SOLVE\|6x + 90 = 180\|x = 15` | angle_relationships_generator.py |
| `PARAMS` | 3 | `PARAMS\|W1=[[2,1], [-2,2]]\|b1=(1,2)\|v=(2,-2), c=-1` | backprop_generator.py |
| `PARAM_PART` | 2 | `PARAM_PART\|attention_per_layer\|4734976` | param_count_generator.py |
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(-t + 2, 8*t - 4)\|0 <= t <= 1` | line_integral_generator.py |
...
| `PARSE` | 2, 3 | `PARSE\|error\|unmatched parenthesis\|position 1` | wff_parsing_generator.py |
...
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_y\|15*x^4*y^2 + 9*x^3*y^2` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|3*x^3*y^3\|d/dy\|9*x^3*y^2` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 5*x^4*y^3 + 3*x^3*y^3\|f_yy` | partial_derivative_generator.py |
| `PARTIAL_TRACE` | 2 | `PARTIAL_TRACE\|ket00bra00\|ket0bra0` | partial_trace_generator.py |
| `PARTICLE_TABLE` | 1 | `PARTICLE_TABLE\|mu-(Q=-1,B=0,Le=0,Lmu=1); gamma(Q=0,B=0,Le=0,Lmu=0); anti_nu_mu(Q=0,B=0,Le=0,Lmu=-1); e-(Q=-1,B=0,Le=1,Lmu=0); nu_e(Q=0,B=0,Le=1,Lmu=0)` | conservation_law_generator.py |
| `PARTICULAR` | 2 | `PARTICULAR\|y_p\|3e^(2x)` | undetermined_coeff_generator.py, variation_parameters_generator.py |
| `PARTICULAR_CHECK` | 2 | `PARTICULAR_CHECK\|K = -4\|6K - 8K - 12 = K` | recurrence_generator.py |
| `PARTICULAR_TRY` | 2 | `PARTICULAR_TRY\|a_n = K\|constant forcing` | recurrence_generator.py |
| `PARTITION` | 1 | `PARTITION\|{{23, 38}, {24, 29, 53, 57}}` | equivalence_relation_generator.py |
| `PARTITION_FORMULA` | 1 | `PARTITION_FORMULA\|Z=g0+g1*b` | partition_function_generator.py |
| `PARTITION_SETUP` | 3 | `PARTITION_SETUP\|degenerate_two_level\|g0=5, g1=3\|epsilon=6, b=1/8` | partition_function_generator.py |
...
| `PATH` | 2 | `PATH\|7→19→7\|add (7, 7)` | relation_closure_generator.py |
...
| `PAULI_SETUP` | 3 | `PAULI_SETUP\|anticommutator\|A=2sigma_z\|B=-4sigma_x` | pauli_algebra_generator.py |
| `PCA_SETUP` | 2 | `PCA_SETUP\|points=[(0,4), (-6,4), (-3,6), (-3,2)]\|population covariance` | pca_generator.py |
...
| `PDE_SETUP` | 2 | `PDE_SETUP\|u_t = 10u_xx on [0,11]\|u(x,0)=10sin(5πx/11)` | separable_pde_generator.py |
| `PDF_FORMULA` | 1 | `PDF_FORMULA\|f_Y(y)=1/(26*sqrt(y))` | rv_transform_generator.py |
| `PD_SETUP` | 2 | `PD_SETUP\|A=[[4,5], [5,2]]\|Sylvester criterion` | positive_definite_generator.py |
| `PEANO_BASE` | 2 | `PEANO_BASE\|SS0 · 0\|0` | peano_arithmetic_generator.py |
| `PEANO_EQ` | 2 | `PEANO_EQ\|SS0 · SSSS0\|SS0 · SSS0 + SS0` | peano_arithmetic_generator.py |
...
| `PERCEPTRON_SETUP` | 3 | `PERCEPTRON_SETUP\|eta=2\|w=(-2,2,-1)\|samples=[(-3,3,-1), (2,1,-1), (3,3,-1)]` | perceptron_generator.py |
...
| `PERM_COMPOSE` | 3 | `PERM_COMPOSE\|i=1\|tau(i)=1\|sigma(tau(i))=1` | permutation_group_generator.py |
...
| `PERPLEXITY_SETUP` | 2 | `PERPLEXITY_SETUP\|tokens=82\|p=1/8` | perplexity_generator.py |
| `PE_ENTRY` | 2 | `PE_ENTRY\|0\|1` | positional_encoding_generator.py |
| `PE_SETUP` | 3 | `PE_SETUP\|position=92\|d=2\|theta=pi/2` | positional_encoding_generator.py |
...
| `PHYS_SETUP` | 3 | `PHYS_SETUP\|W = 310 joules\|d = 5 meters\|force` | physics_formula_generator.py |
...
| `PI2_NUM` | 3 | `PI2_NUM\|-91/61440\|π^2\|-91π^2/61440` | casimir_force_generator.py |
| `PICTO_COUNT` | 2 | `PICTO_COUNT\|Tigers\|1` | graph_interpret_generator.py |
...
| `PI_DEN` | 3 | `PI_DEN\|25/16\|π\|25/(16π)` | gauss_law_generator.py, hawking_generator.py, magnetism_generator.py |
...
| `PLANCK_SETUP` | 4 | `PLANCK_SETUP\|length\|hbar=49\|G=16\|c=1` | planck_units_generator.py |
...
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|24*3/6\|12` | lagrange_multiplier_generator.py |
...
| `POLISH` | 1 | `POLISH\|EqArKpq` | wff_parsing_generator.py |
| `POLLARD_FACTOR` | 2 | `POLLARD_FACTOR\|11\|17` | pollard_factorization_generator.py |
| `POLLARD_PM1_SETUP` | 3 | `POLLARD_PM1_SETUP\|n=187\|base=3\|B=7` | pollard_factorization_generator.py |
| `POLLARD_RHO_SETUP` | 3 | `POLLARD_RHO_SETUP\|n=91\|c=3\|x0=6` | pollard_factorization_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(16x^7 - 4x^5 - 12x^4 - 4x^3) / (4x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(16x^7) / (4x^3) + (-4x^5) / (4x^3) + (-12x^4) / (4x^3) + (-4x^3) / (4x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|x^3 + x + 2` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 1)(-4x^2 + 2x - 2)` | multiplying_polynomials_generator.py |
...
| `PORT_RESULT` | 2 | `PORT_RESULT\|expected_return=0.065\|variance=0.02125` | portfolio_generator.py |
| `PORT_SETUP` | 3 | `PORT_SETUP\|wA=0.5,wB=0.5\|rA=4%,rB=9%\|varA=0.0625,varB=0.0225,cov=0` | portfolio_generator.py |
...
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|2*x^2 + 2*y^2 - 4*x*y + 3*x - 3*y` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(1/2)^2\|0.25` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|144*2 + (-112)\|176` | diagonalization_generator.py |
...
| `POWER_REDUCE` | 2 | `POWER_REDUCE\|67^149\|67^5 mod 60` | totient_generator.py |
...
| `POWER_SETUP` | 2 | `POWER_SETUP\|(e^(i*68 deg))^(-7i)\|principal logarithm` | complex_log_generator.py |
| `POWER_SET_RESULT` | 1 | `POWER_SET_RESULT\|{∅, {i}, {q}, {i, q}}` | set_operations_generator.py |
| `POWER_SHIFT` | 3 | `POWER_SHIFT\|k=0\|0-2\|-2` | laurent_series_generator.py |
| `PREDICATES` | 1 | `PREDICATES\|D(x): x is a chemist; C(x): x is careful; Z(x): x is kind` | english_to_logic_generator.py |
| `PREDICT` | 2 | `PREDICT\|x*\|-35/9` | kernel_ridge_generator.py |
| `PREIMAGE` | 2 | `PREIMAGE\|10\|∅` | function_properties_generator.py |
| `PREMISE` | 2 | `PREMISE\|1\|f` | natural_deduction_generator.py |
| `PREMISES_ALL_T` | 2 | `PREMISES_ALL_T\|p=T, s=T\|no` | argument_form_generator.py |
| `PRIME` | 1 | `PRIME\|41` | divisibility_classification_generator.py |
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited E\|DE=2, BE=8, AE=15` | mst_generator.py |
| `PRIM_START` | 1 | `PRIM_START\|E` | mst_generator.py |
| `PRINCIPAL_LOG` | 1 | `PRINCIPAL_LOG\|ln(209) + i*32pi/45` | complex_log_generator.py |
...
| `PROB_CONDITIONAL` | 2 | `PROB_CONDITIONAL\|P(green given first was red)\|4/21` | compound_probability_generator.py |
| `PROB_DEPENDENT` | 1 | `PROB_DEPENDENT\|Drawing without replacement means dependent events` | compound_probability_generator.py |
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Two dice: d20=3, d8=4` | compound_probability_generator.py |
| `PROB_IDENTIFY` | 2 | `PROB_IDENTIFY\|P(first die is 3)\|1/20` | compound_probability_generator.py |
| `PROB_INDEPENDENT` | 1 | `PROB_INDEPENDENT\|The two dice are independent events` | compound_probability_generator.py |
| `PROB_MULTIPLY` | 3 | `PROB_MULTIPLY\|1/20\|1/8\|1/160` | compound_probability_generator.py |
...
| `PROB_SIMPLIFY` | 2 | `PROB_SIMPLIFY\|48/462\|8/77` | compound_probability_generator.py |
| `PROB_WEIGHT` | 2 | `PROB_WEIGHT\|0^2\|0` | clebsch_gordan_generator.py |
| `PRODUCT` | 2 | `PRODUCT\|Delta x^2 * Delta p^2\|841pi^2/12 - 1/2` | uncertainty_generator.py |
| `PROJECT` | 2 | `PROJECT\|P1\|3` | pca_generator.py |
| `PROJECTILE_SETUP` | 3 | `PROJECTILE_SETUP\|vx=8\|vy=5\|g=10` | projectile_motion_generator.py |
...
| `PROJ_COEFF` | 3 | `PROJ_COEFF\|v2 on u1\|36/36\|1` | gram_schmidt_generator.py |
| `PROJ_VECTOR` | 2 | `PROJ_VECTOR\|u1\|[6, 0]` | gram_schmidt_generator.py |
...
| `PSD_SETUP` | 2 | `PSD_SETUP\|K=[[1,-2], [-2,8]]\|criterion=all principal minors >= 0` | kernel_validity_generator.py |
...
| `PYTHAG_CONTEXT` | 3 | `PYTHAG_CONTEXT\|displacement\|east=48m, north=36m\|diagram=BED` | pythag_leg_generator.py |
| `PYTHAG_FORMULA` | 1 | `PYTHAG_FORMULA\|a² + b² = c²` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_MODEL` | 3 | `PYTHAG_MODEL\|east=48\|north=36\|distance=?` | pythag_leg_generator.py |
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|57600\|240` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 2, 3 | `PYTHAG_SETUP\|legs=21,28\|hypotenuse NU=?` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 133225 - 75625\|57600` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|275\|75625` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|275² + b² = 365²` | pythag_leg_generator.py |
...
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[4, 1, 2], [0, 4, 1], [0, 0, 5]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
...
| `QUANTUM_SETUP` | 2, 3 | `QUANTUM_SETUP\|gate=Y\|input=e^(i69π/269)·ket0` | quantum_formula_generator.py, quantum_gate_generator.py |
...
| `QUANT_SETUP` | 3 | `QUANT_SETUP\|x=(13/50,97/100,-103/100)\|scale=1/25\|zero_point=-1` | quantization_generator.py |
...
| `QUARK_SETUP` | 3 | `QUARK_SETUP\|meson,count=107\|anti_u u\|u=2/3,d=-1/3,s=-1/3,c=2/3,b=-1/3; anti=-charge` | quark_composition_generator.py |
...
| `QUAT_INVERSE` | 2 | `QUAT_INVERSE\|p\|(3/31,-2/31,-3/31,3/31)` | quaternion_generator.py |
| `QUAT_MUL_START` | 3 | `QUAT_MUL_START\|p*q\|p\|q` | quaternion_generator.py |
| `QUAT_RESULT` | 2 | `QUAT_RESULT\|p*q\|(-14,-5,16,9)` | quaternion_generator.py |
| `QUAT_SETUP` | 2 | `QUAT_SETUP\|p=(3,2,3,-3)\|q=(-1,-2,3,-2)` | quaternion_generator.py |
...
| `RANGE` | 1 | `RANGE\|{5, 11, 17, 19}` | relation_operations_generator.py |
...
| `RATIO_BASE` | 3 | `RATIO_BASE\|33:18\|3\|11:6` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
| `RATIO_TABLE` | 2 | `RATIO_TABLE\|Red (liters): 11, 33, 44, 110\|Blue (liters): ?, 18, 24, 60` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
...
| `RECT_FORM` | 1 | `RECT_FORM\|-2i` | de_moivre_generator.py, euler_formula_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = 6 a_(n-1) - 8 a_(n-2) - 12\|a_0 = -4, a_1 = -8` | master_theorem_generator.py, recurrence_generator.py |
| `REDUCE` | 2, 3 | `REDUCE\|(99, 230)\|(0, 131)` | integers_as_pairs_generator.py, rationals_as_pairs_generator.py |
| `REDUCED_DENSITY` | 1 | `REDUCED_DENSITY\|rho_A=[[1/2,e^(-i27π/257)/2],[e^(i27π/257)/2,1/2]]` | partial_trace_generator.py |
| `REFLEXIVE_CHECK` | 2 | `REFLEXIVE_CHECK\|(1, 1)\|present` | equivalence_relation_generator.py, relation_check_generator.py |
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q23609_2` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|(a or b)*ab(a or b)*\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q23609_0\|no useful suffix` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q23609_0\|a\|q23609_1` | regex_to_automaton_generator.py |
| `REGION` | 2 | `REGION\|both\|{17, 19, 25}` | attribute_sorting_generator.py, venn_region_count_generator.py |
| `REGION_EQ` | 2 | `REGION_EQ\|A ∩ B\|10` | venn_region_count_generator.py |
| `REGION_MEASURE` | 3 | `REGION_MEASURE\|area\|3*10\|30` | vector_theorem_generator.py |
...
| `REJECT` | 1, 2 | `REJECT\|x = −29` | cantor_pairing_generator.py, conditional_forms_generator.py, counterexample_search_generator.py, factor_trinomial_generator.py, knights_knaves_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py, set_builder_roster_generator.py, structure_isomorphism_generator.py |
...
| `REL_ENERGY_SETUP` | 3 | `REL_ENERGY_SETUP\|velocity_addition\|u=4/9\|v=2/3` | relativistic_energy_generator.py |
...
| `REL_SETUP` | 2, 3 | `REL_SETUP\|A = {1, 11, 32, 40, 45, 48}\|R = {(1, 1), (1, 11), (1, 48), (11, 1), (11, 11), (11, 48), (32, 32), (32, 40), (40, 32), (40, 40), (45, 45), (48, 1), (48, 11), (48, 48)}` | equivalence_relation_generator.py, relation_check_generator.py, relation_closure_generator.py, relation_operations_generator.py, special_relativity_generator.py |
...
| `REPRESENT` | 2 | `REPRESENT\|t ∣ y\|y = td` | direct_proof_algebra_generator.py |
...
| `RESIDUE_SETUP` | 2 | `RESIDUE_SETUP\|a=-5\|f=(1 - (z+5) - (z+5)^2 - 2(z+5)^3)/(z+5)^3` | residue_generator.py |
...
| `RESOLVE` | 3 | `RESOLVE\|C1\|C2\|¬P3476` | resolution_proof_generator.py |
| `RESTRICT_CHECK` | 3 | `RESTRICT_CHECK\|(g, 1)\|g in D=yes\|keep` | relation_operations_generator.py |
| `RES_EMPTY` | 1 | `RES_EMPTY\|C7` | resolution_proof_generator.py |
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(¬P3476), C2=(P29349 ∨ P3476), C3=(¬P29349), C4=(P37428)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C2\|(P29349)` | resolution_proof_generator.py |
| `REVERSE` | 2 | `REVERSE\|0,0,1,1,0,1,0,1\|10101100` | base_arithmetic_generator.py, base_conversion_generator.py, bitwise_ops_generator.py |
...
| `RG_SETUP` | 3 | `RG_SETUP\|one_loop\|alpha0=4/59\|beta=8/3,L=1` | running_coupling_generator.py |
| `RHO_ITER` | 4 | `RHO_ITER\|1\|x=39, y=68\|abs(r)=29\|gcd=1` | pollard_factorization_generator.py |
...
| `ROUTH_ROW` | 2 | `ROUTH_ROW\|s^3\|1, 38` | routh_hurwitz_generator.py |
| `ROUTH_SETUP` | 1 | `ROUTH_SETUP\|p(s)=s^3+32s^2+38s+4` | routh_hurwitz_generator.py |
...
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, 0, -2], [0, 1, 0, -4], [0, 0, 1, -1]]` | subspace_basis_generator.py |
| `RSA_DECRYPT` | 2 | `RSA_DECRYPT\|180\|71` | rsa_generator.py |
| `RSA_ENCRYPT` | 2 | `RSA_ENCRYPT\|71\|180` | rsa_generator.py |
| `RSA_PRIVATE_KEY` | 1 | `RSA_PRIVATE_KEY\|d=107` | rsa_generator.py |
| `RSA_PUBLIC_KEY` | 2 | `RSA_PUBLIC_KEY\|n=187\|e=3` | rsa_generator.py |
| `RSA_SETUP` | 3 | `RSA_SETUP\|p=11\|q=17\|message=71` | rsa_generator.py |
| `RSQ_FORMULA` | 1 | `RSQ_FORMULA\|r^2 = Sxy^2/(Sxx·Syy)` | regression_generator.py |
| `RS_CORRECT` | 2 | `RS_CORRECT\|position=1\|[79,40,21,101]` | reed_solomon_generator.py |
| `RS_EVAL` | 2 | `RS_EVAL\|x=12\|18` | reed_solomon_generator.py |
| `RS_LINE` | 3 | `RS_LINE\|m0=54\|m1=10\|agree=2` | reed_solomon_generator.py |
| `RS_PAIR` | 2 | `RS_PAIR\|x=39,64\|y=8,40` | reed_solomon_generator.py |
| `RS_RECEIVED` | 1 | `RS_RECEIVED\|[8,40,21,101]` | reed_solomon_generator.py |
| `RS_SETUP` | 3 | `RS_SETUP\|F_109\|RS(4,2)\|points 39,64,65,78; one error allowed` | reed_solomon_generator.py |
| `RUNNING_TOTAL` | 3 | `RUNNING_TOTAL\|0\|256\|256` | function_properties_generator.py |
...
| `SAMPLE_MOMENT` | 2 | `SAMPLE_MOMENT\|xbar\|27/8` | method_of_moments_generator.py |
...
| `SA_FACES` | 3 | `SA_FACES\|top/bottom\|12 × 4\|48` | volume_3d_generator.py |
...
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=12, w=4, h=12` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(48 + 144 + 48)\|480` | round_solids_generator.py, volume_3d_generator.py |
| `SB_FORMULA` | 1 | `SB_FORMULA\|C(n+k-1, k-1)` | stars_and_bars_generator.py |
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x5 = 23\|xi >= 0` | stars_and_bars_generator.py |
| `SCALE_DIV` | 3 | `SCALE_DIV\|2937\|89\|33` | scaling_generator.py |
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|2*cos\|0` | de_moivre_generator.py, euler_formula_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|4.25 centimeters\|actual_dimension` | scaling_generator.py |
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = -3\|81*4\|324` | diagonalization_generator.py |
| `SCALE_MULT` | 3 | `SCALE_MULT\|4.25\|40\|170` | scaling_generator.py |
| `SCALE_SETUP` | 3 | `SCALE_SETUP\|1 centimeter\|40 kilometers\|40` | scaling_generator.py |
| `SCALE_SHIFT` | 2 | `SCALE_SHIFT\|1\|-3` | layer_norm_generator.py |
| `SCALING_COMPUTE` | 2 | `SCALING_COMPUTE\|6ND\|12300000000000000000` | scaling_law_generator.py |
| `SCALING_SETUP` | 3 | `SCALING_SETUP\|N=50000000\|D=41000000000\|F=37000000000000000` | scaling_law_generator.py |
| `SCAN` | 2 | `SCAN\|)\|parenthesis depth -1` | wff_parsing_generator.py |
| `SCHWARZSCHILD_SETUP` | 3, 4 | `SCHWARZSCHILD_SETUP\|time_dilation\|r_s=272\|r=425` | schwarzschild_generator.py |
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|3.02\|-6` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|left\|6` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|divide_coefficients\|7.48\|3.4\|2.2` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|3.02 × 10^-6` | exponent_generator.py |
| `SCORE_EQ` | 1 | `SCORE_EQ\|1/p=5/(1-p)` | mle_generator.py |
...
| `SEPARATOR` | 3 | `SEPARATOR\|37/26\|in L(3/2)\|not in L(√2)` | dedekind_cut_generator.py |
...
| `SET_SETUP` | 2, 3, 4 | `SET_SETUP\|S = {i, q}\|power set` | set_expression_generator.py, set_operations_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y10 = 17` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
| `SHM_FORMULA` | 1 | `SHM_FORMULA\|omega^2=g/L` | shm_generator.py |
| `SHM_SETUP` | 3 | `SHM_SETUP\|pendulum_period\|g=10\|L=10` | shm_generator.py |
| `SHORTEST` | 2 | `SHORTEST\|(9,-1)\|norm^2=82` | lll_reduction_generator.py |
| `SIDE` | 2 | `SIDE\|left\|∉` | set_identity_membership_table_generator.py |
| `SIGFIG_ROUND` | 3 | `SIGFIG_ROUND\|1350000\|2 significant figures\|1.4 × 10^6` | fermi_estimation_generator.py |
...
| `SIGNAL_SETUP` | 2, 3 | `SIGNAL_SETUP\|sampling\|f_max=1023 Hz\|f_s=3311 Hz` | signal_arithmetic_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, -7)\|y = -8\|f(y) = 17 (positive)\|up` | stability_generator.py |
| `SIMILAR_APPLY` | 3 | `SIMILAR_APPLY\|3\|0.5\|1.5` | scaling_generator.py |
| `SIMILAR_SCALE` | 3 | `SIMILAR_SCALE\|2\|4\|0.5` | scaling_generator.py |
| `SIMILAR_SETUP` | 3 | `SIMILAR_SETUP\|triangle\|8,3,4\|2 (others unknown)` | scaling_generator.py |
| `SIMPLEX_SETUP` | 3 | `SIMPLEX_SETUP\|max z=6x+3y\|x<=6\|y<=11` | simplex_generator.py |
...
| `SIZE_REDUCE` | 2 | `SIZE_REDUCE\|b2=(10, -12)\|b2-(-1)b1=(-1, -13)` | lll_reduction_generator.py |
...
| `SOFTMAX_PROB` | 2 | `SOFTMAX_PROB\|1\|7/24` | softmax_gradient_generator.py |
| `SOFTMAX_SETUP` | 3 | `SOFTMAX_SETUP\|z=(1*ln(7),1*ln(9),1*ln(8))\|T=1\|target=1` | softmax_gradient_generator.py |
...
| `SOLUTION_SETUP` | 3 | `SOLUTION_SETUP\|dilution_final_molarity\|M1=7/4, V1=25\|V2=404` | solution_chem_generator.py |
...
| `SOLVE_Y` | 2 | `SOLVE_Y\|e^(4x)y = 2e^(5x) + C\|y = 2e^x + Ce^(-4x)` | integrating_factor_generator.py, laplace_ivp_generator.py, ode_substitution_generator.py |
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(6*e^(-6t) - 5*e^(-4t))*6 + (15*e^(-6t) - 15*e^(-4t))*3\|81*e^(-6t) - 75*e^(-4t)` | matrix_exponential_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|BC=1, CE=4, AD=14, AB=15, BE=18, CF=21` | mst_generator.py |
| `SPECIAL_SOLUTION` | 2 | `SPECIAL_SOLUTION\|27 = 27\|identity: true for every x` | radical_equation_generator.py, special_solution_equation_generator.py |
...
| `SPHERICAL_EXCESS_SETUP` | 2 | `SPHERICAL_EXCESS_SETUP\|R=18\|angles=135,120,150` | spherical_excess_generator.py |
| `SPHERICAL_SINE_LAW` | 1 | `SPHERICAL_SINE_LAW\|sin(A)/sin(a)=sin(B)/sin(b)` | spherical_triangle_generator.py |
| `SPHERICAL_TRIANGLE_SETUP` | 2 | `SPHERICAL_TRIANGLE_SETUP\|b=45 deg, c=30 deg, A=135 deg\|find cos(a)` | spherical_triangle_generator.py |
| `SPIN_COMPONENT` | 2 | `SPIN_COMPONENT\|row=1\|112/113` | spin_half_generator.py |
| `SPIN_SETUP` | 3 | `SPIN_SETUP\|apply_pauli\|operator=sigma_x\|psi=[15/113,112/113]` | spin_half_generator.py |
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|-8x = 4x - 12x\|16x^2 + 4x - 12x - 3` | factor_trinomial_generator.py |
| `SPLIT_SETUP` | 3 | `SPLIT_SETUP\|region\|left pos=0, neg=8\|right pos=4, neg=4` | information_gain_generator.py |
...
| `SQRT_SETUP` | 2 | `SQRT_SETUP\|N = 278784\|groups 27, 87, 84` | manual_square_root_generator.py |
...
| `STANDING_SETUP` | 3 | `STANDING_SETUP\|closed_pipe\|k=3\|L=23, v=188` | standing_wave_generator.py |
| `STATEMENT_EVAL` | 3 | `STATEMENT_EVAL\|Cleo says Ravi is a knave\|F\|contradiction` | knights_knaves_generator.py |
| `STATICS_FORMULA` | 1 | `STATICS_FORMULA\|sum_tau_left=0 => RB*L=W*x` | statics_generator.py |
| `STATICS_SETUP` | 3 | `STATICS_SETUP\|supported_beam\|W=72, L=20\|x=4` | statics_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(57 + 76) / 2\|66.5` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|10` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|27\|21\|6` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|370 / 10\|37` | statistics_generator.py |
| `STAT_FREQUENCY` | 2 | `STAT_FREQUENCY\|27\|1` | statistics_generator.py |
| `STAT_MAD` | 3 | `STAT_MAD\|54\|6\|9` | statistics_generator.py |
| `STAT_MAX` | 1 | `STAT_MAX\|88` | statistics_generator.py |
| `STAT_MEAN` | 2 | `STAT_MEAN\|126 / 6\|21` | statistics_generator.py |
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|position 3\|37` | statistics_generator.py |
| `STAT_MIN` | 1 | `STAT_MIN\|12` | statistics_generator.py |
| `STAT_MODE` | 2 | `STAT_MODE\|41 and 78\|3` | statistics_generator.py |
| `STAT_ORDER` | 1 | `STAT_ORDER\|26, 33, 37, 44, 98` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|88 - 12\|76` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|54, 5, 43, 15, 43, 18, 57, 61, 23, 51` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|54 + 5 + 43 + 15 + 43 + 18 + 57 + 61 + 23 + 51\|370` | statistics_generator.py |
...
| `STEREO_SETUP` | 3, 4 | `STEREO_SETUP\|sphere_to_plane\|X=-72/217\|Y=48/217\|Z=199/217` | stereographic_generator.py |
...
| `STOICH_SETUP` | 2, 3 | `STOICH_SETUP\|limiting_reagent\|2 CO + O2 -> 2 CO2\|given=CO=11 mol, O2=24 mol` | stoichiometry_generator.py |
...
| `SUBGROUP` | 2 | `SUBGROUP\|H={1, 9, 25}\|size 3` | coset_generator.py |
| `SUBGROUP_ELEM` | 2 | `SUBGROUP_ELEM\|k=1\|13` | coset_generator.py, cyclic_group_generator.py |
| `SUBGROUP_START` | 2 | `SUBGROUP_START\|H=<9>\|identity 1` | coset_generator.py |
| `SUBPROOF_CLOSE` | 3 | `SUBPROOF_CLOSE\|→I\|lines 2–3\|k → i` | natural_deduction_generator.py |
...
| `SVM_SETUP` | 3 | `SVM_SETUP\|x1=(-24,0),y1=-1,alpha1=1\|x2=(0,-7),y2=-1,alpha2=1\|b=5,x=(2,-1)` | svm_margin_generator.py |
| `SWAP` | 2 | `SWAP\|norm b2=82\|norm b1=170` | lll_reduction_generator.py |
...
| `TABLEAU` | 2, 3 | `TABLEAU\|initial\|s1: x + s1 = 6\|s2: y + s2 = 11` | simplex_generator.py |
| `TABLEAU_ROOT` | 1 | `TABLEAU_ROOT\|j ∧ ¬i` | semantic_tableau_generator.py |
...
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 9 + (x - 0) + 6*(y - 3)` | gradient_generator.py |
...
| `TENSOR_SETUP` | 3 | `TENSOR_SETUP\|A=diag(1,-5)\|B=diag(-2,5)\|u=[1,2], v=[1,3]` | tensor_product_generator.py |
| `TENSOR_STATE` | 2 | `TENSOR_STATE\|u tensor v\|[1,3,2,6]` | tensor_product_generator.py |
| `TERM` | 2, 3 | `TERM\|4 makes\|(7/10)^4\|2401/10000` | binomial_probability_generator.py, random_digit_simulation_generator.py |
| `TERMS` | 1 | `TERMS\|x[0..3]=[31,-310,3100,-31000]` | z_transform_generator.py |
...
| `TF_SETUP` | 3 | `TF_SETUP\|block_feedback\|G1=6/(s+1), G2=11/(s+10)\|H=1` | transfer_function_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Green\|F=<0, 4*x>\|rectangle 3 by 10` | vector_theorem_generator.py |
| `THETA` | 2 | `THETA\|min(6,14)\|6` | transportation_generator.py |
| `THROUGHPUT` | 2 | `THROUGHPUT\|tokens_per_second\|370000000/3` | scaling_law_generator.py |
...
| `TIME_EVOLVE` | 2 | `TIME_EVOLVE\|U psi\|[i,2+i]` | braket_generator.py |
...
| `TOPO_PICK` | 2 | `TOPO_PICK\|available {21, 44, 53, 59}\|pick 21` | partial_order_generator.py |
...
| `TRACE` | 2 | `TRACE\|-4 + 5\|1` | ode_system_generator.py |
...
| `TRANSFER` | 1 | `TRANSFER\|G(s)=66/(s^2+11s+10)` | transfer_function_generator.py |
...
| `TRANSIENT_SETUP` | 3 | `TRANSIENT_SETUP\|rl_rise\|R=11, L=121\|V=37, t=22` | transient_circuit_generator.py |
...
| `TRANSLATE` | 2 | `TRANSLATE\|Some traveler is punctual\|∃y (E(y) ∧ L(y))` | quantifier_negation_generator.py |
| `TRANSPORT_SETUP` | 3 | `TRANSPORT_SETUP\|supply=(22,6)\|demand=(14,14)\|costs=(13,3;6,7)` | transportation_generator.py |
...
| `TT_COLUMN` | 2 | `TT_COLUMN\|formula\|TFTT` | truth_table_generator.py |
...
| `TYPE_ABS` | 2 | `TYPE_ABS\|lambda z\|c → b` | type_theory_generator.py |
| `TYPE_APP` | 3 | `TYPE_APP\|(b e)\|unify\|D` | type_theory_generator.py |
| `TYPE_ASSIGN` | 2 | `TYPE_ASSIGN\|b\|L → D` | type_theory_generator.py |
| `UB` | 2 | `UB\|{18, 30}\|∅` | partial_order_generator.py |
...
| `UNCERTAINTY_SETUP` | 3 | `UNCERTAINTY_SETUP\|particle in a box\|L=1, hbar=1\|n=29` | uncertainty_generator.py |
| `UNFOLD` | 2 | `UNFOLD\|g(16)\|g(15) + 8·16` | recursive_definition_unfold_generator.py |
...
| `UNIT_ATTACH` | 3 | `UNIT_ATTACH\|5\|hours\|5 hours` | cross_section_generator.py, kinematics_generator.py, physics_formula_generator.py |
...
| `UNIT_RATE_DIV` | 3 | `UNIT_RATE_DIV\|36 minutes\|3\|12 minutes` | unit_rate_generator.py |
| `UNIT_RATE_PICK` | 2 | `UNIT_RATE_PICK\|1\|20` | unit_rate_generator.py |
| `UNIT_RATE_SETUP` | 3 | `UNIT_RATE_SETUP\|3\|laps\|36 minutes` | unit_rate_generator.py |
| `UNIT_RATE_TABLE` | 2 | `UNIT_RATE_TABLE\|1,2,5,6\|20,40,100,120` | unit_rate_generator.py |
| `UNIT_RULE` | 3 | `UNIT_RULE\|hbar=1\|E=1/L\|MeV` | natural_units_generator.py |
...
| `UNPAIR` | 2 | `UNPAIR\|16187\|(102, 77)` | cantor_pairing_generator.py |
...
| `VALIDITY` | 2 | `VALIDITY\|valid\|simplification` | argument_form_generator.py |
| `VALUE_FORMULA` | 1 | `VALUE_FORMULA\|v=(ad-bc)/(a-b-c+d)` | game_theory_generator.py |
| `VARIANCE` | 1, 2 | `VARIANCE\|Delta x^2\|1/12 - 1/(1682pi^2)` | layer_norm_generator.py, uncertainty_generator.py |
| `VAR_FORMULA` | 1 | `VAR_FORMULA\|Var(X) = p(1 − p)` | discrete_uniform_bernoulli_generator.py, expected_value_generator.py |
...
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y,z) = <-5*x + y - 5*z, -3*x - 2*y + 4*z, 5*x - 5*y - 2*z>\|divergence and curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|324*8 + (-176)*3\|2064` | diagonalization_generator.py |
| `VEC_SETUP` | 2 | `VEC_SETUP\|u = ⟨-3, 6⟩, v = ⟨2, -6⟩\|4u + 3v` | dot_product_generator.py, vector_ops_generator.py |
| `VENN_MARK` | 2 | `VENN_MARK\|dancers ∩ ¬gardeners\|x1` | syllogism_generator.py |
| `VENN_REGION` | 2 | `VENN_REGION\|A ∩ B\|4` | venn_probability_generator.py |
| `VENN_SHADE` | 2 | `VENN_SHADE\|jewelers ∩ bakers\|empty` | syllogism_generator.py |
...
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 5 × 6\|15.0` | round_solids_generator.py, volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 15.0 × 11\|165.0` | round_solids_generator.py, volume_3d_generator.py |
...
| `VOL_SETUP` | 2 | `VOL_SETUP\|triangular_prism\|b=5, h_tri=6, length=11` | volume_3d_generator.py |
| `VOP_FORM` | 2 | `VOP_FORM\|u1' = -y2*g/W\|30/5 * e^(2x)` | variation_parameters_generator.py |
...
| `WARSHALL_K` | 2 | `WARSHALL_K\|k=5\|0 1 0 0; 1 1 0 1; 0 0 0 0; 1 1 1 0` | relation_closure_generator.py |
| `WAVE_FORMULA` | 1 | `WAVE_FORMULA\|1=N^2*integral_0^L (x/L)^(2k) dx` | wavefunction_generator.py |
| `WAVE_SETUP` | 3 | `WAVE_SETUP\|power_interval\|psi=N*(x/L)^4\|0<=x<=4` | wavefunction_generator.py |
...
| `WIDTH_SETUP` | 3 | `WIDTH_SETUP\|combined\|Gamma_a=12, Gamma_b=15, Gamma_c=18,hbar=5\|target=BR_a,tau` | branching_ratio_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|90 - 27\|63` | line_integral_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(59 - 88)/20\|-1.45` | normal_table_generator.py, z_score_generator.py |
...
| `ZT_SETUP` | 2, 3 | `ZT_SETUP\|geometric\|x[n]=31*(-10)^n u[n]` | z_transform_generator.py |
