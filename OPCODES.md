...
| `DEC_TO_PERCENT` | 2 | `DEC_TO_PERCENT\|0.8\|80%` | fraction_decimal_percent_converter.py, mixture_generator.py, percent_problem_generator.py, simple_probability_generator.py, standard_deviation_generator.py, tip_bill_split_generator.py |
...
| `MODEL_EQ` | 2 | `MODEL_EQ\|x = 5 * 9 - 18\|quantities in the story` | integer_puzzle_word_generator.py, mixture_generator.py, multi_step_word_generator.py, work_rate_generator.py |
