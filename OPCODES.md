...
1966 distinct op-codes observed.
...
| `COMB_X` | 1, 3 | `COMB_X\|3x\|+4x\|7x` | derivative_product_quotient_generator.py, integer_puzzle_word_generator.py, linear_complex_generator.py, rational_expr_add_sub_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `DEFINE_VAR` | 2 | `DEFINE_VAR\|a\|tens digit` | integer_puzzle_word_generator.py |
...
| `DIV_COEFF` | 1, 3 | `DIV_COEFF\|13\|7\|x=13/7` | integer_puzzle_word_generator.py, linear_complex_generator.py |
...
| `MODEL_EQ` | 2 | `MODEL_EQ\|x = 5 * 9 - 18\|quantities in the story` | integer_puzzle_word_generator.py, multi_step_word_generator.py |
