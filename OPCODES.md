...
1639 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|4x - 8 = 19` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|4x - 4 ≥ 17 -> x ≥ 21/4` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|abs(4x - 4) ≥ 17` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for >` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|4x - 4 ≥ 17 or 4x - 4 ≤ -17` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(4x - 8) = 19` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|4x - 8 = 19\|4x - 8 = -19` | absolute_value_equation_generator.py |
...
| `ACT_SETUP` | 3 | `ACT_SETUP\|activation=sigmoid\|x=3\|w1=-1,b1=3,w2=-2,b2=4` | activation_generator.py |
| `ACT_VALUE` | 3 | `ACT_VALUE\|sigmoid\|0\|1/2` | activation_generator.py |
| `AC_COMPLEX` | 3 | `AC_COMPLEX\|Z\|38\|0j` | ac_circuit_generator.py |
...
| `AC_SETUP` | 3 | `AC_SETUP\|resonance\|R=38, L=9\|C=1/144` | ac_circuit_generator.py |
| `ADAM_SETUP` | 3 | `ADAM_SETUP\|theta=-7/2,g=4\|beta1=9/10,beta2=99/100\|lr=1/100,epsilon=0` | adam_step_generator.py |
| `ADAM_UPDATE` | 2 | `ADAM_UPDATE\|theta_new\|-351/100` | adam_step_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 4/20, P(B) = 9/20, mutually exclusive\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `ALG_SETUP` | 3 | `ALG_SETUP\|merge sort\|merges 2\|values 42, 34, 14, 22, 31, 3` | algorithm_trace_generator.py |
| `ALIGN_NUM` | 2 | `ALIGN_NUM\|046.36\|177.07` | number_comparison_generator.py |
| `ALPHA` | 2 | `ALPHA\|alpha1\|1/4` | kernel_ridge_generator.py |
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda t. f\|lambda z. f` | lambda_reduction_generator.py |
| `AMORT_ROW` | 3 | `AMORT_ROW\|1\|interest=$1062.00\|principal=$6988.00,balance=$46112.00` | annuity_generator.py |
...
| `ANGLE_DEFECT_SETUP` | 2 | `ANGLE_DEFECT_SETUP\|R=6\|angles=30,15,15` | angle_defect_generator.py |
...
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|complementary\|(2x + 13)° + (4x + 23)° = 90°` | angle_relationships_generator.py |
...
| `ANNUITY_SETUP` | 2, 3 | `ANNUITY_SETUP\|perpetuity present value\|PMT=6255,r=1%` | annuity_generator.py |
...
| `APPLY_GATE` | 3 | `APPLY_GATE\|Z\|e^(i188π/175)·ket1\|-·e^(i188π/175)·ket1` | quantum_gate_generator.py |
| `APPLY_OPERATOR` | 2 | `APPLY_OPERATOR\|L[Ae^(2x)]\|A(4 - 16)e^(2x)` | commutator_generator.py, undetermined_coeff_generator.py |
| `APPLY_PAULI` | 2 | `APPLY_PAULI\|sigma_x psi\|[-3/5,-4/5]` | spin_half_generator.py |
| `APPLY_SUBST` | 1 | *(not observed in sampling)* | unification_generator.py |
| `APPROX` | 2 | `APPROX\|lora/full\|31/4784` | param_count_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 9, central angle 60°\|sector area` | arc_sector_generator.py |
| `AREA` | 1 | `AREA\|66` | geometry_area_perimeter_generator.py |
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|7*12^3/3\|4032` | centroid_generator.py |
| `AREA_INTEGRAL` | 2 | `AREA_INTEGRAL\|sqrt(EG-F^2)=R\|area = R*theta*h` | fundamental_form_generator.py |
| `AREA_SCALE` | 3 | `AREA_SCALE\|uv rectangle area\|5*4\|20` | jacobian_generator.py |
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 + 3x - 40 and y = -x^2 - x - 10\|area between the curves` | area_between_curves_generator.py |
| `ARGUMENT` | 2 | `ARGUMENT\|(0,11)\|90 deg` | complex_log_generator.py, euler_formula_generator.py |
| `ARITH_INTERVAL` | 1 | `ARITH_INTERVAL\|[3/4,1)` | arithmetic_coding_generator.py |
| `ARITH_SETUP` | 2 | `ARITH_SETUP\|A=1/4, B=1/4, C=1/4, D=1/4\|message=DAB` | arithmetic_coding_generator.py |
| `ARITH_SYMBOL` | 2 | `ARITH_SYMBOL\|D\|cum=[3/4,1)` | arithmetic_coding_generator.py |
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|30, 32, 23, 1, 19, 29` | algorithm_trace_generator.py |
| `ASSIGN` | 2 | `ASSIGN\|P1\|C2` | kmeans_step_generator.py |
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = -5 ± (3/4)(x + 3)` | hyperbola_features_generator.py |
| `ATA` | 2 | `ATA\|A^T A\|[[26, 10], [10, 26]]` | svd_generator.py |
| `ATOM_CHECK` | 3 | `ATOM_CHECK\|N\|left=2\|right=2` | stoichiometry_generator.py |
| `ATTN_OUTPUT` | 2 | `ATTN_OUTPUT\|1\|[[0,-1/2]]` | attention_generator.py |
...
| `AV_VECTOR` | 2 | `AV_VECTOR\|A*v1\|[6/√2, 6/√2]` | svd_generator.py |
...
| `BACKPROP_GRAD` | 2 | `BACKPROP_GRAD\|dL/dy_hat\|-14` | backprop_generator.py |
| `BACKPROP_SETUP` | 3 | `BACKPROP_SETUP\|x=(-2,-3)\|y=2\|eta=1/3` | backprop_generator.py |
| `BACK_SUB` | 2 | `BACK_SUB\|u = 1/y\|y = 1/(3 + e^(3x))` | ode_substitution_generator.py |
| `BACK_SUB_ROW` | 3 | `BACK_SUB_ROW\|r=192\|x=1\|y=0` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `BASE_ADD_COL` | 3 | `BASE_ADD_COL\|col 0\|0 + 4 + carry 0\|4 -> digit 4, carry 0` | base_arithmetic_generator.py |
| `BASE_ARITH_SETUP` | 2 | `BASE_ARITH_SETUP\|base 16\|D4C * A` | base_arithmetic_generator.py |
| `BASE_CARRY` | 2 | `BASE_CARRY\|carry 8\|digit 8, carry 0` | base_arithmetic_generator.py |
| `BASE_MUL_COL` | 3 | `BASE_MUL_COL\|col 0\|C * A + carry 0\|120 -> digit 8, carry 7` | base_arithmetic_generator.py |
| `BASE_SETUP` | 2 | `BASE_SETUP\|1101010_2\|decimal` | base_conversion_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 100, disease=no 48\|sensitivity 7/10, specificity 3/4\|P(disease=yes given test positive)` | conditional_probability_generator.py |
| `BAYES_UPDATE_SETUP` | 2, 3 | `BAYES_UPDATE_SETUP\|beta_binomial\|prior=Beta(8,11)\|successes=1, trials=24` | bayesian_update_generator.py |
| `BCH_FORM` | 2 | `BCH_FORM\|A+B+1/2[A,B]\|[[0, 3, 0], [0, 0, 0], [-3, 9/2, 0]]` | bch_generator.py |
| `BCH_SETUP` | 3 | `BCH_SETUP\|A=3E12\|B=-3E31\|order=2` | bch_generator.py |
...
| `BETA` | 1 | `BETA\|(lambda f. (f (lambda f. f))) applied to (f f)` | lambda_reduction_generator.py |
| `BEZOUT_CHECK` | 2 | `BEZOUT_CHECK\|192*11 + 124*-17\|4` | extended_euclid_generator.py |
| `BIAS_CORRECT` | 2 | `BIAS_CORRECT\|m_hat\|4` | adam_step_generator.py |
| `BINARY_EXPONENT` | 2 | `BINARY_EXPONENT\|20\|10100` | mod_exp_generator.py, quadratic_residue_generator.py |
| `BINOM_FORMULA` | 1 | `BINOM_FORMULA\|P(X ≥ 1) = 1 - (1-p)^n` | binomial_probability_generator.py |
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 5, p = 1/5\|P(X ≥ 1)` | binomial_probability_generator.py |
| `BISECTION_SETUP` | 3 | `BISECTION_SETUP\|f(x)=x^2-5\|interval=[2, 3]\|iterations=3` | bisection_generator.py |
| `BISECT_UPDATE` | 3 | `BISECT_UPDATE\|1\|product < 0\|[2, 5/2]` | bisection_generator.py |
...
| `BIT_SETUP` | 2 | `BIT_SETUP\|1111 OR 0011\|4-bit mask` | bitwise_ops_generator.py |
| `BLACKBODY_FORMULA` | 1 | `BLACKBODY_FORMULA\|P=sigma*A*T^4` | blackbody_generator.py |
| `BLACKBODY_SETUP` | 3 | `BLACKBODY_SETUP\|stefan_power\|sigma=12, A=2\|T=12` | blackbody_generator.py |
| `BOND_FORMULA` | 1 | `BOND_FORMULA\|price=sum coupon/(1+y)^t + face/(1+y)^n` | bond_pricing_generator.py |
| `BOND_PRICE` | 1 | `BOND_PRICE\|$504.00` | bond_pricing_generator.py |
| `BOND_SETUP` | 2 | `BOND_SETUP\|face=600\|coupon=5%,ytm=25%,years=1` | bond_pricing_generator.py |
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables L, M, N\|K-map simplify` | boolean_algebra_generator.py |
...
| `BOX_SETUP` | 1, 3 | `BOX_SETUP\|transition_wavelength\|n_low=3, n_high=6\|h=9, c=6` | particle_in_box_generator.py |
| `BRAKET_FORMULA` | 1 | `BRAKET_FORMULA\|U=diag(phases)` | braket_generator.py |
| `BRAKET_SETUP` | 3 | `BRAKET_SETUP\|time_evolution\|psi=[-1-i,1,1-i]\|phases=[-i,-1,-i]` | braket_generator.py |
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|20000 <= 8000\|no` | piecewise_evaluation_generator.py |
| `BRANCH_USE` | 1 | `BRANCH_USE\|9` | piecewise_evaluation_generator.py |
| `BRING_DOWN` | 2 | `BRING_DOWN\|group 50\|current = 50` | composite_arithmetic_generator.py, manual_square_root_generator.py |
...
| `BSGS_SETUP` | 4 | `BSGS_SETUP\|p=29\|g=2\|h=11\|m=6` | baby_step_giant_step_generator.py |
...
| `CARTESIAN_RESULT` | 1 | `CARTESIAN_RESULT\|{(a, 1), (a, 3), (c, 1), (c, 3), (d, 1), (d, 3)}` | set_operations_generator.py |
| `CART_PAIR` | 3 | `CART_PAIR\|a\|1\|(a, 1)` | set_operations_generator.py |
| `CASE` | 1 | `CASE\|Bea=knight, Oona=knight` | knights_knaves_generator.py |
| `CASHFLOW_PV` | 2 | `CASHFLOW_PV\|coupon_t1\|24` | bond_pricing_generator.py |
| `CASIMIR_FORCE_SETUP` | 2 | `CASIMIR_FORCE_SETUP\|F/A=-π^2*hbar*c/(240*d^4)\|hbar=13,c=10,d=2` | casimir_force_generator.py |
| `CASIMIR_SETUP` | 3 | `CASIMIR_SETUP\|spin=3\|hbar=42/5\|J^2 entry at m=2` | casimir_generator.py |
...
| `CBRT` | 2 | `CBRT\|216p^3\|6p` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
...
| `CEIL` | 2 | `CEIL\|2275.767025\|2276` | confidence_interval_generator.py |
...
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(36288)/(4032)\|9` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= 7*x^2\|0 <= x <= 12\|centroid` | centroid_generator.py |
...
| `CF_RESULT` | 1 | `CF_RESULT\|[2; 4, 3, 1, 2, 3]` | continued_fraction_generator.py |
| `CF_SETUP` | 1 | `CF_SETUP\|353/158` | continued_fraction_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*x_s + f_y*y_s\|65*1 + (-38)*4\|-87` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(0,3)\|2*3 + 4\|10` | multivar_chain_rule_generator.py |
...
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^3 + 8λ^2 + 17λ + 10\|(λ + 5)*(λ + 2)*(λ + 1)` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 3, 12, 11, 14; expected: 10 each\|goodness of fit; df = 3, critical value = 7.815` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|3 - 10 = -7\|(-7)^2 = 49\|49/10 = 4.9` | chi_square_generator.py |
| `CHOLESKY_ENTRY` | 2 | `CHOLESKY_ENTRY\|l11\|4` | cholesky_generator.py |
| `CHOL_SETUP` | 2 | `CHOL_SETUP\|A = [[16, -16, -16], [-16, 20, 18], [-16, 18, 42]]\|A = L L^T` | cholesky_generator.py |
| `CHRISTOFFEL_FORMULA` | 1 | `CHRISTOFFEL_FORMULA\|Gamma^i_jk = 1/2 g^im(d_j g_mk + d_k g_mj - d_m g_jk)` | christoffel_generator.py |
| `CHRISTOFFEL_SETUP` | 3 | `CHRISTOFFEL_SETUP\|sphere\|g_phiphi=R^2, g_thetatheta=R^2 sin^2(phi)\|R=11, phi=90 deg` | christoffel_generator.py |
...
| `CIRCLE_CALCULATE` | 2 | `CIRCLE_CALCULATE\|C = 47π\|47π` | circle_generator.py |
| `CIRCLE_EQ` | 1 | `CIRCLE_EQ\|(x + 4)^2 + (y - 1)^2 = 4` | complex_locus_generator.py |
| `CIRCLE_FORMULA` | 1 | `CIRCLE_FORMULA\|C = πd` | circle_generator.py |
| `CIRCLE_SETUP` | 2 | `CIRCLE_SETUP\|47\|diameter` | circle_equation_generator.py, circle_generator.py |
| `CIRCLE_SUBSTITUTE` | 1 | `CIRCLE_SUBSTITUTE\|C = π × 47` | circle_generator.py |
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(-3)*11^2*pi\|-363*pi` | vector_theorem_generator.py |
| `CI_FORMULA` | 1 | `CI_FORMULA\|x̄ ± E` | confidence_interval_generator.py |
| `CI_SETUP` | 2 | `CI_SETUP\|σ = 29, E = 1, z* = 1.645\|minimum sample size for the mean` | confidence_interval_generator.py |
| `CLAUSE` | 2 | `CLAUSE\|C1\|(P11837)` | resolution_proof_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(W OR X OR Y) AND (W OR X OR NOT Y) AND (W OR NOT X OR NOT Y) AND (NOT W OR X OR Y) AND (NOT W OR X OR NOT Y) AND (NOT W OR NOT X OR Y)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|1200` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|1, 3, -9, 7` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COEFF_MATCH` | 2 | `COEFF_MATCH\|x^n\|(n+1)a_(n+1) = 2a_n` | series_solution_generator.py |
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=3, j=5\|3i + 5j = 34\|accepted` | generating_function_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[-3, -1], [-3, -4]]` | determinant_generator.py |
| `COLLIDER_SETUP` | 3 | `COLLIDER_SETUP\|events_fb\|L=28 fb^-1\|sigma=33 fb` | cross_section_generator.py |
| `COLLISION_SETUP` | 3 | `COLLISION_SETUP\|elastic_1d\|m1=5, u1=0\|m2=12, u2=1` | collision_generator.py |
...
| `COMBO` | 2 | `COMBO\|x = -20*v1 + 6*v2\|[-8, -6]` | diagonalization_generator.py |
| `COMB_CONST` | 3 | `COMB_CONST\|-3\|+6\|3` | derivative_product_quotient_generator.py, equation_from_two_points_generator.py, linear_complex_generator.py, rational_expr_add_sub_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|-10 - (-5)\|-5` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|-108/360\|-3/10` | geometric_sequence_generator.py, recursive_explicit_generator.py |
| `COMMUTATOR` | 2 | `COMMUTATOR\|[A,B]\|[[0, -255/2], [255/2, 0]]` | structure_constant_generator.py |
...
| `COMM_RESULT` | 2 | `COMM_RESULT\|[x,p]f\|10i*x^20` | commutator_generator.py |
| `COMM_SETUP` | 3 | `COMM_SETUP\|[x,p]f\|f=x^20\|p=-i*hbar*D, hbar=10` | commutator_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|5x + 8 < -17 -> x < -5` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|-9 < 3x + 3 < 18` | compound_inequality_generator.py |
| `COND_COUNT` | 2 | `COND_COUNT\|club=no and commute=bus\|7` | conditional_probability_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 8, no/bike 11, yes/bus 11, no/bus 7\|P(club=no given commute=bus)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|commute=bus total\|11 + 7 = 18` | conditional_probability_generator.py |
| `CONGRUENCE_REDUCE` | 2 | `CONGRUENCE_REDUCE\|17x congruent to 4\|mod 6` | modular_inverse_generator.py |
| `CONGRUENCE_SOLUTIONS` | 3 | `CONGRUENCE_SOLUTIONS\|base 2\|step 6\|2, 8` | modular_inverse_generator.py |
...
| `CONSERVATION_SETUP` | 2 | `CONSERVATION_SETUP\|p + gamma -> gamma + e+ + gamma\|check=Q,B,Le,Lmu` | conservation_law_generator.py |
| `CONSERVE_CHECK` | 3 | `CONSERVE_CHECK\|Q\|left=1,right=1\|conserved` | conservation_law_generator.py |
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|3*x + y = 48\|lambda*(9/6 + 1/10) = 48\|lambda = 30` | lagrange_multiplier_generator.py |
| `CONST_SOLVE` | 2 | `CONST_SOLVE\|C1 = -1\|C2 = -3` | recurrence_generator.py |
| `CONTOUR_SETUP` | 3 | `CONTOUR_SETUP\|abs(z)=2\|positive orientation\|f=2/(z-4) - 5/(z+6) - 4/(z-5)` | contour_integral_generator.py |
| `CONT_DIST_SETUP` | 3 | `CONT_DIST_SETUP\|f(x)=k*x\|support=[0,13]\|interval=(2,5)` | continuous_distribution_generator.py |
| `CONVERGENT` | 2 | `CONVERGENT\|i=0\|2/1` | continued_fraction_generator.py |
| `CONVERGE_CHECK` | 2 | `CONVERGE_CHECK\|abs(r) = 2/7 < 1\|converges` | geometric_sequence_generator.py, series_convergence_generator.py |
...
| `CONV_SETUP` | 2, 3 | `CONV_SETUP\|x=[4,8,3,3,4]\|h=[6,4,6,3]` | convolution_generator.py, convolutional_code_viterbi_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[-20, 6]` | diagonalization_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|20 boxes\|force 15 in one box` | counting_classics_generator.py |
| `COUPON` | 1 | `COUPON\|30` | bond_pricing_generator.py |
| `COV_ENTRY` | 2 | `COV_ENTRY\|xx\|8` | pca_generator.py |
| `COV_FORMULA` | 1 | `COV_FORMULA\|Cov=E[XY]-E[X]E[Y]` | joint_distribution_generator.py |
| `CRC_CHECK` | 3 | `CRC_CHECK\|codeword=101100000110\|remainder=0000\|valid` | crc_generator.py |
| `CRC_REMAINDER` | 1 | `CRC_REMAINDER\|0110` | crc_generator.py |
| `CRC_SETUP` | 3 | `CRC_SETUP\|data=10110000\|poly=11001\|augmented=101100000000` | crc_generator.py |
| `CRC_SKIP` | 2 | `CRC_SKIP\|i=2\|leading bit 0` | crc_generator.py |
| `CRC_XOR` | 3 | `CRC_XOR\|i=0\|10110 xor 11001\|01111` | crc_generator.py |
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|-10*x + 4*y - 12 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|(-10)*8 - 4^2\|-96` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=2\|ln(14/9)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|56·BC = 24·56` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CROSS_RATIO` | 1 | `CROSS_RATIO\|-3/7` | mobius_transform_generator.py |
| `CROSS_RATIO_SETUP` | 4 | `CROSS_RATIO_SETUP\|z1=-1\|z2=4\|z3=0\|z4=-8` | mobius_transform_generator.py |
...
| `CRT_TERM` | 2 | `CRT_TERM\|i=1\|99` | crt_generator.py |
| `CRT_TOTAL_MODULUS` | 2 | `CRT_TOTAL_MODULUS\|4, 11\|44` | crt_generator.py |
| `CR_SETUP` | 2 | `CR_SETUP\|u=-x^2 + y^2 - 4x - 4y\|v=-2xy + 4x - 3y` | cauchy_riemann_generator.py |
| `CUM_INTERVAL` | 2 | `CUM_INTERVAL\|A\|[0,1/4)` | arithmetic_coding_generator.py |
| `CURL_COMPONENT` | 3 | `CURL_COMPONENT\|Q_x - P_y\|5 - 6\|-1` | div_curl_generator.py |
...
| `CURVE_GEOM_SETUP` | 3 | `CURVE_GEOM_SETUP\|r(t) = <-8*t + 8, -15*t - 8>\|0 <= t <= 8\|arc length` | curve_geometry_generator.py |
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 12x^2 + 36x - 2\|critical points and their nature` | curve_analysis_generator.py |
| `CX_A` | 3 | `CX_A\|0\|-3/5\|-3/5` | braket_generator.py, spin_half_generator.py |
| `CX_M` | 3 | `CX_M\|0\|-4/5\|0` | braket_generator.py, spin_half_generator.py |
| `CX_SETUP` | 2 | `CX_SETUP\|(8 + 5i) + (-8 - 2i)\|add` | complex_division_generator.py, complex_number_ops_generator.py |
| `CYCLE` | 1 | `CYCLE\|(1 2 3 4)` | permutation_group_generator.py |
...
| `CYCLE_TRACE` | 2 | `CYCLE_TRACE\|start 1\|1->2->3->4->1` | permutation_group_generator.py |
| `CYCLIC_START` | 2 | `CYCLIC_START\|15\|identity 0` | cyclic_group_generator.py |
| `CYCLIC_SUBGROUP` | 2 | `CYCLIC_SUBGROUP\|{0, 15, 13, 11, 9, 7, 5, 3, 1, 16, 14, 12, 10, 8, 6, 4, 2}\|17` | cyclic_group_generator.py |
| `CYK_CELL` | 2 | `CYK_CELL\|1,2\|{S,Y}` | cyk_parser_generator.py |
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|D U\|{Y}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|D\|b or d` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string dcdc\|length 4` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{D,Y} x {U}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|d\|{D,Y}` | cyk_parser_generator.py |
...
| `DATE_ORDINAL` | 2 | `DATE_ORDINAL\|2025-08-10\|739473` | calendar_arithmetic_generator.py |
| `DB_FORMULA` | 1 | `DB_FORMULA\|G_dB=10*log10(P2/P1)` | signal_arithmetic_generator.py |
| `DECISION` | 2 | `DECISION\|f(x)\|-55` | kernel_perceptron_generator.py, svm_margin_generator.py |
...
| `DEGREE` | 2, 3 | `DEGREE\|A\|C, D, F\|3` | euler_circuit_generator.py, graph_counting_generator.py |
...
| `DEMOIVRE_POWER` | 1 | `DEMOIVRE_POWER\|49 cis(180 deg)` | de_moivre_generator.py |
| `DEMOIVRE_SETUP` | 2, 4 | `DEMOIVRE_SETUP\|roots_of_unity\|n=4` | de_moivre_generator.py |
| `DENSITY` | 2 | `DENSITY\|f_X(x)\|1/14` | rv_transform_generator.py |
| `DENSITY_MATRIX` | 1 | `DENSITY_MATRIX\|rho=[[4/13,0],[0,9/13]]` | density_matrix_generator.py |
| `DENSITY_SETUP` | 2, 3 | `DENSITY_SETUP\|state=Schmidt\|psi=(sqrt(62)ket00 + sqrt(89)ket11)/sqrt(151)` | density_matrix_generator.py, partial_trace_generator.py |
...
| `DERANGE_SETUP` | 2 | `DERANGE_SETUP\|n = 6\|exactly 3 fixed` | derangement_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 4x^2 + 7x - 4x^(-2)\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -1], [1, 0], [1, 1]]\|y = [14, 21, 16]` | least_squares_generator.py |
| `DET` | 2 | `DET\|K\|8` | kernel_ridge_generator.py, kernel_validity_generator.py |
...
| `DEV_ROW` | 3 | `DEV_ROW\|21\|-6\|36` | standard_deviation_generator.py |
...
| `DFT_SETUP` | 2 | `DFT_SETUP\|N=4\|x=[-1,5,0,-2]` | dft_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[1, 2], [0, -1]]\|D = [[2, 0], [0, 9]]\|P^-1 = [[1, 2], [0, -1]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[60, 114, 168]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 4*x^2 + y^2 + 2*x*y - 2*x - y\|point (3, 3)\|dx=1/4, dy=-1/2` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|28*1/4 + 11*(-1/2)\|1.5` | multivar_chain_rule_generator.py |
...
| `DIRECTRIX` | 1 | `DIRECTRIX\|y = -8` | parabola_features_generator.py |
| `DISC` | 2, 3 | `DISC\|2116\|-384\|2500` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-26y - 85 = -33` | systems_substitution_generator.py |
...
| `DIST_SETUP` | 3 | `DIST_SETUP\|uniform\|[-1,11]\|interval=(5,10)` | named_distribution_generator.py |
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited B\|A=4, B=0, C=6, D=inf, E=inf` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|- 6x^3 + 4x^2 + 4x` | multiplying_polynomials_generator.py |
| `DIVIDE_EQ` | 2 | `DIVIDE_EQ\|divide by y^2\|y^(-2)dy/dx + 3y^(-1) = 9` | ode_substitution_generator.py |
| `DIVMOD` | 4 | `DIVMOD\|56\|2\|28\|r=0` | base_conversion_generator.py |
...
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y\|-4 + 4\|0` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|15t^2\|5\|3t^2` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT B AND NOT C AND D) OR (NOT B AND C AND NOT D) OR (NOT B AND C AND D) OR (B AND NOT C AND NOT D) OR (B AND NOT C AND D) OR (B AND C AND NOT D)` | boolean_algebra_generator.py |
...
| `DOPPLER_SETUP` | 3 | `DOPPLER_SETUP\|acoustic_toward\|f=871, v=44\|v_observer=2, v_source=14` | doppler_generator.py |
| `DOT` | 2, 3 | `DOT\|(18, -5) · (-3/5, 4/5)\|18*(-3/5) + (-5)*4/5\|-14.8` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=5,v=4); 2:(w=3,v=8); 3:(w=4,v=4); 4:(w=2,v=10)` | dp_table_generator.py |
...
| `ECDSA_SETUP` | 4 | `ECDSA_SETUP\|E/F_17, G=(5,1), n=19\|d=3\|z=7\|k=6` | ecdsa_generator.py |
| `ECDSA_SIGN` | 2 | `ECDSA_SIGN\|s=k^-1(z+rd) mod n\|s=6` | ecdsa_generator.py |
| `ECDSA_VERIFY` | 2 | `ECDSA_VERIFY\|u1=17\|u2=9` | ecdsa_generator.py |
| `EC_ACCUM` | 2 | `EC_ACCUM\|1P\|(0,11)` | elliptic_curve_finite_field_generator.py |
| `EC_ADD` | 1 | `EC_ADD\|(16,13)` | ecdsa_generator.py |
| `EC_IDENTITY` | 2 | `EC_IDENTITY\|O + Q\|(0,11)` | elliptic_curve_finite_field_generator.py |
...
| `EC_PUBLIC` | 2 | `EC_PUBLIC\|A=(10,6)\|B=(13,7)` | ecdh_generator.py |
| `EC_SCALAR` | 2 | `EC_SCALAR\|a=3\|aG=(10,6)` | ecdh_generator.py, ecdsa_generator.py |
| `EC_SCALAR_SETUP` | 2 | `EC_SCALAR_SETUP\|k=3\|P=(0,11)` | elliptic_curve_finite_field_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|AB\|weight 21\|add A` | mst_generator.py |
...
| `EIGENVALUES` | 2 | `EIGENVALUES\|A^T A\|64,16` | low_rank_approx_generator.py, matrix_norm_generator.py, pca_generator.py |
| `EIGENVECTOR` | 2 | `EIGENVECTOR\|A + 5I times v = 0\|[13, 4, 12]` | diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, svd_generator.py |
| `EIGEN_CHECK` | 3 | `EIGEN_CHECK\|sigma_y psi\|-1*psi\|lambda=-1` | spin_half_generator.py |
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 5I\|[[4, -4, -3], [0, 3, -1], [0, 0, 0]]` | eigenvalue_generator.py |
| `EINSTEIN_SETUP` | 2, 3 | `EINSTEIN_SETUP\|trace\|T_ij=[[3, -1, -5], [1, 3, -6], [3, -4, -3]]` | einstein_summation_generator.py |
| `ELEC_FORMULA` | 1 | `ELEC_FORMULA\|V=sum(q_i/r_i)` | electrostatics_generator.py |
| `ELEC_SETUP` | 2, 3 | `ELEC_SETUP\|potential_axis\|q1=-9, r1=5\|q2=-3, r2=10` | electrostatics_generator.py |
...
| `EL_SOLVE` | 2 | `EL_SOLVE\|yddot\|60/7` | lagrangian_generator.py |
| `EMBED_SETUP` | 1 | `EMBED_SETUP\|A=(3,4), B=(12,-5), C=(8,15)` | embedding_similarity_generator.py |
| `ENERGY_FORMULA` | 1 | `ENERGY_FORMULA\|vf^2=vi^2+2W/m` | energy_conservation_generator.py |
| `ENERGY_LEVEL` | 2 | `ENERGY_LEVEL\|E_2=hbar*omega*(n+1/2)\|140` | ladder_operator_generator.py |
| `ENERGY_SETUP` | 3 | `ENERGY_SETUP\|work_energy\|m=17\|vi=11, W=4743/2` | energy_conservation_generator.py |
...
| `ENGINE_SETUP` | 3 | `ENGINE_SETUP\|refrigerator_cop\|Qc=43\|W=33` | heat_engine_generator.py |
...
| `EQUILIBRIA` | 2 | `EQUILIBRIA\|f(y) = 0\|y=-11, y=-9, y=15` | stability_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(-8, 6)\|(-5, 10)` | equation_from_two_points_generator.py |
...
| `EQ_SIMPLIFY` | 1 | `EQ_SIMPLIFY\|x + 2 = 9` | error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, two_step_equation_generator.py |
| `ESCAPE_CHECK` | 3 | `ESCAPE_CHECK\|n=1\|norm2=5/4\|bounded` | fractal_iteration_generator.py |
| `ESTIMATE` | 2 | `ESTIMATE\|50750 × 21485 ≈ 50000 × 20000\|1000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|192\|124\|1\|68` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|A\|route suffix A\|stack A-B-C-A-D-B-E` | euler_circuit_generator.py |
| `EULER_CRITERION` | 2 | `EULER_CRITERION\|16^6 mod 13\|1` | quadratic_residue_generator.py |
...
| `EXP_CELL` | 2 | `EXP_CELL\|(180·210)/300\|126` | chi_square_generator.py |
| `EXP_DIAG` | 2 | `EXP_DIAG\|e^(Dt)\|[[e^(-5t), 0], [0, e^(6t)]]` | matrix_exponential_generator.py |
| `EXP_ENTRY` | 3 | `EXP_ENTRY\|(1,1)\|2*e^(-5t) - e^(6t)\|2*e^(-5t) - e^(6t)` | matrix_exponential_generator.py |
| `EXP_EXPAND` | 1 | `EXP_EXPAND\|(-6) × (-6) × (-6)` | exponent_generator.py |
...
| `EXP_RULE_APPLY` | 3, 4 | `EXP_RULE_APPLY\|subtract\|16\|2\|14` | exponent_generator.py, exponent_mixed_rules_generator.py |
...
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|a^16 / a^2` | exponent_generator.py, exponent_mixed_rules_generator.py, rational_exponent_generator.py |
| `EXP_RULE_SIMPLIFY` | 1 | `EXP_RULE_SIMPLIFY\|a^14` | exponent_generator.py, exponent_mixed_rules_generator.py |
| `EXP_SETUP` | 2 | `EXP_SETUP\|-6\|3` | exponent_generator.py |
| `EXP_SUB` | 3 | `EXP_SUB\|t/tau\|1\|e^-1` | transient_circuit_generator.py |
| `EXP_VALUE` | 2 | `EXP_VALUE\|exp(-z)\|1` | activation_generator.py |
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|192\|124` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `FACTOR` | 1, 2 | `FACTOR\|x^2 + 11x + 28\|(x + 7)(x + 4)` | polynomial_inequality_generator.py, second_order_ode_generator.py, transfer_function_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `FACTOR_FORM` | 2 | `FACTOR_FORM\|28\|2^2 * 7` | totient_generator.py |
| `FACTOR_FOUND` | 2 | `FACTOR_FOUND\|2\|2` | totient_generator.py |
| `FACTOR_GROUP` | 3 | `FACTOR_GROUP\|3x^2 - 12x\|3x\|(x - 4)` | conic_standard_form_generator.py, curve_analysis_generator.py, derivative_limit_def_generator.py, factor_grouping_generator.py, factor_trinomial_generator.py |
| `FACTOR_PAIR_GOAL` | 2 | `FACTOR_PAIR_GOAL\|m·n = 72\|m + n = 17` | factor_trinomial_generator.py |
...
| `FEATURE_MAP_SETUP` | 3 | `FEATURE_MAP_SETUP\|K(x,z)=(xz+2)^2\|phi(t)=(t^2,2t,2)\|x=4,z=-4` | feature_map_generator.py |
| `FEATURE_VECTOR` | 2 | `FEATURE_VECTOR\|phi(x)\|(16,8,2)` | feature_map_generator.py |
| `FEEDBACK` | 1 | `FEEDBACK\|T=G/(1+G)` | transfer_function_generator.py |
| `FERMAT_SETUP` | 3 | `FERMAT_SETUP\|prime 31\|base 79\|exponent 158` | totient_generator.py |
...
| `FINITE_DIFF_SETUP` | 3 | `FINITE_DIFF_SETUP\|forward_derivative\|x0=0,h=3\|f0=-7,f1=5` | finite_difference_generator.py |
| `FIN_FORMULA` | 1 | `FIN_FORMULA\|I = P*r*t; A = P + I` | finance_generator.py |
| `FIN_SETUP` | 3 | `FIN_SETUP\|simple interest P = 500\|r = 3%, t = 2\|interest and balance` | finance_generator.py |
...
| `FIXED_POINT_SETUP` | 3 | `FIXED_POINT_SETUP\|g(x)=3/10*x-2/3\|x0=1\|iterations=4` | fixed_point_generator.py |
| `FIXED_POINT_UPDATE` | 3 | `FIXED_POINT_UPDATE\|1\|x_0=1\|x_1=-11/30` | fixed_point_generator.py |
| `FLAG` | 2 | `FLAG\|4\|40 ÷ 8 = 5, not 4` | error_spotting_generator.py |
| `FLOOR_DIV` | 3 | `FLOOR_DIV\|5\|2\|2` | algorithm_trace_generator.py |
| `FLOPS_SETUP` | 2 | `FLOPS_SETUP\|rule=2mnk\|m=8,d=256,h=512,o=64` | flops_memory_generator.py |
| `FLUX_SUM` | 2 | `FLUX_SUM\|(-2 + 3 - 4)*810\|-2430` | vector_theorem_generator.py |
...
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-3i) * 1\|-3i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(3 + √2)(5 + √2)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FOURIER_SETUP` | 3 | `FOURIER_SETUP\|square\|A=5\|n=6` | fourier_series_generator.py |
| `FOUR_VECTOR_SETUP` | 3 | `FOUR_VECTOR_SETUP\|mass_shell\|c=1\|p=12, m=5` | four_vector_generator.py |
| `FRACTAL_SETUP` | 4 | `FRACTAL_SETUP\|mandelbrot\|z0=(0,0)\|c=(-1/2,1)\|N=6` | fractal_iteration_generator.py |
| `FRAC_BUILD` | 2 | `FRAC_BUILD\|240/360\|2/3` | conditional_probability_generator.py, geometric_probability_generator.py |
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|-22/-3\|22/3` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|43/40\|1.075` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Apple: 12, Banana: 7, Cherry: 4, Grape: 6, Melon: 6\|most frequent category` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(g - h)(5)\|g(5) - h(5)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|g(x) = -4x^2 + 4x + 3\|g(-8)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
| `FUNDAMENTAL_FORM_SETUP` | 3 | `FUNDAMENTAL_FORM_SETUP\|cylinder\|R=2\|u in [0,2pi/3], v in [0,6]` | fundamental_form_generator.py |
| `GAME_SETUP` | 2 | `GAME_SETUP\|payoffs=(14,15;17,10)\|row player maximizes, column player minimizes` | game_theory_generator.py |
...
| `GAS_SETUP` | 3 | `GAS_SETUP\|ideal_moles\|P=30, V=22\|T=11, R=1` | gas_law_generator.py |
...
| `GAUSSIAN_CURVATURE_SETUP` | 2, 3 | `GAUSSIAN_CURVATURE_SETUP\|saddle\|z=(4x^2-12y^2)/2\|point=(0,0)` | gaussian_curvature_generator.py |
| `GAUSS_BONNET_SETUP` | 3 | `GAUSS_BONNET_SETUP\|flat_torus\|width=21, height=33\|chi=0` | gauss_bonnet_generator.py |
| `GAUSS_FORMULA` | 1 | `GAUSS_FORMULA\|E*(4πr^2)=Q` | gauss_law_generator.py |
| `GAUSS_SETUP` | 3 | `GAUSS_SETUP\|sphere\|Q=68\|r=4` | gauss_law_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|15, 35\|5` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_RESULT` | 1 | `GCF_RESULT\|5` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_VAR` | 2 | `GCF_VAR\|y^5, y^4, y\|y` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GD_SETUP` | 3 | `GD_SETUP\|f(x,y)=1/2*(6x^2+1y^2)\|start=(-8,-8)\|eta=1/13` | gradient_descent_generator.py |
| `GD_UPDATE` | 3 | `GD_UPDATE\|w_old=(-3,1)\|eta=1/6\|w_new=(-14/3,-11/3)` | gradient_step_generator.py |
| `GELLMANN_IDENTITY` | 3 | `GELLMANN_IDENTITY\|Tr(lambda_1 lambda_4)\|2 delta_ab\|0` | pauli_algebra_generator.py |
| `GELLMANN_SETUP` | 3 | `GELLMANN_SETUP\|trace\|A=lambda_1\|B=-lambda_4` | pauli_algebra_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; segments p = 4 (adjacent to the leg) and q = 60\|the leg adjacent to p` | geometric_mean_generator.py |
| `GF2_XOR` | 3 | `GF2_XOR\|quotient x^4\|0 xor 1\|1` | finite_field_generator.py |
| `GF_DIV_CHECK` | 3 | `GF_DIV_CHECK\|34 / 5\|not integer\|reject` | generating_function_generator.py |
| `GF_EXPAND` | 2 | `GF_EXPAND\|1/(1 - x^3)\|sum x^(3i), i >= 0` | generating_function_generator.py |
| `GF_SETUP` | 2 | `GF_SETUP\|[x^34]\|1/((1 - x^3)(1 - x^5))` | generating_function_generator.py |
| `GIANT_FACTOR` | 2 | `GIANT_FACTOR\|g^-m mod p\|5` | baby_step_giant_step_generator.py |
| `GIANT_STEP` | 2 | `GIANT_STEP\|i=0\|11` | baby_step_giant_step_generator.py |
| `GOAL` | 1 | `GOAL\|Convert to Slope-Intercept Form (y = mx + b)` | point_slope_generator.py, standard_form_conversion_generator.py |
| `GRAD` | 2 | `GRAD\|1\|1/7` | softmax_gradient_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = 5*x^2 + 3*y^2 - 4*x*y + 5*x - 6*y\|point (2, 1)\|tangent` | gradient_generator.py |
...
| `GRAPH_SETUP` | 2 | `GRAPH_SETUP\|vertices A, B, C, D, E, F\|edges AC, AD, AF, BC, BD, BE, BF, CE, DF` | dijkstra_generator.py, euler_circuit_generator.py, graph_counting_generator.py, graph_traversal_generator.py |
| `GRASSMANN_RESULT` | 3 | `GRASSMANN_RESULT\|constant=-24\|theta=-23\|-24 - 23theta` | grassmann_generator.py |
| `GRASSMANN_SETUP` | 3 | `GRASSMANN_SETUP\|integrate\|expr=3 - 2theta\|int1=0,inttheta=1` | grassmann_generator.py |
| `GREAT_CIRCLE_SETUP` | 3 | `GREAT_CIRCLE_SETUP\|R=6\|A=(0,120)\|B=(0,-150)` | great_circle_generator.py |
| `GROUP` | 2 | `GROUP\|(3x^2 - 12x)\|(-x + 4)` | factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `GS_SETUP` | 2 | `GS_SETUP\|vectors [[-1, 0, -1], [4, 0, 2], [0, 2, 6]]\|orthogonal basis, not normalized` | gram_schmidt_generator.py |
...
| `HAMMING_RECEIVED` | 1 | `HAMMING_RECEIVED\|r=0000110` | hamming_code_generator.py |
...
| `HAM_SETUP` | 3 | `HAM_SETUP\|atwood\|m1=8, m2=28\|g=10, q=y, p=p_y` | hamiltonian_generator.py |
| `HARMONIC_SETUP` | 1 | `HARMONIC_SETUP\|u=3x^2 - 3y^2 - 5x + 5y` | cauchy_riemann_generator.py |
| `HAWKING_SETUP` | 3 | `HAWKING_SETUP\|temperature\|T_H=hbar*c^3/(8π*G*M*k_B)\|hbar=10,c=1,G=11,M=13,k_B=1` | hawking_generator.py |
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|(-10)*8 - 4^2\|-96` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = -5*x^2 + 4*y^2 + 4*x*y - 12*x + 24*y\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = -96\|f_xx = -10\|saddle point` | hessian_classify_generator.py |
...
| `HOOK` | 4 | `HOOK\|(1,1)\|right=2\|below=7\|hook=10` | young_tableaux_generator.py |
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-3x^4 + x^3 - 4x^2 - 5x + 2\|x = 4` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 25, 12 successes, critical value = 2.326` | hypothesis_test_generator.py, two_sample_test_generator.py |
| `HUFFMAN_FORMULA` | 1 | `HUFFMAN_FORMULA\|L=sum p_i*l_i` | huffman_coding_generator.py |
| `HUFFMAN_MERGE` | 2 | `HUFFMAN_MERGE\|D:1/16 + E:1/16\|DE:1/8` | huffman_coding_generator.py |
| `HUFFMAN_SETUP` | 1 | `HUFFMAN_SETUP\|A=1/2, B=1/4, C=1/8, D=1/16, E=1/16` | huffman_coding_generator.py |
| `HYDROGEN_FORMULA` | 1 | `HYDROGEN_FORMULA\|1/lambda=R_L*(1/n_low^2-1/n_high^2)` | hydrogen_atom_generator.py |
| `HYDROGEN_SETUP` | 3 | `HYDROGEN_SETUP\|transition_wavelength\|n_low=5, n_high=13\|R_L=3 1/m` | hydrogen_atom_generator.py |
| `HYPERBOLIC_DISTANCE_SETUP` | 3 | `HYPERBOLIC_DISTANCE_SETUP\|half-plane\|P=(5,6)\|Q=(5,36/5)` | hyperbolic_distance_generator.py |
| `HYPERBOLIC_SETUP` | 2 | `HYPERBOLIC_SETUP\|e^x=33/19\|e^(-x)=19/33` | hyperbolic_function_generator.py |
...
| `ICE_ROW` | 2 | `ICE_ROW\|equilibrium\|[A]=3, [B]=5.5` | equilibrium_ice_generator.py |
| `IDENTIFY` | 2 | `IDENTIFY\|order does not matter\|use C(n, r)` | permutation_combination_generator.py |
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=15..70 C(i,15) = C(71,16)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
| `IDENTITY_SETUP` | 2 | `IDENTITY_SETUP\|verify: 1 = (1 + tan^2 A) · cos^2 A\|transform the right side` | trig_identity_verify_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=24, n(B)=31\|n(A intersect B)=19` | inclusion_exclusion_generator.py |
| `IFACTOR` | 2 | `IFACTOR\|mu = e^(∫ 3 dx)\|e^(3x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `IG_SETUP` | 3 | `IG_SETUP\|parent pos=5, neg=11\|total=16\|splits=size,texture` | information_gain_generator.py |
| `IMAGE` | 2 | `IMAGE\|T(4)\|-7` | mobius_transform_generator.py |
...
| `INDEP_CHECK` | 3 | `INDEP_CHECK\|P11=121/441\|product=121/441\|yes` | joint_distribution_generator.py |
...
| `INDEX_SETUP` | 3 | `INDEX_SETUP\|c=1\|j=1, k=1\|l=1, m=1` | index_gymnastics_generator.py |
| `INDUCT_ASSUME` | 1 | `INDUCT_ASSUME\|sum to k = (9^(k+1)-1)/(9-1)` | induction_verify_generator.py |
| `INDUCT_BASE` | 2 | `INDUCT_BASE\|n=0\|1 = (r^1-1)/(r-1)` | induction_verify_generator.py |
| `INDUCT_STEP` | 1, 2 | `INDUCT_STEP\|add 9^(k+1)` | induction_verify_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|4\|-6 ≤ 2x ≤ -2` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
| `INEQ_OP_BOTH` | 4 | `INEQ_OP_BOTH\|add\|9\|x\|15` | domain_range_generator.py, linear_fractional_generator.py, one_step_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_RESULT` | 3 | `INEQ_RESULT\|x\|≥\|15` | domain_range_generator.py, linear_fractional_generator.py, one_step_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_SETUP` | 1 | `INEQ_SETUP\|x - 9 ≥ 6` | linear_fractional_generator.py, one_step_inequality_generator.py, polynomial_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_SIMPLIFY` | 1 | `INEQ_SIMPLIFY\|3x > 27` | domain_range_generator.py, linear_fractional_generator.py, two_step_inequality_generator.py |
| `INFO_GAIN` | 2 | `INFO_GAIN\|size\|0.124375` | information_gain_generator.py |
| `INFO_SETUP` | 2 | `INFO_SETUP\|p=1/8\|I=-log2(p)` | entropy_generator.py |
| `INFO_TABLE` | 1 | `INFO_TABLE\|1/8=3, 1/4=2, 5/16=1.678, 3/8=1.415, 1/2=1, 5/8=0.678, 11/16=0.541, 3/4=0.415, 7/8=0.193` | information_gain_generator.py |
...
| `INNER_PRODUCT_SETUP` | 3 | `INNER_PRODUCT_SETUP\|interval=[0,2pi]\|f=cos(19x)\|g=cos(19x)` | function_inner_product_generator.py |
| `INSERT_KEY` | 3 | `INSERT_KEY\|pass 1\|32\|index 1` | algorithm_trace_generator.py |
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 1\|30, 32, 23, 1, 19, 29` | algorithm_trace_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (12x^3 + 2x) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `INTERFERENCE_SETUP` | 3 | `INTERFERENCE_SETUP\|thin_film\|m=5, lambda=7\|n=4/3` | interference_generator.py |
| `INTERP_SETUP` | 3 | `INTERP_SETUP\|newton\|points=(-4,-73), (-3,-47), (2,-7)\|x=6` | interpolation_generator.py |
| `INTERVAL_CLASS` | 2 | `INTERVAL_CLASS\|s2=-192\|spacelike` | minkowski_interval_generator.py |
...
| `ITERATE` | 2 | `ITERATE\|n=1\|z=(-1/2,1)` | fractal_iteration_generator.py, gradient_descent_generator.py |
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 3x + 8 on [0, 2]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `JACOBI_SETUP` | 3 | `JACOBI_SETUP\|a=160\|n=77\|n odd` | jacobi_symbol_generator.py |
| `JACOBI_SWAP` | 3 | `JACOBI_SWAP\|a=77\|n=3\|sign -1` | jacobi_symbol_generator.py |
| `JACOBI_TWO_RULE` | 3 | `JACOBI_TWO_RULE\|n mod 8 = 5\|flip sign\|sign -1` | jacobi_symbol_generator.py |
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|2*5 - (-2)*(-1)\|8` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[2, -2], [-1, 5]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = 2*u - 2*v\|y = -u + 5*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
| `JOINT_SETUP` | 3 | `JOINT_SETUP\|X,Y in {0,1}\|p00=100/441, p01=110/441\|p10=110/441, p11=121/441` | joint_distribution_generator.py |
...
| `KERNEL_SETUP` | 3 | `KERNEL_SETUP\|type=rbf\|points=A=(-2,3), B=(3,1)\|gamma=1/2` | kernel_evaluation_generator.py |
...
| `KIN_SETUP` | 3, 4 | `KIN_SETUP\|v = 77 m/s\|t = 7 seconds\|distance` | invariant_mass_generator.py, kinematics_generator.py |
| `KL_FORMULA` | 1 | `KL_FORMULA\|D=sum source_i*log2(source_i/target_i)` | kl_divergence_generator.py |
| `KL_SETUP` | 3 | `KL_SETUP\|P=[1/2,7/510,124/255]\|Q=[1/2,112/255,31/510]\|direction=Q to P` | kl_divergence_generator.py |
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|101, 111\|L AND N` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|L=0\|0, 0, 1, 0` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows L=0,L=1\|columns MN=00,MN=01,MN=11,MN=10` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|(L AND N) OR (M AND N)` | boolean_algebra_generator.py |
| `KMEANS_SETUP` | 2 | `KMEANS_SETUP\|points=P1=(5,3), P2=(-2,4), P3=(1,4), P4=(1,-2)\|centroids=C1=(3,-2), C2=(4,1)` | kmeans_step_generator.py |
| `KNN_DISTANCE` | 3 | `KNN_DISTANCE\|P1\|label=B\|d2=85` | knn_generator.py |
| `KNN_NEIGHBORS` | 1 | `KNN_NEIGHBORS\|P5:4:A,P2:9:B,P3:17:A` | knn_generator.py |
| `KNN_SETUP` | 3 | `KNN_SETUP\|q=(3,-2)\|k=3\|training=P1=(-3,5,B), P2=(0,-2,B), P3=(2,2,A), P4=(-4,-4,A), P5=(3,-4,A)` | knn_generator.py |
| `KNN_SORT` | 1 | `KNN_SORT\|P5:4:A,P2:9:B,P3:17:A,P4:53:A,P1:85:B` | knn_generator.py |
| `KP_EXAMPLE` | 3 | `KP_EXAMPLE\|1\|x=7,y=1\|alpha=(0,0,0)` | kernel_perceptron_generator.py |
| `KP_SETUP` | 3 | `KP_SETUP\|kernel=linear\|data=[(7,1), (1,1), (-3,1)]\|alpha0=(0,0,0)` | kernel_perceptron_generator.py |
...
| `KRAFT_SETUP` | 2 | `KRAFT_SETUP\|A=1, B=4, C=3, D=4\|binary prefix code` | kraft_inequality_generator.py |
| `KRAFT_TERM` | 3 | `KRAFT_TERM\|A\|l=1\|1/2` | kraft_inequality_generator.py |
| `KRR_SETUP` | 3 | `KRR_SETUP\|kernel=linear\|data=[(-5,3), (3,-1)]\|lambda=2,x*=4` | kernel_ridge_generator.py |
| `KV_CACHE` | 2 | `KV_CACHE\|values\|50331648` | flops_memory_generator.py |
...
| `LADDER_SETUP` | 3 | `LADDER_SETUP\|number_energy\|state=ket2\|hbar=7, omega=8` | ladder_operator_generator.py |
| `LAGRANGE_EQ` | 2 | `LAGRANGE_EQ\|6*x = lambda*3\|x = lambda*3/6` | lagrange_multiplier_generator.py |
| `LAGRANGE_FACTOR` | 3 | `LAGRANGE_FACTOR\|L_0\|j=1\|6` | interpolation_generator.py |
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = 3*x^2 + 5*y^2\|constraint 3*x + y = 48\|minimize` | lagrange_multiplier_generator.py |
| `LAGRANGIAN` | 1, 2 | `LAGRANGIAN\|L=T-V` | lagrangian_generator.py |
| `LAG_SETUP` | 3 | `LAG_SETUP\|atwood\|m1=1, m2=13\|g=10, q=y` | lagrangian_generator.py |
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|(((lambda f. (f (lambda f. f))) (f f)) (lambda p. f))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LAURENT_SETUP` | 3 | `LAURENT_SETUP\|center a=-3\|w=(z+3)\|f=4/(z+5)` | laurent_series_generator.py |
| `LAURENT_TERM` | 1 | `LAURENT_TERM\|2(z+5)^-3` | residue_generator.py |
| `LAYERNORM_SETUP` | 3 | `LAYERNORM_SETUP\|x=(-11,3)\|gamma=(2,1)\|beta=(0,2)` | layer_norm_generator.py |
...
| `LEGENDRE_SETUP` | 2 | `LEGENDRE_SETUP\|a=16\|p=13` | legendre_construction_generator.py, quadratic_residue_generator.py |
...
| `LIMITING_REAGENT` | 2 | `LIMITING_REAGENT\|H2\|NH3=50/3 mol` | stoichiometry_generator.py |
| `LIMIT_CHECK` | 2 | `LIMIT_CHECK\|NH3 from N2=52 mol\|NH3 from H2=50/3 mol` | stoichiometry_generator.py |
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→∞ of (-5x - 1)/(x^2 + 3x - 2)\|compare degrees` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
| `LINEAR_SYSTEM` | 2 | `LINEAR_SYSTEM\|a=4/5, b=-3/10\|c=-2/9, d=7/9` | markov_chain_generator.py |
| `LINE_EQ` | 1 | `LINE_EQ\|-2x - 2y - 4 = 0` | complex_locus_generator.py |
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|-16/2 - 16\|-24` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = -2x + 10\|(7, -7)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <8*x + 3*y + 1, 6*y + 3*x - 4>\|from (2, -2) to (-1, 3)` | line_integral_generator.py |
| `LLL_DONE` | 1 | `LLL_DONE\|[(7,-3),(-4,-15)]` | lll_reduction_generator.py |
| `LLL_SETUP` | 1 | `LLL_SETUP\|[(-11,-12),(7,-3)]` | lll_reduction_generator.py |
| `LOCUS_SETUP` | 3 | `LOCUS_SETUP\|z=x+iy\|p=(-4,3)\|q=(-5,2)` | complex_locus_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|log_2(2^x) = log_2(21)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_EVAL` | 2 | `LOG_EVAL\|6/5\|ln(6/5)` | hyperbolic_distance_generator.py |
...
| `LOG_LIKELIHOOD` | 1 | `LOG_LIKELIHOOD\|ell(mu)=-(1/(2*6))*sum((x_i-mu)^2)+C` | mle_generator.py |
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|4x - 8 = x + 4` | log_equation_generator.py |
...
| `LOG_PRODUCT` | 1, 2 | `LOG_PRODUCT\|log_3(27x^3y)\|log_3(27x^3) + log_3(y)` | log_equation_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_10(100x/y^4)\|log_10(100x) - log_10(y^4)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|log_3(27x^3y)\|expand` | complex_log_generator.py, log_properties_generator.py |
| `LOG_SOFTMAX` | 2 | `LOG_SOFTMAX\|1\|ln(1/7)` | softmax_gradient_generator.py |
...
| `LORA_COUNT` | 2 | `LORA_COUNT\|r*(d_in+d_out)\|5952` | param_count_generator.py |
| `LOWRANK_SETUP` | 2 | `LOWRANK_SETUP\|A=[[19,0], [0,17]]\|rank=1` | low_rank_approx_generator.py |
| `LP_CORNER_SETUP` | 3 | `LP_CORNER_SETUP\|max z=4x+13y\|0<=x<=19, 0<=y<=4\|x+y<=21` | lp_corner_generator.py |
| `LR_PHASE` | 1 | `LR_PHASE\|warmup` | lr_schedule_generator.py |
| `LR_SETUP` | 3 | `LR_SETUP\|base=1/1000\|min=1/10000\|warmup=40,total=440,t=31` | lr_schedule_generator.py |
| `LR_VALUE` | 1 | `LR_VALUE\|31/40000` | lr_schedule_generator.py |
| `LS_LINE` | 2 | `LS_LINE\|a = 17, b = 1\|ŷ = 17 + x` | least_squares_generator.py |
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-1, 14), (0, 21), (1, 16)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[5, 4, 1], [0, -3, 1], [-20, -19, -8]]\|unit lower L` | lu_decomposition_generator.py |
| `LZ77_EMIT` | 1 | `LZ77_EMIT\|(0,0,n)` | lz_compression_generator.py |
| `LZ77_EXPAND` | 4 | `LZ77_EXPAND\|(0,0,t)\|no copy\|then add t\|out = t` | lz_compression_generator.py |
...
| `LZ78_EMIT` | 1 | `LZ78_EMIT\|(0,w)` | lz_compression_generator.py |
| `LZ78_LOOKUP` | 2 | `LZ78_LOOKUP\|index 0\|phrase empty` | lz_compression_generator.py |
| `LZ78_MATCH` | 4 | `LZ78_MATCH\|pos 0\|phrase empty\|index 0\|next w` | lz_compression_generator.py |
| `LZ_SETUP` | 2 | `LZ_SETUP\|LZ77 decode\|(0,0,t), (1,1,t), (0,0,x), (3,2,$)` | lz_compression_generator.py |
...
| `MAG_SETUP` | 3 | `MAG_SETUP\|straight_wire\|I=27, r=8\|mu0=1` | magnetism_generator.py |
...
| `MARKOV_SETUP` | 2, 3 | `MARKOV_SETUP\|two_state\|P00=7/13, P01=6/13\|P10=4/5, P11=1/5` | entropy_rate_markov_generator.py, markov_chain_generator.py |
...
| `MATRIX_GROUP_SETUP` | 2 | `MATRIX_GROUP_SETUP\|SU2\|M=[[-144/145,-17/145],[17/145,-144/145]]` | matrix_group_check_generator.py |
| `MATRIX_MULT` | 2, 3 | `MATRIX_MULT\|row1 dot col1\|9043059025/10944716689*9043059025/10944716689+4146902760/10944716689*4146902760/10944716689\|9043059025/10944716689` | projector_generator.py |
| `MATRIX_POWER` | 2 | `MATRIX_POWER\|J^2\|-I` | lie_exponential_generator.py |
| `MATRIX_PRODUCT` | 2 | `MATRIX_PRODUCT\|AB\|[[0, -255/4], [255/4, 0]]` | bch_generator.py, casimir_generator.py, gamma_matrix_generator.py, pauli_algebra_generator.py, structure_constant_generator.py |
| `MATRIX_ROW` | 2 | `MATRIX_ROW\|row 1\|0, 0, 1` | graph_counting_generator.py |
| `MATRIX_SCALE` | 2 | `MATRIX_SCALE\|1/2 ladder sum\|[[160/81, 0, 0, 0, 0, 0], [0, 416/81, 0, 0, 0, 0], [0, 0, 544/81, 0, 0, 0], [0, 0, 0, 544/81, 0, 0], [0, 0, 0, 0, 416/81, 0], [0, 0, 0, 0, 0, 160/81]]` | bch_generator.py, casimir_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[1, 3], [4, -2]], v = [[4], [5]]\|Av` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
| `MAX` | 2, 3 | `MAX\|10, 5\|10` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
| `MAXTERM` | 2 | `MAXTERM\|000\|W OR X OR Y` | boolean_algebra_generator.py |
| `MC_SETUP` | 3 | `MC_SETUP\|expression=a^T x\|a=(3,2)\|x=(6,-2)` | matrix_calculus_generator.py |
...
| `MEMORY_SETUP` | 3 | `MEMORY_SETUP\|kv_cache\|L=12,h=16,d_k=128\|seq=1024,precision_bytes=2` | flops_memory_generator.py |
| `MEMORY_UNIT` | 2 | `MEMORY_UNIT\|MiB\|96` | flops_memory_generator.py |
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=1,mid=2,hi=3\|left 34; right 14` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|34\|14\|take right` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 1-2\|array 42, 14, 34, 22, 31, 3` | algorithm_trace_generator.py |
| `MERGE_TAKE` | 2 | `MERGE_TAKE\|14\|merged 14` | algorithm_trace_generator.py |
| `METRIC` | 2 | `METRIC\|taxicab vs Chebyshev\|sum of absolute differences vs their max` | taxicab_geometry_generator.py |
| `METRICS_SETUP` | 1 | `METRICS_SETUP\|TP=31, FP=22, FN=6, TN=43` | classifier_metrics_generator.py |
| `METRIC_ARC_SETUP` | 3 | `METRIC_ARC_SETUP\|polar metric\|ds^2=dr^2+r^2 dtheta^2\|theta=60 deg, r:28->37` | metric_arc_length_generator.py |
...
| `MGF_SETUP` | 3 | `MGF_SETUP\|P(X=0)=4/13\|P(X=1)=7/13\|P(X=2)=2/13` | mgf_generator.py |
| `MGF_TERM` | 3 | `MGF_TERM\|x=0\|p0*e^(0t)\|4/13` | mgf_generator.py |
...
| `MIN` | 2 | `MIN\|64,16\|16` | matrix_norm_generator.py |
...
| `MINKOWSKI_SETUP` | 3 | `MINKOWSKI_SETUP\|rapidity_addition\|eta1=1/2\|eta2=2/3` | minkowski_interval_generator.py |
...
| `MI_SETUP` | 2 | `MI_SETUP\|rows=[[1/8,0,0,1/8,0];[0,1/8,1/8,0,0];[0,0,0,0,1/2]]\|task=H(Y given X)` | mutual_information_generator.py |
| `MLE_SETUP` | 2, 3 | `MLE_SETUP\|normal_mu\|parameter=mu\|sigma^2=6` | mle_generator.py |
| `MOBIUS_SETUP` | 2 | `MOBIUS_SETUP\|T(z)=(-10)/(z - 7)\|fixed points` | mobius_transform_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 25300 · (1 + 0.65)^2` | exponential_model_generator.py |
...
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 31\|exponent 20\|modulus 36` | mod_exp_generator.py |
...
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|30 mod 13\|10` | crt_generator.py, ecdsa_generator.py, elliptic_curve_finite_field_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|-3\|mod 13\|10` | modular_inverse_generator.py, rsa_generator.py |
| `MOD_POWER` | 3 | `MOD_POWER\|79^8\|mod 31\|18` | diffie_hellman_generator.py, pollard_factorization_generator.py, primality_test_generator.py, rsa_generator.py, tonelli_shanks_generator.py, totient_generator.py |
| `MOD_REDUCE` | 3 | `MOD_REDUCE\|369\|mod 11\|6` | calendar_arithmetic_generator.py, cayley_table_generator.py, coset_generator.py, crt_generator.py, cyclic_group_generator.py, de_moivre_generator.py, elliptic_curve_finite_field_generator.py, finite_field_generator.py, jacobi_symbol_generator.py, lie_exponential_generator.py, mod_exp_generator.py, modular_arithmetic_generator.py, modular_inverse_generator.py, primality_test_generator.py, quadratic_residue_generator.py, reed_solomon_generator.py, rsa_generator.py, totient_generator.py |
| `MOD_SETUP` | 2, 3, 4 | `MOD_SETUP\|ISBN-10 modulus 11\|prefix 968862937` | modular_arithmetic_generator.py, modular_inverse_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|7^2*12^5/10\|6096384/5` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|7*12^4/4\|36288` | centroid_generator.py |
| `MOM_EQUATION` | 2 | `MOM_EQUATION\|E[X]=lambda\|xbar=lambda` | method_of_moments_generator.py |
| `MOM_SETUP` | 3 | `MOM_SETUP\|poisson\|parameter=lambda\|data=[6,9,5,6,6,6,2,7,0]` | method_of_moments_generator.py |
| `MONO_ADD_EXP` | 2 | `MONO_ADD_EXP\|x^7 * x^3 = x^(7+3)\|x^10` | monomial_mult_div_generator.py |
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|-72 / 9\|-8` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|-1 * -2\|2` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-72x^10) / (9x^5)` | monomial_mult_div_generator.py |
| `MONO_SUB_EXP` | 2 | `MONO_SUB_EXP\|x^10 / x^5 = x^(10-5)\|x^5` | monomial_mult_div_generator.py |
| `MOVE_TERM` | 2, 3 | `MOVE_TERM\|+3x\|left\|2x-6-3x = -3` | area_between_curves_generator.py, completing_square_generator.py, conic_standard_form_generator.py, linear_complex_generator.py, polar_parametric_generator.py, quadratic_factoring_generator.py, quadratic_square_root_generator.py, radical_equation_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py |
| `MR_DECOMPOSE` | 2 | `MR_DECOMPOSE\|142\|2^1 * 71` | primality_test_generator.py |
| `MR_SETUP` | 2 | `MR_SETUP\|n=143\|witnesses 12, 19` | primality_test_generator.py |
...
| `MSE_GRADIENT` | 2 | `MSE_GRADIENT\|g0=10\|g1=28` | gradient_step_generator.py |
| `MSE_SAMPLE` | 3 | `MSE_SAMPLE\|i=1\|pred=0\|r=9` | gradient_step_generator.py |
| `MSE_SETUP` | 3 | `MSE_SETUP\|model y_hat=w0+w1*x\|samples=[(3,-9), (-1,-3), (2,-8)]\|w=(-3,1), eta=1/6` | gradient_step_generator.py |
...
| `MU` | 2 | `MU\|-41/265\|round=0` | lll_reduction_generator.py |
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(3x)y' + 3e^(3x)y\|12e^(3x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `MULTIVALUED_LOG` | 2 | `MULTIVALUED_LOG\|ln(19) + i*(23pi/90 + 2pi*k)\|k in Z` | complex_log_generator.py |
| `MULTI_FORMULA` | 2 | `MULTI_FORMULA\|n!/(a!b!c!...)\|12! / repeats` | stars_and_bars_generator.py |
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|4 J's, 3 T's, 1 X, 4 H's\|total 12` | stars_and_bars_generator.py |
...
| `MUL_TERM` | 3 | `MUL_TERM\|4\|(3/4)x\|3x` | linear_fractional_generator.py, polynomial_long_division_generator.py, rational_equation_generator.py |
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 + 4x + 4 on [-1, 5]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 3*x^2 + 3*y^2 - 2*x*y - 3*x + 6*y\|x = s + 2*t + 4, y = 4*s - 3*t + 5\|(s,t) = (0, 3)` | multivar_chain_rule_generator.py |
| `NATURAL_SETUP` | 3 | `NATURAL_SETUP\|time\|hbar=1,c=1\|t=13/33 MeV^-1` | natural_units_generator.py |
| `NB_FEATURE_COUNT` | 3 | `NB_FEATURE_COUNT\|Spam\|link=1\|count=11` | naive_bayes_generator.py |
| `NB_LIKELIHOOD` | 3 | `NB_LIKELIHOOD\|Spam\|link=1\|3/5` | naive_bayes_generator.py |
| `NB_PRIOR` | 2 | `NB_PRIOR\|Spam\|9/17` | naive_bayes_generator.py |
| `NB_SCORE` | 2 | `NB_SCORE\|Spam\|start=9/17` | naive_bayes_generator.py |
| `NB_SETUP` | 3 | `NB_SETUP\|query=link=1, known=1\|alpha=1\|classes=Spam,Ham` | naive_bayes_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 7:11\|line 4 multiplies 7 by 12` | fill_in_step_generator.py |
| `NEG_LOG` | 2 | `NEG_LOG\|p=1/2\|ln(2)` | perplexity_generator.py |
| `NET_SETUP` | 2 | `NET_SETUP\|1 square 2 by 2; 4 triangles with base 2 and height 3\|total surface area` | nets_surface_area_generator.py |
| `NEWTON_DD` | 2 | `NEWTON_DD\|f[x0,x1]\|26` | interpolation_generator.py |
| `NEWTON_SETUP` | 2, 3 | `NEWTON_SETUP\|f(x)=x^2-5\|f'(x)=2x\|x0=2,iterations=2` | newton_raphson_generator.py, newtons_laws_generator.py |
| `NEWTON_STEP` | 2 | `NEWTON_STEP\|1\|1/3` | npv_irr_generator.py |
| `NEWTON_UPDATE` | 3 | `NEWTON_UPDATE\|1\|x_0=2\|x_1=9/4` | newton_raphson_generator.py |
...
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|p6\|{p7}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|cabba` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{t2}\|c\|t2->{t2}\|{t2}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|c` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states t2, t4, t8\|alphabet a, b, c\|start t2` | nfa_simulation_generator.py |
| `NFA_TRANSITION` | 3 | `NFA_TRANSITION\|t2\|a\|{t2,t4}` | nfa_simulation_generator.py |
| `NILPOTENT` | 3 | `NILPOTENT\|theta^2=0\|12theta^2\|0` | grassmann_generator.py |
| `NLL` | 2 | `NLL\|8 tokens\|8*ln(2)` | perplexity_generator.py |
| `NORM2` | 2 | `NORM2\|b1\|265` | lll_reduction_generator.py |
| `NORMALIZE` | 2 | `NORMALIZE\|1\|1` | clebsch_gordan_generator.py, layer_norm_generator.py |
| `NORMALIZE_SIGN` | 2 | `NORMALIZE_SIGN\|(-5,1)\|(5,-1)` | lll_reduction_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(112, 5)\|raw value for z = -0.8` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
| `NORM_SQUARED` | 2 | `NORM_SQUARED\|q\|1` | quaternion_generator.py |
| `NO_REDEX` | 2 | `NO_REDEX\|(((f f) (lambda f. f)) (lambda p. f))\|no beta redex remains` | lambda_reduction_generator.py |
| `NPV_SETUP` | 2 | `NPV_SETUP\|c0=-2800,c1=800,c2=300,c3=600\|rate=10%` | npv_irr_generator.py |
| `NPV_TERM` | 2 | `NPV_TERM\|t=0\|-2800` | npv_irr_generator.py |
...
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dt = 10y, y(0) = 19\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `OPTICS_FORMULA` | 1 | `OPTICS_FORMULA\|n1*sin(theta1)=n2*sin(theta2)` | optics_generator.py |
| `OPTICS_SETUP` | 3 | `OPTICS_SETUP\|snell\|n1=1, n2=2\|sin(theta1)=1` | optics_generator.py |
| `OPT_SETUP` | 2 | `OPT_SETUP\|x + y = 1722, x, y > 0\|maximize P = x·y^2` | optimization_generator.py |
| `ORBIT_FORMULA` | 1 | `ORBIT_FORMULA\|F=G*m1*m2/r^2` | orbital_mechanics_generator.py |
| `ORBIT_SETUP` | 3 | `ORBIT_SETUP\|gravity_force\|m1=71, m2=68\|r=10, G=1` | orbital_mechanics_generator.py |
| `ORDER_PDF` | 1 | `ORDER_PDF\|f_{4:6}(x)=60*x^3*(1-x)^2` | order_statistics_generator.py |
| `ORDER_SETUP` | 3 | `ORDER_SETUP\|n=6\|k=4\|q=1/2` | order_statistics_generator.py |
...
| `OR_SETUP` | 3 | `OR_SETUP\|EOQ\|D=960\|S=24, H=20` | or_formula_generator.py |
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|4*x^2 + 8*x` | double_integral_generator.py |
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|y=0..16\|8*4*4^2/2\|256` | double_integral_generator.py |
| `OUTER_PRODUCT` | 1 | `OUTER_PRODUCT\|rho=62/151ket00bra00 + sqrt(5518)/151(ket00bra11+ket11bra00) + 89/151ket11bra11` | partial_trace_generator.py |
| `OUTPUT` | 1 | `OUTPUT\|y_hat=-12` | backprop_generator.py |
| `PAIR` | 2 | `PAIR\|apricot\|badger` | one_to_one_correspondence_generator.py |
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|4x + 35 = 3x + 52` | angle_relationships_generator.py |
...
| `PARAMS` | 3 | `PARAMS\|W1=[[-2,-1], [-2,0]]\|b1=(-1,0)\|v=(-1,-1), c=-2` | backprop_generator.py |
| `PARAM_PART` | 2 | `PARAM_PART\|full_matrix\|918528` | param_count_generator.py |
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(2*t + 2, 0)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 14cos t + 16, y = 14sin t + 1\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(3x + 4)/((x + 2)(x + 4)) = A/(x + 2) + B/(x + 4)` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|2/(s + 4) - 3/(s - 3)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|6*x^2*y^3 + 10*x*y` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|5*x^2*y\|d/dx\|10*x*y` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 2*x^3*y^3 + 5*x^2*y\|f_xy` | partial_derivative_generator.py |
...
| `PARTITION_SETUP` | 3 | `PARTITION_SETUP\|two_level\|g0=1, g1=1\|epsilon=7, b=1/3` | partition_function_generator.py |
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = -220x, dv = sin(x) dx\|du = -220 dx, v = -cos(x)` | integration_by_parts_generator.py |
...
| `PASCAL_SETUP` | 1 | `PASCAL_SETUP\|3C1` | pascal_triangle_generator.py |
| `PATH_DERIV` | 2 | `PATH_DERIV\|r'(t)\|(2, 0)` | curve_geometry_generator.py, line_integral_generator.py |
| `PAULI_IDENTITY` | 3 | `PAULI_IDENTITY\|Tr(sigma_z sigma_z)\|2 delta_ij\|16` | pauli_algebra_generator.py |
| `PAULI_MATRIX` | 2 | `PAULI_MATRIX\|sigma_x\|[[0,1],[1,0]]` | spin_half_generator.py |
| `PAULI_SETUP` | 3 | `PAULI_SETUP\|trace\|A=2sigma_z\|B=4sigma_z` | pauli_algebra_generator.py |
| `PCA_SETUP` | 2 | `PCA_SETUP\|points=[(1,3), (-7,3), (-3,11), (-3,-5)]\|population covariance` | pca_generator.py |
...
| `PDE_SETUP` | 2 | `PDE_SETUP\|u_t = 9u_xx on [0,2]\|u(x,0)=9sin(6πx/2)` | separable_pde_generator.py |
| `PDF_FORMULA` | 1 | `PDF_FORMULA\|f_Y(y)=1/(28*sqrt(y))` | rv_transform_generator.py |
| `PD_SETUP` | 2 | `PD_SETUP\|A=[[-2,-5], [-5,-4]]\|Sylvester criterion` | positive_definite_generator.py |
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|1.775\|2425\|4304.375` | percent_problem_generator.py |
...
| `PERCEPTRON_SETUP` | 3 | `PERCEPTRON_SETUP\|eta=2\|w=(0,0,1)\|samples=[(-2,-3,-1), (0,1,1), (1,0,-1)]` | perceptron_generator.py |
| `PERCEPTRON_UPDATE` | 2, 3 | `PERCEPTRON_UPDATE\|i=1\|no change\|w=(0,0,1)` | perceptron_generator.py |
...
| `PERM_RESULT` | 1 | `PERM_RESULT\|[2, 3, 4, 1]` | permutation_group_generator.py |
...
| `PERPLEXITY_SETUP` | 2 | `PERPLEXITY_SETUP\|tokens=8\|p=1/2` | perplexity_generator.py |
| `PE_ENTRY` | 2 | `PE_ENTRY\|0\|1/2` | positional_encoding_generator.py |
| `PE_SETUP` | 3 | `PE_SETUP\|position=135\|d=2\|theta=pi/6` | positional_encoding_generator.py |
...
| `PHYS_SETUP` | 3 | `PHYS_SETUP\|P = 122 watts\|t = 5 minutes\|energy` | physics_formula_generator.py |
...
| `PI2_NUM` | 3 | `PI2_NUM\|-13/384\|π^2\|-13π^2/384` | casimir_force_generator.py |
...
| `PI_DEN` | 3 | `PI_DEN\|5/572\|π\|5/(572π)` | gauss_law_generator.py, hawking_generator.py, magnetism_generator.py |
...
| `PLANCK_SETUP` | 4 | `PLANCK_SETUP\|time\|hbar=49\|G=9\|c=36` | planck_units_generator.py |
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|x = ±√2249\|x = √2249 or x = -√2249` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|30*3/6\|15` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y - 6 = 4/3(x + 8)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_FORM` | 1 | `POLAR_FORM\|11 cis(90 deg)` | euler_formula_generator.py |
| `POLAR_FORMULA` | 1 | `POLAR_FORMULA\|x = r cos θ, y = r sin θ` | polar_parametric_generator.py |
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|(r, θ) = (24, 29925°)\|rectangular coordinates` | parametric_calculus_generator.py, polar_parametric_generator.py |
| `POLES` | 1 | `POLES\|s=-1, -6` | transfer_function_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|3y^3 + 7y^2 - 8y - 6\|y + 3` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|x^3 - 7x^2 - x - 1` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(10x^7 + 5x^6) / (-5x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(10x^7) / (-5x^3) + (5x^6) / (-5x^3)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(x^3) + (x^2 -8x^2) + (-x) + (4 -5)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|x + 2` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x + 2)(-3x^2 + 2x + 2)` | multiplying_polynomials_generator.py |
| `POLY_MUL_START` | 2 | `POLY_MUL_START\|degree 1\|degree 1` | finite_field_generator.py |
| `POLY_REMAINDER` | 1 | `POLY_REMAINDER\|x^5 + x^3 + 1` | finite_field_generator.py |
| `POLY_SCALE` | 3 | `POLY_SCALE\|x^3 - 3x/5\|5/2\|(5x^3 - 3x)/2` | legendre_construction_generator.py |
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(x^3 + x^2 + 4) - (8x^2 + x + 5)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(3y^3 + 7y^2) - (3y^3 + 9y^2)\|-2y^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
| `PORT_FORMULA` | 2 | `PORT_FORMULA\|E=wA*rA+wB*rB\|Var=wA^2*varA+wB^2*varB+2*wA*wB*cov` | portfolio_generator.py |
| `PORT_RESULT` | 2 | `PORT_RESULT\|expected_return=0.1125\|variance=0.02953125` | portfolio_generator.py |
| `PORT_SETUP` | 3 | `PORT_SETUP\|wA=0.25,wB=0.75\|rA=12%,rB=11%\|varA=0.0225,varB=0.04,cov=0.015` | portfolio_generator.py |
...
| `POTENTIAL_BUILD` | 3 | `POTENTIAL_BUILD\|integrate P dx\|4*x^2 + 3*x*y + x + g(y)\|g'(y) remains` | exact_ode_generator.py, line_integral_generator.py |
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|4*x^2 + 3*y^2 + 3*x*y + x - 4*y` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(4/5)^5\|0.32768` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|(-256) + (-27)*(-3)\|-175` | diagonalization_generator.py |
...
| `POWER_REDUCE` | 2 | `POWER_REDUCE\|79^158\|79^8 mod 31` | totient_generator.py |
...
| `POWER_SETUP` | 2 | `POWER_SETUP\|cis(304 deg)^(-12i)\|principal logarithm` | complex_log_generator.py |
...
| `PREDICT` | 2 | `PREDICT\|x*\|-2` | kernel_ridge_generator.py |
| `PRIME` | 1 | `PRIME\|41` | divisibility_classification_generator.py |
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited B\|AB=21, BF=22, BE=23` | mst_generator.py |
| `PRIM_START` | 1 | `PRIM_START\|B` | mst_generator.py |
| `PRINCIPAL_LOG` | 1 | `PRINCIPAL_LOG\|ln(19) + i*23pi/90` | complex_log_generator.py |
...
| `PROB_CONDITIONAL` | 2 | `PROB_CONDITIONAL\|P(black given first was black)\|1/17` | compound_probability_generator.py |
...
| `PROB_SIMPLIFY` | 2 | `PROB_SIMPLIFY\|2/306\|1/153` | compound_probability_generator.py |
...
| `PROJECTILE_SETUP` | 3 | `PROJECTILE_SETUP\|vx=27\|vy=30\|g=10` | projectile_motion_generator.py |
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[16, 17, 18]` | least_squares_generator.py, legendre_construction_generator.py |
| `PROJECTOR_SETUP` | 2 | `PROJECTOR_SETUP\|v=(95095/104617, 43608/104617)\|P=vv^T=[[9043059025/10944716689,4146902760/10944716689],[4146902760/10944716689,1901657664/10944716689]]` | projector_generator.py |
...
| `PSD_SETUP` | 2 | `PSD_SETUP\|K=[[3,-1], [-1,3]]\|criterion=all principal minors >= 0` | kernel_validity_generator.py |
| `PURITY` | 1 | `PURITY\|Tr(rho^2)=97/169` | density_matrix_generator.py |
| `PYTHAG_CALCULATE` | 2 | `PYTHAG_CALCULATE\|d² = 2592100 + 5760000 = 8352100\|8352100` | pythag_leg_generator.py |
| `PYTHAG_CONTEXT` | 3 | `PYTHAG_CONTEXT\|displacement\|east=1610m, north=2400m\|diagram=TSD` | pythag_leg_generator.py |
| `PYTHAG_FORMULA` | 1 | `PYTHAG_FORMULA\|a² + b² = c²` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_MODEL` | 3 | `PYTHAG_MODEL\|east=1610\|north=2400\|distance=?` | pythag_leg_generator.py |
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|50176\|224` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 2, 3 | `PYTHAG_SETUP\|legs=36,15\|hypotenuse NP=?` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 67600 - 17424\|50176` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|132\|17424` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|132² + b² = 260²` | pythag_leg_generator.py |
| `Q1` | 4 | `Q1\|46\|50\|4\|24` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|46\|50\|4\|-1` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QN_ADD` | 4 | `QN_ADD\|Q\|left\|0 + p(1)\|1` | conservation_law_generator.py |
| `QR_ENTRY` | 2 | `QR_ENTRY\|q1\|[1, 0, 0]` | qr_decomposition_generator.py |
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[6, 0, -3], [0, 5, 0], [0, 0, 2]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|216°\|quadrant III` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
| `QUADRATIC` | 3 | `QUADRATIC\|1\|-7\|10` | mobius_transform_generator.py |
| `QUANTUM_FORMULA` | 1 | `QUANTUM_FORMULA\|lambda=h/p` | quantum_formula_generator.py |
| `QUANTUM_SETUP` | 2, 3 | `QUANTUM_SETUP\|gates=Z then H then X\|input=e^(i188π/175)·ket1` | quantum_formula_generator.py, quantum_gate_generator.py |
| `QUANT_SETUP` | 3 | `QUANT_SETUP\|x=(-101/100,-91/50,-97/100)\|scale=1/20\|zero_point=-8` | quantization_generator.py |
| `QUANT_VALUE` | 2 | `QUANT_VALUE\|1\|-28` | quantization_generator.py |
| `QUARK_CHARGE` | 2 | `QUARK_CHARGE\|u\|2/3` | quark_composition_generator.py |
| `QUARK_SETUP` | 3 | `QUARK_SETUP\|meson,count=599\|u anti_b\|u=2/3,d=-1/3,s=-1/3,c=2/3,b=-1/3; anti=-charge` | quark_composition_generator.py |
| `QUARTILE` | 3 | `QUARTILE\|Q1\|8,14,26,28,31\|26` | five_number_summary_generator.py |
...
| `QUAT_RESULT` | 2 | `QUAT_RESULT\|q*v\|(1,-2,0,2)` | quaternion_generator.py |
| `QUAT_SETUP` | 2 | `QUAT_SETUP\|q=(0,0,-1,0)\|v=(0,2,1,2)` | quaternion_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|circle: dr/dt = 5 ft/min; r = 38 ft\|dA/dt` | related_rates_generator.py |
| `RATIO` | 2, 3 | `RATIO\|2*y = 3*x\|y = 3/2*x` | lagrange_multiplier_generator.py, simplex_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|(11 - √97)/(11 - √97)` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
| `RATIO_BASE` | 3 | `RATIO_BASE\|15:9\|3\|5:3` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
| `RATIO_TABLE` | 2 | `RATIO_TABLE\|Water (oz): ?, 15, 45, 55\|Concentrate (oz): 6, 9, 27, 33` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
| `RAW_FORMULA` | 1 | `RAW_FORMULA\|x = μ + z·σ` | z_score_generator.py |
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 2480 / 0.32` | percent_problem_generator.py |
...
| `RECT_FORM` | 1 | `RECT_FORM\|sqrt2 + sqrt2i` | de_moivre_generator.py, euler_formula_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = 2 a_(n-1) + 8 a_(n-2) - 9\|a_0 = -3, a_1 = 3` | master_theorem_generator.py, recurrence_generator.py |
| `REDUCED_DENSITY` | 1 | `REDUCED_DENSITY\|rho_A=[[62/151,0],[0,89/151]]` | partial_trace_generator.py |
| `REFLEXIVE_CHECK` | 2 | `REFLEXIVE_CHECK\|(1, 1)\|missing` | relation_check_generator.py |
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q22692_1` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|a*b\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q22692_0\|still reading a*` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q22692_0\|a\|q22692_0` | regex_to_automaton_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 51), (2, 53), (3, 52), (4, 55), (5, 54)\|correlation coefficient r` | regression_generator.py |
| `REJECT` | 1, 2 | `REJECT\|x = −45` | conditional_forms_generator.py, counterexample_search_generator.py, factor_trinomial_generator.py, knights_knaves_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py, set_builder_roster_generator.py |
| `RELAX` | 3 | `RELAX\|B->A\|update inf to 4\|via weight 4` | dijkstra_generator.py |
...
| `REL_ENERGY_SETUP` | 3 | `REL_ENERGY_SETUP\|velocity_addition\|u=-1/2\|v=11/13` | relativistic_energy_generator.py |
| `REL_FORMULA` | 1 | `REL_FORMULA\|t=gamma*tau` | special_relativity_generator.py |
| `REL_SETUP` | 2, 3 | `REL_SETUP\|A = {1, 2, 3, 4}\|R = {(2, 1), (2, 3), (2, 4), (3, 2), (3, 3), (4, 3), (4, 4)}` | relation_check_generator.py, special_relativity_generator.py |
...
| `RESIDUE_SETUP` | 2 | `RESIDUE_SETUP\|a=-5\|f=(2 + 8(z+5)^2 + 3(z+5)^3 + 3(z+5)^4)/(z+5)^3` | residue_generator.py |
| `RESIDUE_SUM` | 1 | `RESIDUE_SUM\|0` | contour_integral_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (1, 54), line ŷ = 53.6 + 0.8x\|residual = observed − predicted` | regression_generator.py |
| `RESOLVE` | 3 | `RESOLVE\|C1\|C2\|P11837` | resolution_proof_generator.py |
| `RES_EMPTY` | 1 | `RES_EMPTY\|C4` | resolution_proof_generator.py |
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(P11837), C2=(not P11837), C3=(P89849)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C2\|(P50924)` | resolution_proof_generator.py |
| `REVERSE` | 2 | `REVERSE\|0,0,0,1,1,1\|111000` | base_arithmetic_generator.py, base_conversion_generator.py, bitwise_ops_generator.py |
...
| `RG_SETUP` | 3 | `RG_SETUP\|one_loop\|alpha0=4/13\|beta=5/6,L=2/5` | running_coupling_generator.py |
...
| `RIEMANN_SETUP` | 2, 3 | `RIEMANN_SETUP\|f(x) = 3x + 5 on [-2, 2], n = 4\|left Riemann sum` | riemann_sum_generator.py, riemann_tensor_generator.py |
| `RK_COMBINE` | 2 | `RK_COMBINE\|k1+2k2+2k3+k4\|39` | runge_kutta_generator.py |
| `RK_STAGE` | 3 | `RK_STAGE\|k1\|t=-5/2\|y=7` | runge_kutta_generator.py |
...
| `ROTATED_VECTOR` | 1 | `ROTATED_VECTOR\|(-2,1,-2)` | quaternion_generator.py |
| `ROT_FORMULA` | 1 | `ROT_FORMULA\|I1*omega1=I2*omega2` | rotational_dynamics_generator.py |
| `ROT_SETUP` | 3 | `ROT_SETUP\|angular_momentum\|I1=30, omega1=7\|I2=14` | rotational_dynamics_generator.py |
| `ROUND` | 2 | `ROUND\|-141/5\|-28` | quantization_generator.py |
...
| `ROUTH_SETUP` | 1 | `ROUTH_SETUP\|p(s)=s^3+28s^2+19s+12` | routh_hurwitz_generator.py |
...
| `RSA_DECRYPT` | 2 | `RSA_DECRYPT\|327\|72` | rsa_generator.py |
| `RSA_ENCRYPT` | 2 | `RSA_ENCRYPT\|72\|327` | rsa_generator.py |
| `RSA_PRIVATE_KEY` | 1 | `RSA_PRIVATE_KEY\|d=275` | rsa_generator.py |
| `RSA_PUBLIC_KEY` | 2 | `RSA_PUBLIC_KEY\|n=377\|e=11` | rsa_generator.py |
| `RSA_SETUP` | 3 | `RSA_SETUP\|p=13\|q=29\|message=72` | rsa_generator.py |
| `RSQ_FORMULA` | 1 | `RSQ_FORMULA\|r^2 = Sxy^2/(Sxx·Syy)` | regression_generator.py |
| `RS_CORRECT` | 2 | `RS_CORRECT\|position=1\|[40,127,78,123]` | reed_solomon_generator.py |
| `RS_EVAL` | 2 | `RS_EVAL\|x=10\|129` | reed_solomon_generator.py |
| `RS_LINE` | 3 | `RS_LINE\|m0=113\|m1=55\|agree=2` | reed_solomon_generator.py |
| `RS_PAIR` | 2 | `RS_PAIR\|x=25,70\|y=118,127` | reed_solomon_generator.py |
| `RS_RECEIVED` | 1 | `RS_RECEIVED\|[118,127,78,123]` | reed_solomon_generator.py |
| `RS_SETUP` | 3 | `RS_SETUP\|F_137\|RS(4,2)\|points 25,70,73,101; one error allowed` | reed_solomon_generator.py |
...
| `SAMPLE_MOMENT` | 2 | `SAMPLE_MOMENT\|xbar\|47/9` | method_of_moments_generator.py |
| `SAMPLE_SIZE_FORMULA` | 1 | `SAMPLE_SIZE_FORMULA\|n = (z*·σ/E)^2` | confidence_interval_generator.py |
| `SA_BASES` | 2 | `SA_BASES\|2π(13)² = 2π × 169\|338π` | volume_3d_generator.py |
...
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 13 × 51\|1326π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=3, w=11, h=3` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(33 + 9 + 33)\|150` | round_solids_generator.py, volume_3d_generator.py |
| `SB_FORMULA` | 1 | `SB_FORMULA\|C(n-1, k-1)` | stars_and_bars_generator.py |
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x3 = 38\|xi >= 1` | stars_and_bars_generator.py |
| `SCALE_DIV` | 3 | `SCALE_DIV\|3034\|74\|41` | scaling_generator.py |
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|2*cos\|sqrt2` | de_moivre_generator.py, euler_formula_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|3034 meters\|scaled_dimension` | scaling_generator.py |
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = 2\|4*(-20)\|-80` | diagonalization_generator.py |
| `SCALE_MULT` | 3 | `SCALE_MULT\|3.25\|46\|149.5` | scaling_generator.py |
| `SCALE_SETUP` | 3 | `SCALE_SETUP\|1 centimeter\|74 meters\|74` | scaling_generator.py |
| `SCALE_SHIFT` | 2 | `SCALE_SHIFT\|1\|-2` | layer_norm_generator.py |
| `SCALING_COMPUTE` | 2 | `SCALING_COMPUTE\|6ND\|12054000000000000000` | scaling_law_generator.py |
| `SCALING_SETUP` | 3 | `SCALING_SETUP\|N=41000000\|D=49000000000\|F=66000000000000000` | scaling_law_generator.py |
| `SCHWARZSCHILD_SETUP` | 3, 4 | `SCHWARZSCHILD_SETUP\|time_dilation\|r_s=9\|r=25` | schwarzschild_generator.py |
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|4.75\|-10` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|right\|10` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|divide_coefficients\|4.1\|4.1\|1` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|(4.1 × 10^-10) ÷ (4.1 × 10^-9)` | exponent_generator.py |
| `SCORE_EQ` | 1 | `SCORE_EQ\|28-6*mu=0` | mle_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(8, 4), B(26, 22); ratio 4:5 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_16 = -5 + (16 - 1)·-5` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|-5, -10, -15, -20, ...\|16th term` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ -27·1^n, n ≥ 0\|converge or diverge? find the sum if it converges` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
| `SERIES_TERM` | 3 | `SERIES_TERM\|n=0\|1\|1` | grassmann_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|2480 = 0.32 * whole` | percent_problem_generator.py |
| `SET_SETUP` | 2, 3 | `SET_SETUP\|A = {d, e}\|B = {b, c, e}\|minus` | set_operations_generator.py |
| `SET_SIDE` | 2 | `SET_SIDE\|left\|∅` | counterexample_search_generator.py |
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y3 = 35` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
| `SHM_FORMULA` | 1 | `SHM_FORMULA\|omega^2=k/m` | shm_generator.py |
| `SHM_SETUP` | 3 | `SHM_SETUP\|mass_spring_energy\|m=3, k=243\|A=2, x=1` | shm_generator.py |
...
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|(-11) + (-7) + (-3) + 1 + 5 + 9` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=-7)^(-2) (4k + 17)\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=-7\|4(-7) + 17\|-11` | sigma_notation_generator.py |
| `SIGN` | 3 | `SIGN\|left\|-1\|negative` | bisection_generator.py |
| `SIGNAL_SETUP` | 2, 3 | `SIGNAL_SETUP\|sampling\|f_max=877 Hz\|f_s=1758 Hz` | signal_arithmetic_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, -11)\|y = -12\|f(y) = 81 (positive)\|up` | stability_generator.py |
| `SIMILAR_APPLY` | 3 | `SIMILAR_APPLY\|3\|3\|9` | scaling_generator.py |
| `SIMILAR_SCALE` | 3 | `SIMILAR_SCALE\|9\|3\|3` | scaling_generator.py |
| `SIMILAR_SETUP` | 3 | `SIMILAR_SETUP\|triangle\|3,7,3\|9 (others unknown)` | scaling_generator.py |
| `SIMPLEX_SETUP` | 3 | `SIMPLEX_SETUP\|max z=11x+2y\|x<=18\|y<=21` | simplex_generator.py |
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; DE = 56, AB = 24, EF = 56\|find BC` | similar_triangles_generator.py |
...
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = -5cos(3(x - π/4)) - 4\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
| `SIZE_REDUCE` | 2 | `SIZE_REDUCE\|b2=(-11, -12)\|b2-(-1)b1=(-4, -15)` | lll_reduction_generator.py |
...
| `SLOPE_INT_IDENTIFY` | 2 | `SLOPE_INT_IDENTIFY\|Slope (m)\|70` | slope_intercept_form_generator.py |
| `SLOPE_INT_MATCH` | 2 | `SLOPE_INT_MATCH\|Compare to Slope-Intercept Form\|y = mx + b` | slope_intercept_form_generator.py |
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = 70x + 37` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|4/3` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(0, 6)\|(-10, -2)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-2 - 6) / (-10 - 0)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOFTMAX_PROB` | 2 | `SOFTMAX_PROB\|1\|1/7` | softmax_gradient_generator.py |
| `SOFTMAX_SETUP` | 3 | `SOFTMAX_SETUP\|z=(3*ln(2),3*ln(9),3*ln(3))\|T=3\|target=2` | softmax_gradient_generator.py |
| `SOFTMAX_WEIGHT` | 2 | `SOFTMAX_WEIGHT\|1,1\|1/2` | attention_generator.py |
| `SOLUTIONS` | 2 | `SOLUTIONS\|sin x = 1/2\|30°, 150°, 390°, 510°, 750°, 870°, 1110°, 1230°, 1470°, 1590°, 1830°, 1950°, 2190°, 2310°, 2550°, 2670°, 2910°, 3030°, 3270°, 3390°, 3630°, 3750°, 3990°, 4110°, 4350°, 4470°, 4710°, 4830°, 5070°, 5190°` | trig_equation_generator.py |
| `SOLUTION_FORMULA` | 1 | `SOLUTION_FORMULA\|M1*V1=M2*V2` | solution_chem_generator.py |
| `SOLUTION_SETUP` | 3 | `SOLUTION_SETUP\|dilution_final_molarity\|M1=1/4, V1=40\|V2=72` | solution_chem_generator.py |
...
| `SOLVE_Y` | 2 | `SOLVE_Y\|e^(3x)y = 4e^(3x) + C\|y = 4 + Ce^(-3x)` | integrating_factor_generator.py, laplace_ivp_generator.py, ode_substitution_generator.py |
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(2*e^(-5t) - e^(6t))*(-3) + (2*e^(-5t) - 2*e^(6t))*5\|4*e^(-5t) - 7*e^(6t)` | matrix_exponential_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|CD=2, BC=3, BD=6, DE=7, DF=8, EF=9, AD=12, AB=14, BE=15, AF=19, BF=20` | mst_generator.py |
| `SPECIAL_SOLUTION` | 2 | `SPECIAL_SOLUTION\|16 = 16\|identity: true for every x` | radical_equation_generator.py, special_solution_equation_generator.py |
...
| `SPHERICAL_EXCESS_SETUP` | 2 | `SPHERICAL_EXCESS_SETUP\|R=13\|angles=30,90,120` | spherical_excess_generator.py |
| `SPHERICAL_SINE_LAW` | 1 | `SPHERICAL_SINE_LAW\|sin(A)/sin(a)=sin(B)/sin(b)` | spherical_triangle_generator.py |
| `SPHERICAL_TRIANGLE_SETUP` | 2 | `SPHERICAL_TRIANGLE_SETUP\|a=30 deg, b=90 deg, A=30 deg\|find sin(B)` | spherical_triangle_generator.py |
| `SPIN_COMPONENT` | 2 | `SPIN_COMPONENT\|row=1\|-3/5` | spin_half_generator.py |
| `SPIN_SETUP` | 3 | `SPIN_SETUP\|measurement_probability\|axis=z\|psi=[-12/37,-35/37]` | spin_half_generator.py |
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|-13x = -12x - x\|3x^2 - 12x - x + 4` | factor_trinomial_generator.py |
| `SPLIT_SETUP` | 3 | `SPLIT_SETUP\|size\|left pos=1, neg=7\|right pos=4, neg=4` | information_gain_generator.py |
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|x^2 = 2249\|x = ±√2249` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `SQRT_DIGIT` | 2 | `SQRT_DIGIT\|7\|root = 7` | manual_square_root_generator.py |
| `SQRT_NEG` | 2 | `SQRT_NEG\|√(-352)\|i√352` | complex_quadratic_generator.py, polynomial_zeros_generator.py |
| `SQRT_SETUP` | 2 | `SQRT_SETUP\|N = 116\|x0 = 3` | manual_square_root_generator.py |
| `SQRT_TRIAL` | 3 | `SQRT_TRIAL\|x = 7\|(0 + 7)*7 = 49\|fits` | manual_square_root_generator.py |
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(x + 33) = x + 3\|x + 33 = (x + 3)^2` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|36900\|900 × 41\|900` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `STANDING_SETUP` | 3 | `STANDING_SETUP\|open_pipe\|n=7\|L=24, v=103` | standing_wave_generator.py |
...
| `STATICS_SETUP` | 3 | `STATICS_SETUP\|lever_balance\|F1=70\|d1=3, d2=11` | statics_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(59 + 64) / 2\|61.5` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|10` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|44\|47\|-3` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|530 / 10\|53` | statistics_generator.py |
...
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|position 3\|57` | statistics_generator.py |
...
| `STAT_ORDER` | 1 | `STAT_ORDER\|20, 38, 57, 73, 81` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|96 - 24\|72` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|38, 70, 52, 77, 40, 56, 53, 46, 41, 57` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|38 + 70 + 52 + 77 + 40 + 56 + 53 + 46 + 41 + 57\|530` | statistics_generator.py |
...
| `STEREO_SETUP` | 3, 4 | `STEREO_SETUP\|plane_to_sphere\|u=-7/2\|v=-1/3` | stereographic_generator.py |
...
| `STOICH_SETUP` | 2, 3 | `STOICH_SETUP\|limiting_reagent\|N2 + 3 H2 -> 2 NH3\|given=N2=26 mol, H2=25 mol` | stoichiometry_generator.py |
| `STRUCTURE_CONSTANT` | 3 | `STRUCTURE_CONSTANT\|epsilon_zxy\|1\|-255iJy` | structure_constant_generator.py |
| `STRUCTURE_SETUP` | 3 | `STRUCTURE_SETUP\|A=-15Jz\|B=17Jx\|epsilon_zxy=1` | structure_constant_generator.py |
...
| `SUBGROUP_START` | 2 | `SUBGROUP_START\|H=<3>\|identity 1` | coset_generator.py |
...
| `SUM` | 2, 3 | `SUM\|51 + 53 + 52 + 55 + 54\|265` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
| `SUM_ORDER` | 2 | `SUM_ORDER\|Σ i^3\|n^4` | master_theorem_generator.py |
| `SUPPORT` | 2 | `SUPPORT\|0<=x<=14\|0<=y<=196` | rv_transform_generator.py |
| `SUPPORT_TERM` | 2 | `SUPPORT_TERM\|1\|(-15,0)` | svm_margin_generator.py |
| `SVM_SETUP` | 3 | `SVM_SETUP\|x1=(15,0),y1=-1,alpha1=1\|x2=(0,-8),y2=-1,alpha2=1\|b=-2,x=(3,-1)` | svm_margin_generator.py |
| `SWAP` | 2 | `SWAP\|norm b2=58\|norm b1=265` | lll_reduction_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|x^3 + 3x^2 - 9x + 7\|r = 2` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: 2x = -18` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with y only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = -5y - 17` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * 5, Eq2 * 2` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|10x + 10y = 10\|-8x - 10y = -28` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x + 5y = -17\|5x - y = -33` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=-2 into x = -5y - 17` | systems_elimination_generator.py, systems_substitution_generator.py |
| `TABLEAU` | 2, 3 | `TABLEAU\|initial\|s1: x + s1 = 18\|s2: y + s2 = 21` | simplex_generator.py |
| `TABLEAU_RULE` | 3 | `TABLEAU_RULE\|3 x 3bar\|box plus antibox gives adjoint plus singlet\|8 + 1` | young_tableaux_generator.py |
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|h(-1)\|-4` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(6)\|-1` | de_moivre_generator.py, dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, lie_exponential_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 19 + 21*(x - 2) - 8*(y - 1)` | gradient_generator.py |
...
| `TAYLOR_SETUP` | 2 | `TAYLOR_SETUP\|f(x) = e^x, P_4 around 0\|bound the error at x = 1` | taylor_series_generator.py |
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|all middle factors cancel\|101/189` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Π k=101..188 k/(k+1)` | telescoping_generator.py |
| `TEMP_SCALE` | 2 | `TEMP_SCALE\|z1/T\|ln(2)` | softmax_gradient_generator.py |
| `TENSOR_ENTRY` | 2 | `TENSOR_ENTRY\|C_11\|-10` | einstein_summation_generator.py, index_raising_generator.py |
| `TENSOR_RULE` | 1 | `TENSOR_RULE\|diag(a,b) tensor diag(c,d)=diag(ac,ad,bc,bd)` | tensor_product_generator.py |
| `TENSOR_SETUP` | 3 | `TENSOR_SETUP\|A=diag(-5,-3)\|B=diag(-4,4)\|u=[3,2], v=[-4,4]` | tensor_product_generator.py |
| `TENSOR_STATE` | 2 | `TENSOR_STATE\|u tensor v\|[-12,12,-8,8]` | tensor_product_generator.py |
| `TERM` | 2 | `TERM\|i=0: 1·(1/2)^0·(1/2)^4\|0.0625` | binomial_probability_generator.py |
| `TERMS` | 1 | `TERMS\|y[0..4]=[1,9,81,729,6561]` | z_transform_generator.py |
| `TEST_CHOOSE` | 2 | `TEST_CHOOSE\|geometric series\|common ratio r = 1` | power_series_generator.py, series_convergence_generator.py |
| `TEST_STAT_FORMULA` | 1 | `TEST_STAT_FORMULA\|z = (p̂ - p0)/√(p0(1-p0)/n)` | hypothesis_test_generator.py, two_sample_test_generator.py |
| `TF_SETUP` | 3 | `TF_SETUP\|block_feedback\|G1=11/(s+12), G2=7/(s+8)\|H=1` | transfer_function_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Stokes\|F=<3*y, 0, 0>\|disk radius 11 in z=0` | vector_theorem_generator.py |
| `THETA` | 2 | `THETA\|min(12,8)\|8` | transportation_generator.py |
| `THROUGHPUT` | 2 | `THROUGHPUT\|tokens_per_second\|11000000000/41` | scaling_law_generator.py |
...
| `TIME_EVOLVE` | 2 | `TIME_EVOLVE\|U psi\|[-1+i,-1,-1-i]` | braket_generator.py |
...
| `TRANSFER` | 1 | `TRANSFER\|G(s)=77/(s^2+20s+96)` | transfer_function_generator.py |
...
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(-5, 8)\|rotation 90° counterclockwise about the origin` | rv_transform_generator.py, transformation_generator.py |
| `TRANSIENT_FORMULA` | 1 | `TRANSIENT_FORMULA\|tau=R*C` | transient_circuit_generator.py |
| `TRANSIENT_SETUP` | 3 | `TRANSIENT_SETUP\|rc_charging\|R=7, C=5\|Vs=16, t=35` | transient_circuit_generator.py |
| `TRANSITIVE_CHECK` | 3 | `TRANSITIVE_CHECK\|(2, 3) and (3, 2)\|need (2, 2)\|missing` | relation_check_generator.py |
| `TRANSPORT_SETUP` | 3 | `TRANSPORT_SETUP\|supply=(9,12)\|demand=(8,13)\|costs=(4,2;4,3)` | transportation_generator.py |
| `TRIG_RATIO` | 2 | `TRIG_RATIO\|cos\|adjacent/hypotenuse` | right_triangle_trig_generator.py |
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: adjacent side = 2, hypotenuse = 5; given cos 66° ≈ 0.4\|angle A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|z_part * r_part * angle\|5*32*2*2*pi\|640*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 5*z\|cylinder radius 2, height 8\|cylindrical` | triple_integral_generator.py |
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|72\|35\|x` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|x = 180 - 72 - 35\|73` | angle_relationships_generator.py |
| `TRI_ANGLE_SUM` | 1 | `TRI_ANGLE_SUM\|72 + 35 + x = 180` | angle_relationships_generator.py |
| `TRI_AREA_FORMULA` | 1 | `TRI_AREA_FORMULA\|Area = (1/2)·a·b·sin C` | triangle_area_sas_generator.py |
| `TRI_SETUP` | 2 | `TRI_SETUP\|45-45-90 triangle, hypotenuse = 8\|leg` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
| `TRUNCATE` | 2 | `TRUNCATE\|rank=1\|discard=17` | low_rank_approx_generator.py |
| `TRUTH_ROW` | 2 | `TRUTH_ROW\|W=0, X=0, Y=0\|h=0` | boolean_algebra_generator.py |
...
| `UNIT_ATTACH` | 3 | `UNIT_ATTACH\|539\|meters\|539 meters` | cross_section_generator.py, kinematics_generator.py, physics_formula_generator.py |
...
| `UNIT_RATE_DIV` | 3 | `UNIT_RATE_DIV\|$3.75\|5\|$0.75` | unit_rate_generator.py |
| `UNIT_RATE_PICK` | 2 | `UNIT_RATE_PICK\|3\|12` | unit_rate_generator.py |
| `UNIT_RATE_SETUP` | 3 | `UNIT_RATE_SETUP\|5\|shirts\|$3.75` | unit_rate_generator.py |
| `UNIT_RATE_TABLE` | 2 | `UNIT_RATE_TABLE\|3,6,9,10\|12,24,36,40` | unit_rate_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|11, 22, 44, 88\|geometric, r = 2` | recursive_explicit_generator.py |
| `UPDATE` | 2 | `UPDATE\|W1_11\|22/3` | backprop_generator.py, kernel_perceptron_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|7 - 4 = 3\|(3)^2 = 9\|2/5·9 = 3.6` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|5` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y) = <-4*x + 6*y, 5*x + 4*y>\|divergence and scalar curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|(-80) + 486*2\|892` | diagonalization_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|base: region under y = 474 - x on [0, 474]; cross-sections perpendicular to the x-axis are squares\|cross-section method` | solid_revolution_generator.py |
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 12 × 9\|54.0` | round_solids_generator.py, volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 3 × 9 × 3\|81` | round_solids_generator.py, volume_3d_generator.py |
| `VOL_FORMULA` | 1 | `VOL_FORMULA\|V = l × w × h` | round_solids_generator.py, solid_revolution_generator.py, volume_3d_generator.py |
| `VOL_SETUP` | 2 | `VOL_SETUP\|rectangular_prism\|l=3, w=9, h=3` | volume_3d_generator.py |
| `VOP_FORM` | 2 | `VOP_FORM\|u1' = -y2*g/W\|-90/2 * e^(5x)` | variation_parameters_generator.py |
...
| `WAVE_SETUP` | 3 | `WAVE_SETUP\|power_interval\|psi=N*(x/L)^5\|0<=x<=20` | wavefunction_generator.py |
...
| `WIDTH_SETUP` | 3 | `WIDTH_SETUP\|lifetime\|hbar=11\|Gamma=7` | branching_ratio_generator.py |
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|9 - 26\|-17` | line_integral_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(38 - 80)/20\|-2.1` | normal_table_generator.py, z_score_generator.py |
...
| `ZT_SETUP` | 2, 3 | `ZT_SETUP\|difference\|y[n]-9y[n-1]=delta[n]\|y[-1]=0` | z_transform_generator.py |
