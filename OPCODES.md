...
434 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|- 5x^3 + 1x^2 - 3x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|64666 × 52181 ≈ 60000 × 50000\|3000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3000000000\|3374336546\|3374336546 ≈ 3000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 18x^4 + 12x^4 - 30x^4) / (-6x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-18x^4) / (-6x) + (12x^4) / (-6x) + (-30x^4) / (-6x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 3)(-5x^2 + x - 3)` | multiplying_polynomials_generator.py |
