...
1979 distinct op-codes observed.
...
| `ESTIMATE` | 2 | `ESTIMATE\|round the base before applying the percent\|$100.00` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|$100.00\|$111.35\|$111.35 ≈ $100.00 ✓` | fermi_estimation_generator.py, long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `MODEL_EQ` | 2 | `MODEL_EQ\|x = 60*(1+20/100)\|changed value` | integer_puzzle_word_generator.py, linear_model_word_generator.py, mixture_generator.py, money_life_generator.py, motion_word_generator.py, multi_step_word_generator.py, percent_chain_generator.py, percent_word_problem_generator.py, work_rate_generator.py |
...
| `SELECT_RELEVANT` | 2 | `SELECT_RELEVANT\|used: base 97, rate 30%\|ignored: 45 empty folders` | proportion_word_problem_generator.py |
...
| `UNIT_PRICE` | 3 | `UNIT_PRICE\|A\|4.8/24\|$0.20` | money_life_generator.py |
