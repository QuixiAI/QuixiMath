...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|- 3x^3 - 12x^2 - 3x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|44699 × 11581 ≈ 40000 × 10000\|400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|400000000\|517659119\|517659119 ≈ 400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|7 × 11 = 77, not 55` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 gives the scale factor 10\|line 5 answers 70` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(163, 6)\|P(X < 173.2)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 6x^2 - 8x + 2x) / (2x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-6x^2) / (2x) + (-8x) / (2x) + (2x) / (2x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x - 4)(-x^2 - 4x - 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(173.2 - 163)/6\|1.70` | normal_table_generator.py |
