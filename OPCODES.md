...
| `DECISION` | 2 | `DECISION\|f(x)\|0` | svm_margin_generator.py |
...
| `KERNEL_VALUE` | 2 | `KERNEL_VALUE\|A,A\|1` | feature_map_generator.py, kernel_evaluation_generator.py, kernel_ridge_generator.py |
