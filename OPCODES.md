...
| `CX_SETUP` | 2 | `CX_SETUP\|(9 - 8i)(-3 - 8i)\|multiply` | complex_number_ops_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|5x\|- 10x^3 + 15x^2 + 5x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|66870 × 3771 ≈ 70000 × 4000\|280000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|280000000\|252166770\|252166770 ≈ 280000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|5 × 5 = 25, not 30` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: 9 * (-3)\|-27` | complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-8i) * (-3)\|24i` | complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (-8i) * (-8i)\|64i^2` | complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: 9 * (-8i)\|-72i` | complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(5 + √3)(1 + √3)` | complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py |
...
| `I_SQUARE` | 2 | `I_SQUARE\|64i^2\|-64` | complex_number_ops_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 2x = 14\|line 5 shows x = 7` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(45, 7)\|P(47.8 < X < 60.4)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 45x^5 + 36x^4 - 9x^3) / (9x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-45x^5) / (9x) + (36x^4) / (9x) + (-9x^3) / (9x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(5x + 4)(-2x^2 + 3x + 1)` | multiplying_polynomials_generator.py |
...
| `REWRITE` | 1 | `REWRITE\|8 + 90` | completing_square_generator.py, complex_number_ops_generator.py, domain_range_generator.py, evaluate_expression_generator.py, exponent_mixed_rules_generator.py, factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, function_composition_generator.py, function_operations_generator.py, inverse_function_generator.py, linear_complex_generator.py, linear_fractional_generator.py, literal_equation_generator.py, normal_table_generator.py, order_of_operations_generator.py, quadratic_factoring_generator.py, radical_add_sub_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py, rational_equation_generator.py, rational_exponent_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, recursive_explicit_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py, standard_form_conversion_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(47.8 - 45)/7\|0.40` | normal_table_generator.py |
