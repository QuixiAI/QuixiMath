...
1774 distinct op-codes observed.
...
| `CLASSIFY` | 2 | `CLASSIFY\|contingency\|T at 3 of 8 rows` | foundations_critic_generator.py, truth_table_generator.py |
...
| `MEMBER_ROW` | 1, 3 | `MEMBER_ROW\|x∈B, x∈M, x∈T` | foundations_critic_generator.py, set_identity_membership_table_generator.py |
...
| `SUM` | 2, 3 | `SUM\|59 + 47 + 53 + 50 + 56\|265` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
