...
412 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-3x\|- 15x^3 - 15x^2 + 15x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|93840 × 80332 ≈ 90000 × 80000\|7200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|7200000000\|7538354880\|7538354880 ≈ 7200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|22 ÷ 2 = 11, not 13` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 gives the scale factor 12\|line 5 answers 72` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(513, 7)\|P(X > 520.7)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 7x^6 + 7x^4) / (-7x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-7x^6) / (-7x^2) + (7x^4) / (-7x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-3x + 1)(5x^2 + 5x - 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(520.7 - 513)/7\|1.10` | normal_table_generator.py |
