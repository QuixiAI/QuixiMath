...
1654 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|x + 3 = 5` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|5x - 9 ≥ 8 -> x ≥ 17/5` | absolute_value_inequality_generator.py |
...
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|AND case\|-5 < 3x < 5` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(x + 3) = 5` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|x + 3 = 5\|x + 3 = -5` | absolute_value_equation_generator.py |
| `ABS_VAL` | 2 | `ABS_VAL\|14\|14` | taxicab_geometry_generator.py |
...
| `ACT_SETUP` | 3 | `ACT_SETUP\|activation=relu\|x=-1\|w1=2,b1=1,w2=-1,b2=6` | activation_generator.py |
| `ACT_VALUE` | 3 | `ACT_VALUE\|relu\|-1\|0` | activation_generator.py |
| `AC_COMPLEX` | 3 | `AC_COMPLEX\|Z\|22\|7j` | ac_circuit_generator.py |
| `AC_FORMULA` | 1 | `AC_FORMULA\|Z=R+j(XL-XC)` | ac_circuit_generator.py |
| `AC_PRODUCT` | 2 | `AC_PRODUCT\|4 × (-6)\|-24` | factor_trinomial_generator.py |
| `AC_SETUP` | 3 | `AC_SETUP\|series_rlc\|R=22, XL=32\|XC=25, V=91` | ac_circuit_generator.py |
| `ADAM_SETUP` | 3 | `ADAM_SETUP\|theta=7/4,g=10\|beta1=9/10,beta2=99/100\|lr=1/100,epsilon=0` | adam_step_generator.py |
| `ADAM_UPDATE` | 2 | `ADAM_UPDATE\|theta_new\|87/50` | adam_step_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 8/12, P(B) = 10/12, P(A ∪ B) = 11/12\|P(A ∩ B)` | probability_addition_rule_generator.py |
...
| `ALG_SETUP` | 3 | `ALG_SETUP\|binary search\|target 23\|values 6, 23, 25, 27, 28, 47` | algorithm_trace_generator.py |
| `ALIGN_NUM` | 2 | `ALIGN_NUM\|046.36\|177.07` | number_comparison_generator.py |
| `ALPHA` | 2 | `ALPHA\|alpha1\|-6` | kernel_ridge_generator.py |
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda c. t\|lambda z. t` | lambda_reduction_generator.py |
| `AMORT_ROW` | 3 | `AMORT_ROW\|1\|interest=$4192.00\|principal=$256.00,balance=$16512.00` | annuity_generator.py |
| `AMPLITUDE` | 2 | `AMPLITUDE\|abs(-4)\|4` | sinusoid_features_generator.py |
| `ANALOGY_SETUP` | 3 | `ANALOGY_SETUP\|man=(0,-1)\|woman=(2,-1)\|king=(0,-4)` | embedding_similarity_generator.py |
...
| `ANGLE_DEFECT_SETUP` | 2 | `ANGLE_DEFECT_SETUP\|R=3\|angles=30,60,60` | angle_defect_generator.py |
...
| `ANGLE_WRAP` | 2 | `ANGLE_WRAP\|218 deg\|-142 deg` | complex_log_generator.py |
| `ANNUITY_FORMULA` | 1 | `ANNUITY_FORMULA\|PV = PMT/r` | annuity_generator.py |
| `ANNUITY_SETUP` | 2, 3 | `ANNUITY_SETUP\|perpetuity present value\|PMT=225,r=8%` | annuity_generator.py |
| `ANTICOMM_ENTRY` | 3 | `ANTICOMM_ENTRY\|(1,1)\|0 + 0\|0` | pauli_algebra_generator.py |
| `ANTIDERIV` | 2 | `ANTIDERIV\|-12e^(3x)\|-4e^(3x)` | antiderivative_generator.py, arc_length_generator.py, area_between_curves_generator.py, definite_integral_generator.py, improper_integral_generator.py, integrating_factor_generator.py, integration_by_parts_generator.py, ode_substitution_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py, variation_parameters_generator.py |
...
| `APPLY_GATE` | 3 | `APPLY_GATE\|Y\|e^(i188π/103)·ket0\|i·e^(i188π/103)·ket1` | quantum_gate_generator.py |
| `APPLY_OPERATOR` | 2 | `APPLY_OPERATOR\|L[Ae^x]\|A(1 - 3 - 4)e^x` | commutator_generator.py, undetermined_coeff_generator.py |
| `APPLY_PAULI` | 2 | `APPLY_PAULI\|sigma_x psi\|[20/29,21/29]` | spin_half_generator.py |
| `APPLY_SUBST` | 1 | *(not observed in sampling)* | unification_generator.py |
| `APPROX` | 2 | `APPROX\|lora/full\|155/2496` | param_count_generator.py |
| `APPROX_ENTRY` | 2 | `APPROX_ENTRY\|(1,1)\|0` | low_rank_approx_generator.py |
| `APPROX_SETUP` | 2 | `APPROX_SETUP\|estimate ∛6\|linearize f(x) = ∛x at a = 8` | linear_approx_generator.py |
...
| `ARC_LENGTH` | 3 | `ARC_LENGTH\|int_0^T speed dt\|5*11\|55` | curve_geometry_generator.py |
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 42, central angle 15°\|sector area` | arc_sector_generator.py |
...
| `AREA_SCALE` | 3 | `AREA_SCALE\|uv rectangle area\|9*8\|72` | jacobian_generator.py |
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 - 24x + 45 and y = -x^2 - 2x - 3\|area between the curves` | area_between_curves_generator.py |
...
| `ARITH_SETUP` | 2 | `ARITH_SETUP\|A=1/8, B=3/8, C=1/4, D=1/4\|message=CBBDB` | arithmetic_coding_generator.py |
| `ARITH_SYMBOL` | 2 | `ARITH_SYMBOL\|C\|cum=[1/2,3/4)` | arithmetic_coding_generator.py |
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|10, 12, 33, 11, 7` | algorithm_trace_generator.py |
| `ASSIGN` | 2 | `ASSIGN\|P1\|C2` | kmeans_step_generator.py |
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = 1 ± (4/3)(x + 3)` | hyperbola_features_generator.py |
| `ATA` | 2 | `ATA\|A^T A\|[[10042, 9558], [9558, 10042]]` | svd_generator.py |
...
| `AV_VECTOR` | 2 | `AV_VECTOR\|A*v1\|[140/√2, 140/√2]` | svd_generator.py |
...
| `BACKPROP_SETUP` | 3 | `BACKPROP_SETUP\|x=(-2,3)\|y=4\|eta=1/3` | backprop_generator.py |
| `BACK_SUB` | 2 | `BACK_SUB\|v = y/x\|y/x = -3 ln(x) + C` | ode_substitution_generator.py |
| `BACK_SUB_ROW` | 3 | `BACK_SUB_ROW\|r=164\|x=1\|y=0` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 36, disease=no 104\|sensitivity 5/6, specificity 7/8\|P(disease=yes given test positive)` | conditional_probability_generator.py |
| `BAYES_UPDATE_SETUP` | 2, 3 | `BAYES_UPDATE_SETUP\|normal_normal\|prior=Normal(-2,3)\|sigma^2=1` | bayesian_update_generator.py |
| `BCH_FORM` | 2 | `BCH_FORM\|A+B+1/2[A,B]\|[[0, 5, 10], [0, 0, -4], [0, 0, 0]]` | bch_generator.py |
| `BCH_SETUP` | 3 | `BCH_SETUP\|A=-4E23\|B=5E12\|order=2` | bch_generator.py |
...
| `BETA` | 1 | `BETA\|(lambda f. (lambda q. (q (lambda e. e)))) applied to (q q)` | lambda_reduction_generator.py |
| `BEZOUT_CHECK` | 2 | `BEZOUT_CHECK\|164*-1 + 84*2\|4` | extended_euclid_generator.py |
...
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 5, p = 7/10\|P(X ≤ 2)` | binomial_probability_generator.py |
| `BISECTION_SETUP` | 3 | `BISECTION_SETUP\|f(x)=x^2-189\|interval=[13, 14]\|iterations=5` | bisection_generator.py |
...
| `BLACKBODY_SETUP` | 3 | `BLACKBODY_SETUP\|wien_peak\|b=3984\|T=249` | blackbody_generator.py |
...
| `BOND_SETUP` | 2 | `BOND_SETUP\|face=8900\|coupon=20%,ytm=20%,years=4` | bond_pricing_generator.py |
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables K, L, M\|DNF from G=1 rows` | boolean_algebra_generator.py |
...
| `BOX_SETUP` | 1, 3 | `BOX_SETUP\|transition_wavelength\|n_low=1, n_high=4\|h=8, c=8` | particle_in_box_generator.py |
| `BRAKET_FORMULA` | 1 | `BRAKET_FORMULA\|inner(phi,psi)=sum conj(phi_k)*psi_k` | braket_generator.py |
| `BRAKET_SETUP` | 3 | `BRAKET_SETUP\|inner_product\|phi=[-1,2-i,1+i]\|psi=[-i,1,i]` | braket_generator.py |
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|433 <= 500\|yes` | piecewise_evaluation_generator.py |
...
| `BS_RESULT` | 2 | `BS_RESULT\|call=6.8\|put=4.8` | black_scholes_generator.py |
| `BS_SETUP` | 3 | `BS_SETUP\|S=110,K=120\|df=0.9\|N_d1=0.7,N_d2=0.65` | black_scholes_generator.py |
...
| `CASHFLOW_PV` | 2 | `CASHFLOW_PV\|coupon_t1\|4450/3` | bond_pricing_generator.py |
| `CASIMIR_FORCE_SETUP` | 2 | `CASIMIR_FORCE_SETUP\|F/A=-π^2*hbar*c/(240*d^4)\|hbar=10,c=4,d=4` | casimir_force_generator.py |
| `CASIMIR_SETUP` | 3 | `CASIMIR_SETUP\|spin=5\|hbar=13/3\|J^2 entry at m=-3` | casimir_generator.py |
...
| `CBRT` | 2 | `CBRT\|64r^3\|4r` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
...
| `CEIL` | 2 | `CEIL\|864.36\|865` | confidence_interval_generator.py |
...
| `CENTROID_UPDATE` | 2 | `CENTROID_UPDATE\|C1\|(-2,3)` | kmeans_step_generator.py |
| `CF_PARTIAL` | 2 | `CF_PARTIAL\|a_0\|4` | continued_fraction_generator.py |
| `CF_RESULT` | 1 | `CF_RESULT\|[4; 1, 1, 1, 3, 2, 1, 3]` | continued_fraction_generator.py |
| `CF_SETUP` | 1 | `CF_SETUP\|617/133` | continued_fraction_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*x_s + f_y*y_s\|2*(-1) + 16*(-3)\|-50` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(1,-1)\|(-1)*1 + (-1)*(-1)\|0` | multivar_chain_rule_generator.py |
| `CHANGE_BASE` | 1 | `CHANGE_BASE\|log_16(4) = log_2(4)/log_2(16)` | log_conversion_generator.py |
| `CHAR_DIAG` | 2 | `CHAR_DIAG\|diagonal of λI - A\|(λ + 5), (λ - 1), λ` | eigenvalue_generator.py |
| `CHAR_EQ` | 2 | `CHAR_EQ\|assume y=e^(rx)\|r^2 - 6r + 25 = 0` | ode_system_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^3 + 4λ^2 - 5λ\|(λ + 5)*λ*(λ - 1)` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
| `CHAR_ROOTS` | 2 | `CHAR_ROOTS\|r = 3 ± 4i\|complex conjugates` | recurrence_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `CHINCHILLA` | 2 | `CHINCHILLA\|20N\|1040000000` | scaling_law_generator.py |
| `CHI_FORMULA` | 1 | `CHI_FORMULA\|E = (row·col)/N; χ² = Σ (O - E)^2/E` | chi_square_generator.py |
| `CHI_SETUP` | 2 | `CHI_SETUP\|row 1: 91, 59; row 2: 89, 61; N = 300\|independence; df = 1, critical value = 3.841` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|91 - 90 = 1\|1^2 = 1\|1/90 = 1/90` | chi_square_generator.py |
| `CHOLESKY_ENTRY` | 2 | `CHOLESKY_ENTRY\|l11\|5` | cholesky_generator.py |
| `CHOL_SETUP` | 2 | `CHOL_SETUP\|A = [[25, -5, -5], [-5, 2, -2], [-5, -2, 19]]\|A = L L^T` | cholesky_generator.py |
| `CHRISTOFFEL_FORMULA` | 1 | `CHRISTOFFEL_FORMULA\|Gamma^i_jk = 1/2 g^im(d_j g_mk + d_k g_mj - d_m g_jk)` | christoffel_generator.py |
| `CHRISTOFFEL_SETUP` | 3 | `CHRISTOFFEL_SETUP\|sphere\|g_phiphi=R^2, g_thetatheta=R^2 sin^2(phi)\|R=6, phi=45 deg` | christoffel_generator.py |
| `CHRISTOFFEL_VALUE` | 2 | `CHRISTOFFEL_VALUE\|Gamma^phi_thetatheta\|-168/625` | riemann_tensor_generator.py |
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|central angle 270° subtends an arc\|inscribed angle on the same arc` | circle_angle_generator.py |
| `CIRCLE_CALCULATE` | 2 | `CIRCLE_CALCULATE\|radius = diameter / 2 = 46 / 2\|23` | circle_generator.py |
| `CIRCLE_EQ` | 1 | `CIRCLE_EQ\|(x + 5)^2 + (y - 6)^2 = 49` | complex_locus_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|3*2^2*pi\|12*pi` | vector_theorem_generator.py |
| `CI_FORMULA` | 1 | `CI_FORMULA\|x̄ ± E` | confidence_interval_generator.py |
| `CI_SETUP` | 2 | `CI_SETUP\|σ = 16, n = 25, z* = 1.96\|margin of error` | confidence_interval_generator.py |
| `CLASSIFY` | 2 | `CLASSIFY\|contingency\|T at 3 of 8 rows` | truth_table_generator.py |
| `CLAUSE` | 2 | `CLAUSE\|C1\|(P87511 OR P31058)` | resolution_proof_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(Q OR NOT R OR S) AND (Q OR NOT R OR NOT S) AND (NOT Q OR R OR S) AND (NOT Q OR NOT R OR S)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|12240` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|3, 4, 0, 17\|0 inserted for missing x term` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[1, -1], [-1, -1]]` | determinant_generator.py |
| `COLLIDER_SETUP` | 3 | `COLLIDER_SETUP\|luminosity\|N=29 events\|sigma=26 fb` | cross_section_generator.py |
| `COLLISION_SETUP` | 3 | `COLLISION_SETUP\|elastic_1d\|m1=1, u1=7\|m2=9, u2=-13` | collision_generator.py |
...
| `COMBO` | 2 | `COMBO\|x = 3*v1 - 31*v2\|[2, 1]` | diagonalization_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|choose 4 of 15\|order does not matter` | counting_classics_generator.py, permutation_combination_generator.py, stars_and_bars_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|14 - 7\|7` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|320/(-256)\|-5/4` | geometric_sequence_generator.py, recursive_explicit_generator.py |
| `COMMUTATOR` | 2 | `COMMUTATOR\|[A,B]\|[[0, -11i], [-11i, 0]]` | structure_constant_generator.py |
...
| `COMM_RESULT` | 2 | `COMM_RESULT\|[D,x]f\|x^17` | commutator_generator.py |
| `COMM_SETUP` | 3 | `COMM_SETUP\|[D,x]f\|f=x^17\|D=d/dx` | commutator_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|x < -4 -> x < -4` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|-11 < x - 9 < 0` | compound_inequality_generator.py |
| `CONCLUSION_AT` | 2 | `CONCLUSION_AT\|q=F, r=T, s=T\|T` | argument_form_generator.py |
| `COND_COUNT` | 2 | `COND_COUNT\|club=no and commute=bike\|21` | conditional_probability_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 4, no/bike 21, yes/bus 13, no/bus 22\|P(commute=bike given club=no)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|club=no total\|21 + 22 = 43` | conditional_probability_generator.py |
| `CONGRUENCE_REDUCE` | 2 | `CONGRUENCE_REDUCE\|7x congruent to 4\|mod 5` | modular_inverse_generator.py |
| `CONGRUENCE_SOLUTIONS` | 3 | `CONGRUENCE_SOLUTIONS\|base 2\|step 5\|2, 7` | modular_inverse_generator.py |
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(y - 3)^2 = 8(x - 6)\|vertex, focus, directrix` | conic_standard_form_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `CONSERVATION_SETUP` | 2 | `CONSERVATION_SETUP\|e- + e+ -> gamma + pi0 + gamma\|check=Q,B,Le,Lmu` | conservation_law_generator.py |
...
| `CONTOUR_SETUP` | 3 | `CONTOUR_SETUP\|abs(z)=4\|positive orientation\|f=2/(z-5) + 1/(z+1) - 4/(z+5)` | contour_integral_generator.py |
| `CONT_DIST_SETUP` | 3 | `CONT_DIST_SETUP\|f(x)=k*x\|support=[0,6]\|interval=(2,3)` | continuous_distribution_generator.py |
...
| `CONV_SETUP` | 2, 3 | `CONV_SETUP\|x=[0,5,9,3]\|h=[8,0,0,2,9]` | convolution_generator.py, convolutional_code_viterbi_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[3, -31]` | diagonalization_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|9 boxes\|force 8 in one box` | counting_classics_generator.py |
| `COUPON` | 1 | `COUPON\|1780` | bond_pricing_generator.py |
| `COV_ENTRY` | 2 | `COV_ENTRY\|xx\|18` | pca_generator.py |
| `COV_FORMULA` | 1 | `COV_FORMULA\|Cov=E[XY]-E[X]E[Y]` | joint_distribution_generator.py |
| `CRC_CHECK` | 3 | `CRC_CHECK\|codeword=100110000100\|remainder=0000\|valid` | crc_generator.py |
| `CRC_REMAINDER` | 1 | `CRC_REMAINDER\|0100` | crc_generator.py |
| `CRC_SETUP` | 3 | `CRC_SETUP\|data=10011000\|poly=11001\|augmented=100110000000` | crc_generator.py |
| `CRC_SKIP` | 2 | `CRC_SKIP\|i=3\|leading bit 0` | crc_generator.py |
| `CRC_XOR` | 3 | `CRC_XOR\|i=0\|10011 xor 11001\|01010` | crc_generator.py |
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|-10*x + 4*y + 52 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|(-10)*2 - 4^2\|-36` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=2\|ln(5/3)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|6·EF = 21·6` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CROSS_RATIO` | 1 | `CROSS_RATIO\|13/28` | mobius_transform_generator.py |
| `CROSS_RATIO_SETUP` | 4 | `CROSS_RATIO_SETUP\|z1=-7\|z2=-1\|z3=6\|z4=1` | mobius_transform_generator.py |
| `CRT_CHECK` | 3 | `CRT_CHECK\|i=1\|0\|0` | crt_generator.py |
| `CRT_CONGRUENCE` | 3 | `CRT_CONGRUENCE\|i=1\|x=0\|mod 5` | crt_generator.py |
| `CRT_FACTOR` | 3 | `CRT_FACTOR\|i=1\|M_i=143\|mod 5` | crt_generator.py |
| `CRT_SETUP` | 1 | `CRT_SETUP\|3 congruences` | crt_generator.py |
| `CRT_TERM` | 2 | `CRT_TERM\|i=1\|0` | crt_generator.py |
| `CRT_TOTAL_MODULUS` | 2 | `CRT_TOTAL_MODULUS\|5, 11, 13\|715` | crt_generator.py |
| `CR_SETUP` | 2 | `CR_SETUP\|u=-4x^2 + 4y^2 + 3x + 4y\|v=-8xy - 4x + 4y` | cauchy_riemann_generator.py |
...
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 6x^2 + 9x + 4\|inflection point and concavity` | curve_analysis_generator.py |
...
| `CX_SETUP` | 2 | `CX_SETUP\|i^28\|simplify` | complex_division_generator.py, complex_number_ops_generator.py |
| `CYCLE` | 1 | `CYCLE\|(1 2 4 3)` | permutation_group_generator.py |
...
| `CYCLE_TRACE` | 2 | `CYCLE_TRACE\|start 1\|1->2->4->3->1` | permutation_group_generator.py |
...
| `CYK_CELL` | 2 | `CYK_CELL\|1,2\|{S,T}` | cyk_parser_generator.py |
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|D T\|{S,T}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|D\|b or e` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string eeeec\|length 5` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{D,T} x {D,T}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|e\|{D,T}` | cyk_parser_generator.py |
...
| `DEMOIVRE_SETUP` | 2, 4 | `DEMOIVRE_SETUP\|power\|r=3\|theta=120 deg\|n=4` | de_moivre_generator.py |
| `DENSITY` | 2 | `DENSITY\|f_X(x)\|1/23` | rv_transform_generator.py |
| `DENSITY_MATRIX` | 1 | `DENSITY_MATRIX\|rho=[[9/10,0],[0,1/10]]` | density_matrix_generator.py |
| `DENSITY_SETUP` | 2, 3 | `DENSITY_SETUP\|state=plus_phase_0\|psi=(ket00 + e^(i55π/141)ket10)/sqrt(2)` | density_matrix_generator.py, partial_trace_generator.py |
| `DEPTH` | 1, 2 | `DEPTH\|3` | wff_parsing_generator.py |
| `DEQUANT_VALUE` | 2 | `DEQUANT_VALUE\|1\|3/25` | quantization_generator.py |
...
| `DERIVED` | 2 | `DERIVED\|C5\|(P87511)` | resolution_proof_generator.py |
| `DERIV_FORM` | 2 | `DERIV_FORM\|y'(0)\|3C1 + 4C2` | second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = -2x^5 - 7x^3 + 3x^2 - x\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -3], [1, -1], [1, 1], [1, 3]]\|y = [2, 6, 12, 20]` | least_squares_generator.py |
...
| `DEV_ROW` | 3 | `DEV_ROW\|30\|3\|9` | standard_deviation_generator.py |
| `DFA_ACCEPT` | 1 | `DFA_ACCEPT\|q1` | dfa_minimization_generator.py, dfa_simulation_generator.py |
| `DFA_INPUT` | 1 | `DFA_INPUT\|0111` | dfa_simulation_generator.py |
...
| `DFT_SETUP` | 2 | `DFT_SETUP\|N=2\|x=[-4,-3]` | dft_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[11, 1], [-10, -1]]\|D = [[-7, 0], [0, -5]]\|P^-1 = [[1, 1], [-10, -11]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[0, 4, 8]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 4*x^2 + y^2 + 3*x*y - 6*x + 5*y\|point (1, 1)\|dx=2/5, dy=2/5` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|5*2/5 + 10*2/5\|6` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|1600\|0\|1600` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|18y + 20 = 20` | systems_substitution_generator.py |
...
| `DIST_SETUP` | 3 | `DIST_SETUP\|exponential\|target=P(X<t)\|e^(-lambda*t)=5/19` | named_distribution_generator.py |
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited A\|A=0, B=8, C=7, D=2, E=inf` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|3x^3 + 12x^2 - 12x` | multiplying_polynomials_generator.py |
...
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y\|-5 - 3\|-8` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|24y^5\|3y\|8y^4` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT K AND NOT L AND NOT M) OR (NOT K AND L AND NOT M) OR (NOT K AND L AND M) OR (K AND NOT L AND NOT M) OR (K AND NOT L AND M) OR (K AND L AND M)` | boolean_algebra_generator.py |
| `DOMAIN` | 2 | `DOMAIN\|x = −45..−35\|{−45, −44, −43, −42, −41, −40, −39, −38, −37, −36, −35}` | set_builder_roster_generator.py |
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|radicand ≥ 0\|x + 3 ≥ 0` | domain_range_generator.py |
...
| `DOPPLER_SETUP` | 3 | `DOPPLER_SETUP\|acoustic_toward\|f=343, v=60\|v_observer=14, v_source=19` | doppler_generator.py |
| `DOT` | 2, 3 | `DOT\|(22, 2) · (5/13, 12/13)\|22*5/13 + 2*12/13\|134/13` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
| `DOT4` | 4 | `DOT4\|gamma0gamma1\|(1,1)\|1*0 + 0*-1 + 0*0 + 0*0\|0` | gamma_matrix_generator.py |
| `DOT_FORMULA` | 1 | `DOT_FORMULA\|cos θ = (u·v)/(‖u‖ · ‖v‖)` | dot_product_generator.py |
| `DOUBLE_SETUP` | 2, 3 | `DOUBLE_SETUP\|integrand 6*x + 8*y + 1\|x:2..3\|y:3..5` | double_integral_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=3,v=9); 2:(w=1,v=8); 3:(w=1,v=4)` | dp_table_generator.py |
| `DP_ROW` | 2 | `DP_ROW\|i=0\|0, 1, 2, 3` | dp_table_generator.py |
| `DP_SETUP` | 2, 3 | `DP_SETUP\|edit distance\|source=ACC\|target=CCC` | dp_table_generator.py |
...
| `ECDSA_SETUP` | 4 | `ECDSA_SETUP\|E/F_17, G=(5,1), n=19\|d=8\|z=7\|k=2` | ecdsa_generator.py |
| `ECDSA_SIGN` | 2 | `ECDSA_SIGN\|s=k^-1(z+rd) mod n\|s=18` | ecdsa_generator.py |
| `ECDSA_VERIFY` | 2 | `ECDSA_VERIFY\|u1=12\|u2=13` | ecdsa_generator.py |
...
| `EC_PUBLIC` | 2 | `EC_PUBLIC\|A=(16,13)\|B=(16,13)` | ecdh_generator.py |
| `EC_SCALAR` | 2 | `EC_SCALAR\|a=6\|aG=(16,13)` | ecdh_generator.py, ecdsa_generator.py |
| `EC_SCALAR_SETUP` | 2 | `EC_SCALAR_SETUP\|k=4\|P=(2,7)` | elliptic_curve_finite_field_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|AC\|weight 6\|add C` | mst_generator.py |
...
| `EDGE_LIST` | 1 | `EDGE_LIST\|AC, AE, BC, BD, DE` | euler_circuit_generator.py |
...
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 5I\|[[0, -1, -1], [0, 6, 3], [0, 0, 5]]` | eigenvalue_generator.py |
| `EINSTEIN_SETUP` | 2, 3 | `EINSTEIN_SETUP\|contract\|A_ij=[[-1, 5], [-4, 4]]\|B_jk=[[4, -4], [1, 3]]` | einstein_summation_generator.py |
| `ELEC_FORMULA` | 1 | `ELEC_FORMULA\|left charge: E1=q1/r1^2` | electrostatics_generator.py |
| `ELEC_SETUP` | 2, 3 | `ELEC_SETUP\|field_axis\|q1=-5, x1=-1\|q2=-1, x2=6` | electrostatics_generator.py |
| `ELEMENT_ORDER` | 2 | `ELEMENT_ORDER\|5\|13` | cayley_table_generator.py |
...
| `EL_SOLVE` | 2 | `EL_SOLVE\|xddot\|-(53/10)*x` | lagrangian_generator.py |
| `EMBED_SETUP` | 1 | `EMBED_SETUP\|A=(5,12), B=(3,4), C=(4,-3)` | embedding_similarity_generator.py |
| `ENERGY_FORMULA` | 1 | `ENERGY_FORMULA\|mgh=1/2*m*v^2` | energy_conservation_generator.py |
| `ENERGY_LEVEL` | 2 | `ENERGY_LEVEL\|E_7=hbar*omega*(n+1/2)\|270` | ladder_operator_generator.py |
| `ENERGY_SETUP` | 3 | `ENERGY_SETUP\|gravity_drop\|m=16\|h=245, g=10` | energy_conservation_generator.py |
...
| `ENGINE_SETUP` | 3 | `ENGINE_SETUP\|engine_efficiency\|Qh=184\|Qc=177` | heat_engine_generator.py |
...
| `EQUILIBRIA` | 2 | `EQUILIBRIA\|f(y) = 0\|y=4, y=10` | stability_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(10, 5)\|(11, 7)` | equation_from_two_points_generator.py |
...
| `EQ_OP_NOTE` | 3 | `EQ_OP_NOTE\|add\|c\|to both sides` | equation_from_two_points_generator.py, literal_equation_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, standard_form_conversion_generator.py |
...
| `ESCAPE_CHECK` | 3 | `ESCAPE_CHECK\|n=1\|norm2=37/16\|bounded` | fractal_iteration_generator.py |
| `ESTIMATE` | 2 | `ESTIMATE\|72458 × 57640 ≈ 70000 × 60000\|4200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2.4 × 10^5\|240000\|rounded estimate` | fermi_estimation_generator.py, long_division_generator.py, multi_digit_multiplication_generator.py |
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|164\|84\|1\|80` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|A\|route suffix A\|stack A-C-B-D-E` | euler_circuit_generator.py |
| `EULER_CRITERION` | 2 | `EULER_CRITERION\|15^3 mod 7\|1` | quadratic_residue_generator.py |
...
| `EULER_ROUTE` | 2 | `EULER_ROUTE\|A-C-B-D-E-A\|uses 5 edges` | euler_circuit_generator.py |
...
| `EV_SETUP` | 2 | `EV_SETUP\|P(X=8) = 1/5; P(X=4) = 1/5; P(X=3) = 3/5\|Var(X)` | expected_value_generator.py |
...
| `EXPECTATION` | 3 | `EXPECTATION\|E[X]=44/47\|E[Y]=44/47\|E[XY]=1969/2209` | joint_distribution_generator.py |
...
| `EXP_CELL` | 2 | `EXP_CELL\|(150·180)/300\|90` | chi_square_generator.py |
...
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|164\|84` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `FACTOR` | 1, 2 | `FACTOR\|x^2 - 7x + 6\|(x - 1)(x - 6)` | polynomial_inequality_generator.py, second_order_ode_generator.py, transfer_function_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `FACTOR_FORM` | 2 | `FACTOR_FORM\|90\|2 * 3^2 * 5` | totient_generator.py |
| `FACTOR_FOUND` | 2 | `FACTOR_FOUND\|2\|1` | totient_generator.py |
| `FACTOR_GROUP` | 3 | `FACTOR_GROUP\|4y^2 - 8y\|4y\|(y - 2)` | conic_standard_form_generator.py, curve_analysis_generator.py, derivative_limit_def_generator.py, factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `FEATURE_MAP_SETUP` | 3 | `FEATURE_MAP_SETUP\|K(x,z)=(xz+2)^2\|phi(t)=(t^2,2t,2)\|x=-19,z=-20` | feature_map_generator.py |
...
| `FERMAT_SETUP` | 3 | `FERMAT_SETUP\|prime 37\|base 24\|exponent 121` | totient_generator.py |
...
| `FINITE_DIFF_SETUP` | 3 | `FINITE_DIFF_SETUP\|forward_derivative\|x0=5,h=4\|f0=1,f1=-35` | finite_difference_generator.py |
...
| `FIRSTLAW_SETUP` | 3 | `FIRSTLAW_SETUP\|isothermal\|W=60\|ideal gas` | first_law_generator.py |
| `FIXED_EQ` | 1 | `FIXED_EQ\|z=(az+b)/(cz+d)` | mobius_transform_generator.py |
| `FIXED_POINT` | 1 | `FIXED_POINT\|-5` | mobius_transform_generator.py |
| `FIXED_POINT_SETUP` | 3 | `FIXED_POINT_SETUP\|g(x)=-3/11*x-1\|x0=0\|iterations=4` | fixed_point_generator.py |
| `FIXED_POINT_UPDATE` | 3 | `FIXED_POINT_UPDATE\|1\|x_0=0\|x_1=-1` | fixed_point_generator.py |
| `FLAG` | 2 | `FLAG\|4\|81 ÷ 9 = 9, not 7` | error_spotting_generator.py |
| `FLOOR_DIV` | 3 | `FLOOR_DIV\|5\|2\|2` | algorithm_trace_generator.py |
| `FLOPS_SETUP` | 2 | `FLOPS_SETUP\|rule=2mnk\|m=32,d=512,h=512,o=64` | flops_memory_generator.py |
| `FLUX_SUM` | 2 | `FLUX_SUM\|(-2 + 1 - 1)*315\|-630` | vector_theorem_generator.py |
| `FOCUS` | 1 | `FOCUS\|(8, 3)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (-5) * (-2)\|10` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-9i) * (-2)\|18i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (-9i) * 7i\|-63i^2` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOURIER_SETUP` | 3 | `FOURIER_SETUP\|square\|A=4\|n=12` | fourier_series_generator.py |
| `FOUR_VECTOR_SETUP` | 3 | `FOUR_VECTOR_SETUP\|mass_shell\|c=1\|p=12, m=35` | four_vector_generator.py |
| `FRACTAL_SETUP` | 4 | `FRACTAL_SETUP\|julia\|z0=(1/2,0)\|c=(0,-3/2)\|N=6` | fractal_iteration_generator.py |
| `FRAC_BUILD` | 2 | `FRAC_BUILD\|144/360\|0.4` | conditional_probability_generator.py, geometric_probability_generator.py |
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|6/-21\|-2/7` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|43/40\|1.075` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|histogram — 60-69: 7, 70-79: 12, 80-89: 14, 90-99: 14, 100-109: 1\|cumulative count up to 90-99` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(f + g)(2)\|f(2) + g(2)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|x: -4, -3, 4, 5, 9; h(x): -7, 29, -1, -15, 11\|h(5)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
| `FUNDAMENTAL_FORM_SETUP` | 3 | `FUNDAMENTAL_FORM_SETUP\|cylinder\|R=2\|u in [0,2pi/3], v in [0,8]` | fundamental_form_generator.py |
| `GAME_SETUP` | 2 | `GAME_SETUP\|payoffs=(3,17;11,9)\|row player maximizes, column player minimizes` | game_theory_generator.py |
...
| `GAS_SETUP` | 3 | `GAS_SETUP\|combined_pressure\|P1=27, V1=11, T1=29\|V2=8, T2=17` | gas_law_generator.py |
...
| `GAUSSIAN_CURVATURE_SETUP` | 2, 3 | `GAUSSIAN_CURVATURE_SETUP\|sphere\|R=75` | gaussian_curvature_generator.py |
| `GAUSS_BONNET_SETUP` | 3 | `GAUSS_BONNET_SETUP\|flat_torus\|width=7, height=19\|chi=0` | gauss_bonnet_generator.py |
| `GAUSS_FORMULA` | 1 | `GAUSS_FORMULA\|E*(4πr^2)=Q` | gauss_law_generator.py |
| `GAUSS_SETUP` | 3 | `GAUSS_SETUP\|sphere\|Q=50\|r=3` | gauss_law_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|24, 21, 6\|3` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GD_SETUP` | 3 | `GD_SETUP\|f(x,y)=1/2*(5x^2+2y^2)\|start=(-7,-5)\|eta=1/11` | gradient_descent_generator.py |
| `GD_UPDATE` | 3 | `GD_UPDATE\|w_old=(3,3)\|eta=1/6\|w_new=(8/3,28/9)` | gradient_step_generator.py |
| `GELLMANN_IDENTITY` | 3 | `GELLMANN_IDENTITY\|Tr(lambda_6 lambda_4)\|2 delta_ab\|0` | pauli_algebra_generator.py |
| `GELLMANN_SETUP` | 3 | `GELLMANN_SETUP\|trace\|A=-4lambda_6\|B=lambda_4` | pauli_algebra_generator.py |
...
| `GEOM_SETUP` | 2 | `GEOM_SETUP\|p = 4/5, q = 1/5\|P(X > 5)` | geometric_distribution_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; the altitude splits the hypotenuse into p = 72 and q = 72\|altitude h` | geometric_mean_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^2]\|(1 + x)^8(1 + x)^7` | generating_function_generator.py |
...
| `GRADIENT_FORMULA` | 1 | `GRADIENT_FORMULA\|grad=(5x,2y)` | gradient_descent_generator.py, matrix_calculus_generator.py |
| `GRAD_ENTRY` | 2 | `GRAD_ENTRY\|g1\|24` | matrix_calculus_generator.py |
| `GRAD_RESULT` | 2 | `GRAD_RESULT\|grad g\|(1, 1)` | lagrange_multiplier_generator.py |
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = 5*x^2 + 3*y^2 + 2*x*y + 5*x\|point (0, 4)\|tangent` | gradient_generator.py |
...
| `GRASSMANN_RESULT` | 3 | `GRASSMANN_RESULT\|constant=56\|theta=65\|56 + 65theta` | grassmann_generator.py |
| `GRASSMANN_SETUP` | 3 | `GRASSMANN_SETUP\|multiply\|x=-8 - 7theta\|y=-7 - 2theta` | grassmann_generator.py |
| `GREAT_CIRCLE_SETUP` | 3 | `GREAT_CIRCLE_SETUP\|R=9\|A=(0,-30)\|B=(60,150)` | great_circle_generator.py |
| `GROUP` | 2 | `GROUP\|(4y^2 - 8y)\|(3y - 6)` | factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `HAMMING_RECEIVED` | 1 | `HAMMING_RECEIVED\|r=0001011` | hamming_code_generator.py |
| `HAMMING_SETUP` | 2 | `HAMMING_SETUP\|data=1111\|even parity` | hamming_code_generator.py |
| `HAM_EQ` | 2 | `HAM_EQ\|ydot=dH/dp_y\|ydot=p_y/20` | hamiltonian_generator.py |
| `HAM_SETUP` | 3 | `HAM_SETUP\|atwood\|m1=4, m2=16\|g=10, q=y, p=p_y` | hamiltonian_generator.py |
| `HARMONIC_SETUP` | 1 | `HARMONIC_SETUP\|u=-2x^2 + 2y^2 - 2x + 5y` | cauchy_riemann_generator.py |
| `HAWKING_SETUP` | 3 | `HAWKING_SETUP\|temperature\|T_H=hbar*c^3/(8π*G*M*k_B)\|hbar=7,c=4,G=6,M=15,k_B=10` | hawking_generator.py |
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|(-10)*2 - 4^2\|-36` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = -5*x^2 + y^2 + 4*x*y + 52*x - 10*y\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = -36\|f_xx = -10\|saddle point` | hessian_classify_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-2x^3 - 3x^2 + 3x - 2\|x = -4` | horner_evaluation_generator.py |
...
| `HUFFMAN_SETUP` | 1 | `HUFFMAN_SETUP\|A=1/16, B=1/4, C=1/4, D=1/16, E=1/16, F=1/4, G=1/16` | huffman_coding_generator.py |
| `HYDROGEN_FORMULA` | 1 | `HYDROGEN_FORMULA\|E_ion=R_E/n^2` | hydrogen_atom_generator.py |
| `HYDROGEN_SETUP` | 3 | `HYDROGEN_SETUP\|ionization_energy\|n=5\|R_E=9 eV` | hydrogen_atom_generator.py |
| `HYPERBOLIC_DISTANCE_SETUP` | 3 | `HYPERBOLIC_DISTANCE_SETUP\|half-plane\|P=(3,7)\|Q=(3,119/11)` | hyperbolic_distance_generator.py |
| `HYPERBOLIC_SETUP` | 2 | `HYPERBOLIC_SETUP\|e^x=32/19\|e^(-x)=19/32` | hyperbolic_function_generator.py |
...
| `ICE_ROW` | 2 | `ICE_ROW\|equilibrium\|[A]=1, [B]=4` | equilibrium_ice_generator.py |
| `IDENTIFY` | 2 | `IDENTIFY\|order does not matter\|use C(n, r)` | permutation_combination_generator.py |
| `IDENTITY` | 2 | `IDENTITY\|Vandermonde\|Σ C(7,i)C(18,25-i) = C(25,25)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=18, n(B)=32, n(C)=11\|n(AB)=10, n(AC)=4, n(BC)=3, n(ABC)=1` | inclusion_exclusion_generator.py |
| `IFACTOR` | 2 | `IFACTOR\|mu = e^(∫ 3 dx)\|e^(3x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `IG_SETUP` | 3 | `IG_SETUP\|parent pos=13, neg=3\|total=16\|splits=color,region` | information_gain_generator.py |
| `IMAGE` | 2 | `IMAGE\|T(-2)\|-1` | mobius_transform_generator.py |
...
| `IMPLICIT_SETUP` | 2 | `IMPLICIT_SETUP\|x^3 + y^3 = 16\|dy/dx` | implicit_diff_generator.py |
...
| `INDEP_CHECK` | 3 | `INDEP_CHECK\|P11=1969/2209\|product=1936/2209\|no` | joint_distribution_generator.py |
...
| `INDEX_SETUP` | 3 | `INDEX_SETUP\|c=4\|j=3, k=1\|l=1, m=1` | index_gymnastics_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|divide\|3\|-5/3 < x < 5/3` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INITIAL_COEFF` | 2 | `INITIAL_COEFF\|a_0\|6120` | series_solution_generator.py |
| `INITIAL_EQ` | 2 | `INITIAL_EQ\|C1 + C2\|0` | recurrence_generator.py |
| `INITIAL_SYSTEM` | 2 | `INITIAL_SYSTEM\|C1[2, 1] + C2[1, 0]\|[-2, -2]` | ode_system_generator.py |
| `INNER_ANTIDERIV` | 2 | `INNER_ANTIDERIV\|dy\|6*x*y + 4*y^2 + y` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_EVAL` | 2, 3 | `INNER_EVAL\|y=3..5\|12*x + 66` | double_integral_generator.py, triple_integral_generator.py |
...
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 1\|10, 12, 33, 11, 7` | algorithm_trace_generator.py |
...
| `INTEGRAL_SETUP` | 1 | `INTEGRAL_SETUP\|L = integral from 0 to 3pi/4 of 8 dtheta` | metric_arc_length_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ -12e^(3x) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `INTERFERENCE_SETUP` | 3 | `INTERFERENCE_SETUP\|thin_film\|m=4, lambda=11\|n=4/5` | interference_generator.py |
| `INTERP_SETUP` | 3 | `INTERP_SETUP\|lagrange\|points=(-5,-53), (-1,-9), (5,-3)\|x=2` | interpolation_generator.py |
| `INTERVAL_CLASS` | 2 | `INTERVAL_CLASS\|s2=-476\|spacelike` | minkowski_interval_generator.py |
...
| `IRR_SETUP` | 2 | `IRR_SETUP\|c0=-2000,c1=2400\|r0=1/5,iterations=2` | npv_irr_generator.py |
| `IRR_VALUE` | 2 | `IRR_VALUE\|f1\|0` | npv_irr_generator.py |
| `ITERATE` | 2 | `ITERATE\|n=1\|z=(1/4,-3/2)` | fractal_iteration_generator.py, gradient_descent_generator.py |
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 4x + 2 on [0, 3]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
| `I_CYCLE` | 2 | `I_CYCLE\|i^0\|1` | complex_number_ops_generator.py |
| `I_SQUARE` | 2 | `I_SQUARE\|-63i^2\|63` | complex_division_generator.py, complex_log_generator.py, complex_number_ops_generator.py |
| `JACOBIAN` | 2 | `JACOBIAN\|dA\|r dr dtheta` | double_integral_generator.py |
| `JACOBI_END` | 2 | `JACOBI_END\|gcd(9,105)>1\|0` | jacobi_symbol_generator.py |
| `JACOBI_RECIPROCITY` | 3 | `JACOBI_RECIPROCITY\|a mod 4 = 1\|n mod 4 = 1\|keep sign` | jacobi_symbol_generator.py |
| `JACOBI_SETUP` | 3 | `JACOBI_SETUP\|a=9\|n=105\|n odd` | jacobi_symbol_generator.py |
| `JACOBI_SWAP` | 3 | `JACOBI_SWAP\|a=105\|n=9\|sign 1` | jacobi_symbol_generator.py |
| `JACOBI_TWO_RULE` | 3 | `JACOBI_TWO_RULE\|n mod 8 = 1\|keep sign\|sign 1` | jacobi_symbol_generator.py |
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|(-1)*(-3) - (-4)*5\|23` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[-1, -4], [5, -3]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = -u - 4*v\|y = 5*u - 3*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
| `JOINT_SETUP` | 3 | `JOINT_SETUP\|X,Y in {0,1}\|p00=42/2209, p01=99/2209\|p10=99/2209, p11=1969/2209` | joint_distribution_generator.py |
...
| `KERNEL_SETUP` | 3 | `KERNEL_SETUP\|type=polynomial\|points=A=(-1,-3), B=(-3,-1)\|c=2,d=2` | kernel_evaluation_generator.py |
...
| `KL_SETUP` | 3 | `KL_SETUP\|P=[1/2,127/255,1/510]\|Q=[1/2,127/510,64/255]\|direction=P to Q` | kl_divergence_generator.py |
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|1001\|W AND NOT X AND NOT Y AND Z` | boolean_algebra_generator.py |
...
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|(W AND NOT X AND NOT Y AND Z) OR (W AND NOT X AND Y AND NOT Z) OR (W AND X AND NOT Y AND NOT Z) OR (W AND X AND Y AND Z)` | boolean_algebra_generator.py |
| `KMEANS_SETUP` | 2 | `KMEANS_SETUP\|points=P1=(4,-3), P2=(-2,3), P3=(5,-2), P4=(-1,-5)\|centroids=C1=(0,3), C2=(1,-5)` | kmeans_step_generator.py |
| `KNN_DISTANCE` | 3 | `KNN_DISTANCE\|P1\|label=A\|d2=17` | knn_generator.py |
| `KNN_NEIGHBORS` | 1 | `KNN_NEIGHBORS\|P5:10:A,P1:17:A,P2:26:B` | knn_generator.py |
| `KNN_SETUP` | 3 | `KNN_SETUP\|q=(0,3)\|k=3\|training=P1=(-4,4,A), P2=(1,-2,B), P3=(-2,-3,A), P4=(-3,-4,B), P5=(1,0,A)` | knn_generator.py |
| `KNN_SORT` | 1 | `KNN_SORT\|P5:10:A,P1:17:A,P2:26:B,P3:40:A,P4:58:B` | knn_generator.py |
...
| `KRAFT_CLASSIFY` | 2 | `KRAFT_CLASSIFY\|excess=3/16\|no prefix code` | kraft_inequality_generator.py |
| `KRAFT_FORMULA` | 1 | `KRAFT_FORMULA\|sum 2^-l_i` | huffman_coding_generator.py, kraft_inequality_generator.py |
| `KRAFT_SETUP` | 2 | `KRAFT_SETUP\|A=2, B=4, C=6, D=1, E=2, F=6, G=5, H=4\|binary prefix code` | kraft_inequality_generator.py |
| `KRAFT_TERM` | 3 | `KRAFT_TERM\|A\|l=2\|1/4` | kraft_inequality_generator.py |
| `KRR_SETUP` | 3 | `KRR_SETUP\|kernel=linear\|data=[(2,-5), (5,5)]\|lambda=1,x*=1` | kernel_ridge_generator.py |
...
| `LADDER_SETUP` | 3 | `LADDER_SETUP\|commutator_energy\|state=ket7\|hbar=12, omega=3` | ladder_operator_generator.py |
...
| `LAG_SETUP` | 3 | `LAG_SETUP\|mass_spring\|m=10, k=53\|q=x` | lagrangian_generator.py |
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|((lambda f. (lambda q. (q (lambda e. e)))) (q q))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LAURENT_SETUP` | 3 | `LAURENT_SETUP\|center a=-4\|w=(z+4)\|f=(3 - 2(z+4) + 4(z+4)^2 + 3(z+4)^3 - 6(z+4)^4 + 2(z+4)^5)/(z+4)^2` | laurent_series_generator.py |
...
| `LAYERNORM_SETUP` | 3 | `LAYERNORM_SETUP\|x=(0,2)\|gamma=(3,4)\|beta=(-4,-1)` | layer_norm_generator.py |
...
| `LEGENDRE_SETUP` | 2 | `LEGENDRE_SETUP\|a=15\|p=7` | legendre_construction_generator.py, quadratic_residue_generator.py |
| `LIE_EXP_FORM` | 2 | `LIE_EXP_FORM\|e^(theta J)\|cos(theta)I + sin(theta)J` | lie_exponential_generator.py |
| `LIE_EXP_SETUP` | 4 | `LIE_EXP_SETUP\|SO3\|axis=x\|theta=90 deg\|K=[[0, 0, 0], [0, 0, -1], [0, 1, 0]]` | lie_exponential_generator.py |
| `LIMITING_REAGENT` | 2 | `LIMITING_REAGENT\|CO\|CO2=21 mol` | stoichiometry_generator.py |
| `LIMIT_CHECK` | 2 | `LIMIT_CHECK\|CO2 from CO=21 mol\|CO2 from O2=40 mol` | stoichiometry_generator.py |
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→∞ of (-2x + 4)/(4x^2 - 5x + 3)\|compare degrees` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
| `LINEAR_SYSTEM` | 2 | `LINEAR_SYSTEM\|a=8/9, b=-1/3\|c=-1/5, d=4/5` | markov_chain_generator.py |
| `LINE_EQ` | 1 | `LINE_EQ\|14x + 8y - 21 = 0` | complex_locus_generator.py |
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|18/2 - 9\|0` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = -3x + 10\|(-8, -6)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <6*x - 3*y - 1, 2*y - 3*x + 4>\|from (-1, 1) to (-4, 2)` | line_integral_generator.py |
| `LLL_DONE` | 1 | `LLL_DONE\|[(3,-12),(-16,-2)]` | lll_reduction_generator.py |
| `LLL_SETUP` | 1 | `LLL_SETUP\|[(3,-12),(-13,-14)]` | lll_reduction_generator.py |
| `LOCUS_SETUP` | 3 | `LOCUS_SETUP\|z=x+iy\|center=(-5,6)\|radius=7` | complex_locus_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(3x)) = ln(15)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_EVAL` | 2 | `LOG_EVAL\|17/11\|ln(17/11)` | hyperbolic_distance_generator.py |
| `LOG_EXACT` | 2 | `LOG_EXACT\|log_10(10000000)\|7` | master_theorem_generator.py |
...
| `LOG_PRODUCT` | 1, 2 | `LOG_PRODUCT\|log_2(4x)\|log_2(4) + log_2(x)` | log_equation_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_5(x^3/y^4)\|log_5(x^3) - log_5(y^4)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|log_5(x^3/y^4)\|expand` | complex_log_generator.py, log_properties_generator.py |
...
| `LOG_TERM` | 3 | `LOG_TERM\|9\|ln(9)\|9*ln(9)` | entropy_change_generator.py |
| `LOOKUP_SUPPLIED` | 2 | `LOOKUP_SUPPLIED\|e^(-lambda*t)\|5/19` | named_distribution_generator.py |
| `LORA_COUNT` | 2 | `LORA_COUNT\|r*(d_in+d_out)\|64480` | param_count_generator.py |
| `LOWRANK_SETUP` | 2 | `LOWRANK_SETUP\|A=[[7,0], [0,18]]\|rank=1` | low_rank_approx_generator.py |
| `LP_CORNER_SETUP` | 3 | `LP_CORNER_SETUP\|max z=8x+12y\|0<=x<=20, 0<=y<=4\|x+y<=23` | lp_corner_generator.py |
...
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-3, 2), (-1, 6), (1, 12), (3, 20)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[3, -2, 5], [12, -3, 15], [-12, 13, -29]]\|unit lower L` | lu_decomposition_generator.py |
...
| `LZ_SETUP` | 2 | `LZ_SETUP\|LZ78\|yyyyyryy` | lz_compression_generator.py |
...
| `MAG_SETUP` | 3 | `MAG_SETUP\|straight_wire\|I=10, r=8\|mu0=1` | magnetism_generator.py |
...
| `MARKOV_SETUP` | 2, 3 | `MARKOV_SETUP\|two_state\|P00=2/3, P01=1/3\|P10=1/2, P11=1/2` | entropy_rate_markov_generator.py, markov_chain_generator.py |
...
| `MATRIX_GROUP_SETUP` | 2 | `MATRIX_GROUP_SETUP\|SL2Z\|M=[[-6,-4],[11,-11]]` | matrix_group_check_generator.py |
| `MATRIX_MULT` | 2, 3 | `MATRIX_MULT\|row1 dot col1\|7738544961/11657304961*7738544961/11657304961+5506859400/11657304961*5506859400/11657304961\|7738544961/11657304961` | projector_generator.py |
| `MATRIX_POWER` | 2 | `MATRIX_POWER\|K^2\|[[0, 0, 0], [0, -1, 0], [0, 0, -1]]` | lie_exponential_generator.py |
| `MATRIX_PRODUCT` | 2 | `MATRIX_PRODUCT\|AB\|[[0, -11i/2], [-11i/2, 0]]` | bch_generator.py, casimir_generator.py, gamma_matrix_generator.py, pauli_algebra_generator.py, structure_constant_generator.py |
| `MATRIX_ROW` | 2 | `MATRIX_ROW\|row 1\|0, 0, 0, 1` | graph_counting_generator.py |
| `MATRIX_SCALE` | 2 | `MATRIX_SCALE\|1/2 ladder sum\|[[384/25, 0, 0, 0], [0, 896/25, 0, 0], [0, 0, 896/25, 0], [0, 0, 0, 384/25]]` | bch_generator.py, casimir_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[-3, 0], [-5, -1]]\|-2A` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
| `MAX` | 2, 3 | `MAX\|2, 4\|4` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
| `MAXTERM` | 2 | `MAXTERM\|010\|Q OR NOT R OR S` | boolean_algebra_generator.py |
| `MC_SETUP` | 3 | `MC_SETUP\|expression=x^T A x\|A=[[4,4], [4,-2]]\|x=(5,-2)` | matrix_calculus_generator.py |
...
| `MEMORY_SETUP` | 3 | `MEMORY_SETUP\|kv_cache\|L=8,h=16,d_k=32\|seq=2048,precision_bytes=1` | flops_memory_generator.py |
| `MEMORY_UNIT` | 2 | `MEMORY_UNIT\|MiB\|16` | flops_memory_generator.py |
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=0,mid=1,hi=2\|left 39; right 40` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|39\|40\|take left` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 0-1\|array 39, 40, 27, 28, 15` | algorithm_trace_generator.py |
| `MERGE_TAKE` | 2 | `MERGE_TAKE\|39\|merged 39` | algorithm_trace_generator.py |
| `METRIC` | 2 | `METRIC\|Chebyshev circle\|all points with max(abs(x), abs(y)) = 4` | taxicab_geometry_generator.py |
| `METRICS_SETUP` | 1 | `METRICS_SETUP\|TP=15, FP=11, FN=15, TN=7` | classifier_metrics_generator.py |
| `METRIC_ARC_SETUP` | 3 | `METRIC_ARC_SETUP\|polar metric\|ds^2=dr^2+r^2 dtheta^2\|r=8, theta:0->3pi/4` | metric_arc_length_generator.py |
...
| `MGF_SETUP` | 3 | `MGF_SETUP\|P(X=0)=19/32\|P(X=1)=1/16\|P(X=2)=11/32` | mgf_generator.py |
| `MGF_TERM` | 3 | `MGF_TERM\|x=0\|p0*e^(0t)\|19/32` | mgf_generator.py |
...
| `MINTERM` | 2 | `MINTERM\|000\|NOT K AND NOT L AND NOT M` | boolean_algebra_generator.py |
...
| `MOBIUS_SETUP` | 2 | `MOBIUS_SETUP\|T(z)=(-5)/(z + 6)\|fixed points` | mobius_transform_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 944 · (1/2)^(20/5)` | exponential_model_generator.py |
...
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 3\|exponent 31\|modulus 13` | mod_exp_generator.py |
...
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|7 mod 5\|3` | crt_generator.py, ecdsa_generator.py, elliptic_curve_finite_field_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|-2\|mod 5\|3` | modular_inverse_generator.py, rsa_generator.py |
| `MOD_POWER` | 3 | `MOD_POWER\|24^13\|mod 37\|18` | diffie_hellman_generator.py, pollard_factorization_generator.py, primality_test_generator.py, rsa_generator.py, tonelli_shanks_generator.py, totient_generator.py |
...
| `MOM_SETUP` | 3 | `MOM_SETUP\|poisson\|parameter=lambda\|data=[5,9,6,3,5,0,1,8]` | method_of_moments_generator.py |
...
| `MONO_SETUP` | 1 | `MONO_SETUP\|(9x^5) / (-9x^3)` | monomial_mult_div_generator.py |
...
| `MR_DECOMPOSE` | 2 | `MR_DECOMPOSE\|90\|2^1 * 45` | primality_test_generator.py |
| `MR_SETUP` | 2 | `MR_SETUP\|n=91\|witnesses 5, 19` | primality_test_generator.py |
...
| `MSE_GRADIENT` | 2 | `MSE_GRADIENT\|g0=2\|g1=-2/3` | gradient_step_generator.py |
| `MSE_SAMPLE` | 3 | `MSE_SAMPLE\|i=1\|pred=0\|r=0` | gradient_step_generator.py |
| `MSE_SETUP` | 3 | `MSE_SETUP\|model y_hat=w0+w1*x\|samples=[(-1,0), (-2,-5), (3,11)]\|w=(3,3), eta=1/6` | gradient_step_generator.py |
...
| `MU` | 2 | `MU\|43/51\|round=1` | lll_reduction_generator.py |
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(3x)y' + 3e^(3x)y\|15e^(3x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `MULTIVALUED_LOG` | 2 | `MULTIVALUED_LOG\|ln(295) + i*(5pi/6 + 2pi*k)\|k in Z` | complex_log_generator.py |
| `MULTI_FORMULA` | 2 | `MULTI_FORMULA\|n!/(a!b!c!...)\|9! / repeats` | stars_and_bars_generator.py |
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|3 Q's, 3 T's, 3 L's\|total 9` | stars_and_bars_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 - x - 6 on [0, 4]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 5*x^2 + 5*y^2 - 2*x*y + 4*x + 6*y\|x = -s - t, y = -3*s + t + 5\|(s,t) = (1, -1)` | multivar_chain_rule_generator.py |
| `NATURAL_SETUP` | 3 | `NATURAL_SETUP\|mass\|hbar=1,c=1\|m=61/12 GeV` | natural_units_generator.py |
| `NB_FEATURE_COUNT` | 3 | `NB_FEATURE_COUNT\|Spam\|money=1\|count=12` | naive_bayes_generator.py |
| `NB_LIKELIHOOD` | 3 | `NB_LIKELIHOOD\|Spam\|money=1\|13/22` | naive_bayes_generator.py |
| `NB_PRIOR` | 2 | `NB_PRIOR\|Spam\|20/31` | naive_bayes_generator.py |
| `NB_SCORE` | 2 | `NB_SCORE\|Spam\|start=20/31` | naive_bayes_generator.py |
| `NB_SETUP` | 3 | `NB_SETUP\|query=money=1, link=1, known=1\|alpha=1\|classes=Spam,Ham` | naive_bayes_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 26.60\|line 4 answers $159.60` | fill_in_step_generator.py |
| `NEG_LOG` | 2 | `NEG_LOG\|p=1/32\|ln(32)` | perplexity_generator.py |
| `NET_SETUP` | 2 | `NET_SETUP\|2 right triangles with legs 3 and 4; rectangles 3 by 3, 4 by 3, and 5 by 3\|total surface area` | nets_surface_area_generator.py |
| `NEWTON_DD` | 2 | `NEWTON_DD\|f[x0,x1]\|-7` | interpolation_generator.py |
| `NEWTON_SETUP` | 2, 3 | `NEWTON_SETUP\|f(x)=x^2-40\|f'(x)=2x\|x0=7,iterations=3` | newton_raphson_generator.py, newtons_laws_generator.py |
| `NEWTON_STEP` | 2 | `NEWTON_STEP\|1\|1/5` | npv_irr_generator.py |
| `NEWTON_UPDATE` | 3 | `NEWTON_UPDATE\|1\|x_0=7\|x_1=89/14` | newton_raphson_generator.py |
...
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|s0\|{s4}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|aabaab` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{s0}\|a\|s0->{s0,s2}\|{s0,s2}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|a` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states s0, s2, s7\|alphabet a, b\|start s0` | nfa_simulation_generator.py |
| `NFA_TRANSITION` | 3 | `NFA_TRANSITION\|s0\|a\|{s0,s2}` | nfa_simulation_generator.py |
...
| `NORMALIZE_SIGN` | 2 | `NORMALIZE_SIGN\|(-3,-6)\|(3,6)` | lll_reduction_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|A: 166 in N(119, 20)\|compare relative standing` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
| `NORM_SQUARED` | 2 | `NORM_SQUARED\|q\|1` | quaternion_generator.py |
| `NO_REDEX` | 2 | `NO_REDEX\|lambda q. (q (lambda e. e))\|no beta redex remains` | lambda_reduction_generator.py |
| `NPV_SETUP` | 2 | `NPV_SETUP\|c0=-1300,c1=1950,c2=100,c3=1200\|rate=10%` | npv_irr_generator.py |
| `NPV_TERM` | 2 | `NPV_TERM\|t=0\|-1300` | npv_irr_generator.py |
...
| `NW_ALLOC` | 1, 3 | `NW_ALLOC\|cell x11\|min(20,19)\|19` | transportation_generator.py |
...
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dx = y^2, y(0) = 73\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `OPTICS_FORMULA` | 1 | `OPTICS_FORMULA\|1/f=1/d_o+1/d_i` | optics_generator.py |
| `OPTICS_SETUP` | 3 | `OPTICS_SETUP\|thin_lens\|f=23\|d_o=43` | optics_generator.py |
| `OPT_SETUP` | 2 | `OPT_SETUP\|x + y = 1173, x, y > 0\|maximize P = x·y^2` | optimization_generator.py |
| `ORBIT_FORMULA` | 1 | `ORBIT_FORMULA\|F=G*m1*m2/r^2` | orbital_mechanics_generator.py |
| `ORBIT_SETUP` | 3 | `ORBIT_SETUP\|gravity_force\|m1=66, m2=43\|r=18, G=1` | orbital_mechanics_generator.py |
| `ORDER_PDF` | 1 | `ORDER_PDF\|f_{2:8}(x)=56*x*(1-x)^6` | order_statistics_generator.py |
| `ORDER_SETUP` | 3 | `ORDER_SETUP\|n=8\|k=2\|q=1/5` | order_statistics_generator.py |
...
| `OR_SETUP` | 3 | `OR_SETUP\|M/M/1\|lambda=7\|mu=18` | or_formula_generator.py |
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|6*x^2 + 66*x` | double_integral_generator.py |
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|x=2..3\|6*(3^2 - 2^2) + 66*(3 - 2)\|96` | double_integral_generator.py |
| `OUTER_PRODUCT` | 1 | `OUTER_PRODUCT\|rho=1/2(ket00bra00+e^(-i55π/141)ket00bra10+e^(i55π/141)ket10bra00+ket10bra10)` | partial_trace_generator.py |
...
| `PARAMS` | 3 | `PARAMS\|W1=[[-2,-2], [0,1]]\|b1=(0,-2)\|v=(2,2), c=0` | backprop_generator.py |
| `PARAM_PART` | 2 | `PARAM_PART\|full_matrix\|1038336` | param_count_generator.py |
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(-5*t + 3, -2*t + 3)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 7t - 7, y = -11t - 14\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(-x - 6)/(x + 2)^2 = A/(x + 2) + B/(x + 2)^2` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|2/(s + 5) - 4/(s - 4)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|6*x^2*y^3 + 10*x*y^2` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|2*x^3*y^3\|d/dx\|6*x^2*y^3` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 2*x^3*y^3 + 5*x^2*y^2\|f_x` | partial_derivative_generator.py |
...
| `PARTICULAR_CHECK` | 2 | `PARTICULAR_CHECK\|K = 3\|-2K + 8K - 15 = K` | recurrence_generator.py |
...
| `PARTITION_SETUP` | 3 | `PARTITION_SETUP\|two_level\|g0=1, g1=1\|epsilon=17, b=1/5` | partition_function_generator.py |
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = -184x, dv = e^(-x) dx\|du = -184 dx, v = -e^(-x)` | integration_by_parts_generator.py |
...
| `PASCAL_SETUP` | 1 | `PASCAL_SETUP\|18C2` | pascal_triangle_generator.py |
| `PATH_DERIV` | 2 | `PATH_DERIV\|r'(t)\|(-5, -2)` | curve_geometry_generator.py, line_integral_generator.py |
| `PAULI_IDENTITY` | 3 | `PAULI_IDENTITY\|sigma_z sigma_z\|delta_ij I\|16I` | pauli_algebra_generator.py |
| `PAULI_MATRIX` | 2 | `PAULI_MATRIX\|sigma_x\|[[0,1],[1,0]]` | spin_half_generator.py |
| `PAULI_SETUP` | 3 | `PAULI_SETUP\|product\|A=-4sigma_z\|B=-4sigma_z` | pauli_algebra_generator.py |
| `PCA_SETUP` | 2 | `PCA_SETUP\|points=[(8,-5), (-4,-5), (2,-4), (2,-6)]\|population covariance` | pca_generator.py |
...
| `PDE_SETUP` | 2 | `PDE_SETUP\|u_t = 1u_xx on [0,12]\|u(x,0)=18sin(8πx/12)` | separable_pde_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|1.58\|1420\|2243.6` | percent_problem_generator.py |
...
| `PERCEPTRON_SETUP` | 3 | `PERCEPTRON_SETUP\|eta=1\|w=(2,0,0)\|samples=[(2,-2,-1), (3,-3,-1), (2,0,-1), (1,3,1)]` | perceptron_generator.py |
...
| `PERM_RESULT` | 1 | `PERM_RESULT\|[2, 4, 1, 3]` | permutation_group_generator.py |
| `PERM_SETUP` | 2, 3 | `PERM_SETUP\|P(10, 2)\|n!/(n-r)!` | permutation_combination_generator.py, permutation_group_generator.py |
...
| `PE_SETUP` | 3 | `PE_SETUP\|position=72\|d=2\|theta=pi` | positional_encoding_generator.py |
...
| `PH_SETUP` | 2, 3 | `PH_SETUP\|hydronium_with_log\|[H+]=3*10^-12\|log10(3)=0.48` | ph_calculation_generator.py |
| `PI2_NUM` | 3 | `PI2_NUM\|-1/1536\|π^2\|-π^2/1536` | casimir_force_generator.py |
...
| `PI_COEFF` | 2 | `PI_COEFF\|9π/8\|9/8` | arc_sector_generator.py |
| `PI_DEN` | 3 | `PI_DEN\|14/225\|π\|14/(225π)` | gauss_law_generator.py, hawking_generator.py, magnetism_generator.py |
...
| `PLANCK_SETUP` | 4 | `PLANCK_SETUP\|length\|hbar=100\|G=100\|c=4` | planck_units_generator.py |
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|y = ±√402\|y = √402 or y = -√402` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|120*2/8\|30` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y - 5 = 2(x - 10)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|(x, y) = (897, 540)\|polar (r ≥ 0, 0° ≤ θ < 360°)` | parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `POLLARD_FACTOR` | 2 | `POLLARD_FACTOR\|29\|17` | pollard_factorization_generator.py |
| `POLLARD_PM1_SETUP` | 3 | `POLLARD_PM1_SETUP\|n=589\|base=5\|B=4` | pollard_factorization_generator.py |
| `POLLARD_RHO_SETUP` | 3 | `POLLARD_RHO_SETUP\|n=493\|c=2\|x0=5` | pollard_factorization_generator.py |
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|2y^3 + 4y^2 - 15y + 2\|y + 4` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|9x^2 + 10` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(-12x^5 + 4x^4 - 4x^3 - 16x^3) / (4x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-12x^5) / (4x^3) + (4x^4) / (4x^3) + (-4x^3) / (4x^3) + (-16x^3) / (4x^3)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(9x^2) + (2x -2x) + (2 +8)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|x^2 + x + 1` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x + 2)(x^2 + 4x - 4)` | multiplying_polynomials_generator.py |
...
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(9x^2 + 2x + 2) - (2x - 8)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(2y^3 + 4y^2) - (2y^3 + 8y^2)\|-4y^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
| `PORT_FORMULA` | 2 | `PORT_FORMULA\|E=wA*rA+wB*rB\|Var=wA^2*varA+wB^2*varB+2*wA*wB*cov` | portfolio_generator.py |
| `PORT_RESULT` | 2 | `PORT_RESULT\|expected_return=0.11\|variance=0.038125` | portfolio_generator.py |
| `PORT_SETUP` | 3 | `PORT_SETUP\|wA=0.5,wB=0.5\|rA=15%,rB=7%\|varA=0.0625,varB=0.04,cov=0.025` | portfolio_generator.py |
...
| `POTENTIAL_BUILD` | 3 | `POTENTIAL_BUILD\|integrate P dx\|3*x^2 - 3*x*y - x + g(y)\|g'(y) remains` | exact_ode_generator.py, line_integral_generator.py |
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|3*x^2 + y^2 - 3*x*y - x + 4*y` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(2/3)^3\|8/27` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|343*3 + (-1458)\|-429` | diagonalization_generator.py |
...
| `POWER_REDUCE` | 2 | `POWER_REDUCE\|24^121\|24^13 mod 37` | totient_generator.py |
...
| `POWER_SETUP` | 2 | `POWER_SETUP\|cis(218 deg)^(-2i)\|principal logarithm` | complex_log_generator.py |
...
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited A\|AC=6, AD=8, AB=11` | mst_generator.py |
| `PRIM_START` | 1 | `PRIM_START\|A` | mst_generator.py |
| `PRINCIPAL_LOG` | 1 | `PRINCIPAL_LOG\|ln(295) + i*5pi/6` | complex_log_generator.py |
...
| `PROJECTILE_SETUP` | 3 | `PROJECTILE_SETUP\|vx=57\|vy=21\|g=10` | projectile_motion_generator.py |
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[1, 7, 13, 19]` | least_squares_generator.py, legendre_construction_generator.py |
| `PROJECTOR_SETUP` | 2 | `PROJECTOR_SETUP\|v=(87969/107969, 62600/107969)\|P=vv^T=[[7738544961/11657304961,5506859400/11657304961],[5506859400/11657304961,3918760000/11657304961]]` | projector_generator.py |
...
| `PSD_SETUP` | 2 | `PSD_SETUP\|K=[[3,-3], [-3,6]]\|criterion=all principal minors >= 0` | kernel_validity_generator.py |
...
| `Q1` | 4 | `Q1\|40\|40\|40\|2` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|40\|40\|40\|0` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QN_ADD` | 4 | `QN_ADD\|Q\|left\|0 + e-(-1)\|-1` | conservation_law_generator.py |
| `QR_ENTRY` | 2 | `QR_ENTRY\|q1\|[3/5, 4/5]` | qr_decomposition_generator.py |
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[12, -7], [16, -1]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|340°\|quadrant IV` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
...
| `QUANTUM_SETUP` | 2, 3 | `QUANTUM_SETUP\|gate=Y\|input=e^(i188π/103)·ket0` | quantum_formula_generator.py, quantum_gate_generator.py |
| `QUANT_SETUP` | 3 | `QUANT_SETUP\|x=(13/100,97/100,107/100)\|scale=1/25\|zero_point=8` | quantization_generator.py |
| `QUANT_VALUE` | 2 | `QUANT_VALUE\|1\|11` | quantization_generator.py |
| `QUARK_CHARGE` | 2 | `QUARK_CHARGE\|c\|2/3` | quark_composition_generator.py |
| `QUARK_SETUP` | 3 | `QUARK_SETUP\|baryon,count=307\|c u s\|u=2/3,d=-1/3,s=-1/3,c=2/3,b=-1/3; anti=-charge` | quark_composition_generator.py |
| `QUARTILE` | 3 | `QUARTILE\|Q1\|11,11,15,19,21,23,25\|19` | five_number_summary_generator.py |
...
| `QUAT_RESULT` | 2 | `QUAT_RESULT\|q*v\|(-1,-1,0,2)` | quaternion_generator.py |
| `QUAT_SETUP` | 2 | `QUAT_SETUP\|q=(0,0,1,0)\|v=(0,-2,1,-1)` | quaternion_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|circle: dr/dt = 13 ft/s; r = 20 ft\|dA/dt` | related_rates_generator.py |
| `RATIO` | 2, 3 | `RATIO\|3*y = 3*x\|y = x` | lagrange_multiplier_generator.py, simplex_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|(18 - √173)/(18 - √173)` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 483 / 0.2` | percent_problem_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = -2 a_(n-1) + 8 a_(n-2)\|a_0 = 0, a_1 = -6` | master_theorem_generator.py, recurrence_generator.py |
| `REDUCED_DENSITY` | 1 | `REDUCED_DENSITY\|rho_A=[[1/2,e^(-i55π/141)/2],[e^(i55π/141)/2,1/2]]` | partial_trace_generator.py |
| `REFLEXIVE_CHECK` | 2 | `REFLEXIVE_CHECK\|(1, 1)\|missing` | relation_check_generator.py |
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q77937_1` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|a*b\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q77937_0\|still reading a*` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q77937_0\|a\|q77937_0` | regex_to_automaton_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 64), (2, 65), (3, 67), (4, 66), (5, 68)\|least-squares line` | regression_generator.py |
...
| `REL_ENERGY_SETUP` | 3 | `REL_ENERGY_SETUP\|rest_energy\|m=57\|c=22` | relativistic_energy_generator.py |
| `REL_FORMULA` | 1 | `REL_FORMULA\|ct_prime=gamma*(ct-beta*x), x_prime=gamma*(x-beta*ct)` | special_relativity_generator.py |
| `REL_SETUP` | 2, 3 | `REL_SETUP\|A = {1, 2, 3}\|R = {}` | relation_check_generator.py, special_relativity_generator.py |
...
| `RESIDUE_SETUP` | 2 | `RESIDUE_SETUP\|a=-5\|f=(3 - 5(z+5) + 2(z+5)^2 + 2(z+5)^3 - 3(z+5)^4)/(z+5)^3` | residue_generator.py |
| `RESIDUE_SUM` | 1 | `RESIDUE_SUM\|1` | contour_integral_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (1, 55), line ŷ = 57.4 + 1.2x\|residual = observed − predicted` | regression_generator.py |
| `RESOLVE` | 3 | `RESOLVE\|C1\|C2\|P31058` | resolution_proof_generator.py |
| `RES_EMPTY` | 1 | `RES_EMPTY\|C7` | resolution_proof_generator.py |
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(P87511 OR P31058), C2=(not P31058), C3=(not P87511), C4=(P43826)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C2\|(P87511)` | resolution_proof_generator.py |
...
| `RG_SETUP` | 3 | `RG_SETUP\|one_loop\|alpha0=3/31\|beta=1,L=2/5` | running_coupling_generator.py |
| `RHO_ITER` | 4 | `RHO_ITER\|1\|x=27, y=238\|abs(r)=211\|gcd=1` | pollard_factorization_generator.py |
...
| `RIEMANN_SETUP` | 2, 3 | `RIEMANN_SETUP\|f(x) = x^2 + 3 on [0, 4], n = 4\|trapezoid rule` | riemann_sum_generator.py, riemann_tensor_generator.py |
| `RK_COMBINE` | 2 | `RK_COMBINE\|k1+2k2+2k3+k4\|54/5` | runge_kutta_generator.py |
| `RK_STAGE` | 3 | `RK_STAGE\|k1\|t=5/2\|Q=7` | runge_kutta_generator.py |
...
| `ROT_SETUP` | 3 | `ROT_SETUP\|angular_momentum\|I1=4, omega1=30\|I2=13` | rotational_dynamics_generator.py |
| `ROUND` | 2 | `ROUND\|45/4\|11` | quantization_generator.py |
...
| `ROUTH_SETUP` | 1 | `ROUTH_SETUP\|p(s)=s^3+16s^2+30s+33` | routh_hurwitz_generator.py |
| `ROW_ENTROPY` | 2 | `ROW_ENTROPY\|H0\|649/800` | entropy_rate_markov_generator.py |
| `ROW_OP` | 1, 2 | `ROW_OP\|R2 → R2 + 2·R1\|[0, 1, 3, 4]` | row_reduction_generator.py, simplex_generator.py, subspace_basis_generator.py |
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, -2, -4], [0, 1, 2, -2], [0, 0, 0, 0]]` | subspace_basis_generator.py |
| `RSA_DECRYPT` | 2 | `RSA_DECRYPT\|116\|117` | rsa_generator.py |
| `RSA_ENCRYPT` | 2 | `RSA_ENCRYPT\|117\|116` | rsa_generator.py |
| `RSA_PRIVATE_KEY` | 1 | `RSA_PRIVATE_KEY\|d=103` | rsa_generator.py |
| `RSA_PUBLIC_KEY` | 2 | `RSA_PUBLIC_KEY\|n=209\|e=7` | rsa_generator.py |
| `RSA_SETUP` | 3 | `RSA_SETUP\|p=11\|q=19\|message=117` | rsa_generator.py |
| `RSQ_FORMULA` | 1 | `RSQ_FORMULA\|r^2 = Sxy^2/(Sxx·Syy)` | regression_generator.py |
| `RS_CORRECT` | 2 | `RS_CORRECT\|position=3\|[56,47,63,40]` | reed_solomon_generator.py |
| `RS_EVAL` | 2 | `RS_EVAL\|x=33\|98` | reed_solomon_generator.py |
| `RS_LINE` | 3 | `RS_LINE\|m0=68\|m1=124\|agree=3` | reed_solomon_generator.py |
| `RS_PAIR` | 2 | `RS_PAIR\|x=4,7\|y=56,47` | reed_solomon_generator.py |
| `RS_RECEIVED` | 1 | `RS_RECEIVED\|[56,47,73,40]` | reed_solomon_generator.py |
| `RS_SETUP` | 3 | `RS_SETUP\|F_167\|m(x)=47+123x\|points 33,40,82,154` | reed_solomon_generator.py |
...
| `SAMPLE_MOMENT` | 2 | `SAMPLE_MOMENT\|xbar\|37/8` | method_of_moments_generator.py |
...
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x8 = 21\|xi >= 1` | stars_and_bars_generator.py |
...
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = -7\|49*3\|147` | diagonalization_generator.py |
...
| `SCALING_COMPUTE` | 2 | `SCALING_COMPUTE\|6ND\|18096000000000000000` | scaling_law_generator.py |
| `SCALING_SETUP` | 3 | `SCALING_SETUP\|N=52000000\|D=58000000000\|F=89000000000000000` | scaling_law_generator.py |
| `SCAN` | 2 | `SCAN\|(\|parenthesis depth 1` | wff_parsing_generator.py |
| `SCHWARZSCHILD_SETUP` | 3, 4 | `SCHWARZSCHILD_SETUP\|radius\|G=1\|M=16\|c=2` | schwarzschild_generator.py |
...
| `SCORE_EQ` | 1 | `SCORE_EQ\|0-6*mu=0` | mle_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(-6, 7), B(-30, 25); ratio 2:4 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_11 = 7 + (11 - 1)·7` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|7, 14, 21, 28, ...\|sum of first 11 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ 1/n^(29/7), n ≥ 1\|converge or diverge?` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
| `SERIES_TERM` | 3 | `SERIES_TERM\|n=0\|1\|1` | grassmann_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|percent_dec = 1554 / 1295` | percent_problem_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y8 = 13` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
| `SHM_FORMULA` | 1 | `SHM_FORMULA\|omega^2=k/m` | shm_generator.py |
| `SHM_SETUP` | 3 | `SHM_SETUP\|mass_spring_energy\|m=11, k=396\|A=6, x=5` | shm_generator.py |
| `SHORTEST` | 2 | `SHORTEST\|(3,-12)\|norm^2=153` | lll_reduction_generator.py |
| `SIGFIG_ROUND` | 3 | `SIGFIG_ROUND\|240000\|2 significant figures\|2.4 × 10^5` | fermi_estimation_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|960 + 1215 + 1500` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=8)^(10) 15k^2\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=8\|15(8)^2\|960` | sigma_notation_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, 4)\|y = 3\|f(y) = -7 (negative)\|down` | stability_generator.py |
...
| `SIMPLEX_SETUP` | 3 | `SIMPLEX_SETUP\|max z=5x+3y\|x<=11\|y<=10` | simplex_generator.py |
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; AB = 6, DE = 21, BC = 6\|find EF` | similar_triangles_generator.py |
| `SIN` | 2 | `SIN\|pi\|0` | positional_encoding_generator.py |
| `SINGULAR_VALUE` | 2 | `SINGULAR_VALUE\|sigma1\|7` | low_rank_approx_generator.py |
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = -4cos(4(x - π/3)) - 4\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
| `SIZE_REDUCE` | 2 | `SIZE_REDUCE\|b2=(-13, -14)\|b2-1b1=(-16, -2)` | lll_reduction_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = 47x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|2` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-5, -6)\|(-3, -6)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-6 - (-6)) / (-3 - (-5))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOLUTIONS` | 2 | `SOLUTIONS\|sin x = 1\|90°, 450°, 810°, 1170°, 1530°, 1890°, 2250°, 2610°, 2970°, 3330°, 3690°, 4050°, 4410°, 4770°, 5130°, 5490°, 5850°, 6210°, 6570°, 6930°, 7290°, 7650°, 8010°, 8370°` | trig_equation_generator.py |
| `SOLUTION_FORMULA` | 1 | `SOLUTION_FORMULA\|M1*V1=M2*V2` | solution_chem_generator.py |
| `SOLUTION_SETUP` | 3 | `SOLUTION_SETUP\|dilution_final_molarity\|M1=1/3, V1=123\|V2=226` | solution_chem_generator.py |
...
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(e^(-t))*(-6) + (-8*e^(-6t) + 8*e^(-t))*0\|-6*e^(-t)` | matrix_exponential_generator.py |
| `SOL_FORM` | 1, 2 | `SOL_FORM\|y = e^(3x)(C1 cos(4x) + C2 sin(4x))` | ode_system_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `SORT` | 2 | `SORT\|9,15,20,2,1\|1,2,9,15,20` | five_number_summary_generator.py, simple_stats_generator.py |
| `SORT_EDGES` | 1 | `SORT_EDGES\|CD=3, BD=4, BC=8, AD=16, AB=23` | mst_generator.py |
...
| `SPHERICAL_EXCESS_SETUP` | 2 | `SPHERICAL_EXCESS_SETUP\|R=3\|angles=120,120,45` | spherical_excess_generator.py |
| `SPHERICAL_SINE_LAW` | 1 | `SPHERICAL_SINE_LAW\|sin(A)/sin(a)=sin(B)/sin(b)` | spherical_triangle_generator.py |
| `SPHERICAL_TRIANGLE_SETUP` | 2 | `SPHERICAL_TRIANGLE_SETUP\|a=45 deg, b=30 deg, A=45 deg\|find sin(B)` | spherical_triangle_generator.py |
| `SPIN_COMPONENT` | 2 | `SPIN_COMPONENT\|row=1\|20/29` | spin_half_generator.py |
| `SPIN_SETUP` | 3 | `SPIN_SETUP\|apply_pauli\|operator=sigma_x\|psi=[21/29,20/29]` | spin_half_generator.py |
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|-5y = -8y + 3y\|4y^2 - 8y + 3y - 6` | factor_trinomial_generator.py |
| `SPLIT_SETUP` | 3 | `SPLIT_SETUP\|color\|left pos=7, neg=1\|right pos=6, neg=2` | information_gain_generator.py |
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|y^2 = 402\|y = ±√402` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
...
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(x + 23) = x + 3\|x + 23 = (x + 3)^2` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|1504\|16 × 94\|16` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `STANDING_SETUP` | 3 | `STANDING_SETUP\|string_harmonic\|n=4\|L=24, v=113` | standing_wave_generator.py |
...
| `STATICS_SETUP` | 3 | `STATICS_SETUP\|supported_beam\|W=75, L=19\|x=10` | statics_generator.py |
...
| `STD` | 1 | `STD\|1` | layer_norm_generator.py |
...
| `STEREO_SETUP` | 3, 4 | `STEREO_SETUP\|plane_to_sphere\|u=1/5\|v=7/4` | stereographic_generator.py |
...
| `STOICH_SETUP` | 2, 3 | `STOICH_SETUP\|limiting_reagent\|2 CO + O2 -> 2 CO2\|given=CO=21 mol, O2=20 mol` | stoichiometry_generator.py |
| `STRUCTURE_CONSTANT` | 3 | `STRUCTURE_CONSTANT\|epsilon_zyx\|-1\|-22iJx` | structure_constant_generator.py |
| `STRUCTURE_SETUP` | 3 | `STRUCTURE_SETUP\|A=-2Jz\|B=-11Jy\|epsilon_zyx=-1` | structure_constant_generator.py |
...
| `SUBGROUP_START` | 2 | `SUBGROUP_START\|H=<27>\|identity 1` | coset_generator.py |
...
| `SUBSTITUTE` | 2 | `SUBSTITUTE\|f:=(q q) in lambda q. (q (lambda e. e))\|lambda q. (q (lambda e. e))` | lambda_reduction_generator.py |
...
| `SUM` | 2, 3 | `SUM\|64 + 65 + 67 + 66 + 68\|330` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
| `SUM_ORDER` | 2 | `SUM_ORDER\|Σ i^3\|n^4` | master_theorem_generator.py |
| `SUPPORT` | 2 | `SUPPORT\|0<=x<=23\|0<=y<=529` | rv_transform_generator.py |
| `SUPPORT_TERM` | 2 | `SUPPORT_TERM\|1\|(5,0)` | svm_margin_generator.py |
| `SVM_SETUP` | 3 | `SVM_SETUP\|x1=(-5,0),y1=-1,alpha1=1\|x2=(0,-12),y2=1,alpha2=1\|b=4,x=(2,5)` | svm_margin_generator.py |
| `SWAP` | 2 | `SWAP\|norm b2=65\|norm b1=130` | lll_reduction_generator.py |
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = -3y + 8` | inverse_function_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|3x^3 + 4x^2 + 17\|r = -2` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|3, -2, 4, 9` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: y = 10` | systems_elimination_generator.py |
...
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|6x + 9y = 30\|-6x - 8y = -20` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x + 4y = -4\|-5x - 2y = 20` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=0 into x = -4y - 4` | systems_elimination_generator.py, systems_substitution_generator.py |
| `TABLEAU` | 2, 3 | `TABLEAU\|initial\|s1: x + s1 = 11\|s2: y + s2 = 10` | simplex_generator.py |
...
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|g(-3)\|14` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(5)\|-15` | de_moivre_generator.py, dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, lie_exponential_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 48 + 13*(x - 0) + 24*(y - 4)` | gradient_generator.py |
...
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|all middle factors cancel\|32/65` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Π k=32..64 k/(k+1)` | telescoping_generator.py |
| `TEMP_SCALE` | 2 | `TEMP_SCALE\|z1/T\|ln(5)` | softmax_gradient_generator.py |
| `TENSOR_ENTRY` | 2 | `TENSOR_ENTRY\|C_11\|1` | einstein_summation_generator.py, index_raising_generator.py |
| `TENSOR_RULE` | 1 | `TENSOR_RULE\|diag(a,b) tensor diag(c,d)=diag(ac,ad,bc,bd)` | tensor_product_generator.py |
| `TENSOR_SETUP` | 3 | `TENSOR_SETUP\|A=diag(-2,-1)\|B=diag(1,0)\|u=[-4,0], v=[-2,4]` | tensor_product_generator.py |
...
| `TEST_CHOOSE` | 2 | `TEST_CHOOSE\|p-series\|Σ 1/n^p with p = 29/7` | power_series_generator.py, series_convergence_generator.py |
| `TEST_STAT_FORMULA` | 1 | `TEST_STAT_FORMULA\|z = (p̂ - p0)/√(p0(1-p0)/n)` | hypothesis_test_generator.py, two_sample_test_generator.py |
| `TF_SETUP` | 3 | `TF_SETUP\|block_feedback\|G1=11/(s+4), G2=12/(s+10)\|H=1` | transfer_function_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Stokes\|F=<-3*y, 0, 0>\|disk radius 2 in z=0` | vector_theorem_generator.py |
| `THETA` | 2 | `THETA\|min(7,19)\|7` | transportation_generator.py |
| `THROUGHPUT` | 2 | `THROUGHPUT\|tokens_per_second\|11125000000/39` | scaling_law_generator.py |
...
| `TRANSFER` | 1 | `TRANSFER\|G(s)=132/(s^2+14s+40)` | transfer_function_generator.py |
...
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(-7, 5)\|reflection over the y-axis, then translation by (-5, 6)` | rv_transform_generator.py, transformation_generator.py |
| `TRANSIENT_FORMULA` | 1 | `TRANSIENT_FORMULA\|tau=L/R` | transient_circuit_generator.py |
| `TRANSIENT_SETUP` | 3 | `TRANSIENT_SETUP\|rl_rise\|R=5, L=25\|V=36, t=15` | transient_circuit_generator.py |
| `TRANSITIVE_CHECK` | 3 | `TRANSITIVE_CHECK\|(2, 2) and (2, 2)\|need (2, 2)\|present` | relation_check_generator.py |
| `TRANSPORT_SETUP` | 3 | `TRANSPORT_SETUP\|supply=(20,7)\|demand=(19,8)\|costs=(15,11;3,8)` | transportation_generator.py |
| `TRIG_RATIO` | 2 | `TRIG_RATIO\|cos\|adjacent/hypotenuse` | right_triangle_trig_generator.py |
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: adjacent side = 117, hypotenuse = 195; given cos 53° ≈ 0.6\|angle A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|z_part * r_part * angle\|5*18*18*2*pi\|3240*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 5*z\|cylinder radius 6, height 6\|cylindrical` | triple_integral_generator.py |
...
| `TS_INIT` | 4 | `TS_INIT\|m=3\|c=10\|t=72\|r=36` | tonelli_shanks_generator.py |
| `TS_LOOP` | 2 | `TS_LOOP\|i=1\|b=27` | tonelli_shanks_generator.py |
| `TS_NONRESIDUE` | 1 | `TS_NONRESIDUE\|5` | tonelli_shanks_generator.py |
| `TS_SETUP` | 2 | `TS_SETUP\|a=18\|p=73` | tonelli_shanks_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|4, -8, -20, -32\|arithmetic, d = -12` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|8 - 4.2 = 3.8\|(3.8)^2 = 14.44\|1/5·14.44 = 2.888` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|13` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y) = <-5*x - 5*y, 6*x - 3*y>\|divergence and scalar curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|147*11 + (-775)\|842` | diagonalization_generator.py |
...
| `VERTEX` | 1 | `VERTEX\|(6, 3)` | ellipse_features_generator.py, hyperbola_features_generator.py, lp_corner_generator.py, parabola_features_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region under y = x(59 - x) on [0, 59], rotated about the y-axis\|shell method` | solid_revolution_generator.py |
...
| `VOP_FORM` | 2 | `VOP_FORM\|u1' = -y2*g/W\|-48/2 * e^(-4x)` | variation_parameters_generator.py |
| `WALK_ENTRY` | 2 | `WALK_ENTRY\|A^2[2,4]\|1` | graph_counting_generator.py |
| `WALK_GOAL` | 2 | `WALK_GOAL\|length 2\|2 to 4` | graph_counting_generator.py |
| `WALK_TERM` | 3 | `WALK_TERM\|via 1\|A[2,1]*A[1,4]\|1` | graph_counting_generator.py |
| `WAVE_FORMULA` | 1 | `WAVE_FORMULA\|1=N^2*integral_0^L (x/L)^(2k) dx` | wavefunction_generator.py |
| `WAVE_SETUP` | 3 | `WAVE_SETUP\|power_interval\|psi=N*(x/L)^5\|0<=x<=18` | wavefunction_generator.py |
...
| `WIDTH_SETUP` | 3 | `WIDTH_SETUP\|lifetime\|hbar=7\|Gamma=5` | branching_ratio_generator.py |
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|88 - 12\|76` | line_integral_generator.py |
...
| `YOUNG_SETUP` | 3 | `YOUNG_SETUP\|partition=[2,2,2,2,2,1]\|n=11\|group=S_11` | young_tableaux_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(166 - 119)/20\|2.35` | normal_table_generator.py, z_score_generator.py |
...
| `ZT_SETUP` | 2, 3 | `ZT_SETUP\|difference\|y[n]-6y[n-1]=delta[n]\|y[-1]=0` | z_transform_generator.py |
