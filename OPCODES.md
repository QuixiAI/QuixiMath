...
| `DERIV_RULE` | 2 | `DERIV_RULE\|power rule\|d/dx of c·x^n = c·n·x^(n-1)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py |
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 3x^4 - 6x^2 + x\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-x\|1x^3 - 1x^2 + 3x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|67297 × 54413 ≈ 70000 × 50000\|3500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3500000000\|3661831661\|3661831661 ≈ 3500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 99:63\|line 3 divides 84 by 7` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(41, 9)\|P(X < 35.6)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 36x^7 + 45x^5 + 36x^4 + 27x^4) / (9x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-36x^7) / (9x^3) + (45x^5) / (9x^3) + (36x^4) / (9x^3) + (27x^4) / (9x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x + 1)(-x^2 + x - 3)` | multiplying_polynomials_generator.py |
...
| `POWER_RULE` | 2 | `POWER_RULE\|3x^4\|12x^3` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(35.6 - 41)/9\|-0.60` | normal_table_generator.py |
