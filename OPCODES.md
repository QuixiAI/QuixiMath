...
1344 distinct op-codes observed.
...
| `DIST2` | 2, 3 | `DIST2\|P1\|C1\|68` | embedding_similarity_generator.py, kmeans_step_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(15, 33) · (0, 1)\|15*0 + 33*1\|33` | embedding_similarity_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, line_integral_generator.py |
