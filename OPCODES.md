...
400 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-3x\|- 3x^3 - 12x^2 + 15x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|96963 × 36931 ≈ 100000 × 40000\|4000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|4000000000\|3580940553\|3580940553 ≈ 4000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|9 ÷ 3 = 3, not 2` | error_spotting_generator.py |
...
| `IMPLICIT_DIFF` | 2 | `IMPLICIT_DIFF\|d/dx of x^2\|2x` | implicit_diff_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 18% to 0.18\|line 3 adds the tip 18.36 to the bill` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(51, 5)\|P(X > 56.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 6x^4 - 9x^4 + 6x) / (-3x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-6x^4) / (-3x) + (-9x^4) / (-3x) + (6x) / (-3x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-3x - 5)(x^2 + 4x - 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(56.5 - 51)/5\|1.10` | normal_table_generator.py |
