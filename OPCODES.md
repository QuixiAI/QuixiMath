...
346 distinct op-codes observed.
...
| `ESTIMATE` | 2 | `ESTIMATE\|64761 × 52350 ≈ 60000 × 50000\|3000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3000000000\|3390238350\|3390238350 ≈ 3000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|6 × 8 = 48, not 56` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 40.50\|line 4 answers $265.50` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(35, 7)\|P(X > 46.9)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 6x^5 - 6x^4 + 9x) / (3x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-6x^5) / (3x) + (-6x^4) / (3x) + (9x) / (3x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x - 1)(-5x^2 - 5x + 3)` | multiplying_polynomials_generator.py |
...
| `ROOT_SIMPLIFY` | 1 | `ROOT_SIMPLIFY\|7√7` | complex_quadratic_generator.py, exponent_generator.py, geometric_mean_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(46.9 - 35)/7\|1.70` | normal_table_generator.py |
