...
1662 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|x - 6 = 9` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|2x - 9 > 20 -> x > 29/2` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|abs(2x - 9) > 20` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for >=` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|2x - 9 > 20 or 2x - 9 < -20` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(x - 6) = 9` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|x - 6 = 9\|x - 6 = -9` | absolute_value_equation_generator.py |
| `ABS_VAL` | 2 | `ABS_VAL\|(-17)\|17` | taxicab_geometry_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|fair die; A = [1, 3, 5], B = [3, 6]\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `ALG_SETUP` | 3 | `ALG_SETUP\|insertion sort\|passes 1\|values 28, 32, 7, 21, 26, 38` | algorithm_trace_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 20, central angle 75°\|sector area` | arc_sector_generator.py |
| `AREA` | 1 | `AREA\|66` | geometry_area_perimeter_generator.py |
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|6*7^3/3\|686` | centroid_generator.py |
| `AREA_INTEGRAL` | 2 | `AREA_INTEGRAL\|sqrt(EG-F^2)=R^2 sin(phi)\|area = R^2*theta*(cos phi1 - cos phi2)` | fundamental_form_generator.py |
| `AREA_SCALE` | 3 | `AREA_SCALE\|uv rectangle area\|8*8\|64` | jacobian_generator.py |
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 + 2x - 4 and y = 14x - 36\|area between the curves` | area_between_curves_generator.py |
...
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|28, 32, 7, 21, 26, 38` | algorithm_trace_generator.py |
| `ASSIGN` | 2 | `ASSIGN\|P1\|C1` | kmeans_step_generator.py |
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = -2 ± (3/4)(x - 4)` | hyperbola_features_generator.py |
| `ATA` | 2 | `ATA\|A^T A\|[[1753, 1728], [1728, 1753]]` | svd_generator.py |
...
| `AV_VECTOR` | 2 | `AV_VECTOR\|A*v1\|[59/√2, 59/√2]` | svd_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 24, disease=no 120\|sensitivity 3/4, specificity 4/5\|P(disease=yes given test positive)` | conditional_probability_generator.py |
...
| `BETA` | 1 | `BETA\|(lambda n. n) applied to (lambda n. n)` | lambda_reduction_generator.py |
...
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 3, k = 1, p = 1/3\|P(X = k)` | binomial_probability_generator.py |
...
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|210 <= 100\|no` | piecewise_evaluation_generator.py |
...
| `CBRT` | 2 | `CBRT\|27r^3\|3r` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
...
| `CEIL` | 2 | `CEIL\|243542.25\|243543` | confidence_interval_generator.py |
...
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(7203/2)/(686)\|21/4` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= 6*x^2\|0 <= x <= 7\|centroid` | centroid_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*x_s + f_y*y_s\|(-91)*(-3) + (-22)*4\|185` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(1,3)\|(-3)*1 + (-1)*3 + (-5)\|-11` | multivar_chain_rule_generator.py |
| `CHANGE_BASE` | 1 | `CHANGE_BASE\|log_125(25) = log_5(25)/log_5(125)` | log_conversion_generator.py |
| `CHAR_DIAG` | 2 | `CHAR_DIAG\|diagonal of λI - A\|(λ - 3), (λ - 5), (λ + 1)` | eigenvalue_generator.py |
...
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^3 - 7λ^2 + 7λ + 15\|(λ + 1)*(λ - 3)*(λ - 5)` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 24, 16, 28, 15, 17; expected: 20 each\|goodness of fit; df = 4, critical value = 9.488` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|24 - 20 = 4\|4^2 = 16\|16/20 = 0.8` | chi_square_generator.py |
...
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|central angle 284° subtends an arc\|inscribed angle on the same arc` | circle_angle_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(-1 - 0)*36\|-36` | vector_theorem_generator.py |
| `CI_FORMULA` | 1 | `CI_FORMULA\|x̄ ± E` | confidence_interval_generator.py |
| `CI_SETUP` | 2 | `CI_SETUP\|σ = 4, n = 400, z* = 1.645\|confidence interval for μ` | confidence_interval_generator.py |
| `CLASSIFY` | 2 | `CLASSIFY\|contingency\|T at 3 of 8 rows` | truth_table_generator.py |
| `CLAUSE` | 2 | `CLAUSE\|C1\|(not P3514)` | resolution_proof_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(W OR X OR NOT Y) AND (W OR NOT X OR NOT Y) AND (NOT W OR X OR Y) AND (NOT W OR NOT X OR Y) AND (NOT W OR NOT X OR NOT Y)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|42120` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|1, -1, -1, -9` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COEFF_MATCH` | 2 | `COEFF_MATCH\|x^n\|(n+1)a_(n+1) = 3a_n` | series_solution_generator.py |
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=0, j=6\|4i + 5j = 30\|accepted` | generating_function_generator.py |
...
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2\|[[-2, -3, -4], [1, 1, 1]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(5,1)\|5` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = -27*v1 + 5*v2\|[8, -3]` | diagonalization_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|15 - 6\|9` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|270/630\|3/7` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|x < -10 -> x < -10` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|x < -10 or x > 5` | compound_inequality_generator.py |
...
| `COND_COUNT` | 2 | `COND_COUNT\|club=yes and commute=bus\|14` | conditional_probability_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 14, no/bike 24, yes/bus 14, no/bus 28\|P(commute=bus given club=yes)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|club=yes total\|14 + 14 = 28` | conditional_probability_generator.py |
...
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(y + 2)^2 = -8(x + 4)\|vertex, focus, directrix` | conic_standard_form_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|x + y = 8\|x = 2*8/4\|4` | lagrange_multiplier_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[-27, 5]` | diagonalization_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|25 boxes\|force 29 in one box` | counting_classics_generator.py |
...
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|-10*x + y + 29 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|(-10)*(-2) - 1^2\|19` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=1\|ln(5/2)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|7·EF = 28·5` | similar_triangles_generator.py, triangle_solve_generator.py |
...
| `CURVE_GEOM_SETUP` | 3 | `CURVE_GEOM_SETUP\|r(t) = <-7*t - 4, 24*t - 8>\|0 <= t <= 3\|arc length` | curve_geometry_generator.py |
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 + 6x^2 + 9x + 7\|inflection point and concavity` | curve_analysis_generator.py |
...
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|T T\|{X}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|S\|T X` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string cbc\|length 3` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{T,U,X} x {T,X}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|c\|{T,U,X}` | cyk_parser_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 6x^4 - 4x^3 + x^2\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -3], [1, -1], [1, 1], [1, 3]]\|y = [14, 14, 10, 2]` | least_squares_generator.py |
...
| `DEV_ROW` | 3 | `DEV_ROW\|28\|-1\|1` | standard_deviation_generator.py |
| `DFA_ACCEPT` | 1 | `DFA_ACCEPT\|q2` | dfa_minimization_generator.py, dfa_simulation_generator.py |
| `DFA_INPUT` | 1 | `DFA_INPUT\|11010100` | dfa_simulation_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[1, 7], [-1, -6]]\|D = [[-6, 0], [0, -2]]\|P^-1 = [[-6, -7], [1, 1]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[18, 14, 10]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = x^2 + 5*y^2 - 3*x*y + 6*x\|point (-2, 4)\|dx=-1/4, dy=-2/5` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|(-10)*(-1/4) + 46*(-2/5)\|-15.9` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|589824\|587520\|2304` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `DISC_CLASSIFY` | 2 | `DISC_CLASSIFY\|-24 < 0\|no real solutions` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|y - 27 = -34` | systems_substitution_generator.py |
...
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited A\|A=0, B=6, C=inf, D=7, E=5, F=inf` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|-3x\|- 12x^3 - 3x^2 + 12x` | multiplying_polynomials_generator.py |
...
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y + R_z\|-5 - 2 + 0\|-7` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|35x^5\|5x^2\|7x^3` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT J AND NOT K AND L AND NOT M) OR (J AND K AND L AND NOT M)` | boolean_algebra_generator.py |
| `DOMAIN` | 2 | `DOMAIN\|x = −45..−35\|{−45, −44, −43, −42, −41, −40, −39, −38, −37, −36, −35}` | set_builder_roster_generator.py |
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|radicand ≥ 0\|x + 8 ≥ 0` | domain_range_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(10, 39) · (0, 1)\|10*0 + 39*1\|39` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `DOUBLE_SETUP` | 2, 3 | `DOUBLE_SETUP\|integrand 10\|x:0..2\|y:0..2*x` | double_integral_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=5,v=4); 2:(w=3,v=10); 3:(w=4,v=9); 4:(w=5,v=2)` | dp_table_generator.py |
...
| `D_POWER` | 2 | `D_POWER\|D^4\|[[16, 0], [0, 625]]` | diagonalization_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|AE\|weight 9\|add A` | mst_generator.py |
...
| `EIGENVECTOR` | 2 | `EIGENVECTOR\|A + 1I times v = 0\|[21, 4, 24]` | diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, svd_generator.py |
| `EIGEN_CHECK` | 3 | `EIGEN_CHECK\|sigma_z psi\|-1*psi\|lambda=-1` | spin_half_generator.py |
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 1I\|[[4, -3, -3], [0, 6, -1], [0, 0, 0]]` | eigenvalue_generator.py |
...
| `EPS_CLOSURE` | 2 | `EPS_CLOSURE\|{u2}\|{u2}` | nfa_simulation_generator.py |
| `EQUATE_EXP` | 1 | `EQUATE_EXP\|2x - 3 = 3` | exponential_equation_generator.py |
| `EQUILIBRIA` | 2 | `EQUILIBRIA\|f(y) = 0\|y=-14, y=-11, y=13` | stability_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(-4, -8)\|(-3, -3)` | equation_from_two_points_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|80369 × 21789 ≈ 80000 × 20000\|1600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EV_SETUP` | 2 | `EV_SETUP\|P(win $8) = 2/5; P(win $1) = 3/5\|fair? cost = $4` | expected_value_generator.py |
| `EXACT_MATCH` | 2 | `EXACT_MATCH\|F_y = N\|4*x + g'(y) = 4*x + 6*y + 1` | exact_ode_generator.py |
...
| `EXP_APPLY` | 2 | `EXP_APPLY\|x(t) = e^(At)x(0)\|x(0) = [2, -2]` | matrix_exponential_generator.py |
| `EXP_CELL` | 2 | `EXP_CELL\|(150·150)/300\|75` | chi_square_generator.py |
| `EXP_DIAG` | 2 | `EXP_DIAG\|e^(Dt)\|[[e^t, 0], [0, e^(2t)]]` | matrix_exponential_generator.py |
| `EXP_ENTRY` | 3 | `EXP_ENTRY\|(1,1)\|-4*e^t + 5*e^(2t)\|-4*e^t + 5*e^(2t)` | matrix_exponential_generator.py |
...
| `FACTOR` | 1, 2 | `FACTOR\|x^2 - 3x - 40\|(x + 5)(x - 8)` | polynomial_inequality_generator.py, second_order_ode_generator.py, transfer_function_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `FACTOR_PAIR_GOAL` | 2 | `FACTOR_PAIR_GOAL\|m·n = 7\|m + n = 8` | factor_trinomial_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|11 × 11 = 121, not 99` | error_spotting_generator.py |
...
| `FLUX_SUM` | 2 | `FLUX_SUM\|(2 - 5 + 2)*243\|-243` | vector_theorem_generator.py |
| `FOCUS` | 1 | `FOCUS\|(-6, -2)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (-3) * 1\|-3` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-3) * 4i\|-12i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|35, 5\|5` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEOM_SETUP` | 2 | `GEOM_SETUP\|p = 1/6, q = 5/6\|P(X = 2)` | geometric_distribution_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; leg = 82 with projection p = 41 on the hypotenuse\|the hypotenuse c` | geometric_mean_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^30]\|1/((1 - x^4)(1 - x^5))` | generating_function_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = 2*x^2 + 5*y^2 - 2*x*y + 5*x + 6*y\|point (2, 0)\|gradient` | gradient_generator.py |
...
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|(-10)*(-2) - 1^2\|19` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = -5*x^2 - y^2 + x*y + 29*x - y\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = 19\|f_xx = -10\|local maximum` | hessian_classify_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-3x^3 - 2x^2 + 3x - 1\|x = 3` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 400, 186 successes, critical value = 1.96` | hypothesis_test_generator.py, two_sample_test_generator.py |
...
| `HYPERCUBE_SETUP` | 2 | `HYPERCUBE_SETUP\|5-cube with side 5\|main diagonal` | hypercube_counting_generator.py |
...
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=13..51 C(i,13) = C(52,14)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=51, n(B)=42\|n(A intersect B)=25` | inclusion_exclusion_generator.py |
...
| `INDUCT_ASSUME` | 1 | `INDUCT_ASSUME\|sum to k = (10^(k+1)-1)/(10-1)` | induction_verify_generator.py |
| `INDUCT_BASE` | 2 | `INDUCT_BASE\|n=0\|1 = (r^1-1)/(r-1)` | induction_verify_generator.py |
| `INDUCT_STEP` | 1, 2 | `INDUCT_STEP\|add 10^(k+1)` | induction_verify_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|9\|-14 < 2x < -4` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INITIAL_COEFF` | 2 | `INITIAL_COEFF\|a_0\|14040` | series_solution_generator.py |
| `INITIAL_EQ` | 2 | `INITIAL_EQ\|C1 + C2\|2` | recurrence_generator.py |
| `INITIAL_SYSTEM` | 2 | `INITIAL_SYSTEM\|C1[1, 1] + C2[2, 1]\|[-4, -3]` | ode_system_generator.py |
| `INNER_ANTIDERIV` | 2 | `INNER_ANTIDERIV\|dx\|10*x` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_EVAL` | 2, 3 | `INNER_EVAL\|x=y/2..2\|10*(2 - y/2)` | double_integral_generator.py, triple_integral_generator.py |
...
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 1\|28, 32, 7, 21, 26, 38` | algorithm_trace_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (-12x^3 + 8x) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 4x - 7 on [2, 3]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|3*(-5) - (-2)*4\|-7` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[3, -2], [4, -5]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = 3*u - 2*v\|y = 4*u - 5*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
...
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|000, 001\|NOT V AND NOT W` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|V=0\|1, 1, 0, 0` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows V=0,V=1\|columns WX=00,WX=01,WX=11,WX=10` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|(NOT V AND NOT W) OR (NOT W AND X)` | boolean_algebra_generator.py |
...
| `LAGRANGE_EQ` | 2 | `LAGRANGE_EQ\|f_x = lambda\|2*x*y^2` | lagrange_multiplier_generator.py |
| `LAGRANGE_FACTOR` | 3 | `LAGRANGE_FACTOR\|L_0\|j=1\|-3/4` | interpolation_generator.py |
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = x^2*y^2\|constraint x + y = 8\|maximize` | lagrange_multiplier_generator.py |
...
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|((lambda n. n) (lambda n. n))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|9/2 - 24\|-39/2` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = 1/5x - 9\|(7, -7)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <8*x + 5*y + 4, 6*y + 5*x - 2>\|from (-2, -2) to (-4, -1)` | line_integral_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|log_7(7^x) = log_7(45)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_EVAL` | 2 | `LOG_EVAL\|16\|ln(16)` | hyperbolic_distance_generator.py |
| `LOG_EXACT` | 2 | `LOG_EXACT\|log_6(279936)\|7` | master_theorem_generator.py |
...
| `LOG_PRODUCT` | 1, 2 | `LOG_PRODUCT\|log_3(x^2) + log_3(y)\|log_3(x^2y)` | log_equation_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_3(x^2y) - log_3(z)\|log_3(x^2y/z)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|2log_3(x) + log_3(y) - log_3(z)\|condense` | complex_log_generator.py, log_properties_generator.py |
...
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-3, 14), (-1, 14), (1, 10), (3, 2)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[-5, 0, 1], [0, -4, -4], [-20, 4, 3]]\|unit lower L` | lu_decomposition_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[3, 1], [5, 3]]\|2A` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
| `MAX` | 2, 3 | `MAX\|1, 2\|2` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
...
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=1,mid=2,hi=3\|left 17; right 27` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|17\|27\|take left` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 1-2\|array 37, 17, 27, 28, 5, 48` | algorithm_trace_generator.py |
| `MERGE_TAKE` | 2 | `MERGE_TAKE\|17\|merged 17` | algorithm_trace_generator.py |
| `METRIC` | 2 | `METRIC\|taxicab circle\|all points with abs(x) + abs(y) = 7` | taxicab_geometry_generator.py |
...
| `MINTERM` | 2 | `MINTERM\|0010\|NOT J AND NOT K AND L AND NOT M` | boolean_algebra_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 13400 · (1 - 0.35)^2` | exponential_model_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|6^2*7^5/10\|302526/5` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|6*7^4/4\|7203/2` | centroid_generator.py |
...
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|-16 / 8\|-2` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|7 * -1\|-7` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(7x^4)(-x^2)` | monomial_mult_div_generator.py |
...
| `MST_ADD` | 2 | `MST_ADD\|AE\|total 9` | mst_generator.py |
...
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(5x)y' + 5e^(5x)y\|9e^(9x)` | integrating_factor_generator.py, ode_substitution_generator.py |
...
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|5 A's, 2 Z's, 1 M\|total 8` | stars_and_bars_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 - 4x + 1 on [-2, 2]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 4*x^2 + 2*y^2 - 3*x - 6*y\|x = -3*s - t - 5, y = 4*s - t - 5\|(s,t) = (1, 3)` | multivar_chain_rule_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 15% to 0.15\|line 3 adds the tip 23.10 to the bill` | fill_in_step_generator.py |
| `NEG_LOG` | 2 | `NEG_LOG\|p=1/16\|ln(16)` | perplexity_generator.py |
| `NET_SETUP` | 2 | `NET_SETUP\|2 right triangles with legs 3 and 4; rectangles 3 by 10, 4 by 10, and 5 by 10\|total surface area` | nets_surface_area_generator.py |
...
| `NFA_ACTIVE` | 2 | `NFA_ACTIVE\|start\|{u2}` | nfa_simulation_generator.py |
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|u1\|{u4}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|aaaba` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{u2}\|a\|u2->{u2,u3}\|{u2,u3}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|a` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states u2, u3, u7, u8\|alphabet a, b\|start u2` | nfa_simulation_generator.py |
| `NFA_TRANSITION` | 3 | `NFA_TRANSITION\|u2\|a\|{u2,u3}` | nfa_simulation_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|A: 75 in N(57, 8)\|compare relative standing` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
| `NORM_SQUARED` | 2 | `NORM_SQUARED\|p\|14` | quaternion_generator.py |
| `NO_REDEX` | 2 | `NO_REDEX\|lambda n. n\|no beta redex remains` | lambda_reduction_generator.py |
...
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dx = x^2/y^2, y(0) = 2\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `OPT_SETUP` | 2 | `OPT_SETUP\|172 m of fence, barn forms the fourth side; sides x, x, and 172 - 2x\|maximize area` | optimization_generator.py |
...
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|4*x^2 + 96*x` | double_integral_generator.py |
...
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(-t + 2, t - 3)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 6t + 11, y = -t + 7\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(x - 17)/((x - 3)(x + 4)) = A/(x - 3) + B/(x + 4)` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|2/(s + 5) + 3/(s - 4)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|16*x^3*y^3 + 6*x*y^2` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|4*x^4*y^3\|d/dx\|16*x^3*y^3` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 4*x^4*y^3 + 3*x^2*y^2\|f_xx` | partial_derivative_generator.py |
...
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = 142x, dv = e^x dx\|du = 142 dx, v = e^x` | integration_by_parts_generator.py |
...
| `PASCAL_SETUP` | 1 | `PASCAL_SETUP\|3C2` | pascal_triangle_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|1.575\|1155\|1819.125` | percent_problem_generator.py |
...
| `PI_COEFF` | 2 | `PI_COEFF\|π/4\|1/4` | arc_sector_generator.py |
...
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|x = ±69\|x = 69 or x = -69` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|96*5/8\|60` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 8 = 5(x + 4)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|(x, y) = (95, -228)\|polar (r ≥ 0, 0° ≤ θ < 360°)` | parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|3x^3 + 14x^2 - 14x - 6\|3x - 1` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-9x^3 + 13x + 5` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(20x^2 + 15x^2) / (5x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(20x^2) / (5x) + (15x^2) / (5x)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-9x^3) + (8x +5x) + (-3 +8)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|x^3 + x^2` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-3x + 4)(4x^2 + x - 4)` | multiplying_polynomials_generator.py |
...
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-9x^3 + 8x - 3) - (-5x - 8)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(3x^3 + 14x^2) - (3x^3 - x^2)\|15x^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
...
| `POTENTIAL_BUILD` | 3 | `POTENTIAL_BUILD\|integrate P dx\|4*x^2 + 5*x*y + 4*x + g(y)\|g'(y) remains` | exact_ode_generator.py, line_integral_generator.py |
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|4*x^2 + 3*y^2 + 5*x*y + 4*x - 2*y` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(1/3)^1\|1/3` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|16*(-11) + 7500\|7324` | diagonalization_generator.py |
...
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited E\|AE=9, DE=13` | mst_generator.py |
...
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[16, 12, 8, 4]` | least_squares_generator.py, legendre_construction_generator.py |
...
| `Q1` | 4 | `Q1\|768\|48\|48\|17` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|768\|48\|48\|15` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
...
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[12, -6], [16, 17]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|262°\|quadrant III` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
...
| `QUARTILE` | 3 | `QUARTILE\|Q1\|11,14,17,19,21\|17` | five_number_summary_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|cube: ds/dt = 9 in/min; s = 17 in\|dV/dt` | related_rates_generator.py |
| `RATIO` | 2, 3 | `RATIO\|2*y = 2*x\|y = x` | lagrange_multiplier_generator.py, simplex_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|√359/√359` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 14079 / 1.805` | percent_problem_generator.py |
...
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q85595_1` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|a*b\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q85595_0\|still reading a*` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q85595_0\|a\|q85595_0` | regex_to_automaton_generator.py |
...
| `REGION_MEASURE` | 3 | `REGION_MEASURE\|area\|4*9\|36` | vector_theorem_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|line ŷ = 62.6 - 1.2x\|predict ŷ at x = 8` | regression_generator.py |
...
| `REL_SETUP` | 2, 3 | `REL_SETUP\|A = {1, 2, 3}\|R = {(1, 1), (2, 1), (2, 2), (3, 1)}` | relation_check_generator.py, special_relativity_generator.py |
...
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (2, 37), line ŷ = 34.6 + 1.8x\|residual = observed − predicted` | regression_generator.py |
| `RESOLVE` | 3 | `RESOLVE\|C1\|C2\|not P3514` | resolution_proof_generator.py |
| `RES_EMPTY` | 1 | `RES_EMPTY\|C4` | resolution_proof_generator.py |
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(not P3514), C2=(P3514), C3=(P42813 OR P40880 OR P18306)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C2\|(P21893)` | resolution_proof_generator.py |
...
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, -1, 0], [0, 1, 4, -1], [0, 0, 0, 0]]` | subspace_basis_generator.py |
...
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x8 = 31\|xi >= 0` | stars_and_bars_generator.py |
...
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = -6\|(-216)*(-27)\|5832` | diagonalization_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(-6, 8), B(26, 40); ratio 3:5 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_24 = 6 + (24 - 1)·9` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|6, 15, 24, 33, ...\|sum of first 24 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ (-1)^(n+1)·1/n^(38/9), n ≥ 1\|absolutely convergent, conditionally convergent, or divergent?` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
| `SERIES_TERM` | 3 | `SERIES_TERM\|n=0\|1\|1` | grassmann_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|14079 = 1.805 * whole` | percent_problem_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y6 = 14` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
...
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|130 + 149 + 168 + 187` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=7)^(10) (19k - 3)\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=7\|19(7) - 3\|130` | sigma_notation_generator.py |
...
| `SIGN_CHART` | 2 | `SIGN_CHART\|zeros\|-5, 8` | polynomial_inequality_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, -14)\|y = -15\|f(y) = -112 (negative)\|down` | stability_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; AB = 7, DE = 28, BC = 5\|find EF` | similar_triangles_generator.py |
...
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = -cos(2(x - π/4)) + 2\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_INT_IDENTIFY` | 2 | `SLOPE_INT_IDENTIFY\|Slope (m)\|-66` | slope_intercept_form_generator.py |
| `SLOPE_INT_MATCH` | 2 | `SLOPE_INT_MATCH\|Compare to Slope-Intercept Form\|y = mx + b` | slope_intercept_form_generator.py |
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -46 - 66x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|5` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-8, 3)\|(-10, -2)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-2 - 3) / (-10 - (-8))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOLUTIONS` | 2 | `SOLUTIONS\|cos x = -1\|180°, 540°, 900°, 1260°, 1620°, 1980°, 2340°, 2700°` | trig_equation_generator.py |
...
| `SOLVE_Y` | 2 | `SOLVE_Y\|e^(5x)y = e^(9x) + C\|y = e^(4x) + Ce^(-5x)` | integrating_factor_generator.py, laplace_ivp_generator.py, ode_substitution_generator.py |
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(-5*e^(-2t) + 6*e^(-t))*2 + (2*e^(-2t) - 2*e^(-t))*(-2)\|-14*e^(-2t) + 16*e^(-t)` | matrix_exponential_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|AB=4, AC=11, CD=17, BD=21, BC=22` | mst_generator.py |
...
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|x^2 = 4761\|x = ±69` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
...
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|2880\|576 × 5\|576` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `SUBSTITUTE` | 2 | `SUBSTITUTE\|n:=(lambda n. n) in n\|lambda n. n` | lambda_reduction_generator.py |
...
| `SUM` | 2, 3 | `SUM\|48 + 45 + 39 + 51 + 42\|225` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
...
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = (y + 7)/2` | inverse_function_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|x^3 - x^2 - x - 9\|r = 3` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|1, 2, 5, 6` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = y + 9` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq2 * -1` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|x + 2y = 2\|-x - 3y = -4` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x - y = 9\|-3x + 4y = -34` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=-7 into x = y + 9` | systems_elimination_generator.py, systems_substitution_generator.py |
...
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|f(-1)\|-3` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|f(-4)\|5` | de_moivre_generator.py, dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, lie_exponential_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 18 + 14*(x - 3) + (y - 2)` | gradient_generator.py |
...
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|all middle factors cancel\|86/133` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Π k=86..132 k/(k+1)` | telescoping_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Green\|F=<0, -x>\|rectangle 4 by 9` | vector_theorem_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle, angle 30°, hypotenuse = 130; given sin 30° ≈ 0.5\|the opposite side` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|rho_part * phi_part * angle\|6*64/3*2*2*pi\|512*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 6\|ball radius 4\|spherical` | triple_integral_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|30-60-90 triangle, hypotenuse = 276\|both legs` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|-27, -34, -41, -48\|arithmetic, d = -7` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|5 - 5 = 0\|(0)^2 = 0\|2/5·0 = 0` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|13` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y,z) = <-5*x + 5*y + 2*z, x - 2*y + z, 5*x - 4*y>\|divergence and curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|5832 + (-40)*7\|5552` | diagonalization_generator.py |
...
| `VERTEX` | 1 | `VERTEX\|(-4, -2)` | ellipse_features_generator.py, hyperbola_features_generator.py, lp_corner_generator.py, parabola_features_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region under y = 11x on [0, 5], rotated about the x-axis\|disk method` | solid_revolution_generator.py |
...
| `VOP_FORM` | 2 | `VOP_FORM\|u1' = -y2*g/W\|-30/6 * e^x` | variation_parameters_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|73 - 44\|29` | line_integral_generator.py |
