...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 3x^4 - 6x^2 + x\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|20x^3 - 8x^2 - 12x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|94061 × 91877 ≈ 90000 × 90000\|8100000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|8100000000\|8642042497\|8642042497 ≈ 8100000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-48 ÷ 6 = -8, not -6` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 20% to 0.20\|line 3 adds the tip 34.00 to the bill` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(53, 8)\|P(X < 46.6)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(16x^6 + 24x^5 + 8x^3) / (-8x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(16x^6) / (-8x^3) + (24x^5) / (-8x^3) + (8x^3) / (-8x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x - 1)(-5x^2 + 2x + 3)` | multiplying_polynomials_generator.py |
...
| `POWER_RULE` | 2 | `POWER_RULE\|3x^4\|12x^3` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py |
...
| `SUBST` | 3 | `SUBST\|x\|-5\|2(-5)+5y+7` | chain_rule_generator.py, derivative_limit_def_generator.py, evaluate_expression_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, implicit_diff_generator.py, limit_evaluation_generator.py, log_diff_higher_order_generator.py, piecewise_evaluation_generator.py, polar_parametric_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, trig_equation_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(46.6 - 53)/8\|-0.80` | normal_table_generator.py |
