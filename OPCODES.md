...
2007 distinct op-codes observed.
...
| `AREA` | 2 | `AREA\|10 × 8\|80` | geometry_area_perimeter_generator.py, geometry_in_context_generator.py, optimization_in_context_generator.py |
...
| `DECIDE` | 2 | `DECIDE\|A+B\|value 76` | optimization_in_context_generator.py |
...
| `OPTION` | 2 | `OPTION\|A\|$740.00` | optimization_in_context_generator.py |
