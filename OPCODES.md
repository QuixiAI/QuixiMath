...
382 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|-2x\|- 2x^3 - 6x^2 - 2x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|11298 × 2394 ≈ 10000 × 2000\|20000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|20000000\|27047412\|27047412 ≈ 20000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 15% to 0.15\|line 3 adds the tip 6.30 to the bill` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(45, 8)\|P(X > 50.6)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(28x^5 - 7x^5 - 7x^5 + 14x) / (-7x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(28x^5) / (-7x) + (-7x^5) / (-7x) + (-7x^5) / (-7x) + (14x) / (-7x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x + 2)(x^2 + 3x + 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(50.6 - 45)/8\|0.70` | normal_table_generator.py |
