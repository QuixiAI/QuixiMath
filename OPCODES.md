...
369 distinct op-codes observed.
...
| `ESTIMATE` | 2 | `ESTIMATE\|76568 × 17409 ≈ 80000 × 20000\|1600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1600000000\|1332972312\|1332972312 ≈ 1600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-10 - 14 = -24, not -16` | error_spotting_generator.py |
...
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|16/-20\|-4/5` | arc_sector_generator.py, complex_division_generator.py, function_operations_generator.py, hyperbola_features_generator.py, right_triangle_trig_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 5x = 5\|line 5 shows x = 1` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(83, 15)\|P(X < 62)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(25x^4 - 25x^3 + 5x^2) / (-5x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(25x^4) / (-5x^2) + (-25x^3) / (-5x^2) + (5x^2) / (-5x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x + 2)(-3x^2 + x + 1)` | multiplying_polynomials_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(5)\|18` | function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, right_triangle_trig_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle, angle 24°, hypotenuse = 20; given sin 24° ≈ 0.4\|the opposite side` | right_triangle_trig_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(62 - 83)/15\|-1.40` | normal_table_generator.py |
