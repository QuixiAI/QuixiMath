...
373 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|5x\|- 5x^3 - 5x^2 + 5x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|80020 × 72226 ≈ 80000 × 70000\|5600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5600000000\|5779524520\|5779524520 ≈ 5600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|9 × 5 = 45, not 35` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 25% to 0.25\|line 3 adds the tip 50.50 to the bill` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(35, 7)\|P(X < 49.7)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(2x^6 + 4x^2) / (x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(2x^6) / (x^2) + (4x^2) / (x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(5x - 1)(-x^2 - x + 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(49.7 - 35)/7\|2.10` | normal_table_generator.py |
