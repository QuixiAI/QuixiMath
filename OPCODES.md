...
| `C` | 2, 3 | `C\|1/2\|14\|7/14` | alternative_means_generator.py, applied_common.py, complement_probability_generator.py, experimental_probability_generator.py, fraction_comparison_generator.py, fraction_op_generator.py, mixed_number_operation_generator.py, rational_expr_add_sub_generator.py |
...
| `CF_RESULT` | 1 | `CF_RESULT\|[3; 80]` | continued_fraction_generator.py |
| `CF_SETUP` | 1, 2 | `CF_SETUP\|241/80` | continued_fraction_generator.py |
...
| `DEFINE_VAR` | 2 | `DEFINE_VAR\|a\|tens digit` | applied_common.py, integer_puzzle_word_generator.py, linear_model_word_generator.py, systems_word_generator.py |
...
| `L` | 2, 3 | `L\|2\|7\|14` | alternative_means_generator.py, applied_common.py, complement_probability_generator.py, experimental_probability_generator.py, fraction_comparison_generator.py, fraction_op_generator.py, linear_fractional_generator.py, mixed_number_operation_generator.py, rational_expr_add_sub_generator.py |
...
| `MAT_POW` | 2 | `MAT_POW\|multiply\|[[6, 5], [1, 0]]` | recurrence_unroll_generator.py |
...
| `MILESTONE` | 3 | `MILESTONE\|14\|(P + Q) mod 9\|8` | depth_common.py |
...
| `PART` | 2 | `PART\|1\|The values recorded are 50, 180, 200, 370; what is the mean?` | applied_common.py |
...
| `PIPE_STAGE` | 2 | `PIPE_STAGE\|1\|fixed_adjustment` | pipeline_composition_generator.py |
...
| `RATE` | 2, 3 | `RATE\|together\|1/5 job per hour` | applied_common.py, work_rate_generator.py |
...
| `RATE_SUM` | 2 | `RATE_SUM\|1/15 + 1/10\|1/6` | applied_common.py, work_rate_generator.py |
...
| `SELECT_RELEVANT` | 1 | `SELECT_RELEVANT\|used: base 97, rate 30%\|ignored: 45 empty folders` | applied_common.py |
