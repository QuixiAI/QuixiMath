...
1785 distinct op-codes observed.
...
| `ALPHA` | 2 | `ALPHA\|line 4\|6: w; 7: ¬w` | kernel_ridge_generator.py, semantic_tableau_generator.py |
...
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|supplementary\|angle1 = 32°` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|180 - 32\|148` | angle_relationships_generator.py |
...
| `ANTICHAIN` | 2 | `ANTICHAIN\|{1, 18, 25}\|size 3` | partial_order_generator.py |
...
| `ARG_SETUP` | 2 | `ARG_SETUP\|q ∨ ¬s; (r ∨ q) ∨ q\|(q ∨ ¬s) ∧ ((r ∨ q) ∨ q)` | argument_form_generator.py |
...
| `BASE` | 2 | `BASE\|Ack(0, 1)\|1 + 1` | recursive_definition_unfold_generator.py |
| `BASE_ADD_COL` | 3 | `BASE_ADD_COL\|col 0\|6 + C + carry 0\|18 -> digit 2, carry 1` | base_arithmetic_generator.py |
| `BASE_ARITH_SETUP` | 2 | `BASE_ARITH_SETUP\|base 16\|D96 + 16C` | base_arithmetic_generator.py |
| `BASE_CARRY` | 2 | `BASE_CARRY\|carry 1\|digit 1, carry 0` | base_arithmetic_generator.py |
| `BASE_MUL_COL` | 3 | `BASE_MUL_COL\|col 0\|1 * 3 + carry 0\|3 -> digit 3, carry 0` | base_arithmetic_generator.py |
| `BASE_SETUP` | 2 | `BASE_SETUP\|3007_10\|hexadecimal` | base_conversion_generator.py |
...
| `BETA` | 1, 3 | `BETA\|line 1\|1L: 2: ¬j\|1R: 3: (w ∧ ¬w) ∨ ¬h` | lambda_reduction_generator.py, semantic_tableau_generator.py |
...
| `BINARY` | 2 | `BINARY\|21133\|101001010001101` | countability_bijection_generator.py |
...
| `BITWISE` | 1 | `BITWISE\|∨\|10110010100\|11001001000\|11111011100` | characteristic_vector_generator.py |
...
| `BIT_SETUP` | 2 | `BIT_SETUP\|0111 AND 1001\|4-bit mask` | bitwise_ops_generator.py |
...
| `BRANCH_CLOSE` | 2 | `BRANCH_CLOSE\|1RL\|w, ¬w` | semantic_tableau_generator.py |
| `BRANCH_OPEN` | 2 | `BRANCH_OPEN\|1L\|h=F, j=F, w=F` | semantic_tableau_generator.py |
...
| `CAL_DIVMOD` | 3 | `CAL_DIVMOD\|23\|7\|3 R2` | calendar_arithmetic_generator.py |
| `CAL_FORMULA` | 1 | `CAL_FORMULA\|q=m*L` | calorimetry_generator.py |
| `CAL_SETUP` | 3 | `CAL_SETUP\|start 2027-05-13\|end 2027-10-12\|days between` | calendar_arithmetic_generator.py, calorimetry_generator.py |
...
| `CARTESIAN_RESULT` | 1 | `CARTESIAN_RESULT\|{(g, 9), (g, 19), (q, 9), (q, 19), (r, 9), (r, 19)}` | set_operations_generator.py |
| `CART_PAIR` | 3 | `CART_PAIR\|g\|9\|(g, 9)` | set_operations_generator.py |
| `CASE` | 1, 2 | `CASE\|Cleo=knight, Kira=knight, Dara=knight` | countability_bijection_generator.py, knights_knaves_generator.py |
...
| `CHAIN` | 2 | `CHAIN\|{1, 36, 41}\|length 3` | partial_order_generator.py |
...
| `CHECK_POINT` | 3 | `CHECK_POINT\|x=0\|12·0 - 2 = -2\|12·0 - 2 = -2` | special_solution_equation_generator.py |
...
| `CLASS` | 2 | `CLASS\|[1]\|{1}` | equivalence_relation_generator.py |
...
| `CLUE_APPLY` | 3 | `CLUE_APPLY\|clue 1\|Mara does not have globe\|6 → 4 candidates` | logic_grid_puzzle_generator.py |
...
| `COLLISION` | 1 | `COLLISION\|f(c) = f(d) = 10` | function_properties_generator.py |
...
| `COMB_CONST` | 3 | `COMB_CONST\|4\|+2\|6` | derivative_product_quotient_generator.py, equation_from_two_points_generator.py, linear_complex_generator.py, rational_expr_add_sub_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `COMPLEMENT` | 2, 3 | `COMPLEMENT\|P(Aᶜ) = 1 − P(A)\|1 − 4/13\|9/13` | complement_probability_generator.py, derangement_generator.py, odds_probability_generator.py |
...
| `COMPOSE` | 3 | `COMPOSE\|k\|f(k) = 29\|g(29) = L` | function_properties_generator.py |
| `COMPOSE_PAIR` | 3 | `COMPOSE_PAIR\|(n, 23)\|(23, D)\|(n, D)` | relation_operations_generator.py |
...
| `CONCLUSION_AT` | 2 | `CONCLUSION_AT\|q=T, r=T, s=T\|T` | argument_form_generator.py |
...
| `COND_PARTS` | 2 | `COND_PARTS\|n is divisible by 740\|n is divisible by 148` | conditional_forms_generator.py |
...
| `COUNTEREXAMPLE` | 2, 3 | `COUNTEREXAMPLE\|set pair\|A = ∅; B = {22}; left = {22}; right = ∅` | argument_form_generator.py, conditional_forms_generator.py, counterexample_search_generator.py, truth_table_generator.py |
| `COUNTERMODEL` | 1 | `COUNTERMODEL\|writers=TFF, inventors=FTF, pilots=TTF` | syllogism_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|18 boxes\|force 23 in one box` | counting_classics_generator.py |
| `COUPON` | 1 | `COUPON\|2125` | bond_pricing_generator.py |
| `COVER` | 3 | `COVER\|16\|37\|no c strictly between` | partial_order_generator.py |
...
| `DATE_ORDINAL` | 2 | `DATE_ORDINAL\|2027-05-13\|740114` | calendar_arithmetic_generator.py |
...
| `DECODE` | 2 | `DECODE\|11111011100\|{b, h, j, k, l, s, t, u}` | characteristic_vector_generator.py |
...
| `DEDUCE` | 3 | `DEDUCE\|Gia\|item = globe\|only solution left` | logic_grid_puzzle_generator.py |
...
| `DIAGONAL` | 3 | `DIAGONAL\|w=49\|start=1225\|offset=49` | cantor_pairing_generator.py |
...
| `DIVMOD` | 3, 4 | `DIVMOD\|249\|2\|124\|r=1` | base_conversion_generator.py, induction_verify_generator.py, recursive_definition_unfold_generator.py |
...
| `DIV_COEFF` | 3 | `DIV_COEFF\|6\|1\|x=6` | linear_complex_generator.py |
...
| `DOMAIN` | 1, 2 | `DOMAIN\|x = −37..−29\|{−37, −36, −35, −34, −33, −32, −31, −30, −29}` | quantifier_finite_domain_generator.py, relation_operations_generator.py, set_builder_roster_generator.py |
...
| `ELIMINATE` | 1, 3 | `ELIMINATE\|clue 1\|Gia: camera; Kira: shell; Mara: globe\|violates clue` | logic_grid_puzzle_generator.py, newtons_laws_generator.py |
...
| `EQ_SIMPLIFY` | 1 | `EQ_SIMPLIFY\|10x = 80` | error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, two_step_equation_generator.py |
...
| `EXPAND` | 1, 2 | `EXPAND\|p + t\|2e + 2j` | complex_locus_generator.py, direct_proof_algebra_generator.py, mobius_transform_generator.py, zf_axiom_identify_generator.py |
...
| `EXP_EXPAND` | 1 | `EXP_EXPAND\|2 × 2 × 2 × 2 × 2` | exponent_generator.py |
...
| `EXP_RULE_APPLY` | 3, 4 | `EXP_RULE_APPLY\|multiply\|11\|6\|66` | exponent_generator.py, exponent_mixed_rules_generator.py |
...
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|((17c)^11)^6` | exponent_generator.py, exponent_mixed_rules_generator.py, rational_exponent_generator.py |
| `EXP_RULE_SIMPLIFY` | 1 | `EXP_RULE_SIMPLIFY\|(17c)^66` | exponent_generator.py, exponent_mixed_rules_generator.py |
| `EXP_SETUP` | 2 | `EXP_SETUP\|2\|5` | exponent_generator.py |
...
| `FACTOR` | 1, 2 | `FACTOR\|2(e + j)` | direct_proof_algebra_generator.py, polynomial_inequality_generator.py, second_order_ode_generator.py, transfer_function_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `FIN_SETUP` | 3 | `FIN_SETUP\|simple interest P = 400\|r = 6%, t = 1\|interest and balance` | finance_generator.py |
...
| `FIXED_CHECK` | 3 | `FIXED_CHECK\|b\|f(b) = m\|not fixed` | function_properties_generator.py |
...
| `FOLD` | 2 | `FOLD\|Ack(1, 0)\|2` | peano_arithmetic_generator.py, recursive_definition_unfold_generator.py |
...
| `FORM` | 2 | `FORM\|inverse\|If n is not divisible by 740, then n is not divisible by 148.` | conditional_forms_generator.py, zf_axiom_identify_generator.py |
...
| `GCD_DIV` | 4 | `GCD_DIV\|15399\|6480\|2\|2439` | rationals_as_pairs_generator.py |
| `GCD_DONE` | 1 | `GCD_DONE\|9` | rationals_as_pairs_generator.py |
...
| `GLB` | 1 | `GLB\|40` | partial_order_generator.py |
...
| `GRAPH_CHANGE` | 3 | `GRAPH_CHANGE\|Jan\|Feb\|-5` | graph_interpret_generator.py |
| `GRAPH_DATA` | 2 | `GRAPH_DATA\|bar_chart\|Peaches:16,Strawberries:30,Oranges:26,Grapes:29,Apples:27` | graph_interpret_generator.py |
| `GRAPH_MAX` | 2 | `GRAPH_MAX\|Blue\|48` | graph_interpret_generator.py |
| `GRAPH_MAX_CHANGE` | 3 | `GRAPH_MAX_CHANGE\|Mar\|Apr\|8` | graph_interpret_generator.py |
| `GRAPH_MIN` | 2 | `GRAPH_MIN\|min\|17` | graph_interpret_generator.py |
| `GRAPH_READ` | 2 | `GRAPH_READ\|Peaches\|16` | graph_interpret_generator.py |
...
| `IMAGE` | 2 | `IMAGE\|e\|1` | function_properties_generator.py, mobius_transform_generator.py |
...
| `INEQ_SIMPLIFY` | 1 | `INEQ_SIMPLIFY\|-7x ≤ 7` | domain_range_generator.py, linear_fractional_generator.py, two_step_inequality_generator.py |
...
| `INT_REWRITE` | 2 | `INT_REWRITE\|-9 - 4\|-9 + (-4)` | integer_operations_generator.py |
...
| `INVERSE_PAIR` | 2 | `INVERSE_PAIR\|(g, 2)\|(2, g)` | function_properties_generator.py, relation_operations_generator.py |
...
| `KIN_SETUP` | 3, 4 | `KIN_SETUP\|d = 517 meters\|t = 11 seconds\|speed` | invariant_mass_generator.py, kinematics_generator.py |
...
| `LAW` | 3 | `LAW\|identity\|(p ∨ (((T ∧ p) ∨ s) ∧ (T ∧ p))) ∧ T\|p ∨ (((T ∧ p) ∨ s) ∧ (T ∧ p))` | logical_equivalence_laws_generator.py, set_algebra_laws_generator.py |
| `LAYERNORM_SETUP` | 3 | `LAYERNORM_SETUP\|x=(-2,22)\|gamma=(1,2)\|beta=(-2,-3)` | layer_norm_generator.py |
| `LB` | 2 | `LB\|{40, 44}\|{17, 40}` | partial_order_generator.py |
...
| `LIST_MAX` | 2 | `LIST_MAX\|8/29, 3/10, 69/59\|69/59` | dedekind_cut_generator.py |
...
| `MAP` | 2 | `MAP\|g\|f(g) = 2` | function_properties_generator.py |
...
| `MATRIX_ROW` | 2 | `MATRIX_ROW\|c\|0 1` | graph_counting_generator.py, relation_operations_generator.py |
...
| `MAXIMAL` | 1 | `MAXIMAL\|{49, 52}` | partial_order_generator.py |
...
| `MEMBER` | 1 | `MEMBER\|37/23 ∉ L(√2)` | dedekind_cut_generator.py |
...
| `MEMBER_ROW` | 1, 3 | `MEMBER_ROW\|x∈L, x∈V, x∈X` | foundations_critic_generator.py, set_identity_membership_table_generator.py |
...
| `MINIMAL` | 1 | `MINIMAL\|{1, 48}` | partial_order_generator.py |
...
| `MUL_TERM` | 3 | `MUL_TERM\|6\|(-5/3)x\|-10x` | linear_fractional_generator.py, polynomial_long_division_generator.py, rational_equation_generator.py |
...
| `NEGATE` | 2 | `NEGATE\|391\|-391` | countability_bijection_generator.py |
...
| `NEW_STRING` | 1 | `NEW_STRING\|11111` | cantor_diagonal_generator.py |
...
| `NO_WITNESS` | 2, 3 | `NO_WITNESS\|x=13\|fails y=36\|(13, 36) ∉ R` | peano_arithmetic_generator.py, quantifier_finite_domain_generator.py |
...
| `ORDER_PAIR` | 2 | `ORDER_PAIR\|16 ≤ 37\|reachable in H` | partial_order_generator.py |
...
| `PAIRING` | 2 | `PAIRING\|(194, 141)\|(m + n)(m + n + 1)/2 + n` | cantor_pairing_generator.py |
| `PAIR_RULE` | 1, 2 | `PAIR_RULE\|(a, b) + (c, d)\|(a + c, b + d)` | integers_as_pairs_generator.py, rationals_as_pairs_generator.py |
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|(5x + 25) + (5x - 75) = 180` | angle_relationships_generator.py |
...
| `PARALLEL_SOLVE` | 2 | `PARALLEL_SOLVE\|10x + -50 = 180\|x = 23` | angle_relationships_generator.py |
...
| `PARTITION` | 1 | `PARTITION\|{{1}, {15, 32, 44, 54}, {33}, {38, 45}}` | equivalence_relation_generator.py |
...
| `PATH` | 2 | `PATH\|28→22→38\|add (28, 38)` | relation_closure_generator.py |
...
| `PHYS_SETUP` | 3 | `PHYS_SETUP\|W = 2398 joules\|t = 22 seconds\|power` | physics_formula_generator.py |
...
| `PICTO_COUNT` | 2 | `PICTO_COUNT\|Cars\|5` | graph_interpret_generator.py |
...
| `POLISH` | 1 | `POLISH\|ANKqpCErrNq` | wff_parsing_generator.py |
...
| `POWER_SET_RESULT` | 1 | `POWER_SET_RESULT\|{∅, {n}, {p}, {s}, {n, p}, {n, s}, {p, s}, {n, p, s}}` | set_operations_generator.py |
| `POWER_SHIFT` | 3 | `POWER_SHIFT\|k=0\|0-2\|-2` | laurent_series_generator.py |
| `PREDICATES` | 1 | `PREDICATES\|P(x): x is a driver; S(x): x is reliable` | english_to_logic_generator.py |
| `PREDICT` | 2 | `PREDICT\|x*\|-2/5` | kernel_ridge_generator.py |
| `PREIMAGE` | 2 | `PREIMAGE\|1\|{e, j}` | function_properties_generator.py |
| `PREMISE` | 2 | `PREMISE\|1\|d ∧ c` | natural_deduction_generator.py |
...
| `PROB_CONDITIONAL` | 2 | `PROB_CONDITIONAL\|P(red given first was red)\|4/15` | compound_probability_generator.py |
| `PROB_DEPENDENT` | 1 | `PROB_DEPENDENT\|Drawing without replacement means dependent events` | compound_probability_generator.py |
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Two dice: d5=1, d6=3` | compound_probability_generator.py |
| `PROB_IDENTIFY` | 2 | `PROB_IDENTIFY\|P(first die is 1)\|1/5` | compound_probability_generator.py |
| `PROB_INDEPENDENT` | 1 | `PROB_INDEPENDENT\|The two dice are independent events` | compound_probability_generator.py |
| `PROB_MULTIPLY` | 3 | `PROB_MULTIPLY\|1/5\|1/6\|1/30` | compound_probability_generator.py |
...
| `PROB_SIMPLIFY` | 2 | `PROB_SIMPLIFY\|20/240\|1/12` | compound_probability_generator.py |
...
| `PYTHAG_CALCULATE` | 2 | `PYTHAG_CALCULATE\|d² = 57600 + 1411344 = 1468944\|1468944` | pythag_leg_generator.py |
| `PYTHAG_CONTEXT` | 3 | `PYTHAG_CONTEXT\|displacement\|east=240m, north=1188m\|diagram=AVP` | pythag_leg_generator.py |
| `PYTHAG_FORMULA` | 1 | `PYTHAG_FORMULA\|a² + b² = c²` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_MODEL` | 3 | `PYTHAG_MODEL\|east=240\|north=1188\|distance=?` | pythag_leg_generator.py |
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|360000\|600` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 2, 3 | `PYTHAG_SETUP\|legs=484,1287\|hypotenuse ET=?` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 372100 - 12100\|360000` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|110\|12100` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|110² + b² = 610²` | pythag_leg_generator.py |
...
| `RANGE` | 1 | `RANGE\|{3, 4, 26, 30}` | relation_operations_generator.py |
...
| `RATIO_BASE` | 3 | `RATIO_BASE\|6:9\|3\|2:3` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
| `RATIO_TABLE` | 2 | `RATIO_TABLE\|Distance (miles): 2, 6, 14, 22\|Time (hours): ?, 9, 21, 33` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
...
| `REDUCE` | 2, 3 | `REDUCE\|(200, 313)\|(0, 113)` | integers_as_pairs_generator.py, rationals_as_pairs_generator.py |
...
| `REGION_EQ` | 2 | `REGION_EQ\|A ∩ B\|1` | venn_region_count_generator.py |
...
| `REJECT` | 1, 2 | `REJECT\|x = −37` | cantor_pairing_generator.py, conditional_forms_generator.py, counterexample_search_generator.py, factor_trinomial_generator.py, knights_knaves_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py, set_builder_roster_generator.py, structure_isomorphism_generator.py |
...
| `REL_SETUP` | 2, 3 | `REL_SETUP\|A = {1, 15, 32, 33, 38, 44, 45, 54}\|R = {(1, 1), (15, 15), (15, 32), (15, 44), (15, 54), (32, 15), (32, 32), (32, 44), (32, 54), (33, 33), (38, 38), (38, 45), (44, 15), (44, 32), (44, 44), (44, 54), (45, 38), (45, 45), (54, 15), (54, 32), (54, 44), (54, 54)}` | equivalence_relation_generator.py, relation_check_generator.py, relation_closure_generator.py, relation_operations_generator.py, special_relativity_generator.py |
...
| `REPRESENT` | 2 | `REPRESENT\|even p\|p = 2e` | direct_proof_algebra_generator.py |
...
| `RESTRICT_CHECK` | 3 | `RESTRICT_CHECK\|(k, 6)\|k in D=no\|skip` | relation_operations_generator.py |
...
| `REVERSE` | 2 | `REVERSE\|1,0,0,1,1,1,1,1\|11111001` | base_arithmetic_generator.py, base_conversion_generator.py, bitwise_ops_generator.py |
...
| `ROOT_EXTRACT` | 2 | `ROOT_EXTRACT\|14` | exponent_generator.py |
| `ROOT_IDENTIFY` | 3 | `ROOT_IDENTIFY\|196\|perfect_square\|14` | exponent_generator.py |
| `ROOT_SETUP` | 1 | `ROOT_SETUP\|√196` | exponent_generator.py, radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
| `ROOT_SIMPLIFY` | 1, 2 | `ROOT_SIMPLIFY\|12√29` | complex_quadratic_generator.py, distance_formula_generator.py, dot_product_generator.py, euler_formula_generator.py, exponent_generator.py, geometric_mean_generator.py, hypercube_counting_generator.py, polar_parametric_generator.py, vector_ops_generator.py |
| `ROSTER` | 2 | `ROSTER\|S\|{−36, −35, −34, −32, −30}` | set_builder_roster_generator.py |
...
| `SA_BASES` | 2 | `SA_BASES\|2π(17)² = 2π × 289\|578π` | volume_3d_generator.py |
| `SA_FACES` | 3 | `SA_FACES\|top/bottom\|3 × 12\|36` | volume_3d_generator.py |
| `SA_FORMULA` | 1 | `SA_FORMULA\|SA = 2(lw + lh + wh)` | round_solids_generator.py, volume_3d_generator.py |
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 17 × 47\|1598π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=3, w=12, h=4` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(36 + 12 + 48)\|192` | round_solids_generator.py, volume_3d_generator.py |
...
| `SCALE_DIV` | 3 | `SCALE_DIV\|2184\|56\|39` | scaling_generator.py |
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|1*cos\|0` | de_moivre_generator.py, euler_formula_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|2184 feet\|scaled_dimension` | scaling_generator.py |
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = -1\|(-2)\|-2` | diagonalization_generator.py |
| `SCALE_MULT` | 3 | `SCALE_MULT\|19.75\|3\|59.25` | scaling_generator.py |
| `SCALE_SETUP` | 3 | `SCALE_SETUP\|1 inch\|56 feet\|56` | scaling_generator.py |
...
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|4.42\|11` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|right\|11` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|multiply_coefficients\|3.9\|2.8\|10.92` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|(3.9 × 10^5) × (2.8 × 10^5)` | exponent_generator.py |
...
| `SEPARATOR` | 3 | `SEPARATOR\|35/24\|in L(3/2)\|not in L(√2)` | dedekind_cut_generator.py |
...
| `SET_SETUP` | 2, 3, 4 | `SET_SETUP\|A = {g, q, r}\|B = {9, 19}\|A × B` | set_expression_generator.py, set_operations_generator.py |
...
| `SIMILAR_APPLY` | 3 | `SIMILAR_APPLY\|7\|1.5\|10.5` | scaling_generator.py |
| `SIMILAR_SCALE` | 3 | `SIMILAR_SCALE\|18\|9\|2` | scaling_generator.py |
| `SIMILAR_SETUP` | 3 | `SIMILAR_SETUP\|square\|9\|18` | scaling_generator.py |
...
| `SPECIAL_SOLUTION` | 2 | `SPECIAL_SOLUTION\|-2 = -2\|identity: true for every x` | radical_equation_generator.py, special_solution_equation_generator.py |
...
| `SQRT_SETUP` | 2 | `SQRT_SETUP\|N = 576\|groups 05, 76` | manual_square_root_generator.py |
...
| `STATEMENT_EVAL` | 3 | `STATEMENT_EVAL\|Cleo says Kira and Dara are different types\|F\|contradiction` | knights_knaves_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(53 + 60) / 2\|56.5` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|6` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|31\|30\|1` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|210 / 6\|35` | statistics_generator.py |
...
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|position 4\|86` | statistics_generator.py |
...
| `STAT_ORDER` | 1 | `STAT_ORDER\|35, 44, 50, 86, 95, 96, 97` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|95 - 17\|78` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|42, 19, 46, 45, 38, 20` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|42 + 19 + 46 + 45 + 38 + 20\|210` | statistics_generator.py |
...
| `SUBEXPR` | 2 | `SUBEXPR\|A ∪ B\|{11, 19, 21, 25, 26, 32, 34, 36, 37, 38}` | set_expression_generator.py, set_operations_generator.py |
...
| `TABLEAU_ROOT` | 1 | `TABLEAU_ROOT\|¬j ∨ ((w ∧ ¬w) ∨ ¬h)` | semantic_tableau_generator.py |
...
| `TOPO_PICK` | 2 | `TOPO_PICK\|available {1, 35, 41}\|pick 1` | partial_order_generator.py |
...
| `TRANSLATE` | 2 | `TRANSLATE\|No student is curious\|∀w (C(w) → ¬J(w))` | quantifier_negation_generator.py |
...
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|27\|76\|x` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|x = 180 - 27 - 76\|77` | angle_relationships_generator.py |
| `TRI_ANGLE_SUM` | 1 | `TRI_ANGLE_SUM\|27 + 76 + x = 180` | angle_relationships_generator.py |
...
| `UB` | 2 | `UB\|{40, 44}\|{44}` | partial_order_generator.py |
...
| `UNFOLD` | 2 | `UNFOLD\|Ack(2, 1)\|Ack(1, Ack(2, 0))` | recursive_definition_unfold_generator.py |
...
| `UNIT_ATTACH` | 3 | `UNIT_ATTACH\|47\|m/s\|47 m/s` | cross_section_generator.py, kinematics_generator.py, physics_formula_generator.py |
...
| `UNIT_RATE_DIV` | 3 | `UNIT_RATE_DIV\|90¢\|3\|30¢` | unit_rate_generator.py |
| `UNIT_RATE_PICK` | 2 | `UNIT_RATE_PICK\|3\|15` | unit_rate_generator.py |
| `UNIT_RATE_SETUP` | 3 | `UNIT_RATE_SETUP\|3\|cookies\|90¢` | unit_rate_generator.py |
| `UNIT_RATE_TABLE` | 2 | `UNIT_RATE_TABLE\|3,8,9\|15,40,45` | unit_rate_generator.py |
...
| `UNPAIR` | 2 | `UNPAIR\|545\|(15, 17)` | cantor_pairing_generator.py |
...
| `VENN_MARK` | 2 | `VENN_MARK\|pilots ∩ inventors\|x1` | syllogism_generator.py |
| `VENN_SHADE` | 2 | `VENN_SHADE\|writers ∩ inventors\|empty` | syllogism_generator.py |
...
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 9 × 10\|45.0` | round_solids_generator.py, volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 3 × 11 × 15\|495` | round_solids_generator.py, volume_3d_generator.py |
| `VOL_FORMULA` | 1 | `VOL_FORMULA\|V = l × w × h` | round_solids_generator.py, solid_revolution_generator.py, volume_3d_generator.py |
| `VOL_SETUP` | 2 | `VOL_SETUP\|rectangular_prism\|l=3, w=11, h=15` | volume_3d_generator.py |
...
| `WARSHALL_K` | 2 | `WARSHALL_K\|k=20\|0 0 1; 1 0 1; 1 0 1` | relation_closure_generator.py |
