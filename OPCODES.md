...
1750 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|4x - 5 = 19` | absolute_value_equation_generator.py |
...
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(3x - 1) = 0` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Single case\|3x - 1 = 0` | absolute_value_equation_generator.py |
...
| `ACT_DERIV` | 3 | `ACT_DERIV\|relu\|18\|1` | activation_generator.py |
| `ACT_SETUP` | 3 | `ACT_SETUP\|activation=relu\|x=-4\|w1=-4,b1=2,w2=3,b2=2` | activation_generator.py |
| `ACT_VALUE` | 3 | `ACT_VALUE\|relu\|18\|18` | activation_generator.py |
...
| `AC_SETUP` | 3 | `AC_SETUP\|resonance\|R=20, L=12\|C=1/768` | ac_circuit_generator.py |
| `ADAM_SETUP` | 3 | `ADAM_SETUP\|theta=6,g=-10\|beta1=9/10,beta2=99/100\|lr=1/10,epsilon=0` | adam_step_generator.py |
| `ADAM_UPDATE` | 2 | `ADAM_UPDATE\|theta_new\|61/10` | adam_step_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 10/20, P(B) = 2/20, mutually exclusive\|P(A ∪ B)` | probability_addition_rule_generator.py |
| `ADJOINT` | 1 | `ADJOINT\|A^dagger=[[4,4],[4,4]]` | hermitian_check_generator.py |
| `ADJ_LIST` | 2 | `ADJ_LIST\|A\|B, C, E` | euler_circuit_generator.py, graph_traversal_generator.py |
| `ALG_SETUP` | 3 | `ALG_SETUP\|insertion sort\|passes 4\|values 34, 15, 2, 22, 13, 18` | algorithm_trace_generator.py |
...
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda d. (d b)\|lambda z. (z b)` | lambda_reduction_generator.py |
| `AMORT_ROW` | 3 | `AMORT_ROW\|1\|interest=$928.00\|principal=$256.00,balance=$3456.00` | annuity_generator.py |
| `AMPLITUDE` | 2 | `AMPLITUDE\|abs(-1)\|1` | sinusoid_features_generator.py |
| `ANALOGY_SETUP` | 3 | `ANALOGY_SETUP\|man=(2,2)\|woman=(2,0)\|king=(-1,2)` | embedding_similarity_generator.py |
| `ANALOGY_VECTOR` | 2 | `ANALOGY_VECTOR\|king-man+woman\|(-1,0)` | embedding_similarity_generator.py |
| `ANGLE` | 2 | `ANGLE\|theta\|pi/2` | positional_encoding_generator.py |
| `ANGLE_DEFECT_SETUP` | 2 | `ANGLE_DEFECT_SETUP\|R=7\|angles=30,15,45` | angle_defect_generator.py |
...
| `ANGLE_WRAP` | 2 | `ANGLE_WRAP\|292 deg\|-68 deg` | complex_log_generator.py |
| `ANNUITY_FORMULA` | 1 | `ANNUITY_FORMULA\|FV(due) = PMT*((1+r)^n - 1)/r*(1+r)` | annuity_generator.py |
| `ANNUITY_SETUP` | 2, 3 | `ANNUITY_SETUP\|annuity due future value\|PMT=6090,r=10%,n=3` | annuity_generator.py |
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|-4x\|-2x^2` | antiderivative_generator.py, arc_length_generator.py, area_between_curves_generator.py, definite_integral_generator.py, improper_integral_generator.py, integrating_factor_generator.py, integration_by_parts_generator.py, ode_substitution_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py, variation_parameters_generator.py |
...
| `APPLY_GATE` | 3 | `APPLY_GATE\|CNOT\|e^(i157π/138)·ket01\|e^(i157π/138)·ket01` | quantum_gate_generator.py |
| `APPLY_OPERATOR` | 2 | `APPLY_OPERATOR\|L[Ae^(-2x)]\|A(4 - 2 - 6)e^(-2x)` | commutator_generator.py, undetermined_coeff_generator.py |
| `APPLY_PAULI` | 2 | `APPLY_PAULI\|sigma_y psi\|[-24i/25,7i/25]` | spin_half_generator.py |
| `APPLY_SUBST` | 1 | *(not observed in sampling)* | unification_generator.py |
| `APPROX` | 2 | `APPROX\|12*d^2*L\|221184000` | param_count_generator.py |
| `APPROX_ENTRY` | 2 | `APPROX_ENTRY\|(1,1)\|8` | low_rank_approx_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 37, central angle 5°\|arc length` | arc_sector_generator.py |
| `AREA` | 1 | `AREA\|66` | geometry_area_perimeter_generator.py |
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|2*5^3/3\|250/3` | centroid_generator.py |
| `AREA_INTEGRAL` | 2 | `AREA_INTEGRAL\|sqrt(EG-F^2)=R\|area = R*theta*h` | fundamental_form_generator.py |
| `AREA_SCALE` | 3 | `AREA_SCALE\|uv rectangle area\|4*9\|36` | jacobian_generator.py |
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 + 6x - 9 and y = 19x - 49\|area between the curves` | area_between_curves_generator.py |
...
| `ARITH_INTERVAL` | 1 | `ARITH_INTERVAL\|[1/4,1/2)` | arithmetic_coding_generator.py |
| `ARITH_SETUP` | 2 | `ARITH_SETUP\|A=1/4, B=1/4, C=1/4, D=1/4\|message=BCBC` | arithmetic_coding_generator.py |
| `ARITH_SYMBOL` | 2 | `ARITH_SYMBOL\|B\|cum=[1/4,1/2)` | arithmetic_coding_generator.py |
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|15, 34, 2, 22, 13, 18` | algorithm_trace_generator.py |
...
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = -5 ± (2/3)(x + 4)` | hyperbola_features_generator.py |
| `ATA` | 2 | `ATA\|A^T A\|[[4825, 1104], [1104, 4825]]` | svd_generator.py |
| `ATOM_CHECK` | 3 | `ATOM_CHECK\|Al\|left=4\|right=4` | stoichiometry_generator.py |
| `ATTN_OUTPUT` | 2 | `ATTN_OUTPUT\|1\|[[1,4]]` | attention_generator.py |
...
| `BACKPROP_SETUP` | 3 | `BACKPROP_SETUP\|x=(1,-3)\|y=3\|eta=1/8` | backprop_generator.py |
| `BACK_SUB` | 2 | `BACK_SUB\|u = 1/y\|y = 1/(1 + 5e^(2x))` | ode_substitution_generator.py |
| `BACK_SUB_ROW` | 3 | `BACK_SUB_ROW\|r=83\|x=1\|y=0` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 60, disease=no 168\|sensitivity 5/6, specificity 7/8\|P(disease=yes given test positive)` | conditional_probability_generator.py |
| `BAYES_UPDATE_SETUP` | 2, 3 | `BAYES_UPDATE_SETUP\|beta_binomial\|prior=Beta(1,6)\|successes=11, trials=23` | bayesian_update_generator.py |
| `BCH_FORM` | 2 | `BCH_FORM\|A+B+1/2[A,B]\|[[0, -3, 3/2], [0, 0, -1], [0, 0, 0]]` | bch_generator.py |
| `BCH_SETUP` | 3 | `BCH_SETUP\|A=-3E12\|B=-E23\|order=2` | bch_generator.py |
...
| `BEZOUT_CHECK` | 2 | `BEZOUT_CHECK\|83*-13 + 60*18\|1` | extended_euclid_generator.py |
...
| `BINARY_EXPONENT` | 2 | `BINARY_EXPONENT\|46\|101110` | mod_exp_generator.py, quadratic_residue_generator.py |
| `BINOM_FORMULA` | 1 | `BINOM_FORMULA\|P(X ≤ k) = Σ C(n,i)·p^i·(1-p)^(n-i)` | binomial_probability_generator.py |
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 3, p = 1/2\|P(X ≤ 1)` | binomial_probability_generator.py |
| `BISECTION_SETUP` | 3 | `BISECTION_SETUP\|f(x)=x^2-158\|interval=[12, 13]\|iterations=4` | bisection_generator.py |
...
| `BLACKBODY_SETUP` | 3 | `BLACKBODY_SETUP\|stefan_power\|sigma=10, A=1\|T=2` | blackbody_generator.py |
| `BOND_FORMULA` | 1 | `BOND_FORMULA\|price=sum coupon/(1+y)^t + face/(1+y)^n` | bond_pricing_generator.py |
| `BOND_PRICE` | 1 | `BOND_PRICE\|$6500.00` | bond_pricing_generator.py |
| `BOND_SETUP` | 2 | `BOND_SETUP\|face=6500\|coupon=10%,ytm=10%,years=4` | bond_pricing_generator.py |
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables J, K, L\|DNF from F=1 rows` | boolean_algebra_generator.py |
...
| `BOX_SETUP` | 1, 3 | `BOX_SETUP\|energy_level\|n=2, h=7\|m=11, L=2` | particle_in_box_generator.py |
| `BRAKET_FORMULA` | 1 | `BRAKET_FORMULA\|inner(phi,psi)=sum conj(phi_k)*psi_k` | braket_generator.py |
| `BRAKET_SETUP` | 3 | `BRAKET_SETUP\|inner_product\|phi=[0,1-i]\|psi=[1-i,0]` | braket_generator.py |
...
| `BS_RESULT` | 2 | `BS_RESULT\|call=13.875\|put=6.375` | black_scholes_generator.py |
| `BS_SETUP` | 3 | `BS_SETUP\|S=150,K=150\|df=0.95\|N_d1=0.9,N_d2=0.85` | black_scholes_generator.py |
...
| `CASHFLOW_PV` | 2 | `CASHFLOW_PV\|coupon_t1\|6500/11` | bond_pricing_generator.py |
| `CASIMIR_FORCE_SETUP` | 2 | `CASIMIR_FORCE_SETUP\|F/A=-π^2*hbar*c/(240*d^4)\|hbar=17,c=6,d=1` | casimir_force_generator.py |
| `CASIMIR_SETUP` | 3 | `CASIMIR_SETUP\|spin=5/2\|hbar=25/6\|J^2=Jz^2+(J+J-+J-J+)/2` | casimir_generator.py |
...
| `CBRT` | 2 | `CBRT\|8r^6\|2r^2` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
...
| `CEIL` | 2 | `CEIL\|1475.1744\|1476` | confidence_interval_generator.py |
| `CENTER` | 1, 2 | `CENTER\|(6, -1)` | circle_equation_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, pca_generator.py |
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(625/2)/(250/3)\|15/4` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= 2*x^2\|0 <= x <= 5\|centroid` | centroid_generator.py |
| `CENTROID_UPDATE` | 2 | `CENTROID_UPDATE\|C1\|(1,-5/2)` | kmeans_step_generator.py |
| `CF_PARTIAL` | 2 | `CF_PARTIAL\|a_0\|5` | continued_fraction_generator.py |
| `CF_RESULT` | 1 | `CF_RESULT\|[5; 1, 15, 2, 1, 2]` | continued_fraction_generator.py |
| `CF_SETUP` | 1 | `CF_SETUP\|778/131` | continued_fraction_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*x_s + f_y*y_s\|(-32)*4 + 22*4\|-40` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(0,1)\|1 + (-4)\|-3` | multivar_chain_rule_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(-6 - 0)*20\|-120` | vector_theorem_generator.py |
| `CI_FORMULA` | 1 | `CI_FORMULA\|x̄ ± E` | confidence_interval_generator.py |
| `CI_SETUP` | 2 | `CI_SETUP\|p̂ = 0.6, E = 0.025, z* = 1.96\|minimum sample size for the proportion` | confidence_interval_generator.py |
...
| `CLAUSE` | 2 | `CLAUSE\|C1\|(¬P25030 ∨ P67367)` | resolution_proof_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(C OR D OR E) AND (C OR D OR NOT E) AND (C OR NOT D OR E) AND (NOT C OR D OR E) AND (NOT C OR D OR NOT E) AND (NOT C OR NOT D OR E)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|-21600` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|2, -8, -11, 1, 24` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COEFF_MATCH` | 2 | `COEFF_MATCH\|x^n\|(n+1)a_(n+1) = -a_n` | series_solution_generator.py |
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=4, j=5\|4+5=9\|15` | generating_function_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[-3, 4], [1, 3]]` | determinant_generator.py |
| `COLLIDER_SETUP` | 3 | `COLLIDER_SETUP\|luminosity\|N=213 events\|sigma=27 fb` | cross_section_generator.py |
| `COLLISION` | 1 | `COLLISION\|f(g) = f(h) = 4` | function_properties_generator.py |
| `COLLISION_SETUP` | 3 | `COLLISION_SETUP\|inelastic_2d\|m1=14, v1=(1,-11)\|m2=4, v2=(8,0)` | collision_generator.py |
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2, 3\|[[4, 1, 7], [3, 1, 5], [-3, 0, -5]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(6,1)\|6` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = 5*v1 - 9*v2\|[-4, -9]` | diagonalization_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|7 - (-2)\|9` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|10/1\|10` | geometric_sequence_generator.py, recursive_explicit_generator.py |
| `COMMUTATOR` | 2 | `COMMUTATOR\|[A,B]\|[[9i/2, 0], [0, -9i/2]]` | structure_constant_generator.py |
| `COMM_ENTRY` | 3 | `COMM_ENTRY\|(1,1)\|9i/4 - -9i/4\|9i/2` | structure_constant_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|3x - 2 < -2 -> x < 0` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|-4 < 3x + 2 < 5` | compound_inequality_generator.py |
...
| `COND_COUNT` | 2 | `COND_COUNT\|club=no and commute=bike\|4` | conditional_probability_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 15, no/bike 4, yes/bus 9, no/bus 13\|P(club=no given commute=bike)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|commute=bike total\|15 + 4 = 19` | conditional_probability_generator.py |
| `CONGRUENCE_REDUCE` | 2 | `CONGRUENCE_REDUCE\|35x congruent to 13\|mod 16` | modular_inverse_generator.py |
| `CONGRUENCE_SOLUTIONS` | 3 | `CONGRUENCE_SOLUTIONS\|base 15\|step 16\|15, 31, 47, 63` | modular_inverse_generator.py |
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|y^2 = -4x\|vertex, focus, directrix` | conic_standard_form_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `CONSERVATION_SETUP` | 2 | `CONSERVATION_SETUP\|pi0 + pi0 + pi+ -> pi0 + mu+ + gamma + nu_mu\|check=Q,B,Le,Lmu` | conservation_law_generator.py |
| `CONSERVE_CHECK` | 3 | `CONSERVE_CHECK\|Q\|left=1,right=1\|conserved` | conservation_law_generator.py |
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|5*x + y = 231\|lambda*(25/4 + 1/6) = 231\|lambda = 36` | lagrange_multiplier_generator.py |
| `CONST_SOLVE` | 2 | `CONST_SOLVE\|C1 = 1\|C2 = 4` | recurrence_generator.py |
| `CONTOUR_SETUP` | 3 | `CONTOUR_SETUP\|abs(z)=2\|positive orientation\|f=6/(z-1) - 3/(z+2) + 3/(z+1)` | contour_integral_generator.py |
| `CONTRADICTION` | 2 | `CONTRADICTION\|r−d is nonnegative and in S\|r−d < r` | induction_verify_generator.py |
| `CONT_DIST_SETUP` | 3 | `CONT_DIST_SETUP\|f(x)=k*x\|support=[0,13]\|interval=(11,12)` | continuous_distribution_generator.py |
| `CONVERGENT` | 2 | `CONVERGENT\|i=0\|5/1` | continued_fraction_generator.py |
| `CONVERGE_CHECK` | 2 | `CONVERGE_CHECK\|abs(r) = 1/12 < 1\|converges` | geometric_sequence_generator.py, series_convergence_generator.py |
...
| `CONV_SETUP` | 2, 3 | `CONV_SETUP\|x=[2,8,0,4,4]\|h=[2,2,9]` | convolution_generator.py, convolutional_code_viterbi_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[5, -9]` | diagonalization_generator.py |
| `CORRECT_BIT` | 3 | `CORRECT_BIT\|position=1\|0->1\|corrected=1110000` | hamming_code_generator.py |
...
| `COSET` | 2 | `COSET\|1H\|{1, 23}` | coset_generator.py |
| `COSET_ELEM` | 2 | `COSET_ELEM\|1H\|1` | coset_generator.py |
| `COSET_SKIP` | 2 | `COSET_SKIP\|23\|already listed` | coset_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|Catalan C_4` | counting_classics_generator.py |
| `COUPON` | 1 | `COUPON\|650` | bond_pricing_generator.py |
...
| `CRC_CHECK` | 3 | `CRC_CHECK\|codeword=1001011\|remainder=000\|valid` | crc_generator.py |
| `CRC_REMAINDER` | 1 | `CRC_REMAINDER\|011` | crc_generator.py |
| `CRC_SETUP` | 3 | `CRC_SETUP\|data=1001\|poly=1101\|augmented=1001000` | crc_generator.py |
| `CRC_SKIP` | 2 | `CRC_SKIP\|i=3\|leading bit 0` | crc_generator.py |
| `CRC_XOR` | 3 | `CRC_XOR\|i=0\|1001 xor 1101\|0100` | crc_generator.py |
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|-2*x - 2*y - 2 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|(-2)*(-8) - (-2)^2\|12` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=3\|ln(12)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|10·EF = 35·10` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CROSS_RATIO` | 1 | `CROSS_RATIO\|11/8` | mobius_transform_generator.py |
| `CROSS_RATIO_SETUP` | 4 | `CROSS_RATIO_SETUP\|z1=4\|z2=-5\|z3=7\|z4=6` | mobius_transform_generator.py |
...
| `CRT_TERM` | 2 | `CRT_TERM\|i=1\|42` | crt_generator.py |
| `CRT_TOTAL_MODULUS` | 2 | `CRT_TOTAL_MODULUS\|4, 7\|28` | crt_generator.py |
| `CR_SETUP` | 2 | `CR_SETUP\|u=-x^2 + y^2 + 5x + 5y\|v=-2xy - 5x + 6y` | cauchy_riemann_generator.py |
| `CUM_INTERVAL` | 2 | `CUM_INTERVAL\|A\|[0,1/4)` | arithmetic_coding_generator.py |
| `CURL_COMPONENT` | 3 | `CURL_COMPONENT\|Q_x - P_y\|1 - 4\|-3` | div_curl_generator.py |
...
| `CURVE_GEOM_SETUP` | 3 | `CURVE_GEOM_SETUP\|r(t) = <-3*t - 2, -4*t - 5>\|0 <= t <= 12\|arc length` | curve_geometry_generator.py |
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 9x^2 + 24x - 5\|inflection point and concavity` | curve_analysis_generator.py |
...
| `CX_A` | 3 | `CX_A\|0\|-24i/25\|-24i/25` | braket_generator.py, spin_half_generator.py |
| `CX_M` | 3 | `CX_M\|0\|7/25\|0` | braket_generator.py, spin_half_generator.py |
| `CX_SETUP` | 2 | `CX_SETUP\|i^20\|simplify` | complex_division_generator.py, complex_number_ops_generator.py |
| `CYCLE` | 1 | `CYCLE\|(1 2)` | permutation_group_generator.py |
| `CYCLE_LENGTHS` | 1 | `CYCLE_LENGTHS\|2, 2` | permutation_group_generator.py |
| `CYCLE_REJECT` | 2 | `CYCLE_REJECT\|BF\|endpoints already connected` | mst_generator.py |
| `CYCLE_TRACE` | 2 | `CYCLE_TRACE\|start 1\|1->2->1` | permutation_group_generator.py |
| `CYCLIC_START` | 2 | `CYCLIC_START\|12\|identity 0` | cyclic_group_generator.py |
| `CYCLIC_SUBGROUP` | 2 | `CYCLIC_SUBGROUP\|{0, 12, 24, 7, 19, 2, 14, 26, 9, 21, 4, 16, 28, 11, 23, 6, 18, 1, 13, 25, 8, 20, 3, 15, 27, 10, 22, 5, 17}\|29` | cyclic_group_generator.py |
| `CYK_CELL` | 2 | `CYK_CELL\|1,2\|{S,U}` | cyk_parser_generator.py |
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|U U\|{S}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|S\|U U or V S` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string ddde\|length 4` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{U,V} x {U,V}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|d\|{U,V}` | cyk_parser_generator.py |
...
| `DEMOIVRE_SETUP` | 2, 4 | `DEMOIVRE_SETUP\|power\|r=2\|theta=225 deg\|n=4` | de_moivre_generator.py |
| `DENSITY` | 2 | `DENSITY\|f_X(x)\|1/8` | rv_transform_generator.py |
| `DENSITY_MATRIX` | 1 | `DENSITY_MATRIX\|rho=[[2/11,0],[0,9/11]]` | density_matrix_generator.py |
| `DENSITY_SETUP` | 2, 3 | `DENSITY_SETUP\|state=plus_phase_0\|psi=(ket00 + e^(i73π/202)ket10)/sqrt(2)` | density_matrix_generator.py, partial_trace_generator.py |
...
| `DERIV` | 2, 3 | `DERIV\|d_r g_thetatheta = 2r\|at r=7\|14` | christoffel_generator.py, gaussian_curvature_generator.py, riemann_tensor_generator.py |
| `DERIVATIVE` | 1, 2 | `DERIVATIVE\|g'(x)\|2/5` | fixed_point_generator.py, mgf_generator.py, mle_generator.py |
| `DERIVED` | 2 | `DERIVED\|C5\|(¬P25030)` | resolution_proof_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 5x^5 + 6x^4 - x^3 + x^2\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -3], [1, -1], [1, 1], [1, 3]]\|y = [3, 7, 13, 21]` | least_squares_generator.py |
| `DET` | 2 | `DET\|K\|10` | kernel_ridge_generator.py, kernel_validity_generator.py |
...
| `DEV_ROW` | 3 | `DEV_ROW\|24\|0\|0` | standard_deviation_generator.py |
...
| `DFT_SETUP` | 2 | `DFT_SETUP\|N=4\|x=[1,6,1,9]` | dft_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[1, 3], [1, 2]]\|D = [[-2, 0], [0, 7]]\|P^-1 = [[-2, 3], [1, -1]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[-33, -69, -105]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 3*x^2 + 5*y^2 - 4*x*y - 3*x - 2*y\|point (3, 3)\|dx=-1/4, dy=1/4` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|3*(-1/4) + 16*1/4\|3.25` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|4624\|-457776\|462400` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `DISC_CLASSIFY` | 2 | `DISC_CLASSIFY\|-31 < 0\|no real solutions` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-4x - 27 = 13` | systems_substitution_generator.py |
...
| `DIST_SETUP` | 3 | `DIST_SETUP\|normal\|mu=1,sigma=4\|x=5` | named_distribution_generator.py |
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited D\|A=6, B=7, C=3, D=0` | dijkstra_generator.py |
...
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y\|-1 + 5\|4` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|12y^2\|4y\|3y` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT J AND NOT K AND L) OR (NOT J AND K AND NOT L) OR (NOT J AND K AND L) OR (J AND NOT K AND L) OR (J AND K AND L)` | boolean_algebra_generator.py |
...
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|radicand ≥ 0\|t - 5 ≥ 0` | domain_range_generator.py |
...
| `DOPPLER_SETUP` | 3 | `DOPPLER_SETUP\|acoustic_toward\|f=269, v=61\|v_observer=10, v_source=5` | doppler_generator.py |
| `DOT` | 2, 3 | `DOT\|(15, 25) · (5/13, 12/13)\|15*5/13 + 25*12/13\|375/13` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `DOUBLE_SETUP` | 2, 3 | `DOUBLE_SETUP\|integrand 2\|x:0..2\|y:0..2*x` | double_integral_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=2,v=8); 2:(w=3,v=5); 3:(w=1,v=9)` | dp_table_generator.py |
...
| `D_POWER` | 2 | `D_POWER\|D^3\|[[27, 0], [0, 512]]` | diagonalization_generator.py |
...
| `ECDSA_SETUP` | 4 | `ECDSA_SETUP\|E/F_17, G=(5,1), n=19\|d=7\|z=3\|k=15` | ecdsa_generator.py |
...
| `EC_POINT_CHECK` | 3 | `EC_POINT_CHECK\|P\|y^2 mod p = 6\|x^3+ax+b mod p = 6` | elliptic_curve_finite_field_generator.py |
...
| `EC_SCALAR_SETUP` | 2 | `EC_SCALAR_SETUP\|k=6\|P=(13,7)` | elliptic_curve_finite_field_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|CD\|weight 6\|add D` | mst_generator.py |
...
| `EDGE_LIST` | 1 | `EDGE_LIST\|AB, AE, BE, CD, CE, DE` | euler_circuit_generator.py |
...
| `EIGENVECTOR` | 2 | `EIGENVECTOR\|A - 1I times v = 0\|[1, 0]` | diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, svd_generator.py |
| `EIGEN_CHECK` | 3 | `EIGEN_CHECK\|sigma_z psi\|1*psi\|lambda=1` | spin_half_generator.py |
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A - 1I\|[[0, -2], [0, 2]]` | eigenvalue_generator.py |
| `EINSTEIN_SETUP` | 2, 3 | `EINSTEIN_SETUP\|trace\|T_ij=[[6, 1, -1], [4, 1, -4], [0, -2, 4]]` | einstein_summation_generator.py |
| `ELEC_FORMULA` | 1 | `ELEC_FORMULA\|V=sum(q_i/r_i)` | electrostatics_generator.py |
| `ELEC_SETUP` | 2, 3 | `ELEC_SETUP\|potential_axis\|q1=7, r1=12\|q2=9, r2=6` | electrostatics_generator.py |
...
| `EL_SOLVE` | 2 | `EL_SOLVE\|yddot\|25/7` | lagrangian_generator.py |
...
| `ENERGY_LEVEL` | 2 | `ENERGY_LEVEL\|E_8=hbar*omega*(n+1/2)\|340` | ladder_operator_generator.py |
| `ENERGY_SETUP` | 3 | `ENERGY_SETUP\|work_energy\|m=10\|vi=11, W=3600` | energy_conservation_generator.py |
...
| `ENGINE_SETUP` | 3 | `ENGINE_SETUP\|engine_efficiency\|Qh=32\|Qc=17` | heat_engine_generator.py |
| `ENQUEUE` | 3 | `ENQUEUE\|D\|from F\|D` | graph_traversal_generator.py |
...
| `EQUILIBRIA` | 2 | `EQUILIBRIA\|f(y) = 0\|y=-13, y=-8` | stability_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(-2, 10)\|(4, 14)` | equation_from_two_points_generator.py |
...
| `EQ_OP_NOTE` | 3 | `EQ_OP_NOTE\|add\|d\|to both sides` | equation_from_two_points_generator.py, literal_equation_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, standard_form_conversion_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|50549 × 41856 ≈ 50000 × 40000\|2000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|83\|60\|1\|23` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|A\|route suffix A\|stack A-B-E` | euler_circuit_generator.py |
| `EULER_CRITERION` | 2 | `EULER_CRITERION\|7^5 mod 11\|10` | quadratic_residue_generator.py |
...
| `EULER_ROUTE` | 2 | `EULER_ROUTE\|A-B-E-C-D-E-A\|uses 6 edges` | euler_circuit_generator.py |
| `EULER_SETUP` | 2, 3 | `EULER_SETUP\|polyhedral torus grid: V = 20, E = 40, F = 20\|V - E + F` | euler_characteristic_generator.py, euler_formula_generator.py |
...
| `EV_SETUP` | 2 | `EV_SETUP\|P(win $8) = 1/10; P(win $10) = 1/5; P(win $4) = 7/10\|fair? cost = $2` | expected_value_generator.py |
...
| `EXPECTATION` | 3 | `EXPECTATION\|E[X]=1/50\|E[Y]=1/50\|E[XY]=53/10000` | joint_distribution_generator.py |
...
| `EXP_CELL` | 2 | `EXP_CELL\|(80·240)/400\|48` | chi_square_generator.py |
...
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|83\|60` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `FACTOR_FORM` | 2 | `FACTOR_FORM\|70\|2 * 5 * 7` | totient_generator.py |
| `FACTOR_FOUND` | 2 | `FACTOR_FOUND\|2\|1` | totient_generator.py |
| `FACTOR_GROUP` | 3 | `FACTOR_GROUP\|3n^2 + 2n\|n\|(3n + 2)` | conic_standard_form_generator.py, curve_analysis_generator.py, derivative_limit_def_generator.py, factor_grouping_generator.py, factor_trinomial_generator.py |
| `FACTOR_PAIR_GOAL` | 2 | `FACTOR_PAIR_GOAL\|m·n = -36\|m + n = 5` | factor_trinomial_generator.py |
| `FACTOR_SETUP` | 1 | `FACTOR_SETUP\|70` | totient_generator.py |
...
| `FEATURE_MAP_SETUP` | 3 | `FEATURE_MAP_SETUP\|K(x,z)=(xz+2)^2\|phi(t)=(t^2,2t,2)\|x=-4,z=9` | feature_map_generator.py |
...
| `FERMAT_SETUP` | 3 | `FERMAT_SETUP\|prime 11\|base 48\|exponent 59` | totient_generator.py |
...
| `FINITE_DIFF_SETUP` | 3 | `FINITE_DIFF_SETUP\|table\|x=[1, 4, 7, 10]\|y=[1, -32, -101, -206]` | finite_difference_generator.py |
...
| `FIRSTLAW_SETUP` | 3 | `FIRSTLAW_SETUP\|isochoric\|Q=-66\|W=0` | first_law_generator.py |
...
| `FIXED_POINT_SETUP` | 3 | `FIXED_POINT_SETUP\|g(x)=2/5*x+8/5\|x0=-5\|iterations=4` | fixed_point_generator.py |
| `FIXED_POINT_UPDATE` | 3 | `FIXED_POINT_UPDATE\|1\|x_0=-5\|x_1=-2/5` | fixed_point_generator.py |
| `FLAG` | 2 | `FLAG\|3\|56 ÷ 7 = 8, not 9` | error_spotting_generator.py |
| `FLOOR_DIV` | 3 | `FLOOR_DIV\|6\|2\|3` | algorithm_trace_generator.py |
| `FLOPS_SETUP` | 2 | `FLOPS_SETUP\|rule=2mnk\|m=128,d=512,h=256,o=32` | flops_memory_generator.py |
| `FLUX_SUM` | 2 | `FLUX_SUM\|(2 + 5 + 2)*64\|576` | vector_theorem_generator.py |
| `FOCUS` | 1 | `FOCUS\|(-1, 0)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: 6 * 2\|12` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: 7i * 2\|14i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(5 + √2)(6 + √2)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FOURIER_SETUP` | 3 | `FOURIER_SETUP\|square\|A=10\|n=2` | fourier_series_generator.py |
| `FOUR_VECTOR_SETUP` | 3 | `FOUR_VECTOR_SETUP\|signature=+---\|p=[-1,2,0,2]\|q=[3,-5,-7,0]` | four_vector_generator.py |
...
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|21/-20\|-21/20` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|43/40\|1.075` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Red: 7, Blue: 4, Green: 7, Yellow: 10\|total count` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(f/g)(-3)\|f(-3)/g(-3)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|t: -4, -3, -2, 0, 3; g(t): 27, 24, 13, -15, 15\|g(-2)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
| `FUNDAMENTAL_FORM_SETUP` | 3 | `FUNDAMENTAL_FORM_SETUP\|cylinder\|R=3\|u in [0,pi/4], v in [0,12]` | fundamental_form_generator.py |
| `GAME_SETUP` | 2 | `GAME_SETUP\|payoffs=(16,1;0,14)\|row player maximizes, column player minimizes` | game_theory_generator.py |
...
| `GAS_SETUP` | 3 | `GAS_SETUP\|ideal_moles\|P=6, V=4\|T=19, R=1` | gas_law_generator.py |
| `GAS_STOICH_SETUP` | 3 | `GAS_STOICH_SETUP\|mass_to_gas_volume\|2 H2O2 -> 2 H2O + O2\|given=170 g H2O2, gas=O2` | gas_stoichiometry_generator.py |
| `GATE_MATRIX` | 2 | `GATE_MATRIX\|CNOT\|ket00bra00+ket01bra01+ket11bra10+ket10bra11` | quantum_gate_generator.py |
| `GAUSSIAN_CURVATURE_SETUP` | 2, 3 | `GAUSSIAN_CURVATURE_SETUP\|saddle\|z=(10x^2-11y^2)/2\|point=(0,0)` | gaussian_curvature_generator.py |
| `GAUSS_BONNET_SETUP` | 3 | `GAUSS_BONNET_SETUP\|flat_torus\|width=19, height=40\|chi=0` | gauss_bonnet_generator.py |
| `GAUSS_FORMULA` | 1 | `GAUSS_FORMULA\|2*E*A=sigma*A` | gauss_law_generator.py |
| `GAUSS_SETUP` | 3 | `GAUSS_SETUP\|sheet_charge\|sigma=5\|A=17` | gauss_law_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|12, 32\|4` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_RESULT` | 1 | `GCF_RESULT\|4y` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_VAR` | 2 | `GCF_VAR\|y^2, y\|y` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GD_SETUP` | 3 | `GD_SETUP\|f(x,y)=1/2*(3x^2+1y^2)\|start=(-2,3)\|eta=1/10` | gradient_descent_generator.py |
| `GD_UPDATE` | 3 | `GD_UPDATE\|w_old=(2,3)\|eta=1/7\|w_new=(2,22/7)` | gradient_step_generator.py |
...
| `GEOMETRIC_FORMULA` | 2 | `GEOMETRIC_FORMULA\|c_n = A*(-1)^n/d^(n+1)\|A=-5, d=-3` | laurent_series_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; leg = 114 with projection p = 18 on the hypotenuse\|the hypotenuse c` | geometric_mean_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^9]\|(1 + x)^6(1 + x)^5` | generating_function_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = 3*x^2 + 4*y^2 + 4*x*y - 3*x - 4*y\|point (4, 1)\|gradient` | gradient_generator.py |
...
| `GRAPH_SETUP` | 2 | `GRAPH_SETUP\|vertices A, B, C, D, E\|edges AB, AC, AD, AE, BC, BD, BE, CD` | dijkstra_generator.py, euler_circuit_generator.py, graph_counting_generator.py, graph_traversal_generator.py |
...
| `GREAT_CIRCLE_SETUP` | 3 | `GREAT_CIRCLE_SETUP\|R=8\|A=(90,30)\|B=(30,90)` | great_circle_generator.py |
| `GROUP` | 2 | `GROUP\|(3n^2 + 2n)\|(-9n - 6)` | factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `HAM_EQ` | 2 | `HAM_EQ\|ydot=dH/dp_y\|ydot=p_y/9` | hamiltonian_generator.py |
| `HAM_SETUP` | 3 | `HAM_SETUP\|atwood\|m1=2, m2=7\|g=10, q=y, p=p_y` | hamiltonian_generator.py |
| `HARMONIC_SETUP` | 1 | `HARMONIC_SETUP\|u=-x^2 + y^2 - x - 4y` | cauchy_riemann_generator.py |
| `HAWKING_SETUP` | 3 | `HAWKING_SETUP\|entropy\|S_BH=k_B*c^3*A/(4*hbar*G)\|k_B=2,c=5,A=47,hbar=1,G=11` | hawking_generator.py |
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|(-2)*(-8) - (-2)^2\|12` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = -x^2 - 4*y^2 - 2*x*y - 2*x + 10*y\|find and classify the critical point` | hessian_classify_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-3x^4 + x^3 + 3x^2 + 4x - 5\|x = 3` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 400, 126 successes, critical value = 1.96` | hypothesis_test_generator.py, two_sample_test_generator.py |
| `HUFFMAN_FORMULA` | 1 | `HUFFMAN_FORMULA\|L=sum p_i*l_i` | huffman_coding_generator.py |
| `HUFFMAN_MERGE` | 2 | `HUFFMAN_MERGE\|D:1/32 + E:1/32\|DE:1/16` | huffman_coding_generator.py |
| `HUFFMAN_SETUP` | 1 | `HUFFMAN_SETUP\|A=1/16, B=1/8, C=1/4, D=1/32, E=1/32, F=1/8, G=1/8, H=1/4` | huffman_coding_generator.py |
| `HYDROGEN_FORMULA` | 1 | `HYDROGEN_FORMULA\|Delta_E=R_E*(1/n_low^2-1/n_high^2)` | hydrogen_atom_generator.py |
| `HYDROGEN_SETUP` | 3 | `HYDROGEN_SETUP\|transition_energy\|n_low=4, n_high=11\|R_E=16 eV` | hydrogen_atom_generator.py |
| `HYPERBOLIC_DISTANCE_SETUP` | 3 | `HYPERBOLIC_DISTANCE_SETUP\|half-plane\|P=(-5,9)\|Q=(-5,189/4)` | hyperbolic_distance_generator.py |
...
| `HYPERCUBE_SETUP` | 2 | `HYPERCUBE_SETUP\|points P(0, 2, 4, 3) and Q(1, -2, -5, -3) in R^4\|distance` | hypercube_counting_generator.py |
...
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=18..59 C(i,18) = C(60,19)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
| `IDENTITY_SETUP` | 2 | `IDENTITY_SETUP\|verify: tan θ · cos θ = sin θ\|transform the left side` | trig_identity_verify_generator.py |
| `IDENT_MATCH` | 1 | `IDENT_MATCH\|sin θ = sin θ` | trig_identity_verify_generator.py |
| `IDENT_SUB` | 1, 2 | `IDENT_SUB\|tan θ = sin θ/cos θ` | parametric_calculus_generator.py, trig_identity_verify_generator.py |
| `IE_FORMULA` | 2 | `IE_FORMULA\|n(A union B)\|n(A) + n(B) - n(A intersect B)` | inclusion_exclusion_generator.py |
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=18, n(B)=37\|n(A intersect B)=6` | inclusion_exclusion_generator.py |
| `IFACTOR` | 2 | `IFACTOR\|mu = e^(∫ 3 dx)\|e^(3x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `IG_SETUP` | 3 | `IG_SETUP\|parent pos=12, neg=4\|total=16\|splits=source,texture` | information_gain_generator.py |
...
| `INDEP_CHECK` | 3 | `INDEP_CHECK\|P11=53/10000\|product=1/2500\|no` | joint_distribution_generator.py |
| `INDEP_FORMULA` | 1 | `INDEP_FORMULA\|independent iff P11=P(X=1)P(Y=1)` | joint_distribution_generator.py |
| `INDEX` | 3 | `INDEX\|G size 20\|H size 2\|10` | coset_generator.py |
| `INDEX_METRIC` | 3 | `INDEX_METRIC\|raise\|Minkowski\|g^ii=[-1,1,1,1]` | index_raising_generator.py |
| `INDEX_SETUP` | 3 | `INDEX_SETUP\|c=4\|j=2, k=1\|l=1, m=1` | index_gymnastics_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|5\|-16 ≤ 2x ≤ 6` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INFO_GAIN` | 2 | `INFO_GAIN\|source\|0.31125` | information_gain_generator.py |
...
| `INITIAL_COEFF` | 2 | `INITIAL_COEFF\|a_0\|21600` | series_solution_generator.py |
| `INITIAL_EQ` | 2 | `INITIAL_EQ\|C1 + C2\|5` | recurrence_generator.py |
| `INITIAL_SYSTEM` | 2 | `INITIAL_SYSTEM\|C1[2, 1] + C2[1, 1]\|[2, -1]` | ode_system_generator.py |
| `INNER_ANTIDERIV` | 2 | `INNER_ANTIDERIV\|dx\|2*x` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_EVAL` | 2, 3 | `INNER_EVAL\|x=y/2..2\|2*(2 - y/2)` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_PRODUCT` | 2 | `INNER_PRODUCT\|inner(phi,psi)\|0` | braket_generator.py |
| `INNER_PRODUCT_SETUP` | 3 | `INNER_PRODUCT_SETUP\|interval=[0,2pi]\|f=sin(39x)\|g=sin(6x)` | function_inner_product_generator.py |
| `INSERT_KEY` | 3 | `INSERT_KEY\|pass 1\|15\|index 1` | algorithm_trace_generator.py |
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 0\|15, 34, 2, 22, 13, 18` | algorithm_trace_generator.py |
...
| `INTEGRATE` | 2 | `INTEGRATE\|v_y = u_x\|v=-2xy + 4x - y + phi(x)` | cauchy_riemann_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (-4x - 2) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `INTERFERENCE_SETUP` | 3 | `INTERFERENCE_SETUP\|double_slit\|m=1, lambda=15\|L=9, d=11` | interference_generator.py |
| `INTERP_SETUP` | 3 | `INTERP_SETUP\|newton\|points=(-5,-18), (-1,2), (4,-18)\|x=-2` | interpolation_generator.py |
| `INTERVAL_CLASS` | 2 | `INTERVAL_CLASS\|s2=-520\|spacelike` | minkowski_interval_generator.py |
...
| `IRR_SETUP` | 2 | `IRR_SETUP\|c0=-1300,c1=2600\|r0=0,iterations=2` | npv_irr_generator.py |
| `IRR_VALUE` | 2 | `IRR_VALUE\|f1\|1300` | npv_irr_generator.py |
| `ITERATE` | 2 | `ITERATE\|n=1\|z=(-1/2,-1/2)` | fractal_iteration_generator.py, gradient_descent_generator.py |
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 3x - 6 on [-3, -1]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `JACOBI_END` | 2 | `JACOBI_END\|gcd(174,165)>1\|0` | jacobi_symbol_generator.py |
| `JACOBI_RECIPROCITY` | 3 | `JACOBI_RECIPROCITY\|a mod 4 = 1\|n mod 4 = 1\|keep sign` | jacobi_symbol_generator.py |
| `JACOBI_SETUP` | 3 | `JACOBI_SETUP\|a=174\|n=165\|n odd` | jacobi_symbol_generator.py |
| `JACOBI_SWAP` | 3 | `JACOBI_SWAP\|a=165\|n=9\|sign 1` | jacobi_symbol_generator.py |
| `JACOBI_TWO_RULE` | 3 | `JACOBI_TWO_RULE\|n mod 8 = 5\|flip sign\|sign -1` | jacobi_symbol_generator.py |
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|2*(-2) - (-5)*1\|1` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[2, -5], [1, -2]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = 2*u - 5*v\|y = u - 2*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
| `JOINT_SETUP` | 3 | `JOINT_SETUP\|X,Y in {0,1}\|p00=9653/10000, p01=147/10000\|p10=147/10000, p11=53/10000` | joint_distribution_generator.py |
| `KERNEL_BASE` | 3 | `KERNEL_BASE\|A,A\|dot+c=9+2\|11` | feature_map_generator.py, kernel_evaluation_generator.py |
| `KERNEL_EXPONENT` | 2 | `KERNEL_EXPONENT\|A,A\|0` | kernel_evaluation_generator.py |
| `KERNEL_SETUP` | 3 | `KERNEL_SETUP\|type=polynomial\|points=A=(0,-3), B=(2,1)\|c=2,d=3` | kernel_evaluation_generator.py |
| `KERNEL_VALIDITY` | 1 | `KERNEL_VALIDITY\|psd=true` | kernel_validity_generator.py |
| `KERNEL_VALUE` | 2 | `KERNEL_VALUE\|A,A\|1331` | feature_map_generator.py, kernel_evaluation_generator.py, kernel_perceptron_generator.py, kernel_ridge_generator.py |
...
| `KL_SETUP` | 3 | `KL_SETUP\|P=[87296/87381,85/87381]\|Q=[341/87381,87040/87381]\|direction=Q to P` | kl_divergence_generator.py |
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|0111\|NOT V AND W AND X AND Y` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|VW=00\|0, 0, 0, 0` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows VW=00,VW=01,VW=11,VW=10\|columns XY=00,XY=01,XY=11,XY=10` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|(NOT V AND W AND X AND Y) OR (V AND NOT W AND NOT X AND NOT Y) OR (V AND W AND X AND NOT Y)` | boolean_algebra_generator.py |
| `KMEANS_SETUP` | 2 | `KMEANS_SETUP\|points=P1=(0,-3), P2=(2,-2), P3=(-3,2), P4=(1,1)\|centroids=C1=(0,-1), C2=(0,2)` | kmeans_step_generator.py |
| `KNN_DISTANCE` | 3 | `KNN_DISTANCE\|P1\|label=A\|d2=34` | knn_generator.py |
| `KNN_NEIGHBORS` | 1 | `KNN_NEIGHBORS\|P3:4:B,P5:5:A,P2:8:A` | knn_generator.py |
| `KNN_SETUP` | 3 | `KNN_SETUP\|q=(5,2)\|k=3\|training=P1=(0,-1,A), P2=(3,0,A), P3=(5,0,B), P4=(1,-1,B), P5=(4,4,A)` | knn_generator.py |
| `KNN_SORT` | 1 | `KNN_SORT\|P3:4:B,P5:5:A,P2:8:A,P4:25:B,P1:34:A` | knn_generator.py |
| `KP_EXAMPLE` | 3 | `KP_EXAMPLE\|1\|x=-7,y=1\|alpha=(0,0,0)` | kernel_perceptron_generator.py |
| `KP_SETUP` | 3 | `KP_SETUP\|kernel=linear\|data=[(-7,1), (3,-1), (-6,1)]\|alpha0=(0,0,0)` | kernel_perceptron_generator.py |
...
| `KRAFT_SETUP` | 2 | `KRAFT_SETUP\|A=2, B=4, C=4, D=2, E=3, F=3, G=3\|binary prefix code` | kraft_inequality_generator.py |
| `KRAFT_TERM` | 3 | `KRAFT_TERM\|A\|l=2\|1/4` | kraft_inequality_generator.py |
| `KRR_SETUP` | 3 | `KRR_SETUP\|kernel=linear\|data=[(2,-4), (-3,3)]\|lambda=2,x*=6` | kernel_ridge_generator.py |
| `KV_CACHE` | 2 | `KV_CACHE\|values\|25165824` | flops_memory_generator.py |
| `K_EXPR` | 1, 2 | `K_EXPR\|K = [B]^2/[A]\|16/7 = (2x)^2/(9-x)` | equilibrium_ice_generator.py |
...
| `LADDER_SETUP` | 3 | `LADDER_SETUP\|single_step_energy\|state=ket9\|hbar=5, omega=8` | ladder_operator_generator.py |
...
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = 2*x^2 + 3*y^2\|constraint 5*x + y = 231\|minimize` | lagrange_multiplier_generator.py |
| `LAGRANGIAN` | 1, 2 | `LAGRANGIAN\|L=T-V` | lagrangian_generator.py |
| `LAG_SETUP` | 3 | `LAG_SETUP\|atwood\|m1=18, m2=38\|g=10, q=y` | lagrangian_generator.py |
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|((lambda b. (lambda d. (d b))) (lambda b. d))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LAURENT_SETUP` | 3 | `LAURENT_SETUP\|center a=0\|w=z\|f=(-5 + 3z - 2z^2 - 2z^3 + 5z^4)/z^2` | laurent_series_generator.py |
| `LAURENT_TERM` | 1 | `LAURENT_TERM\|-1(z+3)^-1` | residue_generator.py |
| `LAW` | 3 | `LAW\|distributive ∨ over ∧\|q ∨ (¬u ∧ ¬p)\|(q ∨ ¬u) ∧ (q ∨ ¬p)` | logical_equivalence_laws_generator.py, set_algebra_laws_generator.py |
| `LAYERNORM_SETUP` | 3 | `LAYERNORM_SETUP\|x=(2,10)\|gamma=(3,3)\|beta=(-2,1)` | layer_norm_generator.py |
...
| `LEGENDRE_SETUP` | 2 | `LEGENDRE_SETUP\|a=7\|p=11` | legendre_construction_generator.py, quadratic_residue_generator.py |
...
| `LIMITING_REAGENT` | 2 | `LIMITING_REAGENT\|H2\|H2O=29 mol` | stoichiometry_generator.py |
| `LIMIT_CHECK` | 2 | `LIMIT_CHECK\|H2O from H2=29 mol\|H2O from O2=58 mol` | stoichiometry_generator.py |
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→∞ of (-3x^2 - 5x)/(4x^2 - x - 1)\|compare degrees` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
| `LINEAR_SYSTEM` | 2 | `LINEAR_SYSTEM\|a=5/6, b=0\|c=-1/9, d=8/9` | markov_chain_generator.py |
| `LINE_EQ` | 1 | `LINE_EQ\|-6x - 14y - 24 = 0` | complex_locus_generator.py |
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|32/2 - 10\|6` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = -3x + 4\|(0, 6)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <3*x - 4*y, -4*x - 3*y>\|from (1, 2) to (-1, 4)` | line_integral_generator.py |
| `LIST_MAX` | 2 | `LIST_MAX\|19/41, 27/49, 9/11\|9/11` | dedekind_cut_generator.py |
| `LLL_DONE` | 1 | `LLL_DONE\|[(8,2),(1,-11)]` | lll_reduction_generator.py |
| `LLL_SETUP` | 1 | `LLL_SETUP\|[(9,-9),(-1,11)]` | lll_reduction_generator.py |
| `LOCUS_SETUP` | 3 | `LOCUS_SETUP\|z=x+iy\|p=(1,2)\|q=(-2,-5)` | complex_locus_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(3x)) = ln(20)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_EVAL` | 2 | `LOG_EVAL\|21/4\|ln(21/4)` | hyperbolic_distance_generator.py |
| `LOG_EXACT` | 2 | `LOG_EXACT\|log_10(10)\|1` | master_theorem_generator.py |
| `LOG_FORM` | 1 | `LOG_FORM\|log_8(512) = y ⟺ 8^y = 512` | log_conversion_generator.py, log_equation_generator.py |
...
| `LOG_LIKELIHOOD` | 1 | `LOG_LIKELIHOOD\|ell(p)=2*log(p)+6*log(1-p)` | mle_generator.py |
...
| `LOG_PRODUCT` | 1, 2 | `LOG_PRODUCT\|log_3(x^3) + log_3(y^2)\|log_3(x^3y^2)` | log_equation_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_3(x^3y^2) - log_3(z)\|log_3(x^3y^2/z)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|3log_3(x) + 2log_3(y) - log_3(z)\|condense` | complex_log_generator.py, log_properties_generator.py |
...
| `LORA_COUNT` | 2 | `LORA_COUNT\|r*(d_in+d_out)\|3744` | param_count_generator.py |
| `LOWRANK_SETUP` | 2 | `LOWRANK_SETUP\|A=[[8,0], [0,5]]\|rank=1` | low_rank_approx_generator.py |
| `LP_CORNER_SETUP` | 3 | `LP_CORNER_SETUP\|max z=14x+15y\|0<=x<=16, 0<=y<=21\|x+y<=29` | lp_corner_generator.py |
| `LR_PHASE` | 1 | `LR_PHASE\|decay` | lr_schedule_generator.py |
| `LR_SETUP` | 3 | `LR_SETUP\|base=1/10\|min=1/100\|warmup=50,total=450,t=450` | lr_schedule_generator.py |
| `LR_VALUE` | 1 | `LR_VALUE\|1/100` | lr_schedule_generator.py |
| `LS_LINE` | 2 | `LS_LINE\|a = 11, b = 3\|ŷ = 11 + 3x` | least_squares_generator.py |
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-3, 3), (-1, 7), (1, 13), (3, 21)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_RESULT` | 2 | `LU_RESULT\|L\|[[1, 0, 0], [-2, 1, 0], [-3, 2, 1]]` | lu_decomposition_generator.py |
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[-5, 0, -4], [10, 2, 13], [15, 4, 27]]\|unit lower L` | lu_decomposition_generator.py |
...
| `LZ_SETUP` | 2 | `LZ_SETUP\|LZ78\|ogggogggg` | lz_compression_generator.py |
...
| `MAG_SETUP` | 3 | `MAG_SETUP\|loop_center\|I=73, R=6\|mu0=1` | magnetism_generator.py |
...
| `MARKOV_SETUP` | 2, 3 | `MARKOV_SETUP\|absorbing\|row0 to0=1/6, to1=0, toA=1/3, toB=1/2\|row1 to0=1/9, to1=1/9, toA=5/9, toB=2/9` | entropy_rate_markov_generator.py, markov_chain_generator.py |
...
| `MATRIX_GROUP_SETUP` | 2 | `MATRIX_GROUP_SETUP\|SL2Z\|M=[[-2,-3],[-8,-7]]` | matrix_group_check_generator.py |
| `MATRIX_MULT` | 2, 3 | `MATRIX_MULT\|row1 dot col1\|1270851201/1509244801*1270851201/1509244801+550420560/1509244801*550420560/1509244801\|1270851201/1509244801` | projector_generator.py |
| `MATRIX_POWER` | 2 | `MATRIX_POWER\|J^2\|-I` | lie_exponential_generator.py |
| `MATRIX_PRODUCT` | 2 | `MATRIX_PRODUCT\|AB\|[[9i/4, 0], [0, -9i/4]]` | bch_generator.py, casimir_generator.py, gamma_matrix_generator.py, pauli_algebra_generator.py, structure_constant_generator.py |
| `MATRIX_ROW` | 2 | `MATRIX_ROW\|d\|1 0 0` | graph_counting_generator.py, relation_operations_generator.py |
| `MATRIX_SCALE` | 2 | `MATRIX_SCALE\|1/2 ladder sum\|[[3125/72, 0, 0, 0, 0, 0], [0, 8125/72, 0, 0, 0, 0], [0, 0, 10625/72, 0, 0, 0], [0, 0, 0, 10625/72, 0, 0], [0, 0, 0, 0, 8125/72, 0], [0, 0, 0, 0, 0, 3125/72]]` | bch_generator.py, casimir_generator.py |
| `MATRIX_SETUP` | 2 | `MATRIX_SETUP\|hermitian\|A=[[4,4],[4,4]]` | hermitian_check_generator.py |
| `MATRIX_SUB` | 2 | `MATRIX_SUB\|AB - BA\|[[0, 0, 3], [0, 0, 0], [0, 0, 0]]` | bch_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[2, -3], [-4, 4]], B = [[0, 2], [3, -4]]\|A + B` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
| `MAX` | 2, 3 | `MAX\|4, 15\|15` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
| `MAXIMAL` | 1 | `MAXIMAL\|{55, 58}` | partial_order_generator.py |
| `MAXTERM` | 2 | `MAXTERM\|000\|C OR D OR E` | boolean_algebra_generator.py |
| `MC_SETUP` | 3 | `MC_SETUP\|expression=x^T A x\|A=[[4,3], [2,-2]]\|x=(0,-3)` | matrix_calculus_generator.py |
...
| `MEMORY_SETUP` | 3 | `MEMORY_SETUP\|kv_cache\|L=24,h=4,d_k=128\|seq=1024,precision_bytes=1` | flops_memory_generator.py |
| `MEMORY_UNIT` | 2 | `MEMORY_UNIT\|MiB\|24` | flops_memory_generator.py |
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=1,mid=2,hi=3\|left 49; right 20` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|49\|20\|take right` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 1-2\|array 39, 20, 49, 15, 24, 32, 47` | algorithm_trace_generator.py |
...
| `METRICS_SETUP` | 1 | `METRICS_SETUP\|TP=31, FP=28, FN=21, TN=12` | classifier_metrics_generator.py |
| `METRIC_ARC_SETUP` | 3 | `METRIC_ARC_SETUP\|polar metric\|ds^2=dr^2+r^2 dtheta^2\|theta=0 deg, r:25->46` | metric_arc_length_generator.py |
...
| `MGF_SETUP` | 3 | `MGF_SETUP\|P(X=0)=37/42\|P(X=1)=2/21\|P(X=2)=1/42` | mgf_generator.py |
| `MGF_TERM` | 3 | `MGF_TERM\|x=0\|p0*e^(0t)\|37/42` | mgf_generator.py |
...
| `MINTERM` | 2 | `MINTERM\|001\|NOT J AND NOT K AND L` | boolean_algebra_generator.py |
...
| `MI_SETUP` | 2 | `MI_SETUP\|rows=[[0,0,0,1/4,0];[0,0,1/8,0,1/8];[1/4,1/4,0,0,0]]\|task=H(Y given X)` | mutual_information_generator.py |
| `MLE_SETUP` | 2, 3 | `MLE_SETUP\|bernoulli\|parameter=p\|data=[0,1,0,0,0,1,0,0]` | mle_generator.py |
| `MOBIUS_SETUP` | 2 | `MOBIUS_SETUP\|T(z)=(4z + 2)/(z + 4)\|z0=-1` | mobius_transform_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 39600 · (1 + 0.22)^2` | exponential_model_generator.py |
| `MODEL_OUTPUT` | 1 | `MODEL_OUTPUT\|56` | activation_generator.py |
| `MODEXP_MULTIPLY` | 2 | `MODEXP_MULTIPLY\|bit 1=1\|10` | mod_exp_generator.py, quadratic_residue_generator.py |
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 53\|exponent 46\|modulus 43` | mod_exp_generator.py |
...
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|35 mod 16\|11` | crt_generator.py, ecdsa_generator.py, elliptic_curve_finite_field_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|-5\|mod 16\|11` | modular_inverse_generator.py, rsa_generator.py |
| `MOD_POWER` | 3 | `MOD_POWER\|48^9\|mod 11\|3` | diffie_hellman_generator.py, pollard_factorization_generator.py, primality_test_generator.py, rsa_generator.py, tonelli_shanks_generator.py, totient_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|2^2*5^5/10\|1250` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|2*5^4/4\|625/2` | centroid_generator.py |
| `MOM_EQUATION` | 2 | `MOM_EQUATION\|E[X]=1/lambda\|xbar=1/lambda` | method_of_moments_generator.py |
| `MOM_SETUP` | 3 | `MOM_SETUP\|exponential\|parameter=lambda\|data=[5,6,10,7,5]` | method_of_moments_generator.py |
| `MONO_ADD_EXP` | 2 | `MONO_ADD_EXP\|x^9 * x^6 = x^(9+6)\|x^15` | monomial_mult_div_generator.py |
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|1 / 1\|1` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|-9 * 2\|-18` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-9x^9)(2x^6)` | monomial_mult_div_generator.py |
...
| `MR_DECOMPOSE` | 2 | `MR_DECOMPOSE\|32\|2^5 * 1` | primality_test_generator.py |
| `MR_SETUP` | 2 | `MR_SETUP\|n=33\|witnesses 4, 17` | primality_test_generator.py |
...
| `MSE_GRADIENT` | 2 | `MSE_GRADIENT\|g0=0\|g1=-1` | gradient_step_generator.py |
| `MSE_SAMPLE` | 3 | `MSE_SAMPLE\|i=1\|pred=-4\|r=-1` | gradient_step_generator.py |
| `MSE_SETUP` | 3 | `MSE_SETUP\|model y_hat=w0+w1*x\|samples=[(-2,-3), (-3,-8)]\|w=(2,3), eta=1/7` | gradient_step_generator.py |
| `MST_ADD` | 2 | `MST_ADD\|CD\|total 6` | mst_generator.py |
| `MST_SET` | 1 | `MST_SET\|CD` | mst_generator.py |
| `MST_SETUP` | 2 | `MST_SETUP\|weighted undirected graph\|vertices A, B, C, D, E` | mst_generator.py |
| `MU` | 2 | `MU\|-2/3\|round=-1` | lll_reduction_generator.py |
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(3x)y' + 3e^(3x)y\|24e^(6x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `MULTIVALUED_LOG` | 2 | `MULTIVALUED_LOG\|ln(156) + i*(29pi/30 + 2pi*k)\|k in Z` | complex_log_generator.py |
| `MULTI_FORMULA` | 2 | `MULTI_FORMULA\|n!/(a!b!c!...)\|10! / repeats` | stars_and_bars_generator.py |
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|2 E's, 3 M's, 5 A's\|total 10` | stars_and_bars_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 - 3x - 7 on [-3, 3]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 3*x^2 + 3*y^2 - 3*x*y - 5*x - 5*y\|x = 4*s + t - 4, y = 4*s + t + 2\|(s,t) = (0, 1)` | multivar_chain_rule_generator.py |
| `NATURAL_SETUP` | 3 | `NATURAL_SETUP\|cross section\|hbar=1,c=1\|E=3/2 TeV` | natural_units_generator.py |
| `NB_FEATURE_COUNT` | 3 | `NB_FEATURE_COUNT\|Spam\|urgent=1\|count=2` | naive_bayes_generator.py |
| `NB_LIKELIHOOD` | 3 | `NB_LIKELIHOOD\|Spam\|urgent=1\|1/4` | naive_bayes_generator.py |
| `NB_PRIOR` | 2 | `NB_PRIOR\|Spam\|5/8` | naive_bayes_generator.py |
| `NB_SCORE` | 2 | `NB_SCORE\|Spam\|start=5/8` | naive_bayes_generator.py |
| `NB_SETUP` | 3 | `NB_SETUP\|query=urgent=1, offer=0, long=0\|alpha=1\|classes=Spam,Ham` | naive_bayes_generator.py |
...
| `NEAREST` | 2 | `NEAREST\|queen\|(-1,0)` | embedding_similarity_generator.py |
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 5:3\|line 4 multiplies 5 by 9` | fill_in_step_generator.py |
...
| `NET_SETUP` | 2 | `NET_SETUP\|2 right triangles with legs 9 and 12; rectangles 9 by 5, 12 by 5, and 15 by 5\|total surface area` | nets_surface_area_generator.py |
...
| `NFA_ACCEPT` | 1 | `NFA_ACCEPT\|t2, t8` | nfa_simulation_generator.py |
| `NFA_ACTIVE` | 2 | `NFA_ACTIVE\|start\|{t0}` | nfa_simulation_generator.py |
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|p4\|{p5}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|babaa` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{t0}\|b\|t0->{t0,t2}\|{t0,t2}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|b` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states t0, t2, t8\|alphabet a, b\|start t0` | nfa_simulation_generator.py |
| `NFA_TRANSITION` | 3 | `NFA_TRANSITION\|t0\|a\|{t0}` | nfa_simulation_generator.py |
| `NILPOTENT` | 3 | `NILPOTENT\|n>=2\|theta^2=0\|0` | grassmann_generator.py |
| `NLL` | 2 | `NLL\|49 tokens\|49*ln(16)` | perplexity_generator.py |
| `NORM2` | 2 | `NORM2\|b1\|162` | lll_reduction_generator.py |
| `NORMALIZE` | 2 | `NORMALIZE\|1\|1` | clebsch_gordan_generator.py, layer_norm_generator.py |
| `NORMALIZE_SIGN` | 2 | `NORMALIZE_SIGN\|(-12,0)\|(12,0)` | lll_reduction_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|A: 92 in N(82, 4)\|compare relative standing` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
...
| `NO_REDEX` | 2 | `NO_REDEX\|lambda z. (z (lambda b. d))\|no beta redex remains` | lambda_reduction_generator.py |
| `NO_WITNESS` | 2, 3 | `NO_WITNESS\|x=2\|fails y=11\|2² > 11` | peano_arithmetic_generator.py, quantifier_finite_domain_generator.py |
| `NPV_SETUP` | 2 | `NPV_SETUP\|c0=-1700,c1=250,c2=1750,c3=1800\|rate=10%` | npv_irr_generator.py |
| `NPV_TERM` | 2 | `NPV_TERM\|t=0\|-1700` | npv_irr_generator.py |
| `NULL_REL` | 2 | `NULL_REL\|x1 - x4 = 0\|x1 = x4` | subspace_basis_generator.py |
| `NULL_VECTOR` | 2 | `NULL_VECTOR\|x4=1\|[1, -2, -4, 1]` | subspace_basis_generator.py |
| `NUMBER_OPERATOR` | 2 | `NUMBER_OPERATOR\|N ket19\|19 ket19` | ladder_operator_generator.py |
| `NW_ALLOC` | 1, 3 | `NW_ALLOC\|cell x11\|min(28,15)\|15` | transportation_generator.py |
...
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dx = x^2/y^2, y(0) = 44\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `OPTICS_FORMULA` | 1 | `OPTICS_FORMULA\|1/f=1/d_o+1/d_i` | optics_generator.py |
| `OPTICS_SETUP` | 3 | `OPTICS_SETUP\|mirror_magnification\|f=19, d_o=79\|h_o=12` | optics_generator.py |
| `OPT_SETUP` | 2 | `OPT_SETUP\|x + y = 543, x, y > 0\|maximize P = x·y^2` | optimization_generator.py |
| `ORBIT_FORMULA` | 1 | `ORBIT_FORMULA\|(T2/T1)^2=(a2/a1)^3` | orbital_mechanics_generator.py |
| `ORBIT_SETUP` | 3 | `ORBIT_SETUP\|kepler_third\|T1=8, a1=4\|a2=36` | orbital_mechanics_generator.py |
| `ORDER_PAIR` | 2 | `ORDER_PAIR\|24 ≤ 55\|reachable in H` | partial_order_generator.py |
| `ORDER_PDF` | 1 | `ORDER_PDF\|f_{1:3}(x)=3*(1-x)^2` | order_statistics_generator.py |
| `ORDER_SETUP` | 3 | `ORDER_SETUP\|n=3\|k=1\|q=5/14` | order_statistics_generator.py |
...
| `OR_SETUP` | 3 | `OR_SETUP\|M/M/1\|lambda=18\|mu=28` | or_formula_generator.py |
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|5*x^2 + 140*x` | double_integral_generator.py |
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|y=0..4\|2*2*2^2/2\|8` | double_integral_generator.py |
| `OUTER_PRODUCT` | 1 | `OUTER_PRODUCT\|rho=1/2(ket00bra00+e^(-i73π/202)ket00bra10+e^(i73π/202)ket10bra00+ket10bra10)` | partial_trace_generator.py |
...
| `PARAMS` | 3 | `PARAMS\|W1=[[2,0], [2,2]]\|b1=(1,-1)\|v=(2,-2), c=0` | backprop_generator.py |
| `PARAM_PART` | 2 | `PARAM_PART\|attention_per_layer\|14745600` | param_count_generator.py |
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(-2*t + 1, 2*t + 2)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 12t + 15, y = -t - 16\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(-x + 7)/(x - 2)^2 = A/(x - 2) + B/(x - 2)^2` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|1/(s + 3) - 2/(s - 4)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|28*x^3*y^3 + 4*x*y^4` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|7*x^4*y^3\|d/dx\|28*x^3*y^3` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 7*x^4*y^3 + 2*x^2*y^4\|f_x` | partial_derivative_generator.py |
| `PARTIAL_TRACE` | 2 | `PARTIAL_TRACE\|ket00bra00\|ket0bra0` | partial_trace_generator.py |
| `PARTICLE_TABLE` | 1 | `PARTICLE_TABLE\|pi0(Q=0,B=0,Le=0,Lmu=0); pi+(Q=1,B=0,Le=0,Lmu=0); mu+(Q=1,B=0,Le=0,Lmu=-1); gamma(Q=0,B=0,Le=0,Lmu=0); nu_mu(Q=0,B=0,Le=0,Lmu=1)` | conservation_law_generator.py |
...
| `PARTITION_SETUP` | 3 | `PARTITION_SETUP\|degenerate_two_level\|g0=4, g1=2\|epsilon=12, b=1/4` | partition_function_generator.py |
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = -164x, dv = e^(-x) dx\|du = -164 dx, v = -e^(-x)` | integration_by_parts_generator.py |
...
| `PASCAL_SETUP` | 1 | `PASCAL_SETUP\|15C13` | pascal_triangle_generator.py |
...
| `PAULI_IDENTITY` | 3 | `PAULI_IDENTITY\|sigma_z sigma_z\|delta_ij I\|-12I` | pauli_algebra_generator.py |
| `PAULI_MATRIX` | 2 | `PAULI_MATRIX\|sigma_y\|[[0,-i],[i,0]]` | spin_half_generator.py |
| `PAULI_SETUP` | 3 | `PAULI_SETUP\|product\|A=3sigma_z\|B=-4sigma_z` | pauli_algebra_generator.py |
| `PCA_SETUP` | 2 | `PCA_SETUP\|points=[(6,2), (2,2), (4,10), (4,-6)]\|population covariance` | pca_generator.py |
...
| `PD_SETUP` | 2 | `PD_SETUP\|A=[[1,1], [1,10]]\|Sylvester criterion` | positive_definite_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|1.61\|860\|1384.6` | percent_problem_generator.py |
...
| `PERCEPTRON_SETUP` | 3 | `PERCEPTRON_SETUP\|eta=2\|w=(0,1,2)\|samples=[(-1,2,1), (-1,3,1), (-1,0,1), (-3,3,1)]` | perceptron_generator.py |
...
| `PERM_RESULT` | 1 | `PERM_RESULT\|[2, 1, 5, 4, 3]` | permutation_group_generator.py |
| `PERM_SETUP` | 2, 3 | `PERM_SETUP\|arrange 4 of 10\|order matters` | permutation_combination_generator.py, permutation_group_generator.py |
| `PERPLEXITY` | 2 | `PERPLEXITY\|exp(CE)\|16` | perplexity_generator.py |
| `PERPLEXITY_SETUP` | 2 | `PERPLEXITY_SETUP\|tokens=49\|p=1/16` | perplexity_generator.py |
| `PE_ENTRY` | 2 | `PE_ENTRY\|0\|1` | positional_encoding_generator.py |
| `PE_SETUP` | 3 | `PE_SETUP\|position=61\|d=2\|theta=pi/2` | positional_encoding_generator.py |
...
| `PHI_STEP` | 2 | `PHI_STEP\|p=2\|35` | totient_generator.py |
...
| `PH_SETUP` | 2, 3 | `PH_SETUP\|hydroxide_power\|[OH-]=10^-7` | ph_calculation_generator.py |
| `PI2_NUM` | 3 | `PI2_NUM\|-17/40\|π^2\|-17π^2/40` | casimir_force_generator.py |
...
| `PI_DEN` | 3 | `PI_DEN\|1/1088\|π\|1/(1088π)` | gauss_law_generator.py, hawking_generator.py, magnetism_generator.py |
...
| `PLANCK_SETUP` | 4 | `PLANCK_SETUP\|time\|hbar=121\|G=81\|c=25` | planck_units_generator.py |
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|x = ±√9322\|x = √9322 or x = -√9322` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|36*5/4\|45` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y - 10 = 2/3(x + 2)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|(x, y) = (-3822, -1904)\|polar (r ≥ 0, 0° ≤ θ < 360°)` | parametric_calculus_generator.py, polar_parametric_generator.py |
| `POLES` | 1 | `POLES\|s=-3, -7` | transfer_function_generator.py |
...
| `POLLARD_FACTOR` | 2 | `POLLARD_FACTOR\|19\|23` | pollard_factorization_generator.py |
| `POLLARD_PM1_SETUP` | 3 | `POLLARD_PM1_SETUP\|n=299\|base=5\|B=7` | pollard_factorization_generator.py |
| `POLLARD_RHO_SETUP` | 3 | `POLLARD_RHO_SETUP\|n=437\|c=1\|x0=2` | pollard_factorization_generator.py |
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|2x^3 - x^2 - 6x - 4\|x - 1` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|4x^3 - x^2` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(9x^7 + 3x^7 - 9x^7 + 15x^4) / (3x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(9x^7) / (3x^3) + (3x^7) / (3x^3) + (-9x^7) / (3x^3) + (15x^4) / (3x^3)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-x^3 +5x^3) + (-2x^2 +x^2)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|x^3 + x^2 + 2x` | finite_field_generator.py |
...
| `POLY_REMAINDER` | 1 | `POLY_REMAINDER\|x^5 + x^4 + x^3 + x^2 + x` | finite_field_generator.py |
| `POLY_SCALE` | 3 | `POLY_SCALE\|x^3 - 3x/5\|5/2\|(5x^3 - 3x)/2` | legendre_construction_generator.py |
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-x^3 - 2x^2) - (-5x^3 - x^2)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(2x^3 - x^2) - (2x^3 - 2x^2)\|x^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
| `PORT_FORMULA` | 2 | `PORT_FORMULA\|E=wA*rA+wB*rB\|Var=wA^2*varA+wB^2*varB+2*wA*wB*cov` | portfolio_generator.py |
| `PORT_RESULT` | 2 | `PORT_RESULT\|expected_return=0.0675\|variance=0.028125` | portfolio_generator.py |
| `PORT_SETUP` | 3 | `PORT_SETUP\|wA=0.25,wB=0.75\|rA=12%,rB=5%\|varA=0.09,varB=0.04,cov=0` | portfolio_generator.py |
...
| `POTENTIAL_BUILD` | 3 | `POTENTIAL_BUILD\|integrate P dx\|x^2 + 2*x*y + x + g(y)\|g'(y) remains` | exact_ode_generator.py, line_integral_generator.py |
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|x^2 + y^2 + 2*x*y + x - 2*y` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(4/5)^5\|0.32768` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|135 + 512*(-4)\|-1913` | diagonalization_generator.py |
...
| `POWER_REDUCE` | 2 | `POWER_REDUCE\|48^59\|48^9 mod 11` | totient_generator.py |
...
| `POWER_SETUP` | 2 | `POWER_SETUP\|(cos 174 deg + i sin 174 deg)^(5i)\|principal logarithm` | complex_log_generator.py |
...
| `PREDICT` | 2 | `PREDICT\|x*\|-34/5` | kernel_ridge_generator.py |
...
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited C\|CD=6, BC=11, AC=24` | mst_generator.py |
| `PRIM_START` | 1 | `PRIM_START\|C` | mst_generator.py |
| `PRINCIPAL_LOG` | 1 | `PRINCIPAL_LOG\|ln(156) + i*29pi/30` | complex_log_generator.py |
...
| `PRODUCT` | 2 | `PRODUCT\|Delta x^2 * Delta p^2\|31684pi^2/12 - 1/2` | uncertainty_generator.py |
| `PROJECT` | 2 | `PROJECT\|P1\|0` | pca_generator.py |
| `PROJECTILE_SETUP` | 3 | `PROJECTILE_SETUP\|vx=28\|vy=22\|g=10` | projectile_motion_generator.py |
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[2, 8, 14, 20]` | least_squares_generator.py, legendre_construction_generator.py |
| `PROJECTOR_SETUP` | 2 | `PROJECTOR_SETUP\|v=(35649/38849, 15440/38849)\|P=vv^T=[[1270851201/1509244801,550420560/1509244801],[550420560/1509244801,238393600/1509244801]]` | projector_generator.py |
...
| `PSD_SETUP` | 2 | `PSD_SETUP\|K=[[2,0], [0,5]]\|criterion=all principal minors >= 0` | kernel_validity_generator.py |
| `PULL` | 2 | `PULL\|∀w\|from left past ∨` | prenex_normal_form_generator.py |
| `PURITY` | 1 | `PURITY\|Tr(rho^2)=85/121` | density_matrix_generator.py |
...
| `Q1` | 4 | `Q1\|-68\|680\|34\|18` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|-68\|680\|34\|-22` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QN_ADD` | 4 | `QN_ADD\|Q\|left\|0 + pi0(0)\|0` | conservation_law_generator.py |
| `QR_ENTRY` | 2 | `QR_ENTRY\|q1\|[1, 0, 0]` | qr_decomposition_generator.py |
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[4, -5, -2], [0, 2, -4], [0, 0, 2]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|236°\|quadrant III` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
...
| `QUANTUM_SETUP` | 2, 3 | `QUANTUM_SETUP\|gate=CNOT\|input=e^(i157π/138)·ket01` | quantum_formula_generator.py, quantum_gate_generator.py |
...
| `QUANT_SETUP` | 3 | `QUANT_SETUP\|x=(-21/25,4/25,-47/25)\|scale=1/20\|zero_point=-2` | quantization_generator.py |
| `QUANT_VALUE` | 2 | `QUANT_VALUE\|1\|-19` | quantization_generator.py |
| `QUARK_CHARGE` | 2 | `QUARK_CHARGE\|b\|-1/3` | quark_composition_generator.py |
| `QUARK_SETUP` | 3 | `QUARK_SETUP\|meson,count=760\|b anti_u\|u=2/3,d=-1/3,s=-1/3,c=2/3,b=-1/3; anti=-charge` | quark_composition_generator.py |
| `QUARTILE` | 3 | `QUARTILE\|Q1\|9,24,25,28,32\|25` | five_number_summary_generator.py |
...
| `QUAT_RESULT` | 2 | `QUAT_RESULT\|q*v\|(4,-4,0,-2)` | quaternion_generator.py |
| `QUAT_SETUP` | 2 | `QUAT_SETUP\|q=(0,0,1,0)\|v=(0,2,-4,-4)` | quaternion_generator.py |
| `QUEUE_STATE` | 2 | `QUEUE_STATE\|initial\|F` | graph_traversal_generator.py |
| `QUOTIENT` | 1 | `QUOTIENT\|x^4 + x^3 + 1` | finite_field_generator.py |
...
| `RAPIDITY_SUM` | 2 | `RAPIDITY_SUM\|collinear boosts\|-4/3` | minkowski_interval_generator.py |
| `RATE_MONTHLY` | 2 | `RATE_MONTHLY\|24% / 12\|0.02` | finance_generator.py |
| `RATE_SETUP` | 2 | `RATE_SETUP\|cube: ds/dt = 11 cm/min; s = 15 cm\|dV/dt` | related_rates_generator.py |
| `RATIO` | 2, 3 | `RATIO\|y = x\|y = x` | lagrange_multiplier_generator.py, simplex_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|(11 - √30)/(11 - √30)` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 772 / 0.08` | percent_problem_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = 5 a_(n-1) - 6 a_(n-2) + 2\|a_0 = 6, a_1 = 15` | master_theorem_generator.py, recurrence_generator.py |
| `REDUCE` | 2, 3 | `REDUCE\|(21191, 20443)\|(748, 0)` | integers_as_pairs_generator.py, rationals_as_pairs_generator.py |
| `REDUCED_DENSITY` | 1 | `REDUCED_DENSITY\|rho_A=[[1/2,e^(-i73π/202)/2],[e^(i73π/202)/2,1/2]]` | partial_trace_generator.py |
| `REFLEXIVE_CHECK` | 2 | `REFLEXIVE_CHECK\|(19, 19)\|present` | equivalence_relation_generator.py, relation_check_generator.py |
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q19548_2` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|(a or b)*ab(a or b)*\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q19548_0\|no useful suffix` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q19548_0\|a\|q19548_1` | regex_to_automaton_generator.py |
...
| `REGION_MEASURE` | 3 | `REGION_MEASURE\|area\|5*4\|20` | vector_theorem_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 57), (2, 61), (3, 65), (4, 59), (5, 63)\|least-squares line` | regression_generator.py |
...
| `REL_ENERGY_SETUP` | 3 | `REL_ENERGY_SETUP\|rest_energy\|m=43\|c=7` | relativistic_energy_generator.py |
...
| `RESIDUE_SETUP` | 2 | `RESIDUE_SETUP\|a=-3\|f=-1/(z+3) - 1 + 3(z+3)` | residue_generator.py |
| `RESIDUE_SUM` | 1 | `RESIDUE_SUM\|9` | contour_integral_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (3, 33), line ŷ = 33.2 - 0.4x\|residual = observed − predicted` | regression_generator.py |
| `RESOLVE` | 3 | `RESOLVE\|C1\|C2\|P67367` | resolution_proof_generator.py |
...
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(¬P25030 ∨ P67367), C2=(¬P67367), C3=(P25030), C4=(P30935)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C2\|(¬P25030)` | resolution_proof_generator.py |
...
| `RG_SETUP` | 3 | `RG_SETUP\|one_loop\|alpha0=1/30\|beta=5/4,L=8` | running_coupling_generator.py |
...
| `RK_COMBINE` | 2 | `RK_COMBINE\|k1+2k2+2k3+k4\|-18729/512` | runge_kutta_generator.py |
| `RK_STAGE` | 3 | `RK_STAGE\|k1\|t=-1\|P=5` | runge_kutta_generator.py |
...
| `ROT_SETUP` | 3 | `ROT_SETUP\|angular_momentum\|I1=27, omega1=10\|I2=28` | rotational_dynamics_generator.py |
| `ROUND` | 2 | `ROUND\|-94/5\|-19` | quantization_generator.py |
...
| `ROUTH_ROW` | 2 | `ROUTH_ROW\|s^3\|1, 26` | routh_hurwitz_generator.py |
| `ROUTH_SETUP` | 1 | `ROUTH_SETUP\|p(s)=s^3+24s^2+26s+35` | routh_hurwitz_generator.py |
| `ROW_ENTROPY` | 2 | `ROW_ENTROPY\|H0\|649/800` | entropy_rate_markov_generator.py |
| `ROW_OP` | 1, 2 | `ROW_OP\|R2 → R2 - 3·R1\|[0, 1, 2, 7]` | row_reduction_generator.py, simplex_generator.py, subspace_basis_generator.py |
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, 0, -1], [0, 1, 0, 2], [0, 0, 1, 4]]` | subspace_basis_generator.py |
| `RSA_DECRYPT` | 2 | `RSA_DECRYPT\|74\|46` | rsa_generator.py |
| `RSA_ENCRYPT` | 2 | `RSA_ENCRYPT\|46\|74` | rsa_generator.py |
| `RSA_PRIVATE_KEY` | 1 | `RSA_PRIVATE_KEY\|d=37` | rsa_generator.py |
| `RSA_PUBLIC_KEY` | 2 | `RSA_PUBLIC_KEY\|n=77\|e=13` | rsa_generator.py |
| `RSA_SETUP` | 3 | `RSA_SETUP\|p=7\|q=11\|message=46` | rsa_generator.py |
| `RSQ_FORMULA` | 1 | `RSQ_FORMULA\|r^2 = Sxy^2/(Sxx·Syy)` | regression_generator.py |
| `RS_CORRECT` | 2 | `RS_CORRECT\|position=1\|[1,6,2,14]` | reed_solomon_generator.py |
| `RS_EVAL` | 2 | `RS_EVAL\|x=1\|22` | reed_solomon_generator.py |
| `RS_LINE` | 3 | `RS_LINE\|m0=16\|m1=14\|agree=2` | reed_solomon_generator.py |
| `RS_PAIR` | 2 | `RS_PAIR\|x=5,17\|y=24,6` | reed_solomon_generator.py |
| `RS_RECEIVED` | 1 | `RS_RECEIVED\|[24,6,2,14]` | reed_solomon_generator.py |
| `RS_SETUP` | 3 | `RS_SETUP\|F_73\|m(x)=30+65x\|points 1,6,21,51` | reed_solomon_generator.py |
...
| `SAMPLE_MOMENT` | 2 | `SAMPLE_MOMENT\|xbar\|33/5` | method_of_moments_generator.py |
...
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x4 = 47\|xi >= 1` | stars_and_bars_generator.py |
...
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = -7\|49*5\|245` | diagonalization_generator.py |
...
| `SCALING_COMPUTE` | 2 | `SCALING_COMPUTE\|6ND\|13392000000000000000` | scaling_law_generator.py |
| `SCALING_SETUP` | 3 | `SCALING_SETUP\|N=24000000\|D=93000000000\|F=91000000000000000` | scaling_law_generator.py |
| `SCAN` | 2 | `SCAN\|(\|parenthesis depth 1` | wff_parsing_generator.py |
| `SCHWARZSCHILD_SETUP` | 3, 4 | `SCHWARZSCHILD_SETUP\|time_dilation\|r_s=90\|r=162` | schwarzschild_generator.py |
...
| `SCORE_EQ` | 1 | `SCORE_EQ\|2/p=6/(1-p)` | mle_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(5, -7), B(17, -1); ratio 1:2 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_28 = -2 + (28 - 1)·9` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|-2, 7, 16, 25, ...\|sum of first 28 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ n!/42^n, n ≥ 1\|converge or diverge?` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
...
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 1.61 * 860` | percent_problem_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y4 = 43` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
| `SHM_FORMULA` | 1 | `SHM_FORMULA\|omega^2=k/m` | shm_generator.py |
| `SHM_SETUP` | 3 | `SHM_SETUP\|mass_spring_energy\|m=20, k=20\|A=7, x=1` | shm_generator.py |
...
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|153 + 459 + 1377 + 4131` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=2)^(5) 17·3^k\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=2\|17·3^2\|153` | sigma_notation_generator.py |
| `SIGN` | 3 | `SIGN\|left\|-14\|negative` | bisection_generator.py |
| `SIGNAL_SETUP` | 2, 3 | `SIGNAL_SETUP\|sampling\|f_max=626 Hz\|f_s=2893 Hz` | signal_arithmetic_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, -13)\|y = -14\|f(y) = 6 (positive)\|up` | stability_generator.py |
...
| `SIMPLEX_SETUP` | 3 | `SIMPLEX_SETUP\|max z=10x+5y\|x<=10\|y<=9` | simplex_generator.py |
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; AB = 10, DE = 35, BC = 10\|find EF` | similar_triangles_generator.py |
| `SIN` | 2 | `SIN\|pi/2\|1` | positional_encoding_generator.py |
| `SINGULAR_VALUE` | 2 | `SINGULAR_VALUE\|sigma1\|8` | low_rank_approx_generator.py |
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = -cos(4(x + 15°))\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
| `SIZE_REDUCE` | 2 | `SIZE_REDUCE\|b2=(-1, 11)\|b2-(-1)b1=(8, 2)` | lll_reduction_generator.py |
...
| `SLOPE_INT_IDENTIFY` | 2 | `SLOPE_INT_IDENTIFY\|Slope (m)\|-89` | slope_intercept_form_generator.py |
| `SLOPE_INT_MATCH` | 2 | `SLOPE_INT_MATCH\|Compare to Slope-Intercept Form\|y = mx + b` | slope_intercept_form_generator.py |
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -89x - 52` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|2/3` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-9, 8)\|(5, 3)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (3 - 8) / (5 - (-9))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOFTMAX_SETUP` | 3 | `SOFTMAX_SETUP\|z=(2*ln(2),2*ln(9),2*ln(1))\|T=2\|target=3` | softmax_gradient_generator.py |
| `SOFTMAX_WEIGHT` | 2 | `SOFTMAX_WEIGHT\|1,1\|1/3` | attention_generator.py |
| `SOLUTIONS` | 2 | `SOLUTIONS\|sin x = -1\|270°, 630°, 990°, 1350°, 1710°, 2070°, 2430°, 2790°, 3150°, 3510°, 3870°, 4230°, 4590°, 4950°, 5310°, 5670°, 6030°, 6390°, 6750°, 7110°, 7470°, 7830°, 8190°, 8550°, 8910°, 9270°, 9630°, 9990°, 10350°, 10710°, 11070°, 11430°, 11790°, 12150°, 12510°` | trig_equation_generator.py |
| `SOLUTION_FORMULA` | 1 | `SOLUTION_FORMULA\|M1*V1=M2*V2` | solution_chem_generator.py |
| `SOLUTION_SETUP` | 3 | `SOLUTION_SETUP\|dilution_stock_volume\|M1=6\|M2=3/4, V2=260` | solution_chem_generator.py |
...
| `SOLVE_Y` | 2 | `SOLVE_Y\|e^(3x)y = 4e^(6x) + C\|y = 4e^(3x) + Ce^(-3x)` | integrating_factor_generator.py, laplace_ivp_generator.py, ode_substitution_generator.py |
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(e^(3t))*(-2) + (6*e^(-4t) - 6*e^(3t))*(-6)\|-36*e^(-4t) + 34*e^(3t)` | matrix_exponential_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|AB=3, CE=5, DE=9, AC=13, BD=18` | mst_generator.py |
...
| `SPHERICAL_EXCESS_SETUP` | 2 | `SPHERICAL_EXCESS_SETUP\|R=16\|angles=30,135,45` | spherical_excess_generator.py |
| `SPHERICAL_SINE_LAW` | 1 | `SPHERICAL_SINE_LAW\|sin(A)/sin(a)=sin(B)/sin(b)` | spherical_triangle_generator.py |
| `SPHERICAL_TRIANGLE_SETUP` | 2 | `SPHERICAL_TRIANGLE_SETUP\|a=150 deg, b=120 deg, A=150 deg\|find sin(B)` | spherical_triangle_generator.py |
| `SPIN_COMPONENT` | 2 | `SPIN_COMPONENT\|row=1\|-24i/25` | spin_half_generator.py |
| `SPIN_SETUP` | 3 | `SPIN_SETUP\|measurement_probability\|axis=x\|psi=[-5/13,-12/13]` | spin_half_generator.py |
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|-7n = 2n - 9n\|3n^2 + 2n - 9n - 6` | factor_trinomial_generator.py |
| `SPLIT_SETUP` | 3 | `SPLIT_SETUP\|source\|left pos=8, neg=0\|right pos=4, neg=4` | information_gain_generator.py |
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|x^2 = 9322\|x = ±√9322` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `SQRT_DIGIT` | 2 | `SQRT_DIGIT\|5\|root = 5` | manual_square_root_generator.py |
| `SQRT_NEG` | 2 | `SQRT_NEG\|√(-672)\|i√672` | complex_quadratic_generator.py, polynomial_zeros_generator.py |
...
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(2x - 8) = x - 4\|2x - 8 = (x - 4)^2` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|21888\|576 × 38\|576` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `STANDING_SETUP` | 3 | `STANDING_SETUP\|open_pipe\|n=8\|L=19, v=88` | standing_wave_generator.py |
...
| `STATICS_SETUP` | 3 | `STATICS_SETUP\|lever_balance\|F1=26\|d1=9, d2=3` | statics_generator.py |
...
| `STEREO_SETUP` | 3, 4 | `STEREO_SETUP\|sphere_to_plane\|X=2/27\|Y=10/27\|Z=25/27` | stereographic_generator.py |
...
| `STOICH_SETUP` | 2, 3 | `STOICH_SETUP\|limiting_reagent\|2 H2 + O2 -> 2 H2O\|given=H2=29 mol, O2=29 mol` | stoichiometry_generator.py |
| `STRUCTURE_CONSTANT` | 3 | `STRUCTURE_CONSTANT\|epsilon_yxz\|-1\|9iJz` | structure_constant_generator.py |
| `STRUCTURE_SETUP` | 3 | `STRUCTURE_SETUP\|A=-3Jy\|B=3Jx\|epsilon_yxz=-1` | structure_constant_generator.py |
...
| `SUBGROUP` | 2 | `SUBGROUP\|H={1, 23}\|size 2` | coset_generator.py |
...
| `SUBSTITUTE` | 2 | `SUBSTITUTE\|b:=(lambda b. d) in lambda d. (d b)\|lambda z. (z (lambda b. d))` | lambda_reduction_generator.py |
...
| `SUM` | 2, 3 | `SUM\|57 + 61 + 65 + 59 + 63\|305` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
...
| `SVM_SETUP` | 3 | `SVM_SETUP\|x1=(8,0),y1=1,alpha1=1\|x2=(0,-15),y2=-1,alpha2=1\|b=0,x=(2,-2)` | svm_margin_generator.py |
| `SWAP` | 2 | `SWAP\|norm b2=68\|norm b1=162` | lll_reduction_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|2x^4 - 8x^3 - 11x^2 + x + 24\|r = 5` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|2, 2, -1, -4, 4` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -8y = -16` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with x only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = -5y - 5` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * -3, Eq2 * -5` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|15x - 3y = -126\|-15x - 5y = 110` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|y = x + 9\|-x - 3y = 13` | systems_elimination_generator.py, systems_substitution_generator.py |
...
| `TABLEAU` | 2, 3 | `TABLEAU\|initial\|s1: x + s1 = 10\|s2: y + s2 = 9` | simplex_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|g(-2)\|13` | de_moivre_generator.py, dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, lie_exponential_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 22 + 6*(x - 1) + 17*(y - 3)` | gradient_generator.py |
...
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|survive first and last\|1/102 - 1/161` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Σ k=102..160 (1/k - 1/(k+1))` | telescoping_generator.py |
| `TEMP_SCALE` | 2 | `TEMP_SCALE\|z1/T\|ln(2)` | softmax_gradient_generator.py |
| `TENSOR_ENTRY` | 2 | `TENSOR_ENTRY\|C_11\|-7` | einstein_summation_generator.py, index_raising_generator.py |
| `TENSOR_RULE` | 1 | `TENSOR_RULE\|diag(a,b) tensor diag(c,d)=diag(ac,ad,bc,bd)` | tensor_product_generator.py |
| `TENSOR_SETUP` | 3 | `TENSOR_SETUP\|A=diag(4,1)\|B=diag(0,4)\|u=[-3,-2], v=[4,-4]` | tensor_product_generator.py |
| `TENSOR_STATE` | 2 | `TENSOR_STATE\|u tensor v\|[-12,12,-8,8]` | tensor_product_generator.py |
| `TERM` | 2 | `TERM\|i=0: 1·(1/2)^0·(1/2)^3\|0.125` | binomial_probability_generator.py |
| `TERMS` | 1 | `TERMS\|y[0..4]=[1,-8,64,-512,4096]` | z_transform_generator.py |
...
| `TF_SETUP` | 3 | `TF_SETUP\|block_feedback\|G1=7/(s+5), G2=8/(s+1)\|H=1` | transfer_function_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Green\|F=<0, -6*x>\|rectangle 5 by 4` | vector_theorem_generator.py |
| `THETA` | 2 | `THETA\|min(8,15)\|8` | transportation_generator.py |
| `THROUGHPUT` | 2 | `THROUGHPUT\|tokens_per_second\|5687500000/9` | scaling_law_generator.py |
...
| `TIME_EVOLVE` | 2 | `TIME_EVOLVE\|U psi\|[1,0]` | braket_generator.py |
...
| `TRANSFER` | 1 | `TRANSFER\|G(s)=56/(s^2+6s+5)` | transfer_function_generator.py |
| `TRANSFORM_APPLY` | 2 | `TRANSFORM_APPLY\|(-(-4), (-3))\|(4, -3)` | transformation_generator.py |
| `TRANSFORM_RULE` | 1 | `TRANSFORM_RULE\|(x, y) → (-x, y)` | transformation_generator.py |
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(-4, -3)\|reflection over the y-axis, then rotation 180° about the origin` | rv_transform_generator.py, transformation_generator.py |
| `TRANSIENT_FORMULA` | 1 | `TRANSIENT_FORMULA\|tau=R*C` | transient_circuit_generator.py |
| `TRANSIENT_SETUP` | 3 | `TRANSIENT_SETUP\|rc_charging\|R=10, C=11\|Vs=16, t=550` | transient_circuit_generator.py |
...
| `TRANSPORT_SETUP` | 3 | `TRANSPORT_SETUP\|supply=(28,8)\|demand=(15,21)\|costs=(8,2;9,12)` | transportation_generator.py |
| `TRIG_RATIO` | 2 | `TRIG_RATIO\|sin\|opposite/hypotenuse` | right_triangle_trig_generator.py |
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: opposite side = 300, hypotenuse = 500; given sin 37° ≈ 0.6\|angle A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|z_part * r_part * angle\|3*25/2*25/2*2*pi\|1875/2*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 3*z\|cylinder radius 5, height 5\|cylindrical` | triple_integral_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|30-60-90 triangle, longer leg = 161√3\|shorter leg and hypotenuse` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
...
| `UNCERTAINTY_SETUP` | 3 | `UNCERTAINTY_SETUP\|particle in a box\|L=1, hbar=1\|n=178` | uncertainty_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|-12, -60, -300, -1500\|geometric, r = 5` | recursive_explicit_generator.py |
| `UPDATE` | 2 | `UPDATE\|W1_11\|5/4` | backprop_generator.py, kernel_perceptron_generator.py |
...
| `VARIANCE` | 1, 2 | `VARIANCE\|Delta x^2\|1/12 - 1/(63368pi^2)` | layer_norm_generator.py, uncertainty_generator.py |
| `VAR_FORMULA` | 1 | `VAR_FORMULA\|Var(X) = Σ P(x)·(x - μ)^2` | expected_value_generator.py |
| `VAR_ROW` | 3 | `VAR_ROW\|3 - 0.8 = 2.2\|(2.2)^2 = 4.84\|1/10·4.84 = 0.484` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|5` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y) = <-x + 4*y, x + 5*y>\|divergence and scalar curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|245 + (-576)\|-331` | diagonalization_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region under y = x(397 - x) on [0, 397], rotated about the y-axis\|shell method` | solid_revolution_generator.py |
...
| `VOP_FORM` | 2 | `VOP_FORM\|u1' = -y2*g/W\|-60/1 * e^(-4x)` | variation_parameters_generator.py |
...
| `WAVE_SETUP` | 3 | `WAVE_SETUP\|power_interval\|psi=N*(x/L)^5\|0<=x<=45` | wavefunction_generator.py |
...
| `WIDTH_SETUP` | 3 | `WIDTH_SETUP\|combined\|Gamma_a=14, Gamma_b=12, Gamma_c=20,hbar=11\|target=BR_b,tau` | branching_ratio_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|23 - 21\|2` | line_integral_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(92 - 82)/4\|2.5` | normal_table_generator.py, z_score_generator.py |
...
| `ZT_SETUP` | 2, 3 | `ZT_SETUP\|difference\|y[n]-(-8)y[n-1]=delta[n]\|y[-1]=0` | z_transform_generator.py |
