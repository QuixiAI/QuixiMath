...
248 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|3x + 3 = 3` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|x + 5 >= 2 -> x >= -3` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|x + 5\| >= 2` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|x + 5 >= 2 OR x + 5 <= -2` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|4x + 5\| = 0` | absolute_value_equation_generator.py |
...
| `ANGLE_RELATION` | 1 | `ANGLE_RELATION\|2x + 9 = 3x + 1` | angle_relationships_generator.py |
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|vertical\|Vertical angles are equal` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|-1x = -8\|x = 8` | angle_relationships_generator.py |
...
| `CHECK` | 3 | `CHECK\|cross_products\|2×24=48\|3×16=48` | linear_fractional_generator.py, ratio_table_generator.py, tip_bill_split_generator.py |
...
| `COMB_X` | 3 | `COMB_X\|-4x\|-4x\|-8x` | linear_complex_generator.py, simplify_expression_generator.py |
| `COMPOSITE_FACTOR` | 2 | `COMPOSITE_FACTOR\|2\|31` | divisibility_classification_generator.py |
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|2x - 4 < -16 -> x < -6` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|14 < x + 9 < 17` | compound_inequality_generator.py |
...
| `DISC` | 3 | `DISC\|36\|-108\|144` | quadratic_generator.py |
| `DIST` | 3 | `DIST\|-1\|-4x-5\|4x+5` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, simplify_expression_generator.py |
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|8y + 21 = -27` | systems_substitution_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|9x^3 - 6x^2 + 12x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|200\|2\|40000` | pythag_hyp_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(0, -3)\|(-1, -6)` | equation_from_two_points_generator.py |
| `EQ_OP_BOTH` | 4 | `EQ_OP_BOTH\|divide\|2\|x\|1` | absolute_value_equation_generator.py, linear_fractional_generator.py, one_step_equation_generator.py, systems_elimination_generator.py, systems_substitution_generator.py, two_step_equation_generator.py |
| `EQ_OP_NOTE` | 3 | `EQ_OP_NOTE\|subtract\|n\|from both sides` | equation_from_two_points_generator.py, literal_equation_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, standard_form_conversion_generator.py |
| `EQ_RESULT` | 2 | `EQ_RESULT\|x\|1` | linear_fractional_generator.py, one_step_equation_generator.py, two_step_equation_generator.py |
| `EQ_SETUP` | 1 | `EQ_SETUP\|x = 120/5` | linear_fractional_generator.py, literal_equation_generator.py, one_step_equation_generator.py, proportion_word_problem_generator.py, standard_form_conversion_generator.py, two_step_equation_generator.py |
| `EQ_SIMPLIFY` | 1 | `EQ_SIMPLIFY\|x/5 = -2` | linear_fractional_generator.py, two_step_equation_generator.py |
| `EXP_EXPAND` | 1 | `EXP_EXPAND\|(-4) × (-4) × (-4) × (-4) × (-4)` | exponent_generator.py |
| `EXP_PARTIAL` | 3 | `EXP_PARTIAL\|-4\|-4\|16` | exponent_generator.py |
| `EXP_RULE_APPLY` | 4 | `EXP_RULE_APPLY\|multiply\|3\|5\|15` | exponent_generator.py |
| `EXP_RULE_IDENTIFY` | 2 | `EXP_RULE_IDENTIFY\|power_rule\|(x^a)^b = x^(ab)` | exponent_generator.py |
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|(b^3)^5` | exponent_generator.py |
| `EXP_RULE_SIMPLIFY` | 1 | `EXP_RULE_SIMPLIFY\|b^15` | exponent_generator.py |
| `EXP_SETUP` | 2 | `EXP_SETUP\|-4\|5` | exponent_generator.py |
...
| `FIND_SLOPE` | 2 | `FIND_SLOPE\|Given slope (m1)\|-4/2` | parallel_perpendicular_line_generator.py |
...
| `FOIL_L` | 2 | `FOIL_L\|Last: (9) * (8)\|72` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (2x) * (8)\|16x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(2x + 9)(3x + 8)` | multiplying_binomials_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|add\|5\|-11 < 1x < 21` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = -4/2x - 4\|(5, 3)` | parallel_perpendicular_line_generator.py |
...
| `MONO_ADD_EXP` | 2 | `MONO_ADD_EXP\|x^2 * x^4 = x^(2+4)\|x^6` | monomial_mult_div_generator.py |
...
| `MONO_SETUP` | 1 | `MONO_SETUP\|(24x^9) / (6x^5)` | monomial_mult_div_generator.py |
| `MONO_SUB_EXP` | 2 | `MONO_SUB_EXP\|x^9 / x^5 = x^(9-5)\|x^4` | monomial_mult_div_generator.py |
| `MOVE_TERM` | 3 | `MOVE_TERM\|+4x\|left\|-4x+1-4x = +9` | linear_complex_generator.py, standard_form_conversion_generator.py |
...
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = -4/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|6x + 25 = 2x + 85` | angle_relationships_generator.py |
| `PARALLEL_SETUP` | 2 | `PARALLEL_SETUP\|alternate_interior\|Alternate interior angles are equal` | angle_relationships_generator.py |
| `PARALLEL_SOLVE` | 2 | `PARALLEL_SOLVE\|4x = 60\|x = 15` | angle_relationships_generator.py |
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.8\|10\|8` | percent_problem_generator.py |
...
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 3 = 3(x - 0)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-13x - 3` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 8x^6 + 6x^2) / (2x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-8x^6) / (2x^2) + (6x^2) / (2x^2)` | polynomial_div_monomial_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-7x -6x) + (-3)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x - 4)(3x^2 - 2x + 4)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1 | `POLY_SETUP\|(-7x) + (-6x - 3)` | polynomial_add_sub_generator.py |
...
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Two coin flips, looking for tails then tails` | compound_probability_generator.py |
...
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|64\|8` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 3 | `PYTHAG_SETUP\|c=10\|a=6\|b=?` | pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 100 - 36\|64` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|6\|36` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|6² + b² = 10²` | pythag_leg_generator.py |
| `Q1` | 4 | `Q1\|6\|12\|6\|3` | quadratic_generator.py |
| `Q2` | 4 | `Q2\|6\|12\|6\|-1` | quadratic_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 10 / 0.1` | percent_problem_generator.py |
| `REWRITE` | 1 | `REWRITE\|12 + 36` | evaluate_expression_generator.py, linear_complex_generator.py, linear_fractional_generator.py, literal_equation_generator.py, order_of_operations_generator.py, simplify_expression_generator.py, standard_form_conversion_generator.py |
| `ROOT` | 2 | `ROOT\|42025\|205` | pythag_hyp_generator.py, quadratic_generator.py |
| `ROOT_EXTRACT` | 2 | `ROOT_EXTRACT\|3` | exponent_generator.py |
| `ROOT_IDENTIFY` | 3 | `ROOT_IDENTIFY\|9\|perfect_square\|3` | exponent_generator.py |
| `ROOT_SETUP` | 1 | `ROOT_SETUP\|√9` | exponent_generator.py |
| `ROOT_SIMPLIFY` | 1 | `ROOT_SIMPLIFY\|6√7` | exponent_generator.py |
...
| `SA_FACES` | 3 | `SA_FACES\|top/bottom\|5 × 5\|25` | volume_3d_generator.py |
| `SA_FORMULA` | 1 | `SA_FORMULA\|SA = 2(lw + lh + wh)` | volume_3d_generator.py |
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 4 × 9\|72π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=5, w=5, h=7` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(25 + 35 + 35)\|190` | volume_3d_generator.py |
...
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|divide_coefficients\|4.5\|1.5\|3.0` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|280000` | exponent_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|10 = 0.1 * whole` | percent_problem_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -2x + 7` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|3` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(10, 3)\|(-9, -1)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-1 - 3) / (-9 - 10)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(59 + 60) / 2\|59.5` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|10` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|37\|27\|10` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|430 / 10\|43` | statistics_generator.py |
...
| `STAT_MEAN` | 2 | `STAT_MEAN\|189 / 7\|27` | statistics_generator.py |
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|position 4\|61` | statistics_generator.py |
...
| `STAT_ORDER` | 1 | `STAT_ORDER\|15, 19, 34, 61, 64, 66, 95` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|87 - 25\|62` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|38, 54, 23, 34, 64, 67, 37, 50, 33, 30` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|38 + 54 + 23 + 34 + 64 + 67 + 37 + 50 + 33 + 30\|430` | statistics_generator.py |
...
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: 2y = 8` | systems_elimination_generator.py |
...
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|3x + 3y = -18\|-3x - 1y = 26` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x = y + 7\|3x + 5y = -27` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute (y + 7) for x in Eq 2` | systems_substitution_generator.py |
...
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|51\|76\|x` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|x = 180 - 51 - 76\|53` | angle_relationships_generator.py |
| `TRI_ANGLE_SUM` | 1 | `TRI_ANGLE_SUM\|51 + 76 + x = 180` | angle_relationships_generator.py |
...
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 12 × 7\|42.0` | volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 42.0 × 11\|462.0` | volume_3d_generator.py |
| `VOL_FORMULA` | 1 | `VOL_FORMULA\|V = Base Area × length` | volume_3d_generator.py |
| `VOL_SETUP` | 2 | `VOL_SETUP\|triangular_prism\|b=12, h_tri=7, length=11` | volume_3d_generator.py |
