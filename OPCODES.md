...
348 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|9x^3 + 9x^2 + 3x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|93476 × 27153 ≈ 90000 × 30000\|2700000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2700000000\|2538153828\|2538153828 ≈ 2700000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|11 × 8 = 88, not 80` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 5x - 3 = -23\|line 3 shows 5x = -20` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(489, 5)\|P(499 < X < 500)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 6x^4 - 6x^3 + 9x^3) / (-3x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-6x^4) / (-3x) + (-6x^3) / (-3x) + (9x^3) / (-3x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x + 2)(3x^2 + 3x + 1)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(499 - 489)/5\|2.00` | normal_table_generator.py |
