...
491 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|4x - 4 = 6` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|2x + 9 > 10 -> x > 1/2` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|2x + 9\| > 10` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for >=` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|2x + 9 > 10 OR 2x + 9 < -10` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|4x - 4\| = 6` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|4x - 4 = 6\|4x - 4 = -6` | absolute_value_equation_generator.py |
...
| `ACCEPT` | 2 | `ACCEPT\|(-1, 6)\|product -6 ✓, sum 5 ✓` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|fair die; A = [1, 2], B = [4, 5, 6]\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 9, central angle 270°\|sector area` | arc_sector_generator.py |
| `AREA` | 1, 3 | `AREA\|80` | geometry_area_perimeter_generator.py |
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 and y = 10x - 21\|area between the curves` | area_between_curves_generator.py |
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = 2 ± (3/5)(x - 4)` | hyperbola_features_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 50, disease=no 80\|sensitivity 7/10, specificity 3/4\|P(disease=no given test negative)` | conditional_probability_generator.py |
| `BINOM_FORMULA` | 1 | `BINOM_FORMULA\|E[X] = n·p` | binomial_probability_generator.py |
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 8, p = 1/5\|E[X]` | binomial_probability_generator.py |
| `BORROW` | 3 | `BORROW\|col_1\|from_left\|1` | multi_digit_subtraction_generator.py |
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|165 <= 100\|no` | piecewise_evaluation_generator.py |
...
| `CBRT` | 2 | `CBRT\|27y^3\|3y` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
| `CEIL` | 2 | `CEIL\|138.2976\|139` | confidence_interval_generator.py |
| `CENTER` | 1 | `CENTER\|(-5, -3)` | circle_equation_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|row 1: 6, 14; row 2: 14, 66; N = 100\|independence; df = 1, critical value = 3.841` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|6 - 4 = 2\|2^2 = 4\|4/4 = 1` | chi_square_generator.py |
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|central angle 84° subtends an arc\|inscribed angle on the same arc` | circle_angle_generator.py |
...
| `CI_SETUP` | 2 | `CI_SETUP\|p̂ = 0.5, n = 400, z* = 2.576\|margin of error` | confidence_interval_generator.py |
...
| `COEFFS` | 1, 2 | `COEFFS\|1, 0, -26, -13\|0 inserted for missing x^2 term` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[-2, -4], [1, 0]]` | determinant_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|-7 - (-8)\|1` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|2x + 3 < -11 -> x < -7` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|2x + 3 < -11 OR 2x + 3 > 1` | compound_inequality_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 8, no/bike 18, yes/bus 26, no/bus 27\|P(commute=bus given club=yes)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|club=yes total\|8 + 26 = 34` | conditional_probability_generator.py |
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(x + 3)^2 = 12(y + 6)\|vertex, focus, directrix` | conic_standard_form_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
| `CONJUGATE` | 2 | `CONJUGATE\|2 - i\|2 + i` | complex_division_generator.py |
...
| `CROSS_MULT` | 1 | `CROSS_MULT\|30·BC = 12·20` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 3x^2 - 45x - 7\|inflection point and concavity` | curve_analysis_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 2x^2 + 7x + 3x^(-1)\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
...
| `DEV_ROW` | 3 | `DEV_ROW\|14\|-2\|4` | standard_deviation_generator.py |
| `DIRECTRIX` | 1 | `DIRECTRIX\|y = -9` | parabola_features_generator.py |
| `DISC` | 2, 3 | `DISC\|1\|-8\|9` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `DISC_CLASSIFY` | 2 | `DISC_CLASSIFY\|-7 < 0\|no real solutions` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|1y + -22 = -30` | systems_substitution_generator.py |
...
| `DIV_TERM` | 3 | `DIV_TERM\|6t^4\|3\|2t^4` | factor_gcf_generator.py, polynomial_long_division_generator.py |
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|radicand ≥ 0\|2t + 4 ≥ 0` | domain_range_generator.py |
...
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(-7, -9)\|(-5, -9)` | equation_from_two_points_generator.py |
...
| `EQ_OP_NOTE` | 3 | `EQ_OP_NOTE\|divide\|y\|from both sides` | equation_from_two_points_generator.py, literal_equation_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, standard_form_conversion_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|42391 × 14772 ≈ 40000 × 10000\|400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|400000000\|626199852\|626199852 ≈ 400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FIND_SLOPE` | 2 | `FIND_SLOPE\|Given slope (m1)\|-3/4` | parallel_perpendicular_line_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-22 + 8 = -14, not -18` | error_spotting_generator.py |
...
| `FOIL_I` | 2 | `FOIL_I\|Inner: 2i * (-9)\|-18i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|2/-7\|-2/7` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|2/6\|0.3333333333` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Soccer: 7, Tennis: 5, Golf: 2, Track: 9\|total count` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(f · g)(-2)\|f(-2) · g(-2)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|t: -4, -2, 2, 4, 5; g(t): 29, -4, 26, 17, -6\|g(2)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|6, 15, 15\|3` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; the altitude splits the hypotenuse into p = 11 and q = 2\|altitude h` | geometric_mean_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-3x^3 - 5x^2 + 5x + 5\|x = -1` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 100, 61 successes, critical value = 2.326` | hypothesis_test_generator.py |
| `HYPERCUBE_FORMULA` | 1 | `HYPERCUBE_FORMULA\|diagonal = s·√n` | hypercube_counting_generator.py |
| `HYPERCUBE_SETUP` | 2 | `HYPERCUBE_SETUP\|points P(-5, -2, 3, -2) and Q(-2, -4, -3, -3) in R^4\|distance` | hypercube_counting_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|add\|7\|5 <= 5x <= 9` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (-9x^2 + 4x - 3) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 2x - 9 on [-1, 3]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
| `I_CYCLE` | 2 | `I_CYCLE\|i^0\|1` | complex_number_ops_generator.py |
| `I_SQUARE` | 2 | `I_SQUARE\|18i^2\|-18` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = -3/4x - 10\|(-7, 0)` | parallel_perpendicular_line_generator.py |
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(2x)) = ln(35)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
...
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|3x + 6 = x + 4` | log_equation_generator.py |
| `LOG_POWER` | 2 | `LOG_POWER\|log_3(x^3)\|3log_3(x)` | log_diff_higher_order_generator.py, log_properties_generator.py |
| `LOG_PRODUCT` | 2 | `LOG_PRODUCT\|log_3(81x^3y^3)\|log_3(81x^3) + log_3(y^3)` | log_equation_generator.py, log_properties_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_10(10x^3/y^3)\|log_10(10x^3) - log_10(y^3)` | log_properties_generator.py |
| `LOG_SETUP` | 2 | `LOG_SETUP\|log_3(81x^3y^3)\|expand` | log_properties_generator.py |
...
| `MAT_ENTRY` | 2 | `MAT_ENTRY\|(1,1)\|-9` | matrix_ops_generator.py |
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[3, 0], [-2, -6]]\|-3A` | determinant_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py |
| `MAX` | 2 | `MAX\|12, 1\|12` | taxicab_geometry_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 2000e^0.27` | exponential_model_generator.py |
...
| `MONO_ADD_EXP` | 2 | `MONO_ADD_EXP\|x^7 * x^4 = x^(7+4)\|x^11` | monomial_mult_div_generator.py |
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|12 / -2\|-6` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|-5 * -2\|10` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-5x^7)(-2x^4)` | monomial_mult_div_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 + 4x - 4 on [-4, 0]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `NCR` | 2 | `NCR\|C(6,2)\|15` | binomial_probability_generator.py, hypercube_counting_generator.py |
| `NEED` | 2 | `NEED\|the equation is 7x + 9 = -19\|line 3 shows 7x = -28` | fill_in_step_generator.py |
| `NET_SETUP` | 2 | `NET_SETUP\|6 squares 6 by 6\|total surface area` | nets_surface_area_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 4/3\|Perpendicular lines have negative reciprocal slopes` | parallel_perpendicular_line_generator.py |
| `NORMAL_SLOPE` | 2 | `NORMAL_SLOPE\|-1/(3)\|-1/3` | tangent_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(113, 4)\|is x = 103 unusual?` | normal_table_generator.py, z_score_generator.py |
...
| `OPT_SETUP` | 2 | `OPT_SETUP\|square sheet 18 by 18; cut corners x and fold\|maximize volume` | optimization_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(x + 6)/(x + 3)^2 = A/(x + 3) + B/(x + 3)^2` | partial_fractions_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.1\|120\|12` | percent_problem_generator.py |
...
| `PERM_SETUP` | 2 | `PERM_SETUP\|P(13, 3)\|n!/(n-r)!` | permutation_combination_generator.py |
...
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|y - 8 = ±10\|y - 8 = 10 or y - 8 = -10` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 9 = 0(x + 7)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2 | `POLAR_SETUP\|(r, θ) = (4, 150°)\|rectangular coordinates` | parametric_calculus_generator.py, polar_parametric_generator.py |
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|2x^3 - 7x^2 - x - 19\|x - 4` | polynomial_long_division_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-14x - 14` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 27x^6 + 18x^5 - 27x^5 - 27x^2) / (-9x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-27x^6) / (-9x^2) + (18x^5) / (-9x^2) + (-27x^5) / (-9x^2) + (-27x^2) / (-9x^2)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-7x -7x) + (-8 -6)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x - 5)(-2x^2 + 5x + 4)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-7x - 8) - (7x + 6)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2 | `POLY_SUB\|(2x^3 - 7x^2) - (2x^3 - 8x^2)\|x^2` | polynomial_long_division_generator.py |
| `POW` | 2 | `POW\|(3/10)^7\|0.0002187` | binomial_probability_generator.py, geometric_distribution_generator.py |
| `POWER_RULE` | 2 | `POWER_RULE\|2x^2\|4x` | chain_rule_generator.py, curve_analysis_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, lhopital_generator.py, linear_approx_generator.py, log_diff_higher_order_generator.py, mean_value_theorem_generator.py, optimization_generator.py, tangent_line_generator.py |
...
| `Q1` | 4 | `Q1\|1\|3\|2\|2` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|1\|3\|2\|-1` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|277°\|quadrant IV` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
| `QUARTILE` | 3 | `QUARTILE\|Q1\|7,11,19\|11` | five_number_summary_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 15 / 0.5` | percent_problem_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|line ŷ = 59.1 - 0.7x\|predict ŷ at x = 10` | regression_generator.py |
...
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (5, 74), line ŷ = 79.4 - 1.8x\|residual = observed − predicted` | regression_generator.py |
...
| `RIEMANN_SETUP` | 2 | `RIEMANN_SETUP\|f(x) = x^2 - 5 on [1, 9], n = 4\|trapezoid rule` | riemann_sum_generator.py |
...
| `ROW_OP` | 2 | `ROW_OP\|R2 → R2 + 2·R1\|[0, 1, 2]` | row_reduction_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(4, 7), B(-10, 14); ratio 2:5 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_15 = -8 + (15 - 1)·1` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|-8, -7, -6, -5, ...\|sum of first 15 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ n/(n^2 + 2), n ≥ 1\|converge or diverge?` | power_series_generator.py, series_convergence_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 0.1 * 120` | percent_problem_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|3 + 9 + 27 + 81 + 243` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=1)^(5) 3^k\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=1\|3^1\|3` | sigma_notation_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; DE = 30, AB = 12, EF = 20\|find BC` | similar_triangles_generator.py |
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = -2cos(2(x - π/4)) + 2\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(6, 7)\|(-4, 3)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (3 - 7) / (-4 - 6)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|-11n = -15n + 4n\|12n^2 - 15n + 4n - 5` | factor_trinomial_generator.py |
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|(y - 8)^2 = 100\|y - 8 = ±10` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
...
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|49\|49 × 1\|49` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `SUM` | 2 | `SUM\|58 + 60 + 56 + 62 + 64\|300` | regression_generator.py |
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = 5y - 9` | inverse_function_generator.py |
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|x^3 - 26x - 13\|r = -5` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_DROP` | 1 | `SYN_DROP\|1` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_ROW` | 1 | `SYN_ROW\|1, -5, -1, -8` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = -1y + 1` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * 2, Eq2 * 3` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|6x - 8y = 68\|-6x + 3y = -48` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x = -2y - 22\|1x + 3y = -30` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute (-2y - 22) for x in Eq 2` | systems_substitution_generator.py |
...
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|g(-2)\|-1` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|g(2)\|26` | dot_product_generator.py, function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
...
| `TRANSFORM_SETUP` | 2 | `TRANSFORM_SETUP\|P(3, 4)\|reflection over the y-axis` | transformation_generator.py |
| `TRIG_RATIO` | 2 | `TRIG_RATIO\|cos\|adjacent/hypotenuse` | right_triangle_trig_generator.py |
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: adjacent side = 40, hypotenuse = 50; given cos 37° ≈ 0.8\|angle A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRY` | 2 | `TRY\|(-1, 6)\|(-1)·6=-6, (-1)+6=5` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
| `UC_POINT` | 2 | `UC_POINT\|0°\|(1, 0)` | unit_circle_generator.py |
| `UNIT_ATTACH` | 3 | `UNIT_ATTACH\|308\|feet\|308 feet` | kinematics_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|-9, -7, -5, -3\|arithmetic, d = 2` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|1 - 1.5 = -0.5\|(-0.5)^2 = 0.25\|3/5·0.25 = 0.15` | expected_value_generator.py |
...
| `VERTEX` | 1 | `VERTEX\|(-3, -6)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `ZERO_PRODUCT` | 2 | `ZERO_PRODUCT\|4n(n - 4) = 0\|4n = 0 or n - 4 = 0` | area_between_curves_generator.py, curve_analysis_generator.py, domain_range_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_equation_generator.py, trig_equation_generator.py |
| `ZSCORE` | 2 | `ZSCORE\|(83 - 90)/25\|-0.28` | normal_table_generator.py, z_score_generator.py |
