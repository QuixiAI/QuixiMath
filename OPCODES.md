...
323 distinct op-codes observed.
...
| `ESTIMATE` | 2 | `ESTIMATE\|49052 × 25776 ≈ 50000 × 30000\|1500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1500000000\|1264364352\|1264364352 ≈ 1500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|-36 ÷ 6 = -6, not -7` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 3x - 15 = 9\|line 3 shows 3x = 24` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(508, 10)\|P(516 < X < 529)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(2x^4 + 5x^3 + 4x^3) / (x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(2x^4) / (x^3) + (5x^3) / (x^3) + (4x^3) / (x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-x + 3)(-2x^2 - 2x - 3)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(516 - 508)/10\|0.80` | normal_table_generator.py |
