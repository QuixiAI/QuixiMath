...
1676 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|x + 2 = 10` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|4x + 5 > 2 -> x > -3/4` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|abs(4x + 5) > 2` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <=` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|4x + 5 > 2 or 4x + 5 < -2` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(x + 2) = 10` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|x + 2 = 10\|x + 2 = -10` | absolute_value_equation_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 1/6, P(B) = 3/6, mutually exclusive\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `ALG_SETUP` | 3 | `ALG_SETUP\|insertion sort\|passes 2\|values 35, 30, 4, 19, 8, 10` | algorithm_trace_generator.py |
| `ALIGN_NUM` | 2 | `ALIGN_NUM\|046.36\|177.07` | number_comparison_generator.py |
| `ALPHA` | 2 | `ALPHA\|alpha1\|0` | kernel_ridge_generator.py |
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda s. (f s)\|lambda z. (f z)` | lambda_reduction_generator.py |
...
| `ANGLE_DEFECT_SETUP` | 2 | `ANGLE_DEFECT_SETUP\|R=7\|angles=15,90,15` | angle_defect_generator.py |
...
| `APPLY_GATE` | 3 | `APPLY_GATE\|Y\|e^(i35π/246)·ket0\|i·e^(i35π/246)·ket1` | quantum_gate_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 33, central angle 250°\|arc length` | arc_sector_generator.py |
| `AREA` | 1 | `AREA\|66` | geometry_area_perimeter_generator.py |
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|2*10^2/2\|100` | centroid_generator.py |
...
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 + 3x - 8 and y = 16x - 38\|area between the curves` | area_between_curves_generator.py |
| `ARGUMENT` | 2 | `ARGUMENT\|(0,-5)\|270 deg` | complex_log_generator.py, euler_formula_generator.py |
...
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|30, 35, 4, 19, 8, 10` | algorithm_trace_generator.py |
| `ASSIGN` | 2 | `ASSIGN\|P1\|C2` | kmeans_step_generator.py |
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = -2 ± (3/4)x` | hyperbola_features_generator.py |
| `ATA` | 2 | `ATA\|A^T A\|[[4882, 1518], [1518, 4882]]` | svd_generator.py |
...
| `AV_VECTOR` | 2 | `AV_VECTOR\|A*v1\|[80/√2, 80/√2]` | svd_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 50, disease=no 400\|sensitivity 9/10, specificity 19/20\|P(disease=no given test negative)` | conditional_probability_generator.py |
...
| `BETA` | 1 | `BETA\|(lambda m. (lambda c. (n m))) applied to a` | lambda_reduction_generator.py |
| `BEZOUT_CHECK` | 2 | `BEZOUT_CHECK\|81*-19 + 55*28\|1` | extended_euclid_generator.py |
...
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 4, k = 2, p = 3/4\|P(X = k)` | binomial_probability_generator.py |
...
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables Q, R, S\|CNF from h=0 rows` | boolean_algebra_generator.py |
...
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|2.5 <= 1\|no` | piecewise_evaluation_generator.py |
...
| `CALC` | 1 | `CALC\|y = -6` | systems_elimination_generator.py, systems_substitution_generator.py |
...
| `CBRT` | 2 | `CBRT\|64m^3\|4m` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
...
| `CEIL` | 2 | `CEIL\|163.84\|164` | confidence_interval_generator.py |
| `CENTER` | 1, 2 | `CENTER\|(-1, 3)` | circle_equation_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, pca_generator.py |
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(2000/3)/(100)\|20/3` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= 2*x\|0 <= x <= 10\|centroid` | centroid_generator.py |
...
| `CF_RESULT` | 1 | `CF_RESULT\|[4; 1, 18]` | continued_fraction_generator.py |
| `CF_SETUP` | 1 | `CF_SETUP\|94/19` | continued_fraction_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*dx/dt + f_y*dy/dt\|7*3 + 0*1\|21` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(-1)\|3*(-1) + 3\|0` | multivar_chain_rule_generator.py |
| `CHANGE_BASE` | 1 | `CHANGE_BASE\|log_81(27) = log_3(27)/log_3(81)` | log_conversion_generator.py |
| `CHAR_DIAG` | 2 | `CHAR_DIAG\|diagonal of λI - A\|(λ + 1), (λ - 4)` | eigenvalue_generator.py |
| `CHAR_EQ` | 2 | `CHAR_EQ\|assume y=e^(rx)\|r^2 + 8r + 20 = 0` | ode_system_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^2 - 3λ - 4\|(λ + 1)*(λ - 4)` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
| `CHAR_ROOTS` | 2 | `CHAR_ROOTS\|r = -4 ± 2i\|complex conjugates` | recurrence_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|row 1: 18, 2; row 2: 62, 18; N = 100\|independence; df = 1, critical value = 3.841` | chi_square_generator.py |
...
| `CHRISTOFFEL_SETUP` | 3 | `CHRISTOFFEL_SETUP\|sphere\|g_phiphi=R^2, g_thetatheta=R^2 sin^2(phi)\|R=114, phi=45 deg` | christoffel_generator.py |
| `CHRISTOFFEL_VALUE` | 2 | `CHRISTOFFEL_VALUE\|Gamma^phi_thetatheta\|-4680/9409` | riemann_tensor_generator.py |
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|triangle inscribed in a circle with one side a diameter; one acute angle is 15°\|the other acute angle` | circle_angle_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(-7)*3^2*pi\|-63*pi` | vector_theorem_generator.py |
| `CI_FORMULA` | 1 | `CI_FORMULA\|x̄ ± E` | confidence_interval_generator.py |
| `CI_SETUP` | 2 | `CI_SETUP\|σ = 8, n = 25, z* = 1.28\|confidence interval for μ` | confidence_interval_generator.py |
| `CLASSIFY` | 2 | `CLASSIFY\|contingency\|T at 3 of 8 rows` | truth_table_generator.py |
| `CLAUSE` | 2 | `CLAUSE\|C1\|(not P84676 OR P89867)` | resolution_proof_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(Q OR R OR S) AND (Q OR R OR NOT S) AND (NOT Q OR R OR S)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|-46560` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|3, 10, -7, 4` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[-1, -1], [-4, 0]]` | determinant_generator.py |
...
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2\|[[10, 3, -5], [3, 1, -2]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(3,1)\|3` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = -38*v1 - 6*v2\|[-6, -8]` | diagonalization_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|choose 6 of 8\|order does not matter` | counting_classics_generator.py, permutation_combination_generator.py, stars_and_bars_generator.py |
...
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|438/219\|2` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|5x - 10 < -10 -> x < 0` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|24 < 4x + 8 < 48` | compound_inequality_generator.py |
...
| `COND_COUNT` | 2 | `COND_COUNT\|club=yes and commute=bus\|12` | conditional_probability_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 20, no/bike 5, yes/bus 12, no/bus 9\|P(club=yes given commute=bus)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|commute=bus total\|12 + 9 = 21` | conditional_probability_generator.py |
| `CONGRUENCE_REDUCE` | 2 | `CONGRUENCE_REDUCE\|23x congruent to 2\|mod 10` | modular_inverse_generator.py |
| `CONGRUENCE_SOLUTIONS` | 3 | `CONGRUENCE_SOLUTIONS\|base 4\|step 10\|4, 14, 24, 34` | modular_inverse_generator.py |
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(y - 1)^2 = -20(x - 4)\|vertex, focus, directrix` | conic_standard_form_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|3*x + 2*y = 176\|lambda*(9/4 + 4/8) = 176\|lambda = 64` | lagrange_multiplier_generator.py |
| `CONST_SOLVE` | 2 | `CONST_SOLVE\|C1 = 2\|C2 = 1` | recurrence_generator.py |
| `CONTOUR_SETUP` | 3 | `CONTOUR_SETUP\|abs(z)=3\|positive orientation\|f=6/(z-3) + 1/(z-6) - 3/(z+2)` | contour_integral_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[-38, -6]` | diagonalization_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|17 boxes\|force 15 in one box` | counting_classics_generator.py |
...
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|-10*x - 2*y - 32 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|(-10)*6 - (-2)^2\|-64` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=1\|ln(14/9)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|2·EF = 4·5` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CROSS_RATIO` | 1 | `CROSS_RATIO\|-3/4` | mobius_transform_generator.py |
| `CROSS_RATIO_SETUP` | 4 | `CROSS_RATIO_SETUP\|z1=0\|z2=2\|z3=-6\|z4=1` | mobius_transform_generator.py |
| `CRT_CHECK` | 3 | `CRT_CHECK\|i=1\|1\|1` | crt_generator.py |
| `CRT_CONGRUENCE` | 3 | `CRT_CONGRUENCE\|i=1\|x=1\|mod 9` | crt_generator.py |
...
| `CR_SETUP` | 2 | `CR_SETUP\|u=-x^2 + y^2 + 4x + 5y\|v=-2xy - 5x + 4y` | cauchy_riemann_generator.py |
| `CUM_INTERVAL` | 2 | `CUM_INTERVAL\|A\|[0,1/4)` | arithmetic_coding_generator.py |
| `CURL_COMPONENT` | 3 | `CURL_COMPONENT\|i\|1 - 2\|-1` | div_curl_generator.py |
...
| `CX_SETUP` | 2 | `CX_SETUP\|(3 - i)(-8 + 7i)\|multiply` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `CYCLIC_SUBGROUP` | 2 | `CYCLIC_SUBGROUP\|{0, 4, 8, 12, 16, 20, 2, 6, 10, 14, 18}\|11` | cyclic_group_generator.py |
| `CYK_CELL` | 2 | `CYK_CELL\|1,2\|{C,S}` | cyk_parser_generator.py |
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|A C\|{S}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|A\|c or S Z or Z S` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string caa\|length 3` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{A,C} x {C,Z}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|c\|{A,C}` | cyk_parser_generator.py |
...
| `DEGREE` | 2, 3 | `DEGREE\|A\|C, E, F\|3` | euler_circuit_generator.py, graph_counting_generator.py |
...
| `DEGREE_SEQUENCE` | 1 | `DEGREE_SEQUENCE\|4, 3, 2, 1, 1, 1` | graph_counting_generator.py |
...
| `DEMOIVRE_SETUP` | 2, 4 | `DEMOIVRE_SETUP\|arbitrary_roots\|R=25\|theta=0 deg\|n=2` | de_moivre_generator.py |
...
| `DENSITY_SETUP` | 2, 3 | `DENSITY_SETUP\|state=plus_phase_0\|psi=(ket00 + e^(i168π/253)ket10)/sqrt(2)` | density_matrix_generator.py, partial_trace_generator.py |
...
| `DERANGE_SETUP` | 2 | `DERANGE_SETUP\|n = 6\|exactly 1 fixed` | derangement_generator.py |
...
| `DERIVED` | 2 | `DERIVED\|C5\|(not P84676)` | resolution_proof_generator.py |
| `DERIV_FORM` | 2 | `DERIV_FORM\|y'(0)\|-4C1 + 2C2` | second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 5x^2 - 6x + x^(-3)\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -3], [1, -1], [1, 1], [1, 3]]\|y = [-1, -1, 5, 17]` | least_squares_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[1, 0], [12, 1]]\|D = [[3, 0], [0, 7]]\|P^-1 = [[1, 0], [-12, 1]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[8, 16, 24]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 2*x^2 + 3*y^2 + 4*x*y - 6*x + 3*y\|point (-1, -2)\|dx=2/5, dy=-2/5` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|(-18)*2/5 + (-13)*(-2/5)\|-2` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|152881\|48552\|104329` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `DISC_CLASSIFY` | 2 | `DISC_CLASSIFY\|-115 < 0\|no real solutions` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-7x - 24 = -17` | systems_substitution_generator.py |
...
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited E\|A=7, B=4, C=inf, D=inf, E=0, F=inf` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|- 6x^3 - 6x^2 - 9x` | multiplying_polynomials_generator.py |
...
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y + R_z\|3 + 0 + 5\|8` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|18t^3\|6t\|3t^2` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT V AND W AND X AND NOT Y) OR (NOT V AND W AND X AND Y) OR (V AND NOT W AND NOT X AND Y) OR (V AND NOT W AND X AND Y) OR (V AND W AND NOT X AND NOT Y)` | boolean_algebra_generator.py |
| `DOMAIN` | 2 | `DOMAIN\|x = −45..−35\|{−45, −44, −43, −42, −41, −40, −39, −38, −37, −36, −35}` | set_builder_roster_generator.py |
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|denominator ≠ 0\|-2x ≠ 0` | domain_range_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(0, 12) · (5/13, 12/13)\|0*5/13 + 12*12/13\|144/13` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `DOUBLE_SETUP` | 2, 3 | `DOUBLE_SETUP\|integrand 12\|x:0..7\|y:0..2*x` | double_integral_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=5,v=3); 2:(w=2,v=10); 3:(w=5,v=11)` | dp_table_generator.py |
...
| `D_POWER` | 2 | `D_POWER\|D^2\|[[9, 0], [0, 49]]` | diagonalization_generator.py |
...
| `ECDSA_SETUP` | 4 | `ECDSA_SETUP\|E/F_17, G=(5,1), n=19\|d=9\|z=5\|k=8` | ecdsa_generator.py |
| `ECDSA_SIGN` | 2 | `ECDSA_SIGN\|s=k^-1(z+rd) mod n\|s=1` | ecdsa_generator.py |
| `ECDSA_VERIFY` | 2 | `ECDSA_VERIFY\|u1=5\|u2=13` | ecdsa_generator.py |
| `EC_ACCUM` | 2 | `EC_ACCUM\|1P\|(13,8)` | elliptic_curve_finite_field_generator.py |
| `EC_ADD` | 1 | `EC_ADD\|(13,7)` | ecdsa_generator.py |
| `EC_IDENTITY` | 2 | `EC_IDENTITY\|O + Q\|(13,8)` | elliptic_curve_finite_field_generator.py |
...
| `EC_PUBLIC` | 2 | `EC_PUBLIC\|A=(6,3)\|B=(7,6)` | ecdh_generator.py |
| `EC_SCALAR` | 2 | `EC_SCALAR\|a=2\|aG=(6,3)` | ecdh_generator.py, ecdsa_generator.py |
| `EC_SCALAR_SETUP` | 2 | `EC_SCALAR_SETUP\|k=3\|P=(13,8)` | elliptic_curve_finite_field_generator.py |
...
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|BC\|weight 9\|add B` | mst_generator.py |
...
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 1I\|[[0, 3], [0, 5]]` | eigenvalue_generator.py |
...
| `ELEMENT_ORDER` | 2 | `ELEMENT_ORDER\|r\|3` | cayley_table_generator.py |
...
| `EQUILIBRIA` | 2 | `EQUILIBRIA\|f(y) = 0\|y=-4, y=1, y=8` | stability_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(1, -10)\|(3, -16)` | equation_from_two_points_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|67446 × 59562 ≈ 70000 × 60000\|4200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|81\|55\|1\|26` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `EV_SETUP` | 2 | `EV_SETUP\|P($-1) = 1/4; P($5) = 1/4; P($2) = 1/4; P($11) = 1/4\|expected value of the game` | expected_value_generator.py |
| `EXACT_MATCH` | 2 | `EXACT_MATCH\|F_y = N\|x + g'(y) = x + 10*y` | exact_ode_generator.py |
...
| `EXP_APPLY` | 2 | `EXP_APPLY\|x(t) = e^(At)x(0)\|x(0) = [-1, -4]` | matrix_exponential_generator.py |
...
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|81\|55` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `FACTOR_PAIR_GOAL` | 2 | `FACTOR_PAIR_GOAL\|m·n = 36\|m + n = -13` | factor_trinomial_generator.py |
...
| `FERMAT_SETUP` | 3 | `FERMAT_SETUP\|prime 31\|base 6\|exponent 95` | totient_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|3 × 2 = 6, not 2` | error_spotting_generator.py |
...
| `FLUX_SUM` | 2 | `FLUX_SUM\|(5 - 2 + 3)*360\|2160` | vector_theorem_generator.py |
...
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-i) * (-8)\|8i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(3 + √2)(4 + √2)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FRACTAL_SETUP` | 4 | `FRACTAL_SETUP\|julia\|z0=(-1,1)\|c=(-1/2,-1/2)\|N=4` | fractal_iteration_generator.py |
...
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Red: 4, Blue: 6, Green: 3, Yellow: 11\|relative frequency of Blue` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(f/g)(3)\|f(3)/g(3)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|x: -3, -1, 4, 5, 8; h(x): 4, 14, 28, 27, -7\|h(-1)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
| `FUNDAMENTAL_FORM_SETUP` | 3 | `FUNDAMENTAL_FORM_SETUP\|sphere\|R=5\|theta in [0,pi], phi in [0,180]` | fundamental_form_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|18, 42, 24\|6` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_RESULT` | 1 | `GCF_RESULT\|6t` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
| `GCF_VAR` | 2 | `GCF_VAR\|t^3, t^2, t\|t` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEOM_SETUP` | 2 | `GEOM_SETUP\|p = 7/10, q = 3/10\|P(X > 3)` | geometric_distribution_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude h = 140 to the hypotenuse; one segment p = 1400\|the other segment q` | geometric_mean_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^3]\|(1 + x)^3(1 + x)^4` | generating_function_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = 5*x^2 + 2*y^2 - 2*x*y + 6*x - 4*y\|point (2, 1)\|gradient` | gradient_generator.py |
...
| `GREAT_CIRCLE_SETUP` | 3 | `GREAT_CIRCLE_SETUP\|R=3\|A=(0,150)\|B=(0,-30)` | great_circle_generator.py |
...
| `GS_SETUP` | 2 | `GS_SETUP\|vectors [[4, 2, 0], [11, 8, 0], [6, -2, -1]]\|orthogonal basis, not normalized` | gram_schmidt_generator.py |
...
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|(-10)*6 - (-2)^2\|-64` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = -5*x^2 + 3*y^2 - 2*x*y - 32*x\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = -64\|f_xx = -10\|saddle point` | hessian_classify_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|3x^3 - 2x^2 - 4x - 1\|x = 2` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 400, 276 successes, critical value = 1.96` | hypothesis_test_generator.py, two_sample_test_generator.py |
...
| `HYPERBOLIC_DISTANCE_SETUP` | 3 | `HYPERBOLIC_DISTANCE_SETUP\|disk\|P=(0,0)\|Q=(23/31,0)` | hyperbolic_distance_generator.py |
| `HYPERBOLIC_SETUP` | 2 | `HYPERBOLIC_SETUP\|e^x=35/9\|e^(-x)=9/35` | hyperbolic_function_generator.py |
...
| `IDENTITY` | 2 | `IDENTITY\|Vandermonde\|Σ C(13,i)C(18,9-i) = C(31,9)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=24, n(B)=32, n(C)=34\|n(AB)=12, n(AC)=11, n(BC)=10, n(ABC)=7` | inclusion_exclusion_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|6\|-21 ≤ 5x ≤ 9` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INITIAL_COEFF` | 2 | `INITIAL_COEFF\|a_0\|23280` | series_solution_generator.py |
| `INITIAL_EQ` | 2 | `INITIAL_EQ\|C1 + C2\|3` | recurrence_generator.py |
| `INITIAL_SYSTEM` | 2 | `INITIAL_SYSTEM\|C1[2, 1] + C2[1, 0]\|[-8, -2]` | ode_system_generator.py |
| `INNER_ANTIDERIV` | 2 | `INNER_ANTIDERIV\|dx\|12*x` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_EVAL` | 2, 3 | `INNER_EVAL\|x=y/2..7\|12*(7 - y/2)` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_PRODUCT` | 2 | `INNER_PRODUCT\|inner(phi,psi)\|1-3i` | braket_generator.py |
| `INNER_PRODUCT_SETUP` | 3 | `INNER_PRODUCT_SETUP\|interval=[0,2pi]\|f=cos(41x)\|g=cos(26x)` | function_inner_product_generator.py |
| `INSERT_KEY` | 3 | `INSERT_KEY\|pass 1\|30\|index 1` | algorithm_trace_generator.py |
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 0\|30, 35, 4, 19, 8, 10` | algorithm_trace_generator.py |
| `INTEGRAL` | 1, 2 | `INTEGRAL\|integral cos(15x) on [0,2pi]\|0` | fourier_series_generator.py, function_inner_product_generator.py, legendre_construction_generator.py |
| `INTEGRAL_SETUP` | 1 | `INTEGRAL_SETUP\|L = integral from 0 to pi/3 of 9 dtheta` | metric_arc_length_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (-4x^3 - 1) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `ITERATE` | 2 | `ITERATE\|n=1\|z=(-1/2,-5/2)` | fractal_iteration_generator.py, gradient_descent_generator.py |
...
| `JACOBI_SETUP` | 3 | `JACOBI_SETUP\|a=57\|n=91\|n odd` | jacobi_symbol_generator.py |
| `JACOBI_SWAP` | 3 | `JACOBI_SWAP\|a=91\|n=57\|sign 1` | jacobi_symbol_generator.py |
| `JACOBI_TWO_RULE` | 3 | `JACOBI_TWO_RULE\|n mod 8 = 1\|keep sign\|sign 1` | jacobi_symbol_generator.py |
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|5*(-3) - 2*(-1)\|-13` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[5, 2], [-1, -3]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = 5*u + 2*v\|y = -u - 3*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
...
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|001, 011, 101, 111\|Z` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|X=0\|1, 1, 1, 0` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows X=0,X=1\|columns YZ=00,YZ=01,YZ=11,YZ=10` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|Z OR (NOT X AND NOT Y) OR (X AND Y)` | boolean_algebra_generator.py |
...
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = 2*x^2 + 4*y^2\|constraint 3*x + 2*y = 176\|minimize` | lagrange_multiplier_generator.py |
...
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|(((lambda m. (lambda c. (n m))) a) a)\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LAURENT_SETUP` | 3 | `LAURENT_SETUP\|center a=0\|w=z\|f=(5 + z - 2z^2 + 3z^3 + z^4 - 4z^5)/z^3` | laurent_series_generator.py |
| `LAURENT_TERM` | 1 | `LAURENT_TERM\|-5(z+4)^-2` | residue_generator.py |
...
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→2 of 2x^2 + x - 5\|polynomial: direct substitution` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
| `LINEAR_SYSTEM` | 2 | `LINEAR_SYSTEM\|a=4/5, b=-1/3\|c=-1/2, d=1` | markov_chain_generator.py |
| `LINE_EQ` | 1 | `LINE_EQ\|12y - 24 = 0` | complex_locus_generator.py |
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|-54/2 + 108\|81` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = 1/4x + 4\|(-9, 4)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <-3*x + 5*y, -3*x + 2*y>\|from (-4, 4) to (0, 3)` | line_integral_generator.py |
| `LLL_DONE` | 1 | `LLL_DONE\|[(-8,-4),(-6,9)]` | lll_reduction_generator.py |
| `LLL_SETUP` | 1 | `LLL_SETUP\|[(-14,5),(-8,-4)]` | lll_reduction_generator.py |
| `LOCUS_SETUP` | 3 | `LOCUS_SETUP\|z=x+iy\|p=(-3,-1)\|q=(-3,5)` | complex_locus_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(2x)) = ln(28)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_EVAL` | 2 | `LOG_EVAL\|27/4\|ln(27/4)` | hyperbolic_distance_generator.py |
| `LOG_EXACT` | 2 | `LOG_EXACT\|log_4(65536)\|8` | master_theorem_generator.py |
...
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|2x + 1 = x + 8` | log_equation_generator.py |
...
| `LOG_PRODUCT` | 1, 2 | `LOG_PRODUCT\|log_5(125x^4y)\|log_5(125x^4) + log_5(y)` | log_equation_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_2(32x/y^2)\|log_2(32x) - log_2(y^2)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|log_5(125x^4y)\|expand` | complex_log_generator.py, log_properties_generator.py |
...
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-3, -1), (-1, -1), (1, 5), (3, 17)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_RESULT` | 2 | `LU_RESULT\|L\|[[1, 0, 0], [4, 1, 0], [2, 0, 1]]` | lu_decomposition_generator.py |
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[4, 1, -1], [16, 1, -8], [8, 2, -3]]\|unit lower L` | lu_decomposition_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[-3, 1], [5, -6]]\|-3A` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
| `MAX` | 2, 3 | `MAX\|4, 5\|5` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
...
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=0,mid=1,hi=2\|left 14; right 8` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|14\|8\|take right` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 0-1\|array 8, 14, 16, 5, 34` | algorithm_trace_generator.py |
...
| `METRIC_ARC_SETUP` | 3 | `METRIC_ARC_SETUP\|polar metric\|ds^2=dr^2+r^2 dtheta^2\|r=9, theta:0->pi/3` | metric_arc_length_generator.py |
...
| `MINTERM` | 2 | `MINTERM\|0110\|NOT V AND W AND X AND NOT Y` | boolean_algebra_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 16950e^0.9` | exponential_model_generator.py |
...
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 26\|exponent 81\|modulus 95` | mod_exp_generator.py |
...
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|77 mod 36\|29` | crt_generator.py, ecdsa_generator.py, elliptic_curve_finite_field_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|-7\|mod 36\|29` | modular_inverse_generator.py, rsa_generator.py |
| `MOD_POWER` | 3 | `MOD_POWER\|23^21\|mod 84\|71` | diffie_hellman_generator.py, pollard_factorization_generator.py, primality_test_generator.py, rsa_generator.py, tonelli_shanks_generator.py, totient_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|2^2*10^3/6\|2000/3` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|2*10^3/3\|2000/3` | centroid_generator.py |
...
| `MONO_DIV_COEFF` | 2 | `MONO_DIV_COEFF\|72 / -8\|-9` | monomial_mult_div_generator.py |
| `MONO_MULT_COEFF` | 2 | `MONO_MULT_COEFF\|1 * 6\|6` | monomial_mult_div_generator.py |
| `MONO_SETUP` | 1 | `MONO_SETUP\|(x^3)(6x^9)` | monomial_mult_div_generator.py |
...
| `MR_SETUP` | 2 | `MR_SETUP\|n=97\|witnesses 7, 10` | primality_test_generator.py |
| `MR_SQUARE` | 2 | `MR_SQUARE\|r=1\|85` | primality_test_generator.py |
| `MR_WITNESS` | 1 | `MR_WITNESS\|7` | primality_test_generator.py |
| `MR_WITNESS_RESULT` | 2 | `MR_WITNESS_RESULT\|7\|passes at r=4` | primality_test_generator.py |
...
| `MST_ADD` | 2 | `MST_ADD\|BC\|total 9` | mst_generator.py |
| `MST_SET` | 1 | `MST_SET\|BC` | mst_generator.py |
| `MST_SETUP` | 2 | `MST_SETUP\|weighted undirected graph\|vertices A, B, C, D` | mst_generator.py |
| `MU` | 2 | `MU\|92/221\|round=0` | lll_reduction_generator.py |
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(3x)y' + 3e^(3x)y\|9e^(3x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `MULTIVALUED_LOG` | 2 | `MULTIVALUED_LOG\|ln(43/8) + i*(pi/5 + 2pi*k)\|k in Z` | complex_log_generator.py |
| `MULTI_FORMULA` | 2 | `MULTI_FORMULA\|n!/(a!b!c!...)\|7! / repeats` | stars_and_bars_generator.py |
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|1 E, 1 K, 1 U, 4 Q's\|total 7` | stars_and_bars_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 - 6x + 1 on [-1, 7]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 3*x^2 + y^2 + 2*x*y + x - 6*y\|x = 3*t + 3, y = t + 4\|t = -1` | multivar_chain_rule_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 18% to 0.18\|line 3 adds the tip 26.10 to the bill` | fill_in_step_generator.py |
...
| `NFA_ACCEPT` | 1 | `NFA_ACCEPT\|u3` | nfa_simulation_generator.py |
| `NFA_ACTIVE` | 2 | `NFA_ACTIVE\|start\|{u3}` | nfa_simulation_generator.py |
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|q2\|{q3}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|aabac` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{u3}\|a\|u3->{u3,u7}\|{u3,u7}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|a` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states u3, u4, u6, u7, u8\|alphabet a, b, c\|start u3` | nfa_simulation_generator.py |
| `NFA_TRANSITION` | 3 | `NFA_TRANSITION\|u3\|a\|{u3,u7}` | nfa_simulation_generator.py |
...
| `NORM2` | 2 | `NORM2\|b1\|221` | lll_reduction_generator.py |
| `NORMALIZE` | 2 | `NORMALIZE\|2/3 + 1/3\|1` | clebsch_gordan_generator.py, layer_norm_generator.py |
| `NORMALIZE_SIGN` | 2 | `NORMALIZE_SIGN\|(-1,2)\|(1,-2)` | lll_reduction_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(42, 20)\|z-score of x = 70` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
...
| `NO_REDEX` | 2 | `NO_REDEX\|(n a)\|no beta redex remains` | lambda_reduction_generator.py |
...
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dx = y^2, y(0) = 108\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `OPT_SETUP` | 2 | `OPT_SETUP\|800 m of fence, barn forms the fourth side; sides x, x, and 800 - 2x\|maximize area` | optimization_generator.py |
...
| `ORDER_START` | 2 | `ORDER_START\|r\|identity e` | cayley_table_generator.py |
| `ORDER_STEP` | 2 | `ORDER_STEP\|k=1\|r` | cayley_table_generator.py |
...
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|5*x^2 + 165*x` | double_integral_generator.py |
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|y=0..14\|12*2*7^2/2\|588` | double_integral_generator.py |
| `OUTER_PRODUCT` | 1 | `OUTER_PRODUCT\|rho=1/2(ket00bra00+e^(-i168π/253)ket00bra10+e^(i168π/253)ket10bra00+ket10bra10)` | partial_trace_generator.py |
...
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(4*t - 4, -t + 4)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 31cos t - 7, y = 31sin t + 6\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|3/((x - 3)(x - 2)) = A/(x - 3) + B/(x - 2)` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|-2/(s + 1) - 4/(s - 4)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_y\|28*x^3*y^3 + 2*x^2` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|2*x^2*y\|d/dy\|2*x^2` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 7*x^3*y^4 + 2*x^2*y\|f_yy` | partial_derivative_generator.py |
...
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = 101x, dv = e^(-x) dx\|du = 101 dx, v = -e^(-x)` | integration_by_parts_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.35\|2085\|729.75` | percent_problem_generator.py |
...
| `PERM_COMPOSE` | 3 | `PERM_COMPOSE\|i=1\|tau(i)=1\|sigma(tau(i))=5` | permutation_group_generator.py |
| `PERM_FORMULA` | 1 | `PERM_FORMULA\|P(n, r) = n·(n-1)···(n-r+1), 4 factors` | permutation_combination_generator.py |
| `PERM_RESULT` | 1 | `PERM_RESULT\|[5, 3, 6, 4, 1, 2]` | permutation_group_generator.py |
| `PERM_SETUP` | 2, 3 | `PERM_SETUP\|arrange 4 of 6\|order matters` | permutation_combination_generator.py, permutation_group_generator.py |
...
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|y = ±√3998\|y = √3998 or y = -√3998` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|64*3/4\|48` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 10 = -3(x - 1)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_FORM` | 1 | `POLAR_FORM\|5 cis(270 deg)` | euler_formula_generator.py |
| `POLAR_FORMULA` | 1 | `POLAR_FORMULA\|r = √(x^2 + y^2), tan θ = y/x` | polar_parametric_generator.py |
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|r = 67\|pole=(12, -7)\|rectangular equation` | parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|6x^3 + 5x^2 - 8x - 9\|2x + 3` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|9x^3 + 4x^2 + 11x + 15` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(27x^6 + 9x^5 - 18x^4) / (-9x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(27x^6) / (-9x^2) + (9x^5) / (-9x^2) + (-18x^4) / (-9x^2)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(9x^3) + (4x^2) + (4x +7x) + (9 +6)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|2x^3 + x^2 + 2x + 2` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x - 2)(-2x^2 - 2x - 3)` | multiplying_polynomials_generator.py |
...
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(4x + 9) - (-9x^3 - 4x^2 - 7x - 6)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(6x^3 + 5x^2) - (6x^3 + 9x^2)\|-4x^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
...
| `POTENTIAL_BUILD` | 3 | `POTENTIAL_BUILD\|integrate P dx\|5*x^2 + 4*x*y + 5*x + g(y)\|g'(y) remains` | exact_ode_generator.py, line_integral_generator.py |
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|5*x^2 + 4*y^2 + 4*x*y + 5*x + y` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(3/4)^2\|0.5625` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
...
| `POWER_REDUCE` | 2 | `POWER_REDUCE\|23^69\|23^21 mod 84` | totient_generator.py |
...
| `POWER_SETUP` | 2 | `POWER_SETUP\|(cos 260 deg + i sin 260 deg)^(3i)\|principal logarithm` | complex_log_generator.py |
...
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited C\|BC=9, AC=14` | mst_generator.py |
| `PRIM_START` | 1 | `PRIM_START\|C` | mst_generator.py |
| `PRINCIPAL_LOG` | 1 | `PRINCIPAL_LOG\|Log(z) = -i*5pi/9` | complex_log_generator.py |
...
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[-4, 2, 8, 14]` | least_squares_generator.py, legendre_construction_generator.py |
...
| `Q1` | 4 | `Q1\|-391\|323\|34\|-2` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|-391\|323\|34\|-21` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QN_ADD` | 4 | `QN_ADD\|Q\|left\|0 + n(0)\|0` | conservation_law_generator.py |
| `QR_ENTRY` | 2 | `QR_ENTRY\|q1\|[1, 0, 0]` | qr_decomposition_generator.py |
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[4, 0, 1], [0, 4, 2], [0, 0, 3]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|170°\|quadrant II` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
...
| `QUANTUM_SETUP` | 2, 3 | `QUANTUM_SETUP\|gates=Y then Z\|input=e^(i35π/246)·ket0` | quantum_formula_generator.py, quantum_gate_generator.py |
...
| `QUARTILE` | 3 | `QUARTILE\|Q1\|16,17,21,23,28\|21` | five_number_summary_generator.py |
...
| `QUAT_RESULT` | 2 | `QUAT_RESULT\|q*v\|(4,2,3,0)` | quaternion_generator.py |
| `QUAT_SETUP` | 2 | `QUAT_SETUP\|q=(0,0,0,1)\|v=(0,3,-2,-4)` | quaternion_generator.py |
| `QUEUE_STATE` | 2 | `QUEUE_STATE\|initial\|A` | graph_traversal_generator.py |
| `QUOTIENT` | 1 | `QUOTIENT\|x^3 + x` | finite_field_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|conical tank, radius = height/2; water in at dV/dt = 19 ft³/min; depth h = 6 ft\|dh/dt` | related_rates_generator.py |
| `RATIO` | 2, 3 | `RATIO\|3*y = x\|y = x/3` | lagrange_multiplier_generator.py, simplex_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|√222/√222` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 756 / 1.125` | percent_problem_generator.py |
...
| `RECT_FORM` | 1 | `RECT_FORM\|25i` | de_moivre_generator.py, euler_formula_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = 6 a_(n-1) - 8 a_(n-2) + 18\|a_0 = 9, a_1 = 16` | master_theorem_generator.py, recurrence_generator.py |
| `REDUCED_DENSITY` | 1 | `REDUCED_DENSITY\|rho_A=[[1/2,e^(-i168π/253)/2],[e^(i168π/253)/2,1/2]]` | partial_trace_generator.py |
| `REFLEXIVE_CHECK` | 2 | `REFLEXIVE_CHECK\|(1, 1)\|missing` | relation_check_generator.py |
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q23890_2` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|(a or b)*ab(a or b)*\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q23890_0\|no useful suffix` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q23890_0\|a\|q23890_1` | regex_to_automaton_generator.py |
...
| `REL_SETUP` | 2, 3 | `REL_SETUP\|A = {1, 2, 3, 4}\|R = {(1, 3), (1, 4), (2, 2), (3, 2), (3, 3)}` | relation_check_generator.py, special_relativity_generator.py |
...
| `RESIDUE_SETUP` | 2 | `RESIDUE_SETUP\|a=-4\|f=(-5 + (z+4) + (z+4)^2 + 2(z+4)^3)/(z+4)^2` | residue_generator.py |
| `RESIDUE_SUM` | 1 | `RESIDUE_SUM\|-3` | contour_integral_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (1, 60), line ŷ = 60.6 - 0.2x\|residual = observed − predicted` | regression_generator.py |
| `RESOLVE` | 3 | `RESOLVE\|C1\|C2\|P89867` | resolution_proof_generator.py |
| `RES_EMPTY` | 1 | `RES_EMPTY\|C7` | resolution_proof_generator.py |
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(not P84676 OR P89867), C2=(not P89867), C3=(P84676), C4=(P69084)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C2\|(not P84676)` | resolution_proof_generator.py |
...
| `RIEMANN_SETUP` | 2, 3 | `RIEMANN_SETUP\|f(x) = x^2 - 5 on [-2, 2], n = 4\|left Riemann sum` | riemann_sum_generator.py, riemann_tensor_generator.py |
...
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, 3, 3], [0, 1, 3, 0], [0, 0, 0, 0]]` | subspace_basis_generator.py |
| `RSA_DECRYPT` | 2 | `RSA_DECRYPT\|2\|74` | rsa_generator.py |
| `RSA_ENCRYPT` | 2 | `RSA_ENCRYPT\|74\|2` | rsa_generator.py |
| `RSA_PRIVATE_KEY` | 1 | `RSA_PRIVATE_KEY\|d=53` | rsa_generator.py |
| `RSA_PUBLIC_KEY` | 2 | `RSA_PUBLIC_KEY\|n=77\|e=17` | rsa_generator.py |
| `RSA_SETUP` | 3 | `RSA_SETUP\|p=7\|q=11\|message=74` | rsa_generator.py |
...
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x2 = 35\|xi >= 1` | stars_and_bars_generator.py |
| `SCALE_DIV` | 3 | `SCALE_DIV\|1344\|28\|48` | scaling_generator.py |
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|25*cos\|0` | de_moivre_generator.py, euler_formula_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|9 inches\|actual_dimension` | scaling_generator.py |
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = -2\|(-32)*(-38)\|1216` | diagonalization_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(1, 1), B(6, 21); ratio 4:1 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_22 = -4 + (22 - 1)·-9` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|-4, -13, -22, -31, ...\|sum of first 22 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ -4·(9/10)^n, n ≥ 0\|converge or diverge? find the sum if it converges` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
| `SERIES_TERM` | 3 | `SERIES_TERM\|n=0\|1\|1` | grassmann_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|percent_dec = 4455 / 40500` | percent_problem_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y2 = 33` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
...
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|400 + 324 + 256 + 196 + 144` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=-10)^(-6) 4k^2\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=-10\|4(-10)^2\|400` | sigma_notation_generator.py |
...
| `SIGN_CHART` | 2 | `SIGN_CHART\|zeros\|-5, 4` | polynomial_inequality_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, -4)\|y = -5\|f(y) = 78 (positive)\|up` | stability_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; AB = 2, DE = 4, BC = 5\|find EF` | similar_triangles_generator.py |
...
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = 5sin(3(x + 10°)) - 2\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
| `SIZE_REDUCE` | 2 | `SIZE_REDUCE\|b2=(-14, 5)\|b2-1b1=(-6, 9)` | lll_reduction_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -49x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|-3` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-3, -10)\|(7, -8)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-8 - (-10)) / (7 - (-3))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOLUTIONS` | 2 | `SOLUTIONS\|tan x = 1\|45°, 225°, 405°, 585°` | trig_equation_generator.py |
...
| `SOLVE_Y` | 2 | `SOLVE_Y\|e^(3x)y = 3e^(3x) + C\|y = 3 + Ce^(-3x)` | integrating_factor_generator.py, laplace_ivp_generator.py, ode_substitution_generator.py |
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(e^t)*(-1) + (0)*(-4)\|-e^t` | matrix_exponential_generator.py |
| `SOL_FORM` | 1, 2 | `SOL_FORM\|y = e^(-4x)(C1 cos(2x) + C2 sin(2x))` | ode_system_generator.py, second_order_ode_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `SORT` | 2 | `SORT\|9,15,20,2,1\|1,2,9,15,20` | five_number_summary_generator.py, simple_stats_generator.py |
| `SORT_EDGES` | 1 | `SORT_EDGES\|AD=1, BC=7, AB=13, BD=20, AE=21, DE=23` | mst_generator.py |
...
| `SPHERICAL_EXCESS_SETUP` | 2 | `SPHERICAL_EXCESS_SETUP\|R=13\|angles=90,45,90` | spherical_excess_generator.py |
| `SPHERICAL_SINE_LAW` | 1 | `SPHERICAL_SINE_LAW\|sin(A)/sin(a)=sin(B)/sin(b)` | spherical_triangle_generator.py |
| `SPHERICAL_TRIANGLE_SETUP` | 2 | `SPHERICAL_TRIANGLE_SETUP\|b=60 deg, c=60 deg, A=45 deg\|find cos(a)` | spherical_triangle_generator.py |
...
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|y^2 = 3998\|y = ±√3998` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `SQRT_DIGIT` | 2 | `SQRT_DIGIT\|5\|root = 5` | manual_square_root_generator.py |
| `SQRT_NEG` | 2 | `SQRT_NEG\|√(-120)\|i√120` | complex_quadratic_generator.py, polynomial_zeros_generator.py |
...
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(x + 57) = x + 1\|x + 57 = (x + 1)^2` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|126\|9 × 14\|9` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `STEREO_SETUP` | 3, 4 | `STEREO_SETUP\|sphere_to_plane\|X=35/237\|Y=-100/237\|Z=212/237` | stereographic_generator.py |
...
| `SUBSTITUTE` | 2 | `SUBSTITUTE\|m:=a in lambda c. (n m)\|lambda c. (n a)` | lambda_reduction_generator.py |
...
| `SWAP` | 2 | `SWAP\|norm b2=80\|norm b1=221` | lll_reduction_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|3x^3 + 10x^2 - 7x + 4\|r = -4` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|3, -2, 1, 0` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|20x + 5y = -110\|-20x - 4y = 100` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|y = -2x - 8\|-x + 3y = -17` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute (-2x - 8) for y in Eq 2` | systems_substitution_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(-1)\|14` | de_moivre_generator.py, dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, lie_exponential_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 25 + 12*(x - 3) + 12*(y - 1)` | gradient_generator.py |
...
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|survive k=6..12\|subtract k=22..28` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Σ k=6..21 1/(k(k+7))` | telescoping_generator.py |
...
| `TENSOR_SETUP` | 3 | `TENSOR_SETUP\|A=diag(2,-5)\|B=diag(-4,-1)\|u=[3,2], v=[1,-4]` | tensor_product_generator.py |
| `TENSOR_STATE` | 2 | `TENSOR_STATE\|u tensor v\|[3,-12,2,-8]` | tensor_product_generator.py |
...
| `TEST_CHOOSE` | 2 | `TEST_CHOOSE\|geometric series\|common ratio r = 9/10` | power_series_generator.py, series_convergence_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Stokes\|F=<7*y, 0, 0>\|disk radius 3 in z=0` | vector_theorem_generator.py |
...
| `TRANSFORM_APPLY` | 2 | `TRANSFORM_APPLY\|(3(7), 3(5))\|(21, 15)` | transformation_generator.py |
| `TRANSFORM_RULE` | 1 | `TRANSFORM_RULE\|(x, y) → (3x, 3y)` | transformation_generator.py |
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(7, 5)\|dilation by factor 3 centered at the origin` | rv_transform_generator.py, transformation_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle, angle 66°, hypotenuse = 170; given cos 66° ≈ 0.4\|the adjacent side` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|z_part * r_part * angle\|5*50*81/2*2*pi\|20250*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 5*z\|cylinder radius 9, height 10\|cylindrical` | triple_integral_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|30-60-90 triangle, longer leg = 150√3\|shorter leg and hypotenuse` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
...
| `TS_INIT` | 4 | `TS_INIT\|m=3\|c=10\|t=1\|r=32` | tonelli_shanks_generator.py |
| `TS_LOOP` | 2 | `TS_LOOP\|i=2\|b=38` | tonelli_shanks_generator.py |
| `TS_NONRESIDUE` | 1 | `TS_NONRESIDUE\|5` | tonelli_shanks_generator.py |
| `TS_SETUP` | 2 | `TS_SETUP\|a=2\|p=73` | tonelli_shanks_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|-19, -9, 1, 11\|arithmetic, d = 10` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|4 - 6 = -2\|(-2)^2 = 4\|1/4·4 = 1` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|5` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y,z) = <3*x - y + 2*z, -6*x + 2*z, -2*x + y + 5*z>\|divergence and curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|(-6)\|-6` | diagonalization_generator.py |
| `VEC_SETUP` | 2 | `VEC_SETUP\|v = ⟨-1, 6, -1⟩\|magnitude` | dot_product_generator.py, vector_ops_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region between y = 97x (outer) and y = 97x^2 (inner) on [0, 1], about the x-axis\|washer method` | solid_revolution_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|50 - 64\|-14` | line_integral_generator.py |
...
| `ZERO_PRODUCT` | 2 | `ZERO_PRODUCT\|(x + 5)(x - 4)\|x = -5 or x = 4` | area_between_curves_generator.py, curve_analysis_generator.py, domain_range_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_equation_generator.py, trig_equation_generator.py |
| `ZSCORE` | 2 | `ZSCORE\|(50 - 49)/2\|0.5` | normal_table_generator.py, z_score_generator.py |
