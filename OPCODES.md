...
| `DIST_TERM` | 2 | `DIST_TERM\|4x\|- 16x^3 + 20x^2 - 16x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | factor_special_forms_generator.py, function_evaluation_generator.py, function_table_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, round_solids_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|50158 × 10146 ≈ 50000 × 10000\|500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|500000000\|508903068\|508903068 ≈ 500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|4 ÷ 2 = 2, not 3` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (-4x) * (-4x)\|16x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-9) * (-4x)\|36x` | multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (-9) * (-4)\|36` | multiplying_binomials_generator.py |
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-4x) * (-4)\|16x` | multiplying_binomials_generator.py |
...
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|f(t) = 3t + 3\|f(5)` | function_evaluation_generator.py, function_table_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 41.22\|line 4 answers $270.22` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(495, 11)\|P(499.4 < X < 514.8)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(6x^6 - 18x^3) / (-6x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(6x^6) / (-6x^2) + (-18x^3) / (-6x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(4x + 4)(-4x^2 + 5x - 4)` | multiplying_polynomials_generator.py |
...
| `SUBST` | 3 | `SUBST\|x\|-5\|2(-5)+5y+7` | evaluate_expression_generator.py, function_evaluation_generator.py, function_table_generator.py |
