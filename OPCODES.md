...
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|10x^3 + 8x^2 - 10x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|93085 × 53325 ≈ 90000 × 50000\|4500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|4500000000\|4963757625\|4963757625 ≈ 4500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|4 × 7 = 28, not 21` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 21.60\|line 4 answers $237.60` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(164, 6)\|P(X > 177.8)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(3x^5 - 9x^4) / (3x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(3x^5) / (3x^2) + (-9x^4) / (3x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x - 4)(5x^2 + 4x - 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(177.8 - 164)/6\|2.30` | normal_table_generator.py |
