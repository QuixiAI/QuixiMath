...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|x + 1 = 12` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|2x + 6 >= 7 -> x >= 1/2` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|2x + 6\| >= 7` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|2x + 6 >= 7 OR 2x + 6 <= -7` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|x + 1\| = 12` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|x + 1 = 12\|x + 1 = -12` | absolute_value_equation_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|3x - 7 < -16 -> x < -3` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|3x - 7 < -16 OR 3x - 7 > 17` | compound_inequality_generator.py |
...
| `DISC` | 3 | `DISC\|1\|-80\|81` | quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|20x + 70 = 30` | systems_substitution_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|3x^3 - 15x^2 + 3x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|10\|2\|100` | pythag_hyp_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(1, -2)\|(2, 0)` | equation_from_two_points_generator.py |
...
| `EQ_OP_NOTE` | 3 | `EQ_OP_NOTE\|add\|u\|to both sides` | equation_from_two_points_generator.py, literal_equation_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, standard_form_conversion_generator.py |
...
| `FOIL_F` | 2 | `FOIL_F\|First: (-6x) * (-2x)\|12x^2` | multiplying_binomials_generator.py |
...
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-6x) * (4)\|-24x` | multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(-6x - 4)(-2x + 4)` | multiplying_binomials_generator.py |
...
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = 1/2x - 8\|(-3, -7)` | parallel_perpendicular_line_generator.py |
...
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-1x^2)(7x^6)` | monomial_mult_div_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.9\|10\|9` | percent_problem_generator.py |
...
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 2 = 2(x - 1)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|3x^2 - 13x - 1` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 2x^6 - 3x^5 + 5x^4 - 1x^2) / (-x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-2x^6) / (-x^2) + (-3x^5) / (-x^2) + (5x^4) / (-x^2) + (-1x^2) / (-x^2)` | polynomial_div_monomial_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(3x^2) + (-5x -8x) + (6 -7)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x - 4)(x^2 - 5x + 1)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1 | `POLY_SETUP\|(-5x + 6) + (3x^2 - 8x - 7)` | polynomial_add_sub_generator.py |
...
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Two dice rolls, looking for 5 then 3` | compound_probability_generator.py |
...
| `PYTHAG_CONTEXT` | 2 | `PYTHAG_CONTEXT\|displacement\|east=3m, north=4m` | pythag_leg_generator.py |
| `PYTHAG_FORMULA` | 1 | `PYTHAG_FORMULA\|a² + b² = c²` | pythag_leg_generator.py |
| `PYTHAG_MODEL` | 3 | `PYTHAG_MODEL\|east=3\|north=4\|distance=?` | pythag_leg_generator.py |
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|729\|27` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 3 | `PYTHAG_SETUP\|c=45\|a=36\|b=?` | pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 2025 - 1296\|729` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|36\|1296` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|36² + b² = 45²` | pythag_leg_generator.py |
| `Q1` | 4 | `Q1\|-1\|9\|2\|4` | quadratic_generator.py |
| `Q2` | 4 | `Q2\|-1\|9\|2\|-5` | quadratic_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 120 / 0.25` | percent_problem_generator.py |
...
| `ROOT` | 2 | `ROOT\|676\|26` | pythag_hyp_generator.py, quadratic_generator.py |
...
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(110 + 70 + 77)\|514` | volume_3d_generator.py |
...
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 0.9 * 10` | percent_problem_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -10x + 7` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|2` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(2, -2)\|(4, 2)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (2 - (-2)) / (4 - 2)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(67 + 68) / 2\|67.5` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|6` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|20\|46\|-26` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|354 / 6\|59` | statistics_generator.py |
...
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|positions 5 and 6\|67, 68` | statistics_generator.py |
| `STAT_MIN` | 1 | `STAT_MIN\|37` | statistics_generator.py |
| `STAT_MODE` | 2 | `STAT_MODE\|No mode\|All values appear with same frequency` | statistics_generator.py |
| `STAT_ORDER` | 1 | `STAT_ORDER\|22, 36, 42, 46, 67, 68, 74, 91, 91, 97` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|98 - 37\|61` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|49, 103, 44, 38, 44, 76` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|49 + 103 + 44 + 38 + 44 + 76\|354` | statistics_generator.py |
...
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -32y = -192` | systems_elimination_generator.py |
...
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|20x - 12y = -272\|-20x - 20y = 80` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|y = -5x - 14\|-5x - 5y = 30` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute (-5x - 14) for y in Eq 2` | systems_substitution_generator.py |
...
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 9 × 9\|40.5` | volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 40.5 × 6\|243.0` | volume_3d_generator.py |
