...
325 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|4x\|- 16x^3 + 4x^2 - 8x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|83833 × 83532 ≈ 80000 × 80000\|6400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|6400000000\|7002738156\|7002738156 ≈ 6400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|2 × 6 = 12, not 18` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 15% to 0.15\|line 3 adds the tip 13.50 to the bill` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(26, 6)\|P(X < 36.8)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(4x^3 + 4x^3 - 4x^2 + 1x) / (x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(4x^3) / (x) + (4x^3) / (x) + (-4x^2) / (x) + (1x) / (x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(4x + 1)(-4x^2 + x - 2)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(36.8 - 26)/6\|1.80` | normal_table_generator.py |
