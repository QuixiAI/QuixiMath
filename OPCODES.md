...
| `ANTIDERIV` | 2 | `ANTIDERIV\|16x^3\|4x^4` | antiderivative_generator.py, u_substitution_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|4x\|- 20x^3 - 4x^2 - 12x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|65116 × 48993 ≈ 70000 × 50000\|3500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3500000000\|3190228188\|3190228188 ≈ 3500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|70 ÷ 7 = 10, not 9` | error_spotting_generator.py |
...
| `INTEG_RULE` | 2 | `INTEG_RULE\|power rule\|∫ x^n dx = x^(n+1)/(n+1) + C` | antiderivative_generator.py, u_substitution_generator.py |
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (16x^3 - 9x^2 - 4x) dx\|antiderivative` | antiderivative_generator.py, u_substitution_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 gives the scale factor 10\|line 5 answers 90` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(85, 11)\|P(X < 109.2)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(21x^5 + 28x^3 + 28x) / (-7x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(21x^5) / (-7x) + (28x^3) / (-7x) + (28x) / (-7x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(4x - 3)(-5x^2 - x - 3)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(109.2 - 85)/11\|2.20` | normal_table_generator.py |
