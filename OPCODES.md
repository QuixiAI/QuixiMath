...
317 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|10x^3 - 10x^2 + 6x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|18895 × 3222 ≈ 20000 × 3000\|60000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|60000000\|60879690\|60879690 ≈ 60000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `EVAL` | 2 | `EVAL\|g(2)\|-15` | complex_division_generator.py, function_composition_generator.py, function_operations_generator.py, horner_evaluation_generator.py, recursive_explicit_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-25 - 3 = -28, not -24` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 7x - 7 = -35\|line 3 shows 7x = -28` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(167, 7)\|P(X < 183.1)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(21x^6 - 28x^4 - 14x^4 + 7x^4) / (7x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(21x^6) / (7x^2) + (-28x^4) / (7x^2) + (-14x^4) / (7x^2) + (7x^4) / (7x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x - 4)(5x^2 - 5x + 3)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(183.1 - 167)/7\|2.30` | normal_table_generator.py |
