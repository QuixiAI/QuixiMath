...
402 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|15x^3 + 3x^2 + 12x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|7628 × 7593 ≈ 8000 × 8000\|64000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|64000000\|57919404\|57919404 ≈ 64000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|32 ÷ 8 = 4, not 6` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 30.30\|line 4 answers $232.30` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(54, 7)\|P(X < 48.4)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 24x^5 + 24x^4 - 16x^3) / (-8x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-24x^5) / (-8x) + (24x^4) / (-8x) + (-16x^3) / (-8x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x - 2)(5x^2 + x + 4)` | multiplying_polynomials_generator.py |
...
| `SUBST` | 3 | `SUBST\|x\|-5\|2(-5)+5y+7` | chain_rule_generator.py, derivative_limit_def_generator.py, evaluate_expression_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, implicit_diff_generator.py, limit_evaluation_generator.py, log_diff_higher_order_generator.py, piecewise_evaluation_generator.py, polar_parametric_generator.py, recursive_explicit_generator.py, related_rates_generator.py, remainder_factor_theorem_generator.py, tangent_line_generator.py, trig_equation_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(48.4 - 54)/7\|-0.80` | normal_table_generator.py |
