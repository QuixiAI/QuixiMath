...
371 distinct op-codes observed.
...
| `ESTIMATE` | 2 | `ESTIMATE\|53122 × 10308 ≈ 50000 × 10000\|500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|500000000\|547581576\|547581576 ≈ 500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|-24 + 8 = -16, not -12` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the base ratio 5:4\|line 4 multiplies 5 by 8` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(75, 6)\|P(X > 81.6)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(1x^2 - 3x^2 + 5x) / (x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(1x^2) / (x) + (-3x^2) / (x) + (5x) / (x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(5x - 3)(-2x^2 - 2x + 5)` | multiplying_polynomials_generator.py |
...
| `QUADRANT` | 2 | `QUADRANT\|53°\|quadrant I` | angle_measure_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(81.6 - 75)/6\|1.10` | normal_table_generator.py |
