...
435 distinct op-codes observed.
...
| `ESTIMATE` | 2 | `ESTIMATE\|61081 × 16413 ≈ 60000 × 20000\|1200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1200000000\|1002522453\|1002522453 ≈ 1200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|5 × 3 = 15, not 9` | error_spotting_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 4x^7 - 16x^6 + 12x^3) / (4x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-4x^7) / (4x^3) + (-16x^6) / (4x^3) + (12x^3) / (4x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-2x - 3)(-3x^2 - 5x - 1)` | multiplying_polynomials_generator.py |
