...
385 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|15x^3 - 3x^2 + 9x` | multiplying_polynomials_generator.py |
...
| `E` | 3 | `E\|21\|2\|441` | arc_sector_generator.py, circle_equation_generator.py, complex_division_generator.py, conic_standard_form_generator.py, distance_formula_generator.py, ellipse_features_generator.py, exponential_equation_generator.py, exponential_model_generator.py, factor_special_forms_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, geometric_mean_generator.py, geometric_sequence_generator.py, hyperbola_features_generator.py, hypercube_counting_generator.py, log_conversion_generator.py, log_equation_generator.py, log_properties_generator.py, piecewise_evaluation_generator.py, polar_parametric_generator.py, pythag_hyp_generator.py, radical_equation_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, recursive_explicit_generator.py, remainder_factor_theorem_generator.py, round_solids_generator.py, triangle_solve_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|85428 × 61408 ≈ 90000 × 60000\|5400000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5400000000\|5245962624\|5245962624 ≈ 5400000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|9 + 6 = 15, not 21` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 6x - 7 = 17\|line 3 shows 6x = 24` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(36, 9)\|P(X > 55.8)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(9x^4 + 45x^3 + 45x^2) / (-9x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(9x^4) / (-9x^2) + (45x^3) / (-9x^2) + (45x^2) / (-9x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x + 5)(5x^2 - x + 3)` | multiplying_polynomials_generator.py |
...
| `ROOT_SIMPLIFY` | 1 | `ROOT_SIMPLIFY\|7√7` | complex_quadratic_generator.py, distance_formula_generator.py, exponent_generator.py, geometric_mean_generator.py, hypercube_counting_generator.py, polar_parametric_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(55.8 - 36)/9\|2.20` | normal_table_generator.py |
