...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|5x + 6 ≥ 11 -> x ≥ 1` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|abs(5x + 6) ≥ 11` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for >` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|5x + 6 ≥ 11 or 5x + 6 ≤ -11` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(4x - 5) = -5` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Single case\|3x - 3 = 0` | absolute_value_equation_generator.py |
...
| `ACCEPT` | 2 | `ACCEPT\|(-∞, -6)\|(x + 6)x(x - 4) ≤ 0 is accept` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 10/20, P(B) = 9/20, P(A ∪ B) = 12/20\|P(A ∩ B)` | probability_addition_rule_generator.py |
| `ADJOINT` | 1 | `ADJOINT\|U^dagger=[[35/37,12/37],[-12/37,35/37]]` | hermitian_check_generator.py |
| `ADJ_LIST` | 2 | `ADJ_LIST\|A\|B, C, D, F` | euler_circuit_generator.py, graph_traversal_generator.py |
| `ALG_SETUP` | 3 | `ALG_SETUP\|binary search\|target 10\|values 6, 13, 18, 33, 38, 47` | algorithm_trace_generator.py |
| `ALIGN_NUM` | 2 | `ALIGN_NUM\|347.82\|221.45` | number_comparison_generator.py |
| `ALPHA` | 2 | `ALPHA\|alpha1\|-14/37` | kernel_ridge_generator.py |
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda n. h\|lambda z. h` | lambda_reduction_generator.py |
...
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|complementary\|angle1 = 19°` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|90 - 19\|71` | angle_relationships_generator.py |
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|9 cos(3x)\|3 sin(3x)` | antiderivative_generator.py, arc_length_generator.py, area_between_curves_generator.py, definite_integral_generator.py, improper_integral_generator.py, integrating_factor_generator.py, integration_by_parts_generator.py, ode_substitution_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py, variation_parameters_generator.py |
...
| `APPROX_SETUP` | 2 | `APPROX_SETUP\|estimate √65\|linearize f(x) = √x at a = 64` | linear_approx_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 26, central angle 215°\|sector area` | arc_sector_generator.py |
| `AREA` | 1 | `AREA\|108` | geometry_area_perimeter_generator.py |
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|3*7^3/3\|343` | centroid_generator.py |
| `AREA_INTEGRAL` | 2 | `AREA_INTEGRAL\|sqrt(EG-F^2)=R\|area = R*theta*h` | fundamental_form_generator.py |
| `AREA_SCALE` | 3 | `AREA_SCALE\|uv rectangle area\|7*6\|42` | jacobian_generator.py |
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 - x + 5 and y = -10x - 15\|area between the curves` | area_between_curves_generator.py |
...
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|33, 39, 2, 7, 30` | algorithm_trace_generator.py |
| `ASSIGN` | 2 | `ASSIGN\|P1\|C2` | kmeans_step_generator.py |
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = 3 ± (5/6)x` | hyperbola_features_generator.py |
| `ATA` | 2 | `ATA\|A^T A\|[[637, 588], [588, 637]]` | svd_generator.py |
...
| `BASE_ADD_COL` | 3 | `BASE_ADD_COL\|col 0\|1 + D + carry 0\|14 -> digit E, carry 0` | base_arithmetic_generator.py |
| `BASE_ARITH_SETUP` | 2 | `BASE_ARITH_SETUP\|base 16\|C6B * B` | base_arithmetic_generator.py |
...
| `BASE_SETUP` | 2 | `BASE_SETUP\|154_10\|binary` | base_conversion_generator.py |
| `BAYES_CELL` | 3 | `BAYES_CELL\|true positive\|90 * 9/10\|81` | conditional_probability_generator.py |
| `BAYES_FORMULA` | 1 | `BAYES_FORMULA\|P(disease=yes given positive) = TP/(TP + FP)` | conditional_probability_generator.py |
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 90, disease=no 200\|sensitivity 9/10, specificity 19/20\|P(disease=yes given test positive)` | conditional_probability_generator.py |
...
| `BETA` | 1 | `BETA\|(lambda t. t) applied to (p p)` | lambda_reduction_generator.py |
...
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 7, k = 5, p = 1/5\|P(X = k)` | binomial_probability_generator.py |
...
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables L, M, N\|CNF from H=0 rows` | boolean_algebra_generator.py |
...
| `CARTESIAN_RESULT` | 1 | `CARTESIAN_RESULT\|{(e, 3), (e, 4)}` | set_operations_generator.py |
| `CART_PAIR` | 3 | `CART_PAIR\|e\|3\|(e, 3)` | set_operations_generator.py |
...
| `CBRT` | 2 | `CBRT\|216x^3\|6x` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
...
| `CEIL` | 2 | `CEIL\|1039.1136\|1040` | confidence_interval_generator.py |
...
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(7203/4)/(343)\|21/4` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= 3*x^2\|0 <= x <= 7\|centroid` | centroid_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*dx/dt + f_y*dy/dt\|(-41)*1 + (-40)*4\|-201` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(0)\|(-3)\|-3` | multivar_chain_rule_generator.py |
| `CHANGE_BASE` | 1 | `CHANGE_BASE\|log_8(64) = log_2(64)/log_2(8)` | log_conversion_generator.py |
| `CHAR_DIAG` | 2 | `CHAR_DIAG\|diagonal of λI - A\|(λ - 2), (λ - 4), (λ + 4)` | eigenvalue_generator.py |
...
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^3 - 2λ^2 - 16λ + 32\|(λ + 4)*(λ - 2)*(λ - 4)` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
...
| `CHECK_POINT` | 3 | `CHECK_POINT\|x=0\|17·0 + 24 = 24\|17·0 + 24 = 24` | special_solution_equation_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 95, 103, 94, 103, 105; expected: 100 each\|goodness of fit; df = 4, critical value = 9.488` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|95 - 100 = -5\|(-5)^2 = 25\|25/100 = 0.25` | chi_square_generator.py |
...
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|inscribed angle 25°\|central angle on the same arc` | circle_angle_generator.py |
| `CIRCLE_CALCULATE` | 2 | `CIRCLE_CALCULATE\|C = 11π\|11π` | circle_generator.py |
| `CIRCLE_EQ` | 1 | `CIRCLE_EQ\|(x - 5)^2 + (y - 2)^2 = 25` | complex_locus_generator.py |
| `CIRCLE_FORMULA` | 1 | `CIRCLE_FORMULA\|C = πd` | circle_generator.py |
| `CIRCLE_SETUP` | 2 | `CIRCLE_SETUP\|11\|diameter` | circle_equation_generator.py, circle_generator.py |
| `CIRCLE_SUBSTITUTE` | 1 | `CIRCLE_SUBSTITUTE\|C = π × 11` | circle_generator.py |
...
| `CI_SETUP` | 2 | `CI_SETUP\|σ = 15, n = 25, z* = 2.05\|confidence interval for μ` | confidence_interval_generator.py |
| `CLAUSE` | 2 | `CLAUSE\|C1\|(not P81501 OR P45545)` | resolution_proof_generator.py |
...
| `CMP_DIGIT` | 4 | `CMP_DIGIT\|pos_0\|3\|2\|>` | number_comparison_generator.py |
| `CMP_NUM` | 3 | `CMP_NUM\|347.82\|221.45\|>` | number_comparison_generator.py |
| `CNF_FORM` | 1 | `CNF_FORM\|(L OR M OR N) AND (L OR M OR NOT N) AND (NOT L OR NOT M OR N)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|-77760` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|3, -16, 0, 26\|0 inserted for missing x term` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COEFF_MATCH` | 2 | `COEFF_MATCH\|x^n\|(n+1)a_(n+1) = -4a_n` | series_solution_generator.py |
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=1, j=5\|2i + 5j = 27\|accepted` | generating_function_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[3, -3], [2, 1]]` | determinant_generator.py |
...
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2, 3\|[[19, -3, -44], [-6, 1, 14], [-3, 0, 7]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(3,1)\|3` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = 31*v1 - 4*v2\|[-5, -1]` | diagonalization_generator.py |
| `COMB_CONST` | 3 | `COMB_CONST\|-9\|-4\|-13` | derivative_product_quotient_generator.py, equation_from_two_points_generator.py, linear_complex_generator.py, rational_expr_add_sub_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
| `COMB_FORMULA` | 1 | `COMB_FORMULA\|C(n, r) = P(n, r)/r!` | permutation_combination_generator.py |
| `COMB_SETUP` | 2 | `COMB_SETUP\|C(9, 5)\|n!/(r!·(n-r)!)` | counting_classics_generator.py, permutation_combination_generator.py, stars_and_bars_generator.py |
...
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|1372/(-2401)\|-4/7` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMPARE` | 2, 3 | `COMPARE\|7 < 9\|log_b(a) < k` | algorithm_trace_generator.py, equilibrium_ice_generator.py, fixed_point_generator.py, master_theorem_generator.py |
...
| `COMPOSITE_FACTOR` | 2 | `COMPOSITE_FACTOR\|2\|155` | divisibility_classification_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|x + 4 < 3 -> x < -1` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|x + 4 < 3 or x + 4 > 11` | compound_inequality_generator.py |
| `COND_COUNT` | 2 | `COND_COUNT\|club=no and commute=bike\|22` | conditional_probability_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 17, no/bike 22, yes/bus 26, no/bus 11\|P(club=no given commute=bike)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|commute=bike total\|17 + 22 = 39` | conditional_probability_generator.py |
...
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|2*x + 2*y = 16\|lambda*(4/4 + 4/4) = 16\|lambda = 8` | lagrange_multiplier_generator.py |
...
| `CONV_FACTOR` | 2 | `CONV_FACTOR\|1 km\|1000 m` | cross_section_generator.py, dimensional_analysis_generator.py, multi_step_unit_conversion_generator.py, rate_conversion_generator.py, unit_conversion_generator.py |
...
| `CONV_RESULT` | 2 | `CONV_RESULT\|19000 m\|19 km` | dimensional_analysis_generator.py, multi_step_unit_conversion_generator.py, rate_conversion_generator.py, temperature_conversion_generator.py, unit_conversion_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[31, -4]` | diagonalization_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|67 boxes\|force 29 in one box` | counting_classics_generator.py |
...
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|-8*x + 4*y + 8 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|(-8)*10 - 4^2\|-96` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=2\|ln(11/2)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|6·EF = 10·6` | similar_triangles_generator.py, triangle_solve_generator.py |
...
| `CURL_COMPONENT` | 3 | `CURL_COMPONENT\|i\|3 + 2\|5` | div_curl_generator.py |
...
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 6x^2 + 9x - 6\|critical points and their nature` | curve_analysis_generator.py |
...
| `CX_SETUP` | 2 | `CX_SETUP\|i^45\|simplify` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|D A\|{D,S}\|cell 2,3` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|A\|a or c or d` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string caca\|length 4` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{A} x {A,D}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|c\|{A}` | cyk_parser_generator.py |
...
| `DATE_ORDINAL` | 2 | `DATE_ORDINAL\|2028-05-03\|740470` | calendar_arithmetic_generator.py |
...
| `DEC_ADD_COL` | 3 | `DEC_ADD_COL\|frac_0\|9+3+0\|->2 (carry 1)` | decimal_add_sub_generator.py |
| `DEC_ALIGN` | 2 | `DEC_ALIGN\|35.29\|68.03` | decimal_add_sub_generator.py |
| `DEC_CARRY_FINAL` | 1 | `DEC_CARRY_FINAL\|1` | decimal_add_sub_generator.py |
| `DEC_SHIFT` | 3 | `DEC_SHIFT\|7.5/1.5\|75/15\|1` | decimal_div_generator.py, percent_problem_generator.py |
| `DEC_SUB_COL` | 3 | `DEC_SUB_COL\|frac_0\|2-4 (borrow_in 0)\|->8 (borrow_out 1)` | decimal_add_sub_generator.py |
| `DEC_TO_FRAC` | 2 | `DEC_TO_FRAC\|8.6\|86/10` | fraction_decimal_percent_converter.py |
| `DEC_TO_PERCENT` | 2 | `DEC_TO_PERCENT\|1.4\|140%` | fraction_decimal_percent_converter.py, percent_problem_generator.py, tip_bill_split_generator.py |
| `DEC_TYPE` | 2 | `DEC_TYPE\|133/158\|repeating` | repeating_decimal_generator.py |
| `DEC_VALUE` | 2 | `DEC_VALUE\|133/158\|0.8(4177215189873)` | repeating_decimal_generator.py |
...
| `DERANGE_SETUP` | 2 | `DERANGE_SETUP\|n = 10\|exactly 1 fixed` | derangement_generator.py |
...
| `DERIVED` | 2 | `DERIVED\|C5\|(not P81501)` | resolution_proof_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 3x^2 + 4x + 5x^(-2)\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -1], [1, 0], [1, 1]]\|y = [16, 5, 12]` | least_squares_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[1, 9], [1, 8]]\|D = [[-7, 0], [0, -4]]\|P^-1 = [[-8, 9], [1, -1]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[17, 11, 5]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 4*x^2 + 4*y^2 - 2*x*y - 6*x + 6*y\|point (1, 1)\|dx=2/5, dy=2/5` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|0*2/5 + 12*2/5\|4.8` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|256\|-57344\|57600` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `DISC_CLASSIFY` | 2 | `DISC_CLASSIFY\|-60 < 0\|no real solutions` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py |
| `DIST` | 3 | `DIST\|4\|2x-5\|8x-20` | derivative_limit_def_generator.py, derivative_product_quotient_generator.py, equation_from_two_points_generator.py, function_composition_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, polar_parametric_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_expr_add_sub_generator.py, recursive_explicit_generator.py, simplify_expression_generator.py, solid_revolution_generator.py, special_solution_equation_generator.py, tangent_line_generator.py |
| `DIST2` | 2, 3 | `DIST2\|P1\|C1\|97` | embedding_similarity_generator.py, kernel_evaluation_generator.py, kmeans_step_generator.py |
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-4x - 6 = -14` | systems_substitution_generator.py |
...
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited E\|A=6, B=inf, C=5, D=3, E=0` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|x\|5x^3 - 2x^2 + 3x` | multiplying_polynomials_generator.py |
| `DIVIDE_EQ` | 2 | `DIVIDE_EQ\|divide by y^2\|y^(-2)dy/dx + 2y^(-1) = 10` | ode_substitution_generator.py |
| `DIVMOD` | 4 | `DIVMOD\|219\|2\|109\|r=1` | base_conversion_generator.py |
| `DIV_CHECK` | 3 | `DIV_CHECK\|6\|2\|remainder 0` | divisibility_classification_generator.py, logical_connective_eval_generator.py |
| `DIV_COEFF` | 3 | `DIV_COEFF\|-13\|-2\|x=13/2` | linear_complex_generator.py |
| `DIV_SETUP` | 2 | `DIV_SETUP\|75\|15` | decimal_div_generator.py, percent_problem_generator.py |
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y + R_z\|-3 - 1 - 6\|-10` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|9t^2\|3t\|3t` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT V AND NOT W AND X AND Y) OR (NOT V AND W AND NOT X AND Y) OR (NOT V AND W AND X AND Y) OR (V AND NOT W AND NOT X AND Y) OR (V AND NOT W AND X AND NOT Y)` | boolean_algebra_generator.py |
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|denominator ≠ 0\|t^2 - 5t + 4 ≠ 0` | domain_range_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(27, 7) · (5/13, 12/13)\|27*5/13 + 7*12/13\|219/13` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `DOUBLE_SETUP` | 2, 3 | `DOUBLE_SETUP\|integrand 4*x + 8*y + 5\|x:2..4\|y:0..4` | double_integral_generator.py |
...
| `EIGENVECTOR` | 2 | `EIGENVECTOR\|A + 4I times v = 0\|[11, 18, -48]` | diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, svd_generator.py |
| `EIGEN_CHECK` | 3 | `EIGEN_CHECK\|sigma_z psi\|1*psi\|lambda=1` | spin_half_generator.py |
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 4I\|[[6, -1, 1], [0, 8, 3], [0, 0, 0]]` | eigenvalue_generator.py |
...
| `EVAL_PARTIAL` | 3 | `EVAL_PARTIAL\|f_x\|2*4 - 6\|2` | gradient_generator.py, multivar_chain_rule_generator.py |
| `EV_FORMULA` | 1 | `EV_FORMULA\|E = Σ (payoff)·P` | expected_value_generator.py |
| `EV_SETUP` | 2 | `EV_SETUP\|P($-6) = 1/4; P($9) = 1/4; P($-4) = 1/4; P($5) = 1/4\|expected value of the game` | expected_value_generator.py |
| `EXACT_MATCH` | 2 | `EXACT_MATCH\|F_y = N\|-3*x + g'(y) = -3*x + 4*y - 2` | exact_ode_generator.py |
...
| `EXP_CELL` | 2 | `EXP_CELL\|(240·150)/300\|120` | chi_square_generator.py |
...
| `EXP_EXPAND` | 1 | `EXP_EXPAND\|8 × 8 × 8 × 8 × 8` | exponent_generator.py |
...
| `EXP_RULE_APPLY` | 3, 4 | `EXP_RULE_APPLY\|multiply\|8\|6\|48` | exponent_generator.py, exponent_mixed_rules_generator.py |
...
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|((8s)^8)^6` | exponent_generator.py, exponent_mixed_rules_generator.py, rational_exponent_generator.py |
| `EXP_RULE_SIMPLIFY` | 1 | `EXP_RULE_SIMPLIFY\|(8s)^48` | exponent_generator.py, exponent_mixed_rules_generator.py |
| `EXP_SETUP` | 2 | `EXP_SETUP\|8\|5` | exponent_generator.py |
...
| `FACTOR` | 1, 2 | `FACTOR\|x^2 - 6x - 7\|(x + 1)(x - 7)` | polynomial_inequality_generator.py, second_order_ode_generator.py, transfer_function_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `FACT_CHECK` | 3 | `FACT_CHECK\|95\|1\|0` | factors_generator.py |
| `FACT_FORMULA` | 1 | `FACT_FORMULA\|3! = 1·2·3` | derangement_generator.py, permutation_combination_generator.py |
| `FACT_PAIR` | 2 | `FACT_PAIR\|1\|95` | factors_generator.py |
...
| `FIN_SETUP` | 3 | `FIN_SETUP\|income = 2700\|needs 60%, savings 20%, fun 20%\|budget amounts` | finance_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|28 + 4 = 32, not 16` | error_spotting_generator.py |
...
| `FLUX_SUM` | 2 | `FLUX_SUM\|(4 - 5 + 1)*72\|0` | vector_theorem_generator.py |
...
| `FOIL_O` | 2 | `FOIL_O\|Outer: (-6) * 2i\|-12i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(4 + √5)(1 + √5)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FRAC_BUILD` | 2 | `FRAC_BUILD\|160/180\|8/9` | conditional_probability_generator.py, geometric_probability_generator.py |
...
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|7/5\|1.4` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Red: 1, Blue: 2, Green: 9, Yellow: 7, Purple: 11\|most frequent category` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(f - g)(1)\|f(1) - g(1)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|g(x) = -2x^2 - 6x + 0\|g(2)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
...
| `GCD_START` | 2 | `GCD_START\|55\|87` | gcf_generator.py, lcm_generator.py |
| `GCD_STEP` | 3 | `GCD_STEP\|55\|87\|55` | gcf_generator.py, lcm_generator.py |
| `GCF_COEFF` | 2 | `GCF_COEFF\|9, 6\|3` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEOM_SETUP` | 2 | `GEOM_SETUP\|p = 2/3, q = 1/3\|P(X > 1)` | geometric_distribution_generator.py |
| `GEO_PROB_FORMULA` | 1 | `GEO_PROB_FORMULA\|probability = favorable area / total area` | geometric_probability_generator.py |
| `GEO_PROB_SETUP` | 2 | `GEO_PROB_SETUP\|rectangle 10 by 18\|shaded rectangle 10 by 16` | geometric_probability_generator.py |
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; segments p = 5 (adjacent to the leg) and q = 23\|the leg adjacent to p` | geometric_mean_generator.py |
...
| `GF_SETUP` | 2 | `GF_SETUP\|[x^27]\|1/((1 - x^2)(1 - x^5))` | generating_function_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = x^2 + 2*y^2 - 4*x*y - 6*x + 6*y\|point (4, 0)\|tangent` | gradient_generator.py |
| `GRAPH_CHANGE` | 3 | `GRAPH_CHANGE\|2018\|2019\|2` | graph_interpret_generator.py |
| `GRAPH_DATA` | 2 | `GRAPH_DATA\|line_graph\|2018:28,2019:30,2020:34,2021:38,2022:45,2023:43,2024:44,2025:39` | graph_interpret_generator.py |
| `GRAPH_MAX` | 2 | `GRAPH_MAX\|Apr\|29` | graph_interpret_generator.py |
| `GRAPH_MAX_CHANGE` | 3 | `GRAPH_MAX_CHANGE\|2021\|2022\|7` | graph_interpret_generator.py |
| `GRAPH_MIN` | 2 | `GRAPH_MIN\|Thursday\|6` | graph_interpret_generator.py |
| `GRAPH_READ` | 2 | `GRAPH_READ\|2018\|28` | graph_interpret_generator.py |
...
| `GROUP` | 2 | `GROUP\|(8x^2 + 6x)\|(20x + 15)` | factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `GS_SETUP` | 2 | `GS_SETUP\|vectors [[1, 1, 1], [-2, 0, -1], [-3, -1, 1]]\|orthogonal basis, not normalized` | gram_schmidt_generator.py |
...
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|(-8)*10 - 4^2\|-96` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = -4*x^2 + 5*y^2 + 4*x*y + 8*x + 20*y\|find and classify the critical point` | hessian_classify_generator.py |
| `HESSIAN_TEST` | 3 | `HESSIAN_TEST\|D = -96\|f_xx = -8\|saddle point` | hessian_classify_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-3x^3 - 5x^2 - 2x - 3\|x = 4` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 400, 239 successes, critical value = 2.576` | hypothesis_test_generator.py, two_sample_test_generator.py |
...
| `I` | 2 | `I\|1/8\|8/1` | fraction_op_generator.py, mixed_number_operation_generator.py, rational_expr_mult_div_generator.py |
...
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=8..34 C(i,8) = C(35,9)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=24, n(B)=10\|n(A intersect B)=4` | inclusion_exclusion_generator.py |
...
| `IMPROPER_TO_MIX` | 2 | `IMPROPER_TO_MIX\|56/9\|6 2/9` | composite_arithmetic_generator.py, mixed_number_operation_generator.py, order_of_operations_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|add\|3\|-15 ≤ 3x ≤ 21` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
| `INEQ_OP_BOTH` | 4 | `INEQ_OP_BOTH\|add\|10\|x\|24` | domain_range_generator.py, linear_fractional_generator.py, one_step_inequality_generator.py, two_step_inequality_generator.py |
...
| `INEQ_SETUP` | 1 | `INEQ_SETUP\|x - 10 < 14` | linear_fractional_generator.py, one_step_inequality_generator.py, polynomial_inequality_generator.py, two_step_inequality_generator.py |
...
| `INNER_ANTIDERIV` | 2 | `INNER_ANTIDERIV\|dy\|4*x*y + 4*y^2 + 5*y` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_EVAL` | 2, 3 | `INNER_EVAL\|y=0..4\|16*x + 84` | double_integral_generator.py, triple_integral_generator.py |
...
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 0\|33, 39, 2, 7, 30` | algorithm_trace_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ 9 cos(3x) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `INT_ABS` | 2 | `INT_ABS\|-10\|10` | integer_operations_generator.py |
...
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|(-4)*2 - (-4)*(-2)\|-16` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[-4, -4], [-2, 2]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = -4*u - 4*v\|y = -2*u + 2*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
...
| `KIN_SETUP` | 3, 4 | `KIN_SETUP\|v = 38 km/hour\|t = 11 hours\|distance` | invariant_mass_generator.py, kinematics_generator.py |
...
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|1001, 1011\|U AND NOT V AND X` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|UV=00\|0, 1, 0, 1` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows UV=00,UV=01,UV=11,UV=10\|columns WX=00,WX=01,WX=11,WX=10` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|(U AND NOT V AND X) OR (NOT V AND NOT W AND X) OR (NOT U AND NOT V AND W AND NOT X)` | boolean_algebra_generator.py |
...
| `L` | 3 | `L\|2\|1\|2` | fraction_comparison_generator.py, fraction_op_generator.py, linear_fractional_generator.py, mixed_number_operation_generator.py, rational_expr_add_sub_generator.py |
...
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = 2*x^2 + 2*y^2\|constraint 2*x + 2*y = 16\|minimize` | lagrange_multiplier_generator.py |
...
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|((lambda t. t) (p p))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LCM_FROM_GCD` | 3 | `LCM_FROM_GCD\|59*122\|1\|7198` | lcm_generator.py |
...
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→0 of 3x^2 - 4x + 4\|polynomial: direct substitution` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
...
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|-4/2 + 4\|2` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = 5x - 3\|(-10, -6)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <2*x - 3*y + 3, 2*y - 3*x>\|from (-4, 4) to (4, -1)` | line_integral_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(4x)) = ln(45)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
...
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_3(x^3y^4) - log_3(z)\|log_3(x^3y^4/z)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|3log_3(x) + 4log_3(y) - log_3(z)\|condense` | complex_log_generator.py, log_properties_generator.py |
...
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-1, 16), (0, 5), (1, 12)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[5, -5, 0], [20, -17, -1], [-5, -7, 2]]\|unit lower L` | lu_decomposition_generator.py |
...
| `MAT_ENTRY` | 2, 3 | `MAT_ENTRY\|(1,1)\|-14` | lie_exponential_generator.py, matrix_calculus_generator.py, matrix_ops_generator.py |
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[1, 2], [2, -2]], v = [[-4], [-5]]\|Av` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
| `MAX` | 2, 3 | `MAX\|11, 15\|15` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
...
| `MEAN_DIV` | 3 | `MEAN_DIV\|20\|5\|4` | composite_arithmetic_generator.py, five_number_summary_generator.py, regression_generator.py, simple_stats_generator.py, standard_deviation_generator.py |
| `MEASURE_BASIS` | 3 | `MEASURE_BASIS\|x\|ket+x=(ket0+ket1)/sqrt(2)\|ket-x=(ket0-ket1)/sqrt(2)` | spin_half_generator.py |
| `MEASURE_FAVORABLE` | 2 | `MEASURE_FAVORABLE\|shaded area\|10 * 16 = 160` | geometric_probability_generator.py |
| `MEASURE_PROB` | 3 | `MEASURE_PROB\|computational basis\|P(01)=1\|all other outcomes 0` | quantum_gate_generator.py |
| `MEASURE_TOTAL` | 2 | `MEASURE_TOTAL\|whole area\|10 * 18 = 180` | geometric_probability_generator.py |
| `MEDIAN_PAIR` | 2 | `MEDIAN_PAIR\|8\|10` | five_number_summary_generator.py, simple_stats_generator.py |
| `MEDIAN_PICK` | 1, 2 | `MEDIAN_PICK\|17` | five_number_summary_generator.py, simple_stats_generator.py |
...
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=0,mid=1,hi=2\|left 12; right 19` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|12\|19\|take left` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 0-1\|array 12, 19, 34, 46, 30` | algorithm_trace_generator.py |
...
| `MINTERM` | 2 | `MINTERM\|0011\|NOT V AND NOT W AND X AND Y` | boolean_algebra_generator.py |
...
| `MIX_IMPROPER` | 2 | `MIX_IMPROPER\|5 1/3\|16/3` | composite_arithmetic_generator.py, mixed_number_operation_generator.py, order_of_operations_generator.py |
...
| `MODE` | 2 | `MODE\|1\|1, 9, 10, 11, 13, 15, 19` | frequency_table_generator.py, simple_stats_generator.py |
| `MODEL` | 1 | `MODEL\|A = P · (1/2)^(t/h)` | exponential_model_generator.py |
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 212 · (1/2)^(50/25)` | exponential_model_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|3^2*7^5/10\|151263/10` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|3*7^4/4\|7203/4` | centroid_generator.py |
...
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|1 F, 1 B, 4 R's, 5 Y's\|total 11` | stars_and_bars_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 - 5x - 2 on [2, 6]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 5*x^2 + 5*y^2 + 2*x*y - 3*x + 6*y\|x = t - 3, y = 4*t - 4\|t = 0` | multivar_chain_rule_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 5x = -30\|line 5 shows x = -6` | fill_in_step_generator.py |
| `NEG_LOG` | 2 | `NEG_LOG\|p=1/64\|ln(64)` | perplexity_generator.py |
| `NET_SETUP` | 2 | `NET_SETUP\|1 square 10 by 10; 4 triangles with base 10 and height 8\|total surface area` | nets_surface_area_generator.py |
...
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|t3\|{t5}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|ccbaa` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{t1}\|c\|t1->{t1,t7}\|{t1,t7}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|c` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states t1, t2, t3, t5, t7\|alphabet a, b, c\|start t1` | nfa_simulation_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(77, 10)\|z-score of x = 74` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
...
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dx = y^2, y(0) = 25\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `OPT_SETUP` | 2 | `OPT_SETUP\|2468 m of fence, barn forms the fourth side; sides x, x, and 2468 - 2x\|maximize area` | optimization_generator.py |
...
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|x=2..4\|8*(4^2 - 2^2) + 84*(4 - 2)\|264` | double_integral_generator.py |
...
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|3x + 37 = 4x + 25` | angle_relationships_generator.py |
| `PARALLEL_SETUP` | 2 | `PARALLEL_SETUP\|corresponding\|Corresponding angles are equal` | angle_relationships_generator.py |
| `PARALLEL_SOLVE` | 2 | `PARALLEL_SOLVE\|-1x = -12\|x = 12` | angle_relationships_generator.py |
...
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(-4*t + 4, -t - 2)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 6cos t + 8, y = 6sin t - 9\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(-4x + 15)/(x - 3)^2 = A/(x - 3) + B/(x - 3)^2` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|-3/(s + 5) - 4/(s - 4)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|16*x^3*y^4 + 4*y^3` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|4*x^4*y^4\|d/dx\|16*x^3*y^4` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 4*x^4*y^4 + 4*x*y^3\|f_x` | partial_derivative_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.775\|2045\|1584.875` | percent_problem_generator.py |
| `PERCENT_TO_DEC` | 2 | `PERCENT_TO_DEC\|5%\|0.05` | annuity_generator.py, bond_pricing_generator.py, composite_arithmetic_generator.py, exponential_model_generator.py, fill_in_step_generator.py, finance_generator.py, fraction_decimal_percent_converter.py, npv_irr_generator.py, percent_problem_generator.py, percent_word_problem_generator.py, piecewise_evaluation_generator.py, portfolio_generator.py, tip_bill_split_generator.py |
...
| `PERM_SETUP` | 2, 3 | `PERM_SETUP\|P(16, 5)\|n!/(n-r)!` | permutation_combination_generator.py, permutation_group_generator.py |
...
| `PF_STEP` | 3 | `PF_STEP\|1911\|3\|637` | prime_factorization_generator.py, repeating_decimal_generator.py |
...
| `PHYS_SETUP` | 3 | `PHYS_SETUP\|W = 2856 joules\|t = 24 seconds\|power` | physics_formula_generator.py |
...
| `PICTO_COUNT` | 2 | `PICTO_COUNT\|Hamsters\|2` | graph_interpret_generator.py |
...
| `PLACE_DP` | 3 | `PLACE_DP\|73112\|3\|73.112` | decimal_mult_generator.py |
| `PLACE_DP_Q` | 3 | `PLACE_DP_Q\|5\|1\|5` | decimal_div_generator.py, percent_problem_generator.py |
...
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|8*2/4\|4` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y - 9 = -4(x - 6)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|r = 8 cos θ\|pole=(-12, 16)\|rectangular equation` | parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|y^3 - 2y^2 - 16y - 5\|y + 3` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-4` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(18x^5 + 45x^2) / (9x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(18x^5) / (9x^2) + (45x^2) / (9x^2)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-8x +8x) + (-5 +1)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|2x + 2` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 1)(5x^2 - 2x + 3)` | multiplying_polynomials_generator.py |
...
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-8x - 5) + (8x + 1)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(y^3 - 2y^2) - (y^3 + 3y^2)\|-5y^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
...
| `POTENTIAL_BUILD` | 3 | `POTENTIAL_BUILD\|integrate P dx\|x^2 - 3*x*y + 3*x + g(y)\|g'(y) remains` | exact_ode_generator.py, line_integral_generator.py |
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|x^2 + y^2 - 3*x*y + 3*x` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(1/5)^5\|0.00032` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|25*4 + (-192)\|-92` | diagonalization_generator.py |
...
| `POWER_SET_RESULT` | 1 | `POWER_SET_RESULT\|{{}, {a}, {c}, {f}, {a, c}, {a, f}, {c, f}, {a, c, f}}` | set_operations_generator.py |
| `POWER_SHIFT` | 3 | `POWER_SHIFT\|k=0\|0-3\|-3` | laurent_series_generator.py |
| `PREDICT` | 2 | `PREDICT\|x*\|5/37` | kernel_ridge_generator.py |
| `PRIME` | 1 | `PRIME\|127` | divisibility_classification_generator.py |
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited A\|AB=1, AC=20` | mst_generator.py |
...
| `PROB_CONDITIONAL` | 2 | `PROB_CONDITIONAL\|P(yellow given first was yellow)\|6/18` | compound_probability_generator.py |
| `PROB_DEPENDENT` | 1 | `PROB_DEPENDENT\|Drawing without replacement means dependent events` | compound_probability_generator.py |
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Coin and d12: tails, then 1` | compound_probability_generator.py |
...
| `PROB_SETUP` | 2 | `PROB_SETUP\|50\|52` | simple_probability_generator.py |
...
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[13, 11, 9]` | least_squares_generator.py, legendre_construction_generator.py |
...
| `PROP_SETUP` | 1 | `PROP_SETUP\|4/4 = x/9` | proportion_word_problem_generator.py, proportional_relationship_generator.py, similar_triangles_generator.py, triangle_solve_generator.py |
...
| `PYTHAG_CALCULATE` | 2 | `PYTHAG_CALCULATE\|d² = 400 + 225 = 625\|625` | pythag_leg_generator.py |
| `PYTHAG_CONTEXT` | 3 | `PYTHAG_CONTEXT\|displacement\|east=20m, north=15m\|diagram=UWF` | pythag_leg_generator.py |
| `PYTHAG_FORMULA` | 1 | `PYTHAG_FORMULA\|a² + b² = c²` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_MODEL` | 3 | `PYTHAG_MODEL\|east=20\|north=15\|distance=?` | pythag_leg_generator.py |
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|2304\|48` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 2, 3 | `PYTHAG_SETUP\|legs=30,40\|hypotenuse KC=?` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 3600 - 1296\|2304` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|36\|1296` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|36² + b² = 60²` | pythag_leg_generator.py |
| `Q1` | 4 | `Q1\|-16\|240\|16\|14` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|-16\|240\|16\|-16` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
...
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[9, -12], [12, 9]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|156°\|quadrant II` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
...
| `QUARTILE` | 3 | `QUARTILE\|Q1\|8,9,18,19,19\|18` | five_number_summary_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|circle: dr/dt = 19 ft/s; r = 9 ft\|dA/dt` | related_rates_generator.py |
| `RATIO` | 2, 3 | `RATIO\|y = x\|y = x` | lagrange_multiplier_generator.py, simplex_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|√403/√403` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
| `RATIO_BASE` | 3 | `RATIO_BASE\|30:27\|3\|10:9` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
| `RATIO_TABLE` | 2 | `RATIO_TABLE\|Red (liters): 20, 30, 100, 110\|Blue (liters): ?, 27, 90, 99` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
| `RAW_FORMULA` | 1 | `RAW_FORMULA\|x = μ + z·σ` | z_score_generator.py |
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 44135 / 0.97` | percent_problem_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = 6 a_(n-1) - 8 a_(n-2) + 6\|a_0 = 4, a_1 = 12` | master_theorem_generator.py, recurrence_generator.py |
...
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q9897_1` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|a*b\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q9897_0\|still reading a*` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q9897_0\|a\|q9897_0` | regex_to_automaton_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 37), (2, 35), (3, 29), (4, 33), (5, 31)\|correlation coefficient r` | regression_generator.py |
| `REJECT` | 2 | `REJECT\|(-6, 0)\|(x + 6)x(x - 4) ≤ 0 is reject` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
| `RELAX` | 3 | `RELAX\|E->A\|update inf to 6\|via weight 6` | dijkstra_generator.py |
...
| `REL_SETUP` | 2, 3 | `REL_SETUP\|A = {1, 2, 3, 4}\|R = {(1, 3), (1, 4), (2, 2), (3, 2), (3, 3), (4, 1), (4, 3)}` | relation_check_generator.py, special_relativity_generator.py |
| `REPEAT_DETECT` | 2 | `REPEAT_DETECT\|remainder 66 repeats\|repetend 4177215189873` | repeating_decimal_generator.py |
...
| `RIEMANN_SETUP` | 2, 3 | `RIEMANN_SETUP\|f(x) = x^2 + 4 on [1, 9], n = 4\|midpoint Riemann sum` | riemann_sum_generator.py, riemann_tensor_generator.py |
...
| `ROOT_SIMPLIFY` | 1, 2 | `ROOT_SIMPLIFY\|12√14` | complex_quadratic_generator.py, distance_formula_generator.py, dot_product_generator.py, euler_formula_generator.py, exponent_generator.py, geometric_mean_generator.py, hypercube_counting_generator.py, polar_parametric_generator.py, vector_ops_generator.py |
...
| `ROUND_CHECK` | 3 | `ROUND_CHECK\|5\|2\|<5` | place_value_rounding_generator.py |
| `ROUND_RESULT` | 2 | `ROUND_RESULT\|28552\|28550` | place_value_rounding_generator.py |
...
| `SA_BASES` | 2 | `SA_BASES\|2π(15)² = 2π × 225\|450π` | volume_3d_generator.py |
| `SA_FACES` | 3 | `SA_FACES\|top/bottom\|6 × 3\|18` | volume_3d_generator.py |
| `SA_FORMULA` | 1 | `SA_FORMULA\|SA = 2(lw + lh + wh)` | round_solids_generator.py, volume_3d_generator.py |
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 15 × 39\|1170π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=6, w=3, h=5` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(18 + 30 + 15)\|126` | round_solids_generator.py, volume_3d_generator.py |
| `SB_FORMULA` | 1 | `SB_FORMULA\|C(n+k-1, k-1)` | stars_and_bars_generator.py |
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x7 = 39\|xi >= 0` | stars_and_bars_generator.py |
| `SCALE_DIV` | 3 | `SCALE_DIV\|2464\|77\|32` | scaling_generator.py |
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|11*cos\|11` | de_moivre_generator.py, euler_formula_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|8.5 centimeters\|actual_dimension` | scaling_generator.py |
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = -7\|(-343)*31\|-10633` | diagonalization_generator.py |
| `SCALE_MULT` | 3 | `SCALE_MULT\|8.5\|45\|382.5` | scaling_generator.py |
| `SCALE_SETUP` | 3 | `SCALE_SETUP\|1 centimeter\|45 meters\|45` | scaling_generator.py |
...
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|8.6\|5` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|right\|5` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|divide_coefficients\|5.61\|1.7\|3.3` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|8.6 × 10^5` | exponent_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(-6, -4), B(-18, 8); ratio 2:2 from A\|point P` | segment_partition_generator.py |
| `SECTOR_FORMULA` | 1 | `SECTOR_FORMULA\|A = (θ/360)·πr^2` | arc_sector_generator.py |
| `SELECT_MIN` | 2 | `SELECT_MIN\|E\|0` | dijkstra_generator.py |
| `SELECT_RELEVANT` | 2 | `SELECT_RELEVANT\|base = 81, rate = 25%\|ignore 9 (irrelevant)` | percent_word_problem_generator.py, proportion_word_problem_generator.py |
| `SEPARATE` | 1, 2 | `SEPARATE\|y^(-2) dy = dx` | ode_substitution_generator.py, separable_ode_generator.py, separable_pde_generator.py |
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_11 = -5 + (11 - 1)·-5` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|-5, -10, -15, -20, ...\|sum of first 11 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|44135 = 0.97 * whole` | percent_problem_generator.py |
| `SET_SETUP` | 2, 3 | `SET_SETUP\|S = {a, c, f}\|power set` | set_operations_generator.py |
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y3 = 38` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
...
| `SIGFIG_ROUND` | 3 | `SIGFIG_ROUND\|7776\|2 significant figures\|7.8 × 10^3` | fermi_estimation_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|176 + 99 + 44 + 11 + 0 + 11 + 44` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=-4)^(2) 11k^2\|expand and evaluate` | sigma_notation_generator.py |
...
| `SIGN_CHART` | 2 | `SIGN_CHART\|zeros\|-6, 0, 4` | polynomial_inequality_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, -11)\|y = -12\|f(y) = -16 (negative)\|down` | stability_generator.py |
| `SIMILAR_APPLY` | 3 | `SIMILAR_APPLY\|7\|5\|35` | scaling_generator.py |
| `SIMILAR_SCALE` | 3 | `SIMILAR_SCALE\|15\|3\|5` | scaling_generator.py |
| `SIMILAR_SETUP` | 3 | `SIMILAR_SETUP\|triangle\|7,3,9\|15 (others unknown)` | scaling_generator.py |
| `SIMPLEX_SETUP` | 3 | `SIMPLEX_SETUP\|max z=15x+6y\|x<=18\|y<=9` | simplex_generator.py |
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; AB = 6, DE = 10, BC = 6\|find EF` | similar_triangles_generator.py |
...
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = 4sin(3(x - π/4)) + 3\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_INT_IDENTIFY` | 2 | `SLOPE_INT_IDENTIFY\|Slope (m)\|39` | slope_intercept_form_generator.py |
| `SLOPE_INT_MATCH` | 2 | `SLOPE_INT_MATCH\|Compare to Slope-Intercept Form\|y = mx + b` | slope_intercept_form_generator.py |
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -44 + 39x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|-4` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(-10, -4)\|(-10, -5)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-5 - (-4)) / (-10 - (-10))` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(e^(6t))*3 + (0)*5\|3*e^(6t)` | matrix_exponential_generator.py |
...
| `SORT` | 2 | `SORT\|9,11,1,10,13,19,15\|1,9,10,11,13,15,19` | five_number_summary_generator.py, simple_stats_generator.py |
| `SORT_EDGES` | 1 | `SORT_EDGES\|AB=5, CE=7, DE=12, AC=13, AD=15, BC=21` | mst_generator.py |
| `SPECIAL_SOLUTION` | 2 | `SPECIAL_SOLUTION\|24 = 24\|identity: true for every x` | radical_equation_generator.py, special_solution_equation_generator.py |
...
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|26x = 6x + 20x\|8x^2 + 6x + 20x + 15` | factor_trinomial_generator.py |
...
| `SQRT_NEG` | 2 | `SQRT_NEG\|√(-828)\|i√828` | complex_quadratic_generator.py, polynomial_zeros_generator.py |
| `SQRT_SETUP` | 2 | `SQRT_SETUP\|N = 279\|x0 = 20` | manual_square_root_generator.py |
...
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|333\|9 × 37\|9` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(47 + 52) / 2\|49.5` | statistics_generator.py |
...
| `STAT_FREQUENCY` | 2 | `STAT_FREQUENCY\|26\|4` | statistics_generator.py |
| `STAT_MAD` | 3 | `STAT_MAD\|54\|6\|9` | statistics_generator.py |
| `STAT_MAX` | 1 | `STAT_MAX\|90` | statistics_generator.py |
| `STAT_MEAN` | 2 | `STAT_MEAN\|276 / 6\|46` | statistics_generator.py |
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|positions 3 and 4\|47, 52` | statistics_generator.py |
| `STAT_MIN` | 1 | `STAT_MIN\|15` | statistics_generator.py |
| `STAT_MODE` | 2 | `STAT_MODE\|26 and 78\|4` | statistics_generator.py |
| `STAT_ORDER` | 1 | `STAT_ORDER\|13, 17, 47, 52, 70, 74` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|90 - 15\|75` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|78, 47, 51, 83, 63, 77, 91` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|78 + 47 + 51 + 83 + 63 + 77 + 91\|490` | statistics_generator.py |
...
| `SUM` | 2, 3 | `SUM\|37 + 35 + 29 + 33 + 31\|165` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
...
| `SYMMETRIC_CHECK` | 3 | `SYMMETRIC_CHECK\|(1, 3)\|reverse (3, 1)\|missing` | relation_check_generator.py |
| `SYMMETRY` | 2 | `SYMMETRY\|odd function\|a0=0, a_n=0` | fourier_series_generator.py |
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|3x^3 - 16x^2 + 26\|r = 5` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|3, -1, -5, 1` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -4y = 20` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with x only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = -5y - 25` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * -3, Eq2 * -1` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|9x - 3y = -30\|-9x - y = 50` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|y = -x - 6\|-3x + y = -14` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute (-x - 6) for y in Eq 2` | systems_substitution_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|g(2)\|-4` | de_moivre_generator.py, dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, lie_exponential_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = -8 + 2*(x - 4) - 10*(y - 0)` | gradient_generator.py |
...
| `TAYLOR_SETUP` | 2 | `TAYLOR_SETUP\|f(x) = e^x, P_3 around 0\|bound the error at x = 1/4` | taylor_series_generator.py |
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|survive k=35..38\|subtract k=126..129` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Σ k=35..125 1/(k(k+4))` | telescoping_generator.py |
...
| `TERM` | 2 | `TERM\|i=0: 1·(1/5)^0·(4/5)^3\|0.512` | binomial_probability_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Stokes\|F=<-y, 0, 0>\|disk radius 11 in z=0` | vector_theorem_generator.py |
...
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(-2, -6)\|rotation 270° counterclockwise about the origin` | rv_transform_generator.py, transformation_generator.py |
...
| `TRANSITIVE_CHECK` | 3 | `TRANSITIVE_CHECK\|(1, 3) and (3, 2)\|need (1, 2)\|missing` | relation_check_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: adjacent side = 6, hypotenuse = 10; given cos 53° ≈ 0.6\|angle A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|rho_part * phi_part * angle\|2*64/3*2*2*pi\|512/3*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 2\|ball radius 4\|spherical` | triple_integral_generator.py |
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|x + 12\|3x\|3x + 77` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|7x + 89 = 180\|x = 13` | angle_relationships_generator.py |
| `TRI_ANGLE_SUM` | 1 | `TRI_ANGLE_SUM\|(x + 12) + (3x) + (3x + 77) = 180` | angle_relationships_generator.py |
| `TRI_AREA_FORMULA` | 1 | `TRI_AREA_FORMULA\|Area = (1/2)·a·b·sin C` | triangle_area_sas_generator.py |
| `TRI_SETUP` | 2 | `TRI_SETUP\|45-45-90 triangle, leg = 66\|hypotenuse` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
| `TRUNCATE` | 2 | `TRUNCATE\|rank=1\|discard=12` | low_rank_approx_generator.py |
| `TRUTH_ROW` | 2 | `TRUTH_ROW\|L=0, M=0, N=0\|H=0` | boolean_algebra_generator.py |
...
| `UNIT_ATTACH` | 3 | `UNIT_ATTACH\|418\|kilometers\|418 kilometers` | cross_section_generator.py, kinematics_generator.py, physics_formula_generator.py |
...
| `UNIT_RATE_DIV` | 3 | `UNIT_RATE_DIV\|$36.00\|12\|$3.00` | unit_rate_generator.py |
| `UNIT_RATE_PICK` | 2 | `UNIT_RATE_PICK\|3\|36` | unit_rate_generator.py |
| `UNIT_RATE_SETUP` | 3 | `UNIT_RATE_SETUP\|12\|kilograms\|$36.00` | unit_rate_generator.py |
| `UNIT_RATE_TABLE` | 2 | `UNIT_RATE_TABLE\|3,4,6\|36,48,72` | unit_rate_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|3, -15, 75, -375\|geometric, r = -5` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|1 - 2 = -1\|(-1)^2 = 1\|2/5·1 = 0.4` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|13` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y,z) = <-3*x + 4*y - 6*z, -x - y - 2*z, -6*x + 3*y - 6*z>\|divergence and curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|(-10633) + 256*9\|-8329` | diagonalization_generator.py |
| `VEC_SETUP` | 2 | `VEC_SETUP\|u = ⟨5, 3⟩, v = ⟨-6, -1⟩\|3u + 5v` | dot_product_generator.py, vector_ops_generator.py |
...
| `VOLUME` | 1 | `VOLUME\|1092` | volume_rect_prism_generator.py |
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region under y = x(276 - x) on [0, 276], rotated about the y-axis\|shell method` | solid_revolution_generator.py |
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 7 × 3\|10.5` | round_solids_generator.py, volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 10.5 × 9\|94.5` | round_solids_generator.py, volume_3d_generator.py |
...
| `VOL_SETUP` | 2 | `VOL_SETUP\|triangular_prism\|b=7, h_tri=3, length=9` | volume_3d_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|41 - 68\|-27` | line_integral_generator.py |
...
| `ZERO_PRODUCT` | 2 | `ZERO_PRODUCT\|(x + 6)x(x - 4)\|x = -6 or x = 0 or x = 4` | area_between_curves_generator.py, curve_analysis_generator.py, domain_range_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_equation_generator.py, trig_equation_generator.py |
| `ZSCORE` | 2 | `ZSCORE\|(91 - 95)/8\|-0.5` | normal_table_generator.py, z_score_generator.py |
