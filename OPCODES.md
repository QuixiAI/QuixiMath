...
388 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|3x\|- 9x^3 + 3x^2 + 15x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|84652 × 65409 ≈ 80000 × 70000\|5600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5600000000\|5537002668\|5537002668 ≈ 5600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 gives the tip 29.20\|line 4 answers $175.20` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(42, 8)\|P(57.2 < X < 58)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 8x^4 + 12x^4) / (4x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-8x^4) / (4x^2) + (12x^4) / (4x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(3x + 5)(-3x^2 + x + 5)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(57.2 - 42)/8\|1.90` | normal_table_generator.py |
