...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|2x^3 - 1x^2 + 2x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|52484 × 35944 ≈ 50000 × 40000\|2000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|2000000000\|1886484896\|1886484896 ≈ 2000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|32 - 14 = 18, not 0` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 9x + 11 = 38\|line 3 shows 9x = 27` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(44, 6)\|P(50 < X < 55.4)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(4x^5 + 1x^4 - 5x^2 - 1x^2) / (-x^2)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(4x^5) / (-x^2) + (1x^4) / (-x^2) + (-5x^2) / (-x^2) + (-1x^2) / (-x^2)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 3)(2x^2 - x + 2)` | multiplying_polynomials_generator.py |
...
| `THEOREM` | 2 | `THEOREM\|factor theorem\|x + 2 is a factor iff P(-2) = 0` | circle_angle_generator.py, geometric_mean_generator.py, logistic_growth_generator.py, mean_value_theorem_generator.py, polar_parametric_generator.py, rational_root_generator.py, remainder_factor_theorem_generator.py, special_right_triangle_generator.py, triangle_solve_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(50 - 44)/6\|1.00` | normal_table_generator.py |
