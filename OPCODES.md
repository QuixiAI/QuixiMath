...
528 distinct op-codes observed.
...
| `EVAL_PARTIAL` | 3 | `EVAL_PARTIAL\|f_x\|4*1 - 4*2 - 3\|-7` | gradient_generator.py |
...
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|32*x^3*y^3 + 3*y^4` | gradient_generator.py, partial_derivative_generator.py |
