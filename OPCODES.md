...
| `ADJOINT` | 1 | `ADJOINT\|U^dagger=[[208/233,105/233],[-105/233,208/233]]` | hermitian_check_generator.py |
...
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda n. (p n)\|lambda z. (p z)` | lambda_reduction_generator.py |
...
| `ANGLE_DEFECT_SETUP` | 2 | `ANGLE_DEFECT_SETUP\|R=5\|angles=45,45,15` | angle_defect_generator.py |
...
| `ANGLE_WRAP` | 2 | `ANGLE_WRAP\|260 deg\|-100 deg` | complex_log_generator.py |
...
| `APPLY_GATE` | 3 | `APPLY_GATE\|CNOT\|e^(i49π/221)·ket11\|e^(i49π/221)·ket10` | quantum_gate_generator.py |
...
| `BACK_SUB_ROW` | 3 | `BACK_SUB_ROW\|r=522\|x=1\|y=0` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `BEZOUT_CHECK` | 2 | `BEZOUT_CHECK\|522*-25 + 384*34\|6` | extended_euclid_generator.py |
...
| `CASIMIR_SETUP` | 3 | `CASIMIR_SETUP\|spin=3/2\|hbar=3/11\|JminusJplus entry at m=-3/2` | casimir_generator.py |
...
| `CF_RESULT` | 1 | `CF_RESULT\|[2; 1, 43]` | continued_fraction_generator.py |
| `CF_SETUP` | 1 | `CF_SETUP\|131/44` | continued_fraction_generator.py |
| `CG_COEFF` | 2 | `CG_COEFF\|ket(0,-)\|sqrt(2/3)` | clebsch_gordan_generator.py |
...
| `CHRISTOFFEL_SETUP` | 3 | `CHRISTOFFEL_SETUP\|polar\|g_rr=1, g_thetatheta=r^2\|r=78` | christoffel_generator.py |
...
| `CIRCLE_EQ` | 1 | `CIRCLE_EQ\|(x - 1)^2 + (y - 3)^2 = 49` | complex_locus_generator.py |
...
| `CLAUSE` | 2 | `CLAUSE\|C1\|(P47676)` | resolution_proof_generator.py |
...
| `COMMUTATOR` | 2 | `COMMUTATOR\|[A,B]\|[[105i, 0], [0, -105i]]` | structure_constant_generator.py |
| `COMM_ENTRY` | 3 | `COMM_ENTRY\|(1,1)\|105i/2 - -105i/2\|105i` | structure_constant_generator.py |
...
| `CONGRUENCE_REDUCE` | 2 | `CONGRUENCE_REDUCE\|15x congruent to 6\|mod 8` | modular_inverse_generator.py |
| `CONGRUENCE_SOLUTIONS` | 3 | `CONGRUENCE_SOLUTIONS\|base 2\|step 8\|2, 10, 18` | modular_inverse_generator.py |
...
| `CONTOUR_SETUP` | 3 | `CONTOUR_SETUP\|abs(z)=7\|positive orientation\|f=1/(z-2) + 4/(z+4) + 1/(z+7)` | contour_integral_generator.py |
...
| `CROSS_RATIO` | 1 | `CROSS_RATIO\|13/10` | mobius_transform_generator.py |
| `CROSS_RATIO_SETUP` | 4 | `CROSS_RATIO_SETUP\|z1=-8\|z2=1\|z3=5\|z4=7` | mobius_transform_generator.py |
| `CRT_CHECK` | 3 | `CRT_CHECK\|i=1\|2\|2` | crt_generator.py |
| `CRT_CONGRUENCE` | 3 | `CRT_CONGRUENCE\|i=1\|x=2\|mod 3` | crt_generator.py |
| `CRT_FACTOR` | 3 | `CRT_FACTOR\|i=1\|M_i=11\|mod 3` | crt_generator.py |
| `CRT_SETUP` | 1 | `CRT_SETUP\|2 congruences` | crt_generator.py |
| `CRT_TERM` | 2 | `CRT_TERM\|i=1\|44` | crt_generator.py |
| `CRT_TOTAL_MODULUS` | 2 | `CRT_TOTAL_MODULUS\|3, 11\|33` | crt_generator.py |
| `CR_SETUP` | 2 | `CR_SETUP\|u=2x^2 - 2y^2 + x + 4y\|v=4xy - 4x + y` | cauchy_riemann_generator.py |
...
| `CYCLIC_START` | 2 | `CYCLIC_START\|21\|identity 0` | cyclic_group_generator.py |
| `CYCLIC_SUBGROUP` | 2 | `CYCLIC_SUBGROUP\|{0, 21, 12, 3, 24, 15, 6, 27, 18, 9}\|10` | cyclic_group_generator.py |
...
| `DEMOIVRE_POWER` | 1 | `DEMOIVRE_POWER\|256 cis(180 deg)` | de_moivre_generator.py |
| `DEMOIVRE_SETUP` | 2, 4 | `DEMOIVRE_SETUP\|arbitrary_roots\|R=64\|theta=270 deg\|n=3` | de_moivre_generator.py |
...
| `DENSITY_SETUP` | 2, 3 | `DENSITY_SETUP\|state=Phi_phase\|psi=(ket00 + e^(i118π/67)ket11)/sqrt(2)` | density_matrix_generator.py, partial_trace_generator.py |
...
| `DERIV` | 2, 3 | `DERIV\|d_r g_thetatheta = 2r\|at r=78\|156` | christoffel_generator.py, gaussian_curvature_generator.py, riemann_tensor_generator.py |
| `DERIVATIVE` | 1, 2 | `DERIVATIVE\|g'(x)\|1/4` | fixed_point_generator.py, mgf_generator.py, mle_generator.py |
| `DERIVED` | 2 | `DERIVED\|C5\|(P73983)` | resolution_proof_generator.py |
...
| `DH_SHARED` | 2 | `DH_SHARED\|Alice\|40` | diffie_hellman_generator.py |
...
| `ECDSA_SETUP` | 4 | `ECDSA_SETUP\|E/F_17, G=(5,1), n=19\|d=7\|z=7\|k=6` | ecdsa_generator.py |
| `ECDSA_SIGN` | 2 | `ECDSA_SIGN\|s=k^-1(z+rd) mod n\|s=4` | ecdsa_generator.py |
| `ECDSA_VERIFY` | 2 | `ECDSA_VERIFY\|u1=16\|u2=4` | ecdsa_generator.py |
| `EC_ACCUM` | 2 | `EC_ACCUM\|1P\|(17,9)` | elliptic_curve_finite_field_generator.py |
| `EC_ADD` | 1 | `EC_ADD\|(16,13)` | ecdsa_generator.py |
| `EC_IDENTITY` | 2 | `EC_IDENTITY\|O + Q\|(17,9)` | elliptic_curve_finite_field_generator.py |
...
| `EC_SCALAR_SETUP` | 2 | `EC_SCALAR_SETUP\|k=5\|P=(17,9)` | elliptic_curve_finite_field_generator.py |
...
| `EINSTEIN_SETUP` | 2, 3 | `EINSTEIN_SETUP\|contract\|A_ij=[[3, -2], [-5, 4]]\|B_jk=[[5, 0], [-2, -3]]` | einstein_summation_generator.py |
...
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|522\|384\|1\|138` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|B\|route suffix B\|stack A-C-B-D-A-E` | euler_circuit_generator.py |
| `EULER_CRITERION` | 2 | `EULER_CRITERION\|61^11 mod 23\|22` | quadratic_residue_generator.py |
...
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|522\|384` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `FERMAT_SETUP` | 3 | `FERMAT_SETUP\|prime 23\|base 35\|exponent 195` | totient_generator.py |
...
| `FUNDAMENTAL_FORM_SETUP` | 3 | `FUNDAMENTAL_FORM_SETUP\|cylinder\|R=10\|u in [0,3pi/4], v in [0,6]` | fundamental_form_generator.py |
...
| `GAUSSIAN_CURVATURE_SETUP` | 2, 3 | `GAUSSIAN_CURVATURE_SETUP\|saddle\|z=(1x^2-21y^2)/2\|point=(0,0)` | gaussian_curvature_generator.py |
...
| `GELLMANN_SETUP` | 3 | `GELLMANN_SETUP\|trace\|A=-lambda_4\|B=-4lambda_2` | pauli_algebra_generator.py |
...
| `GREAT_CIRCLE_SETUP` | 3 | `GREAT_CIRCLE_SETUP\|R=9\|A=(90,-90)\|B=(0,30)` | great_circle_generator.py |
...
| `HARMONIC_SETUP` | 1 | `HARMONIC_SETUP\|u=2x^2 - 2y^2 + x - y` | cauchy_riemann_generator.py |
...
| `HOOK` | 4 | `HOOK\|(1,1)\|right=3\|below=7\|hook=11` | young_tableaux_generator.py |
...
| `HYPERBOLIC_DISTANCE_SETUP` | 3 | `HYPERBOLIC_DISTANCE_SETUP\|disk\|P=(0,0)\|Q=(3/19,0)` | hyperbolic_distance_generator.py |
| `HYPERBOLIC_SETUP` | 2 | `HYPERBOLIC_SETUP\|e^x=29/16\|e^(-x)=16/29` | hyperbolic_function_generator.py |
...
| `INDEX_SETUP` | 3 | `INDEX_SETUP\|c=-5\|j=1, k=1\|l=3, m=2` | index_gymnastics_generator.py |
...
| `INNER_PRODUCT_SETUP` | 3 | `INNER_PRODUCT_SETUP\|interval=[0,2pi]\|f=cos(28x)\|g=cos(28x)` | function_inner_product_generator.py |
...
| `INTEGRAL_SETUP` | 1 | `INTEGRAL_SETUP\|L = integral from 0 to pi/3 of 21 dtheta` | metric_arc_length_generator.py |
| `INTEGRATE` | 2 | `INTEGRATE\|v_y = u_x\|v=4xy + x + y + phi(x)` | cauchy_riemann_generator.py |
...
| `JACOBI_SETUP` | 3 | `JACOBI_SETUP\|a=27\|n=77\|n odd` | jacobi_symbol_generator.py |
| `JACOBI_SWAP` | 3 | `JACOBI_SWAP\|a=77\|n=27\|sign 1` | jacobi_symbol_generator.py |
...
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|((lambda m. (m m)) (lambda p. (lambda n. (p n))))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LAURENT_TERM` | 1 | `LAURENT_TERM\|1(z-2)^-2` | residue_generator.py |
...
| `LEGENDRE_SETUP` | 2 | `LEGENDRE_SETUP\|a=61\|p=23` | legendre_construction_generator.py, quadratic_residue_generator.py |
| `LIE_EXP_FORM` | 2 | `LIE_EXP_FORM\|e^(theta J)\|cos(theta)I + sin(theta)J` | lie_exponential_generator.py |
| `LIE_EXP_SETUP` | 4 | `LIE_EXP_SETUP\|SO3\|axis=z\|theta=600 deg\|K=[[0, -1, 0], [1, 0, 0], [0, 0, 0]]` | lie_exponential_generator.py |
...
| `LINE_EQ` | 1 | `LINE_EQ\|-8x + 6y + 5 = 0` | complex_locus_generator.py |
...
| `LLL_DONE` | 1 | `LLL_DONE\|[(3,10),(-12,1)]` | lll_reduction_generator.py |
| `LLL_SETUP` | 1 | `LLL_SETUP\|[(-9,11),(12,-1)]` | lll_reduction_generator.py |
| `LOCUS_SETUP` | 3 | `LOCUS_SETUP\|z=x+iy\|p=(3,-1)\|q=(-1,2)` | complex_locus_generator.py |
...
| `LOG_EVAL` | 2 | `LOG_EVAL\|11/8\|ln(11/8)` | hyperbolic_distance_generator.py |
...
| `MATRIX_GROUP_SETUP` | 2 | `MATRIX_GROUP_SETUP\|SL2Z\|M=[[-7,-6],[-8,-7]]` | matrix_group_check_generator.py |
| `MATRIX_MULT` | 2, 3 | `MATRIX_MULT\|row1 dot col1\|992250000/992313001*992250000/992313001+7906500/992313001*7906500/992313001\|992250000/992313001` | projector_generator.py |
| `MATRIX_POWER` | 2 | `MATRIX_POWER\|K^2\|[[-1, 0, 0], [0, -1, 0], [0, 0, 0]]` | lie_exponential_generator.py |
| `MATRIX_PRODUCT` | 2 | `MATRIX_PRODUCT\|AB\|[[105i/2, 0], [0, -105i/2]]` | bch_generator.py, casimir_generator.py, gamma_matrix_generator.py, pauli_algebra_generator.py, structure_constant_generator.py |
| `MATRIX_ROW` | 2 | `MATRIX_ROW\|d\|1 0 0` | graph_counting_generator.py, relation_operations_generator.py |
| `MATRIX_SCALE` | 2 | `MATRIX_SCALE\|1/2 ladder sum\|[[4563/32, 0, 0, 0], [0, 10647/32, 0, 0], [0, 0, 10647/32, 0], [0, 0, 0, 4563/32]]` | bch_generator.py, casimir_generator.py |
| `MATRIX_SETUP` | 2 | `MATRIX_SETUP\|unitary\|U=[[208/233,-105/233],[105/233,208/233]]` | hermitian_check_generator.py |
...
| `MATRIX_VALUE` | 2 | `MATRIX_VALUE\|A\|[[0, -15i/2], [15i/2, 0]]` | pauli_algebra_generator.py, structure_constant_generator.py |
...
| `METRIC_ARC_SETUP` | 3 | `METRIC_ARC_SETUP\|polar metric\|ds^2=dr^2+r^2 dtheta^2\|r=21, theta:0->pi/3` | metric_arc_length_generator.py |
...
| `MOBIUS_SETUP` | 2 | `MOBIUS_SETUP\|T(z)=(z - 5)/(-4z + 2)\|z0=5` | mobius_transform_generator.py |
...
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 26\|exponent 12\|modulus 57` | mod_exp_generator.py |
...
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|145 mod 52\|33` | crt_generator.py, ecdsa_generator.py, elliptic_curve_finite_field_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|-19\|mod 52\|33` | modular_inverse_generator.py, rsa_generator.py |
| `MOD_POWER` | 3 | `MOD_POWER\|35^19\|mod 23\|8` | diffie_hellman_generator.py, pollard_factorization_generator.py, primality_test_generator.py, rsa_generator.py, tonelli_shanks_generator.py, totient_generator.py |
...
| `MR_SETUP` | 2 | `MR_SETUP\|n=69\|witnesses 10, 11` | primality_test_generator.py |
| `MR_SQUARE` | 2 | `MR_SQUARE\|r=1\|13` | primality_test_generator.py |
...
| `MU` | 2 | `MU\|-119/202\|round=-1` | lll_reduction_generator.py |
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(3x)y' + 3e^(3x)y\|8e^(4x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `MULTIVALUED_LOG` | 2 | `MULTIVALUED_LOG\|ln(1/2) + i*(-5pi/9 + 2pi*k)\|k in Z` | complex_log_generator.py |
...
| `NO_REDEX` | 2 | `NO_REDEX\|lambda n. (lambda z. (n z))\|no beta redex remains` | lambda_reduction_generator.py |
...
| `OUTER_PRODUCT` | 1 | `OUTER_PRODUCT\|rho=1/2(ket00bra00+e^(-i118π/67)ket00bra11+e^(i118π/67)ket11bra00+ket11bra11)` | partial_trace_generator.py |
...
| `PAULI_SETUP` | 3 | `PAULI_SETUP\|trace\|A=sigma_x\|B=4sigma_z` | pauli_algebra_generator.py |
...
| `PERM_RESULT` | 1 | `PERM_RESULT\|[4, 3, 1, 2, 5]` | permutation_group_generator.py |
...
| `POLE_TEST` | 3 | `POLE_TEST\|pole 2\|abs(2) < 7\|inside` | contour_integral_generator.py |
...
| `POLLARD_RHO_SETUP` | 3 | `POLLARD_RHO_SETUP\|n=341\|c=5\|x0=6` | pollard_factorization_generator.py |
...
| `POWER_REDUCE` | 2 | `POWER_REDUCE\|35^195\|35^19 mod 23` | totient_generator.py |
...
| `POWER_SETUP` | 2 | `POWER_SETUP\|(cos 267 deg + i sin 267 deg)^(5i)\|principal logarithm` | complex_log_generator.py |
...
| `PRINCIPAL_LOG` | 1 | `PRINCIPAL_LOG\|ln(1/2) - i*5pi/9` | complex_log_generator.py |
...
| `PROJECTOR_SETUP` | 2 | `PROJECTOR_SETUP\|v=(31500/31501, 251/31501)\|P=vv^T=[[992250000/992313001,7906500/992313001],[7906500/992313001,63001/992313001]]` | projector_generator.py |
...
| `QUADRATIC` | 3 | `QUADRATIC\|3\|3\|-6` | mobius_transform_generator.py |
| `QUANTUM_FORMULA` | 1 | `QUANTUM_FORMULA\|K_max=h*f-phi` | quantum_formula_generator.py |
| `QUANTUM_SETUP` | 2, 3 | `QUANTUM_SETUP\|gate=CNOT\|input=e^(i49π/221)·ket11` | quantum_formula_generator.py, quantum_gate_generator.py |
...
| `QUAT_INVERSE` | 2 | `QUAT_INVERSE\|p\|(-1/14,3/14,-1/7,0)` | quaternion_generator.py |
| `QUAT_MUL_START` | 3 | `QUAT_MUL_START\|p*q\|p\|q` | quaternion_generator.py |
| `QUAT_RESULT` | 2 | `QUAT_RESULT\|p*q\|(-2,-10,-2,-12)` | quaternion_generator.py |
| `QUAT_SETUP` | 2 | `QUAT_SETUP\|p=(-1,-3,2,0)\|q=(2,2,3,-1)` | quaternion_generator.py |
...
| `RECT_FORM` | 1 | `RECT_FORM\|-28i` | de_moivre_generator.py, euler_formula_generator.py |
...
| `RESIDUE_SETUP` | 2 | `RESIDUE_SETUP\|a=2\|f=(1 + (z-2) - 2(z-2)^3)/(z-2)^2` | residue_generator.py |
...
| `RESOLVE` | 3 | `RESOLVE\|C1\|C2\|P47676` | resolution_proof_generator.py |
...
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(P47676), C2=(not P47676 OR P73983), C3=(not P73983), C4=(P57382)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C2\|(P73983)` | resolution_proof_generator.py |
...
| `RHO_ITER` | 4 | `RHO_ITER\|1\|x=41, y=322\|abs(r)=281\|gcd=1` | pollard_factorization_generator.py |
...
| `ROTATED_VECTOR` | 1 | `ROTATED_VECTOR\|(-2,3,0)` | quaternion_generator.py |
...
| `RSA_DECRYPT` | 2 | `RSA_DECRYPT\|161\|134` | rsa_generator.py |
| `RSA_ENCRYPT` | 2 | `RSA_ENCRYPT\|134\|161` | rsa_generator.py |
| `RSA_PRIVATE_KEY` | 1 | `RSA_PRIVATE_KEY\|d=23` | rsa_generator.py |
| `RSA_PUBLIC_KEY` | 2 | `RSA_PUBLIC_KEY\|n=187\|e=7` | rsa_generator.py |
| `RSA_SETUP` | 3 | `RSA_SETUP\|p=11\|q=17\|message=134` | rsa_generator.py |
...
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|28*cos\|0` | de_moivre_generator.py, euler_formula_generator.py |
...
| `SHORTEST` | 2 | `SHORTEST\|(3,-10)\|norm^2=109` | lll_reduction_generator.py |
...
| `SIZE_REDUCE` | 2 | `SIZE_REDUCE\|b2=(12, -1)\|b2-(-1)b1=(3, 10)` | lll_reduction_generator.py |
...
| `SPHERICAL_EXCESS_SETUP` | 2 | `SPHERICAL_EXCESS_SETUP\|R=2\|angles=150,75,45` | spherical_excess_generator.py |
...
| `STEREO_SETUP` | 3, 4 | `STEREO_SETUP\|plane_to_sphere\|u=-1/5\|v=-5/3` | stereographic_generator.py |
...
| `STRUCTURE_CONSTANT` | 3 | `STRUCTURE_CONSTANT\|epsilon_yxz\|-1\|210iJz` | structure_constant_generator.py |
| `STRUCTURE_SETUP` | 3 | `STRUCTURE_SETUP\|A=15Jy\|B=-14Jx\|epsilon_yxz=-1` | structure_constant_generator.py |
...
| `SUBGROUP_ELEM` | 2 | `SUBGROUP_ELEM\|k=1\|21` | coset_generator.py, cyclic_group_generator.py |
...
| `SUBSTITUTE` | 2 | `SUBSTITUTE\|m:=(lambda p. (lambda n. (p n))) in (m m)\|((lambda p. (lambda n. (p n))) (lambda p. (lambda n. (p n))))` | lambda_reduction_generator.py |
...
| `SWAP` | 2 | `SWAP\|norm b2=109\|norm b1=202` | lll_reduction_generator.py |
...
| `TENSOR_SETUP` | 3 | `TENSOR_SETUP\|A=diag(3,-1)\|B=diag(-3,-2)\|u=[-3,-2], v=[-2,2]` | tensor_product_generator.py |
| `TENSOR_STATE` | 2 | `TENSOR_STATE\|u tensor v\|[6,-6,4,-4]` | tensor_product_generator.py |
...
| `YOUNG_SETUP` | 3 | `YOUNG_SETUP\|partition=[4,2,1,1,1,1,1,1]\|n=12\|group=S_12` | young_tableaux_generator.py |
