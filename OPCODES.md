...
| `DERIV_RULE` | 2 | `DERIV_RULE\|power rule\|d/dx of c·x^n = c·n·x^(n-1)` | derivative_power_rule_generator.py |
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = 3x^4 - 6x^2 + x\|f'(x)` | derivative_power_rule_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|- 4x^3 - 12x^2 + 20x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|64580 × 48264 ≈ 60000 × 50000\|3000000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3000000000\|3116889120\|3116889120 ≈ 3000000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|3 ÷ 3 = 1, not 3` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 108:84\|line 3 divides 28 by 7` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(38, 7)\|P(X > 52)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(5x^6 - 20x^6 + 15x^5 + 25x^3) / (5x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(5x^6) / (5x^3) + (-20x^6) / (5x^3) + (15x^5) / (5x^3) + (25x^3) / (5x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x - 1)(x^2 + 3x - 5)` | multiplying_polynomials_generator.py |
...
| `POWER_RULE` | 2 | `POWER_RULE\|3x^4\|12x^3` | derivative_power_rule_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(52 - 38)/7\|2.00` | normal_table_generator.py |
