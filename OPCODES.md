...
1640 distinct op-codes observed.
...
| `ABS` | 2 | `ABS\|3/4\|3/4` | fixed_point_generator.py, matrix_norm_generator.py, rv_transform_generator.py |
| `ABSORB_EQ` | 2 | `ABSORB_EQ\|u0=p0A+p00*u0+p01*u1\|u1=p1A+p10*u0+p11*u1` | markov_chain_generator.py |
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|5x + 3 = 15` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|2x + 6 ≥ 4 -> x ≥ -1` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|abs(2x + 6) ≥ 4` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|2x + 6 ≥ 4 or 2x + 6 ≤ -4` | absolute_value_inequality_generator.py |
...
| `ACT_SETUP` | 3 | `ACT_SETUP\|activation=sigmoid\|x=-3\|w1=-5,b1=-15,w2=1,b2=-6` | activation_generator.py |
| `ACT_VALUE` | 3 | `ACT_VALUE\|sigmoid\|0\|1/2` | activation_generator.py |
| `AC_COMPLEX` | 3 | `AC_COMPLEX\|Z\|5\|-7j` | ac_circuit_generator.py |
| `AC_FORMULA` | 1 | `AC_FORMULA\|Z=R+j(XL-XC)` | ac_circuit_generator.py |
| `AC_PRODUCT` | 2 | `AC_PRODUCT\|8 × (-5)\|-40` | factor_trinomial_generator.py |
| `AC_SETUP` | 3 | `AC_SETUP\|series_rlc\|R=5, XL=21\|XC=28, V=28` | ac_circuit_generator.py |
| `ADAM_SETUP` | 3 | `ADAM_SETUP\|theta=3/4,g=-5\|beta1=9/10,beta2=99/100\|lr=1/10,epsilon=0` | adam_step_generator.py |
| `ADAM_UPDATE` | 2 | `ADAM_UPDATE\|theta_new\|17/20` | adam_step_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 8/20, P(B) = 6/20, P(A ∪ B) = 10/20\|P(A ∩ B)` | probability_addition_rule_generator.py |
...
| `ALG_SETUP` | 3 | `ALG_SETUP\|binary search\|target 29\|values 11, 23, 29, 33, 36, 38, 43` | algorithm_trace_generator.py |
| `ALIGN_NUM` | 2 | `ALIGN_NUM\|046.36\|177.07` | number_comparison_generator.py |
| `ALPHA` | 2 | `ALPHA\|alpha1\|-9/8` | kernel_ridge_generator.py |
| `ALPHA_RENAME` | 2 | `ALPHA_RENAME\|lambda t. (t q)\|lambda z. (z q)` | lambda_reduction_generator.py |
| `AMORT_ROW` | 3 | `AMORT_ROW\|1\|interest=$12120.00\|principal=$4155.00,balance=$56445.00` | annuity_generator.py |
| `AMPLITUDE` | 2 | `AMPLITUDE\|abs(1)\|1` | sinusoid_features_generator.py |
| `ANALOGY_SETUP` | 3 | `ANALOGY_SETUP\|man=(-4,-1)\|woman=(-4,1)\|king=(-4,-4)` | embedding_similarity_generator.py |
...
| `ANGLE_DEFECT_SETUP` | 2 | `ANGLE_DEFECT_SETUP\|R=13\|angles=75,15,30` | angle_defect_generator.py |
...
| `ANGLE_WRAP` | 2 | `ANGLE_WRAP\|342 deg\|-18 deg` | complex_log_generator.py |
| `ANNUITY_FORMULA` | 1 | `ANNUITY_FORMULA\|PV = PMT/r` | annuity_generator.py |
| `ANNUITY_SETUP` | 2, 3 | `ANNUITY_SETUP\|perpetuity present value\|PMT=4310,r=8%` | annuity_generator.py |
...
| `APPLY_GATE` | 3 | `APPLY_GATE\|Z\|e^(i158π/297)·ket0\|e^(i158π/297)·ket0` | quantum_gate_generator.py |
| `APPLY_OPERATOR` | 2 | `APPLY_OPERATOR\|L[A]\|-16A = 64` | commutator_generator.py, undetermined_coeff_generator.py |
| `APPLY_PAULI` | 2 | `APPLY_PAULI\|sigma_z psi\|[-8/17,-15/17]` | spin_half_generator.py |
| `APPLY_SUBST` | 1 | *(not observed in sampling)* | unification_generator.py |
| `APPROX` | 2 | `APPROX\|12*d^2*L\|1720320000` | param_count_generator.py |
...
| `ARC_LENGTH` | 3 | `ARC_LENGTH\|int_0^T speed dt\|25*2\|50` | curve_geometry_generator.py |
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 57, central angle 8π/5 rad\|sector area` | arc_sector_generator.py |
| `AREA` | 1 | `AREA\|66` | geometry_area_perimeter_generator.py |
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|8*15^2/2\|900` | centroid_generator.py |
...
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 + 2x + 7 and y = -14x - 56\|area between the curves` | area_between_curves_generator.py |
...
| `ARITH_SETUP` | 2 | `ARITH_SETUP\|A=1/2, B=1/8, C=1/8, D=1/4\|message=BABCB` | arithmetic_coding_generator.py |
| `ARITH_SYMBOL` | 2 | `ARITH_SYMBOL\|B\|cum=[1/2,5/8)` | arithmetic_coding_generator.py |
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|20, 22, 27, 39, 16` | algorithm_trace_generator.py |
| `ASSIGN` | 2 | `ASSIGN\|P1\|C2` | kmeans_step_generator.py |
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = 5 ± (4/3)(x + 5)` | hyperbola_features_generator.py |
| `ATA` | 2 | `ATA\|A^T A\|[[3085, 2244], [2244, 3085]]` | svd_generator.py |
| `ATOM_CHECK` | 3 | `ATOM_CHECK\|N\|left=2\|right=2` | stoichiometry_generator.py |
| `ATTN_OUTPUT` | 2 | `ATTN_OUTPUT\|1\|[[0,5/3]]` | attention_generator.py |
...
| `AV_VECTOR` | 2 | `AV_VECTOR\|A*v1\|[73/√2, 73/√2]` | svd_generator.py |
...
| `BACKPROP_SETUP` | 3 | `BACKPROP_SETUP\|x=(1,2)\|y=-3\|eta=1/6` | backprop_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 80, disease=no 400\|sensitivity 9/10, specificity 19/20\|P(disease=yes given test positive)` | conditional_probability_generator.py |
| `BAYES_UPDATE_SETUP` | 2, 3 | `BAYES_UPDATE_SETUP\|normal_normal\|prior=Normal(-4,5)\|sigma^2=10` | bayesian_update_generator.py |
| `BCH_FORM` | 2 | `BCH_FORM\|A+B+1/2[A,B]\|[[0, 0, 0], [-3/2, 0, 1], [3, 0, 0]]` | bch_generator.py |
| `BCH_SETUP` | 3 | `BCH_SETUP\|A=3E31\|B=E23\|order=2` | bch_generator.py |
...
| `BETA` | 1 | `BETA\|(lambda p. p) applied to (g p)` | lambda_reduction_generator.py |
| `BEZOUT_CHECK` | 2 | `BEZOUT_CHECK\|174*-12 + 123*17\|3` | extended_euclid_generator.py |
| `BIAS_CORRECT` | 2 | `BIAS_CORRECT\|m_hat\|-5` | adam_step_generator.py |
| `BINARY_EXPONENT` | 2 | `BINARY_EXPONENT\|49\|110001` | mod_exp_generator.py, quadratic_residue_generator.py |
| `BINOM_FORMULA` | 1 | `BINOM_FORMULA\|P(X ≥ 1) = 1 - (1-p)^n` | binomial_probability_generator.py |
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 5, p = 2/3\|P(X ≥ 1)` | binomial_probability_generator.py |
| `BISECTION_SETUP` | 3 | `BISECTION_SETUP\|f(x)=x^2-171\|interval=[13, 14]\|iterations=4` | bisection_generator.py |
...
| `BLACKBODY_SETUP` | 3 | `BLACKBODY_SETUP\|stefan_power\|sigma=2, A=15\|T=8` | blackbody_generator.py |
| `BOND_FORMULA` | 1 | `BOND_FORMULA\|price=sum coupon/(1+y)^t + face/(1+y)^n` | bond_pricing_generator.py |
| `BOND_PRICE` | 1 | `BOND_PRICE\|$3300.00` | bond_pricing_generator.py |
| `BOND_SETUP` | 2 | `BOND_SETUP\|face=3300\|coupon=10%,ytm=10%,years=6` | bond_pricing_generator.py |
| `BOOL_SETUP` | 2 | `BOOL_SETUP\|variables S, T\|K-map simplify` | boolean_algebra_generator.py |
...
| `BOX_SETUP` | 1, 3 | `BOX_SETUP\|transition_wavelength\|n_low=5, n_high=11\|h=6, c=9` | particle_in_box_generator.py |
| `BRAKET_FORMULA` | 1 | `BRAKET_FORMULA\|inner(phi,psi)=sum conj(phi_k)*psi_k` | braket_generator.py |
| `BRAKET_SETUP` | 3 | `BRAKET_SETUP\|inner_product\|phi=[1+i,-1+i]\|psi=[0,-1]` | braket_generator.py |
| `BRANCH_TEST` | 2 | `BRANCH_TEST\|3 < -2\|no` | piecewise_evaluation_generator.py |
...
| `BSC_SETUP` | 3 | `BSC_SETUP\|p=3/100\|-log2(p)=5.059\|-log2(1-p)=0.044` | channel_capacity_generator.py |
...
| `CASHFLOW_PV` | 2 | `CASHFLOW_PV\|coupon_t1\|300` | bond_pricing_generator.py |
| `CASIMIR_FORCE_SETUP` | 2 | `CASIMIR_FORCE_SETUP\|F/A=-π^2*hbar*c/(240*d^4)\|hbar=9,c=7,d=5` | casimir_force_generator.py |
| `CASIMIR_SETUP` | 3 | `CASIMIR_SETUP\|spin=4\|hbar=56/11\|J^2=j(j+1)hbar^2` | casimir_generator.py |
...
| `CEIL` | 2 | `CEIL\|1859.3344\|1860` | confidence_interval_generator.py |
...
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(9000)/(900)\|10` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= 8*x\|0 <= x <= 15\|centroid` | centroid_generator.py |
| `CENTROID_UPDATE` | 2 | `CENTROID_UPDATE\|C1\|(3/2,1)` | kmeans_step_generator.py |
| `CF_PARTIAL` | 2 | `CF_PARTIAL\|a_0\|1` | continued_fraction_generator.py |
| `CF_RESULT` | 1 | `CF_RESULT\|[1; 3, 3, 4, 3]` | continued_fraction_generator.py |
| `CF_SETUP` | 1 | `CF_SETUP\|181/139` | continued_fraction_generator.py |
...
| `CHAIN_DERIV` | 2 | `CHAIN_DERIV\|dy/dx\|-5/4` | activation_generator.py |
| `CHAIN_RATE` | 2 | `CHAIN_RATE\|dx/dt\|-4` | multivar_chain_rule_generator.py |
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*dx/dt + f_y*dy/dt\|(-13)*(-4) + (-34)*(-4)\|188` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(3)\|(-4)*3 + 6\|-6` | multivar_chain_rule_generator.py |
| `CHANGE_BASE` | 1 | `CHANGE_BASE\|log_9(81) = log_3(81)/log_3(9)` | log_conversion_generator.py |
| `CHAR_DIAG` | 2 | `CHAR_DIAG\|diagonal of λI - A\|(λ + 4), λ, (λ + 2)` | eigenvalue_generator.py |
...
| `CHAR_POLY` | 2 | `CHAR_POLY\|p(λ) = λ^3 + 6λ^2 + 8λ\|(λ + 4)*(λ + 2)*λ` | diagonalization_generator.py, eigenvalue_generator.py, recurrence_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 42, 57, 54, 52, 58, 45, 42; expected: 50 each\|goodness of fit; df = 6, critical value = 12.592` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|42 - 50 = -8\|(-8)^2 = 64\|64/50 = 1.28` | chi_square_generator.py |
| `CHOLESKY_ENTRY` | 2 | `CHOLESKY_ENTRY\|l11\|5` | cholesky_generator.py |
| `CHOL_SETUP` | 2 | `CHOL_SETUP\|A = [[25, -15, -15], [-15, 34, 24], [-15, 24, 22]]\|A = L L^T` | cholesky_generator.py |
| `CHRISTOFFEL_FORMULA` | 1 | `CHRISTOFFEL_FORMULA\|Gamma^i_jk = 1/2 g^im(d_j g_mk + d_k g_mj - d_m g_jk)` | christoffel_generator.py |
| `CHRISTOFFEL_SETUP` | 3 | `CHRISTOFFEL_SETUP\|polar\|g_rr=1, g_thetatheta=r^2\|r=97` | christoffel_generator.py |
| `CHRISTOFFEL_VALUE` | 2 | `CHRISTOFFEL_VALUE\|Gamma^phi_thetatheta\|-12/25` | riemann_tensor_generator.py |
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|central angle 292° subtends an arc\|inscribed angle on the same arc` | circle_angle_generator.py |
| `CIRCLE_CALCULATE` | 2 | `CIRCLE_CALCULATE\|radius = diameter / 2 = 46 / 2\|23` | circle_generator.py |
| `CIRCLE_EQ` | 1 | `CIRCLE_EQ\|(x - 1)^2 + (y - 5)^2 = 25` | complex_locus_generator.py |
...
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(-8 - 0)*42\|-336` | vector_theorem_generator.py |
| `CI_FORMULA` | 1 | `CI_FORMULA\|x̄ ± E` | confidence_interval_generator.py |
| `CI_SETUP` | 2 | `CI_SETUP\|σ = 30, n = 25, z* = 2.576\|confidence interval for μ` | confidence_interval_generator.py |
| `CLAUSE` | 2 | `CLAUSE\|C1\|(not P43253)` | resolution_proof_generator.py |
...
| `CNF_FORM` | 1 | `CNF_FORM\|(NOT P OR NOT Q OR R) AND (NOT P OR NOT Q OR NOT R)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|-82560` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|1, -3, -3, -2, -3` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COEFF_MATCH` | 2 | `COEFF_MATCH\|x^n\|(n+1)a_(n+1) = -4a_n` | series_solution_generator.py |
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=2, j=4\|2+4=6\|28` | generating_function_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[-4, 2], [-3, 4]]` | determinant_generator.py |
| `COLLIDER_SETUP` | 3 | `COLLIDER_SETUP\|events_pb\|L=2 fb^-1\|sigma=1 pb` | cross_section_generator.py |
| `COLLISION_SETUP` | 3 | `COLLISION_SETUP\|elastic_1d\|m1=1, u1=8\|m2=4, u2=3` | collision_generator.py |
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2, 3\|[[5, 2, 17], [2, 1, 7], [2, 0, 7]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(6,1)\|6` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = 2*v1 - 3*v2\|[-4, -3]` | diagonalization_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|C(16, 7)\|n!/(r!·(n-r)!)` | counting_classics_generator.py, permutation_combination_generator.py, stars_and_bars_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|11 - 5\|6` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|894/(-447)\|-2` | geometric_sequence_generator.py, recursive_explicit_generator.py |
| `COMMUTATOR` | 2 | `COMMUTATOR\|[A,B]\|[[0, 45/2], [-45/2, 0]]` | structure_constant_generator.py |
...
| `COMM_RESULT` | 2 | `COMM_RESULT\|[x,p]f\|14i*x` | commutator_generator.py |
| `COMM_SETUP` | 3 | `COMM_SETUP\|[x,p]f\|f=x\|p=-i*hbar*D, hbar=14` | commutator_generator.py |
...
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|-3 < x + 1 < 4` | compound_inequality_generator.py |
...
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 9, no/bike 22, yes/bus 18, no/bus 18\|P(commute=bus given club=yes)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|club=yes total\|9 + 18 = 27` | conditional_probability_generator.py |
| `CONGRUENCE_REDUCE` | 2 | `CONGRUENCE_REDUCE\|39x congruent to 4\|mod 14` | modular_inverse_generator.py |
| `CONGRUENCE_SOLUTIONS` | 3 | `CONGRUENCE_SOLUTIONS\|base 8\|step 14\|8, 22, 36, 50` | modular_inverse_generator.py |
...
| `CONSERVATION_SETUP` | 2 | `CONSERVATION_SETUP\|n -> pi0 + p + e- + anti_nu_e + gamma\|check=Q,B,Le,Lmu` | conservation_law_generator.py |
| `CONSERVE_CHECK` | 3 | `CONSERVE_CHECK\|Q\|left=0,right=0\|conserved` | conservation_law_generator.py |
| `CONSTRAINT_SUBST` | 3 | `CONSTRAINT_SUBST\|5*x + 4*y = 348\|lambda*(25/2 + 16/8) = 348\|lambda = 24` | lagrange_multiplier_generator.py |
| `CONST_SOLVE` | 2 | `CONST_SOLVE\|C1 = -3\|C2 = 5` | recurrence_generator.py |
| `CONTOUR_SETUP` | 3 | `CONTOUR_SETUP\|abs(z)=6\|positive orientation\|f=4/(z-3) - 6/(z-7) + 3/(z+4)` | contour_integral_generator.py |
| `CONT_DIST_SETUP` | 3 | `CONT_DIST_SETUP\|f(x)=k*x\|support=[0,8]\|interval=(0,4)` | continuous_distribution_generator.py |
| `CONVERGENT` | 2 | `CONVERGENT\|i=0\|1/1` | continued_fraction_generator.py |
| `CONVERGE_CHECK` | 2 | `CONVERGE_CHECK\|abs(r) = 7/9 < 1\|converges` | geometric_sequence_generator.py, series_convergence_generator.py |
...
| `CONV_SETUP` | 2, 3 | `CONV_SETUP\|x=[0,8,9]\|h=[8,1,5,4]` | convolution_generator.py, convolutional_code_viterbi_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[2, -3]` | diagonalization_generator.py |
...
| `COUNT_SETUP` | 1, 2 | `COUNT_SETUP\|34 boxes\|force 20 in one box` | counting_classics_generator.py |
| `COUPON` | 1 | `COUPON\|330` | bond_pricing_generator.py |
| `COV_ENTRY` | 2 | `COV_ENTRY\|xx\|9/2` | pca_generator.py |
| `COV_FORMULA` | 1 | `COV_FORMULA\|Cov=E[XY]-E[X]E[Y]` | joint_distribution_generator.py |
| `CRC_CHECK` | 3 | `CRC_CHECK\|codeword=111000010\|remainder=0000\|valid` | crc_generator.py |
| `CRC_REMAINDER` | 1 | `CRC_REMAINDER\|0010` | crc_generator.py |
| `CRC_SETUP` | 3 | `CRC_SETUP\|data=11100\|poly=10011\|augmented=111000000` | crc_generator.py |
| `CRC_SKIP` | 2 | `CRC_SKIP\|i=4\|leading bit 0` | crc_generator.py |
| `CRC_XOR` | 3 | `CRC_XOR\|i=0\|11100 xor 10011\|01111` | crc_generator.py |
| `CRIT_EQS` | 2 | `CRIT_EQS\|f_x = 0\|-6*x + y - 24 = 0` | hessian_classify_generator.py |
| `CRIT_SOLVE` | 3 | `CRIT_SOLVE\|det\|(-6)*2 - 1^2\|-13` | hessian_classify_generator.py |
| `CROSS_ENTROPY` | 2 | `CROSS_ENTROPY\|target=3\|ln(2)` | perplexity_generator.py, softmax_gradient_generator.py |
| `CROSS_MULT` | 1 | `CROSS_MULT\|56·BC = 28·40` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CROSS_RATIO` | 1 | `CROSS_RATIO\|10` | mobius_transform_generator.py |
| `CROSS_RATIO_SETUP` | 4 | `CROSS_RATIO_SETUP\|z1=-1\|z2=2\|z3=4\|z4=-2` | mobius_transform_generator.py |
...
| `CR_SETUP` | 2 | `CR_SETUP\|u=-2x^2 + 2y^2 + 4x - 3y\|v=-4xy + 3x + 4y` | cauchy_riemann_generator.py |
| `CUM_INTERVAL` | 2 | `CUM_INTERVAL\|A\|[0,1/2)` | arithmetic_coding_generator.py |
| `CURL_COMPONENT` | 3 | `CURL_COMPONENT\|i\|3 + 3\|6` | div_curl_generator.py |
...
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 6x^2 + 9x\|inflection point and concavity` | curve_analysis_generator.py |
| `CX_A` | 3 | `CX_A\|-8/17\|0\|-8/17` | braket_generator.py, spin_half_generator.py |
| `CX_M` | 3 | `CX_M\|1\|-8/17\|-8/17` | braket_generator.py, spin_half_generator.py |
| `CX_SETUP` | 2 | `CX_SETUP\|i^5\|simplify` | complex_division_generator.py, complex_number_ops_generator.py |
| `CYCLE` | 1 | `CYCLE\|(1 3 4)` | permutation_group_generator.py |
...
| `CYCLE_TRACE` | 2 | `CYCLE_TRACE\|start 1\|1->3->4->1` | permutation_group_generator.py |
...
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|A Y\|{S}\|cell 3,4` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|A\|b or d or e` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string bbbe\|length 4` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{A,C} x {A,C}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|b\|{A,C}` | cyk_parser_generator.py |
...
| `DECISION` | 2 | `DECISION\|f(x)\|90` | kernel_perceptron_generator.py, svm_margin_generator.py |
...
| `DEGREE_SEQUENCE` | 1 | `DEGREE_SEQUENCE\|4, 3, 2, 2, 2, 1` | graph_counting_generator.py |
| `DELTA_VALUE` | 2 | `DELTA_VALUE\|delta_23\|0` | index_gymnastics_generator.py |
| `DEMOIVRE_POWER` | 1 | `DEMOIVRE_POWER\|243 cis(180 deg)` | de_moivre_generator.py |
| `DEMOIVRE_SETUP` | 2, 4 | `DEMOIVRE_SETUP\|arbitrary_roots\|R=16\|theta=90 deg\|n=2` | de_moivre_generator.py |
| `DENSITY` | 2 | `DENSITY\|f_X(x)\|1/15` | rv_transform_generator.py |
| `DENSITY_MATRIX` | 1 | `DENSITY_MATRIX\|rho=[[2/17,0],[0,15/17]]` | density_matrix_generator.py |
| `DENSITY_SETUP` | 2, 3 | `DENSITY_SETUP\|state=Schmidt\|psi=(sqrt(161)ket00 - sqrt(37)ket11)/sqrt(198)` | density_matrix_generator.py, partial_trace_generator.py |
...
| `DERIV` | 2, 3 | `DERIV\|d_r g_thetatheta = 2r\|at r=97\|194` | christoffel_generator.py, gaussian_curvature_generator.py, riemann_tensor_generator.py |
| `DERIVATIVE` | 1, 2 | `DERIVATIVE\|g'(x)\|3/4` | fixed_point_generator.py, mgf_generator.py, mle_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = x^5 + 4x^3 - 5x + 2\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -3], [1, -1], [1, 1], [1, 3]]\|y = [14, 8, 4, 2]` | least_squares_generator.py |
| `DET` | 2 | `DET\|K\|23` | kernel_ridge_generator.py, kernel_validity_generator.py |
...
| `DEV_ROW` | 3 | `DEV_ROW\|13\|3\|9` | standard_deviation_generator.py |
| `DFA_ACCEPT` | 1 | `DFA_ACCEPT\|q0` | dfa_minimization_generator.py, dfa_simulation_generator.py |
| `DFA_INPUT` | 1 | `DFA_INPUT\|0101101` | dfa_simulation_generator.py |
...
| `DFT_SETUP` | 2 | `DFT_SETUP\|N=2\|x=[-4,-5]` | dft_generator.py |
| `DH_PUBLIC` | 2 | `DH_PUBLIC\|Alice\|34` | diffie_hellman_generator.py |
...
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[2, 3], [-3, -4]]\|D = [[-7, 0], [0, -4]]\|P^-1 = [[-4, -3], [3, 2]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[2, 2, 2]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 5*x^2 + y^2 + x*y + 2*x + 6*y\|point (0, 0)\|dx=1/2, dy=-1/2` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|2*1/2 + 6*(-1/2)\|-2` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|32400\|-50544\|82944` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-7y + 51 = -12` | systems_substitution_generator.py |
...
| `DIST_SETUP` | 3 | `DIST_SETUP\|normal\|mu=-4,sigma=6\|x=-10` | named_distribution_generator.py |
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited D\|A=7, B=7, C=5, D=0` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|4x^3 - 4x^2 - 4x` | multiplying_polynomials_generator.py |
...
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y + R_z\|2 - 4 - 3\|-5` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|14x^2\|2x\|7x` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT B AND NOT C AND D AND NOT E) OR (NOT B AND C AND NOT D AND NOT E) OR (B AND NOT C AND D AND E)` | boolean_algebra_generator.py |
| `DOMAIN` | 2 | `DOMAIN\|x = −45..−35\|{−45, −44, −43, −42, −41, −40, −39, −38, −37, −36, −35}` | set_builder_roster_generator.py |
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|radicand ≥ 0\|x + 4 ≥ 0` | domain_range_generator.py |
...
| `DOPPLER_SETUP` | 3 | `DOPPLER_SETUP\|relativistic_approach\|f=936\|beta=3/5` | doppler_generator.py |
| `DOT` | 2, 3 | `DOT\|(-2, -5) · (1, 0)\|(-2)*1 + (-5)*0\|-2` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
| `DOT4` | 4 | `DOT4\|gamma3gamma1\|(4,1)\|1*0 + 0*-1 + 0*0 + 0*0\|0` | gamma_matrix_generator.py |
| `DOT_FORMULA` | 1 | `DOT_FORMULA\|u·v = x1·x2 + y1·y2` | dot_product_generator.py |
| `DOUBLE_SETUP` | 2, 3 | `DOUBLE_SETUP\|integrand 2*x + 6*y + 2\|x:2..6\|y:1..4` | double_integral_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=5,v=9); 2:(w=1,v=3); 3:(w=5,v=8)` | dp_table_generator.py |
...
| `D_POWER` | 2 | `D_POWER\|D^2\|[[16, 0], [0, 1]]` | diagonalization_generator.py |
...
| `ECDSA_SETUP` | 4 | `ECDSA_SETUP\|E/F_17, G=(5,1), n=19\|d=8\|z=5\|k=5` | ecdsa_generator.py |
| `ECDSA_SIGN` | 2 | `ECDSA_SIGN\|s=k^-1(z+rd) mod n\|s=4` | ecdsa_generator.py |
| `ECDSA_VERIFY` | 2 | `ECDSA_VERIFY\|u1=6\|u2=7` | ecdsa_generator.py |
...
| `EC_X3` | 2 | `EC_X3\|P+Q\|10` | elliptic_curve_finite_field_generator.py |
| `EC_Y3` | 2 | `EC_Y3\|P+Q\|2` | elliptic_curve_finite_field_generator.py |
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|BD\|weight 12\|add B` | mst_generator.py |
...
| `EDGE_LIST` | 1 | `EDGE_LIST\|AD, BC, CD` | euler_circuit_generator.py |
...
| `EIGENVALUES` | 2 | `EIGENVALUES\|A^T A\|4,1` | low_rank_approx_generator.py, matrix_norm_generator.py, pca_generator.py |
...
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 4I\|[[0, -4, 2], [0, 4, -4], [0, 0, 2]]` | eigenvalue_generator.py |
| `EINSTEIN_SETUP` | 2, 3 | `EINSTEIN_SETUP\|trace\|T_ij=[[0, 2, 4], [6, 3, 1], [3, -6, 3]]` | einstein_summation_generator.py |
| `ELEC_FORMULA` | 1 | `ELEC_FORMULA\|V=sum(q_i/r_i)` | electrostatics_generator.py |
| `ELEC_SETUP` | 2, 3 | `ELEC_SETUP\|potential_axis\|q1=-3, r1=12\|q2=-9, r2=8` | electrostatics_generator.py |
...
| `EL_SOLVE` | 2 | `EL_SOLVE\|xddot\|-(7/4)*x` | lagrangian_generator.py |
| `EMBED_SETUP` | 1 | `EMBED_SETUP\|A=(5,12), B=(4,3), C=(8,15)` | embedding_similarity_generator.py |
| `ENERGY_FORMULA` | 1 | `ENERGY_FORMULA\|mgh=1/2*m*v^2` | energy_conservation_generator.py |
| `ENERGY_LEVEL` | 2 | `ENERGY_LEVEL\|E_28=hbar*omega*(n+1/2)\|1140` | ladder_operator_generator.py |
| `ENERGY_SETUP` | 3 | `ENERGY_SETUP\|gravity_drop\|m=5\|h=20, g=10` | energy_conservation_generator.py |
...
| `ENGINE_SETUP` | 3 | `ENGINE_SETUP\|engine_efficiency\|Qh=73\|Qc=10` | heat_engine_generator.py |
...
| `ENTROPY_SETUP` | 2, 3 | `ENTROPY_SETUP\|eigenvalues=[1/8,1/128,1/2,1/128,1/16,1/32,1/16,1/8,1/32,1/32,1/64]\|S=-sum lambda log2(lambda)` | entropy_change_generator.py, entropy_generator.py, huffman_coding_generator.py, information_gain_generator.py, mutual_information_generator.py, von_neumann_entropy_generator.py |
...
| `EPS_CLOSURE` | 2 | `EPS_CLOSURE\|{t2}\|{t2,t4,t7}` | nfa_simulation_generator.py |
| `EQUATE_EXP` | 1 | `EQUATE_EXP\|x + 4 = 3` | exponential_equation_generator.py |
| `EQUILIBRIA` | 2 | `EQUILIBRIA\|f(y) = 0\|y=0, y=3, y=10` | stability_generator.py |
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(4, -10)\|(5, -14)` | equation_from_two_points_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|59443 × 6783 ≈ 60000 × 7000\|420000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1 × 10^4\|10080\|rounded estimate` | fermi_estimation_generator.py, long_division_generator.py, multi_digit_multiplication_generator.py |
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|174\|123\|1\|51` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|B\|route suffix B\|stack A-D-C` | euler_circuit_generator.py |
| `EULER_CRITERION` | 2 | `EULER_CRITERION\|55^8 mod 17\|1` | quadratic_residue_generator.py |
...
| `EULER_ROUTE` | 2 | `EULER_ROUTE\|A-D-C-B\|uses 3 edges` | euler_circuit_generator.py |
...
| `EXP_ENTRY` | 3 | `EXP_ENTRY\|(1,1)\|6*e^(2t) - 5*e^(3t)\|6*e^(2t) - 5*e^(3t)` | matrix_exponential_generator.py |
...
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|174\|123` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `FACTOR` | 1, 2 | `FACTOR\|x^2 + 2x - 8\|(x + 4)(x - 2)` | polynomial_inequality_generator.py, second_order_ode_generator.py, transfer_function_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `FACTOR_FORM` | 2 | `FACTOR_FORM\|21\|3 * 7` | totient_generator.py |
| `FACTOR_FOUND` | 2 | `FACTOR_FOUND\|3\|1` | totient_generator.py |
| `FACTOR_GROUP` | 3 | `FACTOR_GROUP\|8n^2 - 4n\|4n\|(2n - 1)` | conic_standard_form_generator.py, curve_analysis_generator.py, derivative_limit_def_generator.py, factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `FEATURE_MAP_SETUP` | 3 | `FEATURE_MAP_SETUP\|K(x,z)=(xz+2)^2\|phi(t)=(t^2,2t,2)\|x=-16,z=-9` | feature_map_generator.py |
...
| `FERMAT_SETUP` | 3 | `FERMAT_SETUP\|prime 7\|base 3\|exponent 122` | totient_generator.py |
...
| `FINITE_DIFF_SETUP` | 3 | `FINITE_DIFF_SETUP\|forward_derivative\|x0=-2,h=4\|f0=-4,f1=-8` | finite_difference_generator.py |
...
| `FIRSTLAW_SETUP` | 3 | `FIRSTLAW_SETUP\|isothermal\|W=47\|ideal gas` | first_law_generator.py |
| `FIXED_EQ` | 1 | `FIXED_EQ\|z=(az+b)/(cz+d)` | mobius_transform_generator.py |
| `FIXED_POINT` | 1 | `FIXED_POINT\|2` | mobius_transform_generator.py |
| `FIXED_POINT_SETUP` | 3 | `FIXED_POINT_SETUP\|g(x)=3/4*x-1/2\|x0=1/4\|iterations=3` | fixed_point_generator.py |
| `FIXED_POINT_UPDATE` | 3 | `FIXED_POINT_UPDATE\|1\|x_0=1/4\|x_1=-5/16` | fixed_point_generator.py |
| `FLAG` | 2 | `FLAG\|3\|72 ÷ 9 = 8, not 7` | error_spotting_generator.py |
...
| `FLUX_SUM` | 2 | `FLUX_SUM\|(2 - 2 + 2)*216\|432` | vector_theorem_generator.py |
...
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-6i) * (-1)\|6i` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
| `FOIL_L` | 2 | `FOIL_L\|Last: (-6i) * 3i\|-18i^2` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(4 + √13)(3 + √13)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FOURIER_SETUP` | 3 | `FOURIER_SETUP\|square\|A=12\|n=4` | fourier_series_generator.py |
| `FOUR_VECTOR_SETUP` | 3 | `FOUR_VECTOR_SETUP\|signature=+---\|p=[-7,5,6,-2]\|q=[-6,1,-5,-7]` | four_vector_generator.py |
| `FRACTAL_SETUP` | 4 | `FRACTAL_SETUP\|mandelbrot\|z0=(0,0)\|c=(-3/2,-1/2)\|N=6` | fractal_iteration_generator.py |
| `FRAC_BUILD` | 2 | `FRAC_BUILD\|144/360\|0.4` | conditional_probability_generator.py, geometric_probability_generator.py |
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|19/-5\|-19/5` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|43/40\|1.075` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Red: 6, Blue: 8, Green: 10, Yellow: 12\|most frequent category` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(p/q)(2)\|p(2)/q(2)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|h(x) = -5x^2 - 2x - 6\|h(-8)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
| `FUNDAMENTAL_FORM_SETUP` | 3 | `FUNDAMENTAL_FORM_SETUP\|sphere\|R=8\|theta in [0,pi/6], phi in [60,180]` | fundamental_form_generator.py |
| `GAME_SETUP` | 2 | `GAME_SETUP\|payoffs=(7,4;0,17)\|row player maximizes, column player minimizes` | game_theory_generator.py |
| `GAMMA_SETUP` | 3 | `GAMMA_SETUP\|anticommutator_entry\|gamma3,gamma1\|entry=(4,1)` | gamma_matrix_generator.py |
| `GAS_FORMULA` | 1 | `GAS_FORMULA\|PV=nRT so n=PV/T` | gas_law_generator.py, gas_stoichiometry_generator.py |
| `GAS_SETUP` | 3 | `GAS_SETUP\|ideal_moles\|P=19, V=27\|T=25, R=1` | gas_law_generator.py |
...
| `GAUSSIAN_CURVATURE_SETUP` | 2, 3 | `GAUSSIAN_CURVATURE_SETUP\|sphere\|R=66` | gaussian_curvature_generator.py |
| `GAUSS_BONNET_SETUP` | 3 | `GAUSS_BONNET_SETUP\|flat_torus\|width=19, height=15\|chi=0` | gauss_bonnet_generator.py |
| `GAUSS_FORMULA` | 1 | `GAUSS_FORMULA\|2*E*A=sigma*A` | gauss_law_generator.py |
| `GAUSS_SETUP` | 3 | `GAUSS_SETUP\|sheet_charge\|sigma=80\|A=16` | gauss_law_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|14, 6\|2` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GD_SETUP` | 3 | `GD_SETUP\|f(x,y)=1/2*(3x^2+6y^2)\|start=(8,-8)\|eta=1/10` | gradient_descent_generator.py |
| `GD_UPDATE` | 3 | `GD_UPDATE\|w_old=(0,1)\|eta=1/5\|w_new=(4/5,1)` | gradient_step_generator.py |
| `GELLMANN_IDENTITY` | 3 | `GELLMANN_IDENTITY\|Tr(lambda_5 lambda_6)\|2 delta_ab\|0` | pauli_algebra_generator.py |
| `GELLMANN_SETUP` | 3 | `GELLMANN_SETUP\|trace\|A=3lambda_5\|B=3lambda_6` | pauli_algebra_generator.py |
...
| `GEOM_SETUP` | 2 | `GEOM_SETUP\|p = 1/2, q = 1/2\|P(X > 7)` | geometric_distribution_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; leg = 85 with projection p = 25 on the hypotenuse\|the hypotenuse c` | geometric_mean_generator.py |
| `GF2_XOR` | 3 | `GF2_XOR\|quotient x\|0 xor 1\|1` | finite_field_generator.py |
| `GF_DIV_CHECK` | 3 | `GF_DIV_CHECK\|27 / 4\|not integer\|reject` | generating_function_generator.py |
| `GF_EXPAND` | 2 | `GF_EXPAND\|(1 + x)^8\|sum C(a,i)x^i` | generating_function_generator.py |
| `GF_SETUP` | 2 | `GF_SETUP\|[x^6]\|(1 + x)^8(1 + x)^4` | generating_function_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = 5*x^2 + 3*y^2 + x*y + 2*x + 2*y\|point (0, 4)\|tangent` | gradient_generator.py |
...
| `GRAPH_SETUP` | 2 | `GRAPH_SETUP\|vertices A, B, C, D, E, F\|edges AB, BC, BE, BF, CF, DE, DF` | dijkstra_generator.py, euler_circuit_generator.py, graph_counting_generator.py, graph_traversal_generator.py |
| `GRASSMANN_RESULT` | 3 | `GRASSMANN_RESULT\|constant=20\|theta=55\|20 + 55theta` | grassmann_generator.py |
| `GRASSMANN_SETUP` | 3 | `GRASSMANN_SETUP\|multiply\|x=-4 - 7theta\|y=-5 - 5theta` | grassmann_generator.py |
| `GREAT_CIRCLE_SETUP` | 3 | `GREAT_CIRCLE_SETUP\|R=9\|A=(0,60)\|B=(0,150)` | great_circle_generator.py |
| `GROUP` | 2 | `GROUP\|(8n^2 - 4n)\|(10n - 5)` | factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `GS_SETUP` | 2 | `GS_SETUP\|vectors [[-1, 0, -1], [-1, 0, -5], [-8, 1, 4]]\|orthogonal basis, not normalized` | gram_schmidt_generator.py |
...
| `HAMMING_RECEIVED` | 1 | `HAMMING_RECEIVED\|r=1110110` | hamming_code_generator.py |
| `HAMMING_SETUP` | 2 | `HAMMING_SETUP\|data=0101\|even parity` | hamming_code_generator.py |
| `HAM_EQ` | 2 | `HAM_EQ\|thetadot=dH/dp_theta\|thetadot=p_theta/75` | hamiltonian_generator.py |
| `HAM_SETUP` | 3 | `HAM_SETUP\|pendulum\|m=3, L=5\|g=10, q=theta` | hamiltonian_generator.py |
| `HARMONIC_SETUP` | 1 | `HARMONIC_SETUP\|u=-x^2 + y^2 - 4x + 4y` | cauchy_riemann_generator.py |
| `HAWKING_SETUP` | 3 | `HAWKING_SETUP\|temperature\|T_H=hbar*c^3/(8π*G*M*k_B)\|hbar=11,c=4,G=7,M=15,k_B=5` | hawking_generator.py |
| `HESSIAN_DET` | 3 | `HESSIAN_DET\|D = f_xx*f_yy - f_xy^2\|(-6)*2 - 1^2\|-13` | hessian_classify_generator.py |
| `HESSIAN_SETUP` | 2 | `HESSIAN_SETUP\|f(x,y) = -3*x^2 + y^2 + x*y - 24*x + 4*y\|find and classify the critical point` | hessian_classify_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-x^4 + 4x^3 + 4x^2 - x + 4\|x = 4` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: p = 0.5; Ha: p ≠ 0.5\|n = 400, 176 successes, critical value = 2.576` | hypothesis_test_generator.py, two_sample_test_generator.py |
| `HUFFMAN_FORMULA` | 1 | `HUFFMAN_FORMULA\|L=sum p_i*l_i` | huffman_coding_generator.py |
| `HUFFMAN_MERGE` | 2 | `HUFFMAN_MERGE\|A:1/32 + B:1/32\|AB:1/16` | huffman_coding_generator.py |
| `HUFFMAN_SETUP` | 1 | `HUFFMAN_SETUP\|A=1/32, B=1/32, C=1/16, D=1/4, E=1/16, F=1/16, G=1/2` | huffman_coding_generator.py |
| `HYDROGEN_FORMULA` | 1 | `HYDROGEN_FORMULA\|Delta_E=R_E*(1/n_low^2-1/n_high^2)` | hydrogen_atom_generator.py |
| `HYDROGEN_SETUP` | 3 | `HYDROGEN_SETUP\|transition_energy\|n_low=3, n_high=6\|R_E=18 eV` | hydrogen_atom_generator.py |
| `HYPERBOLIC_DISTANCE_SETUP` | 3 | `HYPERBOLIC_DISTANCE_SETUP\|half-plane\|P=(-1,20)\|Q=(-1,460/17)` | hyperbolic_distance_generator.py |
| `HYPERBOLIC_SETUP` | 2 | `HYPERBOLIC_SETUP\|e^x=8\|e^(-x)=1/8` | hyperbolic_function_generator.py |
| `HYPERCUBE_FORMULA` | 1 | `HYPERCUBE_FORMULA\|k-faces of the n-cube: C(n,k) · 2^(n-k)` | hypercube_counting_generator.py |
| `HYPERCUBE_SETUP` | 2 | `HYPERCUBE_SETUP\|points P(3, 0, -1, 5) and Q(-4, 4, -4, 2) in R^4\|distance` | hypercube_counting_generator.py |
| `I` | 2 | `I\|7/2\|2/7` | fraction_op_generator.py, mixed_number_operation_generator.py, rational_expr_mult_div_generator.py |
| `ICE_ROW` | 2 | `ICE_ROW\|equilibrium\|[A]=7, [B]=10` | equilibrium_ice_generator.py |
| `IDENTIFY` | 2 | `IDENTIFY\|order matters\|use P(n, r)` | permutation_combination_generator.py |
| `IDENTITY` | 2 | `IDENTITY\|hockey-stick\|Σ i=9..78 C(i,9) = C(79,10)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
| `IDENTITY_SETUP` | 2 | `IDENTITY_SETUP\|verify: sin^2 t = (1 - cos t)(1 + cos t)\|transform the right side` | trig_identity_verify_generator.py |
| `IDENT_MATCH` | 1 | `IDENT_MATCH\|sin^2 t = sin^2 t` | trig_identity_verify_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=20, n(B)=28, n(C)=18\|n(AB)=6, n(AC)=5, n(BC)=9, n(ABC)=2` | inclusion_exclusion_generator.py |
| `IFACTOR` | 2 | `IFACTOR\|mu = e^(∫ 5 dx)\|e^(5x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `IG_SETUP` | 3 | `IG_SETUP\|parent pos=4, neg=12\|total=16\|splits=texture,size` | information_gain_generator.py |
| `IMAGE` | 2 | `IMAGE\|T(-3)\|1/2` | mobius_transform_generator.py |
...
| `IMPLICIT_SETUP` | 2 | `IMPLICIT_SETUP\|xy = 9\|dy/dx` | implicit_diff_generator.py |
...
| `INDEP_CHECK` | 3 | `INDEP_CHECK\|P11=275/1083\|product=121/361\|no` | joint_distribution_generator.py |
...
| `INDEX_SETUP` | 3 | `INDEX_SETUP\|c=2\|j=2, k=3\|l=3, m=2` | index_gymnastics_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|1\|-7 ≤ 1x ≤ 5` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `INFO_GAIN` | 2 | `INFO_GAIN\|texture\|0.062125` | information_gain_generator.py |
| `INFO_SETUP` | 2 | `INFO_SETUP\|p=1/16\|I=-log2(p)` | entropy_generator.py |
| `INFO_TABLE` | 1 | `INFO_TABLE\|1/8=3, 1/4=2, 3/8=1.415, 5/8=0.678, 3/4=0.415, 7/8=0.193` | information_gain_generator.py |
| `INFO_VALUE` | 2 | `INFO_VALUE\|p=1/4\|I=2` | information_gain_generator.py |
| `INITIAL` | 2 | `INITIAL\|D_0 = 1\|D_1 = 0` | derangement_generator.py |
| `INITIAL_COEFF` | 2 | `INITIAL_COEFF\|a_0\|20640` | series_solution_generator.py |
| `INITIAL_EQ` | 2 | `INITIAL_EQ\|C1 + C2\|2` | recurrence_generator.py |
| `INITIAL_SYSTEM` | 2 | `INITIAL_SYSTEM\|C1[2, 1] + C2[1, 1]\|[5, 3]` | ode_system_generator.py |
| `INNER_ANTIDERIV` | 2 | `INNER_ANTIDERIV\|dy\|2*x*y + 3*y^2 + 2*y` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_EVAL` | 2, 3 | `INNER_EVAL\|y=1..4\|6*x + 51` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_PRODUCT` | 2 | `INNER_PRODUCT\|inner(phi,psi)\|1+i` | braket_generator.py |
| `INNER_PRODUCT_SETUP` | 3 | `INNER_PRODUCT_SETUP\|interval=[0,2pi]\|f=cos(21x)\|g=cos(43x)` | function_inner_product_generator.py |
| `INSERT_KEY` | 3 | `INSERT_KEY\|pass 1\|22\|index 1` | algorithm_trace_generator.py |
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 1\|20, 22, 27, 39, 16` | algorithm_trace_generator.py |
| `INTEGRAL` | 1, 2 | `INTEGRAL\|integral cos(22x) on [0,2pi]\|0` | fourier_series_generator.py, function_inner_product_generator.py, legendre_construction_generator.py |
| `INTEGRAL_SETUP` | 1 | `INTEGRAL_SETUP\|L = integral from 0 to 2pi/3 of 26 dtheta` | metric_arc_length_generator.py |
| `INTEGRATE` | 2 | `INTEGRATE\|v_y = u_x\|v=-2xy - 4x - 4y + phi(x)` | cauchy_riemann_generator.py |
...
| `INTEG_SETUP` | 2 | `INTEG_SETUP\|∫ (-8x + 2) dx\|antiderivative` | antiderivative_generator.py, arc_length_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, u_substitution_generator.py |
...
| `INTERFERENCE_SETUP` | 3 | `INTERFERENCE_SETUP\|double_slit\|m=4, lambda=13\|L=7, d=3` | interference_generator.py |
| `INTERP_SETUP` | 3 | `INTERP_SETUP\|lagrange\|points=(-3,-19), (-2,-9), (1,-3)\|x=-6` | interpolation_generator.py |
| `INTERVAL_CLASS` | 2 | `INTERVAL_CLASS\|s2=-576\|spacelike` | minkowski_interval_generator.py |
...
| `IRR_SETUP` | 2 | `IRR_SETUP\|c0=-2000,c1=4000\|r0=1/10,iterations=2` | npv_irr_generator.py |
| `IRR_VALUE` | 2 | `IRR_VALUE\|f1\|18000/11` | npv_irr_generator.py |
| `ITERATE` | 2 | `ITERATE\|n=1\|z=(-3/2,-1/2)` | fractal_iteration_generator.py, gradient_descent_generator.py |
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 - x + 6 on [2, 6]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `JACOBI_SETUP` | 3 | `JACOBI_SETUP\|a=207\|n=91\|n odd` | jacobi_symbol_generator.py |
| `JACOBI_SWAP` | 3 | `JACOBI_SWAP\|a=91\|n=25\|sign 1` | jacobi_symbol_generator.py |
| `JACOBI_TWO_RULE` | 3 | `JACOBI_TWO_RULE\|n mod 8 = 1\|keep sign\|sign 1` | jacobi_symbol_generator.py |
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|2*(-4) - 1*3\|-11` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[2, 1], [3, -4]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = 2*u + v\|y = 3*u - 4*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
| `JOINT_SETUP` | 3 | `JOINT_SETUP\|X,Y in {0,1}\|p00=104/1083, p01=352/1083\|p10=352/1083, p11=275/1083` | joint_distribution_generator.py |
...
| `KERNEL_SETUP` | 3 | `KERNEL_SETUP\|type=rbf\|points=A=(3,-3), B=(-3,-3), C=(-3,1)\|gamma=1` | kernel_evaluation_generator.py |
...
| `KL_SETUP` | 3 | `KL_SETUP\|P=[28/31,3/31]\|Q=[7/31,24/31]\|direction=P to Q` | kl_divergence_generator.py |
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|10, 11\|S` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|S=0\|1, 0` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows S=0,S=1\|columns T=0,T=1` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|S OR NOT T` | boolean_algebra_generator.py |
| `KMEANS_SETUP` | 2 | `KMEANS_SETUP\|points=P1=(-3,2), P2=(0,0), P3=(-5,-4), P4=(3,2)\|centroids=C1=(3,0), C2=(-3,-2)` | kmeans_step_generator.py |
| `KNN_DISTANCE` | 3 | `KNN_DISTANCE\|P1\|label=B\|d2=13` | knn_generator.py |
| `KNN_NEIGHBORS` | 1 | `KNN_NEIGHBORS\|P1:13:B,P4:25:B,P5:64:B` | knn_generator.py |
| `KNN_SETUP` | 3 | `KNN_SETUP\|q=(4,5)\|k=3\|training=P1=(1,3,B), P2=(-3,1,A), P3=(-2,-2,B), P4=(0,2,B), P5=(4,-3,B)` | knn_generator.py |
| `KNN_SORT` | 1 | `KNN_SORT\|P1:13:B,P4:25:B,P5:64:B,P2:65:A,P3:85:B` | knn_generator.py |
| `KP_EXAMPLE` | 3 | `KP_EXAMPLE\|1\|x=-1,y=-1\|alpha=(0,0,0)` | kernel_perceptron_generator.py |
| `KP_SETUP` | 3 | `KP_SETUP\|kernel=linear\|data=[(-1,-1), (1,-1), (-3,-1)]\|alpha0=(0,0,0)` | kernel_perceptron_generator.py |
...
| `KRAFT_CLASSIFY` | 2 | `KRAFT_CLASSIFY\|excess=9/64\|no prefix code` | kraft_inequality_generator.py |
| `KRAFT_FORMULA` | 1 | `KRAFT_FORMULA\|sum 2^-l_i` | huffman_coding_generator.py, kraft_inequality_generator.py |
| `KRAFT_SETUP` | 2 | `KRAFT_SETUP\|A=5, B=1, C=5, D=6, E=1, F=4\|binary prefix code` | kraft_inequality_generator.py |
| `KRAFT_TERM` | 3 | `KRAFT_TERM\|A\|l=5\|1/32` | kraft_inequality_generator.py |
| `KRR_SETUP` | 3 | `KRR_SETUP\|kernel=linear\|data=[(3,-6), (-2,-2)]\|lambda=3,x*=6` | kernel_ridge_generator.py |
...
| `LADDER_SETUP` | 3 | `LADDER_SETUP\|commutator_energy\|state=ket28\|hbar=5, omega=8` | ladder_operator_generator.py |
| `LAGRANGE_EQ` | 2 | `LAGRANGE_EQ\|2*x = lambda*5\|x = lambda*5/2` | lagrange_multiplier_generator.py |
| `LAGRANGE_FACTOR` | 3 | `LAGRANGE_FACTOR\|L_0\|j=1\|4` | interpolation_generator.py |
| `LAGRANGE_SETUP` | 3 | `LAGRANGE_SETUP\|f(x,y) = x^2 + 4*y^2\|constraint 5*x + 4*y = 348\|minimize` | lagrange_multiplier_generator.py |
| `LAGRANGIAN` | 1, 2 | `LAGRANGIAN\|L=T-V\|1/2*m*xdot^2 - 1/2*k*x^2` | lagrangian_generator.py |
| `LAG_SETUP` | 3 | `LAG_SETUP\|mass_spring\|m=12, k=21\|q=x` | lagrangian_generator.py |
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|((lambda p. p) (g p))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LAURENT_SETUP` | 3 | `LAURENT_SETUP\|center a=-1\|w=(z+1)\|f=(-3 - 6(z+1) - 3(z+1)^2 + 6(z+1)^3 + 2(z+1)^4 + 3(z+1)^5)/(z+1)^2` | laurent_series_generator.py |
| `LAURENT_TERM` | 1 | `LAURENT_TERM\|-5(z+2)^-1` | residue_generator.py |
| `LAYERNORM_SETUP` | 3 | `LAYERNORM_SETUP\|x=(1,19)\|gamma=(2,3)\|beta=(-1,2)` | layer_norm_generator.py |
...
| `LEGENDRE_SETUP` | 2 | `LEGENDRE_SETUP\|a=55\|p=17` | legendre_construction_generator.py, quadratic_residue_generator.py |
| `LIE_EXP_FORM` | 2 | `LIE_EXP_FORM\|e^(theta J)\|cos(theta)I + sin(theta)J` | lie_exponential_generator.py |
| `LIE_EXP_SETUP` | 4 | `LIE_EXP_SETUP\|SO2\|theta=-390 deg\|J=[[0, -1], [1, 0]]\|goal=e^(theta J)` | lie_exponential_generator.py |
| `LIMITING_REAGENT` | 2 | `LIMITING_REAGENT\|H2\|NH3=14/3 mol` | stoichiometry_generator.py |
| `LIMIT_CHECK` | 2 | `LIMIT_CHECK\|NH3 from N2=12 mol\|NH3 from H2=14/3 mol` | stoichiometry_generator.py |
...
| `LINEAR_SYSTEM` | 2 | `LINEAR_SYSTEM\|a=12/13, b=-3/13\|c=-1/5, d=9/10` | markov_chain_generator.py |
| `LINE_EQ` | 1 | `LINE_EQ\|10y + 15 = 0` | complex_locus_generator.py |
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|589/2 - 373\|-157/2` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = 1/2x - 7\|(8, 4)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <5*x - 5*y, -5*x + 4*y>\|from (-4, 3) to (3, -1)` | line_integral_generator.py |
| `LLL_DONE` | 1 | `LLL_DONE\|[(2,6),(-10,6)]` | lll_reduction_generator.py |
| `LLL_SETUP` | 1 | `LLL_SETUP\|[(-12,0),(2,6)]` | lll_reduction_generator.py |
| `LOCUS_SETUP` | 3 | `LOCUS_SETUP\|z=x+iy\|center=(1,5)\|radius=5` | complex_locus_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(x)) = ln(45)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_EVAL` | 2 | `LOG_EVAL\|23/17\|ln(23/17)` | hyperbolic_distance_generator.py |
| `LOG_EXACT` | 2 | `LOG_EXACT\|log_3(6561)\|8` | master_theorem_generator.py |
...
| `LOG_LIKELIHOOD` | 1 | `LOG_LIKELIHOOD\|ell(p)=6*log(p)+4*log(1-p)` | mle_generator.py |
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|4x + 1 = x - 8` | log_equation_generator.py |
| `LOG_POWER` | 2 | `LOG_POWER\|log_2(x^4)\|4log_2(x)` | derivative_transcendental_generator.py, log_diff_higher_order_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_PRODUCT` | 1, 2 | `LOG_PRODUCT\|log_2(4x^4)\|log_2(4) + log_2(x^4)` | log_equation_generator.py, log_properties_generator.py, ph_calculation_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_2(4x^4/y)\|log_2(4x^4) - log_2(y)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|log_2(4x^4/y)\|expand` | complex_log_generator.py, log_properties_generator.py |
...
| `LORA_COUNT` | 2 | `LORA_COUNT\|r*(d_in+d_out)\|6592` | param_count_generator.py |
| `LOWRANK_SETUP` | 2 | `LOWRANK_SETUP\|A=[[8,0], [0,6]]\|rank=1` | low_rank_approx_generator.py |
| `LP_CORNER_SETUP` | 3 | `LP_CORNER_SETUP\|max z=10x+8y\|0<=x<=5, 0<=y<=13\|x+y<=14` | lp_corner_generator.py |
| `LR_PHASE` | 1 | `LR_PHASE\|decay` | lr_schedule_generator.py |
| `LR_SETUP` | 3 | `LR_SETUP\|base=3/100\|min=0\|warmup=10,total=110,t=60` | lr_schedule_generator.py |
| `LR_VALUE` | 1 | `LR_VALUE\|3/200` | lr_schedule_generator.py |
| `LS_LINE` | 2 | `LS_LINE\|a = 7, b = -2\|ŷ = 7 - 2x` | least_squares_generator.py |
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-3, 14), (-1, 8), (1, 4), (3, 2)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_RESULT` | 2 | `LU_RESULT\|L\|[[1, 0, 0], [-4, 1, 0], [-3, 4, 1]]` | lu_decomposition_generator.py |
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[5, 1, -3], [-20, -3, 8], [-15, 1, -2]]\|unit lower L` | lu_decomposition_generator.py |
...
| `LZ_SETUP` | 2 | `LZ_SETUP\|LZ78 decode\|(0,h), (0,a), (2,a), (2,h)` | lz_compression_generator.py |
...
| `MAG_SETUP` | 3 | `MAG_SETUP\|loop_center\|I=17, R=7\|mu0=1` | magnetism_generator.py |
...
| `MARKOV_SETUP` | 2, 3 | `MARKOV_SETUP\|two_state\|P00=1/10, P01=9/10\|P10=4/7, P11=3/7` | entropy_rate_markov_generator.py, markov_chain_generator.py |
...
| `MATRIX_GROUP_SETUP` | 2 | `MATRIX_GROUP_SETUP\|SO2\|M=[[195/197,28/197],[-28/197,195/197]]` | matrix_group_check_generator.py |
| `MATRIX_MULT` | 2, 3 | `MATRIX_MULT\|row1 dot col1\|69696/70225*69696/70225+6072/70225*6072/70225\|69696/70225` | projector_generator.py |
| `MATRIX_POWER` | 2 | `MATRIX_POWER\|J^2\|-I` | lie_exponential_generator.py |
| `MATRIX_PRODUCT` | 2 | `MATRIX_PRODUCT\|AB\|[[0, 45/4], [-45/4, 0]]` | bch_generator.py, casimir_generator.py, gamma_matrix_generator.py, pauli_algebra_generator.py, structure_constant_generator.py |
| `MATRIX_ROW` | 2 | `MATRIX_ROW\|row 1\|0, 1, 0` | graph_counting_generator.py |
| `MATRIX_SCALE` | 2 | `MATRIX_SCALE\|1/2 ladder sum\|[[1369/98, 0], [0, 1369/98]]` | bch_generator.py, casimir_generator.py |
...
| `MATRIX_VALUE` | 2 | `MATRIX_VALUE\|A\|[[9/2, 0], [0, -9/2]]` | pauli_algebra_generator.py, structure_constant_generator.py |
| `MAT_ENTRY` | 2, 3 | `MAT_ENTRY\|(1,1)\|-6` | lie_exponential_generator.py, matrix_calculus_generator.py, matrix_ops_generator.py |
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[3, -3], [-3, 4]], v = [[-3], [-1]]\|Av` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
| `MAX` | 2, 3 | `MAX\|7, 1\|7` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
| `MAXTERM` | 2 | `MAXTERM\|110\|NOT P OR NOT Q OR R` | boolean_algebra_generator.py |
| `MC_SETUP` | 3 | `MC_SETUP\|expression=x^T A x\|A=[[1,-3], [1,-3]]\|x=(-1,0)` | matrix_calculus_generator.py |
...
| `MEMORY_SETUP` | 3 | `MEMORY_SETUP\|kv_cache\|L=8,h=32,d_k=32\|seq=256,precision_bytes=1` | flops_memory_generator.py |
| `MEMORY_UNIT` | 2 | `MEMORY_UNIT\|MiB\|4` | flops_memory_generator.py |
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=1,mid=2,hi=3\|left 43; right 37` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|43\|37\|take right` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 1-2\|array 18, 37, 43, 32, 49, 17` | algorithm_trace_generator.py |
| `MERGE_TAKE` | 2 | `MERGE_TAKE\|37\|merged 37` | algorithm_trace_generator.py |
| `METRIC` | 2 | `METRIC\|taxicab\|d = abs(x2 - x1) + abs(y2 - y1)` | taxicab_geometry_generator.py |
| `METRICS_SETUP` | 1 | `METRICS_SETUP\|TP=10, FP=8, FN=20, TN=23` | classifier_metrics_generator.py |
| `METRIC_ARC_SETUP` | 3 | `METRIC_ARC_SETUP\|polar metric\|ds^2=dr^2+r^2 dtheta^2\|r=26, theta:0->2pi/3` | metric_arc_length_generator.py |
...
| `MGF_SETUP` | 3 | `MGF_SETUP\|P(X=0)=12/41\|P(X=1)=17/41\|P(X=2)=12/41` | mgf_generator.py |
| `MGF_TERM` | 3 | `MGF_TERM\|x=0\|p0*e^(0t)\|12/41` | mgf_generator.py |
...
| `MIN` | 2 | `MIN\|4,1\|1` | matrix_norm_generator.py |
...
| `MINTERM` | 2 | `MINTERM\|0010\|NOT B AND NOT C AND D AND NOT E` | boolean_algebra_generator.py |
...
| `MI_SETUP` | 2 | `MI_SETUP\|rows=[[0,0,0,1/2];[1/8,1/8,0,0];[0,0,1/4,0]]\|task=H(X,Y)` | mutual_information_generator.py |
| `MLE_SETUP` | 2, 3 | `MLE_SETUP\|bernoulli\|parameter=p\|data=[1,1,0,1,0,0,0,1,1,1]` | mle_generator.py |
| `MOBIUS_SETUP` | 2 | `MOBIUS_SETUP\|T(z)=(-2z - 5)/(z + 5)\|z0=-3` | mobius_transform_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 19500 · (1 + 0.3)^2` | exponential_model_generator.py |
| `MODEL_OUTPUT` | 1 | `MODEL_OUTPUT\|-11/2` | activation_generator.py |
| `MODEXP_MULTIPLY` | 2 | `MODEXP_MULTIPLY\|bit 1=1\|25` | mod_exp_generator.py, quadratic_residue_generator.py |
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 25\|exponent 49\|modulus 38` | mod_exp_generator.py |
| `MODEXP_SQUARE` | 2 | `MODEXP_SQUARE\|bit 1=1\|1` | mod_exp_generator.py, quadratic_residue_generator.py |
| `MODEXP_STATE` | 2 | `MODEXP_STATE\|after bit 1\|25` | mod_exp_generator.py, quadratic_residue_generator.py |
| `MODE_COUNT` | 2 | `MODE_COUNT\|1\|1` | simple_stats_generator.py |
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|39 mod 14\|9` | crt_generator.py, ecdsa_generator.py, elliptic_curve_finite_field_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|-5\|mod 14\|9` | modular_inverse_generator.py, rsa_generator.py |
| `MOD_POWER` | 3 | `MOD_POWER\|32^7\|mod 21\|11` | diffie_hellman_generator.py, pollard_factorization_generator.py, primality_test_generator.py, rsa_generator.py, tonelli_shanks_generator.py, totient_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|8^2*15^3/6\|36000` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|8*15^3/3\|9000` | centroid_generator.py |
| `MOM_EQUATION` | 2 | `MOM_EQUATION\|E[X]=lambda\|xbar=lambda` | method_of_moments_generator.py |
| `MOM_SETUP` | 3 | `MOM_SETUP\|poisson\|parameter=lambda\|data=[7,8,6,0]` | method_of_moments_generator.py |
...
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-45x^7) / (-5x^3)` | monomial_mult_div_generator.py |
...
| `MR_DECOMPOSE` | 2 | `MR_DECOMPOSE\|36\|2^2 * 9` | primality_test_generator.py |
| `MR_SETUP` | 2 | `MR_SETUP\|n=37\|witnesses 3, 4` | primality_test_generator.py |
...
| `MSE_GRADIENT` | 2 | `MSE_GRADIENT\|g0=-4\|g1=0` | gradient_step_generator.py |
| `MSE_SAMPLE` | 3 | `MSE_SAMPLE\|i=1\|pred=-1\|r=-3` | gradient_step_generator.py |
| `MSE_SETUP` | 3 | `MSE_SETUP\|model y_hat=w0+w1*x\|samples=[(-1,2), (3,4)]\|w=(0,1), eta=1/5` | gradient_step_generator.py |
| `MST_ADD` | 2 | `MST_ADD\|BD\|total 12` | mst_generator.py |
| `MST_SET` | 1 | `MST_SET\|BD` | mst_generator.py |
| `MST_SETUP` | 2 | `MST_SETUP\|weighted undirected graph\|vertices A, B, C, D` | mst_generator.py |
| `MU` | 2 | `MU\|-1/6\|round=0` | lll_reduction_generator.py |
| `MULTIPLY_IF` | 2 | `MULTIPLY_IF\|e^(5x)y' + 5e^(5x)y\|15e^(5x)` | integrating_factor_generator.py, ode_substitution_generator.py |
| `MULTIVALUED_LOG` | 2 | `MULTIVALUED_LOG\|ln(19/6) + i*(17pi/60 + 2pi*k)\|k in Z` | complex_log_generator.py |
| `MULTI_FORMULA` | 2 | `MULTI_FORMULA\|n!/(a!b!c!...)\|9! / repeats` | stars_and_bars_generator.py |
| `MULTI_SETUP` | 2 | `MULTI_SETUP\|5 X's, 3 B's, 1 O\|total 9` | stars_and_bars_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 - 6x on [0, 6]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 3*x^2 + y^2 - x*y + 5*x - 4*y\|x = -4*t + 6, y = -4*t - 6\|t = 3` | multivar_chain_rule_generator.py |
| `NATURAL_SETUP` | 3 | `NATURAL_SETUP\|mass\|hbar=1,c=1\|m=47/8 MeV` | natural_units_generator.py |
| `NB_FEATURE_COUNT` | 3 | `NB_FEATURE_COUNT\|Spam\|link=0\|count=0` | naive_bayes_generator.py |
| `NB_LIKELIHOOD` | 3 | `NB_LIKELIHOOD\|Spam\|link=0\|1/11` | naive_bayes_generator.py |
| `NB_PRIOR` | 2 | `NB_PRIOR\|Spam\|3/7` | naive_bayes_generator.py |
| `NB_SCORE` | 2 | `NB_SCORE\|Spam\|start=3/7` | naive_bayes_generator.py |
| `NB_SETUP` | 3 | `NB_SETUP\|query=link=0, known=0\|alpha=1\|classes=Spam,Ham` | naive_bayes_generator.py |
...
| `NEED` | 2 | `NEED\|line 2 subtracts 10, giving 54\|line 4 divides by 6` | fill_in_step_generator.py |
| `NEG_LOG` | 2 | `NEG_LOG\|p=1/8\|ln(8)` | perplexity_generator.py |
| `NET_SETUP` | 2 | `NET_SETUP\|2 right triangles with legs 12 and 16; rectangles 12 by 9, 16 by 9, and 20 by 9\|total surface area` | nets_surface_area_generator.py |
| `NEWTON_DD` | 2 | `NEWTON_DD\|f[x0,x1]\|10` | interpolation_generator.py |
| `NEWTON_SETUP` | 2, 3 | `NEWTON_SETUP\|f(x)=x^2-50\|f'(x)=2x\|x0=8,iterations=3` | newton_raphson_generator.py, newtons_laws_generator.py |
| `NEWTON_STEP` | 2 | `NEWTON_STEP\|1\|119/200` | npv_irr_generator.py |
| `NEWTON_UPDATE` | 3 | `NEWTON_UPDATE\|1\|x_0=8\|x_1=57/8` | newton_raphson_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 1/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NFA_ACCEPT` | 1 | `NFA_ACCEPT\|t7` | nfa_simulation_generator.py |
| `NFA_ACTIVE` | 2 | `NFA_ACTIVE\|start\|{t2,t4,t7}` | nfa_simulation_generator.py |
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|t2\|{t4}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|aab` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{t2,t4,t7}\|a\|t2->{}; t4->{t7}; t7->{}\|{t7}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|a` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states t2, t4, t7\|alphabet a, b, c\|start t2` | nfa_simulation_generator.py |
| `NFA_TRANSITION` | 3 | `NFA_TRANSITION\|t2\|a\|{}` | nfa_simulation_generator.py |
| `NILPOTENT` | 3 | `NILPOTENT\|theta^2=0\|35theta^2\|0` | grassmann_generator.py |
| `NLL` | 2 | `NLL\|161 tokens\|161*ln(8)` | perplexity_generator.py |
| `NORM2` | 2 | `NORM2\|b1\|144` | lll_reduction_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|A: 22 in N(67, 20)\|compare relative standing` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
| `NORM_SQUARED` | 2 | `NORM_SQUARED\|q\|1` | quaternion_generator.py |
| `NO_REDEX` | 2 | `NO_REDEX\|(g p)\|no beta redex remains` | lambda_reduction_generator.py |
| `NPV_SETUP` | 2 | `NPV_SETUP\|c0=-2000,c1=550,c2=250,c3=1800\|rate=5%` | npv_irr_generator.py |
| `NPV_TERM` | 2 | `NPV_TERM\|t=0\|-2000` | npv_irr_generator.py |
| `NULL_REL` | 2 | `NULL_REL\|x1 - 3*x4 = 0\|x1 = 3*x4` | subspace_basis_generator.py |
| `NULL_VECTOR` | 2 | `NULL_VECTOR\|x4=1\|[3, 1, -2, 1]` | subspace_basis_generator.py |
| `NUMBER_OPERATOR` | 2 | `NUMBER_OPERATOR\|N ket16\|16 ket16` | ladder_operator_generator.py |
| `NW_ALLOC` | 1, 3 | `NW_ALLOC\|cell x11\|min(19,9)\|9` | transportation_generator.py |
...
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dx = x^2/y^2, y(0) = 119\|solve` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `OPT_SETUP` | 2 | `OPT_SETUP\|x + y = 2319, x, y > 0\|maximize P = x·y^2` | optimization_generator.py |
| `ORBIT_FORMULA` | 1 | `ORBIT_FORMULA\|(T2/T1)^2=(a2/a1)^3` | orbital_mechanics_generator.py |
| `ORBIT_SETUP` | 3 | `ORBIT_SETUP\|kepler_third\|T1=35, a1=7\|a2=175` | orbital_mechanics_generator.py |
| `ORDER_PDF` | 1 | `ORDER_PDF\|f_{3:5}(x)=30*x^2*(1-x)^2` | order_statistics_generator.py |
| `ORDER_SETUP` | 3 | `ORDER_SETUP\|n=5\|k=3\|q=2/5` | order_statistics_generator.py |
...
| `OR_SETUP` | 3 | `OR_SETUP\|M/M/1\|lambda=12\|mu=26` | or_formula_generator.py |
| `OUTER_ANTIDERIV` | 2 | `OUTER_ANTIDERIV\|dx\|3*x^2 + 51*x` | double_integral_generator.py |
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|x=2..6\|3*(6^2 - 2^2) + 51*(6 - 2)\|300` | double_integral_generator.py |
| `OUTER_PRODUCT` | 1 | `OUTER_PRODUCT\|rho=161/198ket00bra00 - sqrt(5957)/198(ket00bra11+ket11bra00) + 37/198ket11bra11` | partial_trace_generator.py |
...
| `PARAMS` | 3 | `PARAMS\|W1=[[2,1], [1,1]]\|b1=(-1,-1)\|v=(-2,1), c=2` | backprop_generator.py |
| `PARAM_PART` | 2 | `PARAM_PART\|attention_per_layer\|10240000` | param_count_generator.py |
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(7*t - 4, -4*t + 3)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 2t + 3, y = 10t - 16\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(-3x - 14)/((x + 4)(x + 2)) = A/(x + 4) + B/(x + 2)` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_x\|32*x^3*y^3 + 24*x^3*y^2` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|6*x^4*y^2\|d/dx\|24*x^3*y^2` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 8*x^4*y^3 + 6*x^4*y^2\|f_xy` | partial_derivative_generator.py |
| `PARTIAL_TRACE` | 2 | `PARTIAL_TRACE\|ket00bra00\|ket0bra0` | partial_trace_generator.py |
| `PARTICLE_TABLE` | 1 | `PARTICLE_TABLE\|n(Q=0,B=1,Le=0,Lmu=0); pi0(Q=0,B=0,Le=0,Lmu=0); p(Q=1,B=1,Le=0,Lmu=0); e-(Q=-1,B=0,Le=1,Lmu=0); anti_nu_e(Q=0,B=0,Le=-1,Lmu=0); gamma(Q=0,B=0,Le=0,Lmu=0)` | conservation_law_generator.py |
...
| `PARTITION_SETUP` | 3 | `PARTITION_SETUP\|two_level\|g0=1, g1=1\|epsilon=20, b=1/9` | partition_function_generator.py |
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = 108x, dv = cos(x) dx\|du = 108 dx, v = sin(x)` | integration_by_parts_generator.py |
...
| `PATH_DERIV` | 2 | `PATH_DERIV\|r'(t)\|(7, -4)` | curve_geometry_generator.py, line_integral_generator.py |
...
| `PAULI_SETUP` | 3 | `PAULI_SETUP\|product\|A=-3sigma_x\|B=-2sigma_z` | pauli_algebra_generator.py |
| `PCA_SETUP` | 2 | `PCA_SETUP\|points=[(3,4), (-3,4), (0,9), (0,-1)]\|population covariance` | pca_generator.py |
...
| `PD_SETUP` | 2 | `PD_SETUP\|A=[[9,-12], [-12,41]]\|Sylvester criterion` | positive_definite_generator.py |
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|1.145\|550\|629.75` | percent_problem_generator.py |
...
| `PERCEPTRON_SETUP` | 3 | `PERCEPTRON_SETUP\|eta=2\|w=(1,-1,0)\|samples=[(-3,-1,-1), (0,1,1), (-3,0,-1), (2,0,1)]` | perceptron_generator.py |
| `PERCEPTRON_UPDATE` | 2, 3 | `PERCEPTRON_UPDATE\|i=1\|w=(-1,5,2)` | perceptron_generator.py |
...
| `PERM_COMPOSE` | 3 | `PERM_COMPOSE\|i=1\|tau(i)=6\|sigma(tau(i))=3` | permutation_group_generator.py |
| `PERM_FORMULA` | 1 | `PERM_FORMULA\|P(n, r) = n·(n-1)···(n-r+1), 2 factors` | permutation_combination_generator.py |
| `PERM_RESULT` | 1 | `PERM_RESULT\|[3, 2, 4, 1, 6, 5]` | permutation_group_generator.py |
| `PERM_SETUP` | 2, 3 | `PERM_SETUP\|P(13, 2)\|n!/(n-r)!` | permutation_combination_generator.py, permutation_group_generator.py |
...
| `PE_SETUP` | 3 | `PE_SETUP\|position=205\|d=2\|theta=3pi/4` | positional_encoding_generator.py |
...
| `PH_SETUP` | 2, 3 | `PH_SETUP\|hydroxide_with_log\|[OH-]=8*10^-3\|log10(8)=0.9` | ph_calculation_generator.py |
| `PI2_NUM` | 3 | `PI2_NUM\|-21/50000\|π^2\|-21π^2/50000` | casimir_force_generator.py |
...
| `PI_COEFF` | 2 | `PI_COEFF\|8π/5\|8/5` | arc_sector_generator.py |
| `PI_DEN` | 3 | `PI_DEN\|88/525\|π\|88/(525π)` | gauss_law_generator.py, hawking_generator.py, magnetism_generator.py |
...
| `PLANCK_SETUP` | 4 | `PLANCK_SETUP\|mass\|hbar=64\|G=1\|c=4` | planck_units_generator.py |
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|n = ±√9047\|n = √9047 or n = -√9047` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|24*5/2\|60` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y + 10 = -4(x - 4)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|r = 10\|pole=(-8, -6)\|rectangular equation` | parametric_calculus_generator.py, polar_parametric_generator.py |
| `POLES` | 1 | `POLES\|s=-2, -3` | transfer_function_generator.py |
| `POLE_ORDER` | 1 | `POLE_ORDER\|1` | residue_generator.py |
| `POLE_TEST` | 3 | `POLE_TEST\|pole 3\|abs(3) < 6\|inside` | contour_integral_generator.py |
...
| `POLLARD_RHO_SETUP` | 3 | `POLLARD_RHO_SETUP\|n=221\|c=5\|x0=3` | pollard_factorization_generator.py |
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|6x^3 + 23x^2 + 8x - 9\|3x + 4` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-6x^3 - 9x^2 + 8x + 3` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(-24x^7 - 24x^7 - 6x^4) / (6x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-24x^7) / (6x^3) + (-24x^7) / (6x^3) + (-6x^4) / (6x^3)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-7x^3 +x^3) + (-3x^2 -6x^2) + (8x) + (3)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|3x^3 + 1` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x - 2)(-x^2 + x + 1)` | multiplying_polynomials_generator.py |
...
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-7x^3 - 3x^2 + 8x + 3) + (x^3 - 6x^2)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(6x^3 + 23x^2) - (6x^3 + 8x^2)\|15x^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
| `PORT_FORMULA` | 2 | `PORT_FORMULA\|E=wA*rA+wB*rB\|Var=wA^2*varA+wB^2*varB+2*wA*wB*cov` | portfolio_generator.py |
| `PORT_RESULT` | 2 | `PORT_RESULT\|expected_return=0.12\|variance=0.0125` | portfolio_generator.py |
| `PORT_SETUP` | 3 | `PORT_SETUP\|wA=0.5,wB=0.5\|rA=10%,rB=14%\|varA=0.04,varB=0.01,cov=0` | portfolio_generator.py |
...
| `POTENTIAL_BUILD` | 3 | `POTENTIAL_BUILD\|integrate P dx\|3*x^2 - 4*x*y - 3*x + g(y)\|g'(y) remains` | exact_ode_generator.py, line_integral_generator.py |
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|3*x^2 + 4*y^2 - 4*x*y - 3*x` | exact_ode_generator.py, line_integral_generator.py |
| `POW` | 2 | `POW\|(1/3)^5\|1/243` | binomial_probability_generator.py, geometric_distribution_generator.py, recurrence_generator.py |
| `POWER_ENTRY` | 3 | `POWER_ENTRY\|(1,1)\|16*(-6) + 7\|-89` | diagonalization_generator.py |
...
| `POWER_REDUCE` | 2 | `POWER_REDUCE\|32^31\|32^7 mod 21` | totient_generator.py |
...
| `POWER_SETUP` | 2 | `POWER_SETUP\|cis(130 deg)^i\|principal logarithm` | complex_log_generator.py |
...
| `PREDICT` | 2 | `PREDICT\|x*\|-21/4` | kernel_ridge_generator.py |
| `PRIME` | 1 | `PRIME\|41` | divisibility_classification_generator.py |
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited D\|BD=12` | mst_generator.py |
| `PRIM_START` | 1 | `PRIM_START\|D` | mst_generator.py |
| `PRINCIPAL_LOG` | 1 | `PRINCIPAL_LOG\|ln(19/6) + i*17pi/60` | complex_log_generator.py |
...
| `PROBABILITY` | 2 | `PROBABILITY\|P(+x)\|1681/1682` | spin_half_generator.py |
...
| `PRODUCT` | 2 | `PRODUCT\|Delta x^2 * Delta p^2\|30625pi^2/12 - 1/2` | uncertainty_generator.py |
| `PROJECT` | 2 | `PROJECT\|P1\|0` | pca_generator.py |
| `PROJECTILE_SETUP` | 3 | `PROJECTILE_SETUP\|vx=41\|vy=50\|g=10` | projectile_motion_generator.py |
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[13, 9, 5, 1]` | least_squares_generator.py, legendre_construction_generator.py |
| `PROJECTOR_SETUP` | 2 | `PROJECTOR_SETUP\|v=(264/265, 23/265)\|P=vv^T=[[69696/70225,6072/70225],[6072/70225,529/70225]]` | projector_generator.py |
...
| `PSD_SETUP` | 2 | `PSD_SETUP\|K=[[12,5], [5,4]]\|criterion=all principal minors >= 0` | kernel_validity_generator.py |
...
| `Q1` | 4 | `Q1\|-180\|288\|36\|3` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|-180\|288\|36\|-13` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QN_ADD` | 4 | `QN_ADD\|Q\|left\|0 + n(0)\|0` | conservation_law_generator.py |
| `QR_ENTRY` | 2 | `QR_ENTRY\|q1\|[3/5, 4/5]` | qr_decomposition_generator.py |
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[9, -16], [12, -13]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|211°\|quadrant III` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
| `QUADRATIC` | 3 | `QUADRATIC\|2\|-12\|16` | mobius_transform_generator.py |
| `QUANTUM_FORMULA` | 1 | `QUANTUM_FORMULA\|lambda=h/p` | quantum_formula_generator.py |
| `QUANTUM_SETUP` | 2, 3 | `QUANTUM_SETUP\|gate=Z\|input=e^(i158π/297)·ket0` | quantum_formula_generator.py, quantum_gate_generator.py |
| `QUANT_SETUP` | 3 | `QUANT_SETUP\|x=(-23/50,-73/100,-97/50)\|scale=1/10\|zero_point=-7` | quantization_generator.py |
| `QUANT_VALUE` | 2 | `QUANT_VALUE\|1\|-12` | quantization_generator.py |
| `QUARK_CHARGE` | 2 | `QUARK_CHARGE\|anti_d\|1/3` | quark_composition_generator.py |
| `QUARK_SETUP` | 3 | `QUARK_SETUP\|antibaryon,count=806\|anti_d anti_b anti_b\|u=2/3,d=-1/3,s=-1/3,c=2/3,b=-1/3; anti=-charge` | quark_composition_generator.py |
| `QUARTILE` | 3 | `QUARTILE\|Q1\|6,19,19,22,23,26,35\|22` | five_number_summary_generator.py |
...
| `QUAT_RESULT` | 2 | `QUAT_RESULT\|q*v\|(2,-4,0,-4)` | quaternion_generator.py |
| `QUAT_SETUP` | 2 | `QUAT_SETUP\|q=(0,0,-1,0)\|v=(0,-4,2,4)` | quaternion_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|cube: ds/dt = 4 in/min; s = 7 in\|dV/dt` | related_rates_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 3498 / 0.165` | percent_problem_generator.py |
...
| `RECT_FORM` | 1 | `RECT_FORM\|-5sqrt2 + 5sqrt2i` | de_moivre_generator.py, euler_formula_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = -5 a_(n-1) - 6 a_(n-2)\|a_0 = 2, a_1 = -9` | master_theorem_generator.py, recurrence_generator.py |
| `REDUCED_DENSITY` | 1 | `REDUCED_DENSITY\|rho_A=[[161/198,0],[0,37/198]]` | partial_trace_generator.py |
| `REFLEXIVE_CHECK` | 2 | `REFLEXIVE_CHECK\|(1, 1)\|present` | relation_check_generator.py |
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q30876_1` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|a*b\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q30876_0\|still reading a*` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q30876_0\|a\|q30876_0` | regex_to_automaton_generator.py |
...
| `REGION_MEASURE` | 3 | `REGION_MEASURE\|volume\|9*8*3\|216` | vector_theorem_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|line ŷ = 60.9 + 0.7x\|predict ŷ at x = 6` | regression_generator.py |
...
| `REL_ENERGY_SETUP` | 3 | `REL_ENERGY_SETUP\|energy_momentum\|c=1\|p=216, m=195` | relativistic_energy_generator.py |
| `REL_FORMULA` | 1 | `REL_FORMULA\|L=L0/gamma` | special_relativity_generator.py |
| `REL_SETUP` | 2, 3 | `REL_SETUP\|A = {1, 2, 3}\|R = {(1, 1), (1, 2), (2, 2), (3, 2)}` | relation_check_generator.py, special_relativity_generator.py |
...
| `RESIDUE_SETUP` | 2 | `RESIDUE_SETUP\|a=-2\|f=-5/(z+2) + (z+2)` | residue_generator.py |
| `RESIDUE_SUM` | 1 | `RESIDUE_SUM\|7` | contour_integral_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (5, 35), line ŷ = 41.8 - 1.6x\|residual = observed − predicted` | regression_generator.py |
| `RESOLVE` | 3 | `RESOLVE\|C1\|C2\|not P43253` | resolution_proof_generator.py |
| `RES_EMPTY` | 1 | `RES_EMPTY\|C4` | resolution_proof_generator.py |
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(not P43253), C2=(P43253), C3=(P77794)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C3\|(P69539)` | resolution_proof_generator.py |
...
| `RG_SETUP` | 3 | `RG_SETUP\|one_loop\|alpha0=5/37\|beta=3,L=1/3` | running_coupling_generator.py |
...
| `RIEMANN_SETUP` | 2, 3 | `RIEMANN_SETUP\|f(x) = 3x + 3 on [0, 8], n = 4\|right Riemann sum` | riemann_sum_generator.py, riemann_tensor_generator.py |
| `RK_COMBINE` | 2 | `RK_COMBINE\|k1+2k2+2k3+k4\|7233/512` | runge_kutta_generator.py |
| `RK_STAGE` | 3 | `RK_STAGE\|k1\|t=3/2\|Q=9/2` | runge_kutta_generator.py |
...
| `ROT_SETUP` | 3 | `ROT_SETUP\|angular_momentum\|I1=9, omega1=3\|I2=16` | rotational_dynamics_generator.py |
| `ROUND` | 2 | `ROUND\|-58/5\|-12` | quantization_generator.py |
| `ROUNDTRIP_ERROR` | 2 | `ROUNDTRIP_ERROR\|sum_abs\|11/100` | quantization_generator.py |
...
| `ROUTH_ROW` | 2 | `ROUTH_ROW\|s^3\|1, 36` | routh_hurwitz_generator.py |
| `ROUTH_SETUP` | 1 | `ROUTH_SETUP\|p(s)=s^3+5s^2+36s+14` | routh_hurwitz_generator.py |
| `ROW_ENTROPY` | 2 | `ROW_ENTROPY\|H0\|649/800` | entropy_rate_markov_generator.py |
| `ROW_OP` | 1, 2 | `ROW_OP\|R2 → R2 + 3·R1\|[0, 1, 3, 9]` | row_reduction_generator.py, simplex_generator.py, subspace_basis_generator.py |
| `RREF_RESULT` | 2 | `RREF_RESULT\|RREF(A)\|[[1, 0, 0, -3], [0, 1, 0, -1], [0, 0, 1, 2]]` | subspace_basis_generator.py |
| `RSA_DECRYPT` | 2 | `RSA_DECRYPT\|38\|272` | rsa_generator.py |
| `RSA_ENCRYPT` | 2 | `RSA_ENCRYPT\|272\|38` | rsa_generator.py |
| `RSA_PRIVATE_KEY` | 1 | `RSA_PRIVATE_KEY\|d=151` | rsa_generator.py |
| `RSA_PUBLIC_KEY` | 2 | `RSA_PUBLIC_KEY\|n=299\|e=7` | rsa_generator.py |
| `RSA_SETUP` | 3 | `RSA_SETUP\|p=13\|q=23\|message=272` | rsa_generator.py |
| `RSQ_FORMULA` | 1 | `RSQ_FORMULA\|r^2 = Sxy^2/(Sxx·Syy)` | regression_generator.py |
| `RS_CORRECT` | 2 | `RS_CORRECT\|position=3\|[41,24,113,99]` | reed_solomon_generator.py |
| `RS_EVAL` | 2 | `RS_EVAL\|x=10\|126` | reed_solomon_generator.py |
| `RS_LINE` | 3 | `RS_LINE\|m0=39\|m1=113\|agree=3` | reed_solomon_generator.py |
| `RS_PAIR` | 2 | `RS_PAIR\|x=32,38\|y=41,24` | reed_solomon_generator.py |
| `RS_RECEIVED` | 1 | `RS_RECEIVED\|[41,24,3,99]` | reed_solomon_generator.py |
| `RS_SETUP` | 3 | `RS_SETUP\|F_191\|m(x)=0+89x\|points 10,15,98,127` | reed_solomon_generator.py |
...
| `SAMPLE_MOMENT` | 2 | `SAMPLE_MOMENT\|xbar\|21/4` | method_of_moments_generator.py |
...
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x3 = 49\|xi >= 1` | stars_and_bars_generator.py |
| `SCALE_DIV` | 3 | `SCALE_DIV\|1344\|28\|48` | scaling_generator.py |
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|10*cos\|-5sqrt2` | de_moivre_generator.py, euler_formula_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|9 inches\|actual_dimension` | scaling_generator.py |
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = 7\|343*2\|686` | diagonalization_generator.py |
...
| `SCALING_COMPUTE` | 2 | `SCALING_COMPUTE\|6ND\|3570000000000000000` | scaling_law_generator.py |
| `SCALING_SETUP` | 3 | `SCALING_SETUP\|N=35000000\|D=17000000000\|F=48000000000000000` | scaling_law_generator.py |
| `SCHWARZSCHILD_SETUP` | 3, 4 | `SCHWARZSCHILD_SETUP\|time_dilation\|r_s=198\|r=550` | schwarzschild_generator.py |
...
| `SCORE_EQ` | 1 | `SCORE_EQ\|6/p=4/(1-p)` | mle_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(-2, -6), B(0, -2); ratio 1:1 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_25 = 5 + (25 - 1)·6` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|5, 11, 17, 23, ...\|sum of first 25 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ 1/n^(16/7), n ≥ 1\|converge or diverge?` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
| `SERIES_TERM` | 3 | `SERIES_TERM\|n=0\|1\|1` | grassmann_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|3498 = 0.165 * whole` | percent_problem_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y3 = 46` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
| `SHM_FORMULA` | 1 | `SHM_FORMULA\|omega^2=k/m` | shm_generator.py |
| `SHM_SETUP` | 3 | `SHM_SETUP\|mass_spring_energy\|m=7, k=63\|A=2, x=1` | shm_generator.py |
| `SHORTEST` | 2 | `SHORTEST\|(2,6)\|norm^2=40` | lll_reduction_generator.py |
| `SIGFIG_ROUND` | 3 | `SIGFIG_ROUND\|10080\|2 significant figures\|1 × 10^4` | fermi_estimation_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|10 + 14 + 18 + 22 + 26 + 30` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=0)^(5) (4k + 10)\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=0\|4(0) + 10\|10` | sigma_notation_generator.py |
| `SIGN` | 3 | `SIGN\|left\|-2\|negative` | bisection_generator.py |
| `SIGNAL_SETUP` | 2, 3 | `SIGNAL_SETUP\|sampling\|f_max=1755 Hz\|f_s=2005 Hz` | signal_arithmetic_generator.py |
| `SIGN_CHART` | 2 | `SIGN_CHART\|critical values\|-7, -6` | polynomial_inequality_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, 0)\|y = -1\|f(y) = 44 (positive)\|up` | stability_generator.py |
...
| `SIMPLEX_SETUP` | 3 | `SIMPLEX_SETUP\|max z=11x+y\|x<=15\|y<=17` | simplex_generator.py |
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; DE = 56, AB = 28, EF = 40\|find BC` | similar_triangles_generator.py |
...
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = cos(4x + 120°) + 3\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
| `SIZE_REDUCE` | 2 | `SIZE_REDUCE\|b2=(-12, 0)\|b2-(-1)b1=(-10, 6)` | lll_reduction_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = -83x - 96` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|-4` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(2, 3)\|(4, 3)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (3 - 3) / (4 - 2)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOFTMAX_SETUP` | 3 | `SOFTMAX_SETUP\|z=(1*ln(1),1*ln(5),1*ln(6))\|T=1\|target=3` | softmax_gradient_generator.py |
| `SOFTMAX_WEIGHT` | 2 | `SOFTMAX_WEIGHT\|1,1\|1/3` | attention_generator.py |
| `SOLUTIONS` | 2 | `SOLUTIONS\|sin x = 0\|0°, 180°, 360°, 540°` | trig_equation_generator.py |
| `SOLUTION_FORMULA` | 1 | `SOLUTION_FORMULA\|M1*V1=M2*V2` | solution_chem_generator.py |
| `SOLUTION_SETUP` | 3 | `SOLUTION_SETUP\|dilution_stock_volume\|M1=10\|M2=2, V2=481` | solution_chem_generator.py |
...
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(6*e^(2t) - 5*e^(3t))*(-2) + (-3*e^(2t) + 3*e^(3t))*(-1)\|-9*e^(2t) + 7*e^(3t)` | matrix_exponential_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|AB=2, BD=4, BC=17, AD=19` | mst_generator.py |
...
| `SPHERICAL_EXCESS_SETUP` | 2 | `SPHERICAL_EXCESS_SETUP\|R=17\|angles=120,60,105` | spherical_excess_generator.py |
| `SPHERICAL_SINE_LAW` | 1 | `SPHERICAL_SINE_LAW\|sin(A)/sin(a)=sin(B)/sin(b)` | spherical_triangle_generator.py |
| `SPHERICAL_TRIANGLE_SETUP` | 2 | `SPHERICAL_TRIANGLE_SETUP\|a=30 deg, b=120 deg, A=30 deg\|find sin(B)` | spherical_triangle_generator.py |
| `SPIN_COMPONENT` | 2 | `SPIN_COMPONENT\|row=1\|-8/17` | spin_half_generator.py |
| `SPIN_SETUP` | 3 | `SPIN_SETUP\|apply_pauli\|operator=sigma_z\|psi=[-8/17,15/17]` | spin_half_generator.py |
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|6n = -4n + 10n\|8n^2 - 4n + 10n - 5` | factor_trinomial_generator.py |
| `SPLIT_SETUP` | 3 | `SPLIT_SETUP\|texture\|left pos=1, neg=7\|right pos=3, neg=5` | information_gain_generator.py |
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|n^2 = 9047\|n = ±√9047` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `SQRT_DIGIT` | 2 | `SQRT_DIGIT\|5\|root = 5` | manual_square_root_generator.py |
| `SQRT_NEG` | 2 | `SQRT_NEG\|√(-4356)\|66i` | complex_quadratic_generator.py, polynomial_zeros_generator.py |
...
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(4x + 65) = 9\|4x + 65 = 81` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|20475\|225 × 91\|225` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `STANDING_SETUP` | 3 | `STANDING_SETUP\|open_pipe\|n=5\|L=6, v=124` | standing_wave_generator.py |
...
| `STATICS_SETUP` | 3 | `STATICS_SETUP\|supported_beam\|W=104, L=13\|x=9` | statics_generator.py |
...
| `STEREO_SETUP` | 3, 4 | `STEREO_SETUP\|plane_to_sphere\|u=2/3\|v=-2` | stereographic_generator.py |
...
| `STRUCTURE_CONSTANT` | 3 | `STRUCTURE_CONSTANT\|epsilon_zxy\|1\|45iJy` | structure_constant_generator.py |
| `STRUCTURE_SETUP` | 3 | `STRUCTURE_SETUP\|A=9Jz\|B=5Jx\|epsilon_zxy=1` | structure_constant_generator.py |
...
| `SUBSTITUTE` | 2 | `SUBSTITUTE\|p:=(g p) in p\|(g p)` | lambda_reduction_generator.py |
...
| `SUM` | 2, 3 | `SUM\|30 + 32 + 31 + 29 + 28\|150` | bayesian_update_generator.py, method_of_moments_generator.py, mle_generator.py, regression_generator.py |
| `SUM_ORDER` | 2 | `SUM_ORDER\|Σ i^2\|n^3` | master_theorem_generator.py |
| `SUPPORT` | 2 | `SUPPORT\|0<=x<=15\|0<=y<=225` | rv_transform_generator.py |
| `SUPPORT_TERM` | 2 | `SUPPORT_TERM\|1\|(7,0)` | svm_margin_generator.py |
| `SVM_SETUP` | 3 | `SVM_SETUP\|x1=(-7,0),y1=-1,alpha1=1\|x2=(0,24),y2=-1,alpha2=1\|b=-2,x=(-4,-5)` | svm_margin_generator.py |
| `SWAP` | 2 | `SWAP\|norm b2=40\|norm b1=144` | lll_reduction_generator.py |
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = -5y + 4` | inverse_function_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|x^4 - 3x^3 - 3x^2 - 2x - 3\|r = 4` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|1, 1, 1, 2, 5` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: 11y = 0` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with y only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = 5y - 51` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * 2` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|2x + 8y = 10\|-2x + 3y = -10` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x - 5y = -51\|-x - 2y = -12` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute x in Eq 2` | systems_substitution_generator.py |
| `SYS_SUBST_BACK` | 1 | `SYS_SUBST_BACK\|Substitute y=9 into x = 5y - 51` | systems_elimination_generator.py, systems_substitution_generator.py |
| `TABLEAU` | 2, 3 | `TABLEAU\|initial\|s1: x + s1 = 15\|s2: y + s2 = 17` | simplex_generator.py |
| `TABLEAU_RULE` | 3 | `TABLEAU_RULE\|8 x 3bar\|attach one antibox to the adjoint tableau\|15bar + 6 + 3bar` | young_tableaux_generator.py |
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|f(-1)\|6` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|g(-1)\|11` | de_moivre_generator.py, dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, lie_exponential_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 56 + 6*(x - 0) + 26*(y - 4)` | gradient_generator.py |
...
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|all middle factors cancel\|108/140` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Π k=108..139 k/(k+1)` | telescoping_generator.py |
...
| `TENSOR_SETUP` | 3 | `TENSOR_SETUP\|A=diag(4,-2)\|B=diag(1,4)\|u=[-2,-2], v=[2,2]` | tensor_product_generator.py |
| `TENSOR_STATE` | 2 | `TENSOR_STATE\|u tensor v\|[-4,-4,-4,-4]` | tensor_product_generator.py |
| `TERM` | 2 | `TERM\|i=0: 1·(1/10)^0·(9/10)^5\|0.59049` | binomial_probability_generator.py |
| `TERMS` | 1 | `TERMS\|x[0..3]=[27,-270,2700,-27000]` | z_transform_generator.py |
| `TEST_CHOOSE` | 2 | `TEST_CHOOSE\|p-series\|Σ 1/n^p with p = 16/7` | power_series_generator.py, series_convergence_generator.py |
| `TEST_STAT_FORMULA` | 1 | `TEST_STAT_FORMULA\|z = (p̂ - p0)/√(p0(1-p0)/n)` | hypothesis_test_generator.py, two_sample_test_generator.py |
| `TF_SETUP` | 3 | `TF_SETUP\|ode\|y''+5y'+6y=6x'+48x\|zero initial conditions` | transfer_function_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|divergence theorem\|F=<2*x, -2*y, 2*z>\|box 9 by 8 by 3` | vector_theorem_generator.py |
| `THETA` | 2 | `THETA\|min(13,9)\|9` | transportation_generator.py |
| `THROUGHPUT` | 2 | `THROUGHPUT\|tokens_per_second\|1600000000/7` | scaling_law_generator.py |
...
| `TIME_EVOLVE` | 2 | `TIME_EVOLVE\|U psi\|[-1-i,-1]` | braket_generator.py |
...
| `TOTIENT_RESULT` | 2 | `TOTIENT_RESULT\|phi(21)\|12` | totient_generator.py |
| `TRACE` | 2 | `TRACE\|-3 + 0\|-3` | ode_system_generator.py |
...
| `TRANSFER` | 1 | `TRANSFER\|H(s)=(6s+48)/(s^2+5s+6)` | transfer_function_generator.py |
...
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(-6, -7)\|rotation 90° counterclockwise about the origin, then dilation by factor 4 centered at the origin` | rv_transform_generator.py, transformation_generator.py |
| `TRANSIENT_FORMULA` | 1 | `TRANSIENT_FORMULA\|tau=R*C` | transient_circuit_generator.py |
| `TRANSIENT_SETUP` | 3 | `TRANSIENT_SETUP\|rc_charging\|R=3, C=5\|Vs=3, t=45` | transient_circuit_generator.py |
| `TRANSITIVE_CHECK` | 3 | `TRANSITIVE_CHECK\|(1, 1) and (1, 1)\|need (1, 1)\|present` | relation_check_generator.py |
| `TRANSPORT_SETUP` | 3 | `TRANSPORT_SETUP\|supply=(19,13)\|demand=(9,23)\|costs=(7,8;4,13)` | transportation_generator.py |
| `TRIG_RATIO` | 2 | `TRIG_RATIO\|sin\|opposite/hypotenuse` | right_triangle_trig_generator.py |
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: opposite side = 384, hypotenuse = 480; given sin 53° ≈ 0.8\|angle A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|z_part * r_part * angle\|4*72*2*2*pi\|1152*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 4*z\|cylinder radius 2, height 12\|cylindrical` | triple_integral_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|45-45-90 triangle, hypotenuse = 396\|leg` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
| `TRUNCATE` | 2 | `TRUNCATE\|rank=1\|discard=6` | low_rank_approx_generator.py |
| `TRUTH_ROW` | 2 | `TRUTH_ROW\|B=0, C=0, D=0, E=0\|G=0` | boolean_algebra_generator.py |
...
| `TS_INIT` | 4 | `TS_INIT\|m=3\|c=10\|t=46\|r=23` | tonelli_shanks_generator.py |
| `TS_LOOP` | 2 | `TS_LOOP\|i=2\|b=10` | tonelli_shanks_generator.py |
| `TS_NONRESIDUE` | 1 | `TS_NONRESIDUE\|5` | tonelli_shanks_generator.py |
| `TS_SETUP` | 2 | `TS_SETUP\|a=48\|p=73` | tonelli_shanks_generator.py |
...
| `UNCERTAINTY_SETUP` | 3 | `UNCERTAINTY_SETUP\|particle in a box\|L=1, hbar=1\|n=175` | uncertainty_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|26, 37, 48, 59\|arithmetic, d = 11` | recursive_explicit_generator.py |
| `UPDATE` | 2 | `UPDATE\|W1_11\|7/3` | backprop_generator.py, kernel_perceptron_generator.py |
...
| `VARIANCE` | 1, 2 | `VARIANCE\|Delta x^2\|1/12 - 1/(61250pi^2)` | layer_norm_generator.py, uncertainty_generator.py |
| `VAR_FORMULA` | 1 | `VAR_FORMULA\|Var(X) = Σ P(x)·(x - μ)^2` | expected_value_generator.py |
| `VAR_ROW` | 3 | `VAR_ROW\|1 - 3.25 = -2.25\|(-2.25)^2 = 5.0625\|1/4·5.0625 = 1.265625` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|13` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y,z) = <2*x - 6*y - 3*z, 6*x - 4*y - 3*z, 5*x + 3*y - 3*z>\|divergence and curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|686*7 + (-1536)*6\|-4414` | diagonalization_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|base: region under y = 168 - x on [0, 168]; cross-sections perpendicular to the x-axis are squares\|cross-section method` | solid_revolution_generator.py |
...
| `WAVE_SETUP` | 3 | `WAVE_SETUP\|power_interval\|psi=N*(x/L)^3\|0<=x<=25` | wavefunction_generator.py |
...
| `WIDTH_SETUP` | 3 | `WIDTH_SETUP\|branching_ratio\|Gamma_a=4, Gamma_b=11, Gamma_c=4\|target=BR_a` | branching_ratio_generator.py |
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|48 - 80\|-32` | line_integral_generator.py |
...
| `YOUNG_SETUP` | 3 | `YOUNG_SETUP\|partition=[3,2,2,2,1]\|n=10\|group=S_10` | young_tableaux_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(22 - 67)/20\|-2.25` | normal_table_generator.py, z_score_generator.py |
...
| `ZT_SETUP` | 2, 3 | `ZT_SETUP\|geometric\|x[n]=27*(-10)^n u[n]` | z_transform_generator.py |
