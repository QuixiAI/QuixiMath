...
1811 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|x + 10 = 1` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|5x - 7 ≥ 15 -> x ≥ 22/5` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|abs(5x - 7) ≥ 15` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|OR case\|5x - 7 ≥ 15 or 5x - 7 ≤ -15` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|abs(x + 10) = 1` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|x + 10 = 1\|x + 10 = -1` | absolute_value_equation_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 4/12, P(B) = 7/12, P(A ∪ B) = 8/12\|P(A ∩ B)` | probability_addition_rule_generator.py |
...
| `ALG_SETUP` | 3 | `ALG_SETUP\|binary search\|target 45\|values 5, 19, 27, 36, 43, 44` | algorithm_trace_generator.py |
| `ALIGN_NUM` | 2 | `ALIGN_NUM\|046.36\|177.07` | number_comparison_generator.py |
| `ALPHA` | 2 | `ALPHA\|line 2\|4: c; 5: ¬g` | kernel_ridge_generator.py, semantic_tableau_generator.py |
...
| `ANGLE_DEFECT_SETUP` | 2 | `ANGLE_DEFECT_SETUP\|R=15\|angles=90,15,45` | angle_defect_generator.py |
...
| `ANGLE_SETUP` | 2 | `ANGLE_SETUP\|supplementary\|angle1 = 51°` | angle_relationships_generator.py |
| `ANGLE_SOLVE` | 2 | `ANGLE_SOLVE\|180 - 51\|129` | angle_relationships_generator.py |
...
| `ANTICHAIN` | 2 | `ANTICHAIN\|{16, 22, 32}\|size 3` | partial_order_generator.py |
...
| `APPLY` | 3 | `APPLY\|∧E₁\|1\|m` | natural_deduction_generator.py |
| `APPLY_GATE` | 3 | `APPLY_GATE\|CNOT\|e^(i5π/106)·ket01\|e^(i5π/106)·ket01` | quantum_gate_generator.py |
| `APPLY_OPERATOR` | 2 | `APPLY_OPERATOR\|L[Ae^(2x)]\|A(4 - 4 - 8)e^(2x)` | commutator_generator.py, undetermined_coeff_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 31, central angle 205°\|sector area` | arc_sector_generator.py |
| `AREA` | 1 | `AREA\|66` | geometry_area_perimeter_generator.py |
| `AREA_INT` | 3 | `AREA_INT\|A = int y dx\|8*6^3/3\|576` | centroid_generator.py |
...
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 + 3x + 12 and y = 22\|area between the curves` | area_between_curves_generator.py |
| `ARGUMENT` | 2 | `ARGUMENT\|(-11,-11)\|225 deg` | complex_log_generator.py, euler_formula_generator.py |
...
| `ARRAY_STATE` | 2 | `ARRAY_STATE\|pass 1\|22, 26, 5, 31, 16` | algorithm_trace_generator.py |
...
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = 4 ± (3/4)(x - 1)` | hyperbola_features_generator.py |
| `ATA` | 2 | `ATA\|A^T A\|[[5101, 5100], [5100, 5101]]` | svd_generator.py |
...
| `AXIOM_MATCH` | 2 | `AXIOM_MATCH\|L1\|p := ¬(k ∨ k), q := ¬(j ∨ m)` | hilbert_axiom_derivation_generator.py |
...
| `BACK_SUB_ROW` | 3 | `BACK_SUB_ROW\|r=225\|x=1\|y=0` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `BASE_ADD_COL` | 3 | `BASE_ADD_COL\|col 0\|F + B + carry 0\|26 -> digit A, carry 1` | base_arithmetic_generator.py |
| `BASE_ARITH_SETUP` | 2 | `BASE_ARITH_SETUP\|base 16\|63F + 52B` | base_arithmetic_generator.py |
| `BASE_CARRY` | 2 | `BASE_CARRY\|carry 2\|digit 2, carry 0` | base_arithmetic_generator.py |
| `BASE_MUL_COL` | 3 | `BASE_MUL_COL\|col 0\|3 * 3 + carry 0\|9 -> digit 1, carry 1` | base_arithmetic_generator.py |
| `BASE_SETUP` | 2 | `BASE_SETUP\|11100111_2\|decimal` | base_conversion_generator.py |
| `BAYES_CELL` | 3 | `BAYES_CELL\|true positive\|299 × 3/13\|69` | conditional_probability_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 299, disease=no 1500\|sensitivity 3/13, specificity 19/20\|P(disease=no given test negative)` | conditional_probability_generator.py |
...
| `BETA` | 1, 3 | `BETA\|line 1\|1L: 2: c ∧ ¬g\|1R: 3: ¬g ∨ ¬g` | lambda_reduction_generator.py, semantic_tableau_generator.py |
| `BETA_COUNT` | 1 | `BETA_COUNT\|1` | lambda_reduction_generator.py |
| `BEZOUT_CHECK` | 2 | `BEZOUT_CHECK\|225*-21 + 215*22\|5` | extended_euclid_generator.py |
...
| `BINARY` | 2 | `BINARY\|42486\|1010010111110110` | countability_bijection_generator.py |
...
| `BINOM_SETUP` | 2 | `BINOM_SETUP\|n = 4, k = 1, p = 1/4\|P(X = k)` | binomial_probability_generator.py |
...
| `BIT` | 1, 2 | `BIT\|g\|A=1\|B=0` | characteristic_vector_generator.py |
| `BITWISE` | 1 | `BITWISE\|¬\|110010\|001101` | characteristic_vector_generator.py |
...
| `BIT_SETUP` | 2 | `BIT_SETUP\|1110 XOR 1001\|4-bit mask` | bitwise_ops_generator.py |
...
| `BRANCH_CLOSE` | 2 | `BRANCH_CLOSE\|1\|s, ¬s` | semantic_tableau_generator.py |
| `BRANCH_OPEN` | 2 | `BRANCH_OPEN\|1L\|c=T, g=F` | semantic_tableau_generator.py |
...
| `BRANCH_USE` | 1 | `BRANCH_USE\|$3.00` | piecewise_evaluation_generator.py |
...
| `CARD_RULE` | 2 | `CARD_RULE\|set construction\|a positive finite power of ℵ0 is ℵ0` | cardinal_arithmetic_generator.py |
| `CARRY_FINAL` | 1 | `CARRY_FINAL\|1` | multi_digit_addition_generator.py |
| `CARTESIAN_RESULT` | 1 | `CARTESIAN_RESULT\|{(p, 14)}` | set_operations_generator.py |
| `CART_PAIR` | 3 | `CART_PAIR\|p\|14\|(p, 14)` | set_operations_generator.py |
...
| `CBRT` | 2 | `CBRT\|64w^6\|4w^2` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
...
| `CEIL` | 2 | `CEIL\|424.689664\|425` | confidence_interval_generator.py |
...
| `CENTROID_COORD` | 3 | `CENTROID_COORD\|xbar = M_y/A\|(2592)/(576)\|9/2` | centroid_generator.py |
| `CENTROID_SETUP` | 3 | `CENTROID_SETUP\|0 <= y <= 8*x^2\|0 <= x <= 6\|centroid` | centroid_generator.py |
...
| `CF_RESULT` | 1 | `CF_RESULT\|[3; 113]` | continued_fraction_generator.py |
| `CF_SETUP` | 1 | `CF_SETUP\|340/113` | continued_fraction_generator.py |
...
| `CHAIN` | 2 | `CHAIN\|{9, 22, 29}\|length 3` | partial_order_generator.py |
...
| `CHAIN_SUM` | 3 | `CHAIN_SUM\|f_x*dx/dt + f_y*dy/dt\|28*(-3) + 41*2\|-2` | multivar_chain_rule_generator.py |
| `CHAIN_VALUE` | 3 | `CHAIN_VALUE\|x(0)\|2\|2` | multivar_chain_rule_generator.py |
| `CHANGE_BASE` | 1 | `CHANGE_BASE\|log_32(4) = log_2(4)/log_2(32)` | log_conversion_generator.py |
...
| `CHECK_POINT` | 3 | `CHECK_POINT\|x=0\|12·0 + 18 = 18\|12·0 + 18 = 18` | special_solution_equation_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|observed: 1, 3, 9, 6, 7, 4; expected: 5 each\|goodness of fit; df = 5, critical value = 11.07` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|1 - 5 = -4\|(-4)^2 = 16\|16/5 = 3.2` | chi_square_generator.py |
...
| `CHURCH_NUMERAL` | 2 | `CHURCH_NUMERAL\|1\|lambda t. (lambda p. (t p))` | lambda_reduction_generator.py |
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|central angle 58° subtends an arc\|inscribed angle on the same arc` | circle_angle_generator.py |
| `CIRCLE_CALCULATE` | 2 | `CIRCLE_CALCULATE\|C = 24π\|24π` | circle_generator.py |
| `CIRCLE_EQ` | 1 | `CIRCLE_EQ\|(x + 1)^2 + (y - 4)^2 = 1` | complex_locus_generator.py |
| `CIRCLE_FORMULA` | 1 | `CIRCLE_FORMULA\|C = 2πr` | circle_generator.py |
| `CIRCLE_SETUP` | 2 | `CIRCLE_SETUP\|12\|radius` | circle_equation_generator.py, circle_generator.py |
| `CIRCLE_SUBSTITUTE` | 1 | `CIRCLE_SUBSTITUTE\|C = 2 × π × 12` | circle_generator.py |
| `CIRCULATION_SUM` | 2 | `CIRCULATION_SUM\|(5 - 0)*20\|100` | vector_theorem_generator.py |
...
| `CLASS` | 2 | `CLASS\|[4]\|{4, 33}` | equivalence_relation_generator.py |
| `CLASSIFY` | 2 | `CLASSIFY\|contradiction\|T at 0 of 4 rows` | foundations_critic_generator.py, truth_table_generator.py |
| `CLAUSE` | 2 | `CLAUSE\|C1\|(¬P39289)` | resolution_proof_generator.py |
| `CLIFFORD_EXPECT` | 3 | `CLIFFORD_EXPECT\|2*eta=-2\|I_entry=0\|0` | gamma_matrix_generator.py |
| `CLOSURE_ADD` | 2 | `CLOSURE_ADD\|(28, 28)\|reflexive` | relation_closure_generator.py |
| `CLUE_APPLY` | 3 | `CLUE_APPLY\|clue 1\|Gia does not drink punch\|36 → 24 candidates` | logic_grid_puzzle_generator.py |
...
| `CNF` | 1 | `CNF\|ω^3·3 + ω^2·5 + ω` | ordinal_arithmetic_generator.py |
| `CNF_FORM` | 1 | `CNF_FORM\|(U OR V OR NOT W) AND (U OR NOT V OR W) AND (U OR NOT V OR NOT W) AND (NOT U OR NOT V OR NOT W)` | boolean_algebra_generator.py |
...
| `COEFF` | 2 | `COEFF\|a_1\|-99600` | laurent_series_generator.py, series_solution_generator.py |
| `COEFFS` | 1, 2 | `COEFFS\|1, 1, -22, -17` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `COEFF_MATCH` | 2 | `COEFF_MATCH\|x^n\|(n+1)a_(n+1) = -5a_n` | series_solution_generator.py |
| `COEFF_PAIR` | 3 | `COEFF_PAIR\|i=0, j=4\|2i + 3j = 12\|accepted` | generating_function_generator.py |
| `COFACTOR` | 2 | `COFACTOR\|(1,1) sign +\|minor [[2, -3], [0, -2]]` | determinant_generator.py |
| `COLLIDER_SETUP` | 3 | `COLLIDER_SETUP\|events_pb\|L=11 fb^-1\|sigma=1 pb` | cross_section_generator.py |
| `COLLISION` | 1 | `COLLISION\|f(f) = f(g) = 7` | function_properties_generator.py |
| `COLLISION_SETUP` | 3 | `COLLISION_SETUP\|inelastic_1d\|m1=20, u1=20\|m2=18, u2=-9` | collision_generator.py |
| `COL_BASIS` | 2 | `COL_BASIS\|original columns 1, 2\|[[0, -1, -6], [1, 1, 3]]` | subspace_basis_generator.py |
| `COMB` | 2 | `COMB\|C(6,1)\|6` | bec_channel_generator.py |
| `COMBO` | 2 | `COMBO\|x = 5*v1 - 36*v2\|[4, -1]` | diagonalization_generator.py |
| `COMB_CONST` | 3 | `COMB_CONST\|-8\|+6\|-2` | derivative_product_quotient_generator.py, equation_from_two_points_generator.py, linear_complex_generator.py, rational_expr_add_sub_generator.py, simplify_expression_generator.py, special_solution_equation_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|C(17, 4)\|n!/(r!·(n-r)!)` | counting_classics_generator.py, permutation_combination_generator.py, stars_and_bars_generator.py |
...
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|780/1170\|2/3` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMPOSE` | 3 | `COMPOSE\|d\|f(d) = 23\|g(23) = T` | function_properties_generator.py |
| `COMPOSE_PAIR` | 3 | `COMPOSE_PAIR\|(i, 2)\|(2, M)\|(i, M)` | relation_operations_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|3x - 4 < -4 -> x < 0` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|3x - 4 < -4 or 3x - 4 > 8` | compound_inequality_generator.py |
| `CONCLUDE` | 1 | `CONCLUDE\|f ∣ p` | direct_proof_algebra_generator.py |
| `CONCLUSION_AT` | 2 | `CONCLUSION_AT\|p=F, q=F\|T` | argument_form_generator.py |
| `CONCLUSION_CHECK` | 1 | `CONCLUSION_CHECK\|not forced` | syllogism_generator.py |
| `COND_COUNT` | 2 | `COND_COUNT\|channel=web and member=no\|76` | conditional_probability_generator.py |
...
| `COND_PARTS` | 2 | `COND_PARTS\|¬(r ∨ q)\|p ∨ r` | conditional_forms_generator.py |
| `COND_SETUP` | 2, 3 | `COND_SETUP\|draw order white, blue, yellow\|counts 8 yellow, 8 white, 10 blue` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|member=no total\|29 + 76 = 105` | conditional_probability_generator.py |
...
| `CONTOUR_SETUP` | 3 | `CONTOUR_SETUP\|abs(z)=6\|positive orientation\|f=4/(z-6) - 1/(z+7) + 2/(z+3)` | contour_integral_generator.py |
...
| `COORDS` | 2 | `COORDS\|c = P^-1 x\|[5, -36]` | diagonalization_generator.py |
...
| `COSET` | 2 | `COSET\|1H\|{1, 17, 9, 41, 25, 33}` | coset_generator.py |
...
| `COUNTEREXAMPLE` | 2, 3 | `COUNTEREXAMPLE\|n = 594\|594 is divisible by 9 but not by 4` | argument_form_generator.py, conditional_forms_generator.py, counterexample_search_generator.py, truth_table_generator.py |
| `COUNTERMODEL` | 1 | `COUNTERMODEL\|kayakers=TFF, editors=TFF, bakers=TFF` | syllogism_generator.py |
...
| `COVER` | 3 | `COVER\|∅\|{h}\|no c strictly between` | partial_order_generator.py |
...
| `CROSS_MULT` | 1 | `CROSS_MULT\|12·EF = 24·8` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CROSS_RATIO` | 1 | `CROSS_RATIO\|-7/8` | mobius_transform_generator.py |
| `CROSS_RATIO_SETUP` | 4 | `CROSS_RATIO_SETUP\|z1=-3\|z2=-8\|z3=-4\|z4=-1` | mobius_transform_generator.py |
| `CRT_CHECK` | 3 | `CRT_CHECK\|i=1\|1\|1` | crt_generator.py |
| `CRT_CONGRUENCE` | 3 | `CRT_CONGRUENCE\|i=1\|x=1\|mod 3` | crt_generator.py |
| `CRT_FACTOR` | 3 | `CRT_FACTOR\|i=1\|M_i=52\|mod 3` | crt_generator.py |
| `CRT_SETUP` | 1 | `CRT_SETUP\|3 congruences` | crt_generator.py |
| `CRT_TERM` | 2 | `CRT_TERM\|i=1\|52` | crt_generator.py |
| `CRT_TOTAL_MODULUS` | 2 | `CRT_TOTAL_MODULUS\|3, 4, 13\|156` | crt_generator.py |
| `CR_SETUP` | 2 | `CR_SETUP\|u=-4x^2 + 4y^2 + 2x + y\|v=-8xy - x + 2y` | cauchy_riemann_generator.py |
...
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 + 9x^2 + 15x - 6\|critical points and their nature` | curve_analysis_generator.py |
...
| `CX_SETUP` | 2 | `CX_SETUP\|i^21\|simplify` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `CYCLIC_SUBGROUP` | 2 | `CYCLIC_SUBGROUP\|{1, 3, 9, 27, 25, 19}\|6` | cyclic_group_generator.py |
| `CYK_CELL` | 2 | `CYK_CELL\|1,2\|{E,S}` | cyk_parser_generator.py |
| `CYK_COMBINE` | 3 | `CYK_COMBINE\|C C\|{E}\|cell 1,2` | cyk_parser_generator.py |
| `CYK_RULE` | 2 | `CYK_RULE\|C\|e` | cyk_parser_generator.py |
| `CYK_SETUP` | 2 | `CYK_SETUP\|string eee\|length 3` | cyk_parser_generator.py |
| `CYK_SPAN` | 1 | `CYK_SPAN\|2` | cyk_parser_generator.py |
| `CYK_SPLIT` | 3 | `CYK_SPLIT\|cell 1,2\|1,1 x 2,2\|{C,E} x {C,E}` | cyk_parser_generator.py |
| `CYK_TERMINAL` | 3 | `CYK_TERMINAL\|cell 1,1\|e\|{C,E}` | cyk_parser_generator.py |
...
| `DATE_ORDINAL` | 2 | `DATE_ORDINAL\|2027-04-08\|740079` | calendar_arithmetic_generator.py |
...
| `DECODE` | 2 | `DECODE\|001101\|{i, k, u}` | characteristic_vector_generator.py |
...
| `DEDUCE` | 3 | `DEDUCE\|Gia\|pet = cat\|only solution left` | logic_grid_puzzle_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = -4x^3 + 3x + 4x^(-2)\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
| `DESIGN_MATRIX` | 2 | `DESIGN_MATRIX\|X = [[1, -3], [1, -1], [1, 1], [1, 3]]\|y = [3, 15, 21, 21]` | least_squares_generator.py |
...
| `DFA_INPUT` | 1 | `DFA_INPUT\|0101` | dfa_simulation_generator.py |
...
| `DIAGONAL` | 3 | `DIAGONAL\|w=128\|start=8256\|offset=53` | cantor_pairing_generator.py |
| `DIAG_FORM` | 3 | `DIAG_FORM\|P = [[1, 4], [-1, -3]]\|D = [[-3, 0], [0, -1]]\|P^-1 = [[-3, -4], [1, 1]]` | diagonalization_generator.py, matrix_exponential_generator.py |
| `DIFF_ROW` | 2 | `DIFF_ROW\|Delta y\|[9, 15, 21]` | finite_difference_generator.py |
| `DIFF_SETUP` | 3 | `DIFF_SETUP\|f(x,y) = 3*x^2 + 5*y^2 - 4*x + 6*y\|point (2, -3)\|dx=2/5, dy=-1/2` | multivar_chain_rule_generator.py |
| `DIFF_SUM` | 3 | `DIFF_SUM\|f_x*dx + f_y*dy\|8*2/5 + (-24)*(-1/2)\|15.2` | multivar_chain_rule_generator.py |
...
| `DISC` | 2, 3 | `DISC\|2025\|-28600\|30625` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `DISC_CLASSIFY` | 2 | `DISC_CLASSIFY\|64 > 0\|two real solutions` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py |
| `DIST` | 3 | `DIST\|4\|4x+5\|16x+20` | derivative_limit_def_generator.py, derivative_product_quotient_generator.py, equation_from_two_points_generator.py, function_composition_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py, polar_parametric_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_expr_add_sub_generator.py, recursive_explicit_generator.py, simplify_expression_generator.py, solid_revolution_generator.py, special_solution_equation_generator.py, tangent_line_generator.py |
| `DIST2` | 2, 3 | `DIST2\|P1\|C1\|1` | embedding_similarity_generator.py, kernel_evaluation_generator.py, kmeans_step_generator.py |
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|-8y - 26 = -10` | systems_substitution_generator.py |
...
| `DIST_TABLE` | 2 | `DIST_TABLE\|visited C\|A=inf, B=1, C=0, D=inf, E=inf` | dijkstra_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|- 6x^3 - 4x^2 + 2x` | multiplying_polynomials_generator.py |
| `DIVIDE_EQ` | 2 | `DIVIDE_EQ\|divide by y^2\|y^(-2)dy/dx + 4y^(-1) = 4` | ode_substitution_generator.py |
| `DIVMOD` | 3, 4 | `DIVMOD\|164\|2\|82\|r=0` | base_conversion_generator.py, induction_verify_generator.py, recursive_definition_unfold_generator.py |
...
| `DIV_COEFF` | 3 | `DIV_COEFF\|-2\|6\|x=-1/3` | linear_complex_generator.py |
| `DIV_SETUP` | 2 | `DIV_SETUP\|330\|2` | decimal_div_generator.py, percent_problem_generator.py |
| `DIV_SUM` | 3 | `DIV_SUM\|P_x + Q_y\|5 + 5\|10` | div_curl_generator.py |
| `DIV_TERM` | 3 | `DIV_TERM\|30t^3\|6t^2\|5t` | factor_gcf_generator.py, finite_field_generator.py, polynomial_long_division_generator.py |
| `DNF_FORM` | 1 | `DNF_FORM\|(NOT R AND NOT S AND NOT T) OR (NOT R AND S AND NOT T) OR (NOT R AND S AND T) OR (R AND NOT S AND NOT T) OR (R AND S AND NOT T) OR (R AND S AND T)` | boolean_algebra_generator.py |
...
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|denominator ≠ 0\|x^2 + 9 ≠ 0` | domain_range_generator.py |
...
| `DOT` | 2, 3 | `DOT\|(37, 12) · (0, 1)\|37*0 + 12*1\|12` | embedding_similarity_generator.py, feature_map_generator.py, fundamental_form_generator.py, gradient_generator.py, gram_schmidt_generator.py, kernel_evaluation_generator.py, line_integral_generator.py, lll_reduction_generator.py, qr_decomposition_generator.py |
...
| `DOUBLE_SETUP` | 2, 3 | `DOUBLE_SETUP\|integrand 10\|x:0..4\|y:0..4*x` | double_integral_generator.py |
...
| `DP_ITEMS` | 1 | `DP_ITEMS\|1:(w=1,v=3); 2:(w=5,v=5); 3:(w=4,v=10); 4:(w=4,v=10)` | dp_table_generator.py |
| `DP_ROW` | 2 | `DP_ROW\|i=0\|0, 0, 0, 0, 0, 0` | dp_table_generator.py |
| `DP_SETUP` | 2, 3 | `DP_SETUP\|LCS\|X=BBBB\|Y=ACDDA` | dp_table_generator.py |
| `D_POWER` | 2 | `D_POWER\|D^2\|[[81, 0], [0, 64]]` | diagonalization_generator.py |
...
| `ECDSA_SETUP` | 4 | `ECDSA_SETUP\|E/F_17, G=(5,1), n=19\|d=3\|z=1\|k=6` | ecdsa_generator.py |
| `ECDSA_SIGN` | 2 | `ECDSA_SIGN\|s=k^-1(z+rd) mod n\|s=5` | ecdsa_generator.py |
| `ECDSA_VERIFY` | 2 | `ECDSA_VERIFY\|u1=4\|u2=7` | ecdsa_generator.py |
...
| `EDGE_CHECK` | 3 | `EDGE_CHECK\|(2040, 2040)\|(k, k)\|absent` | structure_isomorphism_generator.py |
| `EDGE_CHOOSE` | 3 | `EDGE_CHOOSE\|AC\|weight 18\|add A` | mst_generator.py |
...
| `EDGE_LIST` | 1 | `EDGE_LIST\|AC, AD, AE, AF, BC, BD, BF, CE, CF, DE, DF` | euler_circuit_generator.py |
...
| `EIGEN_MATRIX` | 2 | `EIGEN_MATRIX\|A + 4I\|[[0, 2], [0, 7]]` | eigenvalue_generator.py |
...
| `ELIMINATE` | 1, 3 | `ELIMINATE\|clue 1\|Gia: canary, punch; Finn: cat, tea; Luca: gecko, water\|violates clue` | logic_grid_puzzle_generator.py, newtons_laws_generator.py |
...
| `EQ_SIMPLIFY` | 1 | `EQ_SIMPLIFY\|x + 5 = 7` | error_spotting_generator.py, fill_in_step_generator.py, linear_fractional_generator.py, two_step_equation_generator.py |
| `ESCAPE_CHECK` | 3 | `ESCAPE_CHECK\|n=1\|norm2=9/4\|bounded` | fractal_iteration_generator.py |
| `ESTIMATE` | 2 | `ESTIMATE\|85545 × 79852 ≈ 90000 × 80000\|7200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1.1 × 10^6\|1080000\|rounded estimate` | fermi_estimation_generator.py, long_division_generator.py, multi_digit_multiplication_generator.py |
| `EUCLID_DIV` | 4 | `EUCLID_DIV\|225\|215\|1\|10` | continued_fraction_generator.py, extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `EULER_BACKTRACK` | 3 | `EULER_BACKTRACK\|E\|route suffix E\|stack B-C-A-D-B-F-A-E-C-F-D` | euler_circuit_generator.py |
| `EULER_CRITERION` | 2 | `EULER_CRITERION\|51^9 mod 19\|18` | quadratic_residue_generator.py |
...
| `EULER_ROUTE` | 2 | `EULER_ROUTE\|B-C-A-D-B-F-A-E-C-F-D-E\|uses 11 edges` | euler_circuit_generator.py |
...
| `EV_SETUP` | 2 | `EV_SETUP\|P(X=8) = 2/5; P(X=3) = 2/5; P(X=2) = 1/10; P(X=6) = 1/10\|Var(X)` | expected_value_generator.py |
| `EXACT_MATCH` | 2 | `EXACT_MATCH\|F_y = N\|x + g'(y) = x + 4*y + 1` | exact_ode_generator.py |
| `EXPAND` | 1, 2 | `EXPAND\|p = we\|p = (fz)e` | complex_locus_generator.py, direct_proof_algebra_generator.py, mobius_transform_generator.py, zf_axiom_identify_generator.py |
...
| `EXP_CELL` | 2 | `EXP_CELL\|(180·90)/300\|54` | chi_square_generator.py |
...
| `EXP_EXPAND` | 1 | `EXP_EXPAND\|(-96) × (-96)` | exponent_generator.py |
| `EXP_FORM` | 1 | `EXP_FORM\|e^(At) = P*e^(Dt)*P^-1` | euler_formula_generator.py, matrix_exponential_generator.py |
| `EXP_PARTIAL` | 3 | `EXP_PARTIAL\|-96\|-96\|9216` | exponent_generator.py |
| `EXP_RULE_APPLY` | 3, 4 | `EXP_RULE_APPLY\|negate\|6\|6` | exponent_generator.py, exponent_mixed_rules_generator.py |
...
| `EXP_RULE_SETUP` | 1 | `EXP_RULE_SETUP\|(qv)^(-6)` | exponent_generator.py, exponent_mixed_rules_generator.py, rational_exponent_generator.py |
| `EXP_RULE_SIMPLIFY` | 1 | `EXP_RULE_SIMPLIFY\|1/(qv)^6` | exponent_generator.py, exponent_mixed_rules_generator.py |
| `EXP_SETUP` | 2 | `EXP_SETUP\|-96\|2` | exponent_generator.py |
| `EXP_SUB` | 3 | `EXP_SUB\|t/tau\|4\|e^-4` | transient_circuit_generator.py |
| `EXP_VALUE` | 2 | `EXP_VALUE\|exp(-z)\|1` | activation_generator.py |
| `EXT_GCD_SETUP` | 2 | `EXT_GCD_SETUP\|225\|215` | extended_euclid_generator.py, modular_inverse_generator.py, rsa_generator.py |
...
| `FACTOR` | 1, 2 | `FACTOR\|p = f(ze)` | direct_proof_algebra_generator.py, polynomial_inequality_generator.py, second_order_ode_generator.py, transfer_function_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
| `FACTOR_FORM` | 2 | `FACTOR_FORM\|60\|2^2 * 3 * 5` | totient_generator.py |
| `FACTOR_FOUND` | 2 | `FACTOR_FOUND\|2\|2` | totient_generator.py |
| `FACTOR_GROUP` | 3 | `FACTOR_GROUP\|9y^2 + 3y\|3y\|(3y + 1)` | conic_standard_form_generator.py, curve_analysis_generator.py, derivative_limit_def_generator.py, factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `FERMAT_SETUP` | 3 | `FERMAT_SETUP\|prime 17\|base 76\|exponent 102` | totient_generator.py |
...
| `FIN_SETUP` | 3 | `FIN_SETUP\|loan balance = 1000\|payment = 85, annual rate = 12%\|one-payment breakdown` | finance_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|((f ∨ h) ∧ f) ∨ (¬h ∧ ¬m)` | error_spotting_generator.py, foundations_critic_generator.py |
...
| `FLUX_SUM` | 2 | `FLUX_SUM\|(-2 + 0 - 2)*40\|-160` | vector_theorem_generator.py |
...
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(1 + √5)(3 + √5)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FORM` | 2 | `FORM\|contrapositive\|¬(p ∨ r) → ¬¬(r ∨ q)` | conditional_forms_generator.py, zf_axiom_identify_generator.py |
...
| `FRACTAL_SETUP` | 4 | `FRACTAL_SETUP\|mandelbrot\|z0=(0,0)\|c=(-3/2,0)\|N=6` | fractal_iteration_generator.py |
...
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|36/-21\|-12/7` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|43/40\|1.075` | fraction_decimal_percent_converter.py, simple_probability_generator.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Apple: 4, Banana: 10, Cherry: 3, Grape: 9\|most frequent category` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(p · q)(1)\|p(1) · q(1)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|x: 2, 3, 4, 5, 8; h(x): 8, 14, -6, -1, 3\|h(8)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
...
| `GCD_DIV` | 4 | `GCD_DIV\|6795\|450\|15\|45` | rationals_as_pairs_generator.py |
| `GCD_DONE` | 1 | `GCD_DONE\|45` | rationals_as_pairs_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|30, 6\|6` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEOM_SETUP` | 2 | `GEOM_SETUP\|p = 7/10, q = 3/10\|P(X = 8)` | geometric_distribution_generator.py |
| `GEO_PROB_FORMULA` | 1 | `GEO_PROB_FORMULA\|probability = favorable length / total length` | geometric_probability_generator.py |
| `GEO_PROB_SETUP` | 2 | `GEO_PROB_SETUP\|number line from 0 to 36\|lands between 21 and 26` | geometric_probability_generator.py |
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude to hypotenuse; segments p = 98 (adjacent to the leg) and q = 45\|the leg adjacent to p` | geometric_mean_generator.py |
| `GF2_XOR` | 3 | `GF2_XOR\|quotient x\|0 xor 1\|1` | finite_field_generator.py |
| `GF_DIV_CHECK` | 3 | `GF_DIV_CHECK\|10 / 3\|not integer\|reject` | generating_function_generator.py |
| `GF_EXPAND` | 2 | `GF_EXPAND\|1/(1 - x^2)\|sum x^(2i), i >= 0` | generating_function_generator.py |
| `GF_SETUP` | 2 | `GF_SETUP\|[x^12]\|1/((1 - x^2)(1 - x^3))` | generating_function_generator.py |
...
| `GOAL` | 1 | `GOAL\|show g + 1 is even` | direct_proof_algebra_generator.py, point_slope_generator.py, standard_form_conversion_generator.py |
| `GODEL_DECODE` | 2 | `GODEL_DECODE\|1, 7, 1\|¬ q ¬` | godel_numbering_generator.py |
...
| `GRAD_SETUP` | 3 | `GRAD_SETUP\|f(x,y) = 3*x^2 + 5*y^2 - x*y - 5*x - 3*y\|point (2, 4)\|tangent` | gradient_generator.py |
| `GRAPH_CHANGE` | 3 | `GRAPH_CHANGE\|Jan\|Feb\|0` | graph_interpret_generator.py |
| `GRAPH_DATA` | 2 | `GRAPH_DATA\|line_graph\|Jan:27,Feb:31,Mar:29,Apr:26,May:29,Jun:29,Jul:35` | graph_interpret_generator.py |
| `GRAPH_MAX` | 2 | `GRAPH_MAX\|max\|35` | graph_interpret_generator.py |
...
| `GRAPH_READ` | 2 | `GRAPH_READ\|Jan\|27` | graph_interpret_generator.py |
...
| `GROUP` | 2 | `GROUP\|(9y^2 + 3y)\|(-12y - 4)` | factor_grouping_generator.py, factor_trinomial_generator.py |
...
| `GS_SETUP` | 2 | `GS_SETUP\|vectors [[2, 0, 2], [7, 0, 5], [-8, -1, -4]]\|orthogonal basis, not normalized` | gram_schmidt_generator.py |
...
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|2x^4 + x^3 + x^2 - 4x + 5\|x = 3` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: μ = 75; Ha: μ ≠ 75\|n = 25, x̄ = 66, s = 25, critical value = 2.576` | hypothesis_test_generator.py, two_sample_test_generator.py |
...
| `HYPERBOLIC_DISTANCE_SETUP` | 3 | `HYPERBOLIC_DISTANCE_SETUP\|disk\|P=(0,0)\|Q=(15/17,0)` | hyperbolic_distance_generator.py |
| `HYPERBOLIC_SETUP` | 2 | `HYPERBOLIC_SETUP\|e^x=26/17\|e^(-x)=17/26` | hyperbolic_function_generator.py |
...
| `IDENTITY` | 2 | `IDENTITY\|Vandermonde\|Σ C(14,i)C(3,16-i) = C(17,16)` | counting_classics_generator.py, function_inner_product_generator.py, index_gymnastics_generator.py |
...
| `IE_SETUP` | 2 | `IE_SETUP\|n(A)=21, n(B)=49, n(C)=32\|n(AB)=12, n(AC)=10, n(BC)=17, n(ABC)=5` | inclusion_exclusion_generator.py |
...
| `IMAGE` | 2 | `IMAGE\|j\|15` | function_properties_generator.py, mobius_transform_generator.py |
...
| `INDEX` | 3 | `INDEX\|G size 24\|H size 6\|4` | coset_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|add\|1\|-1 ≤ 1x ≤ 3` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
| `INEQ_OP_BOTH` | 4 | `INEQ_OP_BOTH\|add\|14\|x\|11` | domain_range_generator.py, linear_fractional_generator.py, one_step_inequality_generator.py, two_step_inequality_generator.py |
...
| `INEQ_SETUP` | 1 | `INEQ_SETUP\|x - 14 ≥ -3` | linear_fractional_generator.py, one_step_inequality_generator.py, polynomial_inequality_generator.py, two_step_inequality_generator.py |
| `INEQ_SIMPLIFY` | 1 | `INEQ_SIMPLIFY\|x + 7 ≥ -1` | domain_range_generator.py, linear_fractional_generator.py, two_step_inequality_generator.py |
...
| `INITIAL_COEFF` | 2 | `INITIAL_COEFF\|a_0\|19920` | series_solution_generator.py |
| `INITIAL_EQ` | 2 | `INITIAL_EQ\|C1 + C2\|6` | recurrence_generator.py |
| `INITIAL_SYSTEM` | 2 | `INITIAL_SYSTEM\|C1[2, 1] + C2[1, 1]\|[11, 7]` | ode_system_generator.py |
| `INNER_ANTIDERIV` | 2 | `INNER_ANTIDERIV\|dx\|10*x` | double_integral_generator.py, triple_integral_generator.py |
| `INNER_EVAL` | 2, 3 | `INNER_EVAL\|x=y/4..4\|10*(4 - y/4)` | double_integral_generator.py, triple_integral_generator.py |
...
| `INSERT_PLACE` | 2 | `INSERT_PLACE\|index 1\|22, 26, 5, 31, 16` | algorithm_trace_generator.py |
...
| `INT_OP` | 4 | `INT_OP\|÷\|12\|12\|1` | integer_operations_generator.py |
| `INT_REWRITE` | 2 | `INT_REWRITE\|-10 - (-5)\|-10 + 5` | integer_operations_generator.py |
...
| `INVERSE_PAIR` | 2 | `INVERSE_PAIR\|(c, 5)\|(5, c)` | function_properties_generator.py, relation_operations_generator.py |
...
| `ITERATE` | 2 | `ITERATE\|n=1\|z=(-3/2,0)` | fractal_iteration_generator.py, gradient_descent_generator.py |
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 + 3x - 4 on [-4, 0]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
...
| `JACOBI_SETUP` | 3 | `JACOBI_SETUP\|a=38\|n=63\|n odd` | jacobi_symbol_generator.py |
| `JACOBI_SWAP` | 3 | `JACOBI_SWAP\|a=63\|n=19\|sign -1` | jacobi_symbol_generator.py |
| `JACOBI_TWO_RULE` | 3 | `JACOBI_TWO_RULE\|n mod 8 = 7\|keep sign\|sign 1` | jacobi_symbol_generator.py |
| `JAC_DET` | 3 | `JAC_DET\|x_u*y_v - x_v*y_u\|(-3)*(-2) - 3*5\|-9` | jacobian_generator.py |
| `JAC_MATRIX` | 2 | `JAC_MATRIX\|[[x_u, x_v], [y_u, y_v]]\|[[-3, 3], [5, -2]]` | jacobian_generator.py, rv_transform_generator.py |
| `JAC_SETUP` | 3 | `JAC_SETUP\|x = -3*u + 3*v\|y = 5*u - 2*v\|d(x,y)/d(u,v)` | jacobian_generator.py |
...
| `KIN_SETUP` | 3, 4 | `KIN_SETUP\|v_i = 8 m/s\|v_f = 17 m/s, t = 3 s\|acceleration` | invariant_mass_generator.py, kinematics_generator.py |
...
| `KMAP_GROUP` | 2 | `KMAP_GROUP\|000, 001, 010, 011\|NOT L` | boolean_algebra_generator.py |
| `KMAP_ROW` | 2 | `KMAP_ROW\|L=0\|1, 1, 1, 1` | boolean_algebra_generator.py |
| `KMAP_SETUP` | 2 | `KMAP_SETUP\|rows L=0,L=1\|columns MN=00,MN=01,MN=11,MN=10` | boolean_algebra_generator.py |
| `KMAP_SIMPLIFY` | 1 | `KMAP_SIMPLIFY\|NOT L OR NOT M` | boolean_algebra_generator.py |
...
| `LAMBDA_SETUP` | 2 | `LAMBDA_SETUP\|(((lambda d. (lambda b. (lambda t. (lambda p. ((d t) ((b t) p)))))) (lambda f. (lambda a. a))) (lambda h. (lambda s. (h s))))\|leftmost-outermost` | lambda_reduction_generator.py |
...
| `LAURENT_SETUP` | 3 | `LAURENT_SETUP\|center a=-4\|w=(z+4)\|f=4/(z+9)` | laurent_series_generator.py |
| `LAURENT_TERM` | 1 | `LAURENT_TERM\|1(z+4)^-1` | residue_generator.py |
| `LAW` | 3 | `LAW\|distributive ∨ over ∧\|¬u ∨ (¬s ∧ ¬r)\|(¬u ∨ ¬s) ∧ (¬u ∨ ¬r)` | logical_equivalence_laws_generator.py, set_algebra_laws_generator.py |
| `LAYERNORM_SETUP` | 3 | `LAYERNORM_SETUP\|x=(2,12)\|gamma=(2,3)\|beta=(-5,-1)` | layer_norm_generator.py |
| `LB` | 2 | `LB\|{19, 33}\|∅` | partial_order_generator.py |
...
| `LEGENDRE_SETUP` | 2 | `LEGENDRE_SETUP\|a=51\|p=19` | legendre_construction_generator.py, quadratic_residue_generator.py |
| `LEVEL` | 2 | `LEVEL\|y\|78904` | type_theory_generator.py |
...
| `LIMIT_SETUP` | 1, 2 | `LIMIT_SETUP\|lim x→∞ of (-6x^2 + 4x + 5)/(6x^2 + 2x - 4)\|compare degrees` | derivative_limit_def_generator.py, improper_integral_generator.py, lhopital_generator.py, limit_evaluation_generator.py, power_series_generator.py, series_convergence_generator.py |
| `LINEAR_SYSTEM` | 2 | `LINEAR_SYSTEM\|a=3/4, b=-1/6\|c=-1/7, d=6/7` | markov_chain_generator.py |
| `LINE_EQ` | 1 | `LINE_EQ\|18x + 4y + 7 = 0` | complex_locus_generator.py |
| `LINE_INTEGRAL` | 3 | `LINE_INTEGRAL\|int_0^1 dot dt\|-3/2 + 12\|21/2` | line_integral_generator.py |
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|perpendicular\|y = 2x - 4\|(-6, 2)` | parallel_perpendicular_line_generator.py |
| `LINE_SETUP` | 2 | `LINE_SETUP\|F(x,y) = <2*x - 2*y + 4, 8*y - 2*x + 3>\|from (0, -1) to (-4, -4)` | line_integral_generator.py |
| `LIST_MAX` | 2 | `LIST_MAX\|13/20, 20/17, 4/3\|4/3` | dedekind_cut_generator.py |
| `LLL_DONE` | 1 | `LLL_DONE\|[(0,-5),(5,2)]` | lll_reduction_generator.py |
| `LLL_SETUP` | 1 | `LLL_SETUP\|[(0,-5),(5,-13)]` | lll_reduction_generator.py |
| `LOCUS_SETUP` | 3 | `LOCUS_SETUP\|z=x+iy\|center=(-1,4)\|radius=1` | complex_locus_generator.py |
...
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(2x)) = ln(44)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
...
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_5(x^4y^4) - log_5(z^2)\|log_5(x^4y^4/z^2)` | log_properties_generator.py |
| `LOG_SETUP` | 1, 2 | `LOG_SETUP\|4log_5(x) + 4log_5(y) - 2log_5(z)\|condense` | complex_log_generator.py, log_properties_generator.py |
...
| `LS_LINE` | 2 | `LS_LINE\|a = 15, b = 3\|ŷ = 15 + 3x` | least_squares_generator.py |
| `LS_SETUP` | 2 | `LS_SETUP\|points [(-3, 3), (-1, 15), (1, 21), (3, 21)]\|model y = a + bx` | least_squares_generator.py |
...
| `LU_RESULT` | 2 | `LU_RESULT\|L\|[[1, 0, 0], [-3, 1, 0], [-3, -1, 1]]` | lu_decomposition_generator.py |
| `LU_SETUP` | 2 | `LU_SETUP\|A = [[4, -4, 0], [-12, 11, -5], [-12, 13, 1]]\|unit lower L` | lu_decomposition_generator.py |
...
| `MAP` | 2 | `MAP\|f\|f(f) = 7` | function_properties_generator.py |
...
| `MATRIX_ROW` | 2 | `MATRIX_ROW\|i\|0 1` | graph_counting_generator.py, relation_operations_generator.py |
...
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[3, 0], [1, 5]], v = [[-1], [-5]]\|Av` | determinant_generator.py, diagonalization_generator.py, eigenvalue_generator.py, matrix_exponential_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py, subspace_basis_generator.py, svd_generator.py |
| `MAX` | 2, 3 | `MAX\|1, 6\|6` | dp_table_generator.py, matrix_norm_generator.py, taxicab_geometry_generator.py |
| `MAXIMAL` | 1 | `MAXIMAL\|{4, 31, 38, 49}` | partial_order_generator.py |
...
| `MEASURE_FAVORABLE` | 2 | `MEASURE_FAVORABLE\|interval length\|26 - 21 = 5` | geometric_probability_generator.py |
| `MEASURE_PROB` | 3 | `MEASURE_PROB\|computational basis\|P(01)=1\|all other outcomes 0` | quantum_gate_generator.py |
| `MEASURE_TOTAL` | 2 | `MEASURE_TOTAL\|total length\|36` | geometric_probability_generator.py |
...
| `MEMBER` | 1 | `MEMBER\|43/22 ∉ L(√2)` | dedekind_cut_generator.py |
| `MEMBERSHIP_BAD` | 2 | `MEMBERSHIP_BAD\|type(j) = type(j) + 1\|impossible` | type_theory_generator.py |
| `MEMBERSHIP_OK` | 1 | `MEMBERSHIP_OK\|type(k) = type(j) + 1` | type_theory_generator.py |
| `MEMBER_ROW` | 1, 3 | `MEMBER_ROW\|x∈H, x∈V, x∈X` | foundations_critic_generator.py, set_identity_membership_table_generator.py |
...
| `MERGE_BEGIN` | 3 | `MERGE_BEGIN\|merge 1\|lo=1,mid=2,hi=3\|left 10; right 43` | algorithm_trace_generator.py |
| `MERGE_COMPARE` | 3 | `MERGE_COMPARE\|10\|43\|take left` | algorithm_trace_generator.py |
| `MERGE_DONE` | 3 | `MERGE_DONE\|merge 1\|range 1-2\|array 6, 10, 43, 44, 39, 14, 29` | algorithm_trace_generator.py |
...
| `MINIMAL` | 1 | `MINIMAL\|{4, 26, 31, 44}` | partial_order_generator.py |
...
| `MOBIUS_SETUP` | 2 | `MOBIUS_SETUP\|T(z)=(40)/(2z + 2)\|fixed points` | mobius_transform_generator.py |
...
| `MODEL_APPLY` | 1 | `MODEL_APPLY\|A = 3375e^1.12` | exponential_model_generator.py |
| `MODEL_OUTPUT` | 1 | `MODEL_OUTPUT\|67` | activation_generator.py |
| `MODEXP_MULTIPLY` | 2 | `MODEXP_MULTIPLY\|bit 1=1\|44` | mod_exp_generator.py, quadratic_residue_generator.py |
| `MODEXP_SETUP` | 3 | `MODEXP_SETUP\|base 44\|exponent 48\|modulus 69` | mod_exp_generator.py |
| `MODEXP_SQUARE` | 2 | `MODEXP_SQUARE\|bit 1=1\|1` | mod_exp_generator.py, quadratic_residue_generator.py |
| `MODEXP_STATE` | 2 | `MODEXP_STATE\|after bit 1\|44` | mod_exp_generator.py, quadratic_residue_generator.py |
| `MODE_COUNT` | 2 | `MODE_COUNT\|1\|1` | simple_stats_generator.py |
| `MOD_INVERSE` | 2 | `MOD_INVERSE\|108 mod 43\|2` | crt_generator.py, ecdsa_generator.py, elliptic_curve_finite_field_generator.py, modular_inverse_generator.py, rsa_generator.py |
| `MOD_NORMALIZE` | 3 | `MOD_NORMALIZE\|2\|mod 43\|2` | modular_inverse_generator.py, rsa_generator.py |
| `MOD_POWER` | 3 | `MOD_POWER\|37^7\|mod 36\|1` | diffie_hellman_generator.py, pollard_factorization_generator.py, primality_test_generator.py, rsa_generator.py, tonelli_shanks_generator.py, totient_generator.py |
...
| `MOD_SETUP` | 2, 3, 4 | `MOD_SETUP\|Luhn modulus 10\|prefix 4162663` | modular_arithmetic_generator.py, modular_inverse_generator.py |
...
| `MOMENT_X` | 3 | `MOMENT_X\|M_x = 1/2 int y^2 dx\|8^2*6^5/10\|248832/5` | centroid_generator.py |
| `MOMENT_Y` | 3 | `MOMENT_Y\|M_y = int x*y dx\|8*6^4/4\|2592` | centroid_generator.py |
...
| `MONO_SETUP` | 1 | `MONO_SETUP\|(6x)(-2x^4)` | monomial_mult_div_generator.py |
...
| `MUL_TERM` | 3 | `MUL_TERM\|10\|7.6x\|76x` | linear_fractional_generator.py, polynomial_long_division_generator.py, rational_equation_generator.py |
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 + 6x - 1 on [-2, 6]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `MV_CHAIN_SETUP` | 3 | `MV_CHAIN_SETUP\|z = f(x,y) = 2*x^2 + 4*y^2 + 3*x*y + 5*x - 5*y\|x = -3*t + 2, y = 2*t + 5\|t = 0` | multivar_chain_rule_generator.py |
...
| `NEED` | 2 | `NEED\|line 3 shows 9x = -54\|line 5 shows x = -6` | fill_in_step_generator.py |
| `NEGATE` | 2 | `NEGATE\|222\|-222` | countability_bijection_generator.py |
...
| `NET_SETUP` | 2 | `NET_SETUP\|2 right triangles with legs 3 and 4; rectangles 3 by 9, 4 by 9, and 5 by 9\|total surface area` | nets_surface_area_generator.py |
...
| `NEW_STRING` | 1 | `NEW_STRING\|1011011010` | cantor_diagonal_generator.py |
| `NFA_ACCEPT` | 1 | `NFA_ACCEPT\|q7` | nfa_simulation_generator.py |
| `NFA_ACTIVE` | 2 | `NFA_ACTIVE\|start\|{q0,q6}` | nfa_simulation_generator.py |
| `NFA_EPSILON` | 2 | `NFA_EPSILON\|q0\|{q6}` | nfa_simulation_generator.py |
| `NFA_INPUT` | 1 | `NFA_INPUT\|bba` | nfa_simulation_generator.py |
| `NFA_MOVE` | 4 | `NFA_MOVE\|{q0,q6}\|b\|q0->{}; q6->{q7}\|{q7}` | nfa_simulation_generator.py |
| `NFA_READ` | 2 | `NFA_READ\|pos 1\|b` | nfa_simulation_generator.py |
| `NFA_SETUP` | 3 | `NFA_SETUP\|states q0, q6, q7\|alphabet a, b\|start q0` | nfa_simulation_generator.py |
...
| `NORMALIZE_SIGN` | 2 | `NORMALIZE_SIGN\|(-4,7)\|(4,-7)` | lll_reduction_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(92, 20)\|raw value for z = -0.15` | matrix_norm_generator.py, normal_table_generator.py, z_score_generator.py |
...
| `NO_REDEX` | 2 | `NO_REDEX\|lambda t. (lambda p. (t p))\|no beta redex remains` | lambda_reduction_generator.py |
| `NO_WITNESS` | 2, 3 | `NO_WITNESS\|x=28\|tried y in {25, 26, 28, 29}` | peano_arithmetic_generator.py, quantifier_finite_domain_generator.py |
...
| `ODE_SETUP` | 2, 3 | `ODE_SETUP\|dy/dt = ky; y doubles every 51 hours\|find k exactly` | euler_method_generator.py, exact_ode_generator.py, integrating_factor_generator.py, laplace_ivp_generator.py, logistic_growth_generator.py, ode_substitution_generator.py, ode_system_generator.py, runge_kutta_generator.py, second_order_ode_generator.py, separable_ode_generator.py, series_solution_generator.py, stability_generator.py, undetermined_coeff_generator.py, variation_parameters_generator.py |
...
| `OPT_SETUP` | 2 | `OPT_SETUP\|square sheet 1056 by 1056; cut corners x and fold\|maximize volume` | optimization_generator.py |
...
| `ORDER_PAIR` | 2 | `ORDER_PAIR\|∅ ≤ {h}\|∅ ⊆ {h}` | partial_order_generator.py |
...
| `OUTER_EVAL` | 3 | `OUTER_EVAL\|y=0..16\|10*4*4^2/2\|320` | double_integral_generator.py |
...
| `PARALLEL_RELATION` | 1 | `PARALLEL_RELATION\|(3x + 20) + (4x + 55) = 180` | angle_relationships_generator.py |
...
| `PARALLEL_SOLVE` | 2 | `PARALLEL_SOLVE\|7x + 75 = 180\|x = 15` | angle_relationships_generator.py |
...
| `PARAM_PATH` | 3 | `PARAM_PATH\|r(t)\|(t - 4, 1)\|0 <= t <= 1` | line_integral_generator.py |
| `PARAM_SETUP` | 2, 3 | `PARAM_SETUP\|x = 12cos t - 13, y = 12sin t + 13\|eliminate t` | param_count_generator.py, parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(-3x + 4)/(x - 2)^2 = A/(x - 2) + B/(x - 2)^2` | partial_fractions_generator.py, telescoping_generator.py |
...
| `PARTIAL_FRAC` | 2 | `PARTIAL_FRAC\|Y(s)\|2/(s + 4) - 3/(s - 4)` | laplace_ivp_generator.py |
| `PARTIAL_RESULT` | 2 | `PARTIAL_RESULT\|f_y\|8*x^3*y + 12*x^2*y^3` | div_curl_generator.py, exact_ode_generator.py, gradient_generator.py, hessian_classify_generator.py, jacobian_generator.py, lagrange_multiplier_generator.py, line_integral_generator.py, multivar_chain_rule_generator.py, partial_derivative_generator.py, vector_theorem_generator.py |
| `PARTIAL_RULE` | 3 | `PARTIAL_RULE\|4*x^3*y^2\|d/dy\|8*x^3*y` | partial_derivative_generator.py |
| `PARTIAL_SETUP` | 2 | `PARTIAL_SETUP\|f(x,y) = 4*x^3*y^2 + 3*x^2*y^4\|f_yy` | partial_derivative_generator.py |
...
| `PARTITION` | 1 | `PARTITION\|{{4, 33}, {6, 26, 27, 40, 53}}` | equivalence_relation_generator.py |
...
| `PARTS_CHOOSE` | 2 | `PARTS_CHOOSE\|u = 61x, dv = e^(-x) dx\|du = 61 dx, v = -e^(-x)` | integration_by_parts_generator.py |
...
| `PASCAL_SETUP` | 1 | `PASCAL_SETUP\|9C4` | pascal_triangle_generator.py |
| `PATH` | 2 | `PATH\|22→31→28\|add (22, 28)` | relation_closure_generator.py |
...
| `PEANO_EQ` | 2 | `PEANO_EQ\|SSSSSS0^SS0\|SSSSSS0^S0 · SSSSSS0` | peano_arithmetic_generator.py |
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.845\|2505\|2116.725` | percent_problem_generator.py |
...
| `PERM_RESULT` | 1 | `PERM_RESULT\|[2, 1, 3, 4, 5]` | permutation_group_generator.py |
| `PERM_SETUP` | 2, 3 | `PERM_SETUP\|P(8, 7)\|n!/(n-r)!` | permutation_combination_generator.py, permutation_group_generator.py |
...
| `PHYS_SETUP` | 3 | `PHYS_SETUP\|W = 975 joules\|d = 13 meters\|force` | physics_formula_generator.py |
...
| `PICTO_COUNT` | 2 | `PICTO_COUNT\|Tigers\|3` | graph_interpret_generator.py |
...
| `POINT_FROM_LAMBDA` | 3 | `POINT_FROM_LAMBDA\|x\|12/2\|6` | lagrange_multiplier_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y - 4 = -5(x - 0)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_FORM` | 1 | `POLAR_FORM\|11sqrt2 cis(225 deg)` | euler_formula_generator.py |
| `POLAR_FORMULA` | 1 | `POLAR_FORMULA\|x = r cos θ, y = r sin θ` | polar_parametric_generator.py |
| `POLAR_SETUP` | 2, 3 | `POLAR_SETUP\|r = 18 cos θ\|pole=(-12, -7)\|rectangular equation` | parametric_calculus_generator.py, polar_parametric_generator.py |
...
| `POLISH` | 1 | `POLISH\|KqANpKrp` | wff_parsing_generator.py |
...
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|3x^3 + 14x^2 + 27x + 17\|3x + 5` | finite_field_generator.py, polynomial_long_division_generator.py |
...
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|9x^2 - x` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(8x^6 - 32x^5 - 8x^3) / (-8x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(8x^6) / (-8x^3) + (-32x^5) / (-8x^3) + (-8x^3) / (-8x^3)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(9x^2) + (-x)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_INPUT` | 2 | `POLY_INPUT\|f(x)\|2x^3 + 2x^2` | finite_field_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x + 5)(-3x^2 - 2x + 1)` | multiplying_polynomials_generator.py |
...
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-x) + (9x^2)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2, 3 | `POLY_SUB\|(3x^3 + 14x^2) - (3x^3 + 5x^2)\|9x^2` | legendre_construction_generator.py, polynomial_long_division_generator.py |
...
| `POTENTIAL_BUILD` | 3 | `POTENTIAL_BUILD\|integrate P dx\|x^2 - 2*x*y + 4*x + g(y)\|g'(y) remains` | exact_ode_generator.py, line_integral_generator.py |
| `POTENTIAL_RESULT` | 2 | `POTENTIAL_RESULT\|phi(x,y)\|x^2 + 4*y^2 - 2*x*y + 4*x + 3*y` | exact_ode_generator.py, line_integral_generator.py |
...
| `POWER_REDUCE` | 2 | `POWER_REDUCE\|37^127\|37^7 mod 36` | totient_generator.py |
...
| `POWER_SETUP` | 2 | `POWER_SETUP\|(e^(i*146 deg))^(-i)\|principal logarithm` | complex_log_generator.py |
...
| `PREDICATES` | 1 | `PREDICATES\|R(x): x is a student; G(y): y is a volunteer; Y(x, y): x questions y` | english_to_logic_generator.py |
| `PREDICT` | 2 | `PREDICT\|x*\|-15/16` | kernel_ridge_generator.py |
| `PREIMAGE` | 2 | `PREIMAGE\|26\|{l, o, t}` | function_properties_generator.py |
| `PREMISE` | 2 | `PREMISE\|1\|m ∧ k` | natural_deduction_generator.py |
...
| `PRIM_CANDIDATES` | 2 | `PRIM_CANDIDATES\|visited C\|AC=18, CD=21` | mst_generator.py |
| `PRIM_START` | 1 | `PRIM_START\|C` | mst_generator.py |
| `PRINCIPAL_LOG` | 1 | `PRINCIPAL_LOG\|ln(248) + i*137pi/180` | complex_log_generator.py |
...
| `PROB_CONDITIONAL` | 2 | `PROB_CONDITIONAL\|P(less than 9 given first was less than 9)\|7/11` | compound_probability_generator.py |
| `PROB_DEPENDENT` | 1 | `PROB_DEPENDENT\|Drawing without replacement means dependent events` | compound_probability_generator.py |
| `PROB_DESCRIBE` | 1 | `PROB_DESCRIBE\|Draw with replacement: red, then yellow, then yellow` | compound_probability_generator.py |
| `PROB_IDENTIFY` | 2 | `PROB_IDENTIFY\|P(draw 1 is red)\|1/5` | compound_probability_generator.py |
...
| `PROB_MULTIPLY` | 3 | `PROB_MULTIPLY\|1/5\|1/20\|1/100` | compound_probability_generator.py |
...
| `PROB_SIMPLIFY` | 2 | `PROB_SIMPLIFY\|56/132\|14/33` | compound_probability_generator.py |
...
| `PROJECTION` | 2 | `PROJECTION\|X*beta\|[6, 12, 18, 24]` | least_squares_generator.py, legendre_construction_generator.py |
...
| `PYTHAG_CALCULATE` | 2 | `PYTHAG_CALCULATE\|d² = 2916 + 529984 = 532900\|532900` | pythag_leg_generator.py |
| `PYTHAG_CONTEXT` | 3 | `PYTHAG_CONTEXT\|displacement\|east=54m, north=728m\|diagram=NWG` | pythag_leg_generator.py |
| `PYTHAG_FORMULA` | 1 | `PYTHAG_FORMULA\|a² + b² = c²` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_MODEL` | 3 | `PYTHAG_MODEL\|east=54\|north=728\|distance=?` | pythag_leg_generator.py |
| `PYTHAG_ROOT` | 2 | `PYTHAG_ROOT\|100\|10` | pythag_leg_generator.py |
| `PYTHAG_SETUP` | 2, 3 | `PYTHAG_SETUP\|legs=144,60\|hypotenuse YW=?` | pythag_hyp_generator.py, pythag_leg_generator.py |
| `PYTHAG_SOLVE` | 2 | `PYTHAG_SOLVE\|b² = 676 - 576\|100` | pythag_leg_generator.py |
| `PYTHAG_SQUARE` | 2 | `PYTHAG_SQUARE\|24\|576` | pythag_leg_generator.py |
| `PYTHAG_SUBSTITUTE` | 1 | `PYTHAG_SUBSTITUTE\|24² + b² = 26²` | pythag_leg_generator.py |
| `Q1` | 4 | `Q1\|45\|175\|10\|22` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|45\|175\|10\|-13` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QN_ADD` | 4 | `QN_ADD\|Q\|left\|0 + mu-(-1)\|-1` | conservation_law_generator.py |
| `QR_ENTRY` | 2 | `QR_ENTRY\|q1\|[1, 0, 0]` | qr_decomposition_generator.py |
| `QR_SETUP` | 2 | `QR_SETUP\|A = [[5, -2, 1], [0, 4, -1], [0, 0, 4]]\|Gram-Schmidt columns` | qr_decomposition_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|225°\|quadrant III` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
| `QUADRATIC` | 3 | `QUADRATIC\|2\|2\|-40` | mobius_transform_generator.py |
...
| `QUANT_CASE` | 1, 2 | `QUANT_CASE\|x=25` | quantifier_finite_domain_generator.py |
...
| `QUARTILE` | 3 | `QUARTILE\|Q1\|6,8,12\|8` | five_number_summary_generator.py |
...
| `QUAT_RESULT` | 2 | `QUAT_RESULT\|q*v\|(-3,2,-2,0)` | quaternion_generator.py |
| `QUAT_SETUP` | 2 | `QUAT_SETUP\|q=(0,0,0,1)\|v=(0,-2,-2,3)` | quaternion_generator.py |
...
| `RANGE` | 1 | `RANGE\|{4, 5, 20, 24, 25}` | relation_operations_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|cube: ds/dt = 8 in/min; s = 14 in\|dV/dt` | related_rates_generator.py |
| `RATIO` | 2, 3 | `RATIO\|y = x\|y = x` | lagrange_multiplier_generator.py, simplex_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|(34 - √395)/(34 - √395)` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
| `RATIO_BASE` | 3 | `RATIO_BASE\|44:36\|4\|11:9` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
| `RATIO_TABLE` | 2 | `RATIO_TABLE\|Water (oz): 11, 44, 110, 121\|Concentrate (oz): ?, 36, 90, 99` | error_spotting_generator.py, fill_in_step_generator.py, ratio_table_generator.py |
| `RAW_FORMULA` | 1 | `RAW_FORMULA\|x = μ + z·σ` | z_score_generator.py |
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 7968 / 1.66` | percent_problem_generator.py |
...
| `REC_SETUP` | 1, 2 | `REC_SETUP\|a_n = 2 a_(n-1) + 8 a_(n-2) + 9\|a_0 = 5, a_1 = 11` | master_theorem_generator.py, recurrence_generator.py |
| `REDUCE` | 2, 3 | `REDUCE\|(226, 205)\|(21, 0)` | integers_as_pairs_generator.py, rationals_as_pairs_generator.py |
...
| `REGEX_ACCEPT` | 1 | `REGEX_ACCEPT\|q68759_1` | regex_to_automaton_generator.py |
| `REGEX_SETUP` | 3 | `REGEX_SETUP\|a*b\|alphabet a,b\|canonical progress DFA` | regex_to_automaton_generator.py |
| `REGEX_STATE` | 2 | `REGEX_STATE\|q68759_0\|still reading a*` | regex_to_automaton_generator.py |
| `REGEX_TRANSITION` | 3 | `REGEX_TRANSITION\|q68759_0\|a\|q68759_0` | regex_to_automaton_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 51), (2, 57), (3, 54), (4, 63), (5, 60)\|coefficient of determination r^2` | regression_generator.py |
| `REJECT` | 1, 2 | `REJECT\|x = −11` | cantor_pairing_generator.py, conditional_forms_generator.py, counterexample_search_generator.py, factor_trinomial_generator.py, knights_knaves_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py, set_builder_roster_generator.py, structure_isomorphism_generator.py |
| `RELAX` | 3 | `RELAX\|C->B\|update inf to 1\|via weight 1` | dijkstra_generator.py |
...
| `REL_SETUP` | 2, 3 | `REL_SETUP\|A = {4, 6, 26, 27, 33, 40, 53}\|R = {(4, 4), (4, 33), (6, 6), (6, 26), (6, 27), (6, 40), (6, 53), (26, 6), (26, 26), (26, 27), (26, 40), (26, 53), (27, 6), (27, 26), (27, 27), (27, 40), (27, 53), (33, 4), (33, 33), (40, 6), (40, 26), (40, 27), (40, 40), (40, 53), (53, 6), (53, 26), (53, 27), (53, 40), (53, 53)}` | equivalence_relation_generator.py, relation_check_generator.py, relation_closure_generator.py, relation_operations_generator.py, special_relativity_generator.py |
...
| `REPRESENT` | 2 | `REPRESENT\|f ∣ w\|w = fz` | direct_proof_algebra_generator.py |
...
| `RESIDUE_SETUP` | 2 | `RESIDUE_SETUP\|a=-4\|f=1/(z+4) - 5 + (z+4)` | residue_generator.py |
| `RESIDUE_SUM` | 1 | `RESIDUE_SUM\|2` | contour_integral_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (3, 79), line ŷ = 75.9 + 0.7x\|residual = observed − predicted` | regression_generator.py |
| `RESOLVE` | 3 | `RESOLVE\|C1\|C2\|¬P39289` | resolution_proof_generator.py |
| `RESTRICT_CHECK` | 3 | `RESTRICT_CHECK\|(b, 5)\|b in D=no\|skip` | relation_operations_generator.py |
| `RES_EMPTY` | 1 | `RES_EMPTY\|C4` | resolution_proof_generator.py |
| `RES_SETUP` | 1 | `RES_SETUP\|C1=(¬P39289), C2=(P39289), C3=(P49283 ∨ P59561)` | resolution_proof_generator.py |
| `RES_SKIP` | 3 | `RES_SKIP\|C1\|C3\|(P25354)` | resolution_proof_generator.py |
| `REVERSE` | 2 | `REVERSE\|0,0,1,0,0,1,0,1\|10100100` | base_arithmetic_generator.py, base_conversion_generator.py, bitwise_ops_generator.py |
...
| `RIEMANN_SETUP` | 2, 3 | `RIEMANN_SETUP\|f(x) = 3x - 2 on [0, 4], n = 4\|trapezoid rule` | riemann_sum_generator.py, riemann_tensor_generator.py |
...
| `ROSTER` | 2 | `ROSTER\|S\|{−9}` | set_builder_roster_generator.py |
...
| `ROW` | 2 | `ROW\|d=T, k=F, s=F\|T` | foundations_critic_generator.py |
...
| `RSA_DECRYPT` | 2 | `RSA_DECRYPT\|295\|158` | rsa_generator.py |
| `RSA_ENCRYPT` | 2 | `RSA_ENCRYPT\|158\|295` | rsa_generator.py |
| `RSA_PRIVATE_KEY` | 1 | `RSA_PRIVATE_KEY\|d=235` | rsa_generator.py |
| `RSA_PUBLIC_KEY` | 2 | `RSA_PUBLIC_KEY\|n=391\|e=3` | rsa_generator.py |
| `RSA_SETUP` | 3 | `RSA_SETUP\|p=17\|q=23\|message=158` | rsa_generator.py |
...
| `SA_FACES` | 3 | `SA_FACES\|top/bottom\|6 × 12\|72` | volume_3d_generator.py |
| `SA_FORMULA` | 1 | `SA_FORMULA\|SA = 2(lw + lh + wh)` | round_solids_generator.py, volume_3d_generator.py |
| `SA_LATERAL` | 2 | `SA_LATERAL\|2π × 30 × 20\|1200π` | volume_3d_generator.py |
| `SA_SETUP` | 2 | `SA_SETUP\|rectangular_prism\|l=6, w=12, h=10` | volume_3d_generator.py |
| `SA_TOTAL` | 2 | `SA_TOTAL\|SA = 2(72 + 60 + 120)\|504` | round_solids_generator.py, volume_3d_generator.py |
| `SB_FORMULA` | 1 | `SB_FORMULA\|C(n-1, k-1)` | stars_and_bars_generator.py |
| `SB_SETUP` | 2 | `SB_SETUP\|x1+...+x7 = 39\|xi >= 1` | stars_and_bars_generator.py |
| `SCALE_DIV` | 3 | `SCALE_DIV\|88\|8\|11` | scaling_generator.py |
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|28*cos\|14sqrt2` | de_moivre_generator.py, euler_formula_generator.py |
| `SCALE_IDENTIFY` | 2 | `SCALE_IDENTIFY\|88 feet\|scaled_dimension` | scaling_generator.py |
| `SCALE_MODE` | 3 | `SCALE_MODE\|λ = 6\|216*5\|1080` | diagonalization_generator.py |
| `SCALE_MULT` | 3 | `SCALE_MULT\|13.75\|108\|1485` | scaling_generator.py |
| `SCALE_SETUP` | 3 | `SCALE_SETUP\|1 inch\|8 feet\|8` | scaling_generator.py |
...
| `SCI_IDENTIFY` | 2 | `SCI_IDENTIFY\|7.97\|5` | exponent_generator.py |
| `SCI_MOVE_DECIMAL` | 2 | `SCI_MOVE_DECIMAL\|left\|5` | exponent_generator.py |
| `SCI_OPERATION` | 4 | `SCI_OPERATION\|divide_coefficients\|8.74\|4.6\|1.9` | exponent_generator.py |
| `SCI_SETUP` | 1 | `SCI_SETUP\|797000` | exponent_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(1, 7), B(33, 23); ratio 4:4 from A\|point P` | segment_partition_generator.py |
...
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|244 = -8 + (n - 1)·9` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|-8, 1, 10, 19, ...\|which term equals 244` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ 1/n^(14/3), n ≥ 1\|converge or diverge?` | legendre_construction_generator.py, power_series_generator.py, series_convergence_generator.py |
...
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|part = 0.845 * 2505` | percent_problem_generator.py |
| `SET_SETUP` | 2, 3, 4 | `SET_SETUP\|A = {p}\|B = {14}\|A × B` | set_expression_generator.py, set_operations_generator.py |
...
| `SHIFT` | 1, 2 | `SHIFT\|yi = xi - 1\|y1+...+y7 = 32` | algorithm_trace_generator.py, recurrence_generator.py, stars_and_bars_generator.py, z_transform_generator.py |
...
| `SHORTEST` | 2 | `SHORTEST\|(4,-7)\|norm^2=65` | lll_reduction_generator.py |
| `SIDE` | 2 | `SIDE\|left\|∉` | set_identity_membership_table_generator.py |
| `SIGFIG_ROUND` | 3 | `SIGFIG_ROUND\|1080000\|2 significant figures\|1.1 × 10^6` | fermi_estimation_generator.py |
| `SIGMA_EXPAND` | 1 | `SIGMA_EXPAND\|5 + 20 + 80 + 320 + 1280` | sigma_notation_generator.py |
| `SIGMA_SETUP` | 2 | `SIGMA_SETUP\|Σ_(k=0)^(4) 5·4^k\|expand and evaluate` | sigma_notation_generator.py |
| `SIGMA_TERM` | 3 | `SIGMA_TERM\|k=0\|5·4^0\|5` | sigma_notation_generator.py |
...
| `SIGN_CHART` | 2 | `SIGN_CHART\|zeros\|-6, 2, 3` | polynomial_inequality_generator.py |
...
| `SIGN_TEST` | 4 | `SIGN_TEST\|(-inf, 1)\|y = 0\|f(y) = -4 (negative)\|down` | stability_generator.py |
| `SIMILAR_APPLY` | 3 | `SIMILAR_APPLY\|9\|0.5\|4.5` | scaling_generator.py |
| `SIMILAR_SCALE` | 3 | `SIMILAR_SCALE\|4\|8\|0.5` | scaling_generator.py |
| `SIMILAR_SETUP` | 3 | `SIMILAR_SETUP\|triangle\|9,8,3\|4 (others unknown)` | scaling_generator.py |
| `SIMPLEX_SETUP` | 3 | `SIMPLEX_SETUP\|max z=5x+2y\|x<=23\|y<=6` | simplex_generator.py |
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; AB = 12, DE = 24, BC = 8\|find EF` | similar_triangles_generator.py |
| `SIN` | 2 | `SIN\|0\|0` | positional_encoding_generator.py |
| `SINGULAR_VALUE` | 2 | `SINGULAR_VALUE\|sigma1\|1` | low_rank_approx_generator.py |
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = 2cos(4(x - 30°)) + 6\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
| `SIZE_REDUCE` | 2 | `SIZE_REDUCE\|b2=(5, -13)\|b2-3b1=(5, 2)` | lll_reduction_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = 67` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|-5` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(2, -3)\|(10, 5)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (5 - (-3)) / (10 - 2)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SOLUTIONS` | 2 | `SOLUTIONS\|cos x = 0\|90°, 270°, 450°, 630°, 810°, 990°, 1170°, 1350°, 1530°, 1710°, 1890°, 2070°, 2250°, 2430°, 2610°, 2790°, 2970°, 3150°, 3330°, 3510°, 3690°, 3870°, 4050°, 4230°, 4410°, 4590°, 4770°, 4950°, 5130°, 5310°, 5490°, 5670°, 5850°, 6030°, 6210°, 6390°, 6570°, 6750°, 6930°, 7110°, 7290°, 7470°, 7650°, 7830°, 8010°, 8190°, 8370°, 8550°, 8730°, 8910°` | trig_equation_generator.py |
...
| `SOL_ENTRY` | 3 | `SOL_ENTRY\|x1(t)\|(e^(5t))*2 + (0)*5\|2*e^(5t)` | matrix_exponential_generator.py |
...
| `SORT_EDGES` | 1 | `SORT_EDGES\|AB=1, CD=4, AD=10, BC=15` | mst_generator.py |
| `SPECIAL_SOLUTION` | 2 | `SPECIAL_SOLUTION\|18 = 18\|identity: true for every x` | radical_equation_generator.py, special_solution_equation_generator.py |
...
| `SPHERICAL_EXCESS_SETUP` | 2 | `SPHERICAL_EXCESS_SETUP\|R=5\|angles=135,60,75` | spherical_excess_generator.py |
| `SPHERICAL_SINE_LAW` | 1 | `SPHERICAL_SINE_LAW\|sin(A)/sin(a)=sin(B)/sin(b)` | spherical_triangle_generator.py |
| `SPHERICAL_TRIANGLE_SETUP` | 2 | `SPHERICAL_TRIANGLE_SETUP\|b=45 deg, c=150 deg, A=45 deg\|find cos(a)` | spherical_triangle_generator.py |
...
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|-9y = 3y - 12y\|9y^2 + 3y - 12y - 4` | factor_trinomial_generator.py |
...
| `SQRT_SETUP` | 2 | `SQRT_SETUP\|N = 213444\|groups 21, 34, 44` | manual_square_root_generator.py |
| `SQRT_TRIAL` | 3 | `SQRT_TRIAL\|x = 4\|(0 + 4)*4 = 16\|fits` | manual_square_root_generator.py |
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(x + 63) = x + 7\|x + 63 = (x + 7)^2` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|41905\|289 × 145\|289` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
...
| `STATEMENT_EVAL` | 3 | `STATEMENT_EVAL\|Jae says Jae and Suri are different types\|F\|contradiction` | knights_knaves_generator.py |
...
| `STAT_AVERAGE` | 2 | `STAT_AVERAGE\|(74 + 78) / 2\|76` | statistics_generator.py |
| `STAT_COUNT` | 1 | `STAT_COUNT\|8` | statistics_generator.py |
| `STAT_DEVIATION` | 3 | `STAT_DEVIATION\|29\|24\|5` | statistics_generator.py |
| `STAT_DIVIDE` | 2 | `STAT_DIVIDE\|352 / 8\|44` | statistics_generator.py |
| `STAT_FREQUENCY` | 2 | `STAT_FREQUENCY\|34\|2` | statistics_generator.py |
| `STAT_MAD` | 3 | `STAT_MAD\|42\|7\|6` | statistics_generator.py |
| `STAT_MAX` | 1 | `STAT_MAX\|81` | statistics_generator.py |
| `STAT_MEAN` | 2 | `STAT_MEAN\|168 / 7\|24` | statistics_generator.py |
| `STAT_MIDDLE` | 2 | `STAT_MIDDLE\|position 3\|78` | statistics_generator.py |
| `STAT_MIN` | 1 | `STAT_MIN\|11` | statistics_generator.py |
| `STAT_MODE` | 2 | `STAT_MODE\|51\|4` | statistics_generator.py |
| `STAT_ORDER` | 1 | `STAT_ORDER\|18, 42, 78, 79, 88` | statistics_generator.py |
| `STAT_RANGE` | 2 | `STAT_RANGE\|81 - 11\|70` | statistics_generator.py |
| `STAT_SETUP` | 1 | `STAT_SETUP\|44, 61, 53, 27, 43, 57, 23, 44` | statistics_generator.py |
| `STAT_SUM` | 2 | `STAT_SUM\|44 + 61 + 53 + 27 + 43 + 57 + 23 + 44\|352` | statistics_generator.py |
...
| `SUBGROUP` | 2 | `SUBGROUP\|H={1, 17, 9, 41, 25, 33}\|size 6` | coset_generator.py |
...
| `SUBPROOF_CLOSE` | 3 | `SUBPROOF_CLOSE\|→I\|lines 2–3\|x → (c ∧ x)` | natural_deduction_generator.py |
| `SUBPROOF_OPEN` | 2 | `SUBPROOF_OPEN\|assume\|x` | natural_deduction_generator.py |
...
| `SWAP` | 2 | `SWAP\|norm b2=17\|norm b1=218` | lll_reduction_generator.py |
...
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|x^3 + x^2 - 22x - 17\|r = -5` | polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `SYN_ROW` | 1 | `SYN_ROW\|1, -4, -2, -7` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: -4x = 32` | systems_elimination_generator.py |
| `SYS_EQ_NEW` | 1 | `SYS_EQ_NEW\|New equation with y only` | systems_substitution_generator.py |
| `SYS_ISOLATE` | 2 | `SYS_ISOLATE\|Isolate x in Eq 1\|x = 2y - 14` | systems_substitution_generator.py |
| `SYS_MULT` | 1 | `SYS_MULT\|Eq1 * 2` | systems_elimination_generator.py |
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|-2x + 2y = 32\|-2x - 2y = 0` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x = -3y - 13\|2x - 2y = -10` | systems_elimination_generator.py, systems_substitution_generator.py |
...
| `TABLEAU_ROOT` | 1 | `TABLEAU_ROOT\|(c ∧ ¬g) ∨ (¬g ∨ ¬g)` | semantic_tableau_generator.py |
...
| `TANGENT_PLANE` | 2 | `TANGENT_PLANE\|z = z0 + fx(x-a) + fy(y-b)\|z = 62 + 3*(x - 2) + 35*(y - 4)` | gradient_generator.py |
...
| `TELESCOPE_CANCEL` | 2 | `TELESCOPE_CANCEL\|all middle factors cancel\|100/180` | telescoping_generator.py |
| `TELE_SETUP` | 1 | `TELE_SETUP\|Π k=100..179 k/(k+1)` | telescoping_generator.py |
...
| `TEST_CHOOSE` | 2 | `TEST_CHOOSE\|p-series\|Σ 1/n^p with p = 14/3` | power_series_generator.py, series_convergence_generator.py |
...
| `THEOREM_SETUP` | 3 | `THEOREM_SETUP\|Green\|F=<0, 5*x>\|rectangle 4 by 5` | vector_theorem_generator.py |
...
| `TOPO_PICK` | 2 | `TOPO_PICK\|available {3, 19, 27, 59}\|pick 3` | partial_order_generator.py |
...
| `TRANSFORM_APPLY` | 2 | `TRANSFORM_APPLY\|(4(-5), 4(-8))\|(-20, -32)` | transformation_generator.py |
| `TRANSFORM_RULE` | 1 | `TRANSFORM_RULE\|(x, y) → (4x, 4y)` | transformation_generator.py |
| `TRANSFORM_SETUP` | 2, 3 | `TRANSFORM_SETUP\|P(-5, -8)\|dilation by factor 4 centered at the origin, then rotation 90° counterclockwise about the origin` | rv_transform_generator.py, transformation_generator.py |
...
| `TRANSLATE` | 2 | `TRANSLATE\|Some hiker is not quiet\|∃x (D(x) ∧ ¬Q(x))` | quantifier_negation_generator.py |
...
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle, angle 37°, hypotenuse = 80; given sin 37° ≈ 0.6\|the opposite side` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRIPLE_EVAL` | 3 | `TRIPLE_EVAL\|rho_part * phi_part * angle\|3*1000/3*2*2*pi\|4000*pi` | triple_integral_generator.py |
| `TRIPLE_SETUP` | 3 | `TRIPLE_SETUP\|integrand 3\|ball radius 10\|spherical` | triple_integral_generator.py |
| `TRI_ANGLE_SETUP` | 3 | `TRI_ANGLE_SETUP\|68\|51\|exterior` | angle_relationships_generator.py |
| `TRI_ANGLE_SOLVE` | 2 | `TRI_ANGLE_SOLVE\|exterior = 68 + 51\|119` | angle_relationships_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|30-60-90 triangle, shorter leg = 200\|longer leg and hypotenuse` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
...
| `TYPE_ABS` | 2 | `TYPE_ABS\|lambda z\|c → e` | type_theory_generator.py |
| `TYPE_APP` | 3 | `TYPE_APP\|(r g)\|unify\|A` | type_theory_generator.py |
| `TYPE_ASSIGN` | 2 | `TYPE_ASSIGN\|r\|N → A` | type_theory_generator.py |
| `UB` | 2 | `UB\|{19, 33}\|∅` | partial_order_generator.py |
...
| `UNFOLD` | 2 | `UNFOLD\|len("bbaghgg")\|1 + len("baghgg")` | recursive_definition_unfold_generator.py |
...
| `UNIT_RATE_DIV` | 3 | `UNIT_RATE_DIV\|50¢\|5\|10¢` | unit_rate_generator.py |
| `UNIT_RATE_PICK` | 2 | `UNIT_RATE_PICK\|6\|18` | unit_rate_generator.py |
| `UNIT_RATE_SETUP` | 3 | `UNIT_RATE_SETUP\|5\|pencils\|50¢` | unit_rate_generator.py |
| `UNIT_RATE_TABLE` | 2 | `UNIT_RATE_TABLE\|6,7,8,9\|18,21,24,27` | unit_rate_generator.py |
...
| `UNPAIR` | 2 | `UNPAIR\|68453\|(181, 188)` | cantor_pairing_generator.py |
| `UNPAIRED` | 2 | `UNPAIRED\|neither\|∅` | one_to_one_correspondence_generator.py |
| `UNROLL` | 2 | `UNROLL\|-4, -20, -100, -500\|geometric, r = 5` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|8 - 5.2 = 2.8\|(2.8)^2 = 7.84\|2/5·7.84 = 3.136` | expected_value_generator.py |
| `VECTOR_NORM` | 2 | `VECTOR_NORM\|A\|5` | embedding_similarity_generator.py |
| `VECTOR_SETUP` | 2 | `VECTOR_SETUP\|F(x,y) = <5*x + 6*y, -6*x + 5*y>\|divergence and scalar curl` | div_curl_generator.py |
| `VEC_ENTRY` | 3 | `VEC_ENTRY\|(1)\|1080*8 + (-18432)\|-9792` | diagonalization_generator.py |
| `VEC_SETUP` | 2 | `VEC_SETUP\|u = ⟨-4, -1⟩, v = ⟨4, 1⟩\|4u - 3v` | dot_product_generator.py, vector_ops_generator.py |
| `VENN_MARK` | 2 | `VENN_MARK\|bakers ∩ editors\|x1` | syllogism_generator.py |
| `VENN_REGION` | 2 | `VENN_REGION\|A ∩ B\|4` | venn_probability_generator.py |
| `VENN_SHADE` | 2 | `VENN_SHADE\|editors − kayakers\|empty` | syllogism_generator.py |
...
| `VOLUME_SETUP` | 2 | `VOLUME_SETUP\|region under y = 12x on [0, 41], rotated about the x-axis\|disk method` | solid_revolution_generator.py |
| `VOL_BASE_AREA` | 2 | `VOL_BASE_AREA\|Base Area = (1/2) × 12 × 9\|54.0` | round_solids_generator.py, volume_3d_generator.py |
| `VOL_CALCULATE` | 2 | `VOL_CALCULATE\|V = 54.0 × 13\|702.0` | round_solids_generator.py, volume_3d_generator.py |
...
| `VOL_SETUP` | 2 | `VOL_SETUP\|triangular_prism\|b=12, h_tri=9, length=13` | volume_3d_generator.py |
| `VOP_FORM` | 2 | `VOP_FORM\|u1' = -y2*g/W\|40/1 * e^(-4x)` | variation_parameters_generator.py |
...
| `WARSHALL_K` | 2 | `WARSHALL_K\|k=28\|0 0 1; 0 0 0; 0 1 0` | relation_closure_generator.py |
...
| `WORK_DIFF` | 3 | `WORK_DIFF\|phi(end) - phi(start)\|20 - 1\|19` | line_integral_generator.py |
...
| `ZERO_PRODUCT` | 2 | `ZERO_PRODUCT\|(x + 6)(x - 2)(x - 3)\|x = -6 or x = 2 or x = 3` | area_between_curves_generator.py, curve_analysis_generator.py, domain_range_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_inequality_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_equation_generator.py, trig_equation_generator.py |
| `ZSCORE` | 2 | `ZSCORE\|(53 - 46)/5\|1.4` | normal_table_generator.py, z_score_generator.py |
