...
1998 distinct op-codes observed.
...
| `AREA` | 2 | `AREA\|10 × 8\|80` | geometry_area_perimeter_generator.py, geometry_in_context_generator.py |
...
| `CEIL` | 2 | `CEIL\|8000\|8000` | confidence_interval_generator.py, geometry_in_context_generator.py, inference_setup_generator.py, nonparametric_test_generator.py, percentile_generator.py, probability_inequality_generator.py |
