...
| `DIST_TERM` | 2 | `DIST_TERM\|2x\|- 4x^3 + 6x^2 + 4x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|78143 × 71797 ≈ 80000 × 70000\|5600000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|5600000000\|5610432971\|5610432971 ≈ 5600000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|1 + 6 = 7, not 21` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 60:96\|line 3 divides 16 by 8` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(28, 6)\|P(34 < X < 37)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 3x^7 - 4x^7 + 4x^6 - 2x^5) / (x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-3x^7) / (x^3) + (-4x^7) / (x^3) + (4x^6) / (x^3) + (-2x^5) / (x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(2x + 1)(-2x^2 + 3x + 2)` | multiplying_polynomials_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(5)\|18` | function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, right_triangle_trig_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(34 - 28)/6\|1.00` | normal_table_generator.py |
