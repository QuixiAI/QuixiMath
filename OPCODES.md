...
414 distinct op-codes observed.
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|16x^3\|4x^4` | antiderivative_generator.py, area_between_curves_generator.py, definite_integral_generator.py, solid_revolution_generator.py, u_substitution_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|8x^3 - 16x^2 - 16x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|75215 × 36781 ≈ 80000 × 40000\|3200000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|3200000000\|2766482915\|2766482915 ≈ 3200000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|2\|38 - 2 = 36, not 27` | error_spotting_generator.py |
...
| `INTEG_RULE` | 2 | `INTEG_RULE\|power rule\|∫ x^n dx = x^(n+1)/(n+1) + C` | antiderivative_generator.py, definite_integral_generator.py, solid_revolution_generator.py, u_substitution_generator.py |
...
| `NEED` | 2 | `NEED\|the complete column is 44:12\|line 3 divides 24 by 3` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(500, 9)\|P(X < 486.5)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(8x^5 - 40x^4 - 32x^4 - 24x^2) / (8x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(8x^5) / (8x) + (-40x^4) / (8x) + (-32x^4) / (8x) + (-24x^2) / (8x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x - 3)(-2x^2 + 4x + 4)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(486.5 - 500)/9\|-1.50` | normal_table_generator.py |
