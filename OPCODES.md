...
380 distinct op-codes observed.
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|1x^3 - 3x^2 - 4x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|47450 × 25757 ≈ 50000 × 30000\|1500000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1500000000\|1222169650\|1222169650 ≈ 1500000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|16 ÷ 2 = 8, not 10` | error_spotting_generator.py |
...
| `NEED` | 2 | `NEED\|the equation is 3x - 13 = -10\|line 3 shows 3x = 3` | fill_in_step_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(508, 12)\|P(511.6 < X < 518.8)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 6x^6 - 24x^4) / (6x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-6x^6) / (6x^3) + (-24x^4) / (6x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x + 1)(x^2 - 3x - 4)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(511.6 - 508)/12\|0.30` | normal_table_generator.py |
