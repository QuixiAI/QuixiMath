...
870 distinct op-codes observed.
...
| `ARGUMENT` | 2 | `ARGUMENT\|(-6,-6)\|225 deg` | euler_formula_generator.py |
...
| `RECT_FORM` | 1 | `RECT_FORM\|11sqrt2 + 11sqrt2i` | euler_formula_generator.py |
...
| `SCALE_EXACT` | 2 | `SCALE_EXACT\|22*cos\|11sqrt2` | euler_formula_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|g(-1)\|15` | dot_product_generator.py, euler_formula_generator.py, function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
