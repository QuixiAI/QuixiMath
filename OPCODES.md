...
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|8x^3 - 12x^2 + 16x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|86910 × 4001 ≈ 90000 × 4000\|360000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|360000000\|347726910\|347726910 ≈ 360000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|4\|27 ÷ 9 = 3, not 1` | error_spotting_generator.py |
| `FOIL_F` | 2 | `FOIL_F\|First: (9x) * (9x)\|81x^2` | multiplying_binomials_generator.py |
| `FOIL_I` | 2 | `FOIL_I\|Inner: (-6) * (9x)\|-54x` | multiplying_binomials_generator.py |
...
| `FORM_IDENTIFY` | 2 | `FORM_IDENTIFY\|difference_of_squares\|a^2 - b^2 = (a - b)(a + b)` | completing_square_generator.py, factor_special_forms_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, rational_exponent_generator.py, rational_expr_mult_div_generator.py |
...
| `NEED` | 2 | `NEED\|line 1 converts 20% to 0.20\|line 3 adds the tip 42.40 to the bill` | fill_in_step_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/2\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(499, 10)\|P(X > 520)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 18x^5 + 24x^3) / (-6x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-18x^5) / (-6x) + (24x^3) / (-6x)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x + 3)(-2x^2 + 3x - 4)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1 | `POLY_SETUP\|(4x^3 - x + 9) + (8x^2 - 7x - 5)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py |
...
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|Φ(2.10)\|0.9821` | normal_table_generator.py |
