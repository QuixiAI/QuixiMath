...
293 distinct op-codes observed.
...
| `CHECK` | 3 | `CHECK\|multiply_back\|23×98+45=2299\|2299` | completing_square_generator.py, error_spotting_generator.py, factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, fill_in_step_generator.py, inverse_function_generator.py, linear_fractional_generator.py, long_division_generator.py, quadratic_factoring_generator.py, quadratic_square_root_generator.py, radical_variable_simplify_generator.py, ratio_table_generator.py, special_solution_equation_generator.py, systems_elimination_generator.py, tip_bill_split_generator.py, two_step_equation_generator.py |
...
| `DIST_TERM` | 2 | `DIST_TERM\|x\|3x^3 - 4x^2 - 4x` | multiplying_polynomials_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|97601 × 8936 ≈ 100000 × 9000\|900000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|900000000\|872162536\|872162536 ≈ 900000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FLAG` | 2 | `FLAG\|3\|24 ÷ 3 = 8, not 10` | error_spotting_generator.py |
...
| `FOIL_L` | 2 | `FOIL_L\|Last: (-4) * (-1)\|4` | multiplying_binomials_generator.py |
...
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(54, 10)\|P(X > 62)` | normal_table_generator.py |
...
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 18x^6 - 6x^5 + 18x^5 + 12x^4) / (6x^3)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-18x^6) / (6x^3) + (-6x^5) / (6x^3) + (18x^5) / (6x^3) + (12x^4) / (6x^3)` | polynomial_div_monomial_generator.py |
...
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(x - 5)(3x^2 - 4x - 4)` | multiplying_polynomials_generator.py |
...
| `ZSCORE` | 2 | `ZSCORE\|(62 - 54)/10\|0.80` | normal_table_generator.py |
