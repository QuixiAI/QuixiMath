...
488 distinct op-codes observed.
...
| `ABS_CASE` | 2 | `ABS_CASE\|Case 1\|2x + 5 = 12` | absolute_value_equation_generator.py |
...
| `ABS_INEQ_PART` | 2 | `ABS_INEQ_PART\|Part 1\|x - 5 > 5 -> x > 10` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SETUP` | 1 | `ABS_INEQ_SETUP\|\|5x + 7\| <= 12` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPECIAL` | 2 | `ABS_INEQ_SPECIAL\|c = 0\|Check logic for <` | absolute_value_inequality_generator.py |
| `ABS_INEQ_SPLIT` | 2 | `ABS_INEQ_SPLIT\|AND case\|-12 <= 5x + 7 <= 12` | absolute_value_inequality_generator.py |
| `ABS_SETUP` | 1 | `ABS_SETUP\|\|x + 7\| = -10` | absolute_value_equation_generator.py |
| `ABS_SPLIT` | 2, 3 | `ABS_SPLIT\|Two cases\|2x + 5 = 12\|2x + 5 = -12` | absolute_value_equation_generator.py |
...
| `ACCEPT` | 2 | `ACCEPT\|(-7, -8)\|product 56 ✓, sum -15 ✓` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `ADD_SETUP` | 2 | `ADD_SETUP\|P(A) = 2/6, P(B) = 1/6, mutually exclusive\|P(A ∪ B)` | probability_addition_rule_generator.py |
...
| `ANTIDERIV` | 2 | `ANTIDERIV\|-9e^(3x)\|-3e^(3x)` | antiderivative_generator.py, arc_length_generator.py, area_between_curves_generator.py, definite_integral_generator.py, improper_integral_generator.py, integration_by_parts_generator.py, parametric_calculus_generator.py, partial_fractions_generator.py, separable_ode_generator.py, solid_revolution_generator.py, u_substitution_generator.py |
...
| `ARC_SETUP` | 2 | `ARC_SETUP\|circle r = 12, central angle 135°\|arc length` | arc_sector_generator.py |
| `AREA` | 1, 3 | `AREA\|80` | geometry_area_perimeter_generator.py |
| `AREA_SETUP` | 2 | `AREA_SETUP\|y = x^2 and y = 98 - x^2\|area between the curves` | area_between_curves_generator.py |
| `ASYMPTOTE` | 1 | `ASYMPTOTE\|y = -2 ± (5/12)(x - 6)` | hyperbola_features_generator.py |
...
| `BAYES_SETUP` | 3 | `BAYES_SETUP\|disease=yes 45, disease=no 150\|sensitivity 4/5, specificity 9/10\|P(disease=yes given test positive)` | conditional_probability_generator.py |
...
| `BRANCH_USE` | 1 | `BRANCH_USE\|$6.75` | piecewise_evaluation_generator.py |
| `BRING_DOWN` | 2 | `BRING_DOWN\|5\|current = 5` | composite_arithmetic_generator.py |
...
| `CBRT` | 2 | `CBRT\|8y^3\|2y` | factor_special_forms_generator.py, inverse_function_generator.py, rational_exponent_generator.py |
| `CEIL` | 2 | `CEIL\|9463.3984\|9464` | confidence_interval_generator.py |
| `CENTER` | 1 | `CENTER\|(-2, 0)` | circle_equation_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py |
...
| `CHI_SETUP` | 2 | `CHI_SETUP\|row 1: 7, 13; row 2: 13, 67; N = 100\|independence; df = 1, critical value = 3.841` | chi_square_generator.py |
| `CHI_TERM` | 3 | `CHI_TERM\|7 - 4 = 3\|3^2 = 9\|9/4 = 2.25` | chi_square_generator.py |
| `CIRCLE_ANGLE_SETUP` | 2 | `CIRCLE_ANGLE_SETUP\|inscribed angle 84°\|intercepted arc` | circle_angle_generator.py |
...
| `CI_SETUP` | 2 | `CI_SETUP\|σ = 24, n = 25, z* = 1.645\|margin of error` | confidence_interval_generator.py |
...
| `COEFFS` | 1, 2 | `COEFFS\|1, -4, 8, -12` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
...
| `COMB_SETUP` | 2 | `COMB_SETUP\|C(7, 3)\|n!/(r!·(n-r)!)` | permutation_combination_generator.py |
...
| `COMMON_DIFF` | 2 | `COMMON_DIFF\|-4 - (-8)\|4` | arithmetic_sequence_generator.py, recursive_explicit_generator.py |
| `COMMON_RATIO` | 2 | `COMMON_RATIO\|-8/(-16)\|1/2` | geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `COMP_INEQ_PART` | 2 | `COMP_INEQ_PART\|Part 1\|5x + 8 < 2 -> x < -6/5` | compound_inequality_generator.py |
| `COMP_INEQ_SETUP` | 1 | `COMP_INEQ_SETUP\|-10 < 5x + 5 < 25` | compound_inequality_generator.py |
| `COND_COUNT` | 2 | `COND_COUNT\|club=yes and commute=bus\|10` | conditional_probability_generator.py |
| `COND_FORMULA` | 1 | `COND_FORMULA\|P(A given B) = count(A and B)/count(B)` | conditional_probability_generator.py |
| `COND_SETUP` | 2 | `COND_SETUP\|yes/bike 26, no/bike 18, yes/bus 10, no/bus 10\|P(club=yes given commute=bus)` | conditional_probability_generator.py |
| `COND_TOTAL` | 2 | `COND_TOTAL\|commute=bus total\|10 + 10 = 20` | conditional_probability_generator.py |
| `CONIC_SETUP` | 2 | `CONIC_SETUP\|(y - 3)^2 = 12(x - 6)\|vertex, focus, directrix` | conic_standard_form_generator.py, ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
| `CONJUGATE` | 2 | `CONJUGATE\|-2 + 2i\|-2 - 2i` | complex_division_generator.py |
...
| `CROSS_MULT` | 1 | `CROSS_MULT\|12·BC = 8·9` | similar_triangles_generator.py, triangle_solve_generator.py |
| `CURVE_SETUP` | 2 | `CURVE_SETUP\|f(x) = x^3 - 12x^2 + 45x - 3\|critical points and their nature` | curve_analysis_generator.py |
| `CX_SETUP` | 2 | `CX_SETUP\|(-5 + 8i)(5 + 7i)\|multiply` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `DERIV_SETUP` | 2 | `DERIV_SETUP\|f(x) = -5x^3 + 7x^2 + 4\|f'(x)` | chain_rule_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, log_diff_higher_order_generator.py, tangent_line_generator.py |
...
| `DISC` | 2, 3 | `DISC\|225\|-216\|441` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `DISC_CLASSIFY` | 2 | `DISC_CLASSIFY\|124 > 0\|two real solutions` | complex_quadratic_generator.py, discriminant_generator.py, polynomial_zeros_generator.py |
...
| `DIST_COMBINE` | 1 | `DIST_COMBINE\|9y + 112 = 31` | systems_substitution_generator.py |
| `DIST_FORMULA` | 1 | `DIST_FORMULA\|d = √((x2 - x1)^2 + (y2 - y1)^2)` | distance_formula_generator.py, hypercube_counting_generator.py |
| `DIST_TERM` | 2 | `DIST_TERM\|-4x\|4x^3 - 4x^2 - 16x` | multiplying_polynomials_generator.py |
...
| `DIV_TERM` | 3 | `DIV_TERM\|21t^4\|3t^2\|7t^2` | factor_gcf_generator.py, polynomial_long_division_generator.py |
| `DOMAIN_COND` | 2 | `DOMAIN_COND\|denominator ≠ 0\|x^2 - 9x + 20 ≠ 0` | domain_range_generator.py |
...
| `EQ_2PT_SETUP` | 2 | `EQ_2PT_SETUP\|(5, 2)\|(4, 5)` | equation_from_two_points_generator.py |
...
| `ESTIMATE` | 2 | `ESTIMATE\|60992 × 33221 ≈ 60000 × 30000\|1800000000` | long_division_generator.py, multi_digit_multiplication_generator.py |
| `ESTIMATE_CHECK` | 3 | `ESTIMATE_CHECK\|1800000000\|2026215232\|2026215232 ≈ 1800000000 ✓` | long_division_generator.py, multi_digit_multiplication_generator.py |
...
| `FACTOR_PAIR_GOAL` | 2 | `FACTOR_PAIR_GOAL\|m·n = 56\|m + n = -15` | factor_trinomial_generator.py |
...
| `FIND_SLOPE` | 2 | `FIND_SLOPE\|Given slope (m1)\|3/3` | parallel_perpendicular_line_generator.py |
...
| `FOCUS` | 1 | `FOCUS\|(9, 3)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `FOIL_L` | 2 | `FOIL_L\|Last: 8i * 7i\|56i^2` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py |
...
| `FOIL_SETUP` | 1 | `FOIL_SETUP\|(5 + √15)(1 + √15)` | complex_division_generator.py, complex_number_ops_generator.py, multiplying_binomials_generator.py, radical_multiply_generator.py, trig_identity_verify_generator.py |
...
| `FRAC_REDUCE` | 2 | `FRAC_REDUCE\|2/-13\|-2/13` | angle_measure_generator.py, arc_length_generator.py, arc_sector_generator.py, complex_division_generator.py, frequency_table_generator.py, function_operations_generator.py, hyperbola_features_generator.py, implicit_diff_generator.py, improper_integral_generator.py, probability_addition_rule_generator.py, related_rates_generator.py, right_triangle_trig_generator.py |
| `FRAC_TO_DEC` | 2 | `FRAC_TO_DEC\|2/6\|0.3333333333` | fraction_decimal_percent_converter.py |
| `FREQ_SETUP` | 2 | `FREQ_SETUP\|table — Red: 2, Blue: 2, Green: 1, Yellow: 9\|total count` | frequency_table_generator.py |
| `FUNC_OP` | 2 | `FUNC_OP\|(f - g)(6)\|f(6) - g(6)` | function_composition_generator.py, function_operations_generator.py |
| `FUNC_SETUP` | 2 | `FUNC_SETUP\|f(t) = 2t + 1\|f(4)` | domain_range_generator.py, function_composition_generator.py, function_evaluation_generator.py, function_operations_generator.py, function_table_generator.py, inverse_function_generator.py, piecewise_evaluation_generator.py, rational_function_features_generator.py |
...
| `GCF_COEFF` | 2 | `GCF_COEFF\|21, 27\|3` | factor_gcf_generator.py, quadratic_factoring_generator.py, rational_expr_simplify_generator.py |
...
| `GEO_SETUP` | 2 | `GEO_SETUP\|right triangle, altitude h = 8 to the hypotenuse; one segment p = 2\|the other segment q` | geometric_mean_generator.py |
...
| `GROUP` | 2 | `GROUP\|(3x^2 - 9x)\|(-2x + 6)` | factor_grouping_generator.py, factor_trinomial_generator.py |
| `HA` | 1 | `HA\|y = 1` | rational_function_features_generator.py |
| `HOLE` | 1 | `HOLE\|x = 2` | rational_function_features_generator.py |
| `HORNER_SETUP` | 2 | `HORNER_SETUP\|-3x^3 - 5x^2 + 3x - 4\|x = -3` | horner_evaluation_generator.py |
| `HT_SETUP` | 2 | `HT_SETUP\|H0: μ = 75; Ha: μ ≠ 75\|n = 25, x̄ = 72, s = 2.5, critical value = 1.645` | hypothesis_test_generator.py |
...
| `IDENT_SUB` | 1 | `IDENT_SUB\|csc t = 1/sin t` | parametric_calculus_generator.py, trig_identity_verify_generator.py |
...
| `IMPLICIT_SETUP` | 2 | `IMPLICIT_SETUP\|x^2 + y^2 = 25\|dy/dx at (-3, 4)` | implicit_diff_generator.py |
...
| `INEQ_OP_ALL` | 3 | `INEQ_OP_ALL\|subtract\|7\|-19 <= 5x <= 5` | absolute_value_inequality_generator.py, compound_inequality_generator.py |
...
| `IVT_SETUP` | 2 | `IVT_SETUP\|f(x) = x^3 - x + 3 on [0, 3]\|does the IVT guarantee a root?` | mean_value_theorem_generator.py |
| `I_CYCLE` | 2 | `I_CYCLE\|i^2\|-1` | complex_number_ops_generator.py |
| `I_SQUARE` | 2 | `I_SQUARE\|56i^2\|-56` | complex_division_generator.py, complex_number_ops_generator.py |
...
| `LINE_RELATION_SETUP` | 3 | `LINE_RELATION_SETUP\|parallel\|y = 3/3x + 10\|(4, -8)` | parallel_perpendicular_line_generator.py |
| `LOG_BOTH_SIDES` | 1 | `LOG_BOTH_SIDES\|ln(e^(4x)) = ln(23)` | exponential_equation_generator.py, log_diff_higher_order_generator.py, separable_ode_generator.py |
| `LOG_FORM` | 1 | `LOG_FORM\|log_5(1/25) = y ⟺ 5^y = 1/25` | log_conversion_generator.py, log_equation_generator.py |
| `LOG_IDENT` | 2 | `LOG_IDENT\|e^(ln x) = x (inverse functions)\|6` | exponential_equation_generator.py, log_conversion_generator.py |
| `LOG_ONE_TO_ONE` | 1 | `LOG_ONE_TO_ONE\|2x - 8 = x + 1` | log_equation_generator.py |
| `LOG_POWER` | 2 | `LOG_POWER\|log_2(x^2)\|2log_2(x)` | log_diff_higher_order_generator.py, log_properties_generator.py |
| `LOG_PRODUCT` | 2 | `LOG_PRODUCT\|log_2(8x^2y^4)\|log_2(8x^2) + log_2(y^4)` | log_equation_generator.py, log_properties_generator.py |
| `LOG_QUOTIENT` | 2 | `LOG_QUOTIENT\|log_3(x^2) - log_3(y^2)\|log_3(x^2/y^2)` | log_properties_generator.py |
| `LOG_SETUP` | 2 | `LOG_SETUP\|log_2(8x^2y^4)\|expand` | log_properties_generator.py |
...
| `MAT_ENTRY` | 2 | `MAT_ENTRY\|(1,1)\|4` | matrix_ops_generator.py |
| `MAT_SETUP` | 2 | `MAT_SETUP\|A = [[0, 4], [-1, -1]], v = [[2], [1]]\|Av` | determinant_generator.py, matrix_inverse_generator.py, matrix_ops_generator.py, row_reduction_generator.py |
| `MAX` | 2 | `MAX\|1, 7\|7` | taxicab_geometry_generator.py |
...
| `MONO_SETUP` | 1 | `MONO_SETUP\|(-8x^6)(7x^2)` | monomial_mult_div_generator.py |
...
| `MVT_SETUP` | 2 | `MVT_SETUP\|f(x) = x^2 + 2x on [2, 8]\|find the c guaranteed by the MVT` | mean_value_theorem_generator.py |
| `NCR` | 2 | `NCR\|C(5,1)\|5` | binomial_probability_generator.py, hypercube_counting_generator.py |
| `NEED` | 2 | `NEED\|line 2 gives the tip 31.60\|line 4 answers $189.60` | fill_in_step_generator.py |
| `NET_SETUP` | 2 | `NET_SETUP\|6 squares 3 by 3\|total surface area` | nets_surface_area_generator.py |
| `NEW_SLOPE` | 2 | `NEW_SLOPE\|New slope (m2) = 3/3\|Parallel lines have the same slope` | parallel_perpendicular_line_generator.py |
| `NORMAL_SLOPE` | 2 | `NORMAL_SLOPE\|-1/(-9)\|1/9` | tangent_line_generator.py |
| `NORM_SETUP` | 2 | `NORM_SETUP\|X ~ N(45, 5)\|z-score of x = 47` | normal_table_generator.py, z_score_generator.py |
| `ODE_SETUP` | 2 | `ODE_SETUP\|dy/dt = 5y, y(0) = 7\|solve` | euler_method_generator.py, logistic_growth_generator.py, separable_ode_generator.py |
| `OPT_SETUP` | 2 | `OPT_SETUP\|x + y = 21, x, y > 0\|maximize P = x·y^2` | optimization_generator.py |
...
| `PARTFRAC_SETUP` | 1 | `PARTFRAC_SETUP\|(-4x - 3)/((x + 2)(x - 3)) = A/(x + 2) + B/(x - 3)` | partial_fractions_generator.py |
...
| `PERCENT_CALC_PART` | 3 | `PERCENT_CALC_PART\|0.75\|60\|45` | percent_problem_generator.py |
...
| `PERM_SETUP` | 2 | `PERM_SETUP\|P(12, 5)\|n!/(n-r)!` | permutation_combination_generator.py |
...
| `PLUS_MINUS` | 2 | `PLUS_MINUS\|y = ±4\|y = 4 or y = -4` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `POINT_SLOPE_SETUP` | 1 | `POINT_SLOPE_SETUP\|y - 2 = -3(x - 5)` | equation_from_two_points_generator.py, parallel_perpendicular_line_generator.py, point_slope_generator.py |
...
| `POLAR_SETUP` | 2 | `POLAR_SETUP\|r = 7\|rectangular equation` | parametric_calculus_generator.py, polar_parametric_generator.py |
| `POLYDIV_SETUP` | 2 | `POLYDIV_SETUP\|2y^3 + 4y^2 - 17y - 10\|y + 4` | polynomial_long_division_generator.py |
| `POLY_COMBINE` | 1 | `POLY_COMBINE\|-9x^2 - 6x + 7` | multiplying_binomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_DIST_NEG` | 1 | `POLY_DIST_NEG\|Distribute negative sign to second polynomial` | polynomial_add_sub_generator.py |
| `POLY_DIV_SETUP` | 1 | `POLY_DIV_SETUP\|(- 4x^5 + 8x^4) / (2x)` | polynomial_div_monomial_generator.py |
| `POLY_DIV_SPLIT` | 1 | `POLY_DIV_SPLIT\|(-4x^5) / (2x) + (8x^4) / (2x)` | polynomial_div_monomial_generator.py |
| `POLY_FORMULA` | 1 | `POLY_FORMULA\|A = (1/2)·a·P` | regular_polygon_area_generator.py |
| `POLY_GROUP_LIKE` | 1 | `POLY_GROUP_LIKE\|(-9x^2) + (-1x -5x) + (7)` | multiplying_polynomials_generator.py, polynomial_add_sub_generator.py |
| `POLY_MULT_SETUP` | 1 | `POLY_MULT_SETUP\|(-4x + 4)(-x^2 + x + 4)` | multiplying_polynomials_generator.py |
| `POLY_SETUP` | 1, 2 | `POLY_SETUP\|(-x) + (-9x^2 - 5x + 7)` | factor_gcf_generator.py, factor_grouping_generator.py, factor_special_forms_generator.py, factor_trinomial_generator.py, polynomial_add_sub_generator.py, rational_expr_add_sub_generator.py, rational_expr_mult_div_generator.py, rational_expr_simplify_generator.py, regular_polygon_area_generator.py |
| `POLY_SUB` | 2 | `POLY_SUB\|(2y^3 + 4y^2) - (2y^3 + 8y^2)\|-4y^2` | polynomial_long_division_generator.py |
| `POW` | 2 | `POW\|(1/3)^2\|1/9` | binomial_probability_generator.py, geometric_distribution_generator.py |
| `POWER_RULE` | 2 | `POWER_RULE\|-5x^3\|-15x^2` | chain_rule_generator.py, curve_analysis_generator.py, derivative_power_rule_generator.py, derivative_product_quotient_generator.py, derivative_transcendental_generator.py, lhopital_generator.py, linear_approx_generator.py, log_diff_higher_order_generator.py, mean_value_theorem_generator.py, optimization_generator.py, tangent_line_generator.py |
...
| `Q1` | 4 | `Q1\|-15\|21\|6\|1` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `Q2` | 4 | `Q2\|-15\|21\|6\|-6` | complex_quadratic_generator.py, polynomial_zeros_generator.py, quadratic_generator.py |
| `QUADRANT` | 2 | `QUADRANT\|196°\|quadrant III` | angle_measure_generator.py, polar_parametric_generator.py, unit_circle_generator.py |
| `QUARTILE` | 3 | `QUARTILE\|Q1\|6,7,11,14,16,18,30\|14` | five_number_summary_generator.py |
...
| `RATE_SETUP` | 2 | `RATE_SETUP\|17 ft ladder; the base slides away at 4 ft/s; base is 8 ft from the wall\|dy/dt` | related_rates_generator.py |
| `RATIONALIZE` | 1 | `RATIONALIZE\|(4 - √3)/(4 - √3)` | dot_product_generator.py, limit_evaluation_generator.py, radical_rationalize_generator.py, special_right_triangle_generator.py |
...
| `REARRANGE_EQ` | 1 | `REARRANGE_EQ\|whole = 30 / 0.1` | percent_problem_generator.py |
...
| `REG_SETUP` | 2 | `REG_SETUP\|points: (1, 74), (2, 72), (3, 78), (4, 76), (5, 70)\|coefficient of determination r^2` | regression_generator.py |
| `REJECT` | 2 | `REJECT\|(-1, -56)\|sum is -57, need -15` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, optimization_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
| `RESID_SETUP` | 2 | `RESID_SETUP\|point (3, 54), line ŷ = 48.3 + 0.9x\|residual = observed − predicted` | regression_generator.py |
...
| `RIEMANN_SETUP` | 2 | `RIEMANN_SETUP\|f(x) = x^2 + 3 on [-1, 7], n = 4\|midpoint Riemann sum` | riemann_sum_generator.py |
...
| `SECTION_SETUP` | 2 | `SECTION_SETUP\|A(7, -8), B(12, 12); ratio 3:2 from A\|point P` | segment_partition_generator.py |
...
| `SEPARATE` | 1 | `SEPARATE\|dy/y = 5 dt` | separable_ode_generator.py |
| `SEQ_APPLY` | 1 | `SEQ_APPLY\|a_23 = -8 + (23 - 1)·4` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
...
| `SEQ_SETUP` | 2 | `SEQ_SETUP\|-8, -4, 0, 4, ...\|sum of first 23 terms` | arithmetic_sequence_generator.py, geometric_sequence_generator.py, recursive_explicit_generator.py |
| `SERIES_SETUP` | 2 | `SERIES_SETUP\|Σ 9^n/n!, n ≥ 1\|converge or diverge?` | power_series_generator.py, series_convergence_generator.py |
| `SETUP_PERCENT_EQ` | 1 | `SETUP_PERCENT_EQ\|percent_dec = 10 / 20` | percent_problem_generator.py |
...
| `SIM_SETUP` | 2 | `SIM_SETUP\|△ABC ~ △DEF; DE = 12, AB = 8, EF = 9\|find BC` | similar_triangles_generator.py |
| `SINUSOID_SETUP` | 2 | `SINUSOID_SETUP\|y = -3cos(6(x - π/4)) + 2\|amplitude, period, phase shift, midline` | sinusoid_features_generator.py |
...
| `SLOPE_INT_SETUP` | 1 | `SLOPE_INT_SETUP\|y = 1 - 3x` | slope_intercept_form_generator.py |
| `SLOPE_RESULT` | 1 | `SLOPE_RESULT\|-3` | equation_from_two_points_generator.py |
| `SLOPE_SETUP` | 2 | `SLOPE_SETUP\|(10, 3)\|(-1, -10)` | slope_two_points_generator.py |
| `SLOPE_SUBST` | 1 | `SLOPE_SUBST\|m = (-10 - 3) / (-1 - 10)` | equation_from_two_points_generator.py, slope_two_points_generator.py |
...
| `SPLIT_MIDDLE` | 2 | `SPLIT_MIDDLE\|-11x = -9x - 2x\|3x^2 - 9x - 2x + 6` | factor_trinomial_generator.py |
| `SQRT_BOTH_SIDES` | 2 | `SQRT_BOTH_SIDES\|y^2 = 16\|y = ±4` | completing_square_generator.py, quadratic_square_root_generator.py, rational_equation_generator.py |
| `SQRT_NEG` | 2 | `SQRT_NEG\|√(-8)\|i√8` | complex_quadratic_generator.py, polynomial_zeros_generator.py |
| `SQUARE_BOTH_SIDES` | 2 | `SQUARE_BOTH_SIDES\|√(3x - 5) = x - 1\|3x - 5 = (x - 1)^2` | radical_equation_generator.py |
| `SQUARE_FACTOR` | 3 | `SQUARE_FACTOR\|112\|16 × 7\|16` | radical_add_sub_generator.py, radical_multiply_generator.py, radical_rationalize_generator.py, radical_variable_simplify_generator.py |
| `SQUARE_TEST` | 3 | `SQUARE_TEST\|124\|11^2 = 121, 12^2 = 144\|not a perfect square` | discriminant_generator.py |
...
| `SUM` | 2 | `SUM\|74 + 72 + 78 + 76 + 70\|370` | regression_generator.py |
| `SWAP_VARS` | 1 | `SWAP_VARS\|x = -2y + 5` | inverse_function_generator.py |
| `SYNDIV_SETUP` | 2 | `SYNDIV_SETUP\|x^3 - 4x^2 + 8x - 12\|r = 2` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_DROP` | 1 | `SYN_DROP\|1` | horner_evaluation_generator.py, polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYN_ROW` | 1 | `SYN_ROW\|1, -2, 4, -4` | polynomial_zeros_generator.py, synthetic_division_generator.py |
| `SYS_ADD` | 1 | `SYS_ADD\|Add equations: 12y = -48` | systems_elimination_generator.py |
...
| `SYS_REWRITE` | 2 | `SYS_REWRITE\|10x + 10y = -50\|-10x + 2y = 2` | systems_elimination_generator.py |
| `SYS_SETUP` | 2 | `SYS_SETUP\|x = -2y - 28\|-4x + 1y = 31` | systems_elimination_generator.py, systems_substitution_generator.py |
| `SYS_SUBST` | 1 | `SYS_SUBST\|Substitute (-2y - 28) for x in Eq 2` | systems_substitution_generator.py |
...
| `TABLE_ENTRY` | 2 | `TABLE_ENTRY\|h(-2)\|15` | euler_method_generator.py, function_table_generator.py, taylor_series_generator.py |
| `TABLE_LOOKUP` | 2 | `TABLE_LOOKUP\|h(-2)\|13` | dot_product_generator.py, function_evaluation_generator.py, normal_table_generator.py, pascal_triangle_generator.py, polar_parametric_generator.py, right_triangle_trig_generator.py, triangle_solve_generator.py, trig_equation_generator.py, trig_identity_eval_generator.py, unit_circle_generator.py |
| `TAYLOR_FORMULA` | 1 | `TAYLOR_FORMULA\|P_n(x) = Σ f^(k)(a)/k!·(x - a)^k` | taylor_series_generator.py |
| `TAYLOR_SETUP` | 2 | `TAYLOR_SETUP\|f(x) = sin(x)\|approximate sin(0.3) with P_3` | taylor_series_generator.py |
...
| `TRANSFORM_SETUP` | 2 | `TRANSFORM_SETUP\|P(4, 3)\|reflection over the x-axis, then rotation 90° counterclockwise about the origin` | transformation_generator.py |
| `TRIG_RATIO` | 2 | `TRIG_RATIO\|cos\|adjacent/hypotenuse` | right_triangle_trig_generator.py |
| `TRIG_SETUP` | 2 | `TRIG_SETUP\|right triangle: adjacent side = 12, hypotenuse = 20; given cos 53° ≈ 0.6\|angle A` | right_triangle_trig_generator.py, trig_identity_eval_generator.py, trig_six_functions_generator.py, unit_circle_generator.py |
...
| `TRI_SETUP` | 2 | `TRI_SETUP\|30-60-90 triangle, hypotenuse = 20\|both legs` | special_right_triangle_generator.py, triangle_area_sas_generator.py, triangle_solve_generator.py |
| `TRY` | 2 | `TRY\|(-1, -56)\|(-1)·(-56)=56, (-1)+(-56)=-57` | factor_trinomial_generator.py, log_conversion_generator.py, log_equation_generator.py, radical_equation_generator.py, rational_equation_generator.py, rational_root_generator.py |
...
| `UNROLL` | 2 | `UNROLL\|-5, -9, -13, -17\|arithmetic, d = -4` | recursive_explicit_generator.py |
...
| `VAR_ROW` | 3 | `VAR_ROW\|1 - 4.2 = -3.2\|(-3.2)^2 = 10.24\|2/5·10.24 = 4.096` | expected_value_generator.py |
| `VEC_SETUP` | 2 | `VEC_SETUP\|v = ⟨7, 1⟩\|magnitude` | dot_product_generator.py, vector_ops_generator.py |
| `VERIFY` | 2 | `VERIFY\|1\|ok` | error_spotting_generator.py |
| `VERTEX` | 1 | `VERTEX\|(6, 3)` | ellipse_features_generator.py, hyperbola_features_generator.py, parabola_features_generator.py |
...
| `ZERO_PRODUCT` | 2 | `ZERO_PRODUCT\|(x + 5)(x + 4) = 0\|x + 5 = 0 or x + 4 = 0` | area_between_curves_generator.py, curve_analysis_generator.py, domain_range_generator.py, log_equation_generator.py, optimization_generator.py, polynomial_zeros_generator.py, quadratic_factoring_generator.py, radical_equation_generator.py, trig_equation_generator.py |
| `ZSCORE` | 2 | `ZSCORE\|(120 - 106)/5\|2.8` | normal_table_generator.py, z_score_generator.py |
